...
byte fn02F4(byte a, byte c, ui8 b, byte h, struct Eq_n * ix, word16 & ixOut)
{
	...
	Eq_n a_n = (c_n << 0x01) + (ix->tFFFFFFDE).u1;
...
void fn04EE(struct Eq_n * ix)
{
	...
	ui16 a_a_n = (bc_n << 0x01) + ix->wFFFFFFF6;
	ix->wFFFFFFFC = a_a_n;
	...
	ui16 a_a_n = (bc_n << 0x01) + ix->wFFFFFFEE;
	ix->wFFFFFFFC = a_a_n;
...
void fn0914(word16 bc, byte * de, byte * hl, struct Eq_n * ix, word16 wArg00, Eq_n wArg02, Eq_n wArg28)
{
	...
	Eq_n a_a_n = (bc_n << 0x01) + ix->wFFFFFFE6;
	...
	Eq_n a_a_n = (bc_n << 0x01) + (ix->tFFFFFFDE).u0;
	ix->tFFFFFFFA.u1 = (ui16) a_a_n;
...
void fn0CB7(byte c, uint8 b, Eq_n de, byte h, byte l, struct Eq_n * ix, Eq_n wArg20)
{
	...
	Eq_n a_a_n = (bc_n << 0x01) + ix->wFFFFFFEE;
