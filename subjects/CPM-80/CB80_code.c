...
void fn0390(byte b, Eq_n c, byte e, byte bArg02)
{
	...
	while (true)
	{
		...
		if (a_n == 0x00)
			break;
		*g_t1654.u0 = g_b1656;
		g_t1654.u0 = (byte) (g_t1654.u0 + 0x01);
	}
}
...
void fn040D(byte b, Eq_n c, cu8 e, word16 wArg02)
{
	...
	{
		F_DMAOFF(g_t165C.u0);
		if (F_READ(g_t165A.u0) == 0x00)
		{
			--g_b165E;
			g_t165C.u0 = (byte) (g_t165C.u0 + 0x80);
		}
		else
		{
			*g_t165C.u0 = 0x1A;
...
word16 fn0483(byte b, Eq_n c, byte d, Eq_n e, word16 wArg02)
{
	...
	byte l_n;
	byte c_n = fn1326(0x07, g_t1664.u0 + 0x7F, out l_n);
	g_b1667 = (byte) hl_n;
	...
	while (true)
	{
		...
		F_DMAOFF(g_t1662.u0);
		bc_n = SEQ(b_n, 0x15);
		if (F_WRITE(g_t1660.u0) == 0x00)
		{
			--g_b1667;
			g_t1662.u0 = (byte) (g_t1662.u0 + 0x80);
		}
		else
		{
			g_ptr1668 = &g_b02A3;
			...
			if (*g_t1660.u0 == 0x00)
				*g_t1660.u0 = DRV_GET() + 0x01;
			fn0473(*g_t1660.u0 + 0x60);
...
byte fn05CE(Eq_n bc)
{
	...
	while (true)
	{
		...
		if (*g_t166D.u0 == 0x24)
			break;
		fn056B(SEQ(b_n, *g_t166D.u0), out bc_n);
		g_t166D.u0 = (byte) (g_t166D.u0 + 0x01);
	}
...
bool fn05EF(Eq_n bc, union Eq_n & bOut)
{
	...
	do
	{
		...
		if (a_n < g_b1671)
			break;
		C_n = fn056B(SEQ(b_n, *((byte) g_t166F.u0 + (uint16) g_b1671)), out bc_n);
		++g_b1671;
	} while (g_b1671 != 0x00);
	bOut.u1 = <invalid>;
	return C_n;
...
bool fn061B(byte b, Eq_n c, byte d, Eq_n e)
{
	...
	fn05CE(g_t1672.u0);
	byte b_n;
	bool C_n = fn05EF(g_t1674.u0, out b_n);
	fn0387();
	return C_n;
}
...
void fn063E(byte b, Eq_n c, byte d, Eq_n e)
{
	...
	*g_t1678.u0 = 0x00;
	...
	while (g_b167A <= 0x03)
	{
		...
		{
			Eq_n hl_n = g_t1678.u0;
			byte a_n = hl_n.u1[0];
			hl_n.u1[0] = a_n + 0x01;
			*((byte) g_t1678.u0 + (uint16) (a_n + 0x01)) = g_b167C;
		}
		++g_b167A;
		if (g_b167A == 0x00)
			break;
	...
	Eq_n hl_n = g_t1678.u0;
	Eq_n hl_n = g_t1676.u0;
	byte a_n = hl_n.u1[0];
	hl_n.u1[0] = a_n + 0x01;
	*((byte) g_t1678.u0 + (uint16) (a_n + 0x01)) = (byte) hl_n + 0x30;
}
...
byte fn082F(byte f, byte b, Eq_n c, byte e, word16 wArg02, word16 wArg04)
{
	...
	if (__rcr<byte,byte>(a_n, 0x01, cond(a_n)) < 0x00)
		g_b168E = 0x01;
	g_b168D += 0x0F;
	Eq_n hl_n = g_t1687.u0;
	Eq_n hl_n = g_t1689.u0;
	word16 af_n;
...
void fn0920()
{
	...
	if (g_b168D == 0x00)
	{
		...
		if ((~(0x00 - (byte) (a_n < 0x30)) & g_b168E) >> 0x01 < 0x00)
			*((byte) g_t168B.u0 + 7) |= 0x80;
		if (F_OPEN(g_t168B.u0) == ~0x00)
		{
			Eq_n hl_n = g_t1687.u0;
...
Eq_n fn0990(byte f, byte b, Eq_n c, byte d, Eq_n e, union Eq_n & afOut)
{
	...
	g_b1693 = b;
	g_t1692.u0 = (byte) c;
	Eq_n hl_n = g_t168B.u0;
	fn0390(SLICE((word16) hl_n + 1, byte, 8), (byte) hl_n + 0x01, 0x20, 11);
	g_t1696.u0 = *g_t1692.u0;
	Eq_n hl_n = g_t1692.u0;
	g_t1692.u0 = (byte) ((word16) hl_n + 1);
	struct Eq_n * sp_n = (struct Eq_n *) <invalid>;
	if (hl_n.u1->b0002 == 0x3A)
	{
		Eq_n af_n = fn03CB(*g_t1692.u0);
		Eq_n hl_n = g_t1692.u0;
		sp_n->tFFFFFFFE.u0 = (cu8) af_n;
		f = (byte) af_n;
		sp_n->tFFFFFFFE.u0 = (cu8) SEQ(0x00 - (byte) ((((hl_n.u1)->a0000))[0].u0 < 0x41) | sp_n->b0003, f);
		...
		*g_t168B.u0 = *g_t1692.u0 & 0x1F;
		...
		g_t1692.u0 = (byte) (g_t1692.u0 + 0x02);
	...
	while (true)
	{
		sp_n->tFFFFFFFE.u0 = (cu8) SEQ(~SLICE(0x07 - (uint16) g_b1697, byte, 8), f);
		word16 af_n = fn0B74();
		f = (byte) af_n;
		if ((SLICE(af_n, byte, 8) & sp_n->b0003) >> 0x01 >= 0x00)
			break;
		sp_n->tFFFFFFFE.u0 = (cu8) (g_t1692.u0 + (uint16) g_b1697);
		byte a_n = *sp_n->tFFFFFFFE.u0;
		*((word16) ((uint16) g_b1697 + 0x01) + g_t168B.u0) = a_n;
	...
	byte b_n;
	cu8 * hl_n = g_t1692.u0 + (uint16) g_b1697;
	sp_n->tFFFFFFFE.u0 = (cu8) SEQ(SLICE(0x01 - (uint16) g_t1696.u0, byte, 8), f);
	if ((0x00 - (byte) (*hl_n < 0x2F) & sp_n->b0003) >> 0x01 < 0x00)
	{
		...
		sp_n->tFFFFFFFE.u0 = g_t1696.u0;
		sp_n->ptrFFFFFFFC = g_t1692.u0 + (uint16) g_b1697;
		byte * de_n = g_t168B.u0 + 0x09;
	...
	{
		cu8 * hl_n = g_t1692.u0 + (uint16) g_b1697;
		sp_n->tFFFFFFFE.u0 = (cu8) SEQ(0x00 - (byte) (g_t1696.u0 < 0x01), f);
		...
		Eq_n hl_n = g_t1694.u0;
		sp_n->tFFFFFFFE.u0 = (cu8) SEQ(SLICE(hl_n, byte, 8), *hl_n.u1);
		sp_n->ptrFFFFFFFC = g_t1694.u0 + 0x01;
		byte * de_n = g_t168B.u0 + 0x09;
		byte * bc_n = sp_n->ptrFFFFFFFC;
		byte l_n = sp_n->b0002;
		do
	...
	sp_n->tFFFFFFFE.u0 = (cu8) SEQ(b_n, 0x03);
	Eq_n hl_n = g_t168B.u0;
	fn0390(SLICE((word16) hl_n + 0x0C, byte, 8), (byte) hl_n + 0x0C, 0x00, sp_n->b0002);
	*((byte) g_t168B.u0 + 32) = 0x00;
	g_b1697 = 0x00;
	while (g_b1697 <= 0x07)
	{
		*((word16) ((uint16) g_b1697 + 0x01) + g_t168B.u0) = fn03E6(*((word16) ((uint16) g_b1697 + 0x01) + g_t168B.u0));
		cu8 a_n = g_b1697;
		g_b1697 = a_n + 0x01;
		if (a_n == 0x01)
			break;
	...
	do
	{
		...
		if (g_b1697 > 0x02)
			break;
		byte a_n = fn03E6(*((word16) ((uint16) g_b1697 + 0x09) + g_t168B.u0));
		byte * hl_n = g_t168B.u0 + ((uint16) g_b1697 + 0x09);
		*hl_n = a_n;
		cu8 a_n = g_b1697;
		g_b1697 = a_n + 0x01;
		C_n = (bool) cond(hl_n);
...
{
	byte f;
	return SEQ(0x00 - (byte) (g_t1696.u0 < ~0x00) & 0x00 - (byte) (*((byte) g_t1692.u0 + (uint16) g_b1697) < 0x2F), f);
}
...
void fn0BE4(byte f)
{
	...
	struct Eq_n * sp_n = (struct Eq_n *) <invalid>;
	sp_n->tFFFFFFFE.u0 = (cu8) SEQ(0x00 - (byte) (g_b138A < 0x01), f_n);
...
void fn0E63(byte c)
{
	...
	while (true)
	{
		...
		if ((fn1353(0x00, &g_t1521, out l_n) | (byte) hl_n) == 0x00)
			break;
		if (g_b16A6 == *((byte) g_t1521.u0 + 2))
		{
			byte a_n;
			if (__rcr<byte,byte>(a_n, 0x01, fn0EAB(out a_n)) < 0x00)
				return;
		}
		Eq_n hl_n = g_t1521.u0;
		g_t1521.u0 = hl_n.u1->a0000[0].u0;
	}
}
...
bool fn0EAB(union Eq_n & aOut)
{
	...
	while (true)
	{
		...
		byte a_n = *((word16) ((uint16) g_b16A7 + 0x0A) + g_t1521.u0);
