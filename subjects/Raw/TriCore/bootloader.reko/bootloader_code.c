...
void fn000007F8(struct Eq_n * d4)
{
		...
		{
			Eq_n d15_n;
			d15_n.u1 = (uint32) d4->bD0000098;
			struct Eq_n * a15_n = (d15_n << 5) + 0x00005000;
			Eq_n d3_n;
			d3_n.u1 = a15_n->tF000001C.u1;
