...
Eq_n fn00000400(Eq_n a4, Eq_n a15)
{
		...
		*(word32 *) 0xF000400C = 0x43FF;
		...
		do
		{
			int32 d15_n = (int32) *(bool *) 0xF00041C5;
		} while (d15_n != 0x00);
		...
		*(word32 *) 0xF000503C = 0x00200000;
		...
		do
		{
			...
			word32 d15_n = g_a0004[d15_n + 0x07800000];
...
void fn000005CE(ui32 d4, ui16 * a4)
{
		...
		Eq_n d2_n = (int32) a15_n->nF0000003;
		*a4 = (word16) d2_n;
		int32 d15_n = 0x00;
		while (true)
		{
		...
		Eq_n d15_n = a15_n->tF000001C;
		*a4 = (word16) d2_n << 0x04;
		if (__bit<word32,byte>(d15_n, 11))
			*a4 = (word16) d2_n << 0x04 | 0x08;
}
...
word32 fn00000648(ui32 d4, ptr32 & a15Out)
{
		struct Eq_n * a15_n = (d4 << 5) + 0x00005000;
		word32 d2_n = 0x00;
		if (!__bit<word32,byte>(a15_n->tF000001C, 0x08))
		{
...
void fn00000690(ui32 d4, struct Eq_n * a4)
{
		...
		if (__bit<word32,word16>(a15_n->tF000001C, 11))
		{
			int32 d4_n = 0x00;
			while (true)
			{
...
void fn0000074E(ui32 d4, byte * a4)
{
		...
		{
			Eq_n a3_n = a2_n - a4;
			if ((a3_n & 0xFF) >= (int32) a15_n->nF0000003)
				break;
			((char *) a15_n - 0x10000000 + (a3_n & 0xFF))[16] = *a2_n;
			++a2_n;
		}
...
{
		struct Eq_n * a15_n = (d4 << 5) + 0x00005000;
		if (__bit<word32,byte>(a15_n->tF000001C, 0x04))
...
void fn000007F8(struct Eq_n * d4)
{
		...
		{
			Eq_n d15_n = (uint32) d4->bD0000098;
			struct Eq_n * a15_n = (d15_n << 5) + 0x00005000;
			Eq_n d3_n = a15_n->tF000001C;
...
void fn000008BE(struct Eq_n * d4, ui16 * a4)
{
		...
		{
			Eq_n d15_n = (uint32) d4->bD0000018;
			struct Eq_n * a15_n = (d15_n << 5) + 0x00005000;
			Eq_n d3_n = a15_n->tF000001C;
...
void fn000009BA(struct Eq_n * d4, word32 * d5, union Eq_n * a4)
{
		...
		*d5 = 0x30;
		do
			;
		while (!__bit<word32,byte>(*a4, 0x00) && (!__bit<word32,byte>(*a4, 0x02) && !__bit<word32,word16>(*a4, 0x03)));
		do
			;
		while (__bit<word32,word16>(*a4, 0x00) || (__bit<word32,word16>(*a4, 0x02) || __bit<word32,word16>(*a4, 0x03)));
		__load_upper_context();
}
...
Eq_n fn00000B04(Eq_n a4, Eq_n a15, uint32 ICR)
{
		...
		*(union Eq_n *) 247284 = a15;
		...
		do
		{
			Eq_n d15_n = *(union Eq_n *) 0x0003C5F0;
