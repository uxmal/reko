...
// 02BF: Register word16 fn02BF(Register ci16 gp1, Register word16 gp4, Register out ptr16 gp1Out, Register out ptr16 gp2Out, Register out ptr16 gp14Out)
// Called from:
//      fn032A
//      fn034E
word16 fn02BF(ci16 gp1, word16 gp4, ptr16 & gp1Out, ptr16 & gp2Out, ptr16 & gp14Out)
{
	ptr16 fp;
	ci16 gp2_n = gp1;
	if (gp1 < 0x00)
...
int32 fn032A(int32 gp0_gp1, word16 gp2, ptr16 & gp2Out)
{
	...
	if (gp0_gp1 < 0x00)
	{
		real48 gp2_gp3_gp4_n = *((char *) &g_rFFFF811F + 3);
...
// Called from:
//      fn03E0
cui16 fn03EC(Eq_n gp12_gp13_gp14, cui16 gp0, word16 gp1, struct Eq_n * gp11)
{
...
// 045D: void fn045D(Register (ptr16 byte) gp0)
// Called from:
//      fn04AE
void fn045D(byte * gp0)
{
	byte * gp11_n = gp0;
	word16 gp0_n = 0x00;
	while (true)
...
{
	word16 gp14_n;
	fn045D(fn03E0(gp0_gp1, &g_tFFFF813C, gp2, out gp14_n));
	return gp14_n;
}
