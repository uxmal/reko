...
Eq_n fn000D0F0D(Eq_n arg0, Eq_n arg1, Eq_n arg2)
{
	...
	while (true)
	{
		...
		if (loc3_n > v72_n)
		{
			...
			loc8_n = loc3_n - v72_n;
			loc9_n.u2 = &loc4_n.u17->bFFFFFFFF;
	...
	else
	{
		...
		if (loc3_n > v55_n)
		{
			...
			if (arg0.u17[48] != 0x00)
			{
				...
				*(arg1 + &(arg2.u17)->bFFFFFFFF) = (word32) *v55_n.u2;
			}
		}
	}
...
l000D22B7:
					...
					if (arg0.u17[100] == 0x00 == 0x00)
						arg0.u17[4] = (struct Eq_n) arg0.u17[4].bFFFFFFFF;
					if (loc254 < arg3 != 0x00)
						return <invalid>;
...
Eq_n fn000D2493(Eq_n arg0)
{
	...
	if (loc48_n == 0x03)
	{
		...
		else
		{
			...
			int8 * v52_n = &loc36_n.u17->bFFFFFFFF;
...
l000D3C92:
			...
			case 0x45:
				...
				else
				{
					...
					while (true)
					{
						v967_n.u2 = &loc71_n.u17->bFFFFFFFF;
			...
			if (v967_n == 0x61)
			{
				...
				if (v967_n == v967_n + &g_t024C)
				{
					*(v967_n + 0x024B) = (word32) 0x30;
					...
					loc57_n = v967_n;
				loc57_n.u17->bFFFFFFFF = ((byte) (v967_n >> 0x1F) & 0x02) + 0x2B;
				Eq_n v967_n;
...
l000D5230:
			...
			else
			{
				...
				if (v967_n + &g_t024C - v967_n < 0x02)
				{
					...
					loc95_n = v967_n;
				loc95_n.u17->bFFFFFFFF = ((byte) (loc160_n >> 0x1F) & 0x02) + 0x2B;
				Eq_n v967_n;
...
l000D5429:
				...
				else
				{
					...
					while (true)
					{
						v967_n.u2 = &loc45_n.u17->bFFFFFFFF;
						if (v967_n <= v967_n + &g_t024C)
							break;
						loc45_n = v967_n;
					}
					...
					if (loc136_n > 0x00 & v967_n < loc171_n)
					{
						...
						while (true)
						{
							...
							if (v967_n > v967_n + &g_t024C)
							{
								...
								while (true)
								{
									v967_n.u2 = &loc44_n.u17->bFFFFFFFF;
									if (v967_n <= v967_n + &g_t024C)
										break;
									loc44_n = v967_n;
								}
	...
	if ((int32) *loc5.u2 != (int32) ((byte) arg1))
	{
		...
		if (v61_n)
		{
			...
			while (true)
			{
				...
				Eq_n v59_n;
				v59_n.u2 = &loc12_n.u17->tFFFFFFFC.u0;
				if (v59_n <= 0x03)
				{
					loc3 = v59_n;
					loc11 = v59_n;
...
l000D8838:
						if (loc81_n == 0x00)
						{
							...
							else if (v820_n == 0x00 == 0x00)
							{
								Eq_n v820_n;
								v820_n.u2 = arg0.u17[4];
								arg0.u17[4] = (struct Eq_n) &v820_n.u17->bFFFFFFFF;
			...
			if (loc56 == 0x09)
			{
				...
				else
				{
					...
					while (true)
					{
						...
						Eq_n v57_n;
						v57_n.u2 = &loc11_n.u17->bFFFFFFFF;
						if (v57_n < 0x00 == 0x00)
							break;
						if (v57_n == 0x00)
						{
...
l000DC03D:
					...
					case 110:
						...
						else
						{
							Eq_n v443_n;
							v443_n.u2 = arg0.u17[4];
							arg0.u17[4] = (struct Eq_n) &v443_n.u17->bFFFFFFFF;
							loc137_n.u2 = &v443_n.u17->bFFFFFFFF;
						}
						loc28_n = loc7_n;
						...
						if (v443_n != 115)
						{
							...
							while (true)
							{
								...
								case 2:
									...
									case 93:
										Mem1875 = Mem1835;
										ui32 v443_n = (word32) loc64_n.u17->bFFFFFFFF;
...
l000DCAAD:
						...
						else
						{
							...
							v443_n.u2 = arg0.u17[4];
							arg0.u17[4] = (struct Eq_n) &v443_n.u17->bFFFFFFFF;
							loc284_n.u2 = &v443_n.u17->bFFFFFFFF;
						}
						Eq_n v443_n;
...
l000DD495:
		...
		else
		{
			...
			else
			{
				...
				v443_n.u2 = arg0.u17[4];
				arg0.u17[4] = (struct Eq_n) &v443_n.u17->bFFFFFFFF;
				loc352_n.u2 = &v443_n.u17->bFFFFFFFF;
			}
			loc27_n = loc30_n;
	...
	else
	{
		...
		while (true)
		{
			...
			*v67_n.u3 = (int32) v67_n;
			...
			Eq_n v67_n;
			v67_n.u2 = &loc21_n.u17->bFFFFFFFF;
			Eq_n v67_n;
		...
		if (loc26_n > 0x04 & (loc35_n & 0x03) == 0x00)
		{
			...
			while (true)
			{
				...
				*loc16_n.u3 = v196_n & 0xFF;
				...
				Eq_n v196_n;
				v196_n.u2 = &loc32_n.u17->tFFFFFFFC.u0;
				loc186 = v196_n;
				loc189 = v196_n;
				loc190 = v196_n;
				if (v196_n <= 0x04)
		...
		if (loc18_n != 0x00 & loc14_n != 0x00)
		{
			...
			while (true)
			{
				...
				*v68_n.u3 = (int32) (v68_n.u17 + 4);
				Eq_n v68_n;
				v68_n.u2 = &loc17_n.u17->bFFFFFFFF;
		...
		while (true)
		{
			...
			else
			{
				*loc7_n.u2 = (byte) v73_n;
				...
				loc15_n.u2 = &loc12_n.u17->bFFFFFFFF;
				loc45_n.u1 = *arg1.u3;
			}
			Eq_n v73_n;
...
l000DE8B5:
		...
		else
		{
			*loc13_n.u2 = (byte) v73_n;
			...
			loc17_n.u2 = &loc16_n.u17->bFFFFFFFF;
			loc66_n.u1 = *arg1.u3;
		}
		Eq_n v73_n;
...
Eq_n fn000DEB18(Eq_n arg0, Eq_n arg1)
{
	...
	if (loc26 == 0x06)
	{
		Eq_n v29_n;
		v29_n.u2 = arg1.u17[4];
		if (v29_n > &((((arg1.u11))[22].ptrFFFFFFF4)->t0004).u0)
		{
			arg1.u17[4] = (struct Eq_n) &v29_n.u17->bFFFFFFFF;
			v29_n.u17->bFFFFFFFF = (byte) arg0;
