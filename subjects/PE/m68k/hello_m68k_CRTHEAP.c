...
int32 fn00002510(struct Eq_n * a5, Eq_n dwArg04, union Eq_n & d3Out, ptr32 & d4Out, struct Eq_n & a5Out, word32 & a6Out)
{
	...
	Eq_n d0_n;
	d0_n.u0 = *((word32) a2_n->t0000.u0 + 4);
...
Eq_n fn000025B4(struct Eq_n * a5, struct Eq_n * dwArg04, Eq_n dwArg08)
{
	word32 a0_n;
	Eq_n a0_n;
	a0_n.u0 = dwArg04->t0000.u0;
	Eq_n d0_n;
	d0_n.u0 = a0_n.u2->t0004.u0;
	...
	struct Eq_n * d0_n = (struct Eq_n *) ((char *) dwArg08.u1 + SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03));
	d0_n.u2->t0004.u0 = (int32) &d0_n->t0004.u0;
	d0_n->t0004.u0 = (int32) d0_n;
	*d0_n.u1 = dwArg04->t0000.u0;
	dwArg04->t0000.u0 = (int32) d0_n;
	return d0_n;
}
...
l00002758:
	...
	d0_n.u0 = a5->tFFFFFAD0.u0;
	a5->tFFFFFAD0.u0 = *d0_n.u1;
	a0_n = d0_n;
	goto l00002758;
}
		...
		if (true)
		{
			...
			do
			{
				*d0_n.u1 = (word32) d1_n;
				...
				d1_n = d1_n;
			} while (&a0.u2->dw0FF8 > d1_n);
		}
		a0.u2->dw0FF8 = 0;
		a0Out.u1 = &a0.u2->dw0FF8;
		return 1;
	}
	else
	{
...
l0000280C:
	...
	a2_n.u0 = a5->tFFFFFAC8.u0;
	if (a2_n == (a5->tFFFFFACC).u0)
	{
l00002882:
		a0Out = a0;
		return a1_n;
		...
		do
		{
			...
			if ((*a3_n & 3) == 0x01)
			{
				do
				{
					...
					*a0.u1 = a5->tFFFFFAD0.u0;
					a5->tFFFFFAD0.u0 = (int32) a0;
				} while (a0 != (a5->tFFFFFACC).u0);
				a5->tFFFFFACC.u0 = (int32) a2_n;
				a0.u1 = *a2_n.u1;
				Eq_n d0_n;
				d0_n.u0 = a0.u2->t0004.u0;
				ui32 d1_n = *a3_n;
...
int32 fn000028A0(Eq_n a0, struct Eq_n * a2, struct Eq_n * a5, Eq_n dwArg04, union Eq_n & d3Out, union Eq_n & d4Out, struct Eq_n & a5Out, ptr32 & a6Out)
{
	...
	if (d4_n < a5->dwFFFFFAE0)
	{
		...
		do
		{
			if (*((word32) *a5->tFFFFFADC.u0 + d7_n) != 0x00)
			{
				struct Eq_n * a7_n = a7_n - 4;
				a7_n->dw0000 = d3_n;
...
l000029B4:
	...
	a5->tFFFFFADC.u0 = (int32) a0;
l00002974:
	a0 = *a5->tFFFFFADC.u0 + (a5->dwFFFFFAE0 << 0x04);
	int32 d0_n = 7;
	word16 v30_n;
	do
	{
		a0->u0 = 0;
		struct Eq_n * a0_n = (struct Eq_n *) (a0.u2 + 1);
		a0_n->dw0000 = 0;
		a0_n->dw0004 = 0;
		a0_n->dw0008 = 0;
		a0_n->dw000C = 0;
...
int32 fn000029C8(Eq_n a0, struct Eq_n * a5, int32 dwArg04, up32 dwArg08, struct Eq_n & a5Out, ptr32 & a6Out)
{
	...
	if (a0 != 0x00)
	{
		...
		struct Eq_n * a1_n = (struct Eq_n *) (a1_n.u2 + dwArg04 * 4);
		a1_n->t000C.u0 = (int32) a0;
		a1_n->dw0008 = d4_n;
		a1_n->dw0004 = 0;
		word32 d3_n;
		word32 d4_n;
...
{
	ptr32 fp;
	struct Eq_n * a2_n = *a5->tFFFFFADC.u0 + (dwArg04 << 0x04);
	...
	if (d3_n > d0_n)
	{
		...
		a2_n = *a5->tFFFFFADC.u0 + (dwArg04 << 0x04);
		if (*a5->tFFFFFAF0.u0 != 0x00)
		{
			Eq_n d3;
			d3Out = d3;
			Eq_n d4;
...
{
	if (*((word32) *a5->tFFFFFADC.u0 + dwArg04 * 0x10) != 0x00)
		__syscall<word16>(0xA01F);
	Eq_n a0_n;
	a0_n.u0 = *a5->tFFFFFADC.u0;
	((word128) a0_n + dwArg04 * 0x10)->u0 = 0;
	((word128) a0_n + (dwArg04 * 0x10 + 4))->u0 = 0;
	((word128) a0_n + (dwArg04 * 0x10 + 8))->u0 = 0;
}
...
void fn00002B18(struct Eq_n * a5, struct Eq_n * dwArg04)
{
	...
	{
		Eq_n a2_n;
		a2_n.u0 = dwArg04->tFFFFFFFC.u0;
		Eq_n d1_n;
		d1_n.u0 = a2_n.u2->t0004.u0;
		...
		Eq_n d0_n;
		__bclr<word32>(a2_n.u2->t0004.u0, 0x01, out d0_n);
		Eq_n d0_n;
		__bset<word16>(d0_n, 0x00, out d0_n);
		a2_n.u2->t0004.u0 = (int32) d0_n;
		if (a5->tFFFFFAE4.u0 != -1 && d0_n < *((word32) (a5->tFFFFFACC).u0 + 4))
		{
			Eq_n d1_n;
			d1_n.u3 = *((word32) *a2_n.u1 + 4);
...
int32 fn00002BB4(struct Eq_n * a5, Eq_n dwArg04, up32 dwArg08, struct Eq_n & a5Out, ptr32 & a6Out)
{
	...
	if (fn0000273C(fp + ~0x17, a5, out a0_n) != 0x00 && (fn0000273C(a0_n, a5, out a0_n) != 0x00 && fn0000273C(a0_n, a5, out a0_n) != 0x00))
	{
		...
		a3_n.u2->t0004.u0 = (int32) d1_n;
		dwArg04.u3->t0000.u0 = (int32) a3_n;
		if (d0_n <= 0x00)
		{
		...
		if ((a0_n->dw0004 & 3) == 2)
		{
			...
			Eq_n d1_n;
			d1_n.u0 = a0_n.u2->t0004.u0;
			union Eq_n ** dwLoc28_n = &tLoc1C;
...
l00002DE8:
	while (*tLoc1C != 0x00)
	{
		**tLoc1C = (Eq_n) a5->tFFFFFAD0.u0;
		a5->tFFFFFAD0.u0 = (int32) *tLoc1C;
		tLoc1C = (Eq_n) ((word32) tLoc1C + 4);
	}
	a5Out = a5;
	a6Out = a6;
...
// 00002E18: void fn00002E18(Stack Eq_n dwArg04, Stack up32 dwArg08, Stack Eq_n dwArg0C, Stack (ptr32 (ptr32 Eq_n)) dwArg10)
// Called from:
//      fn00002BB4
void fn00002E18(Eq_n dwArg04, up32 dwArg08, Eq_n dwArg0C, union Eq_n ** dwArg10)
{
	Eq_n d2_n;
	d2_n.u0 = dwArg04.u2->t0004.u0;
	Eq_n a2_n = dwArg04;
	if ((d2_n & 3) != 2)
	{
		Eq_n d1_n;
		d1_n.u0 = dwArg0C.u2->t0004.u0;
		if ((d1_n & 0x03) == 0x02)
		{
		...
		if (SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) != d2_n)
		{
			...
			*dwArg10 = (union Eq_n **) ((char *) a0_n + 4);
			v33_n.u2->t0004.u0 = (int32) d2_n;
			Eq_n d2_n;
			__bclr<word32>(d2_n, 0x00, out d2_n);
			Eq_n d2_n;
			__bset<word16>(d2_n, 0x01, out d2_n);
			v33_n.u2->t0004.u0 = (int32) d2_n;
			*dwArg04.u1 = (word32) v33_n;
			a2_n = v33_n;
		}
	}
	*a2_n.u1 = (word32) dwArg0C;
}
...
{
	if ((char *) &a5->tFFFFFAD0 + 4 == (a5->tFFFFFAC8).u0)
		return -3;
	Eq_n d0_n;
	d0_n.u0 = *((word32) a5->tFFFFFAC8.u0 + 4);
	if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) > dwArg04)
		return -1;
	...
	dwArg08->u0 = (int32) a1_n;
	Eq_n d1_n;
	d1_n.u0 = a1_n.u2->t0004.u0;
	int32 d0_n = 0;
	if (SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) != dwArg04)
		d0_n = 1;
	return d0_n;
