...
int32 fn00002510(struct Eq_n * a5, Eq_n dwArg04, union Eq_n & d3Out, ptr32 & d4Out, struct Eq_n & a5Out, word32 & a6Out)
{
	...
	if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) - d3_n != 4)
	{
		...
		{
			Eq_n d0_n;
			__bclr<word32>(d0_n->t0004, 0x01, out d0_n);
			Eq_n d0_n;
...
void fn00002B18(struct Eq_n * a5, struct Eq_n * dwArg04)
{
	...
	if (dwArg04 != null)
	{
		...
		Eq_n d0_n;
		__bclr<word32>(a2_n->t0004, 0x01, out d0_n);
		Eq_n d0_n;
		__bset<word16>(d0_n, 0x00, out d0_n);
		a2_n->t0004 = d0_n;
		...
		if (fn0000273C(a0_n, a5, out a0_n) != null)
		{
			...
			*dwArg04 = a3_n;
			...
			if ((a0_n->dw0004 & 3) == 2)
			{
				...
				{
					Eq_n d0_n = a3_n->t0004;
					up32 d0_n = SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) + dwArg08;
					if (d0_n - a5->dwFFFFFAD8 > 0x00)
						a5->dwFFFFFAD8 = d0_n;
				}
				fn00002E18(a3_n, dwArg08, tLoc08 + 0x00, &tLoc1C);
				struct Eq_n * a0_n = tLoc08;
				word32 d0_n = tLoc08 + 0x00 + 4;
				Eq_n d1_n = a0_n->t0004;
				word32 * dwLoc28_n = &tLoc1C;
...
l00002DE8:
	while (tLoc1C + 0x00 != 0x00)
	{
		tLoc1C + 0x00 + 0x00 = a5->ptrFFFFFAD0;
		a5->ptrFFFFFAD0 = tLoc1C + 0x00;
		tLoc1C += 0x04;
	}
	a5Out = a5;
	a6Out = a6;
...
// 00002E18: void fn00002E18(Stack (ptr32 Eq_n) dwArg04, Stack up32 dwArg08, Stack (ptr32 Eq_n) dwArg0C, Stack (ptr32 word32) dwArg10)
// Called from:
//      fn00002BB4
void fn00002E18(struct Eq_n * dwArg04, up32 dwArg08, struct Eq_n * dwArg0C, word32 * dwArg10)
{
...
// 00002EA8: Register int32 fn00002EA8(Register (ptr32 Eq_n) a5, Stack Eq_n dwArg04, Stack (ptr32 word32) dwArg08)
// Called from:
//      fn00002BB4
int32 fn00002EA8(struct Eq_n * a5, Eq_n dwArg04, word32 * dwArg08)
{
	if ((char *) &a5->ptrFFFFFAD0 + 4 - a5->ptrFFFFFAC8 == 0x00)
		return -3;
	Eq_n d0_n = a5->ptrFFFFFAC8->t0004;
	if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - dwArg04 > 0x00)
		return -1;
