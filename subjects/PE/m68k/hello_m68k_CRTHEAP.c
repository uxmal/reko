...
word32 fn000024C4(struct Eq_n * a5, Eq_n dwArg04)
{
	...
	do
	{
		...
		if (fn00002510(a5, a7_n->u0, out d3_n, out d4_n, out a5_n, out a6_n) != 0x00 || d4_n == 0x00)
			return *a6_n;
		a7_n->t0000.u0 = (struct Eq_n *) d3_n;
		struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
		a7_n = &a7_n->t0004.u0;
...
int32 fn00002510(struct Eq_n * a5, Eq_n dwArg04, union Eq_n & d3Out, ptr32 & d4Out, struct Eq_n & a5Out, word32 & a6Out)
{
	...
	Eq_n d0_n = a2_n->ptr0000->t0004.u0;
...
struct Eq_n * fn000025B4(struct Eq_n * a5, struct Eq_n * dwArg04, Eq_n dwArg08)
{
	...
	struct Eq_n * d0_n = dwArg08.u0 + SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) / 4;
	d0_n->t0004.u0 = (byte) &d0_n->ptr0004;
	d0_n->ptr0004 = d0_n;
...
struct Eq_n * fn000027B0(struct Eq_n * a5, Eq_n dwArg04, struct Eq_n & a0Out)
{
	...
	if ((char *) &a5->ptrFFFFFAD0 + 4 - a2_n != 0x00)
	{
		do
		{
			ui32 * a4_n = &a2_n->t0004.u0;
			if ((*a4_n & 3) == 0x01)
			{
				while (true)
				{
					a0 = a2_n->dw0000;
					Eq_n d0_n = a0->t0004.u0;
					ui32 d3_n = *a4_n;
...
l00002882:
	...
	else
	{
		do
		{
			ui32 * a3_n = &a2_n->t0004.u0;
			if ((*a3_n & 3) == 0x01)
			{
				do
				{
					a0 = a2_n->dw0000;
					Eq_n d3_n = a0->t0004.u0;
					ui32 d1_n = *a3_n;
...
int32 fn000028A0(Eq_n a0, struct Eq_n * a2, struct Eq_n * a5, Eq_n dwArg04, union Eq_n & d3Out, union Eq_n & d4Out, struct Eq_n & a5Out, ptr32 & a6Out)
{
	...
	if (d4_n - a5->dwFFFFFAE0 < 0x00)
	{
		...
		do
		{
			if (*((word16) *a5->tFFFFFADC.u0 + d7_n) != 0x00)
			{
				struct Eq_n * a7_n = a7_n - 4;
				a7_n->dw0000 = d3_n;
...
l000029B4:
	...
	if (a0 == 0x00)
	{
		Eq_n d4_n = a7_n->t0004.u0;
		ptr32 a6_n = *a6_n;
		&d3Out.u0->dw0000 = a7_n->t0000.u0;
		d4Out = d4_n;
		a5Out = a5;
		a6Out = a6_n;
		return -1;
...
l00002974:
	...
	{
		&a0.u0->u1->a0000->u0 = 0;
		struct Eq_n * a0_n = (word16) a0.u0 + 4;
		a0_n->dw0000 = 0;
		a0_n->dw0004 = 0;
		a0_n->dw0008 = 0;
		a0_n->dw000C = 0;
...
int32 fn000029C8(Eq_n a0, struct Eq_n * a5, int32 dwArg04, up32 dwArg08, struct Eq_n & a5Out, ptr32 & a6Out)
{
	...
	if (a0 != 0x00)
	{
		...
		struct Eq_n * a1_n = a1_n.u1 + (dwArg04 << 0x04) / 4;
		a1_n->t000C.u0 = (word16) a0;
		a1_n->dw0008 = d4_n;
		a1_n->dw0004 = 0;
		Eq_n d5_n;
		word32 a2_n;
...
l00002A4C:
		...
		a7_n->t0004.u0 = (struct Eq_n *) d5_n;
...
int32 fn00002A54(struct Eq_n * a5, int32 dwArg04, up32 dwArg08, union Eq_n & d3Out, union Eq_n & d4Out, union Eq_n & d5Out, ptr32 & a2Out, struct Eq_n & a5Out, word32 & a6Out)
{
	...
	struct Eq_n * a7_n = &a7_n->t0004.u0;
	Eq_n d4_n = a7_n->t0000.u0;
	Eq_n d5_n = a7_n->t0004.u0;
...
{
	if (*((word16) *a5->tFFFFFADC.u0 + dwArg04 * 0x10) != 0x00)
		__syscall<word16>(0xA01F);
	Eq_n a0_n = *a5->tFFFFFADC.u0;
	a0_n.u1[dwArg04 * 4] = (struct Eq_n) 0;
	a0_n.u1->a0004[dwArg04].dw0000 = 0;
	&((word128) a0_n + (dwArg04 * 0x10 + 8))->u1->a0000->u0 = 0;
}
...
void fn00002B18(struct Eq_n * a5, struct Eq_n * dwArg04)
{
	...
	if (dwArg04 != null)
	{
		...
		Eq_n d0_n;
		__bclr<word32>(a2_n->t0004.u0, 0x01, out d0_n);
		Eq_n d0_n;
		__bset<word16>(d0_n, 0x00, out d0_n);
		a2_n->t0004.u0 = (byte) d0_n;
		if (a5->tFFFFFAE4.u0 != -1 && d0_n - ((a5->ptrFFFFFACC)->t0004).u0 < 0x00)
		{
			word32 d1_n = *((word32) a2_n->dw0000 + 4);
			if (SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) - SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - 0x04 - (a5->tFFFFFAE4).u0 >= 0x00)
				a5->ptrFFFFFACC = a2_n;
		}
	}
}
...
int32 fn00002BB4(struct Eq_n * a5, Eq_n dwArg04, up32 dwArg08, struct Eq_n & a5Out, ptr32 & a6Out)
{
	...
	tLoc1C = (Eq_n) (fp + ~0x17);
	struct Eq_n * a0_n;
	if (fn0000273C(fp + ~0x17, a5, out a0_n) != null)
	{
		struct Eq_n * a0_n;
		...
		if (fn0000273C(a0_n, a5, out a0_n) != null)
		{
			...
			if ((a0_n->dw0004 & 3) == 2)
			{
				if ((char *) &a5->ptrFFFFFAD0 + 4 - a0_n->dw0000 == 0x00)
				{
					Eq_n d0_n = a3_n->t0004.u0;
				...
				struct Eq_n * a0_n = tLoc08;
				word32 d0_n = *((word32) *tLoc08 + 4);
				Eq_n d1_n = a0_n->t0004.u0;
				...
				Eq_n d0_n = a5->ptrFFFFFACC->t0004.u0;
				if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - dwArg04 > 0x00)
				{
					word32 d0_n = *((word32) a3_n->dw0000 + 4);
					Eq_n d1_n = a3_n->t0004.u0;
					if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) - 0x04 - (a5->tFFFFFAE4).u0 >= 0x00)
						a5->ptrFFFFFACC = a3_n;
				}
				a5Out = a5;
				a6Out = a6;
...
int32 fn00002EA8(struct Eq_n * a5, Eq_n dwArg04, struct Eq_n ** dwArg08)
{
	if ((char *) &a5->ptrFFFFFAD0 + 4 - a5->ptrFFFFFAC8 == 0x00)
		return -3;
	Eq_n d0_n = a5->ptrFFFFFAC8->t0004.u0;
	if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - dwArg04 > 0x00)
		return -1;
