...
l000017A6:
	move.b	($1A,pc,d6.w),d6
	move.w	($0A,pc,d6.w*2),d6
	jmp.l	($06,pc,d6.w)
000017B2       4E 71 00 1E 00 28 00 30 00 38 00 40 04 70   Nq...(.0.8.@.p
...
000017F0 60 00 04 32 08 C3 00 03 60 00 04 2A             `..2....`..*    
...
;; fn00001D0C: 00001D0C
;;   Called from:
;;     00001806 (in fn000016D0)
;;     0000184E (in fn000016D0)
fn00001D0C proc
	link	a6,#$0000
	movea.l	$0008(a6),a0
	movea.l	(a0),a1
...
l00002096:
	move.l	a2,-(a7)
	jsr.l	fn00001D80                                           ; -$0318(pc)
	addq.w	#$04,a7
	move.l	d0,d3
	move.l	a2,-(a7)
	jsr.l	fn000020F0                                           ; $004E(pc)
	addq.w	#$04,a7
	move.l	$0010(a2),-(a7)
	jsr.l	$00A2(a5)
	addq.w	#$04,a7
