...
void fn000022C4(word32 a2, ptr32 a5)
{
	...
	a7_n->ptr0004 = a5 + -748;
	a7_n->ptr0000 = a5 + -752;
	struct Eq_n * a6_n = fn000023B4(a7_n->ptr0000, a7_n->ptr0004);
	struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
	a7_n->w0002 = ~0x5760;
	a7_n->b0001 = 0x01;
	(*((word32) a5 + 0x00C2))();
...
word32 fn00002354(struct Eq_n * a5, word32 dwArg08, byte bArg0F)
{
	...
	if (dwArg08 == 0x00)
	{
		...
		{
			fn000023B4(a5->ptrFFFFFD3C, a5->ptrFFFFFD38);
			struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
			a7_n = &a7_n->ptr0008;
		}
		struct Eq_n * a7_n = a7_n - 4;
		a7_n->ptr0000 = (union Eq_n *) ((char *) &a5->ptrFFFFFAA0 + 0x0288);
		a7_n->ptrFFFFFFFC = (union Eq_n *) ((char *) &a5->ptrFFFFFAA0 + 640);
		fn000023B4(a7_n->ptrFFFFFFFC, a7_n->ptr0000);
		struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
		a7_n = &a7_n->ptr0008;
	}
	struct Eq_n * a7_n = a7_n - 4;
	a7_n->ptr0000 = (union Eq_n *) ((char *) &a5->ptrFFFFFAA0 + 656);
	a7_n->ptrFFFFFFFC = (union Eq_n *) ((char *) &a5->ptrFFFFFAA0 + 652);
	struct Eq_n * a6_n = fn000023B4(a7_n->ptrFFFFFFFC, a7_n->ptr0000);
	if (a6_n->dw0010 == 0x00)
	{
		if (a5->ptrFFFFFAA0 != null)
			a5->ptrFFFFFAA0->dw000E = a6_n->dw0008;
		(*((char *) &a5->ptrFFFFFD3C + 806))();
	}
	return a6_n->dw0000;
}

// 000023B4: Register word32 fn000023B4(Stack (ptr32 Eq_n) dwArg04, Stack (ptr32 Eq_n) dwArg08)
// Called from:
//      fn000022C4
//      fn00002354
word32 fn000023B4(union Eq_n * dwArg04, union Eq_n * dwArg08)
{
	ptr32 fp;
	word32 * a6_n = fp - 0x04;
	<anonymous> * d5_n = (<anonymous> *) ~0x00;
	union Eq_n * d4_n = dwArg08;
...
void fn000023F8(struct Eq_n * a5)
{
	...
	struct Eq_n * a5_n = fn0000243C(a5_n, a7_n->ptrFFFFFFFC, out a6_n);
	struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
	a7_n->ptr0000 = (union Eq_n *) 0xFF;
	a5_n->ptrFFFFFAF8();
}
...
struct Eq_n * fn00002418(struct Eq_n * a5, ptr32 & a6Out)
{
	...
	word32 a6_n;
	struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
	struct Eq_n * a5_n = fn0000243C(a5, (union Eq_n *) 252, out a6_n);
	word32 a7_n = &a7_n->ptr0004;
	<anonymous> * a0_n = a5_n->ptrFFFFFC0C;
	if (a0_n != null)
		a0_n();
	union Eq_n ** a7_n = a7_n - 4;
	*a7_n = (union Eq_n **) (union Eq_n *) 0xFF;
	struct Eq_n * a5_n = fn0000243C(a5_n, *a7_n, out a6_n);
	a6Out = *a6_n;
	return a5_n;
}

// 0000243C: Register (ptr32 Eq_n) fn0000243C(Register (ptr32 Eq_n) a5, Stack (ptr32 Eq_n) dwArg04, Register out ptr32 a6Out)
// Called from:
//      fn000023F8
//      fn00002418
struct Eq_n * fn0000243C(struct Eq_n * a5, union Eq_n * dwArg04, ptr32 & a6Out)
{
	ptr32 fp;
	ptr32 * a6_n = fp - 0x04;
	ui32 d1_n = 0x00;
	...
	if (dwArg04 == ((a5->aFFFFFBB4))[d1_n].ptr0000)
	{
