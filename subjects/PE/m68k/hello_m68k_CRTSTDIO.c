	...
	if (v18_n != 0x00)
	{
		while (true)
		{
			...
			if ((byte) d6_n >= 0x20 && (byte) d6_n <= 0x78)
				...
				d0_n = 0;
			Eq_n d0_n = CONVERT((a5 + -2040 + dwLoc0C_n)[d0_n * 0x08] >> 0x04, byte, int32);
			dwLoc0C_n = d0_n;
			if (d0_n <= 7)
			{
...
int32 fn00001D80(struct Eq_n * a5, struct Eq_n * dwArg04, ptr32 & d3Out, ptr32 & d4Out, ptr32 & a2Out, struct Eq_n & a5Out, ptr32 & a6Out)
{
	...
	if ((d1_n & 3) == 2 && ((word16) d1_n & 0x0108) != 0x00)
	{
		...
		if (d4_n > 0x00)
		{
			...
			{
				Eq_n d0_n;
				d0_n.u0 = a2_n->t000C.u0;
				if (!__btst<byte>((byte) d0_n, 0x07))
				{
					Eq_n d0_n;
					__bclr<word32>(d0_n, 0x01, out d0_n);
					a2_n->t000C.u0 = (int32) d0_n;
				}
			}
			else
			{
				__bset<word16>(a2_n->t000F.u2, 0x05, out a2_n->t000F.u2);
				d3_n = -1;
			}
		}
	}
...
l00001EDA:
			Eq_n d0_n;
			__bset<word16>(dwArg08->t000C.u0, 0x01, out d0_n);
			dwArg08->t000C.u0 = (int32) d0_n;
			Eq_n d0_n;
...
l00001F1C:
			...
			{
				__bset<word16>(a2_n->t0003.u2, 0x05, out a2_n->t0003.u2);
				struct Eq_n * a7_n = (struct Eq_n *) (a7_n + 1);
				ptr32 d4_n = a7_n->ptr0000;
				ptr32 d5_n = a7_n->ptr0004;
				ptr32 a6_n = a6_n->ptr0000;
...
struct Eq_n * fn00002014(struct Eq_n * a2, struct Eq_n * a5, struct Eq_n * a6, struct Eq_n * dwArg04, ptr32 & a5Out, ptr32 & a6Out)
{
	...
	if (d0_n != 0x00)
	{
		__bset<word16>(a2_n->t000F.u2, 0x03, out a2_n->t000F.u2);
		a2_n->dw0018 = 0x0200;
	}
	else
	{
		__bset<word16>(a2_n->t000F.u2, 0x02, out a2_n->t000F.u2);
