...
void fn000014E8(word32 a5, int32 dwArg02)
{
	...
	else
	{
		...
		if (d0_43 >> 0x01 != 0x00)
		{
			for (; d0_163 != 0x00; d0_163 = d0_163 - 0x01)
			{
				*a0_164 = 0x00;
				a0_164 = a0_164 + 0x01;
			}
		...
		if (d0_52 >> 0x01 != 0x00)
		{
			for (; d0_156 != 0x00; d0_156 = d0_156 - 0x01)
			{
				*a0_157 = 0x00;
				a0_157 = a0_157 + 0x01;
			}
...
void fn000021F0(Eq_1252 * a5)
{
	...
	{
		int32 d1_48 = 0x00;
		for (; d1_48 < 0x03; d1_48 = d1_48 + 0x01)
		{
...
void fn00002264(byte * dwArg04)
{
	if (dwArg04 != null)
	{
		...
		if (v11_39 != 0x00)
		{
			...
			if (d0_46 != 0x00)
			{
				for (; d0_46 != 0x00; d0_46 = d0_46 - 0x01)
				{
					*a2_43 = *a1_51;
					a1_51 = a1_51 + 0x01;
					a2_43 = a2_43 + 0x01;
...
l00002974:
	...
	int32 d0_144 = 0x07;
	for (; d0_144 != ~0x00; d0_144 = d0_144 - 0x01)
	{
		*a0 = 0x00;
