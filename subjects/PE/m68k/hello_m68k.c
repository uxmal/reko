...
void fn00001680(struct Eq_n * a5, word32 dwArg04, struct Eq_n * dwArg08)
{
	if (dwArg04 == 0x00)
	{
		if (!__btst(dwArg08->b000E, 0x04))
		{
			...
			word32 a5_n;
			word32 a6_n;
			fn00001D80(a5, dwArg08, out d3_n, out d4_n, out a2_n, out a5_n, out a6_n, out a7_n);
		}
	}
	else
	{
...
// 00001C40: Register (ptr32 Eq_n) fn00001C40(Register (ptr32 Eq_n) a5, Stack Eq_n bArg04, Stack (ptr32 Eq_n) dwArg08, Register out (ptr32 Eq_n) d4Out, Register out (ptr32 Eq_n) d5Out, Register out (ptr32 Eq_n) a5Out, Register out ptr32 a6Out, Register out ptr32 a7Out)
struct Eq_n * fn00001C40(struct Eq_n * a5, Eq_n bArg04, struct Eq_n * dwArg08, struct Eq_n & d4Out, struct Eq_n & d5Out, struct Eq_n & a5Out, ptr32 & a6Out, ptr32 & a7Out)
{
	...
	if (dwArg08 > 0x00)
	{
		...
		do
		{
			...
			*(a7_n - 0x08) = (byte **) d3_n;
			...
			int32 d5_n;
			word32 a6_n;
			d3_n = fn00001C40(a5, *(a7_n - 0x08), *(a7_n - 0x04), out d4_n, out d5_n, out a5, out a6_n, out a7_n);
			a7_n = a7_n + 0x0C;
		} while (d5_n > 0x00);
	}
}
...
// 00001D24: Register int32 fn00001D24(Register (ptr32 Eq_n) a5, Stack (ptr32 Eq_n) dwArg04, Register out ptr32 d3Out, Register out Eq_n d4Out, Register out (ptr32 Eq_n) d5Out, Register out (ptr32 Eq_n) d6Out, Register out (ptr32 Eq_n) d7Out, Register out (ptr32 Eq_n) a2Out, Register out (ptr32 Eq_n) a5Out, Register out (ptr32 ptr32) a6Out, Register out ptr32 a7Out)
int32 fn00001D24(struct Eq_n * a5, struct Eq_n * dwArg04, ptr32 & d3Out, union Eq_n & d4Out, struct Eq_n & d5Out, struct Eq_n & d6Out, struct Eq_n & d7Out, struct Eq_n & a2Out, struct Eq_n & a5Out, ptr32 & a6Out, ptr32 & a7Out)
{
	if (dwArg04 != null)
	{
		struct Eq_n * a2_n;
		...
		struct Eq_n * a7_n;
		ptr32 d3_n;
		if (fn00001D80(a5, dwArg04, out d3_n, out d4_n, out a2_n, out a5_n, out a6_n, out a7_n) == 0x00)
		{
...
// 00001D80: Register int32 fn00001D80(Register (ptr32 Eq_n) a5, Stack (ptr32 Eq_n) dwArg04, Register out ptr32 d3Out, Register out ptr32 d4Out, Register out ptr32 a2Out, Register out (ptr32 Eq_n) a5Out, Register out ptr32 a6Out, Register out ptr32 a7Out)
int32 fn00001D80(struct Eq_n * a5, struct Eq_n * dwArg04, ptr32 & d3Out, ptr32 & d4Out, ptr32 & a2Out, struct Eq_n & a5Out, ptr32 & a6Out, ptr32 & a7Out)
{
		...
		do
		{
			if (d3_n - d6_n == 0x00 && (a2_n->w000C & 131) != 0x00)
			{
				*(a7_n - 0x04) = (struct Eq_n **) a2_n;
				...
				word32 a7_n;
				word32 d7_n;
				if (fn00001D24(a5, stackArg4, out d3_n, out d4_n, out d5_n, out d6_n, out d7_n, out a2_n, out a5, out a6_n, out a7_n) - d7_n != 0x00)
					d4_n += d6_n;
			}
			else if (d3_n == 0x00 && !__btst(a2_n->dw000F, d6_n))
			{
				*(a7_n - 0x04) = (struct Eq_n **) a2_n;
				...
				word32 a7_n;
				word32 d7_n;
				int32 d0_n = fn00001D24(a5, stackArg4, out d3_n, out d4_n, out d5_n, out d6_n, out d7_n, out a2_n, out a5, out a6_n, out a7_n);
				a7_n = a7_n + 0x04;
				if (d0_n - d7_n == 0x00)
					d5_n = d0_n;
			}
...
l00001EDA:
			...
			if ((dwArg08->ptr000C & 0x010C) == 0x00)
			{
				...
				*a7_n = (struct Eq_n **) a3_n;
				word32 a7_n;
				a2_n = fn00002014(a2_n, a5, a6_n, *a7_n, out a5, out a6_n, out a7_n);
				a7_n = a7_n + 0x04;
			}
l00001F1C:
			int32 d5_n;
	...
	if ((char *) a5 - 2592 - a5->dwFFFFF800 <= 0x00)
	{
		do
		{
			...
			*a7_n = (struct Eq_n **) d4_n;
			...
			up32 d4_n;
			word32 a6_n;
			if (fn00002068(d3_n, a5, *a7_n, out d3_n, out d4_n, out a5, out a6_n, out a7_n) != -0x01)
...
// 00002014: Register (ptr32 Eq_n) fn00002014(Register (ptr32 Eq_n) a2, Register (ptr32 Eq_n) a5, Register (ptr32 Eq_n) a6, Stack (ptr32 Eq_n) dwArg04, Register out ptr32 a5Out, Register out ptr32 a6Out, Register out ptr32 a7Out)
struct Eq_n * fn00002014(struct Eq_n * a2, struct Eq_n * a5, struct Eq_n * a6, struct Eq_n * dwArg04, ptr32 & a5Out, ptr32 & a6Out, ptr32 & a7Out)
{
	++a5->dwFFFFFAA8;
	struct Eq_n * a7_n;
	ptr32 * a6_n;
...
// 00002068: Register int32 fn00002068(Register Eq_n d3, Register (ptr32 Eq_n) a5, Stack (ptr32 Eq_n) dwArg04, Register out Eq_n d3Out, Register out ptr32 d4Out, Register out (ptr32 Eq_n) a5Out, Register out ptr32 a6Out, Register out ptr32 a7Out)
int32 fn00002068(Eq_n d3, struct Eq_n * a5, struct Eq_n * dwArg04, union Eq_n & d3Out, ptr32 & d4Out, struct Eq_n & a5Out, ptr32 & a6Out, ptr32 & a7Out)
{
	...
	if (__btst((byte) d0_n, 0x06))
	{
		if (((word16) d0_n & 131) != 0x00)
		{
			...
			word32 d4_n;
			word32 a6_n;
			word32 d0_n = fn00001D80(a5, dwArg04, out d3_n, out d4_n, out a2_n, out a5_n, out a6_n, out a7_n);
			*a7_n = (struct Eq_n **) a2_n;
			ptr32 a5_n;
			word32 a6_n;
			word32 * a7_n;
			struct Eq_n * a2_n = fn000020F0(a5_n, *a7_n, out a5_n, out a6_n, out a7_n);
			*a7_n = a2_n->dw0010;
			int32 * a7_n;
			int32 d0_n;
			word32 d2_n;
...
// 000020F0: Register word32 fn000020F0(Register ptr32 a5, Stack (ptr32 Eq_n) dwArg04, Register out ptr32 a5Out, Register out ptr32 a6Out, Register out ptr32 a7Out)
word32 fn000020F0(ptr32 a5, struct Eq_n * dwArg04, ptr32 & a5Out, ptr32 & a6Out, ptr32 & a7Out)
{
...
{
	struct Eq_n * a7_n;
	fn000023B4(a5 + -744, a5 + -0x02E4, out a7_n);
	a7_n->t0004 = a5 + -0x02EC;
	a7_n->ptr0000 = a5 + -0x02F0;
	struct Eq_n * a7_n;
	struct Eq_n * a6_n = fn000023B4(a7_n->ptr0000, a7_n->t0004, out a7_n);
	a7_n->w0002 = ~0x5760;
	a7_n->b0001 = 0x01;
	word32 * a7_n;
	word32 a6_n;
...
word32 fn00002354(struct Eq_n * a5, int32 dwArg08, byte bArg0F)
{
	...
	if (dwArg08 == 0x00)
	{
		...
		{
			word32 a7_n;
			fn000023B4(a5->ptrFFFFFD3C, a5->tFFFFFD38, out a7_n);
			a7_n = a7_n + 0x08;
		}
		...
		*(a7_n - 0x04) = (char *) &a5->ptrFFFFFAA0 + 0x0280;
		word32 a7_n;
		fn000023B4(*(a7_n - 0x04), *a7_n, out a7_n);
		a7_n = a7_n + 0x08;
	}
	union Eq_n * a7_n = a7_n - 0x04;
	...
	*(a7_n - 0x04) = (char *) &a5->ptrFFFFFAA0 + 0x028C;
	word32 a7_n;
	struct Eq_n * a6_n = fn000023B4(*(a7_n - 0x04), *a7_n, out a7_n);
	if (a6_n->dw0010 == 0x00)
	{
...
// 000023B4: Register word32 fn000023B4(Stack (ptr32 word32) dwArg04, Stack Eq_n dwArg08, Register out ptr32 a7Out)
...
void fn000023F8(Eq_n a5)
{
	struct Eq_n * a6_n;
	ptr32 a7_n;
	Eq_n a5_n = fn00002418(a5, out a6_n, out a7_n);
...
Eq_n fn00002418(Eq_n a5, ptr32 & a6Out, ptr32 & a7Out)
{
	word32 a6_n;
	word32 a7_n;
	Eq_n a5_n = fn0000243C(a5, 252, out a6_n, out a7_n);
	word32 a7_n = a7_n + 0x04;
	...
	*a7_n = 0xFF;
	ptr32 * a6_n;
	word32 a7_n;
	Eq_n a5_n = fn0000243C(a5_n, *a7_n, out a6_n, out a7_n);
	a6Out = *a6_n;
	a7Out = a6_n + 0x01;
	return a5_n;
}

// 0000243C: Register Eq_n fn0000243C(Register Eq_n a5, Stack ptr32 dwArg04, Register out ptr32 a6Out, Register out ptr32 a7Out)
Eq_n fn0000243C(Eq_n a5, ptr32 dwArg04, ptr32 & a6Out, ptr32 & a7Out)
{
	ptr32 * a6_n = fp - 0x04;
	int32 d1_n = 0x00;
...
word32 fn000024C4(struct Eq_n * a5, Eq_n dwArg04)
{
	...
	do
	{
		...
		*a7_n = d3_n;
		...
		word32 d4_n;
		word32 * a6_n;
		if (fn00002510(a5, *a7_n, out d3_n, out d4_n, out a5_n, out a6_n, out a7_n) != 0x00 || d4_n == 0x00)
			return *a6_n;
		*a7_n = d3_n;
		a7_n = a7_n + 0x04;
		word32 a7_n;
	} while (fn00002644(a5_n, *a7_n, out a5, out a6_n, out a7_n) != 0x00);
	return *a6_n;
}

// 00002510: Register int32 fn00002510(Register (ptr32 Eq_n) a5, Stack up32 dwArg04, Register out ptr32 d3Out, Register out ptr32 d4Out, Register out (ptr32 Eq_n) a5Out, Register out (ptr32 word32) a6Out, Register out (ptr32 up32) a7Out)
int32 fn00002510(struct Eq_n * a5, up32 dwArg04, ptr32 & d3Out, ptr32 & d4Out, struct Eq_n & a5Out, word32 & a6Out, up32 & a7Out)
{
	Eq_n a0_n;
	...
	{
		struct Eq_n * a7_n;
		if (fn000028A0(a0_n, d0_n, a5, dwArg04, out d3_n, out d4, out a5, out a6_n, out a7_n) == -0x01)
		{
			word32 * a6_n = *a6_n;
			d3Out = a7_n->ptr0008;
			d4Out = d4;
...
// 00002644: Register int32 fn00002644(Register (ptr32 Eq_n) a5, Stack up32 dwArg04, Register out (ptr32 Eq_n) a5Out, Register out (ptr32 word32) a6Out, Register out ptr32 a7Out)
int32 fn00002644(struct Eq_n * a5, up32 dwArg04, struct Eq_n & a5Out, word32 & a6Out, ptr32 & a7Out)
{
	word32 ** a6_n = fp - 0x04;
...
// 000028A0: Register int32 fn000028A0(Register Eq_n a0, Register (ptr32 Eq_n) a2, Register (ptr32 Eq_n) a5, Stack up32 dwArg04, Register out ptr32 d3Out, Register out ptr32 d4Out, Register out (ptr32 Eq_n) a5Out, Register out ptr32 a6Out, Register out ptr32 a7Out)
int32 fn000028A0(Eq_n a0, struct Eq_n * a2, struct Eq_n * a5, up32 dwArg04, ptr32 & d3Out, ptr32 & d4Out, struct Eq_n & a5Out, ptr32 & a6Out, ptr32 & a7Out)
{
		...
		do
		{
			if (*((char *) *a5->ptrFFFFFADC + d7_n) != 0x00)
			{
				...
				*(a7_n - 0x04) = d4_n;
				...
				struct Eq_n * a7_n;
				if (fn00002A54(a5, *(a7_n - 0x04), *a7_n, out d3_n, out d4_n, out d5_n, out a2_n, out a5, out a6_n, out a7_n) != -0x01)
				{
					a5->dwFFFFFAF4 = d4_n;
...
l000029B4:
		...
		*(a7_n - 0x04) = d5_n;
		...
		ptr32 * a6_n;
		struct Eq_n * a7_n;
		int32 d0_n = fn000029C8(a0, a5, *(a7_n - 0x04), *a7_n, out a5_n, out a6_n, out a7_n);
		ptr32 d4_n = a7_n->ptr000C;
		ptr32 a6_n = *a6_n;
		d3Out = a7_n->ptr0008;
		d4Out = d4_n;
...
// 000029C8: Register int32 fn000029C8(Register Eq_n a0, Register (ptr32 Eq_n) a5, Stack ui32 dwArg04, Stack up32 dwArg08, Register out (ptr32 Eq_n) a5Out, Register out ptr32 a6Out, Register out ptr32 a7Out)
int32 fn000029C8(Eq_n a0, struct Eq_n * a5, ui32 dwArg04, up32 dwArg08, struct Eq_n & a5Out, ptr32 & a6Out, ptr32 & a7Out)
{
	...
	if (a0 != 0x00)
	{
		...
		word32 d4_n;
		word32 d3_n;
		d0_n = fn00002A54(a5, dwArg04, dwArg08, out d3_n, out d4_n, out d5_n, out a2_n, out a5, out a6_n, out a7_n);
		if (d0_n == 0x00)
		{
l00002A4C:
			ptr32 a6_n = *a6_n;
...
// 00002A54: Register int32 fn00002A54(Register (ptr32 Eq_n) a5, Stack ui32 dwArg04, Stack up32 dwArg08, Register out ptr32 d3Out, Register out Eq_n d4Out, Register out Eq_n d5Out, Register out ptr32 a2Out, Register out (ptr32 Eq_n) a5Out, Register out (ptr32 word32) a6Out, Register out ptr32 a7Out)
int32 fn00002A54(struct Eq_n * a5, ui32 dwArg04, up32 dwArg08, ptr32 & d3Out, union Eq_n & d4Out, union Eq_n & d5Out, ptr32 & a2Out, struct Eq_n & a5Out, word32 & a6Out, ptr32 & a7Out)
{
