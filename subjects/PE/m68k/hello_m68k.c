...
// 00001C40: void fn00001C40(Register (ptr32 Eq_455) a5, Stack int32 dwArg04, Stack byte bArg07, Stack (ptr32 Eq_458) dwArg08, Stack (ptr32 int32) dwArg0C)
void fn00001C40(Eq_455 * a5, int32 dwArg04, byte bArg07, Eq_458 * dwArg08, int32 * dwArg0C)
{
	int32 d0_17;
...
// 00001C84: void fn00001C84(Register (ptr32 Eq_455) a5, Stack int32 dwArg04, Stack word32 dwArg08, Stack (ptr32 Eq_458) dwArg0C, Stack (ptr32 int32) dwArg10)
void fn00001C84(Eq_455 * a5, int32 dwArg04, word32 dwArg08, Eq_458 * dwArg0C, int32 * dwArg10)
{
	Eq_520 VZN_28 = DPB(VZN, false, 0);
	if (!VZN_28)
	{
		do
		{
...
// 00001CC4: void fn00001CC4(Register (ptr32 Eq_455) a5, Stack (ptr32 byte) dwArg04, Stack word32 dwArg08, Stack (ptr32 Eq_458) dwArg0C, Stack (ptr32 int32) dwArg10)
void fn00001CC4(Eq_455 * a5, byte * dwArg04, word32 dwArg08, Eq_458 * dwArg0C, int32 * dwArg10)
{
	Eq_535 VZN_28 = DPB(VZN, false, 0);
	if (!VZN_28)
	{
		byte * d3_58 = dwArg04;
		do
...
// 00001D24: Register int32 fn00001D24(Register (ptr32 Eq_562) a5, Stack (ptr32 Eq_318) dwArg04)
int32 fn00001D24(Eq_562 * a5, Eq_318 * dwArg04)
{
	if (dwArg04 == null)
...
{
	struct Eq_603 * d1_20 = dwArg04->dw000C;
	int32 d3_117 = 0x00;
	...
	if (0x02 - (d1_20 & 0x03) == 0x00 && ((word16) d1_20 & 0x0108) != 0x00)
	{
		...
		if (d4_74 > 0x00)
		{
			...
			if (d0_95 - d4_91 == 0x00)
			{
				struct Eq_603 * d0_108 = a2_18->dw000C;
				if (!__btst((byte) d0_108, 0x07))
				{
					struct Eq_603 * d0_111;
...
// 00001DF4: void fn00001DF4(Register (ptr32 Eq_562) a5)
void fn00001DF4(Eq_562 * a5)
{
	fn00001E04(a5, 0x01);
}

// 00001E04: Register int32 fn00001E04(Register (ptr32 Eq_562) a5, Stack int32 dwArg04)
int32 fn00001E04(Eq_562 * a5, int32 dwArg04)
{
...
// 00001E94: Register int32 fn00001E94(Register (ptr32 Eq_455) a5, Stack int32 dwArg04, Stack byte bArg07, Stack (ptr32 Eq_458) dwArg08)
int32 fn00001E94(Eq_455 * a5, int32 dwArg04, byte bArg07, Eq_458 * dwArg08)
{
	struct Eq_603 * d0_27 = dwArg08->ptr000C;
	struct Eq_458 * a3_122 = dwArg08;
	int32 d3_118 = dwArg08->dw0010;
	struct Eq_767 * a2_121 = &dwArg08->ptr000C;
...
l00001EDA:
			...
			dwArg08->dw0004 = 0x00;
			struct Eq_603 * d0_103 = dwArg08->ptr000C;
...
l00001F1C:
			...
			if (((word16) a2_121->dw0000 & 0x0108) != 0x00)
			{
				...
				Eq_938 VZN_204 = DPB(VZN, false, 0);
				if (!VZN_204)
				{
					word32 a7_216;
					word32 a6_217;
					struct Eq_953 * a3_218;
					word32 d4_221;
					word32 d3_222;
					byte CVZN_223;
					int32 d0_224;
...
// 00001FD8: void fn00001FD8(Register (ptr32 Eq_1014) a5)
void fn00001FD8(Eq_1014 * a5)
{
...
// 00002014: void fn00002014(Register ui32 d0, Register (ptr32 Eq_455) a5, Stack (ptr32 Eq_458) dwArg04)
void fn00002014(ui32 d0, Eq_455 * a5, Eq_458 * dwArg04)
{
	++a5->dwFFFFFAA8;
	word32 a7_20;
	word32 a6_21;
	struct Eq_1051 * a2_22;
	byte CVZN_23;
	word32 a5_24;
	byte CVZNX_25;
	ptr32 d0_26;
...
int32 fn00002068(Eq_318 * dwArg04, ptr32 & d3Out)
{
	...
	if (__btst((byte) d0_19, 0x06))
	{
		if (((word16) d0_19 & 131) != 0x00)
		{
			...
			word32 d2_115;
			(a5 + 0x00A2)();
			Eq_1154 VN_120 = DPB(VN_114, false, 0);
			if (!VN_120)
				d3_105 = -0x01;
			else
			{
...
// 000021F0: void fn000021F0(Register (ptr32 Eq_1248) a5)
void fn000021F0(Eq_1248 * a5)
{
	struct Eq_1249 * d0_19 = a5->ptrFFFFFAA0->ptr001C;
	struct Eq_1249 * a1_22 = d0_19;
	if (d0_19 != null)
	{
		int32 d1_48;
		for (d1_48 = 0x00; d1_48 < 0x03; ++d1_48)
		{
			...
			if (d0_55 != 0x45434F4E)
			{
				if (d0_55 == 0x46535953)
				{
					...
					struct Eq_1285 * a0_74 = *a1_22->ptr0008;
					struct Eq_1292 * a0_76 = DPB(a0_74, a0_74->w0002, 0);
					a0_76[d1_48 * 0x04] = (struct Eq_1292) a0_76;
				}
			}
			else
			{
				a5->aFFFFF958[d1_48] |= 0x41;
				a1_22[d1_48 * 0x04 / 0x0014] = (struct Eq_1249) a1_22;
			}
			++a1_22;
		}
	}
...
// 00002294: void fn00002294(Register (ptr32 Eq_1349) a5, Stack word32 dwArg04)
void fn00002294(Eq_1349 * a5, word32 dwArg04)
{
...
// 00002354: void fn00002354(Register (ptr32 Eq_1349) a5, Stack word32 dwArg04, Stack int32 dwArg08, Stack int32 dwArg0C, Stack byte bArg0F)
void fn00002354(Eq_1349 * a5, word32 dwArg04, int32 dwArg08, int32 dwArg0C, byte bArg0F)
{
	a5->bFFFFFA9C = bArg0F;
	if (dwArg08 == 0x00)
	{
...
// 000023B4: Register (ptr32 word32) fn000023B4(Stack (ptr32 word32) dwArg04, Stack Eq_1366 dwArg08)
word32 * fn000023B4(word32 * dwArg04, Eq_1366 dwArg08)
{
	Eq_1366 d4_18 = dwArg08;
...
// 000023F8: void fn000023F8(Register Eq_1508 a5, Stack ptr32 dwArg04)
void fn000023F8(Eq_1508 a5, ptr32 dwArg04)
{
	fn00002418(a5);
...
// 00002418: void fn00002418(Register Eq_1508 a5)
void fn00002418(Eq_1508 a5)
{
	fn0000243C(a5, 252);
...
// 0000243C: void fn0000243C(Register Eq_1508 a5, Stack ptr32 dwArg04)
void fn0000243C(Eq_1508 a5, ptr32 dwArg04)
{
	int32 d1_104 = 0x00;
	struct Eq_1548 * d2_103 = (word32) a5 - 0x044C;
...
// 000024B0: void fn000024B0(Register (ptr32 Eq_1606) a5, Stack Eq_1607 dwArg04)
void fn000024B0(Eq_1606 * a5, Eq_1607 dwArg04)
{
	fn000024C4(a5, fp - 0x04, dwArg04, a5->dwFFFFFAC4);
}

// 000024C4: void fn000024C4(Register (ptr32 Eq_1606) a5, Register ptr32 a6, Stack Eq_1607 dwArg04, Stack word32 dwArg08)
void fn000024C4(Eq_1606 * a5, ptr32 a6, Eq_1607 dwArg04, word32 dwArg08)
{
	if (-0x0020 - dwArg04 < 0x00)
		return;
	Eq_1625 d3_49 = DPB((word32) dwArg04 + 0x03, (word16) ((word32) dwArg04 + 0x03) & ~0x03, 0);
	do
	{
		*(fp - 0x10) = (union Eq_1625 *) d3_49;
		word32 d4_60;
...
// 00002510: Register int32 fn00002510(Register (ptr32 Eq_1606) a5, Register ptr32 a6, Stack (ptr32 Eq_1645) dwArg04, Register out ptr32 d4Out)
int32 fn00002510(Eq_1606 * a5, ptr32 a6, Eq_1645 * dwArg04, ptr32 & d4Out)
{
	*d4Out = d4;
	Eq_1669 a0_22;
	struct Eq_1670 * d0_23 = fn000027B0(a5, dwArg04, out a0_22);
	struct Eq_1670 * a2_139 = d0_23;
	if (d0_23 == null)
	{
		if (-0x01 - fn000028A0(a0_22, a5, fp - 0x04, dwArg04) == 0x00)
			return 0x00;
		*(fp - 0x10) = (struct Eq_1645 **) dwArg04;
		word32 a0_132;
		struct Eq_1670 * d0_133 = fn000027B0(a5, dwArg00, out a0_132);
		a2_139 = d0_133;
		if (d0_133 == null)
			fn000027A0();
	}
	struct Eq_603 * d0_55 = a2_139->ptr0000->ptr0004;
	word32 d1_58 = a2_139->dw0004;
	if (0x04 - ((DPB(d0_55, (word16) d0_55 & ~0x03, 0) - DPB(d1_58, (word16) d1_58 & ~0x03, 0)) - dwArg04) != 0x00)
	{
		*(fp - 0x10) = (struct Eq_1645 **) dwArg04;
		*(fp - 0x14) = (struct Eq_1670 **) a2_139;
		struct Eq_1774 * d0_103 = fn000025B4(a5, dwArg00, dwArg04);
		if (d0_103 != null)
		{
			struct Eq_603 * d0_111;
			__bclr(d0_103->ptr0004, 0x01, out d0_111);
			struct Eq_603 * d0_113;
...
// 000025B4: Register (ptr32 Eq_1684) fn000025B4(Register (ptr32 Eq_1606) a5, Stack (ptr32 Eq_1645) dwArg04, Stack (ptr32 Eq_1645) dwArg08)
Eq_1684 * fn000025B4(Eq_1606 * a5, Eq_1645 * dwArg04, Eq_1645 * dwArg08)
{
	struct Eq_1684 * a0_14 = dwArg04->ptr0000;
	struct Eq_603 * d0_15 = a0_14->ptr0004;
	word32 d1_18 = dwArg04->dw0004;
	if (DPB(d0_15, (word16) d0_15 & ~0x03, 0) - DPB(d1_18, (word16) d1_18 & ~0x03, 0) - 0x04 - dwArg08 <= 0x00)
		return null;
	word32 a0_58;
	struct Eq_1684 * d0_59 = fn0000273C(a0_14, a5, out a0_58);
	if (d0_59 == null)
		return null;
	word32 d0_65 = dwArg04->dw0004;
	struct Eq_1842 * d0_68 = dwArg08 + DPB(d0_65, (word16) d0_65 & ~0x03, 0) / 0x08;
	d0_59->ptr0004 = (struct Eq_603 *) &d0_68->ptr0004;
	d0_68->ptr0004 = d0_59;
...
// 00002610: void fn00002610(Register (ptr32 Eq_1864) a5, Stack word32 dwArg04)
void fn00002610(Eq_1864 * a5, word32 dwArg04)
{
	a5->dwFFFFFD34 = dwArg04;
}

// 00002644: Register int32 fn00002644(Register (ptr32 Eq_1606) a5, Stack (ptr32 Eq_1645) dwArg04)
int32 fn00002644(Eq_1606 * a5, Eq_1645 * dwArg04)
{
...
// 0000273C: Register (ptr32 Eq_1684) fn0000273C(Register (ptr32 Eq_1684) a0, Register (ptr32 Eq_1606) a5, Register out ptr32 a0Out)
Eq_1684 * fn0000273C(Eq_1684 * a0, Eq_1606 * a5, ptr32 & a0Out)
{
	struct Eq_1684 * d0_17;
...
// 0000275C: Register int32 fn0000275C(Register (ptr32 Eq_1684) a0, Register (ptr32 Eq_1606) a5, Register out ptr32 a0Out)
int32 fn0000275C(Eq_1684 * a0, Eq_1606 * a5, ptr32 & a0Out)
{
	*a0Out = a0;
	__syscall(0xA11E);
	if (a0 == null)
		return 0x00;
	a5->ptrFFFFFAD0 = a0;
	struct Eq_1684 * d0_32 = a0;
	struct Eq_1684 * d1_38 = (char *) &a0->ptr0004 + 0x04;
	if (&a0->dw0FF8 - a0 > 0x00)
	{
		do
		{
			d0_32->ptr0000 = d1_66;
			d0_32 = d1_66;
			d1_38 = (struct Eq_1684 *) ((char *) &d1_66->ptr0004 + 0x04);
			struct Eq_1684 * d1_66 = d1_38;
...
// 000027B0: Register (ptr32 Eq_1684) fn000027B0(Register (ptr32 Eq_1606) a5, Stack (ptr32 Eq_1645) dwArg04, Register out ptr32 a0Out)
Eq_1684 * fn000027B0(Eq_1606 * a5, Eq_1645 * dwArg04, ptr32 & a0Out)
{
	*a0Out = a0;
	struct Eq_1684 * a2_111 = a5->ptrFFFFFACC;
	struct Eq_1684 * a1_33 = null;
	if ((char *) &a5->ptrFFFFFAD0 + 0x04 - a2_111 != 0x00)
	{
		do
		{
			...
			if ((*a4_210 & 0x03) == 0x01)
			{
				while (true)
				{
					struct Eq_1684 * a0_227 = a2_111->ptr0000;
					*a0Out = a0_227;
					struct Eq_603 * d0_228 = a0_227->ptr0004;
					ui32 d3_232 = *a4_210;
...
l0000280C:
	...
	do
	{
		...
		if ((*a3_121 & 0x03) == 0x01)
		{
			do
			{
				struct Eq_1684 * a0_156 = a2_111->ptr0000;
				*a0Out = a0_156;
				struct Eq_603 * d3_157 = a0_156->ptr0004;
				ui32 d1_161 = *a3_121;
			...
			struct Eq_1684 * a0_185 = a2_111->ptr0000;
			*a0Out = a0_185;
			struct Eq_603 * d0_186 = a0_185->ptr0004;
			ui32 d1_189 = *a3_121;
...
// 000028A0: Register int32 fn000028A0(Register Eq_1669 a0, Register (ptr32 Eq_1606) a5, Register ptr32 a6, Stack (ptr32 Eq_1645) dwArg04)
int32 fn000028A0(Eq_1669 a0, Eq_1606 * a5, ptr32 a6, Eq_1645 * dwArg04)
{
...
l00002974:
	...
	{
		*a0 = 0x00;
		struct Eq_2321 * a0_150 = (word32) a0 + 0x04;
		a0_150->dw0000 = 0x00;
		a0_150->dw0004 = 0x00;
		a0_150->dw0008 = 0x00;
		a0_150->dw000C = 0x00;
...
// 000029C8: Register int32 fn000029C8(Register Eq_1669 a0, Register (ptr32 Eq_1606) a5, Register ptr32 a6, Stack ui32 dwArg04, Stack (ptr32 Eq_1645) dwArg08)
int32 fn000029C8(Eq_1669 a0, Eq_1606 * a5, ptr32 a6, ui32 dwArg04, Eq_1645 * dwArg08)
{
	word32 d4_18 = a5->dwFFFFFAEC;
	struct Eq_1645 * d4_136 = DPB(d4_18 + 0x0FFF, (word16) (d4_18 + 0x0FFF) & 0xF000, 0);
	...
	if (a0 != 0x00)
	{
		...
		struct Eq_2451 * a1_89 = a1_77 + (dwArg04 << 0x04);
		a1_89->t000C = a0;
...
// 00002A54: Register int32 fn00002A54(Register (ptr32 Eq_1606) a5, Stack ui32 dwArg04, Stack (ptr32 Eq_1645) dwArg08)
int32 fn00002A54(Eq_1606 * a5, ui32 dwArg04, Eq_1645 * dwArg08)
{
	struct Eq_2484 * a2_101 = (word32) *a5->tFFFFFADC + (dwArg04 << 0x04);
	...
	struct Eq_603 * a1_125 = a2_101->dw0000 + d1_28;
	if (d3_39 - d0_30 > 0x00)
	{
		__syscall(0xA020);
...
// 00002AE0: void fn00002AE0(Register (arr Eq_3169) a2, Register (ptr32 Eq_1606) a5, Stack ui32 dwArg04)
void fn00002AE0(Eq_3169 a2[], Eq_1606 * a5, ui32 dwArg04)
{
...
// 00002B18: void fn00002B18(Register (ptr32 Eq_2608) a5, Stack Eq_2609 dwArg04)
void fn00002B18(Eq_2608 * a5, Eq_2609 dwArg04)
{
	if (dwArg04 != 0x00)
	{
		struct Eq_2612 * a2_37 = *(dwArg04 - 0x04);
		struct Eq_603 * d1_38 = a2_37->ptr0004;
...
// 00002BB4: Register int32 fn00002BB4(Register (ptr32 Eq_1606) a5, Stack (ptr32 Eq_603) dwArg04, Stack up32 dwArg08)
int32 fn00002BB4(Eq_1606 * a5, Eq_603 * dwArg04, up32 dwArg08)
{
	struct Eq_1684 *** dwLoc1C_103 = fp + ~0x17;
	struct Eq_1684 * a0_29;
	struct Eq_1684 * d0_30 = fn0000273C(fp + ~0x17, a5, out a0_29);
	if (d0_30 != null)
	{
		struct Eq_1684 * a0_119;
		if (fn0000273C(a0_29, a5, out a0_119) == null)
			goto l00002DE8;
		word32 a0_125;
		if (fn0000273C(a0_119, a5, out a0_125) != null)
		{
			struct Eq_1684 * a3_147;
			Eq_2722 d0_139 = fn00002EA8(a5, dwArg04, fp + ~0x07);
			if (d0_139 == 0x00)
			{
			...
			struct Eq_603 * d1_151;
			__bclr(dwArg04, 0x01, out d1_151);
			struct Eq_603 * d1_153;
			...
			if (0x02 - (dwLoc08->ptr0004 & 0x03) == 0x00)
			{
				...
				{
					struct Eq_603 * d0_277 = a3_147->ptr0004;
				...
				struct Eq_603 * d0_223 = dwLoc08->ptr0000->ptr0004;
				struct Eq_603 * d1_227 = dwLoc08->ptr0004;
				up32 d0_230 = DPB(d0_223, (word16) d0_223 & ~0x03, 0) - DPB(d1_227, (word16) d1_227 & ~0x03, 0);
				fn00002E18(dwLoc08, d0_230, a3_147, fp + ~0x1B);
				struct Eq_603 * d0_241 = a5->ptrFFFFFACC->ptr0004;
				if (DPB(d0_241, (word16) d0_241 & ~0x03, 0) - dwArg04 > 0x00)
				{
					struct Eq_603 * d0_262 = a3_147->ptr0000->ptr0004;
					struct Eq_603 * d1_265 = a3_147->ptr0004;
...
l00002DE8:
	if (*dwLoc1C_103 != 0x00)
	{
		do
		{
			**dwLoc1C_103 = (struct Eq_1684 ***) a5->ptrFFFFFAD0;
			a5->ptrFFFFFAD0 = (struct Eq_1684 *) *dwLoc1C_103;
			struct Eq_1684 *** v30_111 = (char *) dwLoc1C_103 + 0x04;
			dwLoc1C_103 = v30_111;
		} while (*v30_111 != 0x00);
	}
	return -0x01;
...
// 00002E18: void fn00002E18(Stack (ptr32 Eq_1684) dwArg04, Stack up32 dwArg08, Stack (ptr32 Eq_1684) dwArg0C, Stack (ptr32 (ptr32 (ptr32 Eq_1684))) dwArg10)
void fn00002E18(Eq_1684 * dwArg04, up32 dwArg08, Eq_1684 * dwArg0C, Eq_1684 * * * dwArg10)
{
	struct Eq_603 * d2_18 = dwArg04->ptr0004;
	struct Eq_1684 * a2_121 = dwArg04;
	if (0x02 - (d2_18 & 0x03) != 0x00)
	{
		struct Eq_603 * d1_63 = dwArg0C->ptr0004;
		if ((d1_63 & 0x03) == 0x02)
		{
			struct Eq_603 * d2_72 = DPB(d2_18, (word16) d2_18 & ~0x03, 0) + dwArg08 / 0x04;
		...
		struct Eq_603 * d2_95 = DPB(d2_18, (word16) d2_18 & ~0x03, 0) + dwArg08 / 0x04;
		if (DPB(d1_63, (word16) d1_63 & ~0x03, 0) - d2_95 != 0x00)
		{
			struct Eq_1684 ** a0_104 = *dwArg10;
			struct Eq_1684 * v33_105 = *a0_104;
			*dwArg10 = (struct Eq_1684 ***) ((char *) a0_104 + 0x04);
			v33_105->ptr0004 = d2_95;
			struct Eq_603 * d2_112;
			__bclr(d2_95, 0x00, out d2_112);
			struct Eq_603 * d2_114;
...
// 00002EA8: Register int32 fn00002EA8(Register (ptr32 Eq_1606) a5, Stack (ptr32 Eq_603) dwArg04, Stack (ptr32 (ptr32 Eq_1684)) dwArg08)
int32 fn00002EA8(Eq_1606 * a5, Eq_603 * dwArg04, Eq_1684 * * dwArg08)
{
	if ((char *) &a5->ptrFFFFFAD0 + 0x04 - a5->ptrFFFFFAC8 == 0x00)
		return -0x03;
	struct Eq_603 * d0_35 = a5->ptrFFFFFAC8->ptr0004;
	if (DPB(d0_35, (word16) d0_35 & ~0x03, 0) - dwArg04 > 0x00)
		return -0x01;
	uint32 d0_48 = a5->dwFFFFFAD8;
	if (DPB(d0_48, (word16) d0_48 & ~0x03, 0) - dwArg04 <= 0x00)
		return -0x02;
	struct Eq_1684 * a1_61 = a5->ptrFFFFFAC8;
	while (true)
	{
		struct Eq_1684 * a0_63 = a1_61->ptr0000;
		struct Eq_603 * d1_64 = a0_63->ptr0004;
		if (DPB(d1_64, (word16) d1_64 & ~0x03, 0) - dwArg04 > 0x00)
			break;
		a1_61 = a0_63;
	}
	*dwArg08 = (struct Eq_1684 **) a1_61;
	struct Eq_603 * d1_76 = a1_61->ptr0004;
	int32 d0_75 = 0x00;
...
// 00003340: void fn00003340(Register (ptr32 Eq_3104) a5, Stack word16 wArg06)
void fn00003340(Eq_3104 * a5, word16 wArg06)
{
	a5->dwFFFFF940 = (int32) wArg06;
	int32 d2_19 = 0x00;
	struct Eq_3112 * d0_21 = &a5->dwFFFFF940 + 111;
	do
	{
