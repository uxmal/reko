...
Eq_4: (union "Eq_4" (int32 u0) (UINT u1))
	...
	T_10 (in uType : UINT)
	T_14 (in 0<32> : word32)
	T_15 (in MessageBoxA(null, &globals->t403000, &globals->t403007, 0<32>) : int32)
...
Eq_8: LPCSTR
	...
	T_12 (in 0x403000<32> : word32)
	T_13 (in 0x403007<32> : word32)
// Type Variables ////////////
globals_t: (in globals : (ptr32 (struct "Globals")))
  Class: Eq_1
  DataType: (ptr32 Eq_1)
...
T_16: (in ExitProcess(MessageBoxA(null, &globals->t403000, &globals->t403007, 0<32>)) : void)
  Class: Eq_16
  DataType: void
  OrigDataType: void
*/
