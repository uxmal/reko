...
// 10001388: Register word32 fn10001388(Register Eq_397 ecx, Register Eq_198 edx, Register (ptr32 Eq_173) ebx, Register ptr32 esi, Register word32 edi)
word32 fn10001388(LPVOID ecx, DWORD edx,  * ebx, ptr32 esi, word32 edi)
{
	struct Eq_402 * ebp_10 = fn100017E8(ebx, esi, edi, dwLoc0C, 0x100021E8, 0x10);
	Eq_415 ebx_16 = ebp_10->t0008;
	*(ebp_10 - 0x1C) = 0x01;
	*(ebp_10 - 0x04) = 0x00;
...
// 1000149E: Register Eq_734 DllMain(Stack Eq_735 hModule, Stack Eq_198 dwReason, Stack Eq_397 lpReserved)
...
// 100015CF: Register Eq_415 fn100015CF(Register (ptr32 Eq_173) ebx, Register ptr32 esi, Register word32 edi)
_onexit_t fn100015CF( * ebx, ptr32 esi, word32 edi)
{
	Eq_415 eax_132;
	struct Eq_402 * ebp_10 = fn100017E8(ebx, esi, edi, dwLoc0C, 0x10002210, 0x14);
	...
	*(ebp_10 - 0x1C) = eax_16;
	...
	else
	{
		...
		*(ebp_64 - 0x20) = _decode_pointer(globals->ptr100033B0);
		Eq_415 eax_96 = __dllonexit(ebp_64->t0008, ebp_64 - 0x1C, ebp_64 - 0x20);
...
// 1000166E: void fn1000166E(Register (ptr32 Eq_173) ebx, Register ptr32 esi, Register word32 edi, Stack word32 dwArg04)
...
// 100016D0: Register word32 fn100016D0(Stack (ptr32 Eq_924) dwArg04)
word32 fn100016D0(Eq_924 * dwArg04)
{
	if (dwArg04->w0000 != 23117)
		return 0x00;
	struct Eq_930 * eax_21 = dwArg04 + dwArg04->dw003C / 0x0040;
	if (eax_21->dw0000 != 0x4550)
		return 0x00;
	return (word32) (eax_21->w0018 == 0x010B);
}

// 10001700: Register (ptr32 Eq_947) fn10001700(Stack (ptr32 Eq_948) dwArg04, Stack uint32 dwArg08)
Eq_947 * fn10001700(Eq_948 * dwArg04, uint32 dwArg08)
{
	struct Eq_950 * ecx_6 = dwArg04 + dwArg04->dw003C / 0x0040;
	up32 esi_14 = (word32) ecx_6->w0006;
	up32 edx_15 = 0x00;
	struct Eq_947 * eax_23 = ecx_6 + ((word32) ecx_6->w0014 + 0x18) / 22;
	if (!DPB(CZ, false, 0))
	{
		do
		{
...
// 10001742: Register ui32 fn10001742(Register (ptr32 Eq_173) ebx, Register ptr32 esi, Register word32 edi, Register out ptr32 ediOut)
ui32 fn10001742( * ebx, ptr32 esi, word32 edi, ptr32 & ediOut)
{
	ui32 eax_33;
	struct Eq_402 * ebp_10 = fn100017E8(ebx, esi, edi, dwLoc0C, 0x10002230, 0x08);
	*(ebp_10 - 0x04) &= 0x00;
	Eq_489 dwLoc0C_18 = 0x10000000;
	if (fn100016D0(&globals->t10000000) != 0x00)
	{
		Eq_415 eax_50 = ebp_10->t0008;
...
// 100017C6: Register word32 fn100017C6(Stack Eq_490 dwArg04, Stack word32 dwArg08)
...
// 100017E8: Register ptr32 fn100017E8(Register (ptr32 Eq_173) ebx, Register ptr32 esi, Register word32 edi, Stack word32 dwArg00, Stack word32 dwArg04, Stack ui32 dwArg08)
...
// 1000182D: Register word32 fn1000182D(Register (ptr32 Eq_402) ebp, Stack Eq_489 dwArg00, Stack Eq_490 dwArg04, Stack word32 dwArg08, Stack word32 dwArg0C, Stack word32 dwArg10)
word32 fn1000182D(Eq_402 * ebp, Eq_489 dwArg00, HMODULE dwArg04, word32 dwArg08, word32 dwArg0C, word32 dwArg10)
{
	fs->dw0000 = *(ebp - 0x10);
	ebp->t0000 = dwArg00;
	return dwArg08;
