...
// 100011E9: Register word32 fn100011E9(Stack Eq_n dwArg04, Stack Eq_n dwArg08, Stack Eq_n dwArg0C, Register out (ptr32 word32) ecxOut, Register out ptr32 edxOut, Register out ptr32 ebxOut, Register out ptr32 esiOut, Register out ptr32 ediOut)
// Called from:
//      fn10001388
word32 fn100011E9(Eq_n dwArg04, Eq_n dwArg08, Eq_n dwArg0C, word32 & ecxOut, ptr32 & edxOut, ptr32 & ebxOut, ptr32 & esiOut, ptr32 & ediOut)
{
	word32 eax_n;
	Eq_n ebp_n = 0x00;
	if (dwArg08 == 0x00)
	...
	if (dwArg08 == 0x01)
	{
		...
		ecx = &g_dw100020A8;
		esp_n = fp - 16;
		if (_initterm_e(&g_t100020A0, &g_dw100020A8) != 0x00)
		{
			eax_n = 0x00;
l10001381:
