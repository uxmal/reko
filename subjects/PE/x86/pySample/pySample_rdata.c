...
<<<<<<< HEAD:subjects/PE/x86/pySample/pySample.globals.c
...
>>>>>>> Feature: write global objects in files determined by the relevant OutputPolicy.:subjects/PE/x86/pySample/pySample_rdata.c
