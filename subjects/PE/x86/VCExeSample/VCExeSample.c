...
// 004010B0: void indirect_call_test3(Stack (ptr32 Eq_45) c)
...
// 00401120: void test6(Stack Eq_55 c, Stack int32 a, Stack int32 b)
void test6(Eq_55 c, int32 a, int32 b)
{
...
void const_div_test10(word32 dwArg04)
{
	...
	globals->dw40301C = ecx_20;
	globals->dw403020 = eax_18;
}
...
{
	int32 dwLoc08_100;
	for (dwLoc08_100 = 0x05; dwLoc08_100 > 0x00; --dwLoc08_100)
	{
		ui32 eax_19 = dwLoc08_100 & 0x80000001;
		if ((dwLoc08_100 & 0x80000001) < 0x00)
			eax_19 = ((dwLoc08_100 & 0x80000001) - 0x01 | ~0x01) + 0x01;
		if (eax_19 == 0x00)
...
// 00401330: void nested_structs_test12(Stack (ptr32 Eq_232) dwArg04)
...
// 00401360: void nested_structs_test13(Stack (ptr32 Eq_232) str)
