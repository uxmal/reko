...
{
	word24 ebx_n_n_n = SLICE(ebx, word24, 8);
	fn00401663();
...
l00401177:
	...
	*(ebp_n - 0x24) = (byte) (uint32) (uint8) fn0040143F(out edx_n);
	...
	word32 ebx_n = SEQ(ebx_n_n_n, 0x00);
	if (eax_n != 0x01)
	{
		Eq_n eax_n;
		struct Eq_n * esp_n;
...
byte fn0040188F()
{
	...
	word24 eax_n_n_n = SLICE(eax_n, word24, 8);
	if (eax_n->dw0000 != 0x4550 || (eax_n->w0018 != 0x010B || eax_n->dw0074 <= 0x0E))
		return 0x00;
	return (byte) SEQ(eax_n_n_n, eax_n->dw00E8 != 0x00);
}
