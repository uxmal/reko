...
l00401177:
	...
	ebp_n->tFFFFFFDC.u0 = (byte) fn0040143F();
...
// 00401544: Register byte fn00401544(Register word32 ebx, Register Eq_n esi, Register Eq_n edi, Register out word32 edxOut, Register out word32 ebxOut, Register out (ptr32 Eq_n) ebpOut, Register out word32 esiOut, Register out word32 ediOut)
// Called from:
//      Win32CrtStartup
//      fn004014AD
byte fn00401544(word32 ebx, Eq_n esi, Eq_n edi, word32 & edxOut, word32 & ebxOut, struct Eq_n & ebpOut, word32 & esiOut, word32 & ediOut)
{
	word32 edi_n;
	word32 esi_n;
	struct Eq_n * ebp_n;
...
ui32 fn00401613(ui32 dwArg04)
{
	...
	return (word32) (eax_n != 0x00) - 1 & dwArg04;
}
...
void fn00401663()
{
	...
	else
	{
		...
		g_t403004.u0 = (ui32) ecx_n;
		g_t403000.u0 = (ui32) ~ecx_n;
	}
}
...
LONG g_t4018DF(struct _EXCEPTION_POINTERS * ExceptionInfo) = ??/* Unexpected function type (fn LONG ((ptr32 (struct "_EXCEPTION_POINTERS" 0008)))) */ ; // 004018DF
