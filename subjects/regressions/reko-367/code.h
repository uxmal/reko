...
T_59: (in CONVERT(fn8000018E((real96) dwLoc20_119), real96, real80) @ 80000262 : real80)
  ...
  DataType: real80
  OrigDataType: real80
T_60: (in fn80000132(rArg04, (real96) dwLoc20_119) /96 (real80) fn8000018E((real96) dwLoc20_119) @ 00000000 : real96)
  Class: Eq_60
  DataType: real96
  OrigDataType: real96
T_61: (in fn80000132(rArg04, (real96) dwLoc20_119) /96 (real80) fn8000018E((real96) dwLoc20_119) * rLoc1C_114 @ 00000000 : real96)
  Class: Eq_44
  DataType: real96
  OrigDataType: real96
...
T_63: (in CONVERT(fp0_81, real96, real80) @ 8000026E : real80)
  ...
  DataType: real80
  OrigDataType: real80
T_64: (in rLoc10_115 + (real80) fp0_81 @ 00000000 : real96)
  Class: Eq_6
  DataType: real96
  OrigDataType: real96
T_65: (in 2<32> @ 80000284 : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_66: (in dwLoc20_119 + 2<32> @ 00000000 : word32)
  Class: Eq_47
  DataType: int32
  OrigDataType: int32
...
T_71: (in 100<i32> @ 80000222 : int32)
  ...
  DataType: int32
  OrigDataType: int32
T_72: (in dwLoc20_119 > 100<i32> @ 00000000 : bool)
  Class: Eq_72
  DataType: bool
  OrigDataType: bool
...
T_90: (in CONVERT(fn8000018E((real96) dwLoc20_118), real96, real80) @ 80000320 : real80)
  ...
  DataType: real80
  OrigDataType: real80
T_91: (in fn80000132(rArg04, (real96) dwLoc20_118) /96 (real80) fn8000018E((real96) dwLoc20_118) @ 00000000 : real96)
  Class: Eq_91
  DataType: real96
  OrigDataType: real96
T_92: (in fn80000132(rArg04, (real96) dwLoc20_118) /96 (real80) fn8000018E((real96) dwLoc20_118) * rLoc1C_113 @ 00000000 : real96)
  Class: Eq_78
  DataType: real96
  OrigDataType: real96
...
T_94: (in CONVERT(fp0_81, real96, real80) @ 8000032C : real80)
  ...
  DataType: real80
  OrigDataType: real80
T_95: (in rLoc10_114 + (real80) fp0_81 @ 00000000 : real96)
  Class: Eq_73
  DataType: real96
  OrigDataType: real96
T_96: (in 2<32> @ 80000342 : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_97: (in dwLoc20_118 + 2<32> @ 00000000 : word32)
  Class: Eq_81
  DataType: int32
  OrigDataType: int32
...
T_102: (in 100<i32> @ 800002E0 : int32)
  ...
  DataType: int32
  OrigDataType: int32
T_103: (in dwLoc20_118 > 100<i32> @ 00000000 : bool)
  Class: Eq_103
  DataType: bool
  OrigDataType: bool
