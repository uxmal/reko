...
T_20: (in SEQ(SLICE(fp0_11, word32, 0), SLICE(fp0_11, word32, 32), SLICE(fp0_11, word32, 64)) : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_21: (in (real96) dwLoc14_53 : real96)
  Class: Eq_6
  DataType: real96
  OrigDataType: real96
...
T_30: (in rLoc10_64 : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_31: (in (real96) dwLoc14_52 : real96)
  Class: Eq_31
  DataType: real96
  OrigDataType: real96
T_32: (in (real80) (real96) dwLoc14_52 : real80)
  Class: Eq_32
  DataType: real80
  OrigDataType: real80
...
T_39: (in SEQ(SLICE(fp0_11, word32, 0), SLICE(fp0_11, word32, 32), SLICE(fp0_11, word32, 64)) : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_40: (in (real96) dwLoc14_52 : real96)
  Class: Eq_6
  DataType: real96
  OrigDataType: real96
...
T_52: (in signature of fn80000132 : void)
  ...
  DataType: (ptr32 Eq_51)
  OrigDataType: 
T_53: (in (real96) dwLoc20_119 : real96)
  Class: Eq_6
  DataType: real96
  OrigDataType: real96
T_54: (in fn80000132(rArg04, (real96) dwLoc20_119) : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_55: (in (real80) fn80000132(rArg04, (real96) dwLoc20_119) : real80)
  Class: Eq_55
  DataType: real80
  OrigDataType: real80
T_56: (in (real96) (real80) fn80000132(rArg04, (real96) dwLoc20_119) : real96)
  Class: Eq_56
  DataType: real96
  OrigDataType: real96
T_57: (in fn8000018E : ptr32)
...
T_58: (in signature of fn8000018E : void)
  ...
  DataType: (ptr32 Eq_57)
  OrigDataType: 
T_59: (in (real96) dwLoc20_119 : real96)
  Class: Eq_6
  DataType: real96
  OrigDataType: real96
T_60: (in fn8000018E((real96) dwLoc20_119) : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_61: (in (real80) fn8000018E((real96) dwLoc20_119) : real80)
  Class: Eq_61
  DataType: real80
  OrigDataType: real80
T_62: (in (real96) (real80) fn80000132(rArg04, (real96) dwLoc20_119) / (real80) fn8000018E((real96) dwLoc20_119) : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_63: (in (real80) ((real96) (real80) fn80000132(rArg04, (real96) dwLoc20_119) / (real80) fn8000018E((real96) dwLoc20_119)) : real80)
  Class: Eq_63
  DataType: real80
  OrigDataType: real80
T_64: (in (real96) (real80) ((real96) (real80) fn80000132(rArg04, (real96) dwLoc20_119) / (real80) fn8000018E((real96) dwLoc20_119)) : real96)
  Class: Eq_64
  DataType: real96
  OrigDataType: real96
...
T_89: (in (real96) dwLoc20_118 : real96)
  Class: Eq_6
  DataType: real96
  OrigDataType: real96
T_90: (in fn80000132(rArg04, (real96) dwLoc20_118) : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_91: (in (real80) fn80000132(rArg04, (real96) dwLoc20_118) : real80)
  Class: Eq_91
  DataType: real80
  OrigDataType: real80
T_92: (in (real96) (real80) fn80000132(rArg04, (real96) dwLoc20_118) : real96)
  Class: Eq_92
  DataType: real96
  OrigDataType: real96
T_93: (in fn8000018E : ptr32)
...
T_94: (in (real96) dwLoc20_118 : real96)
  Class: Eq_6
  DataType: real96
  OrigDataType: real96
T_95: (in fn8000018E((real96) dwLoc20_118) : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_96: (in (real80) fn8000018E((real96) dwLoc20_118) : real80)
  Class: Eq_96
  DataType: real80
  OrigDataType: real80
T_97: (in (real96) (real80) fn80000132(rArg04, (real96) dwLoc20_118) / (real80) fn8000018E((real96) dwLoc20_118) : real96)
  ...
  DataType: real96
  OrigDataType: real96
T_98: (in (real80) ((real96) (real80) fn80000132(rArg04, (real96) dwLoc20_118) / (real80) fn8000018E((real96) dwLoc20_118)) : real80)
  Class: Eq_98
  DataType: real80
  OrigDataType: real80
T_99: (in (real96) (real80) ((real96) (real80) fn80000132(rArg04, (real96) dwLoc20_118) / (real80) fn8000018E((real96) dwLoc20_118)) : real96)
  Class: Eq_99
  DataType: real96
  OrigDataType: real96
