...
Eq_10: (fn void (ptr64))
	T_10 (in __align_stack<word64> @ 00400449 : ptr32)
...
T_15: (in fp + 8<i64> @ 00400449 : word64)
  ...
  DataType: ptr64
  OrigDataType: ptr64
T_16: (in __align_stack<word64>((char *) fp + 8<i32>) @ 00400449 : void)
  Class: Eq_16
  DataType: void
  OrigDataType: void
T_17: (in __libc_start_main @ 00400464 : ptr64)
