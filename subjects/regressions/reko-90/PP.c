...
l0800_05B1:
	...
	selector es_280 = SLICE(es_bx_278, selector, 16)
	word16 bx_281 = (word16) es_bx_278 + (Mem127[ds:0x2A27:word16] << 0x02)
	Mem284[ss:sp_121 + 0x00:word16] = Mem127[es_280:bx_281 + 0x02:word16]
	Mem286[ss:sp_121 - 0x02 + 0x00:word16] = Mem284[es_280:bx_281 + 0x00:word16]
...
l0800_0606:
	...
	word16 dx_254 = Mem238[es_250:bx_251 + 0x00:word16]
...
l0800_1897:
	...
	Mem505[es_1083:di_1079 - 0x01 + 0x01:byte] = (byte) Mem450[ss:sp_278 + 0x02:word16];
	...
	Mem569[es_1061:di_1057 - 0x01 + 0x02:byte] = (byte) Mem513[ss:sp_278 + 0x02:word16];
	...
	Mem635[es_1039:di_1035 - 0x01 + 0x03:byte] = (byte) Mem580[ss:sp_278 + 0x02:word16];
...
selector fn0800_2201(selector ds, segptr32 ptrArg02, word16 wArg04)
{
	...
	else
	{
		...
		Mem205[ds_76:0x45AA:word16] = di_170 - 0x01 + 0x01;
		return ds_76;
	}
}
...
selector fn0800_6AD4(word16 bp, selector ds)
{
	...
	if (0x00 <u Mem0[ds:0x2A09:word16] || 0x00 == Mem0[ds:0x2A09:word16] && ax_23 <u Mem0[ds:0x2A07:word16])
	{
		...
		else
		{
			...
			Mem246[ss:fp - 0x06 + 0x00:word16] = (DPB(ax_224, 0x00, 8) << 0x08) + dx_240 - 0x0C >>u 0x01 >>u 0x01;
