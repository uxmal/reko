...
void fn1483-0D3F(struct Eq_n * ds_di, struct Eq_n * ss_bp, Eq_n ax, Eq_n cx, ui16 dx, byte bl, byte bh, Eq_n si, struct Eq_n * es, struct Eq_n * fs, struct Eq_n Eq_n::* wArg02, word16 wArg06, word16 wArg0C, struct Eq_n * psegArg01A4, ui8 bArg02C1, uint8 bArg0FA0)
{
	...
	word16 bx_n = bx_n + Mem133[ds:(bx_n - 121) + di:word16] + SCZDOP_n;
	byte dh_n = SLICE(dx_n, byte, 8);
	Mem140[ss:v19_n + 0xF512 + di:byte] = Mem133[ss:v19_n + 0xF512 + di:byte] + dh_n + (bx_n <u 0x00);
	...
	if (!(sp_n - 18) || cx_n == 0x01)
	{
		...
		ds->*((word32) v32_n + 90) = ds->*((word32) v32_n + 90) - bh_n - (v37_n < 0x00);
	}
	else
	{
