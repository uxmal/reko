...
segptr32 fn1483-0D3F(struct Eq_n * ds_di, struct Eq_n * ss_bp, Eq_n ax, Eq_n cx, ui16 dx, byte bl, byte bh, Eq_n si, struct Eq_n * es, struct Eq_n * fs, struct Eq_n Eq_n::* wArg02, word16 wArg06, word16 wArg0C, struct Eq_n * psegArg01A4)
{
	...
	Eq_n v33_n = ds->*((word32) ax_n + 0x0000995D);
	...
	{
		Eq_n v38_n = di.u2[(word16) bx_n + 40] - ah_n - (sp_n - 18);
		di.u2[(word16) bx_n + 40] = v38_n;
		ds->*((word32) v33_n + 90) = ds->*((word32) v33_n + 90) - bh_n - (byte) (v38_n < 0x00);
	}
	else
	{
	...
	while (true)
	{
		...
		if (dx_n == 0x00)
		{
			...
			if (dx_n != 0x00 || cx == 0x01)
			{
				...
				byte cl_n = sp_n[0x0C];
				es->*di_n = (byte) ax_n;
				Eq_n v38_n = (word16) bx_n + ds->*((word16) bx_n + ((word16) di_n + 1));
