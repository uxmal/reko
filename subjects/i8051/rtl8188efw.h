...
Eq_6: (fn void ())
	T_6 (in fn4EF3 @ 0797 : ptr16)
Eq_10: (segment "Eq_10" (157 byte b0157) (80EA bcu8 b80EA))
	T_10 (in __data_23 @ 079F : selector)
Eq_21: (fn void ())
	T_21 (in fn4AC0 @ 07A7 : ptr16)
// Type Variables ////////////
globals_t: (in globals : (ptr16 (struct "Globals")))
  Class: Eq_1
  DataType: (ptr16 Eq_1)
...
T_5: (in Mem8[__data:0x001D<p16>:byte] @ 077C : byte)
  Class: Eq_3
  DataType: byte
  OrigDataType: byte
T_6: (in fn4EF3 @ 0797 : ptr16)
...
T_7: (in signature of fn4EF3 : void)
  Class: Eq_7
  DataType: Eq_7
  OrigDataType: 
T_8: (in fn4EF3() @ 0797 : void)
  Class: Eq_8
  DataType: void
  OrigDataType: void
T_9: (in 5<8> @ 079F : byte)
  Class: Eq_9
  DataType: byte
  OrigDataType: byte
T_10: (in __data_23 @ 079F : selector)
...
T_12: (in Mem32[__data_23:0x157<16>:byte] @ 079F : byte)
  Class: Eq_9
  DataType: byte
  OrigDataType: byte
T_13: (in 0x80EA<16> @ 07A4 : word16)
  Class: Eq_13
  DataType: (memptr (ptr16 Eq_10) bcu8)
  OrigDataType: (memptr T_10 (struct (0 T_14 t0000)))
T_14: (in Mem32[__data_23:0x80EA<16>:byte] @ 07A4 : byte)
  Class: Eq_14
  DataType: bcu8
  OrigDataType: bcu8
T_15: (in 2<8> @ 07A4 : byte)
  Class: Eq_15
  DataType: byte
  OrigDataType: byte
T_16: (in __data_23->b80EA >> 2<8> @ 07A4 : byte)
  Class: Eq_16
  DataType: uint8
  OrigDataType: uint8
T_17: (in 1<8> @ 07A4 : byte)
  Class: Eq_17
  DataType: byte
  OrigDataType: byte
T_18: (in __data_23->b80EA >> 2<8> & 1<8> @ 07A4 : byte)
  Class: Eq_18
  DataType: byte
  OrigDataType: byte
T_19: (in 0<8> @ 07A4 : byte)
  Class: Eq_18
  DataType: byte
  OrigDataType: byte
T_20: (in (__data_23->b80EA >> 2<8> & 1<8>) != 0<8> @ 07A4 : bool)
  Class: Eq_20
  DataType: bool
  OrigDataType: bool
T_21: (in fn4AC0 @ 07A7 : ptr16)
...
T_22: (in signature of fn4AC0 : void)
  Class: Eq_22
  DataType: Eq_22
  OrigDataType: 
T_23: (in fn4AC0() @ 07A7 : void)
  Class: Eq_23
  DataType: void
  OrigDataType: void
*/
