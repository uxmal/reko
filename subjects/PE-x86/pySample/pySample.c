...
Eq_159 fn10001388(Eq_159 ecx, Eq_159 edx, ui32 ebx, ui32 esi, ui32 edi)
{
	...
	if (edx == 0x01 || edx == 0x02)
	{
		...
		if (eax_166 != null)
		{
			*(fp - 0x0C) = (union Eq_159 *) ecx;
			*(fp - 0x10) = (union Eq_159 *) edx;
			*(fp - 0x14) = (union Eq_159 *) ebx_159;
			Eq_159 eax_208;
			eax_166();
...
l1000147A:
		...
		*esp_183 = (union Eq_159 *) edi_13;
		*(esp_183 - 0x04) = (union Eq_159 *) esi_15;
		*(esp_183 - 0x08) = (union Eq_159 *) ebx_159;
	...
	*esp_57 = (union Eq_159 *) edi_13;
	*(esp_57 - 0x04) = (union Eq_159 *) esi_15;
	*(esp_57 - 0x08) = (union Eq_159 *) ebx_159;
	...
	{
		*esp_57 = (union Eq_159 *) edi_13;
		*(esp_57 - 0x04) = (union Eq_159 *) eax_63;
		*(esp_57 - 0x08) = (union Eq_159 *) ebx_159;
	...
	if (esi_15 == 0x00 || esi_15 == 0x03)
	{
		...
		*esp_81 = (union Eq_159 *) edi_13;
		*(esp_81 - 0x04) = (union Eq_159 *) esi_15;
		*(esp_81 - 0x08) = (union Eq_159 *) ebx_159;
...
ui32 fn10001742(ui32 ebx, ui32 esi, ui32 edi, ptr32 & ediOut)
{
	...
	*(ebp_11 - 0x04) = (union Eq_159 *) (*(ebp_11 - 0x04) & 0x00);
	*(fp - 0x0C) = 0x10000000;
	if (fn100016D0(dwArg00) != 0x00)
	{
		*(fp - 0x0C) = (union Eq_772 *) (ebp_11->t0008 - 0x10000000);
		*(fp - 0x10) = 0x10000000;
