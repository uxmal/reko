...
word32 fn100011E9(word32 dwArg08)
{
	...
	if (dwArg08 == 0x01)
	{
		Eq_141 edi_82 = fs->ptr0018->t0004;
		while (true)
		{
			Eq_141 eax_93 = InterlockedCompareExchange(&globals->t100033AC, edi_82, 0x00);
			if (eax_93 == 0x00)
				break;
			if (eax_93 == edi_82)
				break;
		...
		{
			struct Eq_367 * esp_142 = esp_123 - 0x04;
...
Eq_180 fn10001388(Eq_180 ecx, Eq_180 edx, ui32 ebx, ui32 esi, ui32 edi)
{
	struct Eq_451 * ebp_10 = fn100017E8(ebx, esi, edi, dwLoc0C, 0x100021E8, 0x10);
	Eq_180 ebx_158 = ebp_10->t0008;
	...
	if (edx == 0x01 || edx == 0x02)
	{
		...
		if (eax_165 != null)
		{
			*(fp - 0x0C) = (union Eq_180 *) ecx;
			*(fp - 0x10) = (union Eq_180 *) edx;
			*(fp - 0x14) = (union Eq_180 *) ebx_158;
			word32 ecx_202;
			word32 edx_204;
			Eq_180 eax_207;
			byte SZO_208;
...
l1000147A:
			...
			(ebp_10 - 0x04)->t0000.u0 = ~0x01;
			fn10001493();
			Eq_180 eax_39 = (ebp_10 - 0x1C)->t0000;
			fn1000182D(ebp_10, 0x10, dwArg00, dwArg04, dwArg08, dwArg0C);
			return eax_39;
		}
		union Eq_180 * esp_182 = esp_175 - 0x04;
		*esp_182 = (union Eq_180 *) edi_12;
		*(esp_182 - 0x04) = (union Eq_180 *) esi_14;
		*(esp_182 - 0x08) = (union Eq_180 *) ebx_158;
		Eq_180 eax_188 = fn100011E9(dwArg04);
		(ebp_10 - 0x1C)->t0000 = eax_188;
		esp_175 = esp_182;
		if (eax_188 == 0x00)
			goto l1000147A;
	}
	union Eq_180 * esp_56 = esp_175 - 0x04;
	*esp_56 = (union Eq_180 *) edi_12;
	*(esp_56 - 0x04) = (union Eq_180 *) esi_14;
	*(esp_56 - 0x08) = (union Eq_180 *) ebx_158;
	Eq_180 eax_62 = fn100017C6(0x10, dwArg04);
	(ebp_10 - 0x1C)->t0000 = eax_62;
	ptr32 esp_142 = esp_56;
	if (esi_14 == 0x01 && eax_62 == 0x00)
	{
		*esp_56 = (union Eq_180 *) edi_12;
		*(esp_56 - 0x04) = (union Eq_180 *) eax_62;
		*(esp_56 - 0x08) = (union Eq_180 *) ebx_158;
	...
	{
		union Eq_180 * esp_80 = esp_142 - 0x04;
		*esp_80 = (union Eq_180 *) edi_12;
		*(esp_80 - 0x04) = (union Eq_180 *) esi_14;
		*(esp_80 - 0x08) = (union Eq_180 *) ebx_158;
		Eq_180 eax_86 = fn100011E9(dwArg04);
		if (eax_86 == 0x00)
...
BOOL DllMain(HANDLE hModule, Eq_180 dwReason, Eq_180 lpReserved)
{
	if (dwReason == 0x01)
		fn10001864();
...
word32 fn100016D0(word32 dwArg04)
{
	...
	{
		struct Eq_817 * eax_21 = dwArg04 + dwArg04->dw003C / 0x0040;
...
Eq_834 * fn10001700(word32 dwArg04, word32 dwArg08)
{
	struct Eq_837 * ecx_6 = dwArg04 + dwArg04->dw003C / 0x0040;
	uint32 esi_14 = (word32) ecx_6->w0006;
	uint32 edx_15 = 0x00;
	struct Eq_834 * eax_22 = (ecx_6 + ((word32) ecx_6->w0014 + 0x18) / 22)->w0006 + 0x03;
	if (true)
		do
		{
...
{
	ui32 eax_31;
	struct Eq_451 * ebp_10 = fn100017E8(ebx, esi, edi, dwLoc0C, 0x10002230, 0x08);
	*(ebp_10 - 0x04) = (union Eq_180 *) (*(ebp_10 - 0x04) & 0x00);
	*(fp - 0x0C) = 0x10000000;
	if (fn100016D0(dwArg00) != 0x00)
	{
		*(fp - 0x0C) = (union Eq_898 *) (ebp_10->t0008 - 0x10000000);
		*(fp - 0x10) = 0x10000000;
		struct Eq_934 * eax_54 = fn10001700(dwArg00, dwArg04);
		if (eax_54 != null)
		{
...
word32 fn1000182D(Eq_451 * ebp, word32 dwArg00, word32 dwArg04, word32 dwArg08, word32 dwArg0C, word32 dwArg10)
{
	fs->t0000 = *(ebp - 0x10);
	ebp->t0000 = dwArg00;
	return dwArg08;
