...
PyObject * py_unused(ERROR: EQ_3.DataType is Null self, ERROR: EQ_4.DataType is Null args)
{
...
word32 fn100011E9(word32 dwArg08)
{
	...
	if (dwArg08 == 0x01)
	{
		...
		{
			*(fp - 0x1C) = 268448684;
			LONG eax_89 = InterlockedCompareExchange(globals->t100033AC, edi_79, 0x00);
			if (eax_89 == 0x00)
				break;
			if (eax_89 == edi_79)
				goto l10001258;
...
l10001258:
		...
		*(fp - 0x14) = 0x02;
		...
		if (ebp_111 == 0x00)
		{
			*(esp_117 - 0x04) = ebp_111;
			*(esp_117 - 0x08) = 268448684;
			InterlockedExchange(*(esp_117 - 0x08), Mem166[esp_117 - 0x04 + 0x00:LONG]);
		}
		if (globals->ptr100033B8 != null)
		{
			Eq_374 * esp_136 = esp_117 - 0x04;
			esp_136->dw0000 = 0x100033B8;
			word32 edi_138;
			word32 eax_139 = fn10001742(ebx_110, esi_109, edi_108, out edi_138);
			if (eax_139 != 0x00)
			{
				esp_136->dw0000 = esp_136->dw001C;
				*(esp_136 - 0x04) = edi_138;
				*(esp_136 - 0x08) = esp_136->dw0014;
				word32 esp_151;
				word32 eax_152;
				word32 ebp_153;
				byte SZO_154;
	...
	else if (dwArg08 == 0x00)
	{
		...
		else
		{
			*(fp - 0x14) = globals->dw100033B4;
			...
			Eq_170 * fs_295;
			_decode_pointer();
			word32 esp_302 = fp->dwFFFFFFE8[0x01];
			if (eax_285 != 0x00)
			{
				fp->dwFFFFFFE8 = globals->dw100033B0;
				word32 esp_323;
				code * * eax_324;
				word32 ebp_325;
				byte SZO_326;
				...
				Eq_360 * fs_367;
				_encoded_null();
				globals->dw100033B0 = eax_357;
				globals->dw100033B4 = eax_357;
			...
			*(esp_314 - 0x04) = 268448684;
			...
			InterlockedExchange(*(esp_314 - 0x04), Mem318[esp_314 + 0x00:LONG]);
		}
	}
	eax_209 = 0x01;
	return eax_209;
...
void fn1000149E(word32 ebx, word32 esi, word32 edi, ERROR: EQ_805.DataType is Null dwArg00, ERROR: EQ_806.DataType is Null dwArg08, ERROR: EQ_807.DataType is Null dwArg0C)
{
	if (dwArg08 == 0x01)
		fn10001864();
...
void fn10001864()
{
	word32 eax_8 = globals->dw10003000;
