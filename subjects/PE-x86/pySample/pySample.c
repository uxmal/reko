...
word32 fn100011E9(word32 dwArg08)
{
	...
	if (dwArg08 == 0x01)
	{
		Eq_142 edi_82 = fs->ptr0018->t0004;
		while (true)
		{
			Eq_142 eax_93 = InterlockedCompareExchange(&globals->t100033AC, edi_82, 0x00);
			if (eax_93 == 0x00)
				break;
			if (eax_93 == edi_82)
				break;
		...
		{
			struct Eq_368 * esp_142 = esp_123 - 0x04;
...
Eq_181 fn10001388(Eq_181 ecx, Eq_181 edx, ui32 ebx, ui32 esi, ui32 edi)
{
	struct Eq_452 * ebp_10 = fn100017E8(ebx, esi, edi, dwLoc0C, 0x100021E8, 0x10);
	Eq_181 ebx_158 = ebp_10->t0008;
	...
	if (edx == 0x01 || edx == 0x02)
	{
		...
		if (eax_165 != null)
		{
			*(fp - 0x0C) = (union Eq_181 *) ecx;
			*(fp - 0x10) = (union Eq_181 *) edx;
			*(fp - 0x14) = (union Eq_181 *) ebx_158;
			word32 ecx_202;
			word32 edx_204;
			Eq_181 eax_207;
			byte SZO_208;
...
l1000147A:
			...
			(ebp_10 - 0x04)->t0000.u0 = ~0x01;
			fn10001493();
			Eq_181 eax_39 = (ebp_10 - 0x1C)->t0000;
			fn1000182D(ebp_10, 0x10, dwArg00, dwArg04, dwArg08, dwArg0C);
			return eax_39;
		}
		union Eq_181 * esp_182 = esp_175 - 0x04;
		*esp_182 = (union Eq_181 *) edi_12;
		*(esp_182 - 0x04) = (union Eq_181 *) esi_14;
		*(esp_182 - 0x08) = (union Eq_181 *) ebx_158;
		Eq_181 eax_188 = fn100011E9(dwArg04);
		(ebp_10 - 0x1C)->t0000 = eax_188;
		esp_175 = esp_182;
		if (eax_188 == 0x00)
			goto l1000147A;
	}
	union Eq_181 * esp_56 = esp_175 - 0x04;
	*esp_56 = (union Eq_181 *) edi_12;
	*(esp_56 - 0x04) = (union Eq_181 *) esi_14;
	*(esp_56 - 0x08) = (union Eq_181 *) ebx_158;
	Eq_181 eax_62 = fn100017C6(0x10, dwArg04);
	(ebp_10 - 0x1C)->t0000 = eax_62;
	ptr32 esp_142 = esp_56;
	if (esi_14 == 0x01 && eax_62 == 0x00)
	{
		*esp_56 = (union Eq_181 *) edi_12;
		*(esp_56 - 0x04) = (union Eq_181 *) eax_62;
		*(esp_56 - 0x08) = (union Eq_181 *) ebx_158;
	...
	{
		union Eq_181 * esp_80 = esp_142 - 0x04;
		*esp_80 = (union Eq_181 *) edi_12;
		*(esp_80 - 0x04) = (union Eq_181 *) esi_14;
		*(esp_80 - 0x08) = (union Eq_181 *) ebx_158;
		Eq_181 eax_86 = fn100011E9(dwArg04);
		if (eax_86 == 0x00)
...
BOOL DllMain(HANDLE hModule, Eq_181 dwReason, Eq_181 lpReserved)
{
	if (dwReason == 0x01)
		fn10001864();
...
word32 fn100016D0(word32 dwArg04)
{
	...
	{
		struct Eq_818 * eax_21 = dwArg04 + dwArg04->dw003C / 0x0040;
...
Eq_835 * fn10001700(word32 dwArg04, word32 dwArg08)
{
	struct Eq_838 * ecx_6 = dwArg04 + dwArg04->dw003C / 0x0040;
	uint32 esi_14 = (word32) ecx_6->w0006;
	uint32 edx_15 = 0x00;
	struct Eq_835 * eax_22 = (ecx_6 + ((word32) ecx_6->w0014 + 0x18) / 22)->w0006 + 0x03;
	if (true)
		do
		{
...
{
	ui32 eax_31;
	struct Eq_452 * ebp_10 = fn100017E8(ebx, esi, edi, dwLoc0C, 0x10002230, 0x08);
	*(ebp_10 - 0x04) = (union Eq_181 *) (*(ebp_10 - 0x04) & 0x00);
	*(fp - 0x0C) = 0x10000000;
	if (fn100016D0(dwArg00) != 0x00)
	{
		*(fp - 0x0C) = (union Eq_899 *) (ebp_10->t0008 - 0x10000000);
		*(fp - 0x10) = 0x10000000;
		struct Eq_935 * eax_54 = fn10001700(dwArg00, dwArg04);
		if (eax_54 != null)
		{
...
word32 fn1000182D(Eq_452 * ebp, word32 dwArg00, word32 dwArg04, word32 dwArg08, word32 dwArg0C, word32 dwArg10)
{
	fs->t0000 = *(ebp - 0x10);
	ebp->t0000 = dwArg00;
	return dwArg08;
