...
word32 fn100016D0(word32 dwArg04)
{
	...
	{
		struct Eq_764 * eax_21 = dwArg04 + dwArg04->dw003C / 0x0040;
...
{
	struct Eq_784 * ecx_6 = dwArg04 + dwArg04->dw003C / 0x0040;
	uint32 esi_14 = (word32) ecx_6->w0006;
	uint32 edx_15 = 0x00;
	struct Eq_781 * eax_22 = (ecx_6 + ((word32) ecx_6->w0014 + 0x18) / 22)->w0006 + 0x03;
	if (true)
	{
		do
		{
...
ui32 fn10001742( * ebx, ptr32 esi, word32 edi, ptr32 & ediOut)
{
	...
	*(fp - 0x0C) = 0x10000000;
	if (fn100016D0(dwArg00) != 0x00)
	{
		...
		*(fp - 0x10) = 0x10000000;
		struct Eq_881 * eax_54 = fn10001700(dwArg00, dwArg04);
		if (eax_54 != null)
		{
...
word32 fn1000182D(Eq_400 * ebp, word32 dwArg00, word32 dwArg04, word32 dwArg08, word32 dwArg0C, word32 dwArg10)
{
	fs->dw0000 = *(ebp - 0x10);
	ebp->dw0000 = dwArg00;
	return dwArg08;
