...
l1000147A:
		...
		*esp_182 = (Eq_167 *) edi_12;
		*(esp_182 - 0x04) = (Eq_167 *) esi_14;
		*(esp_182 - 0x08) = (Eq_167 *) ebx_158;
	...
	*esp_56 = (Eq_167 *) edi_12;
	*(esp_56 - 0x04) = (Eq_167 *) esi_14;
	*(esp_56 - 0x08) = (Eq_167 *) ebx_158;
	...
	if (esi_14 == 0x00 || esi_14 == 0x03)
	{
		...
		*esp_80 = (Eq_167 *) edi_12;
		*(esp_80 - 0x04) = (Eq_167 *) esi_14;
		*(esp_80 - 0x08) = (Eq_167 *) ebx_158;
...
ui32 fn10001742(ui32 ebx, ui32 esi, ui32 edi, ptr32 & ediOut)
{
	...
	*(ebp_10 - 0x04) = (Eq_167 *) (*(ebp_10 - 0x04) & 0x00);
	*(fp - 0x0C) = 0x10000000;
	if (fn100016D0(dwArg00) != 0x00)
	{
		*(fp - 0x0C) = (Eq_885 *) (ebp_10->t0008 - 0x10000000);
		*(fp - 0x10) = 0x10000000;
