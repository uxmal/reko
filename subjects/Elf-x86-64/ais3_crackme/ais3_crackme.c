...
// 0000000000400520: Register word32 verify(Register (arr Eq_149) rdi)
word32 verify(Eq_149 rdi[])
{
...
// 00000000004005C5: void main(Register (ptr Eq_234) rsi, Register word32 edi)
void main(Eq_234 * rsi, word32 edi)
{
	if (edi != 0x02)
