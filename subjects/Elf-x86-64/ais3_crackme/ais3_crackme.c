...
// 00000000004005C5: void main(Register word64 rax, Register (ptr Eq_243) rsi, Register word32 edi)
void main(word64 rax, Eq_243 * rsi, word32 edi)
{
	if (edi != 0x02)
	{
