...
// 0000000000400EE9: Register word64 print_pixel(Register byte dil, Register (ptr Eq_189) fs, Stack word64 qwArg04, Stack word64 qwArg0C)
word64 print_pixel(byte dil, Eq_189 * fs, word64 qwArg04, word64 qwArg0C)
{
	word64 rsp_36;
	word64 rbp_37;
	word64 rbx_38;
...
// 00000000004012F9: void main(Register (ptr Eq_290) rsi, Register word32 edi, Register word64 r13, Register (ptr Eq_293) fs)
void main(Eq_290 * rsi, word32 edi, word64 r13, Eq_293 * fs)
{
