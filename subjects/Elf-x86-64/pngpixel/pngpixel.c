...
void component(uint32 ecx, word32 edx, word32 esi, word32 edi, word32 r8d, ptr64 r13)
{
	*(r13 - 0x28) = r8d;
	if (ecx > 0x10)
	{
		uint64 rax_84 = (uint64) fprintf(globals->ptr602100, "pngpixel: invalid bit depth %u
", (uint64) ecx);
		exit(0x01);
	}
	else
...
void main(Eq_295 * rsi, word32 edi, word64 r13, Eq_298 * fs)
{
	...
	if (rax_165 == null)
	{
		uint64 rax_1021 = (uint64) fprintf(globals->ptr602100, "pngpixel: %s: could not open file
", rsi->ptr0018);
		goto l000000000040175D;
	}
	word64 rsp_176;
