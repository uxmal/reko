...
{
	selector seg0800;
	struct Eq_n * ds_n = seg0800->ptr01F8;
	__restorezero(ds_n);
	(seg0800->*ds_n->ptr05DC)();
	uint8 Eq_n::* si_n = Eq_n::a0000;
	word16 cx_n;
	uint16 ah_al_n = 0x00;
...
{
	selector seg0800;
	fn0800-01DA(&(seg0800->ptr01F8->*dx), cx);
	__exit();
}

struct Eq_n * g_ptr01F8 = null; // 0800:01F8
// 0800:01FA: void _f3()
// Called from:
//      fn0800-01E9
//      _f2
...
void _main(Eq_n cx, Eq_n dx, Eq_n bx, struct Eq_n * es, Eq_n ds)
{
	...
	Eq_n bx_n;
	Eq_n dx_n = _scanf(_printf(cx, dx, bx, ds, 404), es, ds, 0x01B0, out bx_n, out bp_n);
	struct Eq_n Eq_n::* sp_n = &Eq_n::tBADDCAFE;
	Eq_n cx_n;
	selector ss;
	cx_n.u2 = (ss->*sp_n).t0002.u2;
	(ss->*sp_n).t0002.u2 = (ss->*bp_n).tFFFFFFFE.u2;
	(ss->*sp_n).t0000.u1 = (ss->*bp_n).tFFFFFFFC.u1;
	(ss->*sp_n).tFFFFFFFE.u2 = (struct Eq_n *) 0x01B4;
	_printf(cx_n, dx_n, bx_n, ds, (ss->*sp_n).tFFFFFFFE.u2);
	(ss->*bp_n).tFFFFFFFA.u2 = (struct Eq_n *) 0x00;
	(ss->*bp_n).tFFFFFFF8.u1 = (cup16) 0x01;
	Eq_n dx_n;
	while (true)
	{
		dx_n.u2 = (ss->*bp_n).tFFFFFFFA.u2;
		Eq_n ax_n;
		ax_n.u1 = (ss->*bp_n).tFFFFFFF8.u1;
		if (dx_n >= ((ss->*bp_n).tFFFFFFFE).u2 && (dx_n > ((ss->*bp_n).tFFFFFFFE).u2 || ax_n > ((ss->*bp_n).tFFFFFFFC).u1))
			break;
		_f0();
		(ss->*bp_n).tFFFFFFF8.u0 = (ui32) ((ss->*bp_n).tFFFFFFF8.u0 + 0x01);
	}
	(ss->*sp_n).t0002.u2 = (struct Eq_n *) 0x01CE;
	_printf(cx_n, dx_n, bx_n, ds, (ss->*sp_n).t0002.u2);
}
...
Eq_n g_t0330 = // 0800:0330
	{
		0x00
	};
struct Eq_n * g_ptr0332 = null; // 0800:0332
...
l0800_nE7:
	...
	<unknown>* di_n = fp - ((ax_n + 0x02) + cx_n & ~0x01);
	if (di_n >= 0x00)
	{
		struct Eq_n * ss;
...
l0800_nA3:
			...
			if ((Z_n | C_n) == 0x00)
			{
				...
				do
				{
					if (v36_n)
					{
						word16 cx_n = (word16) (ss->*((char *) di_n - 2));
...
// 0800:03BF: FlagGroup ui32 fn0800-03BF(Sequence (ptr32 Eq_n) ds_si, Sequence (ptr32 byte) es_di, Register word16 ax, Register uint16 cx, Register out word16 axOut, Register out uint16 cxOut, Register out word16 siOut)
// Called from:
//      __setargv
ui32 fn0800-03BF(struct Eq_n * ds_si, byte * es_di, word16 ax, uint16 cx, word16 & axOut, uint16 & cxOut, word16 & siOut)
{
	word16 si = (word16) ds_si;
	byte al_n = (byte) ax;
	if (ax != 0x00)
		*es_di = al_n;
	ui32 Z_n = cond(0x00) & 0x04;
	ui32 C_n = 0x02;
	word16 ax_n = SEQ(al_n, 0x00);
	if (cx != 0x00)
	{
...
void ___pull_free_block(struct Eq_n * ds, Eq_n wArg02)
{
	...
	else
	{
		...
		(ds->*si_n).t0006.u0 = (uint16) ds->t062A;
	}
}
...
{
	ds->*wArg02 -= wArg04;
	Eq_n si_n = ds->*wArg02 + wArg02;
	ds->*si_n = (word16) wArg04.u0 + 1;
	ds->*((word16) si_n + 2) = wArg02;
	if (ds->t0628 == wArg02)
		ds->t0628 = si_n;
	else
		ds->*((word16) (si_n + wArg04) + 2) = (word16) si_n;
...
void _fseek(struct Eq_n * ds, struct Eq_n Eq_n::* wArg02, int32 * dwArg04, word16 wArg08)
{
	...
	if (_fflush(ds, wArg02) == 0x00)
	{
		if (wArg08 == 0x01 && (ds->*wArg02).w0000 > 0x00)
			dwArg04 -= (uint32) fn0800-065B(ds, wArg02);
...
// 0800:0C28: Register Eq_n _lseek(Register (ptr16 Eq_n) ds, Stack int16 wArg02, Stack (ptr32 int32) dwArg04, Stack byte bArg08, Register out word16 dxOut)
// Called from:
//      _fseek
//      _read
//      __write
//      _tell
Eq_n _lseek(struct Eq_n * ds, int16 wArg02, int32 * dwArg04, byte bArg08, word16 & dxOut)
{
	int32 * dx_ax_n;
	ds->a0482[0][wArg02] = ds->a0482[0][wArg02] & ~0x0200;
	Eq_n ax_n = (word16) dx_ax_n;
...
word16 fn0800-1048(struct Eq_n * es_di, Eq_n ds, Eq_n wArg02)
{
	...
	Mem21[es_di + 0x00:byte] = Mem7[ds:CONVERT(dh_n >>u 0x04, uint8, uint16) + 0x04E9:byte];
	Mem27[es_di + 1:byte] = Mem21[ds:CONVERT(dh_n & 0x0F, uint8, uint16) + 0x04E9:byte];
	bcu8 dl_n = (byte) wArg02;
	Mem33[es_di + 2:byte] = Mem27[ds:CONVERT(dl_n >>u 0x04, uint8, uint16) + 0x04E9:byte];
	Mem41[es_di + 3:byte] = Mem33[ds:CONVERT(dl_n & 0x0F, uint8, uint16) + 0x04E9:byte];
	return di + 4;
}
...
word16 __VPRINTER(Eq_n cx, Eq_n dx, Eq_n bx, Eq_n ds, Eq_n wArg02, Eq_n wArg04)
{
	...
	Eq_n bLoc57_n;
	bLoc57_n.u0 = 0x50;
	struct Eq_n Eq_n::* sp_n = fp - 0xA0;
	byte Eq_n::* wLoc98_n = fp - 86;
l0800_nD6:
		...
		if (al_n == 0x25)
		{
			...
			if (al_n != 0x25)
			{
				...
				while (true)
				{
					...
					if (bl_n >= 0x60)
						break;
					uint8 bl_n = (uint8) (ds->*((word32) bx + 0x04F9));
					bx = (uint16) bl_n;
					ah_n = 0x00;
					cx = SEQ(ch_n, 0x00);
					if (bx > 0x17)
...
l0800_n:
							...
							if (ch_n <= 0x02)
							{
								...
								if (wLoc94_n < 0x00)
									goto l0800_nE5;
								wLoc94_n.u1 = (word32) ax_n + wLoc94_n *16 0x0A;
							}
							else
							{
								cx = SEQ(ch_n, 0x00);
...
l0800_nCE:
								...
								wLoc92_n = ax_n;
								if (wLoc92_n >= 0x00)
									wLoc92_n.u1 = (word32) ax_n + wLoc92_n *16 0x0A;
								else
								{
l0800_nE5:
								}
...
l0800_nF:
						...
						bx_n = bx_n;
l0800_nA2:
						struct Eq_n Eq_n::* di_n = (struct Eq_n Eq_n::*) ((word32) wArg02 + 1);
						int8 bh_n = SLICE(bx_n, byte, 8);
						Eq_n dx_n;
						dx_n.u0 = 0x00;
						Eq_n di_n = &di_n->t0001.u0;
						wArg04 = si_n;
						if ((wLoc9A_n & 0x10) != 0x00)
						{
							dx_n.u2 = (ds->*di_n).t0001.u2;
							di_n = (char *) &di_n->t0001 + 2;
						}
						wArg02 = di_n;
						if (ax_n == 0x00)
						{
							...
							if (wLoc92_n == 0x00)
							{
								...
								if (wLoc94_n != 0x00 && wLoc94_n != ~0x00)
								{
									...
									do
									{
										uint8 dl_n = (byte) ah_dl_n;
										dx = SEQ(dh_n, dl_n);
										fn0800-1099(SEQ(ds, di_n), SEQ(ss, fp - 2), (byte) ah_dl_n, cx, dx, bx_n, out di_n);
										--cx;
										ah_dl_n = (uint16) dl_n;
									} while (cx != 0x00);
								}
...
l0800_nF1:
						...
						(ss->*sp_n).tFFFFFFFE.u2 = (struct Eq_n *) ax_n;
						(ss->*sp_n).ptrFFFFFFFC = fp - 0x89;
						(ss->*sp_n).tFFFFFFFA.u2 = (int16) bh_n;
						(ss->*sp_n).tFFFFFFF8.u0 = (uint16) bLoc95_n;
						(ss->*sp_n).tFFFFFFF6.u2 = (struct Eq_n *) bx_n;
						__LONGTOA(ds, (ss->*sp_n).tFFFFFFF6.u0, (ss->*sp_n).tFFFFFFF8.u1, (ss->*sp_n).tFFFFFFFA.u2, (ss->*sp_n).ptrFFFFFFFC, (ss->*sp_n).tFFFFFFFE.u1);
					...
					case 0x0E:
						struct Eq_n Eq_n::* sp_n = sp_n - 2;
						(ss->*sp_n).t0000.u2 = (struct Eq_n *) (ds->*wArg02);
						byte Eq_n::* di_n = fp - 0x8A;
						wArg02.u1 = (word32) wArg02 + 2;
						if ((wLoc9A_n & 0x20) != 0x00)
						{
							(ss->*sp_n).tFFFFFFFE.u2 = (struct Eq_n *) (ds->*((word32) wArg02 + 2));
					...
					case 0x0F:
						...
						if (wLoc92_n < 0x00)
							cx_n.u0 = 0x06;
						struct Eq_n Eq_n::* sp_n = sp_n - 2;
						(ss->*sp_n).t0000.u2 = (struct Eq_n *) wArg02;
						(ss->*sp_n).tFFFFFFFE.u2 = (struct Eq_n *) cx_n;
						(ss->*sp_n).ptrFFFFFFFC = fp - 0x89;
						(ss->*sp_n).tFFFFFFFA.u2 = (struct Eq_n *) ax_n;
						(ss->*sp_n).tFFFFFFF8.u0 = (uint16) (wLoc9A_n & 0x01);
						Eq_n ax_n;
						int16 wLoc06_n;
						...
						(ss->*sp_n).tFFFFFFF6.u2 = (struct Eq_n *) ax_n;
						__REALCVT(ds);
...
l0800_nB5:
								...
								{
									for (; bx_n > cx; --bx_n)
										fn0800-1099(SEQ(ds, di_n), SEQ(ss, fp - 2), 0x20, cx, dx, bx_n, out di_n);
								}
								if ((wLoc9A_n & 0x40) != 0x00)
								{
									word16 di_n;
									fn0800-1099(SEQ(ds, di_n), SEQ(ss, fp - 2), 0x30, cx, dx, bx_n, out di_n);
									fn0800-1099(SEQ(ds, di_n), SEQ(ss, fp - 2), al_n, cx, dx, bx_n, out di_n);
								}
								dx = wLoc8E_n;
								if (wLoc8E_n > 0x00)
								{
									...
									if (wLoc8E_n != 0x00)
									{
										do
										{
											fn0800-1099(SEQ(ds, di_n), SEQ(ss, fp - 2), 0x30, cx_n, cx_n, bx_n, out di_n);
											--cx_n;
										} while (cx_n != 0x00);
									}
									dx = cx_n;
								...
								if (cx != 0x00)
								{
									...
									{
										ds->*di_n = es_n->*si_n;
										Eq_n v47_n = bLoc57_n - 0x01;
										++si_n;
										++di_n;
										bLoc57_n = v47_n;
										if (v47_n <= 0x00)
											fn0800-10A1(SEQ(ss, fp - 2), cx, dx, bx_n, di_n, out di_n);
										--cx;
									} while (cx != 0x00);
								}
								bx = bx_n;
...
l0800_n:
				...
				do
				{
					...
					fn0800-1099(SEQ(ds, di_n), SEQ(ss, fp - 2), (byte) ax_n, cx, dx, bx, out di_n);
					al_n = (uint8) (ds->*si_n);
					si_n.u1 = (word32) si_n + 1;
					ax_n = ax_n;
				} while (al_n != 0x00);
		...
		ds->*di_n = (byte) al_n;
		Eq_n v18_n = bLoc57_n - 0x01;
		++di_n;
		bLoc57_n = v18_n;
		if (v18_n <= 0x00)
			fn0800-10A1(SEQ(ss, fp - 2), cx, dx, bx, di_n, out di_n);
	}
	if (bLoc57_n < 0x50)
	{
		word16 di_n;
	...
	word16 Eq_n::* sp_n = (word16 Eq_n::*) ((char *) &sp_n->t0000 + 2);
	return ss->*sp_n;
}
...
// Called from:
//      __VPRINTER
byte fn0800-1099(union Eq_n * ds_di, struct Eq_n * ss_bp, Eq_n al, Eq_n cx, Eq_n dx, Eq_n bx, byte & diOut)
{
	word16 ax;
	al = (byte) ax;
	...
	{
		byte Eq_n::* di_n;
		fn0800-10A1(ss_bp, cx, dx, bx, di + 0x01, out di_n);
		diOut = di_n;
		return 0x00;
	}
}

// 0800:10A1: Register byte fn0800-10A1(Sequence (ptr32 Eq_n) ss_bp, Register Eq_n cx, Register Eq_n dx, Register Eq_n bx, Register (memptr Eq_n byte) di, Register out (memptr Eq_n byte) diOut)
// Called from:
//      __VPRINTER
//      fn0800-1099
byte fn0800-10A1(struct Eq_n * ss_bp, Eq_n cx, Eq_n dx, Eq_n bx, byte Eq_n::* di, byte & diOut)
{
...
void fn0800-15CF(struct Eq_n * ds, Eq_n wArg02, Eq_n wArg04)
{
	...
	if (ds->t0628 == wArg04)
		...
		ds->*((word16) (ds->*wArg04 + wArg04) + 2) = (word16) wArg02;
...
// 0800:16D4: Register word16 _scanf(Register Eq_n di, Register (ptr16 Eq_n) es, Register Eq_n ds, Stack (memptr Eq_n Eq_n) wArg02, Register out word16 bxOut, Register out word16 bpOut)
// Called from:
//      _main
word16 _scanf(Eq_n di, struct Eq_n * es, Eq_n ds, struct Eq_n Eq_n::* wArg02, word16 & bxOut, word16 & bpOut)
{
	selector ss;
	word16 Eq_n::* bp_n;
	word16 bx_n;
...
// 0800:16F3: Register Eq_n __scanner(Register Eq_n di, Register (ptr16 Eq_n) es, Register Eq_n ds, Stack (memptr (ptr16 Eq_n) code) wArg02, Stack (memptr (ptr16 Eq_n) code) wArg04, Stack Eq_n wArg06, Stack (memptr Eq_n Eq_n) wArg08, Register out uint16 bxOut, Register out word16 bpOut)
// Called from:
//      _scanf
Eq_n __scanner(Eq_n di, struct Eq_n * es, Eq_n ds, <anonymous> seg0800_t::* wArg02, <anonymous> seg0800_t::* wArg04, Eq_n wArg06, struct Eq_n Eq_n::* wArg08, uint16 & bxOut, word16 & bpOut)
{
	struct Eq_n Eq_n::* sp_n;
	struct Eq_n Eq_n::* sp_n;
	ci16 ax_n;
...
l0800_n:
		...
		if (al_n == 0x25)
		{
			...
			{
				++si_n;
				Eq_n ax_n = (int16) (ds->*si_n).t0000.u0;
				...
				case 0x05:
					...
					if (wLoc24_n >= 0x00)
					{
						...
						wLoc24_n = ax_n - 0x30 + wLoc24_n * 0x0A;
					}
					break;
				case 0x06:
				...
				case 0x0A:
					...
					if (wLoc26 > 0x00)
					{
						...
						{
							struct Eq_n * es_di_n = fn0800-1708(&(ss->*(fp - 2)), ds);
							di = (word16) es_di_n;
							es = SLICE(es_di_n, selector, 16);
							__scanrslt(ds);
							wLoc04 = di;
					...
					if (wLoc26 < 0x00)
					{
						word16 bp_n = fn0800-1AEB(&(ss->*(fp - 2)));
						bxOut = bx_n << 0x01;
						bpOut = bp_n;
						return dx;
					}
					...
					{
						word16 bp_n = fn0800-1AFF(&(ss->*(fp - 2)));
						bxOut = bx_n << 0x01;
						bpOut = bp_n;
						return dx;
					}
				...
				case 0x10:
					...
					uint8 al_n = (uint8) (ds->*si_n).t0000.u0;
...
l0800_nA23:
					...
					ss->*((fp - 0x0022) + (ax_n >> 0x03)) = (word16) (ss->*((fp - 0x0022) + (ax_n >> 0x03)) | ch_n);
					uint8 dl_n = al_n;
					Eq_n di_n = ax_n >> 0x03;
					Eq_n dx_n;
					while (true)
					{
						al_n = (uint8) (ds->*si_n).t0000.u0;
						++si_n;
						dx_n = SEQ(dh_n, dl_n);
						if (al_n == 0x00)
							break;
						...
						if (al_n == 0x5D)
						{
							...
							wArg08 = si_n;
							ci16 si_n = v65_n;
							struct Eq_n * es_di_n = (struct Eq_n *) di_n;
							if ((bLoc2B_n & 0x01) == 0x00)
							...
							while (true)
							{
								...
								bx = ax_n >> 0x03;
								Eq_n al_n = (byte) ax_n;
								if ((ss->*((fp - 0x0022) + (ax_n >> 0x03)) & 0x01 << ((byte) ax_n & 0x07)) != 0x00)
								{
...
l0800_nAD3:
						...
						if (al_n != 0x2D || (dl_n > ((ds->*si_n).t0000).u0 || ((ds->*si_n).t0000).u0 == 0x5D))
							goto l0800_nA23;
						++si_n;
						byte al_n = (ds->*si_n).t0000.u0 - dl_n;
						if (al_n != 0x00)
						{
							dl_n += al_n;
							do
							{
								...
								ss->*((fp - 0x0022) + di_n) = (word16) (ss->*((fp - 0x0022) + di_n) | ch_n);
								--al_n;
							} while (al_n != 0x00);
						}
					}
...
l0800_n:
		...
		if (ax_n >= 0x00 && ds->*((word16) ax_n + 0x055A) == 0x01)
		{
			...
			do
			{
				...
				{
					struct Eq_n Eq_n::* sp_n = sp_n - 2;
					(ss->*sp_n).t0000.u0 = (struct Eq_n *) wArg06;
					(ss->*sp_n).tFFFFFFFE.u0 = (struct Eq_n *) ax_n;
					(seg0800->*wArg04)();
					word16 cx_n = (ss->*sp_n).w0002;
					--wLoc28_n;
					uint16 bx_n;
				...
				(ss->*sp_n).tFFFFFFFE.u0 = (struct Eq_n *) wArg06;
				(seg0800->*wArg02)();
				wLoc28_n.u1 = (word16) wLoc28_n.u1 + 1;
				Eq_n cx_n;
...
// 0800:1898: Register word16 fn0800-1898(Sequence (ptr32 Eq_n) ss_bp, Register Eq_n ds, Register out word16 bpOut)
// Called from:
//      __scanner
word16 fn0800-1898(struct Eq_n * ss_bp, Eq_n ds, word16 & bpOut)
{
	word16 bp_n;
...
// 0800:196F: Register word16 fn0800-196F(Sequence (ptr32 Eq_n) ss_bp, Register Eq_n ds, Register out word16 bpOut)
// Called from:
//      __scanner
word16 fn0800-196F(struct Eq_n * ss_bp, Eq_n ds, word16 & bpOut)
{
	word16 bp_n;
	word16 bx_n = fn0800-1B06(ss_bp, ds, out bp_n);
	bpOut = bp_n;
...
// 0800:1AEB: Register word16 fn0800-1AEB(Sequence (ptr32 Eq_n) ss_bp)
// Called from:
//      __scanner
//      fn0800-1898
//      fn0800-1B2C
word16 fn0800-1AEB(struct Eq_n * ss_bp)
{
	selector seg0800;
...
// 0800:1B06: Register word16 fn0800-1B06(Sequence (ptr32 Eq_n) ss_bp, Register Eq_n ds, Register out word16 bpOut)
// Called from:
//      fn0800-1898
//      fn0800-196F
word16 fn0800-1B06(struct Eq_n * ss_bp, Eq_n ds, word16 & bpOut)
{
	struct Eq_n Eq_n::* fp;
...
void fn0800-1B2C(struct Eq_n * ss_bp)
{
	...
	while (true)
	{
		ci16 v9_n = ss_bp->wFFFFFFDE - 0x01;
		ss_bp->wFFFFFFDE = v9_n;
		cl_n = (byte) cx_n;
		if (v9_n < 0x00)
			break;
		struct Eq_n Eq_n::* sp_n = sp_n - 2;
