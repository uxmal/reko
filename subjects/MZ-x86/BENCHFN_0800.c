...
void _abort()
{
	fn0800-01DA((char *) seg0800->ptr01F8 + 86, 0x1E);
	__exit();
}
...
void _setvbuf(struct Eq_n * ds, struct Eq_n Eq_n::* wArg02, Eq_n wArg04, ci16 wArg06, cu16 wArg08)
{
	...
	(ds->*wArg02).t0008 = &(ds->*wArg02).b0004 + 1;
	(ds->*wArg02).t000A = &(ds->*wArg02).b0004 + 1;
...
word16 _fflush(struct Eq_n * ds, struct Eq_n Eq_n::* wArg02)
{
	...
	{
		if (((ds->*wArg02).w0002 & 0x08) != 0x00 || (ds->*wArg02).t000A == &(ds->*wArg02).b0004 + 1)
		{
			(ds->*wArg02).w0000 = 0x00;
			if ((ds->*wArg02).t000A == &(ds->*wArg02).b0004 + 1)
				(ds->*wArg02).t000A = (ds->*wArg02).t0008;
		}
		ax_n = 0x00;
	}
								...
								if (wLoc94_n != 0x00)
								{
									...
									if (wLoc94_n != ~0x00)
									{
										...
										do
										{
											...
											sp_n = (struct Eq_n Eq_n::*) ((char *) &(ds->*sp_n).t0000 + 0x0000FFFE);
											--cx;
										} while (cx != 0x00);
									}
								}
...
l0800_nF1:
						...
						sp_n = (struct Eq_n Eq_n::*) ((char *) &(ds->*sp_n).t0000 + 2);
						dx_n = wLoc92_n;
						if (wLoc92_n > 0x00)
						{
...
l0800_nB5:
								...
								if ((wLoc9A_n & 0x40) != 0x00)
								{
									...
									sp_n = (struct Eq_n Eq_n::*) ((char *) &(ds->*sp_n).t0000 + 0x0000FFFC);
								}
								dx = wLoc8E_n;
								if (wLoc8E_n > 0x00)
								{
...
l0800_n:
	...
	word16 Eq_n::* sp_n = (char *) &(ds->*sp_n).t0000 + 2;
	return ss->*sp_n;
}
...
l0800_nE6:
				...
				case 0x0A:
					...
					if (wLoc26 > 0x00)
					{
						...
						{
							di = fn0800-1708(&(ss->*(fp - 2)).t0000, ds, out es);
							__scanrslt(ds);
						}
						goto l0800_n;
					}
					...
					if (wLoc26 < 0x00)
					{
						ptr16 bp_n = fn0800-1AEB(&(ss->*(fp - 2)).t0000);
						bxOut = bx_n << 0x01;
						bpOut = bp_n;
						return dx;
					}
					...
					{
						ptr16 bp_n = fn0800-1AFF(&(ss->*(fp - 2)).t0000);
						bxOut = bx_n << 0x01;
						bpOut = bp_n;
						return dx;
					}
...
l0800_nA23:
					...
					while (true)
					{
						...
						if (al_n == 0x5D)
						{
							...
							ci16 si_n = v61_n;
							if ((bLoc2B_n & 0x01) == 0x00)
								di = fn0800-1708(&(ss->*(fp - 2)).t0000, ds, out es_n);
							while (true)
							{
								word16 dx_n;
								Eq_n bx_n;
...
l0800_nF:
		...
		struct Eq_n Eq_n::* sp_n = (char *) &(ds->*sp_n).t0000 + 2;
		Eq_n ax_n = ax_n;
		if (ax_n < 0x00)
		{
l0800_n:
...
void fn0800-1B2C(struct Eq_n * ss_bp)
{
	...
	while (true)
	{
		...
		sp_n = (struct Eq_n Eq_n::*) (&(ss->*sp_n).w0004 + 1);
		cu8 al_n = (byte) ax_n;
		if (ax_n <= 0x00)
			break;
		--cl_n;
...
l0800_nD1F:
							...
							ds->*wArg0E = wLoc04_n;
							Eq_n es_n = (ss->*sp_n).t0000;
							struct Eq_n Eq_n::* sp_n = (char *) &(ss->*sp_n).t0000 + 2;
