...
void _main(ci16 cx, ci16 dx, word16 bx, struct Eq_n * es, Eq_n ds)
{
	...
	(ss->*sp_n).t0000.u0 = (ss->*bp_n).tFFFFFFFC.u0;
	(ss->*sp_n).wFFFFFFFE = 0x01B4;
	_printf(cx_n, dx_n, bx_n, ds, (ss->*sp_n).wFFFFFFFE);
	(ss->*bp_n).wFFFFFFFA = 0x00;
	(ss->*bp_n).tFFFFFFF8.u0.u0 = 0x01;
	while (true)
	{
		ci16 dx_n = (ss->*bp_n).wFFFFFFFA;
		Eq_n ax_n = (ss->*bp_n).tFFFFFFF8.u0;
		if (dx_n >= (ss->*bp_n).wFFFFFFFE && (dx_n > (ss->*bp_n).wFFFFFFFE || ax_n > ((ss->*bp_n).tFFFFFFFC).u0))
			break;
		_f0();
		ui32 v16_v14_n = (word32) (ss->*bp_n).tFFFFFFF8.u0.u0 + 1;
		(ss->*bp_n).tFFFFFFF8.u0 = (word16) v16_v14_n;
...
void ___pull_free_block(struct Eq_n * ds, Eq_n wArg02)
{
	...
	else
	{
		...
		ds->*((word16) (ds->t062A).u0 + 4) = si_n;
		(ds->*si_n).t0006.u0 = ds->t062A.u0;
	}
}
...
word16 fn0800-04F9(struct Eq_n * ds, Eq_n wArg02)
{
	...
	{
		ds->*((word16) ax_n + 2) = ds->t0628.u0;
		ds->*ax_n = (word16) wArg02 + 1;
		ds->t0628.u0 = ax_n;
		ax_n = (word16) ds->t0628.u0 + 4;
	}
	return ax_n;
}
...
word16 fn0800-0782(struct Eq_n * ds, struct Eq_n Eq_n::* wArg02)
{
	...
	Eq_n ax_n = (ds->*wArg02).t0008.u0;
	(ds->*wArg02).t000A.u0 = ax_n;
...
void _fgetc(struct Eq_n * ds, struct Eq_n Eq_n::* wArg02)
{
	...
	do
	{
		...
		if (v8_n >= 0x00)
		{
			(ds->*wArg02).t000A.u0 = (word16) (ds->*wArg02).t000A.u0 + 1;
			return;
		}
...
void _setvbuf(struct Eq_n * ds, struct Eq_n Eq_n::* wArg02, Eq_n wArg04, ci16 wArg06, cu16 wArg08)
{
	...
	(ds->*wArg02).t0008.u0 = &wArg02->b0004 + 1;
	(ds->*wArg02).t000A.u0 = &wArg02->b0004 + 1;
	...
	(ds->*wArg02).t000A.u0 = wArg04;
	(ds->*wArg02).t0008.u0 = wArg04;
...
void _fputc(struct Eq_n * ds, byte bArg02, struct Eq_n Eq_n::* wArg04)
{
	...
	(ds->*wArg04).t000A.u0 = (word16) (ds->*wArg04).t000A.u0 + 1;
	ds->*((word16) ((ds->*wArg04).t000A).u0 - 1) = bArg02;
			...
			if (al_n != 0x25)
			{
				...
				while (true)
				{
					...
					case 0x01:
						...
						break;
					case 0x02:
						ax_n = (ds->*wArg02_n).t0000.u0;
						wArg02_n = (union Eq_n Eq_n::*) &wArg02_n->t0002.u0;
						if (ch_n < 0x02)
						{
							wLoc94_n = ax_n;
							ch_n = 0x03;
...
l0800_nE5:
						...
						break;
					case 0x0A:
						dx_ax_n = (int32) (ds->*wArg02_n).t0000.u0;
						bLoc95_n = 0x01;
						ax_n = (word16) dx_ax_n;
						dx_n = SLICE(dx_ax_n, word16, 16);
...
l0800_nF1:
						...
						sp_n = sp_n - 2;
						(ss->*sp_n).t0000.u0 = dx_n;
						(ss->*sp_n).wFFFFFFFE = ax_n;
						(ss->*sp_n).ptrFFFFFFFC = fp - 0x89;
						ax_n.u0 = (int16) bh_n;
						(ss->*sp_n).tFFFFFFFA.u0 = ax_n;
						(ss->*sp_n).tFFFFFFF8.u0 = SEQ(SLICE(ax_n, byte, 8), bLoc95_n);
						(ss->*sp_n).tFFFFFFF6.u0 = bx_n;
						__LONGTOA(ds, (ss->*sp_n).tFFFFFFF6.u0, (ss->*sp_n).tFFFFFFF8.u0, (ss->*sp_n).tFFFFFFFA.u0, (ss->*sp_n).ptrFFFFFFFC, (ss->*sp_n).wFFFFFFFE, (ss->*sp_n).t0000.u0);
						(ss->*sp_n).t0000.u0 = ss;
						es_n = (ss->*sp_n).t0000.u0;
					...
					case 0x0E:
						sp_n = sp_n - 2;
						(ss->*sp_n).t0000.u0 = (ds->*wArg02_n).t0000.u0;
						di_n = fp - 0x8A;
						wArg02_n = (union Eq_n Eq_n::*) &wArg02_n->t0002.u0;
						if ((wLoc9A_n & 0x20) != 0x00)
						{
							(ss->*sp_n).tFFFFFFFE.u0 = (ds->*wArg02_n).t0002.u0;
							(ss->*sp_n).tFFFFFFFC.u0 = ss;
							es_n = (ss->*sp_n).tFFFFFFFC.u0;
							di_n = fn0800-1048(SEQ(es_n, fp - 0x8A), ds, (ss->*sp_n).tFFFFFFFE.u0);
							es_n->*di_n = 0x3A;
							wArg02_n = (struct Eq_n Eq_n::*) ((char *) &wArg02_n->t0002 + 2);
							di_n = di_n + 1;
						}
						(ss->*sp_n).tFFFFFFFE.u0 = ss;
						es_n = (ss->*sp_n).tFFFFFFFE.u0;
						di_n = fn0800-1048(SEQ(es_n, di_n), ds, (ss->*sp_n).t0000.u0);
						ds->*di_n = 0x00;
						sp_n = (struct Eq_n Eq_n::*) ((char *) &sp_n->t0000 + 2);
						wLoc9A_n = wLoc9A_n & ~0x04;
						di_n = di_n - (fp - 0x8A);
					...
					case 0x0F:
						...
						__REALCVT(ds);
						(ss->*sp_n).tFFFFFFF4.u0 = ss;
						wArg02_n = (struct Eq_n Eq_n::*) (wArg02_n + wLoc06_n /16 6);
						sp_n = sp_n - 0x0A;
						es_di_n = SEQ((ss->*sp_n).tFFFFFFF4.u0, fp - 0x89);
l0800_n:
...
l0800_n:
						...
						if (bLoc8F_n != 0x00 && es_n->*di_n != 0x2D)
						{
							...
							es_n->*di_n = bLoc8F_n;
							v41_n = wLoc8E_n - 0x01;
							wLoc8E_n = v41_n + (word16) (v41_n < 0x00);
						}
						cx_n = fn0800-108C(di_n, es_n);
						es_di_n = &(es_n->*di_n);
						goto l0800_n;
					case 0x10:
						...
						cx_n = 0x01;
						es_di_n = SEQ((ss->*sp_n).u0, fp - 0x89);
						goto l0800_n;
					case 0x11:
						if ((wLoc9A_n & 0x20) == 0x00)
						{
							di_n = (ds->*wArg02_n).t0000.u0;
							sp_n = sp_n - 2;
							(ss->*sp_n).u0 = ds;
							wArg02_n = (union Eq_n Eq_n::*) &wArg02_n->t0002.u0;
							v72_n = di_n != 0x00;
							es_di_n = SEQ((ss->*sp_n).u0, di_n);
						}
						else
						{
							es_di_n = (ds->*wArg02_n).t0000.u0;
						...
						if (!v71_n)
						{
							sp_n = sp_n - 2;
							(ss->*sp_n).u0 = ds;
							es_di_n = SEQ(Mem164[ss:sp_n + 0x00:selector], 0x04E2);
						}
						sp_n = sp_n;
...
void fn0800-1596(struct Eq_n * ds, Eq_n wArg02)
{
	if (ds->t062A.u0 != 0x00)
	{
		Eq_n di_n = ds->*((word16) (ds->t062A).u0 + 6);
		ds->*((word16) (ds->t062A).u0 + 6) = wArg02;
		ds->*((word16) di_n + 4) = wArg02;
		ds->*((word16) wArg02 + 6) = di_n;
		ds->*((word16) wArg02 + 4) = ds->t062A.u0;
	}
	else
	{
		ds->t062A.u0 = wArg02;
...
void fn0800-1606(struct Eq_n * ds)
{
	...
	{
		Eq_n si_n = ds->*((word16) (ds->t0628).u0 + 2);
...
void fn0800-165F(struct Eq_n * ds, Eq_n wArg02)
{
	...
	if ((ds->*di_n & 0x01) == 0x00 && wArg02 != (ds->t062C).u0)
	{
		ds->*di_n += ds->*wArg02;
...
void _free(struct Eq_n * ds, Eq_n wArg02)
{
	if (wArg02 != 0x00)
	{
		if ((word16) wArg02 + 0x0000FFFC == (ds->t0628).u0)
			fn0800-1606(ds);
		else
...
l0800_nA23:
					...
					Mem164[ss:fp - 0x0022 + (ax_n >>u 0x03):byte] = Mem162[ss:fp - 0x0022 + (ax_n >>u 0x03):byte] | ch_n;
					cu8 dl_n = al_n;
					Eq_n di_n = ax_n >> 0x03;
					while (true)
					{
						...
						if (al_n == 0x5D)
						{
							...
							while (true)
							{
								...
								bx = ax_n >> 0x03;
								Eq_n al_n = (ss->*fp).t0002.u0;
								if ((Mem216[ss:fp - 0x0022 + (ax_n >>u 0x03):byte] & 0x01 << (Mem216[ss:fp + 0x02:byte] & 0x07)) != 0x00)
								{
...
l0800_nAD3:
						...
						if (al_n != 0x00)
						{
							...
							do
							{
								...
								Mem391[ss:fp - 0x0022 + di_n:byte] = Mem389[ss:fp - 0x0022 + di_n:byte] | ch_n;
								--al_n;
							} while (al_n != 0x00);
						}
					}
...
l0800_nE:
							struct Eq_n * es_di_n = fn0800-1708(fp - 2, ds);
							es_di_n->t0000.u0 = (byte) ax_n;
							word16 di_n = (word16) es_di_n;
							es = SLICE(es_di_n, selector, 16);
							di = di_n + 2;
							if ((bLoc2B_n & 0x04) != 0x00)
							{
								es_di_n->t0002.u0 = (byte) dx;
								dx = ax_n;
								di = di_n + 4;
							}
						}
		...
		if (ax_n >= 0x00 && ds->*((word16) ax_n + 0x055A) == 0x01)
		{
			do
			{
				if ((byte) ax_n < 0x00 || ds->*((word16) ax_n + 0x055A) != 0x01)
				{
					...
					(ss->*sp_n).t0000.u0 = wArg06;
					(ss->*sp_n).tFFFFFFFE.u0 = ax_n;
					struct Eq_n Eq_n::* sp_n;
					SEQ(0x0800, wArg04)();
					word16 cx_n = (ss->*sp_n).w0002;
					--wLoc28_n;
				...
				(ss->*sp_n).tFFFFFFFE.u0 = wArg06;
				union Eq_n Eq_n::* sp_n;
				Eq_n ax_n;
				SEQ(0x0800, wArg02)();
				wLoc28_n.u1 = (word16) wLoc28_n.u1 + 1;
				Eq_n cx_n = (ss->*sp_n).u0;
...
word16 fn0800-1B06(struct Eq_n * ss_bp, Eq_n ds, ptr16 & bpOut)
{
	...
	do
	{
		...
		ci16 ax_n;
		word16 bx_n;
		SEQ(0x0800, ss_bp->t0004.u0)();
		sp_n = fp - 2;
		Eq_n al_n = ss_bp->t0004.u0;
		if (ax_n <= 0x00)
		{
			if (ax_n == 0x00)
				break;
...
l0800_nD1F:
							ds->*wArg0C += wLoc06_n;
							(ds->*wArg0E).u0 = wLoc04_n;
							Eq_n es_n = (ss->*sp_n).t0000.u0;
							struct Eq_n Eq_n::* sp_n = (char *) &sp_n->t0000 + 2;
							Eq_n di_n = (ss->*sp_n).t0000.u0;
							dxOut = dx_n;
							bxOut = wLoc04_n;
							diOut = di_n;
							esOut = es_n;
