...
fn00001390 proc
	lea	$-0014(a7),a7
	movem.l	d2-d6,-(a7)
	pea	$0318(pc)                                              ; 000016B0
	jsr.l	$00004068
	lea	$0028(a7),a0
	move.l	a0,-(a7)
	pea	$0324(pc)                                              ; 000016CC
	jsr.l	$00002E40
	move.l	$0030(a7),-(a7)
	pea	$031A(pc)                                              ; 000016D0
	jsr.l	$000016FC
	lea	$0028(a7),a0
	move.l	a0,-(a7)
	pea	$0326(pc)                                              ; 000016EC
	jsr.l	$00002E40
	lea	$0034(a7),a0
	move.l	a0,-(a7)
	pea	$031A(pc)                                              ; 000016F0
	jsr.l	$00002E40
	moveq	#$+01,d3
	lea	$0024(a7),a7
	bra	$0000168E
...
l00001C7C:
	lea	$03FC(pc),a6                                           ; 00002078
	bra	$00001C86

l00001C82:
	lea	$0406(pc),a6                                           ; 00002088
...
l00002612:
	...
	rts	
00002618                         48 E7 20 22 24 2F 00 10         H. "$/..
...
00002680 4C DF 44 04 4E 75 00 00                         L.D.Nu..       
