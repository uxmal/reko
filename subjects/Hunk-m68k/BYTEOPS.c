...
word32 fn00001390(Eq_n a3, ptr32 & a2Out, ptr32 & a3Out)
{
	...
	ptr32 a2_n;
	ptr32 a3_n;
	word32 d0_n = fn0000143C((uint32) (uint8) (byte) SEQ(SLICE(d2_n, word24, 8), SLICE((uint32) (uint8) SLICE(d2_n, byte, 0) << 0x05, byte, 0)), a3, 0x142C, out a2_n, out a3_n);
	a2Out = a2_n;
	a3Out = a3_n;
	return d0_n;
}
