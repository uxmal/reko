						...
						if (v88_n != 99)
						{
							...
							else
							{
								...
								else if (d4_n == 0x68)
								{
									struct Eq_n ** d0_n = __align((word32) d3_n + 3, 4);
									a0_n = (struct Eq_n *) *d0_n;
									a0_n->t0000.u0 = (int32) (word16) d6_n;
									d3_n = (char *) d0_n + 4;
								}
								else if (d4_n == 0x02)
								{
	...
	if (dwArg0C != null)
	{
		if (dwArg04 - dwArg0C >= 0x00)
		{
			...
			if (d5_n != 0x00)
			{
				...
				word32 * d2_n = __swap(SEQ(SLICE(d2_n, word16, 16), (word16) v41_v39_n));
				a0_n = d6_n;
				d1_n = d0_n;
			...
			else
			{
				...
				while (true)
				{
					...
					if (d5_n < null)
					{
						...
						--d1_n;
						d6_n = (word32) d5_d6_n;
						d5_n = __swap(SEQ(SLICE(d7_n, word16, 16), 0x00)) + SLICE(d5_d6_n, word32, 32);
					}
					if (bLoc26_n != 0x00)
						break;
