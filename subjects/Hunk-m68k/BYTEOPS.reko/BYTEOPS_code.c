...
word32 fn000012D0(ptr32 dwArg04)
{
	if (0x2CD0 != 0x00)
	{
		...
		for (d2_n = d2_n - 0x01; d2_n != 0x00; --d2_n)
		{
			...
			(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&((Eq_n[]) 0x2CD0)[d0_n].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0]();
		}
	}
...
word32 fn00001390(int32 d2)
{
	...
	struct Eq_n * d0_n = (uint32) (uint8) (byte) (d2_n - SEQ(v9_n, v11_n));
	struct Eq_n * d1_n = (uint32) (uint8) v11_n;
				...
				if (d0_n != 0x00)
				{
					...
					if (d7_n != null)
					{
						do
						{
							...
							d0_n = fn00001DD8(a7_n->tFFFFFFFC, a7_n->ptr0000, out a0_n, out a5_n);
							if (d0_n == ~0x00)
							{
								d0_n = d6_n;
								return d0_n;
...
struct Eq_n * fn00002AFA(struct Eq_n * d0, struct Eq_n * d1, struct Eq_n * d2, struct Eq_n & d1Out)
{
	...
	if (v9_n != 0x00)
	{
		...
		struct Eq_n * d0_n = SEQ((uint16) (d0_n % (uint16) d1_n), (word16) d2_n) - SEQ(SLICE(d2_n, word16, 16), v49_n) * (word16) d1_n;
		if (d0_n < null)
		{
