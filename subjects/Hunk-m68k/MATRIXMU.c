...
{
	struct Eq_4 * a6_9 = *(Eq_4 * *) 0x04;
	int32 d2_236 = d0;
	byte * a2_248 = a0;
	struct Eq_11 * a4_7 = (Eq_11 *) 0x948A;
...
{
	struct Eq_519 * a4_1 = (Eq_519 *) 0x948A;
...
{
	struct Eq_563 * a3_12 = (Eq_563 *) 0x14D0;
	if (0x14D0 != 0x00)
	{
		int32 d2_40 = 0x01;
		if (a3_12[0x04] != 0x00)
...
void fn0000131C(int32 dwArg04)
{
	...
	{
		struct Eq_609 * a3_29 = *(Eq_609 * *) 5336;
		*(int32 *) 0x14C4 = 0x01;
		if (a3_29 != null)
			do
			{
