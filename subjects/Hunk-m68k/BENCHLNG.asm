...
fn00001390 proc
	...
	lea	$0018(a7),a0
	move.l	a0,-(a7)
	pea	$00DE(pc)                                              ; 0000147C
	jsr.l	$00002BF0
	move.l	$0020(a7),-(a7)
	pea	$00D4(pc)                                              ; 00001480
	jsr.l	$000015A4
	lea	$0018(a7),a0
	move.l	a0,-(a7)
	pea	$00E0(pc)                                              ; 0000149C
	jsr.l	$00002BF0
	lea	$0024(a7),a0
	move.l	a0,-(a7)
	pea	$00D4(pc)                                              ; 000014A0
	jsr.l	$00002BF0
	moveq	#$+01,d3
	lea	$0020(a7),a7
	bra	$0000145A
...
l00001B24:
	lea	$03FC(pc),a6                                           ; 00001F20
	bra	$00001B2E

l00001B2A:
	lea	$0406(pc),a6                                           ; 00001F30
...
l000021C0:
	movem.l	(a7)+,d2
	rts	
000021C6                   00 00 20 2F 00 04 20 40 4A 80       .. /.. @J.
...
00002320 4E AE FF 2E 4C DF 7C 04 4E 75 00 00             N...L.|.Nu..   
