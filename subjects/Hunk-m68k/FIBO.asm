...
l000023AE:
	...
	rts	
000023B4             48 E7 20 22 24 2F 00 10 20 79 00 00     H. "$/.. y..
...
00002BD0 24 50 20 0A 66 E4 70 00 24 5F 4E 75             $P .f.p.$_Nu   
