...
int32 fn00001E90(Eq_n dwArg04, struct Eq_n * dwArg08, ui32 & a0Out, ptr32 & a1Out, ptr32 & a5Out)
{
	...
	if (dwArg08->ptr0008 == null)
	{
		...
		if ((dwArg08->dw0018 & 0x80) != 0x00)
			...
			d4_n = 1;
		word32 d1_n;
		word32 d0_n = fn00002050(d4_n + dwArg08->dw001C, out d1_n, out a0, out a1_n);
		if (d0_n == 0x00)
		{
			d0_n = -1;
			goto l00001F9E;
										...
										*a0_n = v265_n;
										...
										if (d0 == 0x78 && d6_n - d3_n >= 0x00)
										{
											...
											*a0_n = v280_n;
											...
											a7_n->dw004A = (word32) a7_n[0x0D];
											uint32 d0_n = (uint32) (&g_t28B1)[SEQ(SLICE(d0_n, word24, 8), a7_n->b0037) & 0xFF];
											d3_n = (word32) d3_n + 1;
											d4_n = d4_n + 0x01;
											d0 = d0_n & 0x44;
											if ((d0_n & 0x44) != 0x00 && d6_n - ((word32) d3_n + 1) >= 0x00)
...
l0000374E:
											...
											if (d6_n - d3_n >= 0x00)
											{
												...
												do
												{
													...
													a7_n->dw0048 = d1_n;
													if (((uint32) (&g_t28B1)[SEQ(a7_n->n0001, (byte) d5_n) & 0xFF] & 0x04) != 0x00)
														d4_n = d5_n - 0x30;
													else
														d4_n.u0 = 0;
													Eq_n d6_n;
					...
					else
					{
						...
						*a0_n = v431_n;
						...
						if (a7_n[11] != ~0x00)
						{
							...
							a7_n->tFFFFFFF4 = d5_n;
							d1 = (uint32) (a7_n->ptr0000 + fn000026E4(d2_n, a7_n->tFFFFFFF4, a7_n->tFFFFFFF8));
							a1 = a7_n->ptrFFFFFFFC;
							d0 = 1 << (d5_n & 7) & d1;
	...
	*((word32) dwArg04 + 24) |= 1;
	...
	if (*((word32) dwArg04 + 8) == 0x00)
	{
		...
		if ((*((word32) dwArg04 + 24) & 0x80) != 0x00)
			...
			d4_n = 1;
		word32 a0_n;
		word32 d0_n = fn00002050((word32) *((word32) dwArg04 + 28) + d4_n, out d1_n, out a0_n, out a1_n);
		if (d0_n == 0x00)
		{
			d0_n = -1;
			goto l00003DC2;
...
// 00003DC8: Register word32 fn00003DC8(Register out ptr32 a5Out)
// Called from:
//      fn00003CCC
word32 fn00003DC8(ptr32 & a5Out)
{
	struct Eq_n * a2_n;
	for (a2_n = *(struct Eq_n **) 0x3FFC; a2_n != null; a2_n = a2_n->ptr000C)
	{
