...
fn00001390 proc
	...
	lea	$0004(a7),a0
	move.l	a0,-(a7)
	pea	$004C(pc)                                              ; 000013E4
	jsr.l	$00002B40
	lea	$0008(a7),a0
	move.l	a0,-(a7)
	pea	$0040(pc)                                              ; 000013E8
	jsr.l	$00002B40
	lea	$0014(a7),a0
	move.l	a0,-(a7)
	lea	$0014(a7),a0
	move.l	a0,-(a7)
	pea	$002E(pc)                                              ; 000013EC
	jsr.l	$00002B40
	move.l	$0020(a7),-(a7)
	move.l	$0020(a7),-(a7)
	pea	$0024(pc)                                              ; 000013F4
	jsr.l	$000013FC
	lea	$0028(a7),a7
	addq.w	#$08,a7
	rts	
...
l0000197C:
	lea	$03FC(pc),a6                                           ; 00001D78
	bra	$00001986

l00001982:
	lea	$0406(pc),a6                                           ; 00001D88
...
l00002312:
	...
	rts	
00002318                         48 E7 20 22 24 2F 00 10         H. "$/..
...
00002380 4C DF 44 04 4E 75 00 00                         L.D.Nu..       
