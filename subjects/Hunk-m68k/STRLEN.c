...
{
	struct Eq_519 * a4_1 = (Eq_519 *) 37822;
...
{
	struct Eq_563 * a3_12 = (Eq_563 *) 0x1404;
	if (0x1404 != 0x00)
	{
		int32 d2_40 = 0x01;
		if (a3_12[0x04] != 0x00)
...
void fn0000131C(word32 dwArg04)
{
	if (*(word32 *) 5112 == 0x00)
	{
		struct Eq_609 * a3_29 = *(Eq_609 * *) 0x140C;
		*(int32 *) 5112 = 0x01;
		if (a3_29 != null)
			do
			{
