...
l00001ADC:
					...
					do
					{
						...
						*(a7_n - 24) = d6_n;
						int32 d1_n = fn000027B0(*(a7_n - 24), *(a7_n - 20), *(a7_n - 16), *(a7_n - 0x0C));
						ptr32 v191_n = *(a7_n - 8);
						word32 d1_n = *(a7_n - 4);
						...
						*(a7_n - 24) = d6_n;
						struct Eq_n * d1_n;
						word32 d0_n = fn00002560(*(a7_n - 24), *(a7_n - 20), *(a7_n - 16), *(a7_n - 0x0C), out d1_n, out a0_n);
						a1 = *(a7_n - 8);
						d6_n = d0_n;
						d7_n = d1_n;
...
l00001D2C:
				...
				if (d0_n != 0x00)
				{
					...
					if (d7_n != null)
					{
						do
						{
							...
							d0_n = fn00001F40(*(a7_n - 4), a7_n->ptr0000, out d1, out a0_n, out a1, out a5_n);
							if (d0_n == ~0x00)
							{
								d0_n = d6_n;
								goto l00001F08;
				...
				if ((a7_n[18] & 4) == 0x00)
				{
					...
					if (a7_n[0x0C] != 0x00)
					{
						...
						do
						{
							...
							*(a7_n - 8) = a0_n;
							if (fn00001F40(*(a7_n - 8), *(a7_n - 4), out d1, out a0_n, out a1, out a5_n) == ~0x00)
							{
								d0_n = d6_n;
								goto l00001F08;
							}
				...
				if (a7_n->t0066 != 0x00)
				{
					...
					do
					{
						...
						*a7_n = (struct Eq_n **) a5_n;
						...
						word32 a0_n;
						d0_n = fn00001F40(*(a7_n - 4), *a7_n, out d1, out a0_n, out a1, out a5_n);
						if (d0_n == ~0x00)
						{
							d0_n = d6_n;
							goto l00001F08;
			...
			else
			{
				...
				*(a7_n - 4) = (int32) (int16) (int8) SEQ(SLICE(d0, word24, 8), *a4_n);
				a4_n = (word32) a4_n + 1;
				word32 a0_n;
				d0 = fn00001F40(*(a7_n - 4), *a7_n, out d1, out a0_n, out a1, out a5_n);
...
void fn000021C8(ptr32 dwArg04)
{
	if (dwArg04 != 0x00 && globals->ptr3E58 != null)
		fn00002290(globals->ptr3E58, dwArg04 - 4, *(dwArg04 - 4) + 4);
}
