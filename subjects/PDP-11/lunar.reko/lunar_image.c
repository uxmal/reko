...
void fn0488()
{
	...
	word16 r2_n;
	fn114A(g_t006E, r1_n, out r2_n, out r3_n);
	ui32 r2_r3_n = <invalid>;
	uint32 r2_r3_n = r2_r3_n + (uint32) g_w0056;
	word16 r3_n;
	wchar_t r2_n = fn126C(600, SLICE(r2_r3_n, word16, 16), (word16) r2_r3_n, out r3_n);
	if (r3_n <= 0x00)
		r3_n = -r3_n;
	g_w005C += r3_n;
	g_w0056 = r2_n;
	...
	fn114A(g_t006E, r1_n, out r2_n, out r3_n);
	ui32 r2_r3_n = <invalid>;
	uint32 r2_r3_n = r2_r3_n + (uint32) g_w005A;
	word16 r3_n;
	wchar_t r2_n = fn126C(600, SLICE(r2_r3_n, word16, 16), (word16) r2_r3_n, out r3_n);
	if (r3_n <= 0x00)
		r3_n = -r3_n;
...
void fn053A()
{
	...
	ui32 r2_r3_n = <invalid>;
	uint32 r2_r3_n = r2_r3_n + (uint32) g_w0048;
	word16 r3_n;
	wchar_t r2_n = fn126C(0x3C, SLICE(r2_r3_n, word16, 16), (word16) r2_r3_n, out r3_n);
	if (r5_n <= 0x00)
		r3_n = -r3_n;
	g_w0046 += r3_n;
	g_w0048 = r2_n;
...
void fn0A0A()
{
	...
	else
	{
		...
		if (v15_n > 0x00)
			r4_n.u0 = 0x3F;
		Eq_n r4_n = __rcl<word16,int16,bool>(r4_n, 1, C_n);
		Eq_n r4_n = __rcl<word16,int16,bool>(r4_n, 1, (r4_n & 0x8000) != 0x00);
...
bool fn114A(Eq_n r0, Eq_n r1, union Eq_n & r2Out, union Eq_n & r3Out)
{
	...
	uint32 r2_r3_n;
	uint32 r2_r3_n;
	Eq_n r2_n = __rcl<word16,int16,bool>(r2_n, 1, C_n);
											...
											if ((r2_n & 0x8000) == 0x00)
											{
												...
												if ((r2_n & 0x8000) == 0x00)
												{
													...
													if ((r2_n & 0x8000) == 0x00)
													{
														...
														if ((r2_n & 0x8000) == 0x00)
														{
															r2_r3_n = SEQ(__rcl<word16,int16,bool>(r2_n, 1, C_n), 0x00);
															if ((r2_n & 0x8000) == 0x00)
															{
																r2_n.u0 = 0x00;
																C_n = false;
...
l122E:
														...
														Eq_n r3_n = (word16) v90_n;
														Eq_n r2_n = SLICE(v90_n, word16, 16);
														bool C_n = (r2_n & 0x8000) != 0x00;
														if ((r2_n & 0x8000) == 0x00)
														{
															uint32 r2_r3_n = v90_n + (uint32) r1;
...
Eq_n fn126C(Eq_n r0, Eq_n r2, wchar_t r3, union Eq_n & r3Out)
{
	...
	Eq_n r2_n;
	ui16 r3_n;
	Eq_n r2_n = __rcl<word16,int16,bool>(r2, 1, (bool) cond(r3 << 1)) - r0;
	if (r2_n <= 0x00)
	{
