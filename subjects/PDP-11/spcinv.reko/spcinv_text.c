...
l02A2:
	...
	while (true)
	{
		...
		if (r0_n >= 0x00)
		{
			g_w1174 = g_w1170;
			++pc->w0E52;
			word16 v36_n = ~g_w0EF4;
			g_w0EF6 = v36_n;
			if (v36_n == 0x00)
				g_w0EF8 = ~g_w0EF6;
			if (g_ptr0EFA != null)
			{
				word16 v42_n = g_ptr0EFA - 0x01;
				g_w0EFC = v42_n;
				if (v42_n != 0x00)
					goto l0370;
				if (g_w0F18 == 0x00)
										...
										if (r3_n != 0x00)
										{
											if (r3_n >= 0x00)
											{
												if ((word16) r3_n + 4 - (&(r5_n.u1)->u0)[0x0EF0] <= 0x00)
												{
													...
													wchar_t v70_n = g_w0F12 - 0x01;
													g_w0F14 = v70_n;
													if (v70_n <= 0x00 && g_t0F02.u1 <= 0x00)
													{
														g_ptr0EFA = null;
														g_w0EFC = 0x05;
													}
...
{
	struct Eq_n * r5;
	cup16 v12_n = 0x04 - (r3 - g_t0F02.u1);
	...
	else
	{
		...
		Eq_n v28_n = pc->t090A.u0 >> 1;
		pc->t090A.u0 = (int16) v28_n;
		if (v28_n >= 0x00)
