...
void fn0CF4(struct Eq_n * r5)
{
	...
	if (r5->b0000 == 0x01)
	{
		...
		struct Eq_n * r0_n = fn0D3E(r0_n, tLoc08.t0004.u1);
		r0_n->b0000 = 0x2D;
		r0_n->b0001 = r1_n->b0D4F;
		r0_n->b0002 = r1_n->b0D50;
		r0_n->b0003 = r1_n->b0D51;
		r0_n->b0004 = 0x2D;
		Eq_n v35_n = tLoc08.t0006.u1;
...
struct Eq_n * fn0D3E(struct Eq_n * r0, Eq_n r2)
{
	...
	r0->t0002.u1 = (struct Eq_n *) __swab((word16) r2_n + 0x00003A2F);
...
void fn0F48(struct Eq_n * r5)
{
	if (r5->b0000 == 0x02)
	{
		...
		if (r1_n != 0x00)
		{
			r0_r1_n = SEQ(__rcl<word16,byte>(r0_n, 0x01, (bool) cond(r1_n << 1)) + Mem0[v13_n + 0x00:word16], r1_n << 1) + SEQ(Mem0[v15_n + 0x00:word16], Mem0[v15_n + 0x00:word16]);
			uint16 r1_n = (word16) r0_r1_n;
		...
		v13_n->u1 = SLICE(r0_r1_n, word16, 16);
...
void fn12CA(ptr16 r2, struct Eq_n * r3)
{
	...
	Eq_n v18_n = r4_n->t0000.u1 & 0x20;
	r4_n->t0000.u1 = (ci16) v18_n;
	int16 r0_n = 0x0A;
	if (v18_n != 0x00)
	{
		++r1_n;
...
l132A:
			if (r4_n->t0000.u0 <= 0x00)
			{
				...
				{
					Eq_n r5_n = (int16) r3->ptr001C->u1;
					r3->ptr001C->u2 = (ptr16) 0x80;
					PRINT(r1_n);
					r3->ptr001C->u2 = (ptr16) r5_n;
				}
			}
			else
			{
...
void fn14A8(Eq_n r2, uint16 r5)
{
	...
	struct Eq_n * r0_n = fn1420(r2, r3_n);
	r3_n->ptr0014 = r0_n;
	cui16 v13_n = r0_n->t0000.u1 & 0x0800;
	r0_n->t0000.u1 = v13_n;
	if (v13_n != 0x00)
	{
		word16 * wLoc08_n;
		if (r0_n->t0000.u0 >= 0x00)
		{
			...
			ci16 v20_n = r4_n->t0000.u1 & 0x0200;
			r4_n->t0000.u1 = v20_n;
			if (v20_n != 0x00)
			{
				...
				if (v22_n != 0x00)
				{
					...
					ci16 v25_n = r4_n->t0000.u1 & 0x0100;
					r4_n->t0000.u1 = v25_n;
					if (v25_n != 0x00)
					{
			...
			r3_n->t0010.u1 = (struct Eq_n *) (r3_n->t0010.u1 & ~r0_n);
		}
		else
...
word16 fn1836(struct Eq_n * r3, struct Eq_n * r4, ptr16 & r2Out, struct Eq_n & r3Out, struct Eq_n & r4Out)
{
	...
	if (r4[0x0D] - r4[11] >= 0x00)
		r4[0x0D] = r4[11];
	Eq_n v19_n = r4->t0000.u1 & 0x40;
	r4->t0000.u1 = (ci16) v19_n;
	if (v19_n != 0x00)
	{
...
word16 fn1900(struct Eq_n * r3, struct Eq_n * r4, struct Eq_n & r3Out, struct Eq_n & r4Out)
{
	...
	{
		r4->t0000.u1 &= 0x7FFD;
		cui16 v12_n = r4->t0000.u1 & 0x4000;
		r4->t0000.u1 = v12_n;
		if (v12_n != 0x00)
...
{
	ci16 v7_n = r0->t0000.u1 & 0x4000;
	r0->t0000.u1 = v7_n;
	struct Eq_n * r4_n = r0;
	if (v7_n != 0x00)
	{
		ci16 v9_n = r0->t0000.u1 & 0x02;
		r0->t0000.u1 = v9_n;
		if (v9_n == 0x00)
			goto l1D84;
		r0->t0000.u1 &= ~0x02;
	...
	else
	{
		if (r0->t0000.u1 > 0x00)
			goto l1D84;
		ci16 v15_n = r0->t0000.u1 & 0x0200;
		r0->t0000.u1 = v15_n;
		if (v15_n != 0x00)
		{
			cui16 r2_n = r0[7];
			byte * r2_n = (word16) r0[1].t0000 + r2_n;
			ci16 v21_n = r0->t0000.u1 & 0x2000;
			r0->t0000.u1 = v21_n;
			if (v21_n != 0x00)
				*r2_n = 0x00;
			else
...
void fn4078(struct Eq_n * pc)
{
	...
	*g_ptr5426 = 0x0D;
	...
	g_b57DD = 0x59;
	++*g_ptr5426;
	g_t57DE.u1 = (byte) (int16) g_t57E0.u1;
	++*g_ptr5426;
	g_t57DF.u1 = (byte) (int16) g_t57DE.u1;
	++*g_ptr5426;
	fn4534(&g_w534E);
	++*g_ptr5426;
}
