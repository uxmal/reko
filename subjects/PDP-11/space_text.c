	...
	if ((byte) r1 == 0x3D || (byte) r1 == 0x3F)
	{
		...
		while (true)
		{
			...
			do
			{
				...
				r0_n = SLICE(r0_r1_n << 0x01, word16, 16);
				C_n = (r0_n & 0x80) != 0x00;
				r0_r1_n = SEQ(r0_n, r1_n << 0x01);
...
void fn0670(Eq_n r5, <anonymous> * wArg00, cui16 wArg02, Eq_n wArg04, cui16 wArg06, Eq_n wArg08)
{
	...
	*((word16) r4_n + 42) = wArg00;
	...
	cui16 r1_n = (word16) r0_r1_n;
	Eq_n r0_n = SLICE(r0_r1_n << 0x01, word16, 16);
...
l06B0:
	...
	while (true)
	{
		...
		if ((r0_n & 0x8000) != 0x00)
		{
			r2_r3_n = r2_r3_n + (r4_r5_n >> 0x01);
			r4_r5_n = r4_r5_n >> 0x01;
			r0_r1_n = SEQ(r0_n, r1_n << 0x01);
		}
	}
	uint16 r0_n = SLICE(r0_r1_n << 0x01, word16, 16);
	uint32 r4_r5_n = r4_r5_n >> 0x01;
	uint32 r4_r5_n = r4_r5_n >> 0x01;
	if ((r0_n & 0x8000) != 0x00)
	{
l0700:
	...
	{
l0724:
		uint32 r2_r3_n = SEQ((word16) r4_n + __swab(SEQ(SLICE(r2_n, byte, 8), 0x00)), __swab(SEQ(SLICE(__rcl<word16,byte>(r3_n, 0x01, C_n), byte, 8), 0x00) | r2_n)) + (uint32) __rcl<word16,byte>(r1_n << 0x01, 0x01, (r3_n & 0x80) != 0x00);
		r3_n = (word16) r2_r3_n;
		r2_n = SLICE(r2_r3_n, word16, 16);
l0738:
		(*((word16) r4_n + 42))();
...
void fn07BA(ui32 r4_r3, ui32 r5_r1, Eq_n r0, word16 wArg00, word16 * wArg04)
{
	...
	do
	{
		cui16 r3_n = (word16) r4_r3_n;
		ui16 r4_n = SLICE(r4_r3_n << 0x01, word16, 16);
		Eq_n C_n;
		ui32 r4_r3_n;
		if ((SLICE(r4_r3_n, word16, 16) & 0x80) == 0x00)
		{
			...
			C_n = cond(v13_n) & 0x01;
			r4_r3_n = SEQ(r4_n, r3_n << 0x01);
			if (v13_n > 0x00)
				goto l07CE;
			if (v13_n != 0x00)
				goto l07C6;
			cup16 v17_n = r1 - (r3_n << 0x01);
			C_n = cond(v17_n) & 0x01;
			r4_r3_n = SEQ(r4_n, r3_n << 0x01);
			if (v17_n > 0x00)
				goto l07CE;
			...
			do
			{
				...
				while (true)
				{
					...
					if (v32_n >= 0x00)
						break;
					--r2_n;
					r0_r1_n = SEQ(SLICE(r0_r1_n << 0x01, word16, 16), r1_n << 0x01);
				}
				if (v32_n == 0x00)
					break;
				++r2_n;
...
uint16 fn0F48(struct Eq_n * r5, union Eq_n & r1Out, struct Eq_n & r5Out)
{
	...
	if (r5->b0000 == 0x02)
	{
		...
		if (r1_n != 0x00)
		{
			r0_r1_n = SEQ(SLICE(SEQ(r0_n, r1_n) << 0x01, word16, 16) + *v14_n, r1_n << 1) + SEQ(*v16_n, *v16_n);
		...
		*v16_n = (word16) r0_r1_n;
		...
		Eq_n r1_n = __swab(SEQ(SLICE(r1_n << 0x01, byte, 8), 0x00) | r0_n);
...
void fn172C(struct Eq_n * r0, uint16 r2)
{
	...
	while (true)
	{
		...
		if (r3_n >= 0x00)
		{
			...
			r4_r1_n += r5_r2_n;
		r5_r2_n = SEQ(SLICE(r5_r2_n << 0x01, word16, 16), r2_n << 0x01);
	}
}
