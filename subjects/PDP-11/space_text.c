...
l07B6:
				...
				do
				{
					...
					{
						cup16 v41_n = r4_n - r5_n;
						C_n = (bool) cond(v41_n);
						if (v41_n > 0x00)
							goto l07CE;
						if (v41_n != 0x00)
							goto l07C6;
						cup16 v42_n = r3_n - wArg04;
						C_n = (bool) cond(v42_n);
						if (v42_n > 0x00)
							goto l07CE;
						if (v42_n >= 0x00)
...
void fn0E0E(<anonymous> * wArg00, word16 wArg02, word16 wArg04, word16 wArg06, word16 wArg08)
{
	struct Eq_n * r4_n = g_ptr5424;
	r4_n->ptr002A = wArg00;
	cup16 v19_n = wArg02 - wArg06;
	bool v25_n = v19_n >= 0x00;
	if (v19_n == 0x00)
	{
		cup16 v21_n = wArg04 - wArg08;
		v25_n = v21_n >= 0x00;
		if (v21_n == 0x00)
		{
l0E7C:
