...
void fn0754(<anonymous> * wArg00, Eq_n wArg02, Eq_n wArg04, cui16 wArg06, uint16 wArg08)
{
	...
	if (wArg06 << 1 != 0x00)
	{
		Eq_n v25_n = (word16) v23_n + (word16) (wArg06 << 1 < 0x00);
		wchar_t r2_n = SEQ(SLICE(wArg06 << 1, byte, 8), 0x00);
...
void fn0B02(struct Eq_n * r3, <anonymous> ** r4, uint16 wArg00, word16 wArg04, struct Eq_n * wArg06, struct Eq_n * wArg08, <anonymous> * wArg0A)
{
	...
	r3->w00A4 = wArg00 + (word16) (bArg05 - bArg04 > bArg05);
	if (r3->b0074 == 0x00)
	{
		r3->w0052 = wArg04;
		r3->ptr0044 = wArg08;
...
void fn0B60(struct Eq_n * r0, word16 wArg00, struct Eq_n * wArg02, struct Eq_n * wArg04, word16 * ptrArg06)
{
	...
	word16 * sp_n;
	<anonymous> ** sp_n;
	r3_n->w00A4 = wLoc04_n + (word16) (bArg01 - bArg00 > bArg01);
	if (r3_n->b0074 != 0x00)
	{
		r3_n->w0052 = wArg00;
		r3_n->ptr0044 = wArg02;
...
word16 fn1420(Eq_n r2, struct Eq_n * r3)
{
	...
	do
	{
		...
		if (r1_n->b0000 - r2 == 0x00)
			goto l144A;
	} while (r3->ptr0002 - r1_n > r3->ptr0002);
	r1_n = v14_n;
	do
	{
		++r1_n;
			...
			*sp_n = r2_n;
			...
			do
			{
				*r2_n = *r0_n;
				++r0_n;
				++r2_n;
			} while (r3_n->w000C - r0_n > r3_n->w000C);
			r3_n->w000C -= r5_n << 1;
	...
	if (r5_n + 1 - r4_n > 0x00)
	{
		...
		if (r5_n + 1 - (r4_n - 0x38) > 0x00)
		{
			...
			if (r5_n + 1 - (r4_n - 0x38) > 0x00)
			{
				...
				{
					FnSubfn(&g_t03B8);
					if (false && (g_w53EA - sp_n->wFFFFFFE8 <= g_w53EA && (t0000.w0022 + 0x1000) - (r4_n - 0x38) <= 0x00))
						goto l0372;
				}
