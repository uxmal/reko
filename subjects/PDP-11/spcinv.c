...
void fn06A2()
{
	if (globals->ptr0F0A != 0x00)
	{
		...
		for (; r5_25 >= null; r5_25 = r5_25 - 0x01)
		{
		...
		do
		{
			...
			if (r0_185 != 0x00)
			{
				if (globals->w0EFC != 0x00)
				{
					...
					Eq_14 r3_399 = 0x08;
					for (; r3_399 != 0x00; r3_399 = r3_399 - 0x01)
					{
...
ptr16 fn0BD6(ptr16 & r2Out)
{
	...
	word16 r0_18 = 0x06;
	for (; r0_18 != 0x00; r0_18 = r0_18 - 0x01)
	{
		word16 r2_19 = 0x0A;
		do
		{
...
void fn0C20(Eq_14 r3, Eq_3 * r5, Eq_4 * pc)
{
	...
	word16 r0_15 = 0x06;
	Eq_768 r2_13 = 0x05;
	for (; r0_15 != 0x00; r0_15 = r0_15 - 0x01)
	{
		*r1_12 = (word16) r2_13;
		r1_12 = r1_12 + 0x01;
	...
	word16 r0_20 = 0x08;
	ptr16 r2_21 = 11;
	for (; r0_20 != 0x00; r0_20 = r0_20 - 0x01)
	{
	...
	word16 r0_44 = 0x10;
	for (; r0_44 != 0x00; r0_44 = r0_44 - 0x01)
	{
		*r1_43 = (word16) 0x00;
		r1_43 = r1_43 + 0x01;
	}
