...
void fn0200(Eq_2 r4, Eq_3 * r5, Eq_4 * pc)
{
	...
	ptr16 r2_118;
	Eq_99 r1_110 = fn0BD6(out r2_118);
l02A2:
	fn0C20(r3_115, r5, pc);
	while (true)
	{
		...
		if (r0_101 >= 0x00)
		{
			...
			if (globals->ptr0EFA != 0x00)
			{
				...
				Eq_2 r4_333;
				struct Eq_3 * r5_334;
				Eq_137 r0_335 = fn0486(r0_101, r1_110, r3_115, r4, r5, bArg00, out r3_332, out r4_333, out r5_334);
				globals->w0F16 = 0x02;
				r4 = fn0470(r0_335, r1_110, r2_118, r3_332, r4_333, r5_334, bArg00);
				globals->w0F18 = 0x78;
			}
...
l0370:
			Eq_2 r4_246;
			struct Eq_3 * r5_247;
			Eq_99 r1_248 = fn04A0(r1_110, r4, pc, out r4_246, out r5_247);
			Eq_99 r1_250;
			Eq_14 r3_251;
			Eq_2 r4_252;
			struct Eq_3 * r5_253;
			Eq_137 r0_254 = fn07A6(fn06D6(r1_248, r4_246, r5_247, pc), pc, out r1_250, out r3_251, out r4_252, out r5_253);
			r0_101 = fn0998(r0_254, r1_250, r3_251, r4_252, r5_253, pc, bArg00, out r1_110, out r2_118, out r3_115, out r4, out r5);
			if (0x1178 - r4 != 0x00)
				goto l038E;
...
l03E6:
			...
			Eq_2 r4_180;
			struct Eq_3 * r5_181;
			Eq_137 r0_182 = fn0486(r0_101, r1_110, r3_115, r4, r5, bArg00, out r3_179, out r4_180, out r5_181);
			struct Eq_409 * sp_183 = sp_119 - 0x01;
			sp_183->b0000 = 0x01;
			sp_183->b0001 = 0x18;
			Eq_2 r4_189;
			struct Eq_3 * r5_190;
			fn0AB6(r0_182, r1_110, r3_179, r4_180, r5_181, out r4_189, out r5_190);
			Eq_2 r4_193;
			struct Eq_3 * r5_194;
			Eq_137 r0_195 = fn0AE8(r0_182, r4_189, r5_190, wLoc02, out r4_193, out r5_194);
			*(r1_110 - 0x02) = (union Eq_2 *) r4_193;
			word16 r4_201;
			word16 r5_202;
			fn0AE8(r0_195, r4_193, r5_194, wLoc02, out r4_201, out r5_202);
		}
		if (0x1178 - r4 == 0x00)
			continue;
l038E:
		r3_115 = fn0AF6(r1_110, r3_115, r4, r5, bArg00, out r4, out r5);
l0392:
	}
	globals->u02CB = r0_90;
	word16 * r1_360 = &globals->w02C6;
	do
	{
		r1_360 = r1_414 + 0x01;
		word16 * r1_414 = r1_360;
	} while (*r1_414 - r0_90 != 0x00);
	struct Eq_171 * r1_370 = r1_360 - 711 << 0x01;
	word16 sp_372;
	word16 r2_373;
	byte NZ_374;
	bool V_375;
...
l0524:
					...
					do
					{
						...
						if (r3_233 != 0x00)
						{
							...
							{
								struct Eq_864 * sp_310 = sp_1 - 0x01;
								...
								*(sp_310 - 0x01) = (union Eq_902 *) (r3_325 + 0x01);
...
// 05D4: FlagGroup bool fn05D4(Register Eq_137 r0, Register Eq_99 r1, Register Eq_14 r3, Register Eq_2 r4, Register (ptr Eq_3) r5, Register (ptr Eq_4) pc, Stack byte bArg00, Register out Eq_763 r0Out, Register out Eq_764 r1Out, Register out ptr16 r3Out, Register out ptr16 r4Out, Register out (ptr Eq_767) r5Out)
bool fn05D4(Eq_137 r0, Eq_99 r1, Eq_14 r3, Eq_2 r4, Eq_3 * r5, Eq_4 * pc, byte bArg00, Eq_763 & r0Out, Eq_764 & r1Out, ptr16 & r3Out, ptr16 & r4Out, Eq_767 * & r5Out)
{
	*r3Out = r3;
	*r1Out = r1;
	*r4Out = r4;
...
// 064A: FlagGroup bool fn064A(Register Eq_137 r0, Register Eq_99 r1, Register Eq_14 r3, Register Eq_2 r4, Register (ptr Eq_3) r5, Register out ptr16 r0Out, Register out ptr16 r4Out, Register out (ptr Eq_748) r5Out)
bool fn064A(Eq_137 r0, Eq_99 r1, Eq_14 r3, Eq_2 r4, Eq_3 * r5, ptr16 & r0Out, ptr16 & r4Out, Eq_748 * & r5Out)
{
	*r5Out = r5;
	*r0Out = r0;
	*r4Out = r4;
	struct Eq_1227 * r2_10 = globals->w0F06;
	do
	{
		bool Z_30;
		if (r2_10[0x0EE6] - r3 == 0x00 && r2_10[0x0EEC] >= 0x00)
		{
			...
			r2_10[0x0EE6] = (struct Eq_1227) 0x00;
			Z_30 = true;
			return Z_30;
		}
l0676:
...
// 067C: FlagGroup bool fn067C(Register Eq_137 r0, Register Eq_14 r3, Register Eq_2 r4, Register (ptr Eq_3) r5, Stack byte bArg00, Register out Eq_724 r0Out, Register out Eq_725 r1Out, Register out (ptr Eq_726) r3Out, Register out ptr16 r4Out, Register out (ptr Eq_728) r5Out)
bool fn067C(Eq_137 r0, Eq_14 r3, Eq_2 r4, Eq_3 * r5, byte bArg00, Eq_724 & r0Out, Eq_725 & r1Out, Eq_726 * & r3Out, ptr16 & r4Out, Eq_728 * & r5Out)
{
	*r3Out = r3;
	*r0Out = r0;
	*r5Out = r5;
	*r4Out = r4;
	struct Eq_1292 * r1_7 = (word16) r0 + (r3 - 0x01 << 0x01);
	*r1Out = r1_7;
...
void fn06A2()
{
	...
	{
		struct Eq_1347 * r5_25 = globals->ptr0F04;
		do
		{
			if (r5_25[0x0EF0] == 0x00)
			{
				...
				if (0x08 - r0_37 >= 0x00)
				{
					r5_25[0x0EF0] = (struct Eq_1347) (r0_37 + 0x02);
					r5_25[0x0EF3] = (struct Eq_1347) 0x18;
					globals->u0F0C = 0x00;
				}
				return;
			}
...
{
	struct Eq_1384 * sp_1 = fp;
	struct Eq_1386 * r2_25 = globals->w0F06;
	do
	{
		...
		if (r3_28 != 0x00)
		{
			...
			if (r2_25[0x0EEC] >= 0x00)
			{
				...
				sp_1[0x01] = (struct Eq_1384) r0_57;
				byte * r4_188;
			...
			else
			{
				...
				r2_25[0x0EEC] = (struct Eq_1386) (r2_25[0x0EEC] & ~0x80);
			}
			r2_25[0x0EE9] = (struct Eq_1386) ((byte) r2_25[0x0EE9] + 0x01);
...
l078A:
			...
			{
l0784:
				r2_25[0x0EE6] = (struct Eq_1386) 0x00;
			}
		}
l07A0:
		r2_25 = r2_25 - 0x01;
	...
	*r3Out = r3;
	...
	if (v5 == 0x00)
	{
		...
		*r5Out = 0x00;
		do
		{
			struct Eq_1722 * r2_183 = globals->w0F1A;
			r0 = r2_183->t0DB8;
			if (r0 != 0x00)
			{
...
l08B2:
	if (globals->w0F12 != 0x00)
	{
		...
		if (v38_49 != 0x00)
		{
			struct Eq_1784 * r2_54 = globals->w0F06;
			do
			{
				if (r2_54[0x0EE6] == 0x00)
				{
					...
					r2_54[0x0EE6] = (struct Eq_1784) (r3_111 + 0x02);
					r2_54[0x0EE9] = (struct Eq_1784) *((byte) r0_101.u0 + 0x0C);
					r2_54[0x0EEC] = (struct Eq_1784) 0x80;
					word16 r3_112;
					*r3Out = r3_111 + 0x02;
					if (3500 - r0_101 != 0x00)
					{
					...
					{
l0936:
						r2_54[0x0EEC] = (struct Eq_1784) ((byte) r2_54[0x0EEC] + 0x01);
					}
					return r0_101;
				}
				r2_54 = r2_54 - 0x01;
...
void fn093C(Eq_137 r0, Eq_99 r1, Eq_14 r3)
{
	...
	if (globals->w0F20 >= 0x00)
		r3_17 = r3_7 - 0x02;
	struct Eq_2127 * r3_21 = (word32) r0 + (r3_17 << 0x01) - 22 + 0x0E40;
...
// 0AB6: Register Eq_14 fn0AB6(Register Eq_137 r0, Register Eq_99 r1, Register Eq_14 r3, Register Eq_2 r4, Register (ptr Eq_3) r5, Register out ptr16 r4Out, Register out (ptr Eq_430) r5Out)
Eq_14 fn0AB6(Eq_137 r0, Eq_99 r1, Eq_14 r3, Eq_2 r4, Eq_3 * r5, ptr16 & r4Out, Eq_430 * & r5Out)
{
	byte * r4_6;
	word16 r5_7;
	Eq_137 r0_8 = fn0AE8(r0, r4, r5, wLoc02, out r4_6, out r5_7);
...
// 0AE8: Register Eq_137 fn0AE8(Register Eq_137 r0, Register Eq_2 r4, Register (ptr Eq_3) r5, Stack word16 wArg00, Register out ptr16 r4Out, Register out (ptr Eq_444) r5Out)
Eq_137 fn0AE8(Eq_137 r0, Eq_2 r4, Eq_3 * r5, word16 wArg00, ptr16 & r4Out, Eq_444 * & r5Out)
{
...
// 0AF6: Register Eq_14 fn0AF6(Register Eq_99 r1, Register Eq_14 r3, Register Eq_2 r4, Register (ptr Eq_3) r5, Stack byte bArg00, Register out ptr16 r4Out, Register out ptr16 r5Out)
Eq_14 fn0AF6(Eq_99 r1, Eq_14 r3, Eq_2 r4, Eq_3 * r5, byte bArg00, ptr16 & r4Out, ptr16 & r5Out)
{
	byte * r4_16;
	word16 r5_17;
	Eq_14 r3_18 = fn0AB6(globals->w0F14 + 0x02, r1, r3, r4, r5, out r4_16, out r5_17);
	*r4_16 = 0x80;
	PRINT(&globals->b1178);
	word16 r4_22;
	*r4Out = 0x1178;
...
// 0B1A: Register Eq_137 fn0B1A(Register Eq_99 r1, Register Eq_2 r4, Register (ptr Eq_3) r5, Stack byte bArg00, Register out Eq_1018 r1Out, Register out ptr16 r3Out, Register out ptr16 r4Out, Register out (ptr Eq_1021) r5Out)
Eq_137 fn0B1A(Eq_99 r1, Eq_2 r4, Eq_3 * r5, byte bArg00, Eq_1018 & r1Out, ptr16 & r3Out, ptr16 & r4Out, Eq_1021 * & r5Out)
{
...
void fn0C20(Eq_14 r3, Eq_3 * r5, Eq_4 * pc)
{
	...
	struct Eq_2911 * r1_18 = null;
	word16 r0_20 = 0x08;
	ptr16 r2_21 = 11;
	do
	{
		r1_18[1776] = (struct Eq_2911) r2_21;
		r1_18[0x06F8] = (struct Eq_2911) r2_21;
		r1_18[0x0700] = (struct Eq_2911) r2_21;
		r1_18[1800] = (struct Eq_2911) r2_21;
		r1_18[1808] = (struct Eq_2911) r2_21;
		r1_18[1816] = (struct Eq_2911) r2_21;
		r1_18[0x06E2] = (struct Eq_2911) 0x06;
		r1_18 = r1_18 + 0x01;
		r2_21 = r2_21 + 0x08;
		r0_20 = r0_20 - 0x01;
	} while (r0_20 != 0x00);
