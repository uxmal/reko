...
hexagon_nn_skel_invoke proc
	{ allocframe(0x78); memd(r29-16) = r17:r16; r2 = add(PC,0x218D0) }
	...
	{ r19 = memw(r2-320); p0 = cmp.gtu(r3,0x14) }
...
allocate_graph_storage proc
	{ allocframe(0x20); r3 = 0x60000000; r2 = 0x80 }
...
l0000A71C:
	...
	{ r5:r4 = combine(0x0,0x0); r19 = r0; r2 = add(PC,0x209EC) }
	{ r1:r0 = combine(0x0,r16) }
	{ r6 = memw(r2-208); r3:r2 = combine(0x0,0xD) }
	{ r6 = memw(r6+52) }
...
l0000A75C:
	{ r2 = r16; r1 = 0xF9; r3 = add(PC,0x1AC02) }
	{ call errlog_function }
	{ r2 = r16; r1 = 0x110; r3 = add(PC,0x1ABE1) }
	{ call errlog_function }
	{ r1 = 0x14C; jump 0000A8E0; r3 = add(PC,0x1AA48) }
...
l0000A7C0:
	...
	{ p0 = cmp.eq(r0,0x0); r1 = 0x14E; r3 = add(PC,0x1AA16) }
...
l0000A800:
	...
	{ p0 = cmp.eq(r0,0x0); r1 = 0x155; r3 = add(PC,0x1A9E1) }
...
l0000A834:
	{ r2 = r16 }
	{ r1 = 0x156; jump 0000A8E0; r3 = add(PC,0x1A9BD) }
...
l0000A878:
	{ jump 0000A830; r3 = add(PC,0x1A9BA) }

l0000A884:
	{ memw(r29+4) = r0; r3:r2 = combine(0x2,r16); r4 = add(PC,0x1A9BF) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x1A875) }
...
l0000A9F4:
	{ r2 = memw(r19+8); r1 = 0x127; r4 = add(PC,0x1A8F1) }
...
l0000AA98:
	{ r1 = 0x131; jump 0000A9E8; r3 = add(PC,0x1A85D) }

l0000AAA8:
	{ memw(r29+4) = r22; r5 = memw(r21+20); r4 = add(PC,0x1A85A) }
...
check_allocations proc
	{ allocframe(#0x18); r1 = 0xB8; r4 = add(PC,0x1A7C6) }
...
l0000AB38:
	{ r2 = r16; r1 = 0xBE; r3 = add(PC,0x1A739) }
	{ call errlog_function }
...
l0000AC30:
	{ r2 = r18; r1 = 0xA0; r3 = add(PC,0x1A70D) }
	{ call errlog_function }
	{ jump 0000ACC4 }
...
l0000ADAC:
	{ r1 = 0x2000000; r0 = 0x80 }
	{ call fn00009550 }
	{ memb(r17+1) = r18.new; r18 = r0 }
	{ if (!p0.new) memw(r17+8) = 0x2000000 }
...
hexagon_nn_getlog proc
	{ allocframe(0x10); r4 = 0xE; r3 = add(PC,0x1A541) }
...
hexagon_nn_snpprint proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r3 = add(PC,0x1A4D9) }
...
l0000AEF8:
	{ r1 = 0x87; r2 = 0x0; r3 = add(PC,0x1A49F) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x1A463) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0000AF48:
	{ r1 = 0x98; r2 = 0x0; r3 = add(PC,0x1A44F) }
...
l0000AF9C:
	{ r1 = 0xB4; r2 = 0x0; r3 = add(PC,0x1A3FB) }
...
l0000B004:
	{ r1 = 0xD5; r2 = 0x0; r3 = add(PC,0x1A393) }
...
l0000B078:
	...
	{ r6 = add(r29,0x10); r1 = 0xDA; r4 = add(PC,0x1A362) }
	{ memw(r29+4) = r6; call logv }
...
l0000B0D4:
	{ r1 = 0xF9; r2 = 0x0; r3 = add(PC,0x1A2C3) }
	{ jump 0000B100 }
...
l0000B158:
	{ r1 = 0x10B; r2 = 0x0; r3 = add(PC,0x1A23F) }
	{ memw(r29) = 0x0; call errlog_function }
	{ dealloc_return; r0 = #-0x1 }
...
l0000B1AC:
	{ r1 = 0x117; r2 = 0x0; r3 = add(PC,0x1A1EB) }
	{ call errlog_function }
...
l0000B1D0:
	{ r1 = 0x124; r2 = 0x0; r3 = add(PC,0x1A1C7) }
	{ memw(r29) = 0x0; call errlog_function }
	{ dealloc_return; r0 = #-0x1 }
...
l0000B208:
	{ r1 = 0x134; r2 = 0x0; r3 = add(PC,0x1A18F) }
	{ memw(r29) = 0x0; call errlog_function }
	{ dealloc_return; r0 = #-0x1 }
...
hexagon_nn_op_name_to_id proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r2 = add(PC,0x1FEC0) }
...
hexagon_nn_disable_dcvs proc
	...
	{ memuh(r2+8) = 0x100; call fn000095B0 }
	{ dealloc_return }
...
l0000B318:
	...
	{ memuh(r2+8) = 0x100; r1 = add(r29,0x0) }
	{ r2 = r0 }
...
hexagon_nn_config proc
	{ r1 = 0x0; r0 = 0x1000000; r3:r2 = combine(0xFFFFFFFF,0xFFFFFFFF) }
...
logv proc
	...
	{ memd(r29+8) = r23:r22; r22 = memw(r16+64); r2 = add(PC,0x1A0A2) }
...
l0000B4B8:
	...
	{ r3 = add(PC,0x1A01A) }
	{ r2 = r16; call errlog_function }
	{ r1 = 0xA4; jump 0000B5EC; r3 = add(PC,0x19F68) }
...
l0000B580:
	{ jump 0000B594; r3 = add(PC,0x19F4E) }
0000B58C                                     7C 46 00 00             |F..
0000B590 03 D1 49 6A                                     ..Ij            

l0000B594:
	{ r2 = r16; call errlog_function }
	{ r1 = 0xA8; jump 0000B5EC; r3 = add(PC,0x19EBF) }
...
l0000B5E0:
	{ memw(r29) = r22; r3 = add(PC,0x19E49) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x19E0F) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0000B6B4:
	...
	{ r6 = add(r29,0x10); r1 = 0xB0; r4 = add(PC,0x19DB3) }
	{ memw(r29+4) = r6; call logv }
...
do_append_node proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r6 = add(PC,0x1FA30) }
...
l0000B738:
	{ r2 = r16; r1 = 0xD5; r3 = add(PC,0x19D47) }
	{ call errlog_function }
	{ r0 = 0xFFFFFFFF }
...
l0000B794:
	{ r2 = r16; r1 = 0xFC; r3 = add(PC,0x19CEB) }
	{ call errlog_function }
	{ r0 = 0xFFFFFFFF }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
l0000B7E0:
	{ r2 = r16; r1 = 0x10E; r3 = add(PC,0x19CB6) }
	{ call errlog_function }
...
do_snpprint proc
	{ allocframe(0x40); memd(r29-24) = r19:r18; r3 = add(PC,0x19D26) }
...
l0000B874:
	{ r5 = memw(r20+28); r4 = memw(r20+24); r3 = add(PC,0x1F89C) }
	{ r3 = memw(r3-192); r6 = add(PC,0x1FE08) }
	{ r9 = memw(r20+20); r2 = add(PC,0x19CD8) }
...
l0000B8E0:
	{ r3 = memw(r20+12); r4 = memw(r20+4); r2 = add(PC,0x19CD2) }
...
l0000B940:
	{ r3 = memw(r20+8); r1:r0 = combine(r17,r18); r2 = add(PC,0x19C9C) }
	{ r3 = memw(r29+r21) }
...
l0000B97C:
	{ memw(r29) = r19; r1:r0 = combine(r17,r18); r2 = add(PC,0x19C74) }
	{ call fn000095D0 }
...
const_depth_extend_8 proc
	...
	{ r25 = mpyi(r2,r4) }
	{ call fn00009500; r0 = add(0x80,mpyi(r24,r25)) }
...
const_width_extend_8 proc
	...
	{ r25 = mpyi(r3,r20) }
	{ call fn00009500; r0 = add(0x80,mpyi(r25,r26)) }
...
l0000BCE4:
	...
	{ r5 = memw(r16+28); r2 = convert_uw2sf(r0):chop; r4 = add(PC,0x1991F) }
	...
	{ memw(r29+36) = r2; r0 = add(0x80,mpyi(r3,r2)) }
	{ call fn00009500 }
...
l0000BDB8:
	...
	{ memw(r29+40) = r2; r0 = add(0x80,mpyi(r23,r2)) }
	{ call fn00009500 }
...
l0000BE88:
	...
	{ memw(r19+20) = r0; r3:r2 = combine(0x2,r17); r4 = add(PC,0x197E1) }
...
l0000BF48:
	{ if (cmp.eq(r22.new,0x0)) jump:nt 0000BF98; r21 = add(r29,0x708); r17 = memw(r16) }
...
l0000BF74:
	{ r3:r2 = combine(0x9,r16); r4 = add(PC,0x198B3) }
	{ call logmsg_function }
...
l0000C02C:
	{ r1 = 0xD8; r3:r2 = combine(0x9,r16); r4 = add(PC,0x19815) }
	{ call logmsg_function }
	{ r2 = memw(r18+8); r3 = setbit(r21,0x4); r4 = add(PC,0x1F0D0) }
	{ r0 = r16; r5 = 0x3 }
	{ r6 = memw(r2); r2 = 0x13 }
	{ r6 = memw(r6+20) }
...
l0000C0B0:
	...
	{ r2 = memw(r2+12) }
	{ callr r2 }
	{ r1 = 0xEB; r3:r2 = combine(0x3,r16); r4 = add(PC,0x19783) }
...
l0000C108:
	{ if (cmp.eq(r22.new,0x0)) jump:nt 0000C168; r21 = add(r29,0x560) }
...
l0000C1B8:
	...
	{ call logmsg_function }
	{ r2 = memw(r18+8); r3 = setbit(r20,0x4); r6 = add(PC,0x1EF4C) }
...
l0000C270:
	...
	{ r2 = memw(r2+12) }
	{ callr r2 }
	{ r1 = 0x11A; r3:r2 = combine(0x3,r16); r4 = add(PC,0x19569) }
	{ call logmsg_function }
...
l0000C33C:
	{ r1 = 0x13B; r3:r2 = combine(0x9,r16); r4 = add(PC,0x19444) }
...
l0000C3B0:
	{ r3:r2 = combine(0x9,r16); r4 = add(PC,0x193DE) }
	{ call logmsg_function }
...
l0000C420:
	{ r1 = 0x145; r3:r2 = combine(0x9,r16); r4 = add(PC,0x1937D) }
...
l0000C530:
	{ r2 = memw(r21+8); r3 = setbit(r24,0x4); r6 = add(PC,0x1EBE0) }
	{ r2 = memw(r2); r5 = 0x3 }
...
l0000C5AC:
	...
	{ r2 = memw(r2+12) }
	{ callr r2 }
	{ r1 = 0x176; r3:r2 = combine(0x3,r16); r4 = add(PC,0x191B3) }
...
l0000C6DC:
	{ r1 = 0x83; r3:r2 = combine(0x1,r16); r4 = add(PC,0x19058) }
	{ call logmsg_function }
...
l0000C748:
	{ jump 0000BF38; r3 = add(PC,0x1901E) }

l0000C754:
	{ memb(r29+1) = r2.new; r2 = memw(r17+28); r3 = add(PC,0x18F88) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x18EC1) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0000C818:
	{ r1:r0 = combine(r17,0x80); call fn00009550 }
...
logmsg_function proc
	{ allocframe(0x8); r3 = 0x0; r0 = add(PC,0x18DC0) }
	{ r5 = add(r29,0x10); r1 = 0x3C; r4 = add(PC,0x18DCB) }
...
nn_os_workers_spawn proc
	...
	{ r27:r26 = combine(0x2000,0x1); r25:r24 = combine(0x81,0x0) }
	{ r21 = add(r2,0x3C); r19 = setbit(r3,0x4) }

l0000CBE4:
	{ memb(r21-28) = r24; r3 = 0xFFFE; r20 = add(r21,0xFFFFFFE4) }
	{ memb(r21-11) = r22; memb(r21-8) = r24; r1 = add(PC,0x18D26) }
	...
	{ memw(r21) = r0; p0 = cmp.gt(r26,0x1); r2 = add(PC,0x60) }
...
errlog_function proc
	{ allocframe(0x8); r3 = 0x0; r0 = add(PC,0x18C20) }
	{ r5 = add(r29,0x10); r1 = 0xC2; r4 = add(PC,0x18C28) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); call logv }
...
nn_os_vector_workers_acquire proc
	{ allocframe(0x10); memd(r29-24) = r19:r18; r18 = add(PC,0x1E390) }
	{ memd(r29+8) = r17:r16; r16 = r0 }
	{ r17 = memw(r18-176) }
	{ r0 = r17; call qurt_sem_init_val.1.1_i16_0 }
	{ r18 = memw(r18-160) }
	{ r0 = r18; call qurt_sem_init_val.1.1_i16_0; r19 = add(PC,0x1E8F8) }
	{ r0 = memw(r16+68); r3 = add(r19,0x4); r2 = add(PC,0x30) }
	{ call fn00009650 }
...
worker_acquire proc
	...
	{ memw(r16) = 0x0; r17 = add(PC,0x1E31C) }
...
nn_os_vector_workers_release proc
	{ allocframe(0x10); memd(r29-24) = r19:r18; r18 = add(PC,0x1E2F0) }
	{ memd(r29+8) = r17:r16; r16 = r0 }
	{ r17 = memw(r18-176) }
	{ r0 = r17; call qurt_sem_init_val.1.1_i16_0 }
	{ r18 = memw(r18-160) }
	{ r0 = r18; call qurt_sem_init_val.1.1_i16_0 }
	{ r0 = memw(r16+68); r4 = add(PC,0x1E850) }
	{ r3 = add(r4,0x4); call fn00009650; r2 = add(PC,0x2C) }
	{ r0 = r17; call fn000096A0 }
...
l0000E548:
	{ call fn00009760 }
	{ memw(r29+44) = r0 }
	{ r3 = memw(r20+16); r2 = memw(r19+16); r20 = 0x437F0000 }
...
l0000E55C:
	...
	{ r3 = 0x38D1B717; r16 = sfmpy(r16,r0) }
	{ r21 = r3; r2 = 0x4F000000; r1:r0 = combine(r21,r3) }
	{ memb(r29+17) = r2.new; call fn00009600; r2 = sfmpy(r16,r2) }
	{ r20 = 0x0; r1:r0 = combine(r0,r25) }
	{ r2 = sfsub(r20,r17) }
	{ call fn00009620; r0 = sfmpy(r2,r0) }
...
l0000E658:
	...
	{ r2 = 0xCF000000; r21 = convert_uw2sf(r24):chop; r23 = convert_uw2sf(r21):chop }
...
l0000E6C8:
	...
	{ memw(r29) = r16 }
	{ call logmsg_function }
	{ r7 = memw(r29+128); r17 = memw(r29+124); r4 = add(PC,0x172FC) }
	...
	{ memw(r29+12) = r25; r27 = memw(r29+100); r4 = add(PC,0x172D9) }
	{ memw(r29+8) = r3; r7 = memd(r29+120) }
	{ memw(r29) = r27; memw(r29+4) = r7 }
	{ call logmsg_function }
	{ memw(r29+4) = r18; r1 = 0x8E; r4 = add(PC,0x172D1) }
	{ memw(r29) = r20; r2 = r24 }
	{ call logmsg_function }
	{ r2 = r24; r1 = 0x8F; r4 = add(PC,0x172C9) }
...
l0000EAC8:
	{ memw(r29+12) = r8; r1 = 0xD3; r4 = add(PC,0x16FEB) }
...
deconv_check_ref proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x16E67) }
...
l0000EB64:
	{ r2 = r16; r1 = 0x205; r4 = add(PC,0x16E52) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x16D9F) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0000ED98:
	...
	{ memw(r29) = r24; memw(r29+12) = r25; r4 = add(PC,0x16DB9) }
	{ memw(r29+8) = r7; r3 = memd(r29+92); r2 = r21 }
	{ memw(r29+4) = r3 }
	{ call logmsg_function }
	{ r7 = memw(r29+32); r27 = memw(r29+88); r1 = 0x78 }
	{ memw(r29) = r26; memw(r29+12) = r27; r4 = add(PC,0x16DA6) }
	{ memw(r29+8) = r7; r3 = memd(r29+116); r2 = r21 }
	{ memw(r29+4) = r3 }
	{ call logmsg_function }
	{ memw(r29+4) = r18; r1 = 0x79; r4 = add(PC,0x16D9E) }
	{ memw(r29) = r19; r2 = r21 }
	{ call logmsg_function }
	{ r2 = r21; r1 = 0x7A; r4 = add(PC,0x16D9A) }
...
l0000EFD8:
	{ memw(r29+72) = r2; r2 = memd(r29+116); r24 = 0x0 }
...
l0000F124:
	{ memw(r29+12) = r26; r1 = 0xB3; r4 = add(PC,0x16B1C) }
...
deconv_check_ref proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x16998) }
...
l0000F1C0:
	{ r2 = r16; r1 = 0xBD; r4 = add(PC,0x16983) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0000F1F8 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x168D2) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0000F3AC:
	{ call errlog_function; r3 = add(PC,0x16924) }
	{ r0 = 0xFFFFFFFF; jump 0000F398 }

;; logsoftmax_check: 0000F3C0
logsoftmax_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x168C9) }
...
l0000F418:
	{ r2 = r16; r1 = 0x56; r4 = add(PC,0x1689C) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0000F450 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x16809) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0000F4CC:
	{ r1 = 0x30; call errlog_function; r3 = add(PC,0x1688B) }
	{ dealloc_return; r0 = #-0x1 }

;; expanddims_check: 0000F4E0
expanddims_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x1681E) }
...
l0000F53C:
	{ r2 = r16; r1 = 0x3A; r4 = add(PC,0x167FE) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0000F570 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x1675E) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
sslice_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x167D3) }
...
sslice_check_q8 proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x166F7) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x16651) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
strided_slice_impl proc
	...
	{ r2 = memw(r23+20); r18 = r0; r3 = add(PC,0x16621) }
...
l0000F7D8:
	{ if (!p0.new) r1 = 0x4B; p0 = cmp.gt(r27,0x1); r3 = add(PC,0x165EB) }
...
l0000F81C:
	{ r22 = memw(r23+16); r26 = memw(r22+16); r4 = add(PC,0x165DA) }
...
l0000F934:
	...
	{ memw(r29+28) = r23; r1 = 0x45; r4 = add(PC,0x16548) }
...
resizenear_f_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x163D5) }
...
l0000FAB8:
	{ r2 = r16; r1 = 0x5E; r4 = add(PC,0x163AF) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0000FAF0 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x16315) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
mirrorpad_f_execute proc
	{ allocframe(#0xC0); r4 = add(PC,0x163F2) }
	{ r3 = memw(r0+8); r2 = memw(r0+4) }
...
l0000FC14:
	...
	{ memw(r29+4) = r19; r1 = 0x8A; r3 = add(PC,0x16349) }
	{ jump 0000FCC8 }
...
mirrorpad_f_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x15F17) }
...
l00010028:
	{ r2 = r16; r1 = 0xAE; r4 = add(PC,0x15EE4) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     00010060 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x15E38) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0001014C:
	{ r2 = r6; r1 = 0xBD; r0 = add(PC,0x15EA9) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(PC,0x15EB8) }
...
l00010238:
	{ memw(r29+28) = r12; r1 = 0xBD; r0 = add(PC,0x15DBD) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(PC,0x15DF0) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump 000101A8 }

l0001026C:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(PC,0x15D7D) }
	{ memw(r29+40) = r20; r1 = 0xBD; r4 = add(PC,0x15DEC) }
...
l000103B8:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(PC,0x15C3D) }
...
add_int32_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x15BC6) }
	{ r16 = r1; r1 = 0x37; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(PC,0x15B99) }
	{ call logmsg_function }
...
l00010454:
	{ r0 = add(PC,0x11) }
	{ jump 00010434; r3 = add(PC,0x15B7D) }

l00010464:
	{ r2 = r16; r1 = 0x3A; r0 = add(PC,0x15B3D) }
	{ memw(r29) = r17; call logmsg_function; r4 = add(PC,0x15B75) }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
prod_f_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x158A7) }
	{ r17 = r0; r16 = r1; r1 = 0x37 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r2 = memw(r17+16) }
...
l00010884:
	{ jump 00010864; r0 = add(PC,0x15837) }
...
l000108A0:
	{ r0 = add(PC,0x1F) }
	{ jump 0001086C; r3 = add(PC,0x1584E) }

l000108B0:
	{ r2 = r16; r1 = 0x3B; r4 = add(PC,0x15852) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
l000109BC:
	{ r2 = r6; r1 = 0xBD; r0 = add(PC,0x157D7) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(PC,0x157E6) }
	{ memw(r29+88) = r7; r23 = memw(r25+16); r27 = r5; r24 = r6 }
	{ r17 = memw(r26+16) }
	{ memw(r29) = r5; memw(r29+100) = r3; call logmsg_function }
...
l00010AA8:
	{ memw(r29+28) = r12; r1 = 0xBD; r0 = add(PC,0x156EB) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(PC,0x1571E) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump 00010A18 }

l00010ADC:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(PC,0x156AB) }
	{ memw(r29+40) = r20; r1 = 0xBD; r4 = add(PC,0x1571A) }
	{ memw(r29+28) = r12; memw(r29+32) = r24 }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+12) = r8 }
	{ memw(r29) = r5; memw(r29+4) = r6 }
...
l00010C28:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(PC,0x1556B) }
...
mul_int32_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x154F4) }
	{ r16 = r1; r1 = 0x37; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(PC,0x154C7) }
	{ call logmsg_function }
...
l00010CC4:
	{ r0 = add(PC,0x3F) }
	{ jump 00010CA4; r3 = add(PC,0x154AB) }

l00010CD4:
	{ r2 = r16; r1 = 0x3A; r0 = add(PC,0x1546B) }
	{ memw(r29) = r17; call logmsg_function; r4 = add(PC,0x154A3) }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
l00010DBC:
	{ if (cmp.eq(r6.new,r23)) jump:t 00010DD4; r6 = memw(r5+4); r3 = add(PC,0x154E4) }

l00010DD0:
	{ r1 = 0x43 }

l00010DD4:
	{ if (cmp.eq(r6.new,r21)) jump:t 00010DEC; r6 = memw(r5+8); r3 = add(PC,0x154CC) }

l00010DE8:
	{ r1 = 0x44 }

l00010DEC:
	{ if (cmp.eq(r6.new,r22)) jump:t 00010E04; r6 = memw(r5+12); r3 = add(PC,0x154B4) }

l00010E00:
	{ r1 = 0x45 }

l00010E04:
	{ if (cmp.eq(r5.new,r2)) jump:t 00010E1C; r5 = memw(r5+24); r3 = add(PC,0x154A6) }
...
l00010EA8:
	{ r7 = memw(r29+4); r1 = 0x56; r3 = add(PC,0x15419) }
...
l00010F44:
	...
	{ r6 = add(r29,0x10); r1 = 0x5E; r4 = add(PC,0x15327) }
	{ memw(r29+4) = r6; call logv }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x152F1) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
shape_execute proc
	{ allocframe(0x18); memd(r29-16) = r17:r16; r4 = add(PC,0x153B7) }
...
l00010FD8:
	{ memw(r18+4) = 0x1; r2 = memw(r18+16); r4 = add(PC,0x15395) }
...
shape_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x152CF) }
...
l00011088:
	{ r2 = r16; r1 = 0x44; r4 = add(PC,0x152AD) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     000110C0 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x15214) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
and_int32_execute proc
	{ jump broadcast_elementwise_execute_int32; r2 = add(PC,0x4C8) }

;; logical_int32_check: 0001110C
logical_int32_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x15352) }
	{ r16 = r1; r1 = 0x3E; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(PC,0x15321) }
	{ call logmsg_function }
...
l0001116C:
	{ r0 = add(PC,0x19) }
	{ jump 0001114C; r3 = add(PC,0x15310) }

l0001117C:
	{ r2 = r16; r1 = 0x41; r0 = add(PC,0x152C5) }
	{ memw(r29) = r17; call logmsg_function; r4 = add(PC,0x15304) }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }

;; ior_int32_execute: 000111A4
ior_int32_execute proc
	{ jump broadcast_elementwise_execute_int32; r2 = add(PC,0x41C) }

;; xor_int32_execute: 000111B0
xor_int32_execute proc
	{ jump broadcast_elementwise_execute_int32; r2 = add(PC,0x3C8) }
...
l00011270:
	{ r2 = r25; r1 = 0xBD; r0 = add(PC,0x1510B) }
	{ memw(r29+96) = r8; r27 = memw(r17+16); r4 = add(PC,0x1511A) }
...
l00011340:
	{ memw(r29+28) = r12; r1 = 0xBD; r0 = add(PC,0x1503B) }
	{ memw(r29+12) = r8; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(PC,0x1506E) }
	{ memw(r29+4) = r6; memw(r29+16) = r2; r2 = r25 }
	{ memw(r29) = r5; jump 000112C0 }

l00011374:
	{ memw(r29+44) = r16; r23 = memd(r29+112); r0 = add(PC,0x15007) }
	{ r19 = memw(r29+68); r1 = 0xBD; r4 = add(PC,0x15076) }
...
l0001153C:
	{ memb(r29) = r2.new; r2 = memw(r29+52); r0 = add(PC,0x14E3F) }
...
avgpool_execute_asm proc
	{ jump avgpool_execute; r2 = add(PC,0x7D0) }

;; avgpool_check: 000115DC
avgpool_check proc
	{ allocframe(0x30); memd(r29-16) = r17:r16; r4 = add(PC,0x14F4A) }
...
l0001163C:
	{ memw(r29) = r17; r3:r2 = combine(0x3,r16); r4 = add(PC,0x14F2F) }
	{ call logmsg_function }
...
l0001167C:
	{ r6 = memw(r2+4); r5 = memw(r2); r4 = add(PC,0x14F72) }
...
l000116FC:
	{ r1 = 0x197; r3:r2 = combine(0x2,r16); r4 = add(PC,0x14ED9) }
...
avgpool_execute_ref proc
	{ jump avgpool_execute; r2 = add(PC,0x290) }
...
l0001180C:
	...
	{ r1 = 0x151; r3:r2 = combine(0x2,r16); r4 = add(PC,0x14C80) }
	{ memw(r29) = r17; call logmsg_function }
...
l00011980:
	{ r1 = 0x165; r3:r2 = combine(0x2,r16); r4 = add(PC,0x14B96) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
l00011CE4:
	{ r12 = r26; r9 = add(r4,r3); r8 = add(0x4000,mpyi(r8,r0)) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x1472B) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l00011F84:
	...
	{ r2 = add(r2,r21); r0 = 0x8000; r27 = max(r21,r3) }
	{ r2 = min(r17,r2) }
	{ r26 = sub(r2,r27) }
...
biasadd_8p8to32_execute proc
	...
	{ memd(r29+112) = r23:r22; r18 = 0x437F0000; r23 = sfsub(r27,r21) }
...
l0001216C:
	{ memw(r29) = r4; r1 = 0x6A; r3 = add(PC,0x14563) }
	{ jump 000121C8 }

l00012180:
	{ r3 = memd(r29+84); r2 = memd(r29+80); r4 = add(PC,0x14567) }
	{ r2 = mpyi(r20,r2) }
	{ r2 = memw(r29+76); r5 = mpyi(r2,r3) }
	{ memw(r29) = r2; r2 = memd(r29+92); r3 = 0x2; r5 = mpyi(r5,r24) }
	{ call logmsg_function; r17 = asl(r5,0x2) }
	{ r1 = 0x6E; r0 = clrbit(r21,0x1E); r3 = add(PC,0x14555) }
...
l000121D4:
	...
	{ r5 = 0xC8000000; r3 = 0x48000000 }
	{ r4 = 0x2F800000; r2 = 0x38D1B717 }
	...
	{ r2 = sfsub(r17,r21) }
	{ call fn00009620; r0 = sfmpy(r2,r0) }
	{ r0 = 0x38D1B717; r27 = r18; r2 = convert_uw2sf(r0):chop }
	...
	{ r1 = 0x8C; r15:r14 = convert_sf2df(r21); r4 = add(PC,0x14423) }
	...
	{ memd(r29+16) = r7:r6; r13:r12 = convert_sf2df(r27); r4 = add(PC,0x14415) }
	{ memd(r29) = r13:r12; memd(r29+8) = r9:r8 }
	{ call logmsg_function }
	{ r12 = memw(r29+68); r9:r8 = convert_sf2df(r22); r7:r6 = convert_sf2df(r20) }
	{ r3 = memd(r29+40); r5 = memd(r29+72); r4 = add(PC,0x14417) }
...
l0001244C:
	{ memb(r29) = r2.new; r2 = memw(r29+76); r4 = add(PC,0x1434A) }
...
biasadd_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x141B5) }
...
l000124FC:
	{ jump 000124B8; r3 = add(PC,0x1416D) }
...
l0001253C:
	{ r1 = 0xC0; r3:r2 = combine(0x2,r16); r4 = add(PC,0x1416F) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x1409C) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l00012658:
	{ r2 = r16; r1 = 0x3E; r3 = add(PC,0x14282) }
...
l00012670:
	{ r2 = r16; r1 = 0x40; r4 = add(PC,0x14278) }
	{ call logmsg_function }
	{ r0 = 0x0 }
...
check_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x14131) }
...
l000126E8:
	{ r2 = r16; r1 = 0x49; r4 = add(PC,0x1411D) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     00012720 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x14076) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
close_execute_f proc
	...
	{ memd(r29+72) = r27:r26; memd(r29+80) = r25:r24; if (p0) r24 = 0x3D4CCCCD }
...
l000127AC:
	{ r1 = 0x61; r3:r2 = combine(0x2,r16); r4 = add(PC,0x14377) }
	{ memw(r29) = r17; call logmsg_function }
	{ r4 = memw(r19); r1 = 0x64; r3 = add(PC,0x141C9) }
...
l000128D8:
	...
	{ r1 = 0x7A; r13:r12 = convert_sf2df(r26); r3 = add(PC,0x14263) }
...
l0001292C:
	{ r3:r2 = combine(0x2,r16); r4 = add(PC,0x141B8) }
	{ call logmsg_function }
	{ r0 = 0x0 }
...
close_check_f proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x141A1) }
...
l000129C8:
	{ r1 = 0xFA; r3:r2 = combine(0x2,r16); r4 = add(PC,0x14144) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
close_execute_i32 proc
	{ jump close_execute; r2 = add(PC,0x59C) }
...
close_check__merged proc
	{ allocframe(0x20); p0 = cmp.eq(r2,0x1); r4 = add(PC,0x13F14) }
	{ r6 = 0x6; r5 = 0xED; r7 = add(PC,0x140E9) }
	{ memd(r29+16) = r19:r18; memd(r29+24) = r17:r16; r16 = r1; r8 = 0x2 }
	{ r1 = mux(p0,0x100,r5); if (!p0) r4 = add(r7,0x0); r3:r2 = combine(0x2,r16) }
...
l00012AB8:
	{ r1 = 0xF0; r3 = 0x2; r4 = add(PC,0x14054) }
	{ jump 00012ADC }

l00012ACC:
	{ r1 = 0x103; r3 = 0x2; r4 = add(PC,0x13E8E) }
...
close_execute_u8 proc
	{ jump close_execute; r2 = add(PC,0x39C) }
...
close_execute_q_u8 proc
	...
	{ memd(r29+72) = r25:r24 }
	{ memd(r29+96) = r19:r18; r19 = 0x437F0000 }
	...
	{ r1 = 0xD0; r3:r2 = combine(0x2,r16); r4 = add(PC,0x13E0F) }
	{ memw(r29+56) = r0; r26 = memw(r21+16) }
	{ r19 = memw(r20+24); r27 = memw(r20+16) }
	{ memw(r29) = r17; call logmsg_function }
	{ r4 = memw(r21); r1 = 0xD1; r3 = add(PC,0x13E01) }
...
l00012C40:
	...
	{ r2 = 0x9999999A; r26 = add(r26,0x1); r4 = clrbit(r0,0x1E) }
	{ r3 = 0x3FA99999; r27 = add(r27,0x1); r1:r0 = convert_sf2df(r4) }
...
l00012C9C:
	...
	{ memd(r29+24) = r5:r4; r2 = memd(r29+48); r4 = add(PC,0x13D84) }
	...
	{ memd(r29+16) = r7:r6; memw(r29+4) = r25; r4 = add(PC,0x13D8C) }
	{ memw(r29) = r21; memd(r29+8) = r9:r8 }
	{ call logmsg_function }
	{ r2 = r16; r1 = 0xE3; r3 = add(PC,0x13D88) }
	{ jump 00012C28 }

l00012D18:
	{ r1 = 0xE7; r3 = 0x2; r4 = add(PC,0x13D82) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x13B89) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
close_execute proc
	{ allocframe(0x20); memd(r29-16) = r17:r16; r4 = add(PC,0x13D38) }
	...
	{ r20 = memw(r5+4) }
	{ memw(r29) = r17; call logmsg_function }
	{ r4 = memw(r19); r1 = 0x3D; r3 = add(PC,0x13BC9) }
...
l00012E54:
	{ r2 = r16; r1 = 0x43; r3 = add(PC,0x13C38) }
...
l00012E70:
	{ memw(r29) = r17; r4 = add(PC,0x13C74) }
	{ call logmsg_function }
	{ r0 = 0x0 }
...
l00012F18:
	...
	{ r2 = 0x9999999A; r4 = clrbit(r0,0x1E) }
	{ r3 = 0x3FA99999; r1:r0 = convert_sf2df(r4) }
	{ if (p0.new) memw(r29+12) = r24; if (p0.new) r1 = 0xA2; if (!p0.new) jump:nt 00012F04; p0 = dfcmp.gt(r1:r0,r3:r2) }

l00012F58:
	{ r3:r2 = combine(0x0,r17); r4 = add(PC,0x13B55) }
...
concat_execute_asm proc
	{ jump concat_execute; r2 = add(PC,0x5EC) }

;; concat_check: 0001305C
concat_check proc
	{ allocframe(0x18); memd(r29-16) = r17:r16; r4 = add(PC,0x13BF7) }
	{ r17 = r0; r16 = r1; r1 = 0x123 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r2 = memw(r17+16); r3 = 0xAAAAAAAB; r1 = 0x124 }
...
concat_execute_ref proc
	{ jump concat_execute; r2 = add(PC,0x2D0) }
...
concat_execute proc
	{ allocframe(0xA8); memd(r29-40) = r23:r22; r3 = 0xAAAAAAAB }
	{ r23 = r0 }
	...
	{ r2 = r17; r1 = 0xE5; r4 = add(PC,0x13A1C) }
...
l00013228:
	{ memw(r26+12) = 0xFFFFFF81; r6 = memw(r29+28); r2 = 0x0 }
	...
	{ r2 = r17; r1 = 0x112; r4 = add(PC,0x13974) }
	{ memw(r29) = r23; call logmsg_function }
...
l000134C0:
	{ r4 = memd(r29+8); r3 = memd(r29+12); r1 = 0x437F0000 }
	...
	{ r3 = memd(r29+16); r2 = r0; r0 = 0x41700000 }
...
;;     00013608 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x13590) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l000136D4:
	...
	{ r3 = memw(r3+16); r2 = memw(r2+16); r1 = 0x437F0000 }
	...
	{ r2 = memd(r29+12); r3 = 0x47000000; r6 = 0x7FFF }
...
l00013800:
	{ r2 = r16; r1 = 0x58; r3 = add(PC,0x1350B) }
	{ call errlog_function }
	{ jump 00013828 }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x134A9) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
const_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x134FE) }
...
l000138D8:
	{ memw(r29) = r17; r3:r2 = combine(0x2,r16); r4 = add(PC,0x134E9) }
	{ call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;; const_ctor: 00013900
const_ctor proc
	{ r1 = 0x6D; r3:r2 = combine(0x0,r0); r4 = add(PC,0x1342E) }
...
;; const_dtor: 00013920
const_dtor proc
	{ allocframe(#0x10); r3:r2 = combine(0x2,r1); r4 = add(PC,0x133FB) }
...
l00013A94:
	{ r3 = memw(r23+16); r2 = memw(r19+16); r19 = 0x437F0000 }
	...
	{ r2 = 0xCF000000; r4 = sfmpy(r23,r0) }
	{ r0 = r22; r3 = 0x4F000000; r2 = sfmpy(r4,r2) }
	{ memb(r29+15) = r3.new; r3 = sfmpy(r4,r3) }
	{ memw(r29+56) = r2 }
	{ r18 = 0x0; r1:r0 = combine(r0,r19); call fn00009610 }
	{ r2 = sfsub(r18,r21) }
	{ call fn00009620; r0 = sfmpy(r2,r0) }
	{ r0 = r20; r2 = r0 }
	...
	{ r2 = sfsub(r18,r25) }
	{ call fn00009620; r0 = sfmpy(r2,r0) }
	{ r5 = memw(r27+28); r22 = memw(r29+100); r4 = add(PC,0x132A0) }
	{ memw(r29+4) = r5; r3:r2 = combine(0x2,r22); r1 = 0x207; r7 = convert_uw2sf(r0):chop }
	{ memw(r29) = r27; memw(r29+64) = r7 }
	{ call logmsg_function }
	{ r21 = memd(r29+104); r19 = memd(r29+108); r4 = add(PC,0x13292) }
	...
	{ r5 = memw(r29+120); r25 = memw(r29+92); r4 = add(PC,0x13283) }
	{ memw(r29+12) = r25; r3:r2 = combine(0x2,r22) }
	{ memw(r29+8) = r5; r20 = memd(r29+124); r1 = 0x209 }
	{ memw(r29+4) = r20 }
	{ r18 = memw(r29+116) }
	{ memw(r29) = r18; call logmsg_function }
	{ r5 = memw(r29+112); r1 = 0x20A; r4 = add(PC,0x1326B) }
	{ memw(r29) = r26; memw(r29+4) = r5; r3:r2 = combine(0x2,r22) }
	{ call logmsg_function }
	{ r1 = 0x20B; r3:r2 = combine(0x2,r22); r4 = add(PC,0x1325F) }
	...
	{ call logmsg_function }
	{ r9 = r17; r1 = 0x20D; r3 = add(PC,0x13250) }
...
l00013CFC:
	...
	{ memw(r29+4) = r26; r3:r2 = combine(0x2,r17); r4 = add(PC,0x13250) }
	{ memw(r29) = r22; r16 = r26; r1 = 0x23B }
	{ call logmsg_function }
	{ r1 = 0x23C; r3:r2 = combine(0x2,r17); r4 = add(PC,0x1324B) }
	{ memw(r29+4) = r20; r5 = memd(r29+56) }
	{ memw(r29) = r5; call logmsg_function }
	{ r1 = 0x23D; r3:r2 = combine(0x2,r17); r4 = add(PC,0x13243) }
...
l00013FE8:
	{ memb(r29+3) = r2.new; r2 = memw(r29+116); r4 = add(PC,0x130C2) }
...
conv2d_check_ref proc
	{ allocframe(0x30); memd(r29-16) = r17:r16; r4 = add(PC,0x12F07) }
...
l000140D8:
	{ jump 00014080; r3 = add(PC,0x12EB2) }
...
l00014118:
	{ r1 = 0x282; r3:r2 = combine(0x3,r16); r4 = add(PC,0x12E9C) }
...
l0001413C:
	{ r2 = memw(r17+4); r1 = 0x26B; r4 = add(PC,0x12EDF) }
...
l0001418C:
	{ r1 = 0x286; r3:r2 = combine(0x2,r16); r4 = add(PC,0x12E77) }
...
conv2d_ctor proc
	{ allocframe(0x28); memd(r29-24) = r19:r18; r6 = add(PC,0x12D6C) }
...
l0001430C:
	{ r3 = memd(r29+60); r2 = memd(r29+64); r26 = 0x437F0000 }
	...
	{ r2 = sfsub(r20,r23) }
	{ call fn00009620; r0 = sfmpy(r2,r0) }
	{ r20 = memw(r29+32); r26 = memw(r29+72); r4 = add(PC,0x12A20) }
	{ r3:r2 = combine(0x2,r20); r1 = 0x174; r18 = convert_uw2sf(r0):chop }
	{ memb(r29+1) = r5.new; r5 = memw(r26+28) }
	{ memw(r29) = r26 }
	{ memw(r29+12) = r19; r3:r2 = combine(0x2,r20); r4 = add(PC,0x12A12) }
	{ memw(r29+4) = r17; r1 = 0x175 }
	{ memw(r29+8) = r27; r23 = memw(r29+28) }
	{ memw(r29) = r23; call logmsg_function }
	{ memw(r29+4) = r21; r2 = memd(r29+80); r4 = add(PC,0x12A03) }
	{ memw(r29+12) = r2; r3:r2 = combine(0x2,r20); r1 = 0x176 }
	{ memw(r29) = r16; memw(r29+8) = r22 }
	{ call logmsg_function }
	{ r7 = memw(r29+68); r3:r2 = combine(0x2,r20); r4 = add(PC,0x129FB) }
	{ r1 = 0x177 }
	{ memw(r29+4) = r7; r5 = memd(r29+44) }
	{ memw(r29) = r5; call logmsg_function }
	{ r1 = 0x178; r3:r2 = combine(0x2,r20); r4 = add(PC,0x129EF) }
	{ r26 = memw(r29+48); r5 = memb(r26+32) }
	{ memw(r29) = r5; call logmsg_function }
	{ memw(r29) = r23; memw(r29+12) = r16; r3:r2 = combine(0x2,r20) }
	{ memw(r29+4) = r26; r20 = memw(r29+76); r4 = add(PC,0x129D9) }
	{ memw(r29+8) = r20; r1 = 0x179 }
	{ call logmsg_function }
	{ r1 = 0x17A; r7:r6 = combine(r20,r23); r3 = add(PC,0x129DC) }
...
l00014784:
	{ memw(r29+12) = r16; r3 = 0x2; r4 = add(PC,0x12771) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x125F4) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
flatten_execute proc
	{ allocframe(#0x28); r4 = add(PC,0x129B2) }
	{ r3 = memw(r0+8); r2 = memw(r0+4) }
...
l00014878:
	...
	{ r2 = r16; r1 = 0x3F; r4 = add(PC,0x128CA) }
...
flatten_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x128C1) }
	{ r17 = r0; r16 = r1; r1 = 0x5C }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r1 = 0x5D; r3 = add(PC,0x12824) }
...
l0001494C:
	{ r2 = r16; r1 = 0x61; r4 = add(PC,0x1286D) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
qflatten_execute proc
	{ allocframe(0x28); memd(r29-16) = r17:r16; r4 = add(PC,0x127D5) }
	{ r17:r16 = combine(r0,r1) }
...
l00014A54:
	{ r2 = memw(r18+24); r4 = add(PC,0x12716) }
...
qflatten_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x1266E) }
...
l00014AD8:
	{ r2 = r16; r1 = 0x6A; r4 = add(PC,0x1264F) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     00014B10 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x125B1) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
input_execute proc
	{ allocframe(0x20); memd(r29-16) = r17:r16; r4 = add(PC,0x126FF) }
	{ r16 = r1; r1 = 0x31 }
...
l00014C10:
	{ memw(r29) = r2; r1 = 0x40; r4 = add(PC,0x12674) }
...
input_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x125D3) }
	{ r17 = r0; r16 = r1; r1 = 0x46 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
...
l00014C94:
	{ r2 = r16; r1 = 0x4D; r4 = add(PC,0x125A4) }
...
;;     00014CCC (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x12510) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }

;; matmul_execute_asm: 00014D00
matmul_execute_asm proc
	{ jump matmul_execute; r2 = add(PC,0x724) }

;; matmul_check_ref: 00014D0C
matmul_check_ref proc
	{ allocframe(0x48); memd(r29-16) = r17:r16; r4 = add(PC,0x126DD) }
...
l00014DA4:
	{ memw(r29) = r5; r1 = 0x116; r3 = add(PC,0x126A3) }
	{ jump 00014EE0 }
...
l00014DE0:
	{ r1 = 0x120; r3:r2 = combine(0x3,r16); r4 = add(PC,0x12684) }
...
l00014E04:
	{ r2 = memw(r17+4); r1 = 0x109; r4 = add(PC,0x12723) }
...
l00014E5C:
	...
	{ memw(r17+40) = r0; r1 = 0x13A; r3 = add(PC,0x125D7) }
...
l00014EEC:
	...
	{ memw(r29+16) = r25; r3:r2 = combine(0x2,r16); r4 = add(PC,0x125C8) }
	...
	{ r0 = r16; call nn_os_hvx_power_off }
	{ r1 = 0x143; r3:r2 = combine(0x2,r16); r4 = add(PC,0x125AB) }
	{ memw(r29) = r17; call logmsg_function }
...
matmul_ctor proc
	{ allocframe(0x28); memd(r29-24) = r19:r18; r6 = add(PC,0x12442) }
	{ r19:r18 = combine(r0,r4) }
	{ memd(r29+16) = r21:r20; memd(r29+32) = r17:r16; r21:r20 = combine(r2,r5); r17:r16 = combine(r3,r1) }
...
matmul_execute_ref proc
	{ jump matmul_execute; r2 = add(PC,0x2F4) }
...
matmul_execute proc
	...
	{ r26 = memw(r2) }
	{ memd(r29+96) = r21:r20; memd(r29+104) = r19:r18; r19 = 0x437F0000 }
	{ r8 = memw(r8+16) }
	...
	{ r3 = 0x4F000000; r4 = sfmpy(r22,r0) }
	{ r0 = r20; r2 = 0xCF000000 }
	{ memb(r29+9) = r3.new; r22 = sfmpy(r4,r2); r3 = sfmpy(r4,r3) }
	{ r20 = 0x0; r1:r0 = combine(r0,r19); call fn00009610 }
	...
	{ call fn00009620; r0 = sfmpy(r2,r0) }
	{ r1 = 0x72; r3:r2 = combine(0x2,r16); r4 = add(PC,0x121EC) }
	{ memw(r29) = r20; call logmsg_function; r21 = convert_uw2sf(r0):chop }
	{ memw(r29+20) = r26; memw(r29+28) = r23; r4 = add(PC,0x121E8) }
	...
	{ call logmsg_function }
	{ memw(r29+12) = r23; r3:r2 = combine(0x2,r16); r4 = add(PC,0x121DE) }
	{ memw(r29) = r24; r1 = 0x77 }
	{ memw(r29+4) = r18; memw(r29+8) = r17 }
	{ call logmsg_function }
	{ p0 = cmp.eq(r18,0x1); r1 = 0x78; r3 = add(PC,0x121DF) }
	{ if (p0) r1 = 0x79; if (!p0) jump:nt 00015240 }

l000151A0:
	{ if (p0.new) r1 = 0x7A; p0 = cmp.eq(r26,0x1); r3 = add(PC,0x121C7) }
	{ if (!p0) jump:nt 00015240 }

l000151B4:
	{ if (p0.new) r1 = 0x7B; p0 = cmp.eq(r24,0x1); r3 = add(PC,0x121C5) }
	{ if (!p0) jump:nt 00015240 }

l000151C8:
	{ p0 = cmp.eq(r25,0x1); r2 = mpyi(r24,r17); r3 = add(PC,0x121B1) }
	{ if (!p0) jump:nt 00015240 }

l000151DC:
	{ r3 = memw(r29+52); r1 = 0x7C }
	{ r2 = mpyi(r2,r18) }
	{ r4 = memw(r3+20); r3 = add(PC,0x121A8) }
	{ r2 = mpyi(r2,r23) }
	{ if (cmp.gtu(r2.new,r4)) jump:t 00015240; r2 = asl(r2,0x2) }

l00015204:
	{ r3 = memd(r29+48); r5 = 0x4; r1 = 0x7D }
	{ r4 = memw(r3+20); p2 = cmp.gt(r19,0xFFFFFFFF); r3 = add(PC,0x12195) }
	{ p3 = cmp.gt(r21,0xFFFFFFFF); if (p0) jump:nt 00015240; p0 = cmp.gtu(r5,r4) }

l00015224:
	{ r3 = memd(r29+44); r5 = 0x0; r1 = 0x7E }
	{ r4 = memw(r3+20); r3 = add(PC,0x12183) }
...
l00015250:
	...
	{ r1 = 0x8C; r3:r2 = combine(0x2,r16); r4 = add(PC,0x12111) }
	{ call logmsg_function }
	{ r0 = 0x0 }
...
;; matmul_ref: 000152E0
matmul_ref proc
	{ allocframe(#0x38); r4 = add(PC,0x11FD1) }
...
l000153B4:
	{ r1 = 0xBA; r3:r2 = combine(0x2,r17); r4 = add(PC,0x11F2F) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x11E95) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l00015470:
	{ memw(r29+4) = r23; memw(r29+20) = r20; r4 = add(PC,0x120E5) }
...
l000154F0:
	{ memw(r29+12) = r20; r21 = memw(r4+16); r4 = add(PC,0x11DC1) }
...
l00015594:
	{ r1 = 0xBA; r3:r2 = combine(0x2,r16); r4 = add(PC,0x11D4F) }
...
l000155A4:
	{ call logmsg_function }
	{ r1 = 0xEB; r3:r2 = combine(0x2,r16); r4 = add(PC,0x12002) }
	{ memw(r29+28) = r16; call logmsg_function }

l000155C0:
	{ r1 = 0xEE; r3 = 0x2; r4 = add(PC,0x1203B) }
...
maxpool_execute_asm proc
	{ jump maxpool_execute; r2 = add(PC,0x794) }

;; maxpool_check: 0001560C
maxpool_check proc
	{ allocframe(0x30); memd(r29-16) = r17:r16; r4 = add(PC,0x12087) }
...
l0001566C:
	{ memw(r29) = r17; r3:r2 = combine(0x3,r16); r4 = add(PC,0x1206C) }
	{ call logmsg_function }
...
l000156AC:
	{ r6 = memw(r2+4); r5 = memw(r2); r4 = add(PC,0x120AF) }
...
l0001572C:
	{ r1 = 0x17D; r3:r2 = combine(0x2,r16); r4 = add(PC,0x12016) }
...
maxpool_execute_ref proc
	{ jump maxpool_execute; r2 = add(PC,0x290) }
...
l0001583C:
	...
	{ memw(r29+56) = r17; memw(r4+8) = 0x0; call fn00009740 }
	{ r1:r0 = combine(0x0,r22); call fn00009740 }
	{ r1 = 0x137; r3:r2 = combine(0x2,r16); r4 = add(PC,0x11DBD) }
	{ memw(r29) = r17; call logmsg_function }
...
l000159B0:
	{ r1 = 0x14B; r3:r2 = combine(0x2,r16); r4 = add(PC,0x11CD3) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x118A4) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
min_execute proc
	{ r3 = 0x7F800000; r2 = add(PC,0x150D0) }
	{ r2 = memw(r2-144); jump nn_reduction_float }
0001605C                                     00 C0 00 7F             ....

;; minmax_check: 00016060
minmax_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x1182A) }
	{ r17 = r0; r16 = r1; r1 = 0x75 }
	{ memw(r29) = r17; r2 = r16; r0 = add(PC,0x117FA) }
	{ call logmsg_function }
	{ r1 = 0x76; r3 = add(PC,0x1181F) }
...
l000160FC:
	{ r2 = r16; call errlog_function; r0 = add(PC,0x11772) }
...
l00016114:
	{ r2 = r16; r1 = 0x7C; r0 = add(PC,0x1175A) }
	{ memw(r29) = r17; call logmsg_function; r4 = add(PC,0x117C2) }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
max_execute proc
	{ r3 = 0xFF800000; r2 = add(PC,0x14FD0) }
...
l00016238:
	{ r2 = r25; r1 = 0xBC; r0 = add(PC,0x11551) }
	{ memw(r29+96) = r8; r27 = memw(r17+16); r4 = add(PC,0x11560) }
	{ r26 = memw(r23+16); r20 = memw(r19+16) }
	{ memw(r29) = r24; call logmsg_function }
...
l00016308:
	{ memw(r29+28) = r12; r1 = 0xBC; r0 = add(PC,0x11481) }
	{ memw(r29+12) = r8; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(PC,0x114B4) }
	{ memw(r29+4) = r6; memw(r29+16) = r2; r2 = r25 }
	{ memw(r29) = r5; jump 00016288 }

l0001633C:
	{ memw(r29+44) = r16; r23 = memd(r29+112); r0 = add(PC,0x1144D) }
	{ r19 = memw(r29+68); r1 = 0xBC; r4 = add(PC,0x114BC) }
	{ memw(r29+40) = r23; r20 = memd(r29+88) }
	{ memw(r29+32) = r19; memw(r29+36) = r20 }
	{ memw(r29+28) = r12; memw(r29+52) = r24 }
	{ memw(r29+24) = r9; memw(r29+48) = r25 }
...
l000164FC:
	{ memb(r29) = r2.new; r2 = memw(r29+52); r0 = add(PC,0x1128D) }
...
l00016750:
	...
	{ call errlog_function; r3 = add(PC,0x1106E) }
...
qsoftmax_execute_ref proc
	{ allocframe(#0x68); memd(r29-48) = r25:r24; r6 = 0x437F0000 }
	{ r24 = r0 }
	...
	{ r2 = r25; r1 = 0x4A; r4 = add(PC,0x10FF5) }
...
l000169BC:
	...
	{ memw(r29+24) = r25; memw(r5+8) = r6; if (p0) r20 = 0x7F800000 }
	{ r7 = memw(r18+12); if (p0) r18 = 0xFF800000 }
	{ memw(r5+24) = r22; memw(r5+12) = r7; if (p0) r22 = 0x0 }
	{ if (p0) memw(r29+16) = r5; memw(r29+40) = r2; if (p0) jump:nt 00016A20 }

l00016A0C:
	{ r18 = 0xFF800000; r20 = 0x7F800000 }
	{ jump 00016BC8 }
...
l00016AD4:
	{ memw(r29+44) = r22; r0 = 0x3F800000; r1 = r24 }
	{ call fn00009610 }
...
l00016B70:
	{ r2 = memd(r29+16); r0 = 0x3F800000; r1 = r18 }
	{ r16 = memw(r2+16); call fn00009610 }
	{ r3 = memd(r29+40); r2 = 0x3F000000 }
...
l00016BC8:
	{ r6 = memd(r29+32); r7 = memd(r29+28); r4 = add(PC,0x10DCE) }
...
qsoftmax_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x10CF8) }
...
l00016C7C:
	{ r2 = r16; r1 = 0x8E; r4 = add(PC,0x10CD8) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     00016CB4 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x10C3B) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
nop_execute proc
	{ allocframe(0x18); r2 = r1; r4 = add(PC,0x10D31) }
...
;; nop_check: 00016D70
nop_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x10C75) }
...
l00016DA8:
	{ r2 = r16; r1 = 0x3D; r4 = add(PC,0x10C64) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;; nop_ctor: 00016DC4
nop_ctor proc
	{ allocframe(0x28); memd(r29-24) = r19:r18; r6 = add(PC,0x10C0D) }
...
;; nop_dtor: 00016E1C
nop_dtor proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x10BA4) }
...
errlog_function proc
	{ allocframe(0x8); r3 = 0x0; r0 = add(PC,0x10B37) }
	{ r5 = add(r29,0x10); r1 = 0x3C; r4 = add(PC,0x10B7E) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); call logv }
	{ r0 = memw(r0); r0 = memw(r0) }
	{ r0 = memw(r0); r0 = memw(r0) }
...
output_execute proc
	{ allocframe(0x20); memd(r29-16) = r17:r16; r4 = add(PC,0x10BF6) }
	{ r16 = r1; r1 = 0x34 }
	{ memd(r29+8) = r21:r20; memd(r29+16) = r19:r18; r18 = r0; r2 = r16 }
	{ memw(r29) = r18; call logmsg_function }
	{ r2 = memw(r16+32) }
...
l00016F5C:
	{ memw(r29) = r2; r1 = 0x41; r4 = add(PC,0x10B75) }
	{ r2 = r16; call logmsg_function }
...
output_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x10AD3) }
...
l00016FDC:
	{ r2 = r16; r1 = 0x4C; r4 = add(PC,0x10AA2) }
...
;;     00017014 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x10A13) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
pprint_8_execute proc
	{ allocframe(#0x48); r4 = add(PC,0x10AAF) }
	...
	{ memw(r29+12) = r18; r3:r2 = combine(0x1,r16); r4 = add(PC,0x10A7F) }
...
l000170DC:
	{ memb(r29+4) = r2.new; r2 = memb(r25++#1); r4 = add(PC,0x10AA5) }
...
l0001717C:
	{ r1 = 0x50; r3 = 0x2; r4 = add(PC,0x109F5) }
	{ call logmsg_function }
	{ dealloc_return; r0 = 0x0 }

;; pprint_32_execute: 00017194
pprint_32_execute proc
	{ allocframe(#0x48); r4 = add(PC,0x1096B) }
	{ r5 = memw(r0+28); r2 = memw(r0+4) }
	...
	{ memd(r29+24) = r27:r26; memw(r29+4) = r5 }
	{ memw(r29) = r0; call logmsg_function }
	{ memw(r29+12) = r18; r3:r2 = combine(0x1,r16); r4 = add(PC,0x1093B) }
...
l00017220:
	{ memb(r29+4) = r2.new; r2 = memw(r25++#4); r4 = add(PC,0x1091C) }
	{ memw(r29+4) = r23; r3:r2 = combine(0x1,r16) }
	{ memw(r29+8) = r24; memw(r29+12) = r26 }
	{ memw(r29) = r22; call logmsg_function }
...
pprint_f_execute proc
	{ allocframe(#0x48); r4 = add(PC,0x1086F) }
	{ r5 = memw(r0+28); r2 = memw(r0+4) }
	...
	{ memd(r29+24) = r27:r26; memw(r29+4) = r5 }
	{ memw(r29) = r0; call logmsg_function }
	{ memw(r29+12) = r18; r3:r2 = combine(0x1,r16); r4 = add(PC,0x1083F) }
...
l0001731C:
	{ r2 = memw(r25); r25 = add(r25,0x4); r4 = add(PC,0x1080E) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x10733) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
prefree_execute proc
	{ r2 = r1; r1 = 0x31; r3 = add(PC,0x10825) }
...
prefree_check proc
	{ r2 = r1; r1 = 0x36; r3 = add(PC,0x107E1) }
	{ allocframe(#0x0); call errlog_function }
	{ dealloc_return; r0 = #-0x1 }
...
prefree_ctor proc
	{ allocframe(0x28); memd(r29-24) = r19:r18; r6 = add(PC,0x107A9) }
	{ r19:r18 = combine(r5,r0) }
	{ memd(r29+16) = r21:r20; memd(r29+32) = r17:r16; r21:r20 = combine(r2,r3); r17:r16 = combine(r4,r1) }
...
prefree_dtor proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x10734) }
...
;;     000174C0 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x106C7) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
quantize_execute proc
	{ allocframe(#0x40); r4 = add(PC,0x10805) }
...
l000175AC:
	{ r4 = 0x0; r2 = convert_sf2uw(r25); r3 = convert_sf2uw(r27) }
	{ memw(r19+24) = r21; r18 = r4 }
	{ memw(r19) = r2; memw(r19+8) = r3; r1:r0 = combine(r17,r18) }
	{ memw(r19+4) = r7; memw(r19+12) = r6 }
	{ call fn000097B0 }
	{ r16 = r0 }
	{ r17 = 0x437E0000; call fmaxf.1.0; r0 = sfsub(r20,r16) }
	{ r1 = r17; r19 = r0; call fn00009610 }
	{ r1:r0 = combine(r19,r17); r20 = r0; call fn00009610 }
	{ r16 = r0; r2 = 0xD916872B; r4 = sfsub(r18,r16) }
	{ r3 = 0x3FEFF7CE; r4 = sfmpy(r4,r16) }
	{ call fn000097D0; r1:r0 = convert_sf2df(r4) }
	{ r3 = 0x437F0000; p0 = sfcmp.gt(r24,r18); r2 = convert_df2w(r1:r0):chop }
...
l000176E8:
	{ memb(r29+2) = r0.new; r0 = p0; r4 = add(PC,0x105EF) }
	{ r1 = 0x9E }

l00017700:
	{ r0 = p0; r4 = add(PC,0x10569) }
	{ memw(r29+8) = r0 }
	{ memw(r29) = r17; r2 = r16 }
	{ call logmsg_function }
	{ r0 = memw(r29+8) }
...
l00017764:
	{ if (!p1) jump:nt 00017744; r3 = add(PC,0x10530) }

l00017770:
	{ r1 = 0xA9; jump 00017744; r3 = add(PC,0x10524) }

l00017780:
	{ if (!p1) r1 = 0xA1; if (p1) jump:nt 00017798 }

l00017788:
	{ jump 000177A4; r4 = add(PC,0x10569) }

l00017794:
	{ if (!p0.new) jump:nt 00017770; p0 = cmp.eq(r2,0x1) }

l00017798:
	{ r1 = 0xAA; r4 = add(PC,0x1050C) }
...
dequantize_execute proc
	...
	{ r1 = 0x437F0000; call fn00009610 }
	{ r3 = memw(r22+4); r2 = memw(r22); r5 = 0x40800000 }
	{ r7 = memw(r22+12); r6 = memw(r22+8); r4 = add(PC,0x104B6) }
...
l00017874:
	{ r2 = 0x0; r5 = convert_sf2uw(r25); r4 = convert_sf2uw(r26) }
...
dequantize_i32_execute proc
	...
	{ r3 = memw(r18+4); r2 = memw(r18); r5 = 0x40800000 }
	{ r6 = memw(r18+12); r4 = memw(r18+8); r7 = 0x2F800000 }
	...
	{ r3 = sfmpy(r3,r25); r4 = add(PC,0x102F4) }
	{ r17 = sfmpy(r3,r22) }
	{ r3 = sfmpy(r17,r5) }
...
l00017998:
	{ r2 = 0x0; r5 = convert_sf2uw(r25); r4 = convert_sf2uw(r24) }
...
;;     00017A18 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x101FE) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
relu_execute proc
	{ allocframe(0x48); memd(r29-16) = r17:r16; r4 = add(PC,0x1033E) }
...
l00017BF0:
	...
	{ r3 = memw(r18+16); r2 = memw(r19); r4 = add(PC,0x10213) }
	{ r3 = memw(r3); r2 = memw(r2); r1 = 0x64 }
	{ r2 = r17; r9:r8 = convert_sf2df(r3); r7:r6 = convert_sf2df(r2) }
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call logmsg_function }
	{ r2 = r17; r1 = 0x65; r4 = add(PC,0x10197) }
	{ memw(r29) = r16; call logmsg_function }
	{ r0 = 0x0 }
...
;; relu_check: 00017C60
relu_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x10170) }
	{ r17 = r0; r16 = r1; r1 = 0x98 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r1 = 0x99; r3 = add(PC,0x100D5) }
...
l00017CCC:
	{ r1 = 0x9C }
	{ r6 = memw(r17+8); r3 = add(PC,0x100AB) }
...
l00017CF8:
	{ r2 = r16; r1 = 0x9F; r4 = add(PC,0x100EE) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
reluX_execute proc
	{ allocframe(0x40); memd(r29-16) = r17:r16; r4 = add(PC,0x1007E) }
	{ r16 = r0 }
	...
	{ memw(r29) = r16; call logmsg_function }
	{ r0 = 0x38D1B717; call fn00009600; r1 = sfsub(r22,r20) }
	{ r2 = 0x437F0000 }
	{ r1:r0 = combine(r0,r2); call fn00009610 }
	{ r22 = r0; r2 = 0x0 }
	{ r2 = sfsub(r2,r20) }
...
l00017EA0:
	...
	{ r2 = r18; r1 = 0x91; r4 = add(PC,0xFF07) }
	{ memw(r29) = r16; call logmsg_function }
	{ r0 = 0x0 }
...
reluX_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xFE4E) }
	{ r17 = r0; r16 = r1; r1 = 0xA6 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r1 = 0xA7; r3 = add(PC,0xFE49) }
...
l00017F44:
	{ if (!cmp.eq(r7.new,0x0)) jump:t 00017F5C; r7 = memw(r6++#4); r3 = add(PC,0xFE2C) }
...
l00017F5C:
	{ r7 = memw(r17+8); r3 = add(PC,0xFE1F) }
...
l00017F9C:
	{ r2 = r16; r1 = 0xAE; r4 = add(PC,0xFDEB) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     00017FD4 (in logmsg_function)
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xFD3C) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
autorequantize_execute proc
	{ allocframe(0x48); r5 = 0x2F800000 }
	{ memd(r29+64) = r17:r16; r17:r16 = combine(r1,r0); r4 = add(PC,0xFEF9) }
	...
	{ call logmsg_function }
	{ r3 = memw(r24+16); r2 = memw(r25+16); r4 = add(PC,0xFE9A) }
...
l0001812C:
	...
	{ r6 = memw(r22+8); if (p0) r2 = 0x4F000000 }
	{ memw(r23+8) = r6; if (p0) r24 = 0xCF000000 }
	{ r7 = memw(r22+12) }
...
l000181CC:
	{ r22 = 0x0; r1 = sfmpy(r21,r2) }
	{ r0 = r22; call fn000097B0 }
	{ r23 = r0 }
	{ r0 = togglebit(r23,0x1E) }
	{ r24 = 0x437E0000; call fmaxf.1.0; r0 += sfmpy(r21,r24) }
	{ r1 = r24; r25 = r0; call fn00009610 }
	{ r0 = r24; r25 = r0; r1 = r25; call fn00009610 }
	{ r23 = r0; r2 = 0xD916872B; r4 = sfsub(r22,r23) }
	{ r3 = 0x3FEFF7CE; r4 = sfmpy(r4,r23) }
	{ call fn000097D0; r1:r0 = convert_sf2df(r4) }
	{ p0 = cmp.gtu(r20,0x7F); r3 = 0x437F0000; r2 = convert_df2w(r1:r0):chop }
	{ if (p0) r4 = 0x4F000000; r2 = sub(0x0,r2) }
	{ r2 = convert_w2sf(r2) }
	{ r22 = sfmpy(r25,r2) }
	{ if (!p0) r0 = memw(r29+16); r24 = r22; if (p0) r1:r0 = combine(r21,r22) }
	{ if (p0) r3 = 0x3F000000; if (p0) jump:nt 000182A8; r24 += sfmpy(r25,r3) }
...
l000182C8:
	{ memw(r26+12) = 0xFFFFFF81; r2 = memw(r26+16); r4 = add(PC,0xFD61) }
	...
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call logmsg_function }
	{ r2 = r17; r1 = 0x81; r4 = add(PC,0xFD1B) }
	{ memw(r29) = r16; call logmsg_function }
	{ r0 = 0x0 }
...
autorequantize_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xFC72) }
	{ r17 = r0; r16 = r1; r1 = 0x107 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r1 = 0x108; r3 = add(PC,0xFAED) }
...
l000183CC:
	{ r1 = 0x10B }
	{ r6 = memw(r17+8); r3 = add(PC,0xFC2D) }
...
l000183F8:
	{ r2 = r16; r1 = 0x10E; r4 = add(PC,0xFC11) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
requantize_execute proc
	{ allocframe(#0x50); r4 = add(PC,0xFB39) }
	{ memd(r29+72) = r17:r16; r6 = 0x2F800000; r17 = r0 }
	...
	{ r3 = memw(r23+16); r2 = memw(r19+16); r4 = add(PC,0xFAB2) }
...
l00018514:
	{ r3 = memw(r24+4); r2 = memw(r24); r23 = 0x0 }
	...
	{ r24 = 0x437E0000; call fmaxf.1.0; r0 = sfsub(r2,r22) }
	{ r1 = r24; r25 = r0; call fn00009610 }
	{ r1:r0 = combine(r25,r24); r16 = r0; call fn00009610 }
	{ r2 = 0xD916872B; r4 = sfsub(r23,r22) }
	{ r3 = 0x3FEFF7CE }
	{ r4 = sfmpy(r4,r0) }
	{ call fn000097D0; r1:r0 = convert_sf2df(r4) }
	{ p0 = cmp.gtu(r20,0x7F); r2 = convert_df2w(r1:r0):chop }
	{ r2 = 0x437F0000; r3 = sub(0x0,r2) }
	{ r3 = convert_w2sf(r3) }
	{ r22 = sfmpy(r16,r3) }
	{ r23 = r22 }
...
l0001864C:
	{ memw(r26+12) = 0xFFFFFF81; r2 = memw(r26+16); r4 = add(PC,0xF955) }
	...
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call logmsg_function }
	{ r2 = r16; r1 = 0xC9; r4 = add(PC,0xF913) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
requantize_check__merged proc
	{ allocframe(0x28); p0 = cmp.eq(r2,0x1); r4 = add(PC,0xF839) }
	{ memd(r29+24) = r19:r18; memd(r29+32) = r17:r16; if (!p0) r1 = 0x114; r17:r16 = combine(r0,r1) }
	{ if (p0) r1 = 0x11D; r18 = add(PC,0xF83D) }
...
l00018720:
	{ r19 = 0x120; r23:r22 = combine(0x3,0x2); r4 = add(PC,0xF72B) }
	{ r21 = 0x11E; r20 = 0x11F; r18 = add(PC,0xF758) }
...
requantrange_execute proc
	{ allocframe(0x38); r6 = 0x2F800000 }
	{ memd(r29+48) = r17:r16; r17:r16 = combine(r1,r0); r4 = add(PC,0xF6FA) }
	...
	{ r3 = memw(r24+16); r2 = memw(r23+16); r4 = add(PC,0xF6A5) }
...
l00018858:
	{ r3 = 0x4F000000; r2 = 0xCF000000 }
	{ jump 000188CC }

l0001886C:
	{ r2 = 0x7FFFFFFF; r3 = 0x80000000 }
...
l000188CC:
	...
	{ memw(r18) = 0x1; r2 = sfmpy(r20,r2); r4 = add(PC,0xF604) }
	...
	{ r2 = r17; r1 = 0xFF; r4 = add(PC,0xF5D0) }
	{ memw(r29) = r16; call logmsg_function }
	{ r0 = 0x0 }
	{ r19:r18 = memd(r29+40); r17:r16 = memd(r29+48) }
	{ r23:r22 = memd(r29+24); r21:r20 = memd(r29+32) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xF49B) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l00018B90:
	...
	{ r3 = memw(r24+16); r2 = memw(r22+16); r24 = 0x437F0000 }
...
l00018E38:
	{ r20 = memd(r29+84); r2 = memw(r17+28); r4 = add(PC,0xF6E7) }
	...
	{ r5 = memw(r29+128); r3:r2 = combine(0x2,r16); r4 = add(PC,0xF8EE) }
	...
	{ memd(r29+16) = r9:r8; r22 = memw(r29+132); r4 = add(PC,0xF8D6) }
	...
	{ r1 = 0x3DB; r3:r2 = combine(0x2,r16); r4 = add(PC,0xF6A3) }
	{ memw(r29+4) = r24; r5 = memw(r29+148) }
	{ memw(r29) = r5; call logmsg_function }
	{ r1 = 0x3DC; r3:r2 = combine(0x2,r16); r4 = add(PC,0xF69A) }
...
l00018FDC:
	{ r2 = memw(r29+76); r1 = 0x3E7; r3 = add(PC,0xF62F) }
...
l0001905C:
	{ r3:r2 = combine(0x2,r16); r4 = add(PC,0xF76B) }
	{ call logmsg_function }
...
l00019080:
	{ r3:r2 = combine(0x2,r16); r4 = add(PC,0xF760) }
	{ call logmsg_function }
...
l00019090:
	...
	{ r7 = memw(r29+44) }
	{ memw(r2+12) = r27; if (p0) r2 = 0x3F000000; if (!p0) jump:nt 000190DC }
...
l000190E4:
	...
	{ r3 = r0; r2 = add(r29,0xE8); r21 = add(PC,0xC38) }
...
l00019194:
	{ r5 = memw(r17+28); r7:r6 = convert_sf2df(r2); r4 = add(PC,0xF664) }
...
l000191C4:
	{ r5 = memd(r29+68); r3 = memd(r29+72); r4 = add(PC,0xF667) }
...
l000192F4:
	{ memw(r29) = r6; r1 = 0x445; r3 = add(PC,0xF3E6) }
	{ jump 00019418 }
...
l00019338:
	...
	{ r1 = 0x460; r2 = mpyi(r23,r25); r3 = add(PC,0xF36B) }
...
l000193B0:
	...
	{ if (!p2) memw(r20+4) = 0x3F000000; if (!p1) r25 = 0x0; r22 = and(r4,0xFFFFFFF0) }
...
l000193F8:
	...
	{ memw(r20) = r0; r1 = 0x46B; r3 = add(PC,0xF30A) }
...
l00019428:
	...
	{ call transpack }
	{ r0 = r24; call nn_os_vector_release }
	{ r1 = 0x471; r3:r2 = combine(0x2,r16); r4 = add(PC,0xF2DF) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
l000195E8:
	...
	{ r6 = memd(r29+88); r1 = memd(r29+92); r19 = 0x437F0000 }
	{ r2 = memw(r2+16); r3 = memw(r3+16) }
	...
	{ call logmsg_function }
	{ p0 = cmp.eq(r21,r26); r1 = 0xF5; r3 = add(PC,0xED8E) }
