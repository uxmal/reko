...
hexagon_nn_skel_invoke proc
	{ allocframe(00000078); memd(r29+496) = r17:r16; r2 = add(badva,00000010) }
...
allocate_graph_storage proc
	{ allocframe(00000020); r3 = 00000000; r2 = 00000080 }
...
l0000A6F4:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000A7BC; r2 = memw(r17+20) }
...
l0000A708:
	{ if (cmp.eq(r4.new,00000000)) jump:nt	0000A7B0; r4 = memw(r3+20) }
...
l0000A71C:
	...
	{ r5:r4 = combine(00000000,00000000); r19 = r0; r2 = add(badva,0000002C) }
	{  }
...
l0000A75C:
	{ r2 = r16; r1 = 000000F9; r3 = add(badva,00000002) }
	{ call	errlog_function }
	{ r2 = r16; r1 = 00000110; r3 = add(badva,00000021) }
	{ call	errlog_function }
	{ r1 = 0000014C; jump	0000A8E8; r3 = add(badva,00000008) }
...
l0000A794:
	...
	{ r2 = memw(r17+20) }
	{ if (cmp.gtu(r2,r18.new)) jump:t	0000A708; r18 = add(r18,00000001); r20 = add(r20,00000004) }

l0000A7B0:
	{ if (cmp.gtu(r2,r18.new)) jump:t	0000A708; r18 = add(r18,00000001) }
...
l0000A7C0:
	...
	{ p0 = cmp.eq(r0,00000000); r1 = 0000014E; r3 = add(badva,00000016) }
...
l0000A800:
	...
	{ p0 = cmp.eq(r0,00000000); r1 = 00000155; r3 = add(badva,00000021) }
...
l0000A828:
	{ r3 = add(badva,0000002B) }
	{ r2 = r16; call	errlog_function }

l0000A838:
	{ r1 = 00000156; jump	0000A8E8; r3 = add(badva,0000003D) }

l0000A848:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000A868; r2 = memw(r16+44); r1 = 000000CB }

l0000A858:
	{ jump	0000A838; r3 = add(badva,00000005) }
0000A860 91 C1 90 91 4E 76 FF 5B                         ....Nv.[        
...
l0000A878:
	{ jump	0000A838; r3 = add(badva,0000003A) }

l0000A884:
	{ r4 = add(badva,0000003F) }
	{ memw(r29+4) = r0 }
	...
	{ p0 = cmp.eq(r0,00000000); r1 = 00000158; r3 = add(badva,00000037) }
...
l0000A8F4:
	{ if (cmp.eq(r0.new,00000001)) jump:nt	0000A8F4; r0 = memw(r16); r17 = 00000000; r18 = r16 }

l0000A908:
	{ r18 = add(r0,00000024) }

l0000A90C:
	{ if (cmp.eq(r0.new,00000001)) jump:nt	0000A8EC; r0 = memw(r18) }

l0000A918:
	{ if (!cmp.eq(r2.new,0000001B)) jump:nt	0000A90C }
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000035) }
...
allocate_and_free proc
	{  }
	{ allocframe(00000028); memd(r29+496) = r17:r16 }
	{ memd(r29+24) = r19:r18; r19 = memw(r17) }
	{ memd(r29+16) = r21:r20 }
	{ memd(r29+8) = r23:r22; if (!p0.new) r18 = add(r17,00000028); if (p0.new) jump:nt	0000AAD4; p0 = cmp.eq(r11,00000001) }

l0000A980:
	{ if (cmp.eq(r2.new,0000001A)) jump:t	0000A9D0; r2 = memw(r19+24); r1:r0 = combine(r18,r17) }

l0000A984:
	{ if (cmp.eq(r2.new,0000001A)) jump:t	0000A9D0; r2 = memw(r19+24) }

l0000A990:
	{ if (cmp.eq(r2.new,00000001)) jump:nt	0000AAD4; r2 = memw(r19+20) }

l0000A99C:
	{ r21 = memw(r31+r20<<#2) }
	{ if (cmp.eq(r3.new,00000001)) jump:nt	0000AAC8; r3 = memw(r21+20) }

l0000A9AC:
	{ if (!cmp.eq(r4.new,00000001)) jump:t	0000AAC8 }

l0000A9B4:
	{ if (cmp.eq(r4.new,00000001)) jump:nt	check_allocations; r4 = memw(r18) }

l0000A9C0:
	{ r2 = and(r2,FFFFFF80); jump	0000AA30 }
0000A9C8                         42 C0 93 91 03 C0 82 91         B.......
...
l0000A9F4:
	{ r2 = memw(r19+8); r1 = 00000127; r4 = add(badva,00000031) }
	{  }
	{ r5 = memw(r2) }
	{ r6 = memw(r5+20) }
...
l0000AA30:
	{ r0 = r4 }
	{ if (cmp.gtu(r2,r4.new)) jump:t	0000AA28; r4 = memw(r0+8) }

l0000AA40:
	{ if (!p0.new) r3 = sub(r4,r2); if (!p0.new) jump:nt	0000AA58; p0 = cmp.eq(r4,-00000001) }
...
l0000AA58:
	...
	{ if (!cmp.gtu(r2,r3.new)) jump:t	0000AA90; r3 = memw(r17+48) }

l0000AA70:
	{ r4 = add(badva,0000002A) }
	{ memw(r17+48) = r2 }
...
l0000AA98:
	{ r1 = 00000131; jump	0000A9F0; r3 = add(badva,0000001D) }
0000AAA8                         A1 46 00 00 04 4D 49 6A         .F...MIj
0000AAB0 1E 08 D5 C5 62 60 31 73 00 C5 9D A1 90 C0 00 5A ....b`1s.......Z
0000AAC0 A2 C0 93 91 34 40 14 B0                         ....4@..        

l0000AAC8:
	{ if (cmp.gtu(r2,r20.new)) jump:t	0000A99C }

l0000AACC:
	{ if (!cmp.eq(r19.new,00000000)) jump:t	0000A984; r19 = memw(r19+36) }
...
;;     0000A9B4 (in allocate_and_free)
check_allocations proc
	{ allocframe(+00000018); r1 = 000000B8; r4 = add(badva,00000006) }
	...
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000AB3C; r2 = memw(r16+40) }

l0000AB24:
	{ if (!cmp.eq(r4.new,00000000)) jump:t	0000AB2C; r4 = memw(r4); r3 = add(r3,FFFFFFFF) }

l0000AB2C:
	{ if (!cmp.eq(r4.new,00000000)) jump:t	0000AB2C }

l0000AB34:
	{ if (p0.new) r2 = memw(r2+8) }
	{ r2 = r16; r1 = 000000BE; r3 = add(badva,00000039) }
...
allocator_teardown proc
	...
	{ if (cmp.eq(r0.new,00000000)) jump:nt	0000ABC8; r0 = memw(r16+40) }
...
logmsg_function proc
	{ allocframe(+00000008) }
	{ if (cmp.gtu(r3,r5.new)) jump:t	prefree; r5 = memw(r2+16) }

l0000ABEC:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,0000000D) }
...
l0000AC30:
	{ r2 = r18; r1 = 000000A0; r3 = add(badva,0000000D) }
	{ call	errlog_function }
	{ jump	0000ACC4 }
0000AC48                         E8 48 32 17                     .H2.    
...
l0000AC50:
	...
	{ if (cmp.gtu(r17,r5.new)) jump:t	0000AC4C; r5 = add(r3,r4) }

l0000AC60:
	{ memb(r2+2) = r3.new; r0 = memw(r2); r17 = 00000000; r3 = add(r3,r19) }
	{ if (!p0.new) r5 = memw(r0+4) }
	{ if (!cmp.eq(r4.new,r5)) jump:t	0000ACC8; r4 = add(r4,r3) }
...
do_execute proc
	...
	{ call	fn00009530 }
	{ if (cmp.eq(r17.new,00000000)) jump:nt	0000AD60; r17 = memw(r16); r19:r18 = combine(r1,r0) }
...
l0000AD10:
	...
	{ r2 = memw(r2) }
	{ callr	r2 }
	{ if (!cmp.eq(r20.new,00000000)) jump:nt	0000AD5C; r20 = r0 }
...
hexagon_nn_getlog proc
	{ allocframe(00000010); r4 = 0000000E; r3 = add(badva,00000001) }
	{ memd(r29) = r19:r18; memd(r29+8) = r17:r16; r18 = r2; r17:r16 = combine(r1,r0) }
	{ r1:r0 = combine(r3,r17); call	fn00009564; r2 = min(r4,r18) }
	{ r0 = FFFFFFFF; if (p0.new) jump:nt	0000AE94; p0 = cmp.eq(r8,00000000); r2 = add(r17,add(r18,0000003F)) }
...
hexagon_nn_snpprint proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r3 = add(badva,00000019) }
...
l0000AEF8:
	{ r1 = 00000087; r2 = 00000000; r3 = add(badva,0000001F) }
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000023) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0000AF48:
	{ r1 = 00000098; r2 = 00000000; r3 = add(badva,0000000F) }
	{ memw(r29) = 00000000; jump	0000AF78 }

l0000AF60:
	{ if (cmp.eq(r4.new,00000002)) jump:t	0000AF84; r4 = memb(r0+36) }

l0000AF6C:
	{ r2 = r0; r1 = 0000009B; r3 = add(badva,00000002) }

l0000AF78:
	{ call	errlog_function }
	{ dealloc_return; r0 = -00000001 }
0000AF80 57 1C 44 3C                                     W.D<            
...
l0000AF9C:
	{ r1 = 000000B4; r2 = 00000000; r3 = add(badva,0000003B) }
	{ memw(r29) = 00000000; jump	0000AFCC }

l0000AFB4:
	{ if (cmp.eq(r6.new,00000002)) jump:t	0000AFD8; r6 = memb(r0+36) }

l0000AFC0:
	{ r2 = r0; r1 = 000000B7; r3 = add(badva,0000002E) }

l0000AFCC:
	{ call	errlog_function }
	{ dealloc_return; r0 = -00000001 }
0000AFD4             A7 40 9D 91                             .@..        
...
l0000B004:
	{ r1 = 000000D5; r2 = 00000000; r3 = add(badva,00000013) }
	{ memw(r29) = 00000000; jump	0000B034 }

l0000B01C:
	{ if (cmp.eq(r2.new,00000004)) jump:t	0000B048; r2 = memb(r17+36) }

l0000B028:
	{ r2 = r17; r1 = 000000D8; r3 = add(badva,0000002B) }

l0000B034:
	{ call	errlog_function }
	{ r19:r18 = memd(r29+16); r17:r16 = memd(r29+24); r0 = FFFFFFFF }
	{ dealloc_return; r21:r20 = memd(r29+8) }
0000B044             12 40 00 5A                             .@.Z        

l0000B048:
	{ memw(r29) = r18; memw(r29+4) = r20; r2 = r17 }
...
logmsg_function proc
	...
	{ if (cmp.gtu(r4,r3.new)) jump:t	hexagon_nn_execute; r3 = memw(r2+16) }

l0000B078:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000000B) }
	{ r6 = add(r29,00000010); r1 = 000000DA; r4 = add(badva,00000022) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }

;; hexagon_nn_execute: 0000B09C
;;   Called from:
;;     0000B06C (in logmsg_function)
...
l0000B0D4:
	{ r1 = 000000F9; r2 = 00000000; r3 = add(badva,00000003) }
	{ jump	0000B100 }

l0000B0E8:
	{ if (cmp.eq(r2.new,00000004)) jump:t	0000B110; r2 = memb(r0+36) }

l0000B0F4:
	{ r2 = r0; r1 = 000000FC; r3 = add(badva,0000001F) }

l0000B100:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0000B144 }
0000B10C                                     24 40 00 78             $@.x

l0000B110:
	{ r1 = add(r29,00000028); r2 = 00000001; r3 = add(r29,00000008) }
...
l0000B158:
	{ r1 = 0000010B; r2 = 00000000; r3 = add(badva,0000003F) }
	{ memw(r29) = 00000000; call	errlog_function }
	{ dealloc_return; r0 = -00000001 }
...
l0000B1AC:
	{ r1 = 00000117; r2 = 00000000; r3 = add(badva,0000002B) }
	{ call	errlog_function }
...
l0000B1D0:
	{ r1 = 00000124; r2 = 00000000; r3 = add(badva,00000007) }
	{ memw(r29) = 00000000; call	errlog_function }
	{ dealloc_return; r0 = -00000001 }
...
l0000B208:
	{ r1 = 00000134; r2 = 00000000; r3 = add(badva,0000000F) }
	{ memw(r29) = 00000000; call	errlog_function }
	{ dealloc_return; r0 = -00000001 }
...
hexagon_nn_op_name_to_id proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r2 = add(badva,00000000) }
...
l0000B278:
	...
	{ if (p0.new) r0 = FFFFFFFF; p0 = cmp.gt(r18,00000072); jump	0000B294; if (!p0.new) jump:nt	0000B26C }
...
hexagon_nn_op_id_to_name proc
	...
	{ if (p0) jump:nt	0000B2DC }

l0000B2A8:
	{ memd(r29) = r19:r18; r18 = r2 }
	{ r2 = add(badva,00000024) }
	{ r2 = memw(r2-192) }
	{ r19 = memw(r14+r0<<#2) }
	{ r0 = r19; call	fn00009570 }
	{ if (cmp.gtu(r2.new,r18)) jump:t	0000B2E0; r2 = add(r0,00000001) }
...
hexagon_nn_config proc
	{ r1 = 00000000; r0 = 00000000; r3:r2 = combine(FFFFFFFF,FFFFFFFF) }
...
;;     000153F0 (in fn000153DC)
;;     00015D64 (in logmsg_function)
;;     00016568 (in fn00016568)
...
;;     0001DA44 (in fn0001DA3C)
;;     0001DE54 (in fn0001DE4C)
;;     0001E17C (in fn0001E174)
;;     0001E32C (in fn0001E324)
...
logv proc
	...
	{ call	fn000095D0 }
	{ if (!cmp.gtu(r21,r18.new)) jump:t	0000B3F0; r18 = r0; r3:r2 = combine(r20,r19) }

l0000B3AC:
	{ r1:r0 = combine(r21,r17) }
	{ call	fn000095E4; r0 += add(r18,r22) }
	{ if (!cmp.gtu(r21,r19.new)) jump:t	0000B3F0; r19 = r0; r3 = add(r18,r22) }

l0000B3C8:
	{ r20 = sub(r21,r19); r2 = add(badva,0000000D) }
	{ r17 += add(r19,r3) }
	{ r1:r0 = combine(r20,r17); call	fn000095D0 }
	{ if (!p0.new) jump:nt	0000B3E8; p0 = cmp.gtu(r12,r0) }
...
node_alloc_common proc
	...
	{ call	fn00009500 }
	{ if (cmp.eq(r17.new,00000001)) jump:nt	0000B5E8; r17 = r0; r1 = 000000A0 }

l0000B47C:
	{ r2 = add(badva,00000018) }
...
l0000B4B8:
	{ call	fn00009504; r0 = asl(r19,00000003) }
	{ memb(r17+3) = r20.new; r20 = r0 }
	{ r1 = 00000057 }
	{ r3 = add(badva,0000001A) }
	{ r2 = r16; call	errlog_function }
	{ r1 = 000000A4; jump	0000B5F4; r3 = add(badva,00000028) }
...
l0000B550:
	{ call	fn00009504; r0 = asl(r18,00000002) }
...
l0000B580:
	{ jump	0000B59C; r3 = add(badva,0000000E) }
0000B58C                                     7C 46 00 00             |F..
0000B590 03 D1 49 6A 38 40 00 5A 02 C0 70 70             ..Ij8@.Z..pp    

l0000B59C:
	{ r1 = 000000A8; jump	0000B5F4; r3 = add(badva,0000003F) }
...
l0000B5D0:
	...
	{ dealloc_return }
0000B5E0 79 46 00 00 83 44 49 6A                         yF...DIj        
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000000F) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
node_free_common proc
	...
	{ call	logmsg_function }
	{ if (cmp.eq(r0.new,00000000)) jump:nt	0000B64C; r0 = memw(r16+4) }

l0000B648:
	{ if (cmp.eq(r0.new,00000000)) jump:nt	0000B658; r0 = memw(r16+12) }

l0000B64C:
	{ if (cmp.eq(r0.new,00000000)) jump:nt	0000B658 }

l0000B654:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000B688; r2 = memw(r16+20) }

l0000B658:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000B688 }
...
l0000B664:
	...
	{ if (cmp.gtu(r2,r18.new)) jump:t	0000B664; r18 = add(r18,00000001) }
...
logmsg_function proc
	...
	{ if (cmp.gtu(r4,r3.new)) jump:t	0000B6D8; r3 = memw(r2+16) }

l0000B6B4:
	{ r5 = add(r29,00000010); r3 = 00000003; r0 = add(badva,00000023) }
	{ r6 = add(r29,00000010); r1 = 000000B0; r4 = add(badva,00000033) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
;;     0000B6D8 (in logmsg_function)
do_append_node proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r6 = add(badva,00000030) }
...
l0000B718:
	{ memw(r0+36) = FFFFFF80 }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000B730; r2 = memw(r16) }
...
l0000B730:
	{ memw(r16) = r0; r17:r16 = memd(r29+8) }

l0000B734:
	{ dealloc_return }

l0000B738:
	{ r2 = r16; r1 = 000000D5; r3 = add(badva,00000007) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF }
...
l0000B774:
	{ memw(r0+36) = FFFFFF80 }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000B78C; r2 = memw(r16) }
...
l0000B794:
	{ r2 = r16; r1 = 000000FC; r3 = add(badva,0000002B) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
l0000B7CC:
	...
	{ r2 = memw(r3+12) }
	{ callr	r2 }
	{ r2 = r17; if (p0.new) jump:nt	0000B7C4; p0 = cmp.eq(r16,00000001) }

l0000B7E0:
	{ r2 = r16; r1 = 0000010E; r3 = add(badva,00000036) }
	{ call	errlog_function }
...
do_snpprint proc
	{ allocframe(00000040); memd(r29+488) = r19:r18; r3 = add(badva,00000026) }
	...
	{ memw(r29+4) = r2; r2 = r3 }
	{ call	fn000095D0 }
	{ if (!p0.new) r17 = sub(r17,r0); if (p0.new) jump:nt	0000B990; p0 = cmp.eq(r9,-00000001) }

l0000B85C:
	{ r20 = memw(r16); r18 = add(r18,r0); r19 = 00000000 }
	{ if (!p0.new) r7 = memb(r20-32); if (!p0.new) r8 = memw(r20+16); r1:r0 = combine(r17,r18); if (p0.new) jump:nt	0000B97C; p0 = cmp.eq(r12,00000001) }

l0000B874:
	{ r5 = memw(r20+28); r4 = memw(r20+24); r3 = add(badva,0000001C) }
	{ r3 = memw(r3-192); r6 = add(badva,00000008) }
	{ r9 = memw(r20+20); r2 = add(badva,00000018) }
...
l0000B8C8:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000B97C; r2 = memw(r16+16); r18 = add(r18,r0) }

l0000B8D8:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000B938 }

l0000B8E0:
	{ r3 = memw(r20+12); r4 = memw(r20+4); r2 = add(badva,00000012) }
...
l0000B918:
	...
	{ if (cmp.gtu(r2,r23.new)) jump:t	0000B8E4; r23 = add(r23,00000001) }
...
l0000B940:
	{ r3 = memw(r20+8); r1:r0 = combine(r17,r18); r2 = add(badva,0000001C) }
...
l0000B964:
	...
	{ if (cmp.gtu(r2,r22.new)) jump:t	0000B944; r22 = add(r22,00000001) }

l0000B978:
	{ r20 = memw(r20+4); r19 = r19 }

l0000B97C:
	{ memw(r29) = r19; r1:r0 = combine(r17,r18); r2 = add(badva,00000034) }
	{ call	fn000095D0 }
...
const_depth_extend_8 proc
	...
	{  }
	{ call	fn00009508 }
	{ if (cmp.eq(r20.new,00000000)) jump:nt	0000BA54; r20 = r0; r2 = FFFFFFFF }
...
l0000BA04:
	{ r1:r0 = combine(r19,r22); r2 = r18 }
	{ r19 = add(r19,r18); r2 = r17; r1 = r21; r0 = add(r22,r18) }
	{ r22 = add(r22,r24); call	fn000095F0 }
	{ if (!cmp.eq(r26.new,00000001)) jump:t	0000BA04; r26 = add(r26,FFFFFFFF) }
...
const_width_extend_8 proc
	...
	{  }
	{ call	fn00009508 }
	{ if (cmp.eq(r18.new,00000000)) jump:nt	0000BB30; r18 = r0; r2 = FFFFFFFF }

l0000BAC4:
	{ if (!cmp.gt(r27.new,00000000)) jump:nt	0000BB0C; r27 = mpyi(r20,r16); r19 = mpyi(r26,r19) }
...
l0000BAE0:
	{ r1:r0 = combine(r17,r20); r2 = r21 }
	{ r17 = add(r17,r21); r2 = r19; r1 = r22; r0 = add(r20,r21) }
	{ r20 = add(r20,r16); call	fn000095F0 }
	{ if (!cmp.eq(r27.new,00000001)) jump:t	0000BAE0; r27 = add(r27,FFFFFFFF) }
...
check_same_inputs proc
	{ if (cmp.gtu(r3,r4.new)) jump:t	0000BB94; r4 = memw(r1+16) }

l0000BB4C:
	{ if (cmp.gtu(r3,r4.new)) jump:t	try_pad_bad_supernodes; r4 = memw(r2+16) }
...
l0000BBC4:
	...
	{ if (cmp.eq(r18.new,r16)) jump:nt	0000BED0; r18 = r0 }
...
l0000BBE0:
	{ if (!cmp.gtu(r2,r20.new)) jump:nt	0000BC14; r20 = add(r20,00000001) }

l0000BBEC:
	{ r1:r0 = combine(r16,r17); r2 = r20 }
	{ if (!p0) r1:r0 = combine(r16,r17); if (p0.new) r2 = add(r20,00000000); if (!p0.new) jump:nt	0000BECC; p0 = cmp.eq(r0,-00000001) }

l0000BC00:
	{ call	find_last_consumer }
	{ if (p0.new) r2 = memw(r16+20); if (p0.new) jump:nt	0000BBE0; p0 = cmp.eq(r0,-00000001) }

l0000BC0C:
	{ jump	0000BECC }
0000BC10 A2 06 0B 48                                     ...H            

l0000BC14:
	{ p0 = cmp.eq(r2,00000031); if (!p0.new) jump:nt	0000BECC }

l0000BC1C:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000BED0; r2 = memw(r17) }

l0000BC28:
	{ r3 = memw(r4+56); jump	0000BC38 }
0000BC30 25 41 85 91                                     %A..            

l0000BC34:
	{ if (cmp.eq(r5.new,00000000)) jump:nt	0000BED0 }

l0000BC38:
	{ if (!cmp.eq(r6.new,r3)) jump:t	0000BC34; r6 = memw(r5+28) }
...
l0000BC44:
	{ r5 = memw(r5) }
	{ r24 = memw(r5+12) }
	{ if (!p0.new) r26 = add(r2,00000000); r5 = add(r24,0000001F); if (p0.new) jump:nt	0000BED0; p0 = bitsclr(r24,0000001F) }

l0000BC5C:
	{ r4 = memw(r4+8); r22 = and(r5,FFFFFFE0) }
	{ r20 = sub(r22,r24); jump	0000BC74 }
0000BC6C                                     3A 41 9A 91             :A..

l0000BC70:
	{ if (cmp.eq(r26.new,00000000)) jump:nt	0000BED0 }

l0000BC74:
	{ if (!cmp.eq(r5.new,r4)) jump:t	0000BC70; r5 = memw(r26+28) }
...
l0000BC80:
	{ r25 = r2 }
	{ if (cmp.eq(r25.new,00000000)) jump:nt	0000BED0; r25 = memw(r25+36) }
...
0000BCA0 35 41 95 91                                     5A..            

l0000BCA4:
	{ if (cmp.eq(r21.new,00000000)) jump:nt	0000BED0 }

l0000BCA8:
	{ if (!cmp.eq(r5.new,r4)) jump:t	0000BCA4; r5 = memw(r21+28) }
...
l0000BCB4:
	{ r5 = memw(r3+32) }
	{ if (cmp.eq(r4.new,00000000)) jump:nt	0000BED0; r4 = memw(r4+36) }
...
l0000BCCC:
	{ r3 = memw(r3+40) }
	{ if (cmp.eq(r2.new,00000001)) jump:nt	0000BED0; r2 = memw(r2+36) }

l0000BCD4:
	{ if (cmp.eq(r2.new,00000001)) jump:nt	0000BED0 }
...
l0000BCE4:
	...
	{ memw(r29+36) = r2 }
	{ call	fn00009500 }
	{ if (cmp.eq(r27.new,00000001)) jump:t	0000BED0; r27 = r0 }

l0000BDB8:
	{ r0 = memd(r29+36); r3 = memd(r29+44); r2 = r20 }
	{ r5 = memd(r29+40); r1 = memd(r29+32) }
	{ memb(r29+10) = r6.new; call	fn0000C79C; r6 = mpyi(r3,r0) }
	{ r0 = memw(r23+16) }
	...
	{ memw(r29+40) = r2 }
	{ call	fn00009500 }
	{ if (cmp.eq(r27.new,00000000)) jump:nt	0000BED4; r27 = r0; r3:r2 = combine(r23,r20) }

l0000BE40:
	{ r1 = memd(r29+36); r0 = memd(r29+40) }
	{ r5 = memw(r29+44) }
	{ memb(r29+11) = r6.new; call	fn0000C79C; r6 = mpyi(r23,r0) }
	{ r0 = memw(r25+16) }
...
logmsg_function proc
	{ allocframe(+00000008) }
	{ if (cmp.gtu(r3,r5.new)) jump:t	do_prepare; r5 = memw(r2+16) }

l0000BEF4:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,00000005) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
do_prepare proc
	...
	{ if (cmp.eq(r2.new,00000002)) jump:t	0000BF50; r2 = memb(r16+36); r1 = 000001E5 }

l0000BF34:
	{ r3 = add(badva,00000006) }
	{ r2 = r16 }
...
0000BF48                         11 40 90 91 1C 40 00 00         .@...@..

l0000BF50:
	{ if (cmp.eq(r22.new,00000000)) jump:nt	0000BFA0; r21 = add(r29,00000708) }
...
l0000BF74:
	{ r4 = add(badva,00000033) }
	{ call	logmsg_function }
	{ r1:r0 = combine(r17,r16); call	find_first_consumer.1.2_i32_0 }
	{ if (cmp.eq(r18.new,r17)) jump:nt	0000C0F8; r18 = r0 }

l0000BF98:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000BFDC; r2 = memw(r17+20) }

l0000BFA0:
	{ jump	0000BFAC }

l0000BFA4:
	{ if (!cmp.gtu(r2,r19.new)) jump:nt	0000BFD8; r19 = add(r19,00000001) }

l0000BFAC:
	{ r1:r0 = combine(r17,r16); r2 = r19; call	find_first_consumer }

l0000BFB0:
	{ r1:r0 = combine(r17,r16); r2 = r19 }

l0000BFB8:
	{ if (!p0) r1:r0 = combine(r17,r16); if (p0.new) r2 = add(r19,00000000); if (!p0.new) jump:nt	0000C0F4; p0 = cmp.eq(r0,-00000001) }

l0000BFC4:
	{ call	find_last_consumer }
	{ if (p0.new) r2 = memw(r17+20); if (p0.new) jump:nt	0000BFA4; p0 = cmp.eq(r0,-00000001) }

l0000BFD0:
	{ jump	0000C0F4 }
0000BFD4             C2 C0 92 91                             ....        
...
l0000BFE0:
	{ if (cmp.gtu(r20,r2.new)) jump:t	0000C0F8; r2 = memw(r17+16) }
...
0000C000 04 41 04 B0                                     .A..            

l0000C004:
	{ if (cmp.gt(r2.new,00000004)) jump:nt	0000C038; r2 = add(r2,00000001); r3 = add(r3,00000008) }

l0000C010:
	{ r5 = memw(r4-4) }

l0000C014:
	{ if (!cmp.eq(r6.new,r5)) jump:nt	0000C0F8; r6 = memw(r3-4) }

l0000C020:
	{ if (cmp.eq(r6.new,r5)) jump:t	0000C004; r6 = memw(r3) }

l0000C02C:
	{ r4 = add(badva,00000015) }

l0000C038:
	{ r1 = 000000D8 }
	{ call	logmsg_function }
	{ r2 = memw(r18+8); r3 = setbit(r21,00000004); r4 = add(badva,00000010) }
	{ r0 = r16; r5 = 00000003 }
	...
	{ memw(r29+4) = r21 }
	{ memw(r29) = r7; callr	r6 }
	{ if (cmp.eq(r19.new,00000000)) jump:nt	0000C0F8; r19 = r0 }
...
l0000C0F8:
	{ r22 = add(r2,00000024) }
	{ if (!cmp.eq(r17.new,00000000)) jump:t	0000BF68; r17 = memw(r2+36) }
...
l0000C128:
	{ if (!cmp.eq(r2.new,00000001)) jump:t	0000C2A0; r2 = memw(r3+36) }

l0000C134:
	{ if (cmp.eq(r2.new,00000001)) jump:nt	0000C2A0 }

l0000C13C:
	{ r3 = memw(r3+32) }
	{ if (cmp.eq(r2.new,00000001)) jump:nt	0000C2A0; r2 = memw(r2+36) }
...
l0000C154:
	{ if (!cmp.eq(r2.new,00000007)) jump:t	0000C2A0 }

l0000C15C:
	{ r1:r0 = combine(r17,r16) }
	{ if (cmp.eq(r18.new,r17)) jump:nt	0000C2A0; r18 = r0 }

l0000C168:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C1B0; r2 = memw(r17+20); r19 = 00000000 }

l0000C16C:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C1B0; r2 = memw(r17+20) }

l0000C178:
	{ if (!cmp.gtu(r2,r19.new)) jump:nt	0000C1AC; r19 = add(r19,00000001) }

l0000C184:
	{ r1:r0 = combine(r17,r16); r2 = r19 }
	{ if (!p0) r1:r0 = combine(r17,r16); if (p0.new) r2 = add(r19,00000000); if (!p0.new) jump:nt	0000C29C; p0 = cmp.eq(r0,-00000001) }

l0000C198:
	{ call	find_last_consumer }
	{ if (p0.new) r2 = memw(r17+20); if (p0.new) jump:nt	0000C178; p0 = cmp.eq(r0,-00000001) }

l0000C1A4:
	{ jump	0000C29C }
0000C1A8                         C1 60 00 78                     .`.x    

l0000C1AC:
	{ if (!cmp.eq(r2.new,0000000A)) jump:t	0000C2A4; r2 = memw(r18+24) }

l0000C1B0:
	{ if (!cmp.eq(r2.new,0000000A)) jump:t	0000C2A4 }

l0000C1B8:
	{ r4 = add(badva,00000029) }
	{ call	logmsg_function }
	{ r2 = memw(r18+8); r3 = setbit(r20,00000004); r6 = add(badva,0000000C) }
...
l0000C2A4:
	{ if (!cmp.eq(r17.new,00000000)) jump:t	0000C11C; r17 = memw(r2+36) }

l0000C2B0:
	{ if (cmp.eq(r17.new,00000001)) jump:nt	0000C664; r17 = memw(r16) }

l0000C2BC:
	{ r25 = add(r29,00000020) }
	{ if (!cmp.eq(r2.new,0000001F)) jump:t	0000C628; r2 = memw(r17+24); r1 = 00000133 }

l0000C2C4:
	{ if (!cmp.eq(r2.new,0000001F)) jump:t	0000C628; r2 = memw(r17+24) }

l0000C2D0:
	{ r4 = add(badva,00000026) }
	{ call	logmsg_function }
	{ r1:r0 = combine(r17,r16); call	find_first_consumer.1.2_i32_0 }
	{ if (cmp.eq(r18.new,r17)) jump:nt	0000C624; r18 = r0 }

l0000C2F0:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C334; r2 = memw(r17+20) }

l0000C2FC:
	{ if (!cmp.gtu(r2,r19.new)) jump:nt	0000C330; r19 = add(r19,00000001) }

l0000C308:
	{ r1:r0 = combine(r17,r16); r2 = r19 }
	{ if (!p0) r1:r0 = combine(r17,r16); if (p0.new) r2 = add(r19,00000000); if (!p0.new) jump:nt	0000C620; p0 = cmp.eq(r0,-00000001) }

l0000C31C:
	{ call	find_last_consumer }
	{ if (p0.new) r2 = memw(r17+20); if (p0.new) jump:nt	0000C2FC; p0 = cmp.eq(r0,-00000001) }

l0000C328:
	{ jump	0000C620 }
0000C32C                                     C2 40 92 91             .@..

l0000C330:
	{ if (cmp.eq(r2.new,00000006)) jump:t	0000C340 }

l0000C334:
	{ p0 = cmp.eq(r2,0000004B); if (!p0.new) jump:nt	0000C620 }

l0000C338:
	{ p0 = cmp.eq(r2,0000004B) }

l0000C33C:
	{ r4 = add(badva,00000004) }
...
l0000C348:
	...
	{ if (cmp.eq(r19.new,r18)) jump:nt	0000C624; r19 = r0 }

l0000C364:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C3A8; r2 = memw(r18+20) }

l0000C370:
	{ if (!cmp.gtu(r2,r20.new)) jump:nt	0000C3A4; r20 = add(r20,00000001) }

l0000C37C:
	{ r1:r0 = combine(r18,r16); r2 = r20 }
	{ if (!p0) r1:r0 = combine(r18,r16); if (p0.new) r2 = add(r20,00000000); if (!p0.new) jump:nt	0000C620; p0 = cmp.eq(r0,-00000001) }

l0000C390:
	{ call	find_last_consumer }
	{ if (p0.new) r2 = memw(r18+20); if (p0.new) jump:nt	0000C370; p0 = cmp.eq(r0,-00000001) }

l0000C39C:
	{ jump	0000C620 }
0000C3A0 C2 C0 93 91                                     ....            

l0000C3A4:
	{ if (p0.new) r1 = 00000140; p0 = cmp.eq(r2,00000023); if (!p0.new) jump:nt	0000C620 }

l0000C3A8:
	{ if (p0.new) r1 = 00000140; p0 = cmp.eq(r2,00000023) }

l0000C3B0:
	{ r4 = add(badva,0000001E) }
	{ call	logmsg_function }
	{ r1:r0 = combine(r19,r16); call	find_first_consumer.1.2_i32_0 }
	{ if (cmp.eq(r20.new,r19)) jump:nt	0000C624; r20 = r0 }

l0000C3D4:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C418; r2 = memw(r19+20) }

l0000C3E0:
	{ if (!cmp.gtu(r2,r21.new)) jump:nt	0000C414; r21 = add(r21,00000001) }

l0000C3EC:
	{ r1:r0 = combine(r19,r16); r2 = r21 }
	{ if (!p0) r1:r0 = combine(r19,r16); if (p0.new) r2 = add(r21,00000000); if (!p0.new) jump:nt	0000C620; p0 = cmp.eq(r0,-00000001) }

l0000C400:
	{ call	find_last_consumer }
	{ if (p0.new) r2 = memw(r19+20); if (p0.new) jump:nt	0000C3E0; p0 = cmp.eq(r0,-00000001) }

l0000C40C:
	{ jump	0000C620 }
0000C410 C2 40 92 91                                     .@..            

l0000C414:
	{ if (cmp.eq(r2.new,00000006)) jump:t	0000C424 }
...
l0000C42C:
	...
	{ if (cmp.eq(r21.new,r20)) jump:nt	0000C624; r21 = r0 }

l0000C448:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C48C; r2 = memw(r20+20) }

l0000C454:
	{ if (!cmp.gtu(r2,r22.new)) jump:nt	0000C488; r22 = add(r22,00000001) }

l0000C460:
	{ r1:r0 = combine(r20,r16); r2 = r22 }
	{ if (!p0) r1:r0 = combine(r20,r16); if (p0.new) r2 = add(r22,00000000); if (!p0.new) jump:nt	0000C620; p0 = cmp.eq(r0,-00000001) }

l0000C474:
	{ call	find_last_consumer }
	{ if (p0.new) r2 = memw(r20+20); if (p0.new) jump:nt	0000C454; p0 = cmp.eq(r0,-00000001) }

l0000C480:
	{ jump	0000C620 }
0000C484             C2 C0 95 91                             ....        

l0000C488:
	{ if (!cmp.eq(r2.new,0000000F)) jump:nt	0000C624; r2 = setbit(r2,00000002) }

l0000C48C:
	{ if (!cmp.eq(r2.new,0000000F)) jump:nt	0000C624 }

l0000C494:
	{ r4 = add(badva,0000001B) }
	{ r1 = 0000014B }
	{ call	logmsg_function }
	{ r2 = memw(r17+12) }
	...
	{ memd(r29+104) = r7:r6 }
	{ if (!cmp.eq(r2.new,0000000E)) jump:t	0000C534; r2 = memw(r21+24) }

l0000C528:
	{ r1 = memw(r2+28); r0 = memw(r2+24) }
	{ memd(r29+112) = r1:r0 }
	{ r2 = memw(r21+8); r3 = setbit(r24,00000004); r6 = add(badva,00000020) }
...
l0000C540:
	...
	{ if (cmp.eq(r22.new,00000000)) jump:nt	0000C624; r22 = r0 }
...
l0000C628:
	{ if (!cmp.eq(r17.new,00000000)) jump:t	0000C2C4; r17 = memw(r2+36) }
...
l0000C640:
	...
	{ if (p0.new) r2 = memw(r17); if (!p0.new) r1 = 000001CE; if (!p0.new) jump:nt	0000C748; p0 = cmp.eq(r0,00000001) }
...
l0000C668:
	{ if (cmp.eq(r17.new,00000000)) jump:nt	0000C718; r17 = memw(r16) }

l0000C674:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C704; r2 = memw(r17+16) }

l0000C680:
	{ if (cmp.eq(r4.new,00000000)) jump:nt	0000C6E0; r4 = memw(r23+r18<<#3) }

l0000C68C:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C75C; r2 = memw(r16) }

l0000C698:
	{ r5 = memw(r3+4) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000C758; r2 = memw(r2+36) }
...
l0000C6B8:
	{ memw(r29+4) = r4; r1 = 0000007E; r3 = add(badva,0000001A) }
	{ memw(r29) = r5; r2 = r16 }
	{ jump	0000BF3C }
...
l0000C6F0:
	{ r2 = memw(r17+16) }
	{ if (cmp.gtu(r2,r18.new)) jump:t	0000C680; r18 = add(r18,00000001) }

l0000C700:
	{ if (!cmp.eq(r17.new,00000001)) jump:t	0000C674 }
...
l0000C724:
	{ r2 = memw(r2+4) }
	{ callr	r2 }
	{ r17 = memw(r17+36); if (p0.new) jump:nt	0000C708; p0 = cmp.eq(r16,00000001) }
...
l0000C748:
	{ jump	0000BF40; r3 = add(badva,0000001E) }
0000C754             3E 46 00 00                             >F..        

l0000C758:
	{ memb(r29+1) = r2.new; r2 = memw(r17+28); r3 = add(badva,00000008) }

l0000C75C:
	{ memb(r29+1) = r2.new; r2 = memw(r17+28) }
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000001) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
fn0000C79C proc
	...
	{ if (!p0.new) jump:nt	fn0000C7DC; p0 = cmp.gt(r13,00000000) }

;; fn0000C7B4: 0000C7B4
;;   Called from:
;;     0000C7B0 (in fn0000C79C)
;;     0000C7B0 (in try_pad_bad_supernodes.extracted_region)
fn0000C7B4 proc
	{ r1:r0 = combine(r20,r19); r2 = r16; call	fn00009560 }

l0000C7B8:
	{ r1:r0 = combine(r20,r19); r2 = r16 }
	{ r20 = add(r20,r16); r1 = 00000000; r2 = r17; r0 = add(r19,r16) }
	{ r19 = add(r19,r18); call	fn000095F0 }
	{ if (!cmp.eq(r21.new,00000001)) jump:t	0000C7B8; r21 = add(r21,FFFFFFFF) }
...
tensor_alloc proc
	...
	{ if (!cmp.eq(r16.new,00000000)) jump:t	0000C814; r16 = r0 }

l0000C810:
	{ if (p0.new) memw(r16+16) = 00000000; if (p0.new) jump:nt	0000C838; p0 = cmp.eq(r9,00000000) }

l0000C814:
	{ if (p0.new) memw(r16+16) = 00000000 }
...
tensor_dup proc
	...
	{ if (!cmp.eq(r16.new,00000000)) jump:t	0000C880; r16 = r0 }
...
tensor_free proc
	{ allocframe(00000008); memd(r29+496) = r17:r16; r16 = r0 }
	{ if (cmp.eq(r0.new,00000000)) jump:nt	0000C8F0; r0 = memw(r16+16) }

l0000C8EC:
	{ deallocframe; r17:r16 = memd(r29); jump	0000C97C; r0 = r8 }

l0000C8F0:
	{ deallocframe; r17:r16 = memd(r29); jump	find_last_consumer; r0 = r8 }
...
do_perfinfo_reset proc
	...
	{ if (cmp.eq(r3.new,00000000)) jump:nt	0000C924; r3 = memw(r2); r5:r4 = combine(00000000,00000000) }

l0000C914:
	{ if (!cmp.eq(r3.new,00000001)) jump:t	0000C914; r3 = memw(r3+36) }

l0000C920:
	{ memw(r2+52) = r1; r3 = and(r1,000000FF) }

l0000C924:
	{ call	fn00009644; r1 = setbit(r3,00000010) }
	{ dealloc_return; r0 = 00000000 }
...
l0000C940:
	{ if (!p0.new) jump:nt	0000C970; p0 = cmp.gtu(r2,r0) }
...
l0000C944:
	...
	{ if (!cmp.eq(r3.new,00000001)) jump:t	0000C944; r3 = memw(r3+36) }
...
find_last_consumer proc
	...
	{ memd(r29+16) = r25:r24; jump	0000CA30; if (!p0) jump:nt	0000C9A8 }
...
0000CA20 35 60 00 7E 33 41 93 91 CA E0 72 24 2D 1E 34 3E 5`.~3A....r$-.4>
...
l0000CA5C:
	...
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000CAB8; r2 = memw(r19+16) }
...
l0000CA74:
	{ if (!cmp.eq(r4.new,r20)) jump:t	0000CAAC; r4 = memw(r4-4) }
...
0000CAA0 1A C0 00 5A 82 C0 93 91 17 41 17 B0             ...Z.....A..    

l0000CAAC:
	{ if (cmp.gtu(r2,r22.new)) jump:t	0000CA74; r22 = add(r22,00000001) }

l0000CAB8:
	{ if (!cmp.eq(r19.new,00000001)) jump:t	0000CA6C; r19 = memw(r19+36); if (p0.new) r21 = 00000001 }
...
logmsg_function proc
	{ allocframe(00000008); r3 = 00000000; r0 = add(badva,00000000) }
	{ r5 = add(r29,00000010); r1 = 0000003C; r4 = add(badva,0000000B) }
...
;;   Called from:
;;     000118F4 (in fn000117A4)
;;     000132B4 (in fn00013214)
;;     00015924 (in fn000157D4)
...
l0000CBEC:
	{ memb(r21-28) = r24; r3 = 0000003E }
	{ memb(r21-11) = r22; memb(r21-8) = r24; r1 = add(badva,00000026) }
	...
	{ memw(r21) = r0; p0 = cmp.gt(r26,00000001); r2 = add(badva,00000020) }
	...
	{ if (!cmp.eq(r26.new,00000009)) jump:t	0000CBEC; r26 = add(r26,00000001); r21 = add(r21,00000020) }
...
qurt_worker proc
	...
	{ if (p0.new) jump:nt	0000CCDC; p0 = cmp.eq(r10,00000000); r3:r2 = lsr(r19:r18,00000020) }
...
l0000CCC0:
	...
	{ r0 = r16; call	fn000096B0 }
	{ r19:r18 = combine(r1,r0) }
	{ if (!p0.new) jump:nt	0000CCC0; p0 = cmp.eq(r26,00000001); r3:r2 = lsr(r19:r18,00000020) }
...
errlog_function proc
	{ allocframe(00000008); r3 = 00000000; r0 = add(badva,00000020) }
	{ r5 = add(r29,00000010); r1 = 000000C2; r4 = add(badva,00000028) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
nn_os_get_perfcount proc
	...
	{ nop; if (p0.new) jump:nt	0000CD54; p0 = cmp.eq(r2,0000000A) }
...
nn_os_vector_workers_acquire proc
	{ allocframe(00000010); memd(r29+488) = r19:r18; r18 = add(badva,00000010) }
	{ memd(r29+8) = r17:r16; r16 = r0 }
	{ r17 = memw(r18-176) }
	{ r0 = r17; call	qurt_sem_init_val.1.1_i16_0 }
	{ r18 = memw(r18-160) }
	{ r0 = r18; call	qurt_pipe_send.1.1_i64_0; r19 = add(badva,00000038) }
	{ r0 = memw(r16+68); r3 = add(r19,00000004); r2 = add(badva,00000030) }
	{ call	fn00009650 }
...
worker_acquire proc
	...
	{ memw(r16) = 00000000; r17 = add(badva,0000001C) }
...
nn_os_vector_workers_release proc
	{ allocframe(00000010); memd(r29+488) = r19:r18; r18 = add(badva,00000030) }
	{ memd(r29+8) = r17:r16; r16 = r0 }
	{ r17 = memw(r18-176) }
	{ r0 = r17; call	qurt_sem_init_val.1.1_i16_0 }
	{ r18 = memw(r18-160) }
	{ r0 = r18; call	qurt_sem_init_val.1.1_i16_0 }
	{ r0 = memw(r16+68); r4 = add(badva,00000010) }
	{ r3 = add(r4,00000004); call	fn00009658; r2 = add(badva,0000002C) }
	{ r0 = r17; call	fn000096A0 }
...
transpack proc
	{ if (!p0.new) jump:nt	pad2d; p0 = cmp.gt(r2,00000000); r4 = asl(r1,00000003) }
...
l0000CF68:
	{ if (cmp.gtu(r2,r5.new)) jump:t	0000CEF4; r5 = add(r5,00000020); r3 = addasl(r3,r4,00000002) }

;; pad2d: 0000CF78
;;   Called from:
;;     0000CEE0 (in transpack)
...
l0000CFB8:
	{ r1:r0 = combine(r21,r23); r2 = r22 }
	{ r21 = add(r21,r22); r1 = r18; r2 = r24; r0 = add(r23,r22) }
	{ r23 = add(r23,r17); call	vmemset_asm }
	{ if (!cmp.eq(r25.new,00000001)) jump:t	0000CFB8; r25 = add(r25,FFFFFFFF) }
...
fn0000CFE0 proc
	{ if (!cmp.gt(r19.new,00000000)) jump:nt	0000D000; r19 = sub(r19,r20) }

l0000CFEC:
	{ r16 = add(r16,r17); r2 = r17; r1:r0 = combine(r18,r16) }
	{ if (!cmp.eq(r19.new,00000001)) jump:t	0000CFEC; r19 = add(r19,FFFFFFFF) }
...
unpad2d proc
	...
	{ if (!cmp.gt(r20.new,00000000)) jump:nt	unpad2d_bytes; r20 = r4; r21 = asl(r19,00000002) }

l0000D030:
	{ r1:r0 = combine(r16,r18); r2 = r21; call	fn00022964 }

l0000D034:
	{ r1:r0 = combine(r16,r18); r2 = r21 }
	{ if (!cmp.eq(r20.new,00000001)) jump:t	0000D034; r20 = add(r20,FFFFFFFF); r18 = addasl(r18,r19,00000002) }
...
;; fn0000D054: 0000D054
;;   Called from:
;;     0000D050 (in unpad2d_bytes)
;;     0001A744 (in supernode_execute_hvx_slice)
fn0000D054 proc
	{ memd(r29) = r21:r20; memd(r29+8) = r19:r18; r19:r18 = combine(r5,r3); r17:r16 = combine(r2,r0) }
	{ if (!cmp.gt(r20.new,00000000)) jump:nt	0000D084; r20 = r4 }

l0000D06C:
	{ r16 = add(r16,r17); r2 = r19; r1:r0 = combine(r16,r18) }

l0000D070:
	{ r16 = add(r16,r17); r2 = r19 }
	{ if (!cmp.eq(r20.new,00000001)) jump:t	0000D070; r20 = add(r20,FFFFFFFF); r18 = add(r18,r19) }
...
l0000D0A8:
	...
	{ r12 = r8; if (!p0.new) jump:nt	0000D128; p0 = cmp.gt(r6,00000000); r13 = mpyi(r8,r6) }

l0000D0B4:
	{ r12 = r8; if (!p0.new) jump:nt	0000D128; p0 = cmp.gt(r6,00000000) }
...
l0000D0D8:
	{  }
	{ r10 = memb(r9); p0 = cmp.gtu(r7,00000001); r28 = add(r9,r6) }
...
l0000D118:
	...
	{ if (!cmp.eq(r8.new,r5)) jump:t	0000D0B4; r8 = add(r8,00000001) }

l0000D128:
	{ if (!cmp.eq(r8.new,r5)) jump:t	0000D0B4 }
...
l0000D168:
	{ if (!p1.new) r14 = 00000000; if (p1.new) jump:nt	0000D1B4; p1 = or(p1,!p0) }

l0000D174:
	{ loop1(0000D178,r5) }
	{ memw(r30+r14<<#2) = r13; if (p1.new) r10 = add(r14,00000000); if (!p1.new) jump:t	0000D1A0; p1 = cmp.gt(r7,00000000) }
...
l0000D1B4:
	{ if (p1.new) r10 = add(r14,00000000); p1 = cmp.gt(r7,00000000); r28 = 00000000 }
...
l0000D1E8:
	{ if (p2.new) r14 = 00000000; p2 = cmp.eq(r15,00000020); if (!p0) jump:nt	0000D2D0; if (!p2.new) jump:nt	0000D1B0 }
...
l0000D1F8:
	...
	{ if (!cmp.eq(r14.new,r5)) jump:t	0000D1FC; r14 = add(r14,00000001) }
	{ r15 = 00000000 }
	...
	{ r15 = add(r15,00000001) }
	{ p1 = cmp.eq(r15,r5); if (!p1.new) jump:nt	0000D268; r19 += add(r16,r18) }

l0000D2D0:
	{ if (cmp.gtu(r6,r12.new)) jump:t	0000D168; r12 = add(r12,00000020) }
...
gemaddvvm_cn proc
	{ r5 = 00000000; if (!p0.new) jump:nt	gemm_asm; p0 = cmp.gt(r3,00000000); loop1(0000D480,r3) }
...
l0000D54C:
	...
	{ if (cmp.gtu(r16,r21.new)) jump:t	0000D540; r21 = add(r21,r22); r19 = add(r19,r7) }
...
l0000D614:
	...
	{  }
	{ memw(r29+112) = r12; r12 = memw(r29+8); r14 = sub(r19,r4) }
...
l0000D744:
	{ r4 = sub(r8,r2) }
	{ if (p0.new) r3 = memw(r29+116); if (p0.new) r25 = add(r21,00000000); if (!p0.new) jump:t	0000D764; p0 = tstbit(r4,00000000) }
...
l0000D788:
	{ r18 = add(r18,r23); r1:r0 = combine(r16,r18); r2 = r26 }
	{ if (!tstbit(r17.new,-00000001)) jump:t	0000D788; r17 = add(r17,r24) }
...
l0000D7F0:
	{ r18 = add(r18,r23); r1:r0 = combine(r16,r18); r2 = r27 }
	{ if (cmp.gtu(r26,r21.new)) jump:t	0000D7F0; r21 = add(r21,r24) }
...
l0000D810:
	...
	{ if (!cmp.gt(r21.new,00000000)) jump:nt	0000D874; r21 = r0 }
...
l0000D85C:
	{ r25 = add(r25,r22); r1:r0 = combine(r18,r25) }
	{ if (!cmp.eq(r21.new,00000001)) jump:t	0000D85C; r21 = add(r21,FFFFFFFF); r18 = add(r18,r27) }

l0000D870:
	{ if (!cmp.gt(r21.new,00000000)) jump:nt	0000D8AC; r21 = memw(r29+108) }
...
l0000D898:
	{ r18 = add(r18,r22); r2 = r21; r1:r0 = combine(r16,r18) }
	{ if (cmp.gtu(r26,r17.new)) jump:t	0000D898; r17 = add(r17,r24) }

l0000D8AC:
	{ r26 = memw(r29+100); r2 = memw(r29+88); r21 = r27 }
	{ if (p0.new) jump:nt	0000D8F0; p0 = cmp.gt(r2,-00000001) }
...
l0000D8DC:
	{ r18 = add(r18,r23); r1:r0 = combine(r16,r18); r2 = r26 }
	{ if (cmp.gtu(r19,r17.new)) jump:t	0000D8DC; r17 = add(r17,r24) }
...
l0000D8F8:
	{ if (!cmp.eq(r8.new,r2)) jump:t	0000D744; r27 = memw(r29+104); r8 = add(r8,00000001) }

l0000D904:
	{ r19 = memd(r29+28); r0 = memd(r29+24) }

l0000D908:
	{ if (p0.new) jump:nt	0000D934; p0 = r0 }
...
l0000D920:
	{ r17 = add(r17,r23); r2 = r19; r1:r0 = combine(r16,r17) }
	{ if (!cmp.eq(r18.new,00000001)) jump:t	0000D920; r18 = add(r18,FFFFFFFF) }
...
l0000D954:
	...
	{ r2 = mpyi(r2,r4) }
	{ r3 = and(r3,FFFFFFF8) }
	{ if (!cmp.gt(r18.new,00000000)) jump:nt	0000D98C; r18 = sub(r3,r2) }
...
l0000D978:
	{ r17 = add(r17,r19); r2 = r19; r1:r0 = combine(r16,r17) }
	{ if (!cmp.eq(r18.new,00000001)) jump:t	0000D978; r18 = add(r18,FFFFFFFF) }
...
im2col_cn proc
	...
	{  }
	{ memd(r29+152) = r23:r22; memd(r29+160) = r21:r20; p0 = cmp.gt(r6,00000000) }
...
l0000DA00:
	...
	{  }
	{ memw(r29+32) = r3; memw(r29+36) = r7; r3 = 00000000 }
...
l0000DAB0:
	...
	{ r25 = sub(r2,r22) }
	{ r27 = mpyi(r25,r1) }
	{ nop; if (!p0.new) jump:t	0000DB40; p0 = tstbit(r9,00000000) }

l0000DB34:
	{ nop }

l0000DB38:
	{ if (cmp.gt(r17,r2.new)) jump:t	0000DB4C; r2 = memw(r29+132) }
...
l0000DB8C:
	...
	{ if (!cmp.eq(r21.new,00000001)) jump:t	0000DB34; r21 = add(r21,FFFFFFFF) }
...
im2col_slice_v0_co proc
	...
	{  }
	{  }
	{ r6 = memw(r29+240); r2 = memw(r29+232) }
	...
	{ memw(r29+8) = r2; jump	0000DD44; if (p0) jump:nt	0000DD24 }
0000DD24             16 5D FF 5B 12 40 60 70 00 D6 1A F5     .].[.@`p....
0000DD30 A0 30 07 30 02 DA 07 ED 02 D6 22 F3 03 C2 9D A1 .0.0......".....
0000DD40 38 47 90 14                                     8G..            

l0000DD44:
	{ memw(r29+32) = r7; if (!p0.new) r6 = add(r25,00000000) }
...
l0000DE30:
	...
	{ r24 = sub(r2,r20) }
	{ r17 = mpyi(r24,r1) }
	{ nop; if (!p0.new) jump:t	0000DEBC; p0 = tstbit(r10,00000000) }

l0000DEB0:
	{ nop }

l0000DEB4:
	{ if (cmp.gt(r18,r2.new)) jump:t	0000DEC8; r2 = memw(r29+144) }
...
0000DEC4             08 40 CF 10                             .@..        

l0000DEC8:
	{ if (p0.new) r2 = memw(r29-124); if (!p0) r1:r0 = combine(r21,r26) }
...
l0000DF08:
	...
	{ if (!cmp.eq(r16.new,00000001)) jump:t	0000DEB0; r16 = add(r16,FFFFFFFF) }
...
l0000DF8C:
	...
	{ memw(r29+84) = r3 }
	{ r0 = memw(r29+8) }
	{ if (!p0.new) r25:r24 = memd(r29+160); if (!p0.new) r1:r0 = combine(r21,r27); if (!p0.new) jump:nt	0000DFDC; p0 = r0 }
...
im2col_slice_co proc
	...
	{ r19 = memw(r29+160) }
	{  }
	{ r20 = memw(r29+176); r23 = memw(r29+172) }
	...
	{ memw(r29+16) = r26; if (!p0) r1:r0 = combine(r19,r23); if (p0.new) jump:nt	0000E090; p0 = cmp.gt(r2,-00000001) }
...
l0000E0C8:
	...
	{ if (!p0) r2 = add(r19,00000000) }
	{ if (p1) r2 = add(r19,00000000) }
	{ if (p0.new) memw(r29+36) = r16; memw(r29+68) = r2; if (!p0.new) jump:nt	0000E200; p0 = cmp.gt(r2,-00000001) }
...
l0000E178:
	{ p0 = cmp.gt(r25,FFFFFFFF) }

l0000E17C:
	{ p0 = cmp.gt(r5,r25); if (!p0.new) jump:nt	0000E1C4; r3 = max(r23,r19) }

l0000E188:
	{ r4 = sub(r27,r3); r2 = max(r23,r18) }
	{ if (!cmp.gt(r2.new,00000000)) jump:nt	0000E1C4; r2 = sub(r4,r2) }
...
l0000E1C4:
	{ r17 = add(r17,r27); r25 = add(r25,00000001) }

l0000E1CC:
	{ if (!cmp.eq(r20.new,00000001)) jump:t	0000E178; r20 = add(r20,FFFFFFFF) }
...
l0000E1D8:
	...
	{ if (!cmp.eq(r4.new,r7)) jump:t	0000E144; r4 = add(r4,00000001) }
...
l0000E2FC:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0000E370; r2 = memw(r29+28) }
...
l0000E324:
	{ if (cmp.gtu(r25,r2.new)) jump:nt	0000E318; r2 = memw(r29+16) }
...
l0000E354:
	{ if (cmp.gt(r25,r2.new)) jump:t	0000E3BC; r2 = memw(r29+52) }
...
l0000E368:
	{ jump	0000E3D4 }
0000E36C                                     18 5A 13 F5             .Z..

l0000E370:
	{ memw(r29+40) = r4; r2 = memd(r29+12) }
...
l0000E390:
	...
	{ if (!cmp.eq(r16.new,00000001)) jump:t	0000E390; r16 = add(r16,FFFFFFFF); r25 = add(r25,r27); r24 = add(r24,r17) }

l0000E3B0:
	{ r19 = add(r19,r2); jump	0000E3E8 }
0000E3B8                         94 69 02 5A                     .i.Z    

l0000E3BC:
	{ r1:r0 = combine(r18,r19); r2 = r21 }
	{ r1 = r24; r2 = r20; r0 = add(r19,r21); call	vmemcpy_asm }

l0000E3D4:
	{ r19 = add(r19,r22); r25 = add(r25,00000001); r24 = add(r24,r20) }
	{ if (!cmp.eq(r16.new,00000001)) jump:t	0000E350; r16 = add(r16,FFFFFFFF) }
...
l0000E4BC:
	{ if (p0.new) r2 = memw(r29-128); if (p0.new) r3 = memw(r29+32); if (p0.new) jump:nt	0000E4DC; p0 = cmp.eq(r14,00000004) }

l0000E4C8:
	{ r0 = r18; r23 = 00000000; if (!p0.new) jump:nt	0000E4F0; p0 = cmp.eq(r14,00000002) }

l0000E4D0:
	{ r2 = memw(r29+128) }
	{ jump	0000E4E8; r0 += add(r2,FFFFFFFF) }
...
l0000E4F0:
	...
	{ memb(r29+29) = r0.new; if (p0) r1 = add(r27,00000000); if (p0) jump:nt	0000E540; r0 = p0 }
...
l0000E52C:
	{ jump	0000E548 }
0000E530 00 C0 61 70 E0 5F 02 E2 0A C0 00 58 E3 1D 72 3D ..ap._.....X..r=
...
l0000E55C:
	...
	{  }
	{ r6 = memd(r29+104); r7 = memw(r16+16) }
	...
	{  }
	{ r3 = 38D1B717 }
	{ r21 = r3; r2 = 00000000; r1:r0 = combine(r21,r3) }
	{  }
	{  }
	...
	{ if (p0.new) r0 = add(r17,r3); if (p0.new) jump:nt	0000E63C; p0 = r0 }

l0000E614:
	{ if (p0.new) r0 = add(r17,r3); if (p0.new) jump:nt	0000E63C }

l0000E61C:
	{ if (p0.new) r0 = add(r19,r3); if (p0.new) jump:nt	0000E638; p0 = cmp.eq(r14,00000002) }

l0000E624:
	{ r1 = memd(r29+108); r0 = 00000000 }
	{ if (!p0) r1:r0 = combine(r18,r3); if (!p0.new) jump:nt	0000E64C; p0 = r1 }
...
l0000E63C:
	...
	{ r3 = r20 }
	{ if (!cmp.eq(r2.new,r0)) jump:t	0000E614; r2 = memw(r29+128); r23 = add(r3,00000001) }

l0000E64C:
	{ if (!cmp.eq(r2.new,r0)) jump:t	0000E614; r2 = memw(r29+128) }
...
l0000E658:
	...
	{ r2 = CF000000 }
	{  }
	{ memw(r29+112) = r20; r19 = memd(r29+44); r17 = sub(r20,r3) }
	{ memw(r29+60) = r2 }
	{ r0 = memw(r29+116) }
	{ if (!p0.new) r1:r0 = combine(r20,r19); if (p0.new) jump:nt	0000E6B0; p0 = r0 }

l0000E684:
	{ if (!p0.new) r1:r0 = combine(r20,r19); if (p0.new) jump:nt	0000E6B0 }

l0000E68C:
	{ if (p0.new) jump:nt	0000E6A4; p0 = cmp.eq(r14,00000002) }

l0000E690:
	{ r1 = memd(r29+108); r0 = 00000000 }
	{ if (!p0) r1:r0 = combine(r20,r19); if (!p0.new) jump:nt	0000E6BC; p0 = r1 }

l0000E6A0:
	{ jump	0000E6B4 }

l0000E6A4:
	{ jump	0000E6B8; r0 += add(r20,FFFFFFFF) }
0000E6AC                                     00 53 11 F3             .S..
...
l0000E6B8:
	{ if (!cmp.eq(r2.new,r0)) jump:t	0000E684; r2 = memw(r29+92); r19 = add(r19,00000001) }

l0000E6BC:
	{ if (!cmp.eq(r2.new,r0)) jump:t	0000E684; r2 = memw(r29+92) }

l0000E6C8:
	{ r24 = memw(r29+16); r16 = memw(r29+88); r4 = add(badva,0000000A) }
	{ r22 = add(r19,FFFFFFFF); r1 = 0000008B }
	{ memb(r29+1) = r2.new; r2 = memw(r16+28) }
	{ memw(r29) = r16 }
	{ call	logmsg_function }
	{ r7 = memw(r29+128); r17 = memw(r29+124); r4 = add(badva,0000003C) }
	...
	{ memw(r29+12) = r25; r27 = memw(r29+100); r4 = add(badva,00000019) }
	{ memw(r29+8) = r3; r7 = memd(r29+120) }
	{ memw(r29) = r27; memw(r29+4) = r7 }
	{ call	logmsg_function }
	{ memw(r29+4) = r18; r1 = 0000008E; r4 = add(badva,00000011) }
	{ memw(r29) = r20; r2 = r24 }
	{ call	logmsg_function }
	{ r2 = r24; r1 = 0000008F; r4 = add(badva,00000009) }
	{ memb(r29) = r3.new; r3 = memb(r16+32); r16 = r24; call	logmsg_function }
	{ memw(r29+12) = r27; r24 = memw(r29+64); r4 = add(badva,0000003B) }
	{ memw(r29) = r26; memw(r29+8) = r24; r1 = 00000090 }
	{ memw(r29+4) = r22; r2 = r16 }
	{ call	logmsg_function }
	{ p0 = cmp.eq(r17,r25); r12 = r22; if (p0.new) jump:nt	0000E7DC; r2 = mpyi(r26,r27) }

l0000E7BC:
	{ r1 = 00000092; r3 = add(badva,00000026) }
	{ r2 = r16 }
...
0000E7D8                         08 5B 18 F5                     .[..    

l0000E7DC:
	{ memw(r29+24) = r12; r3 = memw(r29+104) }
	{ r4 = memw(r3+20); r2 = mpyi(r2,r24) }
	{ r2 = mpyi(r2,r22) }
	{ if (!cmp.gtu(r2.new,r4)) jump:t	0000E814; r2 = asl(r2,00000002) }

l0000E7FC:
	{ memw(r29+4) = r2; r1 = 00000094; r3 = add(badva,0000003F) }
	{ memw(r29) = r4; r2 = r16 }
	{ jump	0000E7CC }
0000E810 84 C2 9D 91                                     ....            

l0000E814:
	{ if (cmp.eq(r3.new,00000002)) jump:t	0000E830; r3 = memw(r4) }

l0000E820:
	{ r1 = 00000096; jump	0000E7D0; r3 = add(badva,00000035) }
0000E82C                                     00 40 5A 75             .@Zu

l0000E830:
	{ if (cmp.eq(r3.new,00000002)) jump:t	0000E858; r3 = memw(r4+12); r27 = r18 }

l0000E840:
	{ r1 = 00000097; jump	0000E7D0; r3 = add(badva,00000026) }
0000E84C                                     27 1D A3 3D             '..=
0000E850 E4 C1 9D 91 01 4C 83 A1                         .....L..        
...
l0000E98C:
	...
	{ if (!cmp.gt(r0,r2.new)) jump:nt	0000EA50; r2 = memw(r29+92) }
...
l0000EA40:
	{ if (!cmp.eq(r24.new,r18)) jump:t	0000E9CC; r24 = add(r24,00000001); r20 = add(r20,r17) }

l0000EA44:
	{ if (!cmp.eq(r24.new,r18)) jump:t	0000E9CC; r24 = add(r24,00000001) }

l0000EA4C:
	{ r7 = memd(r29+120); r2 = memd(r29+108) }

l0000EA50:
	{ if (!cmp.eq(r26.new,r7)) jump:t	0000E988; r20 = memw(r29+112); r26 = add(r26,00000001); r25 = add(r25,r2) }
...
l0000EA98:
	...
	{ memw(r29+116) = r3; if (!p0.new) jump:nt	0000E914; p0 = cmp.eq(r2,-00000001) }
...
l0000EAC8:
	{ memw(r29+12) = r8; r1 = 000000D3; r4 = add(badva,0000002B) }
...
deconv_check_ref proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000027) }
	{ r17 = r0; r16 = r1; r1 = 00000202 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,0000000E)) jump:t	0000EB44; r2 = memw(r17+16) }

l0000EB2C:
	{ r2 = memw(r17+28); r1 = 00000203; r3 = add(badva,0000001B) }
	{ memw(r29) = r2; jump	0000EB54 }
0000EB40 81 40 01 78                                     .@.x            

l0000EB44:
	{ if (cmp.eq(r2.new,00000006)) jump:t	0000EB6C; r2 = memw(r17+20) }

l0000EB50:
	{ r3 = add(badva,00000013) }

l0000EB54:
	{ r2 = r16; call	errlog_function }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0000EB64             B9 45 00 00 04 49 49 6A                 .E...IIj    
...
logmsg_function proc
	...
	{ if (cmp.gtu(r3,r5.new)) jump:t	0000EBAC; r5 = memw(r2+16) }

l0000EB94:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000003F) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000001F) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0000EC50:
	{ if (p0.new) jump:nt	0000EC68; p0 = cmp.eq(r9,00000004) }

l0000EC54:
	{ r23 = 00000000; if (!p0.new) jump:nt	0000EC80; p0 = cmp.eq(r9,00000002) }

l0000EC5C:
	{ r2 = memd(r29+120); r0 = r18 }
	{ jump	0000EC78; r0 += add(r2,FFFFFFFF) }
...
l0000EC80:
	...
	{ memb(r29+28) = r0.new; if (p0) jump:nt	0000ECC4; r0 = p0 }

l0000EC94:
	{ if (p0.new) r2 = memw(r29+92); if (p0.new) r1 = add(r27,00000000) }
	{ r1 = memd(r29+104); r0 = 00000000 }
	{ if (p0.new) r0 = memw(r29+92); if (p0.new) r1 = add(r27,00000000); if (!p0.new) jump:nt	0000ECD8; p0 = r1 }

l0000ECB0:
	{ jump	0000ECD0 }
0000ECB4             00 C0 61 70 E0 5F 02 E2 0C C0 00 58     ..ap._.....X
0000ECC0 01 40 7B 70                                     .@{p            

l0000ECC4:
	{ r3 = memd(r29+92); r2 = memd(r29+116) }
	{ r2 = sub(r3,r2) }
	{ r0 = add(r2,r1) }
...
l0000ECDC:
	...
	{ if (p0.new) r0 = add(r20,r3); if (p0.new) jump:nt	0000ED20; p0 = r0 }

l0000ECF8:
	{ if (p0.new) r0 = add(r20,r3); if (p0.new) jump:nt	0000ED20 }

l0000ED00:
	{ if (p0.new) r0 = add(r16,r3); if (p0.new) jump:nt	0000ED1C; p0 = cmp.eq(r9,00000002) }

l0000ED08:
	{ r1 = memd(r29+104); r0 = 00000000 }
	{ if (!p0) r1:r0 = combine(r18,r3); if (!p0.new) jump:nt	0000ED30; p0 = r1 }
...
l0000ED20:
	...
	{ r3 = r19 }
	{ if (!cmp.eq(r2.new,r0)) jump:t	0000ECF8; r2 = memw(r29+120); r23 = add(r3,00000001) }

l0000ED30:
	{ if (!cmp.eq(r2.new,r0)) jump:t	0000ECF8; r2 = memw(r29+120) }

l0000ED3C:
	{ r2 = memd(r29+116); r23 = r3; r20 = r25 }
	{ memw(r29+108) = r19; r16 = sub(r19,r2) }
	{ r0 = memw(r29+112) }
	{ if (!p0.new) r1:r0 = combine(r19,r20); if (p0.new) jump:nt	0000ED80; p0 = r0 }

l0000ED54:
	{ if (!p0.new) r1:r0 = combine(r19,r20); if (p0.new) jump:nt	0000ED80 }

l0000ED5C:
	{ if (p0.new) jump:nt	0000ED74; p0 = cmp.eq(r9,00000002) }

l0000ED60:
	{ r1 = memd(r29+104); r0 = 00000000 }
	{ if (!p0) r1:r0 = combine(r19,r20); if (!p0.new) jump:nt	0000ED8C; p0 = r1 }

l0000ED70:
	{ jump	0000ED84 }

l0000ED74:
	{ jump	0000ED88; r0 += add(r19,FFFFFFFF) }
0000ED7C                                     00 54 10 F3             .T..
...
l0000ED88:
	{ if (!cmp.eq(r2.new,r0)) jump:t	0000ED54; r2 = memw(r29+92); r20 = add(r20,00000001) }

l0000ED8C:
	{ if (!cmp.eq(r2.new,r0)) jump:t	0000ED54; r2 = memw(r29+92) }

l0000ED98:
	{ r2 = memw(r22+28); r4 = add(badva,00000007) }
	{ memw(r29+4) = r2; r1 = 00000076 }
	{ r17 = r20; r2 = r21 }
	{ memw(r29) = r22; memw(r29+24) = r17; call	logmsg_function }
	{ r7 = memw(r29+120); r25 = memw(r29+100); r1 = 00000077 }
	{ memw(r29) = r24; memw(r29+12) = r25; r4 = add(badva,00000039) }
	{ memw(r29+8) = r7; r3 = memd(r29+92); r2 = r21 }
	{ memw(r29+4) = r3 }
	{ call	logmsg_function }
	{ r7 = memw(r29+32); r27 = memw(r29+88); r1 = 00000078 }
	{ memw(r29) = r26; memw(r29+12) = r27; r4 = add(badva,00000026) }
	{ memw(r29+8) = r7; r3 = memd(r29+116); r2 = r21 }
	{ memw(r29+4) = r3 }
	{ call	logmsg_function }
	{ memw(r29+4) = r18; r1 = 00000079; r4 = add(badva,0000001E) }
	{ memw(r29) = r19; r2 = r21 }
	{ call	logmsg_function }
	{ r2 = r21; r1 = 0000007A; r4 = add(badva,0000001A) }
	{ memb(r29) = r3.new; r3 = memb(r22+32); r16 = r25; call	logmsg_function }
	{ memw(r29+12) = r26; r1 = 0000007B; r4 = add(badva,0000000C) }
	{ memw(r29) = r24; r2 = r21 }
	{ memw(r29+4) = r17; memw(r29+8) = r23 }
	{ call	logmsg_function }
	{ if (!p0.new) r1 = 0000007D; p0 = cmp.eq(r16,r27); if (p0.new) jump:nt	0000EE90; r2 = mpyi(r24,r26) }

l0000EE74:
	{ r3 = add(badva,0000003B) }
	{ r2 = r21 }
...
0000EE8C                                     07 40 77 70             .@wp

l0000EE90:
	{ memb(r29+16) = r7.new; r3 = memw(r29+84) }
	{ r4 = memw(r3+20) }
	{ r2 = mpyi(r2,r17) }
	{ if (!cmp.gtu(r2.new,r4)) jump:t	0000EEC8; r2 = asl(r2,00000002) }

l0000EEB0:
	{ memw(r29+4) = r2; r1 = 0000007F; r3 = add(badva,00000018) }
	{ memw(r29) = r4; r2 = r21 }
	{ jump	0000EE80 }
0000EEC4             84 C2 9D 91                             ....        

l0000EEC8:
	{ if (cmp.eq(r3.new,00000002)) jump:t	0000EEE4; r3 = memw(r4) }

l0000EED4:
	{ r1 = 00000081; jump	0000EE84; r3 = add(badva,0000000E) }
0000EEE0 00 40 58 75                                     .@Xu            

l0000EEE4:
	{ if (cmp.eq(r3.new,00000002)) jump:t	0000EF04; r3 = memw(r4+12) }

l0000EEF0:
	{ r1 = 00000082; jump	0000EE84; r3 = add(badva,00000003) }
0000EEFC                                     4D 28 53 DD             M(S.
0000EF00 39 01 32 A6                                     9.2.            
...
l0000EF70:
	{ if (!p0.new) jump:nt	0000F10C; p0 = cmp.gt(r9,00000001) }
...
l0000EF90:
	{ memw(r29+44) = r20; if (!p0.new) jump:nt	0000F0F8; p0 = cmp.gt(r7,00000001) }
...
l0000F004:
	...
	{ if (!cmp.gt(r0,r2.new)) jump:nt	0000F0BC; r2 = memw(r29+92) }
...
l0000F044:
	{ r1:r0 = combine(r18,r22) }
	{ if (!p0) r1:r0 = combine(r18,r22); if (!p0.new) jump:nt	0000F0AC; p0 = cmp.eq(r0,00000000) }

l0000F050:
	{ call	fn00009750 }
	{ if (!cmp.gt(r0,r2.new)) jump:nt	0000F0B0; r2 = memw(r29+120) }

l0000F060:
	{ if (!p0.new) jump:nt	0000F0B0; p0 = cmp.gt(r8,00000000); r4 = addasl(r19,r26,00000002) }
...
l0000F0AC:
	{ if (!cmp.eq(r25.new,r27)) jump:t	0000F044; r25 = add(r25,00000001); r19 = addasl(r19,r23,00000002) }

l0000F0B0:
	{ if (!cmp.eq(r25.new,r27)) jump:t	0000F044; r25 = add(r25,00000001) }
...
l0000F0BC:
	{ r19 = memw(r29+108) }
	{ if (!cmp.eq(r21.new,r7)) jump:t	0000EFFC; r21 = add(r21,00000001); r17 = addasl(r17,r2,00000002) }
...
l0000F0E8:
	...
	{ r2 = add(r2,00000001) }
	{ memw(r29+68) = r2; if (!p0.new) jump:nt	0000EFB4; p0 = cmp.eq(r7,-00000001) }

l0000F0F8:
	{ r20 = memd(r29+44); r3 = memd(r29+112) }
	{ r3 = add(r3,00000001); r2 = add(r3,00000002) }
	{ memw(r29+112) = r3; if (!p0.new) jump:nt	0000EF90; p0 = cmp.eq(r2,-00000001) }
...
l0000F124:
	{ memw(r29+12) = r26; r1 = 000000B3; r4 = add(badva,0000001C) }
...
deconv_check_ref proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000018) }
	{ r17 = r0; r16 = r1; r1 = 000000BA }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	0000F1A0; r2 = memw(r17+16) }

l0000F188:
	{ r2 = memw(r17+28); r1 = 000000BB; r3 = add(badva,0000000C) }
	{ memw(r29) = r2; jump	0000F1B0 }
0000F19C                                     81 57 00 78             .W.x

l0000F1A0:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0000F1C8; r2 = memw(r17+20) }

l0000F1AC:
	{ r3 = add(badva,00000004) }

l0000F1B0:
	{ r2 = r16; call	errlog_function }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0000F1C0 A6 45 00 00 84 41 49 6A                         .E...AIj        
...
logmsg_function proc
	{ allocframe(00000008); r3 = 00000002 }
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function; r5 = memw(r2+16) }

l0000F1F0:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000002E) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     0000F1E4 (in logmsg_function)
;;     0000F1F8 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000012) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0000F264:
	...
	{ memw(r29+4) = r3 }
	{ if (!cmp.gt(r24.new,00000001)) jump:nt	0000F384; r25 = memw(r19+16); r24 = mpyi(r2,r3) }
...
l0000F29C:
	{ memb(r29+4) = r0.new; if (!p0) jump:nt	0000F300; r0 = p0 }
...
l0000F2C8:
	...
	{ if (!p0.new) jump:nt	0000F300; p0 = r0 }

l0000F2DC:
	{  }
	{ call	fn00009784 }
	{  }
	{ if (cmp.eq(r23.new,00000000)) jump:nt	0000F314; r23 = add(r23,FFFFFFFF); r3 = add(r18,00000004) }

l0000F2F8:
	{ jump	0000F2DC; r10 = r3 }
0000F2FC                                     4A 52 FF 5B             JR.[

l0000F300:
	{ r0 = r16 }
	{ jump	0000F368 }
0000F308                         44 52 FF 5B 00 C0 71 70         DR.[..qp
0000F310 82 C0 9D 91                                     ....            

l0000F314:
	{ if (!p0.new) jump:nt	0000F36C; p0 = r2 }
...
l0000F370:
	{ if (!cmp.eq(r26.new,r24)) jump:t	0000F29C; r26 = add(r26,00000001); r25 = addasl(r25,r22,00000002) }
...
l0000F3AC:
	{ call	fn0000F468; r3 = add(badva,00000024) }
	{ r0 = FFFFFFFF; jump	0000F398 }

;; logsoftmax_check: 0000F3C0
logsoftmax_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000009) }
	{ r17 = r0; r16 = r1; r1 = 00000053 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000002)) jump:t	0000F408; r2 = memw(r17+16); r1 = 00000054 }

l0000F3EC:
	{ r3 = add(badva,0000003D) }
	{ r2 = r16; call	errlog_function }

l0000F3F8:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0000F400 A1 4A 00 78 A2 40 91 91                         .J.x.@..        

l0000F408:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0000F420 }

l0000F410:
	{ jump	0000F3F8; r3 = add(badva,00000019) }
0000F418                         A2 45 00 00 04 4E 49 6A         .E...NIj
...
l0000F448:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000025) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }

;; errlog_function: 0000F460
;;   Called from:
;;     0000F3F0 (in logsoftmax_check)
;;     0000F43C (in logmsg_function)
;;     0000F450 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000009) }
...
expanddims_execute proc
	...
	{ memw(r4+8) = r2; r2 = r1 }
	{ r5 = memw(r3+24) }
	{ if (cmp.gtu(r5,r6.new)) jump:t	0000F4D0; r6 = memw(r4+20) }

l0000F4C0:
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
	{ dealloc_return; r0 = 00000000 }
0000F4CC                                     A2 45 00 00             .E..

l0000F4D0:
	{ r1 = 00000030; call	fn0000F588; r3 = add(badva,0000000B) }
	{ dealloc_return; r0 = -00000001 }

;; expanddims_check: 0000F4E0
expanddims_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000001E) }
	{ r17 = r0; r16 = r1; r1 = 00000037 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r2 = memw(r17+16) }
	{ if (cmp.gtu(r3.new,r2)) jump:t	0000F528; r3 = 00000004 }

l0000F50C:
	{ r1 = 00000038; r3 = add(badva,00000013) }
	{ r2 = r16; call	errlog_function }

l0000F51C:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0000F524             21 47 00 78                             !G.x        

l0000F528:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0000F544; r2 = memw(r17+20) }

l0000F534:
	{ jump	0000F51C; r3 = add(badva,0000003A) }
0000F53C                                     9F 45 00 00             .E..
0000F540 04 5F 49 6A                                     ._Ij            
...
l0000F568:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000003A) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }

;; errlog_function: 0000F580
;;   Called from:
;;     0000F514 (in expanddims_check)
;;     0000F55C (in logmsg_function)
;;     0000F570 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000001E) }

;; fn0000F588: 0000F588
;;   Called from:
;;     0000F4D0 (in expanddims_execute)
fn0000F588 proc
	{ allocframe(00000008); r4 = r3 }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
sslice_execute_4b proc
	{ jump	strided_slice_impl; r2 = 00000004 }

;; sslice_check: 0000F5B4
sslice_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000013) }
	{ r17 = r0; r16 = r1; r1 = 00000070 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000008)) jump:t	0000F5F0; r2 = memw(r17+16); r1 = 00000071 }

l0000F5E0:
	{ jump	0000F608; r3 = add(badva,00000002) }
0000F5E8                         41 4E 00 78 00 40 00 78         AN.x.@.x

l0000F5F0:
	{ if (cmp.eq(r2.new,00000002)) jump:t	fn0000F618; r2 = memw(r17+20) }

l0000F5FC:
	{ r3 = add(badva,00000031) }
	{ r2 = r16; call	errlog_function }
...
sslice_execute_1b proc
	{ jump	strided_slice_impl; r2 = 00000001 }
...
;; fn0000F618: 0000F618
;;   Called from:
;;     0000F5F0 (in sslice_check)
;;     0000F614 (in sslice_execute_q8)
fn0000F618 proc
	...
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	fn0000F650; r6 = memw(r2+20) }

;; fn0000F644: 0000F644
;;   Called from:
;;     0000F634 (in fn0000F618)
;;     0000F638 (in fn0000F618)
fn0000F644 proc
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
...
fn0000F650 proc
	...
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	0000F680; r6 = memw(r2+20) }
...
l0000F680:
	{ deallocframe; r17:r16 = memd(r29); r2 = 00000001 }
...
sslice_check_q8 proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000037) }
	{ r17 = r0; r16 = r1; r1 = 00000078 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,0000000C)) jump:t	0000F6CC; r2 = memw(r17+16); r1 = 00000079 }

l0000F6BC:
	{ jump	0000F6E4; r3 = add(badva,00000026) }
0000F6C4             41 4F 00 78 00 40 00 78                 AO.x.@.x    

l0000F6CC:
	{ if (cmp.eq(r2.new,00000006)) jump:t	fn0000F6F4; r2 = memw(r17+20) }

l0000F6D8:
	{ r3 = add(badva,00000015) }
	{ r2 = r16; call	errlog_function }
...
;; fn0000F6F4: 0000F6F4
;;   Called from:
;;     0000F6CC (in sslice_check_q8)
fn0000F6F4 proc
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function }

;; fn0000F6FC: 0000F6FC
;;   Called from:
;;     0000F6F4 (in fn0000F6F4)
;;     0000F6F4 (in fn0000F6F4)
;;     0000F6F4 (in fn0000F6F4)
fn0000F6FC proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000002D) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     0000F6F0 (in fn0000F6F4)
;;     0000F6F4 (in fn0000F6F4)
;;     0000F704 (in fn0000F6FC)
;;     0000F810 (in strided_slice_impl)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000011) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
strided_slice_impl proc
	...
	{ r2 = memw(r23+20); r18 = r0; r3 = add(badva,00000021) }
	{ if (cmp.gtu(r25.new,r2)) jump:t	0000F818; r1 = 00000047; r25 = mpyi(r18,r17) }

l0000F7B0:
	{ r1 = 00000048; p0 = cmp.gt(r26,00000001); r3 = add(badva,00000017) }
	{ if (cmp.gt(r2.new,00000002)) jump:t	0000F814; r2 = memw(r22) }

l0000F7C8:
	{ r1 = 00000049; r3 = add(badva,0000003F) }
	{ if (!p0) r1 = 0000004A; if (p0) jump:nt	0000F810 }

l0000F7D8:
	{ if (!p0.new) r1 = 0000004B; p0 = cmp.gt(r27,00000001); r3 = add(badva,0000002B) }
	{ if (p0) jump:nt	0000F810 }

l0000F7EC:
	{ r3 = add(badva,00000037) }
	{ if (!cmp.gt(r16,r2.new)) jump:t	0000F814; r2 = memw(r29+20) }

l0000F800:
	{ r1 = 0000004C; r3 = add(badva,00000031) }
	{ if (!cmp.gtu(r24,r2.new)) jump:t	0000F820; r2 = memw(r29+20) }
...
l0000F818:
	{ jump	0000F884 }
0000F81C                                     97 45 00 00             .E..

l0000F820:
	{ r22 = memw(r23+16); r26 = memw(r22+16); r4 = add(badva,0000001A) }
...
l0000F874:
	{ r22 = add(r22,r17); r2 = r17 }
	{ if (!cmp.eq(r18.new,00000001)) jump:t	0000F874; r18 = add(r18,FFFFFFFF); r16 = add(r16,r20) }
...
resizenear_f_execute proc
	...
	{  }
	{ r20 = memw(r3); r24 = memw(r2+4) }
	{ r26 = memw(r21+4); r18 = memw(r21) }
	{  }
	{ r19 = memw(r2); r23 = memw(r21+12); call	fn00009614 }
	{  }
	{ r16 = r0 }
	{  }
	{ r0 = r2; call	fn00009614 }
	{ r3 = memw(r20+20); r1 = 00000044; r17 = asl(r23,00000002); r2 = mpyi(r24,r19) }
	{ r2 = mpyi(r2,r18) }
	{ if (!cmp.gtu(r22.new,r3)) jump:t	0000F938; r22 = mpyi(r2,r17) }

l0000F920:
	{ r2 = r27; r3 = add(badva,00000022) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0000FA44 }
0000F934             03 40 7A 70                             .@zp        

l0000F938:
	{ r21 = memw(r20+16); r26 = memw(r21+16); r2 = r27 }
	{ memw(r29+28) = r23; r1 = 00000045; r4 = add(badva,00000008) }
...
l0000F990:
	...
	{ r2 = asl(r2,00000002) }
	{ memw(r29+44) = r2 }
	{ if (p0.new) memw(r29+40) = r5; jump	0000FA38; if (p0.new) jump:nt	0000F9AC; p0 = cmp.gt(r3,00000000) }

l0000F9A4:
	{ if (p0.new) memw(r29+40) = r5; jump	0000FA38 }
...
0000FA30 C8 E3 72 20 92 1C A5 3C                         ..r ...<        

l0000FA38:
	{ if (!cmp.eq(r5.new,r2)) jump:t	0000F9A4; r5 = add(r5,00000001) }
...
resizenear_f_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000015) }
	{ r17 = r0; r16 = r1; r1 = 0000005B }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	0000FAA8; r2 = memw(r17+16); r1 = 0000005C }

l0000FA8C:
	{ r3 = add(badva,00000000) }
	{ r2 = r16; call	errlog_function }

l0000FA98:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0000FAA0 A1 4B 00 78 A2 40 91 91                         .K.x.@..        

l0000FAA8:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0000FAC0 }

l0000FAB0:
	{ jump	0000FA98; r3 = add(badva,0000002B) }
0000FAB8                         8E 45 00 00 84 57 49 6A         .E...WIj
...
l0000FAE8:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000031) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     0000FADC (in logmsg_function)
;;     0000FAF0 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000015) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
mirrorpad_f_execute proc
	{ allocframe(+000000C0); r4 = add(badva,00000032) }
	{ r3 = memw(r0+8); r2 = memw(r0+4) }
	...
	{ call	logmsg_function }
	{ r1 = 00000086; r3 = add(badva,00000039) }
	{ if (!cmp.eq(r2.new,00000004)) jump:t	0000FCC8; r2 = memw(r24+12) }

l0000FBD8:
	{ r1 = 00000087; r3 = add(badva,00000025) }
	{ if (!cmp.eq(r2.new,00000008)) jump:t	0000FCC8; r2 = memw(r24+8) }

l0000FBEC:
	{ r1 = 00000088; r3 = add(badva,0000001F) }
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0000FCC8; r2 = or(r21,r20) }

l0000FC00:
	{ r1 = 00000089; r3 = add(badva,0000001D) }
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0000FCC8; r2 = or(r22,r23) }

l0000FC14:
	{ if (p0.new) memw(r29) = r26; if (!p0.new) r2 = add(r17,00000000); p0 = cmp.gt(r19,r26) }
	{ memw(r29+4) = r19; r1 = 0000008A; r3 = add(badva,00000009) }
	{ jump	0000FCC8 }
...
0000FCC0 0C E8 42 21 02 C0 71 70                         ..B!..qp        
...
mirrorpad_f_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000017) }
	{ r17 = r0; r16 = r1; r1 = 000000A7 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r2 = memb(r17+32) }
	{ r2 = add(r2,FFFFFFFD) }
	{ if (p0.new) r1 = 000000AA; if (!p0.new) jump:nt	0000FFFC; p0 = cmpb.gtu(r2,01) }

l0000FFE0:
	{ r3 = add(badva,00000039) }
	{ r2 = r16; call	errlog_function }

l0000FFF0:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0000FFF8                         81 55 00 78                     .U.x    

l0000FFFC:
	{ if (cmp.eq(r2.new,00000004)) jump:t	00010018; r2 = memw(r17+16) }

l00010008:
	{ jump	0000FFF0; r3 = add(badva,00000029) }
00010010 A1 55 00 78 A2 40 91 91                         .U.x.@..        

l00010018:
	{ if (cmp.eq(r2.new,00000002)) jump:t	00010030 }

l00010020:
	{ jump	0000FFF0; r3 = add(badva,00000020) }
00010028                         7B 45 00 00 04 52 49 6A         {E...RIj
...
l00010058:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000014) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     0001004C (in logmsg_function)
;;     00010060 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000038) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0001014C:
	{ r2 = r6; r1 = 000000BD; r0 = add(badva,00000029) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(badva,00000038) }
	{ memw(r29+88) = r7; r23 = memw(r25+16); r27 = r5; r24 = r6 }
	{ r17 = memw(r26+16) }
	{ memw(r29) = r5; memw(r29+100) = r3; call	logmsg_function }
	{ if (!cmp.gtu(r16,r2.new)) jump:t	000101BC; r2 = memw(r25+20); r1 = 000000BD }

l00010198:
	{ r2 = r24; r0 = add(badva,00000021) }
	{ r3 = add(badva,00000012) }

l000101A8:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	000103E0 }
000101B4             02 40 78 70 0D 40 93 91                 .@xp.@..    
...
l000101F0:
	{ if (p0.new) jump:nt	000101FC; p0 = cmp.eq(r5,00000002) }
...
l00010200:
	{ if (p0.new) jump:nt	0001020C; p0 = cmp.eq(r6,00000002) }

l00010204:
	{ nop; if (!p0.new) jump:nt	00010238; p0 = cmp.eq(r3,00000002) }

l0001020C:
	{ p0 = cmp.eq(r7,r9); if (p0.new) jump:nt	00010220 }

l00010214:
	{ if (p0.new) jump:nt	00010220; p0 = cmp.eq(r7,00000002) }
...
l00010238:
	{ memw(r29+28) = r12; r1 = 000000BD; r0 = add(badva,0000003D) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(badva,00000030) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump	000101A8 }

l0001026C:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(badva,0000003D) }
	{ memw(r29+40) = r20; r1 = 000000BD; r4 = add(badva,0000002C) }
...
l00010398:
	{ if (!cmp.eq(r14.new,r18)) jump:t	00010358; r14 = add(r14,00000001); r12 = addasl(r12,r4,00000002); r13 = addasl(r13,r22,00000002) }

l000103A8:
	{ if (!cmp.eq(r7.new,r24)) jump:t	0001034C; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002); r25 = addasl(r25,r8,00000002) }

l000103AC:
	{ if (!cmp.eq(r7.new,r24)) jump:t	0001034C; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002) }

l000103B8:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,0000003D) }

l000103BC:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,0000003D) }

l000103CC:
	{ r2 = r19; r1 = 000000BD; r4 = add(badva,00000018) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
add_int32_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000006) }
	{ r16 = r1; r1 = 00000037; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(badva,00000019) }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	0001044C; r2 = memw(r17+16); r1 = 00000038 }

l00010428:
	{ r0 = add(badva,0000003D) }
	{ r3 = add(badva,0000001A) }
	{ r2 = r16; call	errlog_function }

l0001043C:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00010444             21 47 00 78 A2 40 91 91                 !G.x.@..    

l0001044C:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001046C }

l00010454:
	{ r0 = add(badva,00000011) }
	{ jump	0001043C; r3 = add(badva,0000003D) }
00010464             6C 45 00 00 80 5E 49 6A                 lE...^Ij    

l0001046C:
	{ r2 = r16; r1 = 0000003A }
	{ memw(r29) = r17; call	fn00010490; r4 = add(badva,00000035) }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0001048C (in logmsg_function)
;;     00010490 (in fn00010490)
errlog_function proc
...
l00010568:
	...
	{ r17 = memw(r16++#4) }
	{ if (!cmp.gt(r17.new,00000006)) jump:t	00010590; r17 = add(r10,sub(0000007F,r17)) }
...
l00010590:
	{ if (p0.new) r13 = 00000001 }

l00010594:
	{ if (p0.new) r9 = 00000001; if (p0.new) jump:t	000105AC; p0 = cmp.eq(r9,00000002) }

l0001059C:
	{ if (p0.new) r8 = 00000001; if (p0.new) jump:t	000105AC; p0 = cmp.eq(r9,00000004) }
...
l000105B8:
	{ if (cmp.eq(r0.new,00000004)) jump:t	000105E8; r0 = memb(r0+32); r11 = r9; p0 = cmp.eq(r18,00000000) }

l000105CC:
	{ r1 = r13; r28 = r12; r17 = r8 }
	{ jump	0001067C }
000105DC                                     0B 40 89 74             .@.t
000105E0 10 4C 08 F5 00 C0 6D 70                         .L....mp        
...
l000105F4:
	{ loop0(000105F8,r18) }
	{ r18 = memw(r1++#4) }
	{ if (!cmp.gt(r18.new,00000006)) jump:t	00010618; r18 = add(r10,sub(0000007F,r18)) }

l00010608:
	{ r16 = 00000000; r0 = 00000000; r17 = 00000000 }
	{ jump	00010630 }
00010614             0E 60 0A 10                             .`..        

l00010618:
	{ if (p0.new) r0 = 00000000 }
	{ if (p0.new) r11 = 00000000; if (p0.new) jump:t	00010630; p0 = cmp.eq(r10,00000002) }

l00010624:
	{ if (p0.new) r17 = 00000000; if (p0.new) jump:t	00010630; p0 = cmp.eq(r10,00000004) }
...
l00010638:
	...
	{ r17 = cmp.eq(r16,00000001); if (!p0) r1 = add(r11,00000000); if (!p0) r10 = add(r1,00000000); if (p3) jump:nt	0001067C }
...
l0001067C:
	...
	{ r0 = mpyi(r0,r8) }
	{ r0 = mpyi(r0,r12) }
	{ if (!cmp.gtu(r0.new,r11)) jump:t	000106BC; r0 = asl(r0,00000002) }

l0001069C:
	{ r1 = 000000C6; r0 = add(badva,0000003A) }
	{ call	fn000108FC; r3 = add(badva,0000000D) }
	{ r0 = FFFFFFFF; jump	00010814 }
000106B8                         00 40 00 78                     .@.x    

l000106BC:
	{ memw(r14+24) = r0; memw(r14+12) = r1 }
...
l00010748:
	{ p0 = cmp.gt(r28,00000000); r24 = add(r21,r20) }
...
l000107A8:
	{  }
	{ r24 = memw(r26); r26 = add(r26,00000004); r27 = r24 }
	{ nop; r25 = r27 }
...
l000107D4:
	{ if (!cmp.eq(r20.new,r15)) jump:t	00010748; r20 = add(r20,00000001) }

l000107DC:
	{ if (!cmp.eq(r19.new,r2)) jump:t	00010734; r19 = add(r19,00000001) }
...
l000107F8:
	{ if (!cmp.eq(r11.new,r9)) jump:t	0001071C; r11 = add(r11,00000001) }

l00010800:
	{ if (!cmp.eq(r10.new,r8)) jump:t	00010710; r10 = add(r10,00000001) }

l00010804:
	{ if (!cmp.eq(r10.new,r8)) jump:t	00010710 }

l00010808:
	{ if (!cmp.eq(r0.new,r12)) jump:t	00010704; r0 = add(r0,00000001) }
...
prod_f_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r2 = memw(r17+16) }
	{ if (cmp.gtu(r3.new,r2)) jump:t	00010880; r3 = 00000004 }

l0001085C:
	{ r1 = 00000038; r0 = add(badva,00000023) }
	{ r3 = add(badva,0000003F) }

l0001086C:
	{ r2 = r16; call	errlog_function }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001087C                                     0A 40 42 10             .@B.

l00010880:
	{ r1 = 00000039 }
	{ jump	0001086C; r0 = add(badva,00000037) }
00010890 41 47 00 78 A2 40 91 91 10 E1 02 24 60 45 00 00 AG.x.@.....$`E..
000108A0 80 CF 49 6A 61 45 00 00 03 47 49 6A E4 FF FF 59 ..IjaE...GIj...Y
000108B0 61 45 00 00 04 49 49 6A 82 30 B1 2B 08 40 00 5A aE...IIj.0.+.@.Z
000108C0 00 D1 9D A1 00 C0 00 78 40 1F 0C 3E             .......x@..>    
...
l000108DC:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000023) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }

;; errlog_function: 000108F4
;;   Called from:
;;     0001086C (in prod_f_check)
;;     000108D0 (in logmsg_function)
;;     000108E4 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r3 = 00000000 }
...
l000109BC:
	{ r2 = r6; r1 = 000000BD; r0 = add(badva,00000017) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(badva,00000026) }
	{ memw(r29+88) = r7; r23 = memw(r25+16); r27 = r5; r24 = r6 }
	{ r17 = memw(r26+16) }
	{ memw(r29) = r5; memw(r29+100) = r3; call	logmsg_function }
	{ if (!cmp.gtu(r16,r2.new)) jump:t	00010A2C; r2 = memw(r25+20); r1 = 000000BD }

l00010A08:
	{ r2 = r24; r0 = add(badva,0000000F) }
	{ r3 = add(badva,00000000) }

l00010A18:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00010C50 }
00010A24             02 40 78 70 0D 40 93 91                 .@xp.@..    
...
l00010A60:
	{ if (p0.new) jump:nt	00010A6C; p0 = cmp.eq(r5,00000002) }
...
l00010A70:
	{ if (p0.new) jump:nt	00010A7C; p0 = cmp.eq(r6,00000002) }

l00010A74:
	{ nop; if (!p0.new) jump:nt	00010AA8; p0 = cmp.eq(r3,00000002) }

l00010A7C:
	{ p0 = cmp.eq(r7,r9); if (p0.new) jump:nt	00010A90 }

l00010A84:
	{ if (p0.new) jump:nt	00010A90; p0 = cmp.eq(r7,00000002) }
...
l00010AA8:
	{ memw(r29+28) = r12; r1 = 000000BD; r0 = add(badva,0000002B) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(badva,0000001E) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump	00010A18 }

l00010ADC:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(badva,0000002B) }
	{ memw(r29+40) = r20; r1 = 000000BD; r4 = add(badva,0000001A) }
	{ memw(r29+28) = r12; memw(r29+32) = r24 }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+12) = r8 }
	{ memw(r29) = r5; memw(r29+4) = r6 }
...
l00010C08:
	{ if (!cmp.eq(r14.new,r18)) jump:t	00010BC8; r14 = add(r14,00000001); r12 = addasl(r12,r4,00000002); r13 = addasl(r13,r22,00000002) }

l00010C18:
	{ if (!cmp.eq(r7.new,r24)) jump:t	00010BBC; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002); r25 = addasl(r25,r8,00000002) }

l00010C1C:
	{ if (!cmp.eq(r7.new,r24)) jump:t	00010BBC; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002) }

l00010C28:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,0000002B) }

l00010C2C:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,0000002B) }

l00010C3C:
	{ r2 = r19; r1 = 000000BD; r4 = add(badva,00000006) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
mul_int32_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000034) }
	{ r16 = r1; r1 = 00000037; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(badva,00000007) }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	00010CBC; r2 = memw(r17+16); r1 = 00000038 }

l00010C98:
	{ r0 = add(badva,0000002B) }
	{ r3 = add(badva,00000008) }
	{ r2 = r16; call	errlog_function }

l00010CAC:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00010CB4             21 47 00 78 A2 40 91 91                 !G.x.@..    

l00010CBC:
	{ if (cmp.eq(r2.new,00000002)) jump:t	00010CDC }

l00010CC4:
	{ r0 = add(badva,0000003F) }
	{ jump	00010CAC; r3 = add(badva,0000002B) }
00010CD4             51 45 00 00 80 55 49 6A                 QE...UIj    

l00010CDC:
	{ r2 = r16; r1 = 0000003A }
	{ memw(r29) = r17; call	fn00010D00; r4 = add(badva,00000023) }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     00010CFC (in logmsg_function)
;;     00010D00 (in fn00010D00)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r3 = 00000000 }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); call	logv }
	{ r0 = memw(r0); r0 = memw(r0) }
...
l00010D98:
	...
	{ r5 = memw(r4); r3 = add(badva,00000000) }
	{ if (cmp.eq(r6.new,r25)) jump:t	00010DC0; r6 = memw(r5) }

l00010DB8:
	{ r1 = 00000042 }
	{ if (cmp.eq(r6.new,r23)) jump:t	00010DE0; r6 = memw(r5+4); r3 = add(badva,00000024) }
...
l00010DD0:
	{ r1 = 00000043 }
	{ if (cmp.eq(r6.new,r21)) jump:t	00010DF8; r6 = memw(r5+8); r3 = add(badva,0000000C) }

l00010DE0:
	{ if (cmp.eq(r6.new,r21)) jump:t	00010DF8 }

l00010DE8:
	{ r1 = 00000044 }
	{ if (cmp.eq(r6.new,r22)) jump:t	00010E10; r6 = memw(r5+12); r3 = add(badva,00000034) }

l00010DF8:
	{ if (cmp.eq(r6.new,r22)) jump:t	00010E10 }

l00010E00:
	{ r1 = 00000045 }
	{ if (cmp.eq(r5.new,r2)) jump:t	00010E28; r5 = memw(r5+24); r3 = add(badva,00000026) }

l00010E10:
	{ if (cmp.eq(r5.new,r2)) jump:t	00010E28 }
...
l00010E24:
	{ r1 = 0000004A; r3 = add(badva,0000000F) }

l00010E28:
	{ r1 = 0000004A; r3 = add(badva,0000000F) }

l00010E30:
	{ if (cmp.gtu(r24,r4.new)) jump:t	00010EC4; r4 = memw(r19+20) }
...
l00010E48:
	...
	{ if (cmp.eq(r27.new,00000000)) jump:nt	00010E7C; r3 = memw(r26+24); r27 = add(r27,FFFFFFFF) }

l00010E64:
	{ r26 = memw(r13+r16); r16 = add(r16,00000004) }
	{ r2 = memw(r26+24); jump	00010E48 }
00010E74             12 41 4E 10 16 E0 14 74                 .AN....t    
...
00010E98                         F2 61 3D 10 15 E0 14 74         .a=....t
00010EA0 EE 61 3F 10 17 E0 14 74 50 45 00 00 83 4C 49 6A .a?....tPE...LIj
00010EB0 C1 4A 00 78 27 C0 9D 91 E4 68 DF 5C 20 C0 19 75 .J.x'....h.\ ..u
00010EC0 54 40 00 5A                                     T@.Z            
...
pack_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (!cmp.eq(r2.new,00000000)) jump:t	00010F14; r2 = memw(r17+16); r1 = 0000005F }

l00010F04:
	{ jump	00010F2C; r3 = add(badva,00000009) }
00010F0C                                     01 4C 00 78             .L.x
00010F10 00 40 00 78                                     .@.x            

l00010F14:
	{ if (cmp.eq(r2.new,00000002)) jump:t	fn00010F3C; r2 = memw(r17+20) }

l00010F20:
	{ r3 = add(badva,00000038) }
	{ r2 = r16; call	errlog_function }
...
logmsg_function proc
	{ allocframe(00000008); r4 = 00000002 }
	{ if (cmp.gtu(r4,r3.new)) jump:t	errlog_function; r3 = memw(r2+16) }

;; fn00010F3C: 00010F3C
;;   Called from:
;;     00010F14 (in pack_check)
fn00010F3C proc
	{ if (cmp.gtu(r4,r3.new)) jump:t	errlog_function }

l00010F44:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000019) }
	{ r6 = add(r29,00000010); r1 = 0000005E; r4 = add(badva,00000027) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
;;     00010F38 (in fn00010F3C)
;;     00010F3C (in fn00010F3C)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000031) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
shape_execute proc
	{ allocframe(00000018); memd(r29+496) = r17:r16; r4 = add(badva,00000037) }
	...
	{ if (cmp.gtu(r2.new,0000001E)) jump:t	00010FDC; r2 = memw(r18+20) }

l00010FC4:
	{ r2 = r17; r1 = 00000033; r3 = add(badva,0000001F) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00011024 }
00010FD8                         4E 45 00 00                     NE..    

l00010FDC:
	{ memw(r18+4) = 00000001; r2 = memw(r18+16); r4 = add(badva,00000015) }
...
shape_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000000F) }
	{ r17 = r0; r16 = r1; r1 = 00000041 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000002)) jump:t	00011078; r2 = memw(r17+16); r1 = 00000042 }

l0001105C:
	{ r3 = add(badva,0000003E) }
	{ r2 = r16; call	errlog_function }

l00011068:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00011070 61 48 00 78 A2 40 91 91                         aH.x.@..        

l00011078:
	{ if (cmp.eq(r2.new,00000002)) jump:t	00011090 }

l00011080:
	{ jump	00011068; r3 = add(badva,00000029) }
00011088                         4A 45 00 00 84 56 49 6A         JE...VIj
...
l000110B8:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000030) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     000110AC (in logmsg_function)
;;     000110C0 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000014) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
and_int32_execute proc
	{ jump	fn000111C8; r2 = add(badva,00000008) }

;; logical_int32_check: 0001110C
logical_int32_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000012) }
	{ r16 = r1; r1 = 0000003E; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(badva,00000021) }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	00011164; r2 = memw(r17+16); r1 = 0000003F }

l00011140:
	{ r0 = add(badva,00000005) }
	{ r3 = add(badva,0000002D) }
	{ r2 = r16; call	errlog_function }

l00011154:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001115C                                     01 48 00 78             .H.x
00011160 A2 40 91 91                                     .@..            

l00011164:
	{ if (cmp.eq(r2.new,00000002)) jump:t	00011184 }

l0001116C:
	{ r0 = add(badva,00000019) }
	{ jump	00011154; r3 = add(badva,00000010) }
0001117C                                     4B 45 00 00             KE..
00011180 80 42 49 6A                                     .BIj            

l00011184:
	{ r2 = r16; r1 = 00000041 }
	{ memw(r29) = r17; call	fn00011588; r4 = add(badva,00000004) }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }

;; ior_int32_execute: 000111A4
ior_int32_execute proc
	{ jump	fn000111C8; r2 = add(badva,0000001C) }
...
;;     000111C0 (in broadcast_elementwise_execute_int32)
fn000111C8 proc
	{ allocframe(+000000A8) }
	...
	{ if (p0) jump:nt	fn00011270 }

;; fn00011268: 00011268
;;   Called from:
;;     00011260 (in fn000111C8)
;;     00011264 (in fn000111C8)
fn00011268 proc
	{ r2 = mpyi(r8,r21) }
	{ memw(r29+84) = r2 }
...
;;     00011260 (in fn000111C8)
;;     00011264 (in fn000111C8)
;;     0001126C (in fn00011268)
;;     00011514 (in broadcast_elementwise_execute_int32)
;;     00011524 (in broadcast_elementwise_execute_int32)
fn00011270 proc
	{ r2 = r25; r1 = 000000BD; r0 = add(badva,0000000B) }
	{ memw(r29+96) = r8; r27 = memw(r17+16); r4 = add(badva,0000001A) }
	{ r26 = memw(r23+16); r20 = memw(r19+16) }
	{ memw(r29) = r24; call	logmsg_function }
	{ if (!cmp.gtu(r22,r2.new)) jump:t	000112D4; r2 = memw(r17+20); r1 = 000000BD }

l000112B0:
	{ r2 = r25; r0 = add(badva,0000000F) }
	{ r3 = add(badva,00000000) }

l000112C0:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00011564 }
000112CC                                     F5 00 B2 00             ....
000112D0 00 42 05 F2                                     .B..            

l000112D4:
	{ r7 = memw(r23+8); r8 = memw(r23+12) }
...
l000112FC:
	{ if (p0.new) jump:nt	00011304; p0 = cmp.eq(r5,00000002) }

l00011300:
	{ if (!p0.new) jump:nt	00011340; p0 = cmp.eq(r2,00000002) }

l00011304:
	{ nop; if (p0.new) jump:nt	00011314; p0 = cmp.eq(r6,-00000001) }

l0001130C:
	{ if (p0.new) jump:nt	00011314; p0 = cmp.eq(r6,00000002) }

l00011310:
	{ if (!p0.new) jump:nt	00011340; p0 = cmp.eq(r3,00000002) }

l00011314:
	{ p0 = cmp.eq(r7,r9); if (p0.new) jump:nt	00011328 }

l0001131C:
	{ if (p0.new) jump:nt	00011328; p0 = cmp.eq(r7,00000002) }
...
l00011340:
	{ memw(r29+28) = r12; r1 = 000000BD; r0 = add(badva,0000003B) }
	{ memw(r29+12) = r8; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(badva,0000002E) }
	{ memw(r29+4) = r6; memw(r29+16) = r2; r2 = r25 }
	{ memw(r29) = r5; jump	000112C0 }

l00011374:
	{ memw(r29+44) = r16; r23 = memd(r29+112); r0 = add(badva,00000007) }
	{ r19 = memw(r29+68); r1 = 000000BD; r4 = add(badva,00000036) }
...
l000113DC:
	...
	{ r25 = !cmp.eq(r7,00000001); r6 = 00000000; p2 = cmp.eq(r6,00000001); r12 = cmp.eq(r7,00000000) }
...
l00011458:
	{ r3 = r4 }
	{ memw(r29+76) = r5; r2 = memd(r29+88) }
	{ memw(r29+80) = r4; p0 = cmp.gt(r2,00000000) }
	{ if (!p0) jump:nt	0001151C }

l00011470:
	{ if (cmp.gt(r2.new,00000000)) jump:t	00011488; r2 = memw(r29+112) }

l00011474:
	{ if (cmp.gt(r2.new,00000000)) jump:t	00011488 }

l0001147C:
	{ memw(r29+100) = r3; jump	000114FC }
00011484             13 40 63 70                             .@cp        
...
l000114E4:
	...
	{ if (!cmp.eq(r2.new,r23)) jump:t	0001149C; r2 = memw(r29+112); r19 = addasl(r19,r7,00000002) }
...
l00011500:
	...
	{ if (!cmp.eq(r7.new,r2)) jump:t	00011474; r7 = add(r7,00000001) }
...
l0001153C:
	{ memb(r29) = r2.new; r2 = memw(r29+52); r0 = add(badva,0000003F) }
	{ r2 = memw(r29+48); r1 = 000000BD; r4 = add(badva,0000001A) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
;;     00011298 (in fn00011270)
;;     000113BC (in fn00011270)
;;     0001155C (in fn00011270)
logmsg_function proc
	{ allocframe(00000008); r3 = 00000002 }
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function; r5 = memw(r2+16) }
...
;;     000112C0 (in fn00011270)
;;     00011584 (in logmsg_function)
;;     00011588 (in fn00011588)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r3 = 00000000 }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); call	logv }
...
avgpool_execute_asm proc
	{ jump	fn00011738; r2 = add(badva,00000010) }

;; avgpool_check: 000115DC
avgpool_check proc
	{ allocframe(00000030); memd(r29+496) = r17:r16; r4 = add(badva,0000000A) }
	{ r17 = r0; r16 = r1; r1 = 00000186 }
	{ call	logmsg_function }
	{ memw(r29) = r17; memd(r29+32) = r19:r18 }
	{ if (cmp.eq(r2.new,0000000A)) jump:t	00011628; r2 = memw(r17+16); r1 = 00000187 }
...
00011620 61 71 00 78 A2 40 91 91                         aq.x.@..        

l00011628:
	{ if (cmp.eq(r2.new,00000006)) jump:t	00011644 }

l00011630:
	{ r1 = 00000188; jump	00011618; r3 = add(badva,0000002A) }
0001163C                                     3C 45 00 00             <E..
00011640 84 57 49 6A                                     .WIj            

l00011644:
	{  }
	{ memw(r29) = r17 }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	000116CC; r2 = memw(r17+16); r19:r18 = combine(00000000,00000000) }

l00011660:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	00011680; r2 = memw(r5+r18) }

l0001166C:
	{ memw(r29) = r19; r1 = 0000018E; r3 = add(badva,00000000) }
	{ jump	00011610 }
0001167C                                     3D 45 00 00             =E..

l00011680:
	{ r6 = memw(r2+4); r5 = memw(r2); r4 = add(badva,00000032) }
	{ r8 = memw(r2+12); r7 = memw(r2+8); r1 = 00000180 }
	{ r2 = memw(r2+16); r9 = memw(r2+24) }
	{  }
	{ memw(r29+12) = r7; memw(r29+24) = r2 }
	{ memw(r29+16) = r8; memw(r29+20) = r9 }
	{ memw(r29+4) = r5; memw(r29+8) = r6 }
	{ memw(r29) = r19; call	logmsg_function }
	{ r2 = memw(r17+16); r18 = add(r18,00000004) }
	{ if (cmp.gtu(r2,r19.new)) jump:t	00011660; r19 = add(r19,00000001) }

l000116C8:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00011700 }

l000116CC:
	{ r3 = memw(r17+8); jump	000116E0; r4 = 00000000 }

l000116D0:
	{ r3 = memw(r17+8) }
000116D4             83 40 03 B0                             .@..        

l000116D8:
	{ if (!cmp.gtu(r2,r4.new)) jump:nt	00011704; r4 = add(r4,00000001) }

l000116E0:
	{ if (!cmp.eq(r5.new,00000001)) jump:t	000116D8; r5 = memw(r3) }

l000116E4:
	{ if (!cmp.eq(r5.new,00000001)) jump:t	000116D8 }

l000116EC:
	{ memw(r29) = r4; r1 = 00000194; r3 = add(badva,00000016) }
	{ jump	00011610 }
000116FC                                     3B 45 00 00             ;E..

l00011700:
	{ r4 = add(badva,00000019) }
...
fn00011738 proc
	...
	{ memw(r29+28) = r0; if (!p0) jump:nt	fn000117A4 }

;; fn000117A0: 000117A0
;;   Called from:
;;     00011798 (in fn00011738)
;;     00011798 (in fn00011738)
fn000117A0 proc
	{ jump	000117C8; r0 = r2 }
...
;;     00011798 (in fn00011738)
;;     00011798 (in fn00011738)
;;     000117A0 (in fn000117A0)
fn000117A4 proc
	{ if (p0.new) r3 = memw(r26+8); if (p0.new) r2 = add(r1,r2); if (p0.new) jump:nt	000117C4; p0 = cmp.eq(r13,00000004) }

l000117B0:
	{ if (p0.new) r0 = add(r1,00000000); r19 = 00000000; if (!p0.new) jump:nt	000117D0; p0 = cmp.eq(r13,00000002) }

l000117BC:
	{ jump	000117CC; r0 += add(r2,FFFFFFFF) }
...
l000117D0:
	{ if (p0.new) r1 = add(r22,00000000); r2 = add(r22,r20); if (p0.new) jump:nt	00011800; p0 = cmp.eq(r13,00000004) }

l000117DC:
	{ if (!p0) r1:r0 = combine(r22,r22); if (p0.new) jump:nt	000117F8; p0 = cmp.eq(r13,00000002) }

l000117E4:
	{ r0 = memd(r29+28); r21 = 00000000 }
	{ if (!p0) r1:r0 = combine(r22,r20); if (!p0.new) jump:nt	00011810; p0 = r0 }

l000117F4:
	{ jump	00011804 }

l000117F8:
	{ jump	00011808; r0 += add(r20,FFFFFFFF) }
...
l00011810:
	{ memw(r29+32) = r17; r3:r2 = combine(00000000,00000000); r5 = add(r29,00000038) }

l00011818:
	{ memw(r4+4) = FFFFFF81; r22 = add(r5,00000008); r20 = add(r4,00000008) }
	{  }
	{ memd(r29+56) = r3:r2; memd(r29+64) = r3:r2 }
	...
	{ call	fn00009740 }
	{ r4 = add(badva,00000000) }
	{ r1 = 00000151 }
	{ memw(r29) = r17; call	logmsg_function }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00011880; r2 = memw(r26) }

l00011868:
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00011880 }

l00011870:
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00011880 }

l00011878:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001189C }

l00011880:
	{ r1 = 00000156; r3 = add(badva,00000022) }
	{ r2 = r16; call	errlog_function }
...
l0001189C:
	...
	{ r2 = mpyi(r2,r19) }
	{ if (!cmp.gtu(r3.new,r4)) jump:t	000118C0; r3 = mpyi(r2,r21) }

l000118B4:
	{ jump	00011890; r3 = add(badva,00000006) }
000118BC                                     21 6B 00 78             !k.x

l000118C0:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	000118DC; r2 = memb(r17+32) }

l000118CC:
	{ jump	00011890; r3 = add(badva,0000003C) }
000118D4             02 44 1D B0 52 40 9D 91                 .D..R@..    
...
l000118DC:
	...
	{ memw(r4+12) = r7 }
	{ r2 = memw(r5+24) }
	{ if (cmp.gtu(r2,r6.new)) jump:t	00011948; r6 = memw(r4+20) }
...
l00011948:
	...
	{ memw(r5+12) = r7 }
	{ r2 = memw(r4+24) }
	{ if (cmp.gtu(r2,r6.new)) jump:t	00011984; r6 = memw(r5+20) }

l00011978:
	{ r1 = memw(r4+16); r2 = memw(r4+24); call	fn00009560 }
	{ r4 = add(badva,00000016) }
...
avgpool_execute_slice_ref proc
	...
	{ memw(r29+116) = r1 }
	{ if (p0.new) r0 = sub(r2,r24); if (!p0.new) r26 = 00000000; if (p0.new) jump:nt	00011A38; p0 = cmp.eq(r11,00000004) }

l00011A2C:
	{ r0 = r17; if (!p0.new) jump:nt	00011A44; p0 = cmp.eq(r11,00000002) }
...
l00011A44:
	{ if (p0.new) r1 = add(r21,00000000); if (p0.new) jump:nt	00011A7C; p0 = cmp.eq(r11,00000004) }

l00011A4C:
	{ if (p0.new) r1 = add(r21,00000000); if (p0.new) jump:nt	00011A70; p0 = cmp.eq(r11,00000002) }
...
l00011A70:
	{ r0 = r1 }
	{ jump	00011A88; r0 += add(r22,FFFFFFFF) }
...
l00011A88:
	{ memw(r29+72) = r0 }
	{ if (!cmp.gt(r2.new,00000000)) jump:nt	00011D3C; r2 = memw(r29+20); r3 = sub(r23,r22) }

l00011A90:
	{ if (!cmp.gt(r2.new,00000000)) jump:nt	00011D3C; r2 = memw(r29+20) }
...
l00011B30:
	{ r2 = memw(r29+24) }
	{ if (!cmp.gt(r2,r3.new)) jump:t	00011D28; r3 = memw(r29+72) }
...
00011B70 25 1D 56 3D                                     %.V=            

l00011B74:
	{ r3 = memd(r29+88); r2 = memd(r29+60); p0 = cmp.gt(r5,r6) }

l00011B78:
	{ r3 = memd(r29+88); r2 = memd(r29+60) }
...
l00011B90:
	...
	{  }
	{ if (!cmp.gt(r3.new,00000001)) jump:nt	00011B78; r3 = memw(r29+128); r27 = 00000000 }
...
l00011BC4:
	...
	{ r3 = memd(r29+116); r0 = 00000000 }
	{ r2 = memd(r29+124); r3 = memd(r29+120); r7 = sub(r2,r3) }
	{ r3 = add(r7,r3); r19 = max(r7,r18) }
	{ r2 = min(r2,r3) }
	{ r24 = sub(r2,r19) }
	{ call	fn00009764; r1 = mpyi(r24,r20) }
	{ p0 = cmp.gt(r25,00000000); if (!p0.new) jump:nt	00011D10; r8 = mpyi(r24,r25) }
...
l00011D10:
	{ r2 = memw(r29+128); r21 = sub(r21,r17) }

l00011D18:
	{ if (cmp.eq(r27.new,r2)) jump:nt	00011B74; r27 = add(r27,00000001) }
...
l00011D28:
	{ r3 = add(r3,00000001) }
	{ memw(r29+28) = r3; if (!p0.new) jump:nt	00011B30; p0 = cmp.eq(r3,-00000001) }
...
;;     00011854 (in fn000117A4)
;;     00011990 (in fn000117A4)
logmsg_function proc
	{ allocframe(+00000008) }
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function; r5 = memw(r2+16) }

l00011D68:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,00000003) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
;;     00011888 (in fn000117A4)
;;     00011D5C (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000002B) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l00011E14:
	{ if (p0.new) r3 = memw(r29+96); if (!p0.new) r0 = add(r26,00000000); if (p0.new) jump:nt	00011E30; p0 = cmp.eq(r10,00000004) }

l00011E20:
	{ r21 = 00000000; if (!p0.new) jump:nt	00011E40; p0 = cmp.eq(r10,00000002) }

l00011E28:
	{ jump	00011E38; r0 += add(r17,FFFFFFFF) }
...
l00011E40:
	{ nop; if (p0.new) jump:nt	00011E70; p0 = cmp.eq(r10,00000004) }

l00011E48:
	{ if (p0.new) r1 = memw(r29+80); if (p0.new) jump:nt	00011E64; p0 = cmp.eq(r10,00000002) }

l00011E50:
	{ r1 = memd(r29+92); r0 = 00000000 }
	{ if (!p0.new) jump:nt	00011E84; p0 = r1 }
...
l00011E64:
	{ r0 = r1 }
	{ jump	00011E80; r0 += add(r19,FFFFFFFF) }
...
l00011E80:
	{ if (!cmp.gt(r2.new,00000001)) jump:nt	0001205C; r2 = memw(r29+24); r6 = mpyi(r21,r20); r7 = mpyi(r20,r17) }

l00011E84:
	{ if (!cmp.gt(r2.new,00000001)) jump:nt	0001205C; r2 = memw(r29+24); r6 = mpyi(r21,r20) }
...
l00011F54:
	...
	{  }
	{ if (!cmp.gt(r3.new,00000001)) jump:nt	00011F40; r3 = memw(r29+76) }
...
l00011F84:
	...
	{ r2 = add(r2,r21); r0 = 00000000; r27 = max(r21,r3) }
	{ r2 = min(r17,r2) }
	{ r26 = sub(r2,r27) }
	{ call	fn00009764; r1 = mpyi(r26,r25) }
	{ r1 = r16; r2 = add(r27,r18); r5:r4 = combine(r17,r25) }
	{ r2 = mpyi(r2,r20) }
	{ if (!cmp.eq(r3.new,00000000)) jump:t	00012014; r3 = memw(r29+92); r1 += add(r2,r22) }

l00011FF8:
	{ memw(r29) = r0; r0 = r24; r3:r2 = combine(r26,r20) }
	{ call	avgpool_aligned_hvx }
	{ jump	0001201C }
0001200C                                     02 54 1A F5             .T..
00012010 00 40 78 70                                     .@xp            
...
l0001201C:
	...
	{ if (cmp.eq(r19.new,00000001)) jump:nt	00011F44; r19 = add(r19,FFFFFFFF); r21 = add(r21,r26) }
...
l0001205C:
	{ r21:r20 = memd(r29+128); r19:r18 = memd(r29+136) }
...
biasadd_8p8to32_execute proc
	...
	{  }
	{ memd(r29+112) = r23:r22; r18 = 00000000 }
	...
	{ r1 = 00000066; r3 = add(badva,0000002C) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	000121C8; r2 = memw(r17+4) }

l00012130:
	{ r1 = 00000067; r3 = add(badva,00000018) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	000121C8; r2 = memw(r17) }

l00012144:
	{ r1 = 00000068; r3 = add(badva,00000004) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	000121C8; r2 = memw(r17+8) }
...
l0001216C:
	{ memw(r29) = r4; r1 = 0000006A; r3 = add(badva,00000023) }
	{ jump	000121C8 }

l00012180:
	{ r3 = memd(r29+84); r2 = memd(r29+80); r4 = add(badva,00000027) }
	{ r2 = mpyi(r20,r2) }
	{ r2 = memw(r29+76); r5 = mpyi(r2,r3) }
	{ memw(r29) = r2; r2 = memd(r29+92); r3 = 00000002; r5 = mpyi(r5,r24) }
	{ call	fn00012560; r17 = asl(r5,00000002) }
	{ r1 = 0000006E; r0 = clrbit(r21,0000001E); r3 = add(badva,00000015) }
	{ if (!cmp.gtu(r17,r2.new)) jump:t	000121D8; r2 = memw(r19+20) }

l000121C8:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00012470 }
000121D4             01 40 7B 70                             .@{p        

l000121D8:
	{ r7 = memd(r29+84); r3 = memd(r29+80) }
	...
	{ call	fn00009624 }
	{  }
	{ r1:r0 = combine(r19,r27) }
	{ call	fn00009614; r17 = max(r2,r23) }
	...
	{ r1 = 0000008C; r15:r14 = convert_sf2df(r21); r4 = add(badva,00000023) }
	{ r13:r12 = convert_sf2df(r2) }
	{ memd(r29+24) = r7:r6; r20 = r0 }
	{ memd(r29+8) = r13:r12; memd(r29+16) = r9:r8 }
	{ memd(r29) = r15:r14; call	logmsg_function }
	{ r9:r8 = convert_sf2df(r19); r7:r6 = convert_sf2df(r24) }
	{ r1 = 0000008D }
	{ memd(r29+16) = r7:r6; r13:r12 = convert_sf2df(r27); r4 = add(badva,00000015) }
	{ memd(r29) = r13:r12; memd(r29+8) = r9:r8 }
	{ call	logmsg_function }
	{ r12 = memw(r29+68); r9:r8 = convert_sf2df(r22); r7:r6 = convert_sf2df(r20) }
	{ r3 = memd(r29+40); r5 = memd(r29+72); r4 = add(badva,00000017) }
...
l000123F0:
	{ r19 = memw(r29+88); r24 = r25; r27 = r16 }
...
l00012400:
	...
	{  }
	{  }
	{ r27 = add(r27,FFFFFFFF); call	fn00009624; r0 += sfmpy(r22,r3) }
	{  }
	{  }
...
l00012444:
	{ if (!cmp.eq(r23.new,r2)) jump:t	000123F0; r23 = add(r23,00000001) }

l0001244C:
	{ memb(r29) = r2.new; r2 = memw(r29+76); r4 = add(badva,0000000A) }
...
biasadd_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000035) }
	{ r17 = r0; r16 = r1; r1 = 000000B3 }
	{ call	logmsg_function }
	{ memw(r29) = r17 }
	{ if (cmp.eq(r2.new,0000000C)) jump:t	000124CC; r2 = memw(r17+16) }

l000124B0:
	{ r1 = 000000B4; r3 = add(badva,00000026) }
...
l000124C0:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
000124C8                         A2 C0 91 91                     ....    

l000124CC:
	{ if (!p0.new) r1 = 000000B5; if (!p0.new) jump:nt	000124FC; p0 = cmp.eq(r2,00000006) }

l000124D4:
	{ r2 = memw(r17+4); r4 = 00000000; loop0(000124E0,00000006) }
	{ r3 = r2 }
	{ if (!cmp.eq(r5.new,00000000)) jump:t	0001250C; r5 = memw(r3) }

l000124EC:
	{ memw(r29) = r4; r1 = 000000B8; r3 = add(badva,00000016) }
	{ jump	000124B8 }

l000124FC:
	{ jump	000124C0; r3 = add(badva,0000002D) }
00012508                         00 80 00 7F                     ....    

l0001250C:
	{ r4 = r4; r3 = add(r3,00000004) }
	{ jump	00012520; r4 = 00000000 }
00012514             82 40 02 B0                             .@..        

l00012518:
	{ if (cmp.gtu(r4.new,0000000A)) jump:nt	00012544; r4 = add(r4,00000001) }

l00012520:
	{ if (!cmp.eq(r3.new,00000001)) jump:t	00012518; r3 = memw(r2) }

l00012524:
	{ if (!cmp.eq(r3.new,00000001)) jump:t	00012518 }

l0001252C:
	{ memw(r29) = r4; r1 = 000000BD; r3 = add(badva,0000002C) }
	{ jump	000124B8 }
0001253C                                     05 45 00 00             .E..
00012540 84 57 49 6A                                     .WIj            
...
l0001256C:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,00000034) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
;;     00012560 (in logmsg_function)
;;     00012560 (in fn00012560)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000001C) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
check_execute proc
	{ allocframe(00000018); memd(r29+496) = r17:r16; r4 = add(badva,0000002C) }
	{ r1 = 00000036; r17:r16 = combine(r0,r1) }
	{ memd(r29+8) = r19:r18; r3 = memw(r17+4); r2 = r16 }
	{ r18 = memw(r3) }
	{ memw(r29) = r17; r19 = memw(r3+4); call	logmsg_function }
	{ r4 = memw(r18); r1 = 00000038; r3 = add(badva,0000001C) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012640; r2 = memw(r19) }

l000125F0:
	{ r4 = memw(r18+4); r1 = 00000039; r3 = add(badva,0000002B) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012640; r2 = memw(r19+4) }

l00012604:
	{ r4 = memw(r18+8); r1 = 0000003A; r3 = add(badva,00000039) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012640; r2 = memw(r19+8) }

l00012618:
	{ r4 = memw(r18+12); r1 = 0000003B; r3 = add(badva,00000006) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012640; r2 = memw(r19+12) }

l0001262C:
	{ r4 = memw(r18+24); r1 = 0000003C; r3 = add(badva,00000013) }
	{ if (cmp.eq(r2.new,r4)) jump:t	00012648; r2 = memw(r19+24) }
...
l00012648:
	{ r1 = memw(r19+16); r0 = memw(r18+16); r2 = r4 }

l00012650:
	{ if (p0.new) memw(r29) = r17; if (p0.new) jump:nt	00012670; p0 = cmp.eq(r0,00000000) }

l00012658:
	{ r2 = r16; r1 = 0000003E; r3 = add(badva,00000002) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00012688 }

l00012670:
	{ r2 = r16; r1 = 00000040; r4 = add(badva,00000038) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
check_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000031) }
	{ r17 = r0; r16 = r1; r1 = 00000046 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	000126D8; r2 = memw(r17+16); r1 = 00000047 }

l000126BC:
	{ r3 = add(badva,00000020) }
	{ r2 = r16; call	errlog_function }

l000126C8:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
000126D0 01 49 00 78 A2 40 91 91                         .I.x.@..        

l000126D8:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	000126F0 }

l000126E0:
	{ jump	000126C8; r3 = add(badva,00000012) }
000126E8                         04 45 00 00 84 4E 49 6A         .E...NIj
...
l00012718:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000012) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     0001270C (in logmsg_function)
;;     00012720 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000036) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
close_execute_f proc
	...
	{ if (p0) jump:nt	000127B0; r21 = lsr(r5,00000002) }

l000127A8:
	{ r24 = memw(r2) }
	{ r4 = add(badva,00000037) }
...
l000127B8:
	{ r1 = 00000061 }
	{ memw(r29) = r17; call	logmsg_function }
	{ r4 = memw(r19); r1 = 00000064; r3 = add(badva,00000009) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	0001286C; r2 = memw(r18) }

l000127E0:
	{ r4 = memw(r19+4); r1 = 00000065; r3 = add(badva,00000015) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	0001286C; r2 = memw(r18+4) }

l000127F8:
	{ r4 = memw(r19+8); r1 = 00000066; r3 = add(badva,00000020) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	0001286C; r2 = memw(r18+8) }

l00012810:
	{ r4 = memw(r19+12); r1 = 00000067; r3 = add(badva,0000002A) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	0001286C; r2 = memw(r18+12) }

l00012828:
	{ r4 = memw(r19+24); r1 = 00000068; r3 = add(badva,00000034) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012874; r2 = memw(r18+24); r25 = 00000000; p0 = cmp.eq(r21,00000000) }
...
l000128C0:
	{  }
	{  }
	{ if (p0.new) memw(r29) = r17; if (!p0.new) r1 = 0000007C; if (!p0.new) jump:nt	00012930; p0 = sfcmp.gt(r26,r3) }

l000128D8:
	{ r5 = memd(r29+68); r4 = memd(r29+64); r9:r8 = convert_sf2df(r2); r7:r6 = convert_sf2df(r3) }
	{ r1 = 0000007A; r13:r12 = convert_sf2df(r26); r3 = add(badva,00000023) }
...
0001292C                                     06 45 00 00             .E..

l00012930:
	{ r4 = add(badva,00000038) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
close_check_f proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000021) }
	{ r17 = r0; r16 = r1; r1 = 000000F6 }
	{ call	logmsg_function }
	{ memw(r29) = r17 }
	{ if (cmp.gtu(r2.new,00000002)) jump:t	000129A0; r2 = memw(r17+16); r1 = 000000F7 }
...
l00012990:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00012998                         01 5F 00 78 83 40 00 78         ._.x.@.x

l000129A0:
	{ if (cmp.gtu(r3.new,r2)) jump:t	000129B8 }

l000129A8:
	{ jump	00012990; r3 = add(badva,00000009) }
000129B0 21 5F 00 78 A2 40 91 91                         !_.x.@..        

l000129B8:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	000129D0 }

l000129C0:
	{ jump	00012990; r3 = add(badva,00000007) }
000129C8                         05 45 00 00 04 42 49 6A         .E...BIj
...
close_execute_i32 proc
	{ jump	fn00012D9C; r2 = add(badva,0000001C) }

;; close_check: 000129F4
close_check proc
	{ jump	close_check__merged; r2 = 00000000 }
...
close_check__merged proc
	{ allocframe(00000020); p0 = cmp.eq(r2,00000001); r4 = add(badva,00000014) }
	{ r6 = 00000006; r5 = 000000ED; r7 = add(badva,00000029) }
	{ memd(r29+16) = r19:r18; memd(r29+24) = r17:r16; r16 = r1; r8 = 00000002 }
	{  }
	{ if (!p0) r4 = add(r7,00000000) }
	{ memb(r29+2) = r19.new; r17 = r0; r19 = p0 }
	{ memw(r29) = r17; r18 = mux(p0,r6,r8) }
	{ if (cmp.eq(r2.new,r18)) jump:t	00012A78; r2 = memw(r17+16) }

l00012A5C:
	{ r0 = memd(r29+8); r2 = r16; r3 = add(badva,00000015) }
	{ if (!p0.new) r1 = 000000EE; if (p0.new) r1 = 00000101; jump	00012AA0; p0 = r0 }
00012A74             40 C0 9D 91                             @...        

l00012A78:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00012ABC; r2 = memw(r17+20); p1 = r0 }

l00012A88:
	{ if (!p1) r1 = 000000EF; if (p1) r1 = 00000102 }
	{ r3 = add(badva,00000033) }
	{ r2 = r16 }
	{ call	errlog_function }
...
00012AB0 F8 FF FF 59 0C C1 00 5C 01 45 00 00             ...Y...\.E..    

l00012ABC:
	{ r1 = 000000F0; r3 = 00000002; r4 = add(badva,00000014) }
	{ jump	00012ADC }
00012ACC                                     FA 44 00 00             .D..
00012AD0 04 47 49 6A 43 40 00 78 61 E0 00 78             .GIjC@.xa..x    
...
close_execute_q_u8 proc
	...
	{ memd(r29+72) = r25:r24 }
	{ memd(r29+96) = r19:r18; r19 = 00000000 }
	...
	{  }
	{ memd(r29+64) = r27:r26; r21 = memw(r2) }
	{  }
	{ r20 = memw(r2+12); call	fn00009614 }
	{ memw(r29+60) = r0; r1:r0 = combine(r19,r18); call	fn00009610 }
	{ r4 = add(badva,0000000F) }
	{ r1 = 000000D0 }
	{ memw(r29+56) = r0; r26 = memw(r21+16) }
	{ r19 = memw(r20+24); r27 = memw(r20+16) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r4 = memw(r21); r1 = 000000D1; r3 = add(badva,00000001) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012C24; r2 = memw(r20) }

l00012BA8:
	{ r4 = memw(r21+4); r1 = 000000D2; r3 = add(badva,0000000D) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012C24; r2 = memw(r20+4) }

l00012BC0:
	{ r4 = memw(r21+8); r1 = 000000D3; r3 = add(badva,00000018) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012C24; r2 = memw(r20+8) }

l00012BD8:
	{ r4 = memw(r21+12); r1 = 000000D4; r3 = add(badva,00000022) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012C24; r2 = memw(r20+12) }

l00012BF0:
	{ r4 = memw(r21+24); r1 = 000000D5; r3 = add(badva,0000002C) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	00012C28; r2 = memw(r20+24); p0 = cmp.gt(r19,00000000) }

l00012C0C:
	{ memw(r29+48) = r24; memw(r29+44) = r25 }
	{ memw(r29+52) = r16; jump	00012C40; if (!p0) jump:nt	00012D18 }
00012C20 02 40 70 70                                     .@pp            
...
00012C34             13 40 79 70                             .@yp        

l00012C38:
	{ if (!cmp.gt(r21,r19.new)) jump:nt	00012D1C }

l00012C40:
	{ r16 = memb(r27); r19 = memb(r26); r20 = r22 }
	{  }
	{ r2 = memd(r29+60); r4 = memd(r29+56); r1 = r18 }
	{  }
	{ r20 += sfmpy(r2,r3) }
	{  }
	{ call	fn00009614 }
	...
	{ if (p0.new) memw(r29+32) = r19; if (!p0.new) r21 = add(r21,00000001); if (!p0.new) jump:nt	00012C38; p0 = dfcmp.gt(r1:r0,r3:r2) }
...
l00012C9C:
	...
	{ memd(r29+24) = r5:r4; r2 = memd(r29+48); r4 = add(badva,00000004) }
	{ r9:r8 = convert_sf2df(r2) }
	{ memd(r29) = r13:r12; memd(r29+16) = r7:r6 }
	{ memd(r29+8) = r9:r8 }
	{ call	logmsg_function }
	{ r9:r8 = convert_sf2df(r20); r7:r6 = convert_sf2df(r24) }
	{ r1 = 000000E2 }
	{ memd(r29+16) = r7:r6; memw(r29+4) = r25; r4 = add(badva,0000000C) }
	{ memw(r29) = r21; memd(r29+8) = r9:r8 }
	{ call	logmsg_function }
	{ r2 = r16; r1 = 000000E3; r3 = add(badva,00000008) }
	{ jump	00012C28 }
00012D18                         F6 44 00 00                     .D..    

l00012D1C:
	{ r1 = 000000E7; r3 = 00000002; r4 = add(badva,00000002) }
...
close_check_q proc
	{ jump	close_check__merged; r2 = 00000001 }
...
;;     00012DBC (in fn00012D9C)
;;     00012DBC (in fn00012D9C)
;;     00012E7C (in fn00012E34)
...
l00012D5C:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,00000021) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
;;     00012D50 (in logmsg_function)
;;     00012E64 (in fn00012E34)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000009) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
close_execute proc
	{ allocframe(00000020); memd(r29+496) = r17:r16; r4 = add(badva,00000038) }

;; fn00012D9C: 00012D9C
;;   Called from:
;;     000129E8 (in close_execute_i32)
;;     00012AF0 (in close_execute_u8)
;;     00012D94 (in close_execute)
fn00012D9C proc
	{ allocframe(00000020); memd(r29+496) = r17:r16 }
	...
	{ r20 = memw(r5+4) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r4 = memw(r19); r1 = 0000003D; r3 = add(badva,00000009) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	fn00012E34; r2 = memw(r20) }

;; fn00012DDC: 00012DDC
;;   Called from:
;;     00012DCC (in fn00012D9C)
;;     00012DD0 (in fn00012D9C)
fn00012DDC proc
	{ r4 = memw(r19+4); r1 = 0000003E; r3 = add(badva,00000019) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	fn00012E34; r2 = memw(r20+4) }

l00012DF0:
	{ r4 = memw(r19+8); r1 = 0000003F; r3 = add(badva,00000028) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	fn00012E34; r2 = memw(r20+8) }

l00012E04:
	{ r4 = memw(r19+12); r1 = 00000040; r3 = add(badva,00000036) }
	{ if (!cmp.eq(r2.new,r4)) jump:t	fn00012E34; r2 = memw(r20+12) }

l00012E1C:
	{ r4 = memw(r19+24); r1 = 00000041; r3 = add(badva,00000000) }
	{ if (cmp.eq(r2.new,r4)) jump:t	00012E3C; r2 = memw(r20+24) }

;; fn00012E34: 00012E34
;;   Called from:
;;     00012DCC (in fn00012D9C)
;;     00012DD0 (in fn00012D9C)
;;     00012DF0 (in fn00012DDC)
;;     00012E04 (in fn00012DDC)
;;     00012E1C (in fn00012DDC)
;;     00012E34 (in fn00012DDC)
;;     00012E3C (in fn00012DDC)
fn00012E34 proc
	{ memw(r29) = r4; memw(r29+4) = r2 }
	{ r2 = memw(r20+16); r1 = memw(r19+16); r0 = r16; r3 = r4 }

l00012E3C:
	{ r2 = memw(r20+16); r1 = memw(r19+16); r0 = r16 }

l00012E44:
	{ callr	r18 }
	{ r1 = 00000045; if (p0.new) jump:nt	00012E70; p0 = cmp.eq(r0,00000000) }

l00012E54:
	{ r2 = r16; r1 = 00000043; r3 = add(badva,00000038) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00012E84 }

l00012E70:
	{ memw(r29) = r17; r4 = add(badva,00000034) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
l00012EC0:
	{ r2 = r4 }
	{ r18 = 00000000; r22 = 00000000; if (!p0) jump:nt	00012F74; r2 = maxu(r18,r2) }

l00012EC8:
	{ r18 = 00000000; r22 = 00000000; if (!p0) jump:nt	00012F74 }
...
l00012EFC:
	{ jump	00012EC8; r18 = maxu(r18,r4) }
00012F04             34 40 14 B0                             4@..        

l00012F08:
	{ if (!cmp.gtu(r16,r22.new)) jump:nt	00012F7C; r22 = add(r22,00000001); r19 = add(r19,00000001) }
...
l00012F18:
	...
	{ if (p0.new) memw(r29+12) = r24; if (p0.new) r1 = 000000A2; if (!p0.new) jump:nt	00012F08; p0 = dfcmp.gt(r1:r0,r3:r2) }
...
l00012FA8:
	...
	{ r3 = abs(r3) }
	{ nop; r0 = maxu(r0,r3) }
	{ r21 = -00000001; r0 = -00000001; jump	0001303C; if (!p0) jump:nt	00012FDC }
...
concat_execute_asm proc
	{ jump	fn00013178; r2 = add(badva,0000002C) }
...
concat_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r2 = memw(r17+16); r3 = 0000002B; r1 = 00000124 }
	{ r4 = add(r2,FFFFFFFF) }
	{  }
	{ r5 = r4 }
	{ r3 = lsr(r3,00000001) }
	{ r5 -= mpyi(r3,00000003) }
	{ r2 = memw(r17+28); r5 = memw(r17+24); r3 = add(badva,0000000F) }
...
concat_execute_ref proc
	{ jump	fn00013178; r2 = add(badva,00000010) }
...
;;     00013170 (in concat_execute)
fn00013178 proc
	{ allocframe(000000A8); memd(r29+472) = r23:r22 }
	{ r23 = r0 }
	{ memd(r29+152) = r19:r18; r4 = memw(r23+16) }
	{ memd(r29+120) = r27:r26; r27 = memw(r23+4); r18 = add(r4,FFFFFFFF) }
	{  }
	{ memd(r29+160) = r17:r16; r5 = memw(r23+8); r17 = r1 }
	{ memd(r29+128) = r25:r24; r0 = memw(r27+4); r25 = r2 }
	{ r2 = r17; r1 = 000000E5; r4 = add(badva,0000001C) }
	...
	{ r2 = memw(r19+16) }
	{ if (!cmp.eq(r2.new,00000006)) jump:t	fn00013304; r2 = memw(r2) }

;; fn00013214: 00013214
;;   Called from:
;;     00013204 (in fn00013178)
;;     00013208 (in fn00013178)
fn00013214 proc
	{ memw(r29+24) = r24; r24 = 00000000 }
	{ if (!cmp.gtu(r2.new,r18)) jump:t	00013320; r2 = 00000003 }
...
l0001322C:
	{ memw(r26+12) = FFFFFF81; r6 = memw(r29+28); r2 = 00000000 }
	{  }
	{ memw(r26+4) = FFFFFF81; memw(r26+8) = 00000001; r3 = add(r29,00000030) }
	{ memw(r6+8) = 00000001; memw(r26) = 00000001; r21 = add(r3,00000014) }
	{  }
	{ memw(r6+4) = 00000001; memw(r6) = 00000001; r16 = add(r29,00000054) }
	{ memw(r6+12) = FFFFFF81 }
	{ r4 = memw(r26+16) }
	...
	{ r2 = r17; r1 = 00000112; r4 = add(badva,00000034) }
	{ memw(r29) = r23; call	logmsg_function }
...
l000132E8:
	...
	{ dealloc_return }
00013300 E3 44 00 00                                     .D..            

;; fn00013304: 00013304
;;   Called from:
;;     00013204 (in fn00013178)
;;     00013208 (in fn00013178)
;;     000132D0 (in fn00013214)
;;     0001337C (in fn00013214)
;;     00013438 (in fn00013214)
fn00013304 proc
	{ r1 = 000000E6; r3 = add(badva,0000001D) }
	{ r2 = r17 }
...
l00013314:
	{ r24 = FFFFFFFF }
	{ jump	000132E8 }
0001331C                                     12 40 00 7C             .@.|

l00013320:
	{ r3 = memd(r29+40); r2 = memd(r29+44); r24 = add(r27,00000004) }
...
l00013358:
	{ r3 = memw(r29+44) }
	{ if (cmp.eq(r2.new,r3)) jump:t	0001337C; r2 = memw(r25+8) }

l00013368:
	{ r1 = 000000E9; r3 = add(badva,00000004) }
...
l0001337C:
	{ if (cmp.eq(r3.new,r2)) jump:t	00013398; r3 = memw(r29+40) }

l00013388:
	{ r1 = 000000EC; jump	00013378; r3 = add(badva,0000003D) }
00013394             02 C0 99 91                             ....        

l00013398:
	{ if (cmp.eq(r3.new,r2)) jump:t	000133B4; r3 = memw(r29+36) }

l000133A4:
	{ r1 = 000000EF; jump	00013378; r3 = add(badva,0000003B) }
000133B0 00 40 75 70                                     .@up            

l000133B4:
	{ r2 = memw(r16++#4); r23 = add(r23,00000001); r17 = add(r27,00000008) }
	{ r2 = memw(r2+16) }
	...
	{ if (!p0) r23 = memw(r29+16); if (!p0) r24 = 00000000; if (p0) jump:nt	00013358; r18 += mpyi(r3,r2) }

l00013414:
	{ r17 = memd(r29+20); r5 = memd(r29+24); r1 = 000000F6 }
	{ r25 = memw(r29+12) }
	{ if (!cmp.gtu(r18,r2.new)) jump:t	0001322C; r2 = memw(r5+20) }

l0001342C:
	{ jump	00013314; r3 = add(badva,0000000E) }

;; concat_execute_slice_ref: 00013434
concat_execute_slice_ref proc
	{ allocframe(00000048); r0 = 00000000 }
	{ r2 = memw(r1+12); r4 = memw(r1+8) }
	{ memd(r29+64) = r17:r16; r16 = memw(r1) }
	{ memd(r29+40) = r23:r22 }
	{ memw(r29+4) = r1; r3 = memw(r16+16) }
	{  }
	{ r23 = memw(r1+4); r22 = memw(r1+16) }
	...
	{ if (!p0.new) r26 = add(r24,00000000); if (p0.new) jump:nt	000135CC; p0 = cmp.gtu(r2,r9) }

l00013480:
	{ r2 = memw(r16+8); r3 = 0000002B }
	{  }
	{ r2 = memw(r2); r16 = 00000000 }
...
l000134A8:
	...
	{ if (!p0.new) jump:t	000135BC; p0 = cmp.eq(r3,-00000001) }
...
l000134C0:
	...
	{ call	fn000097C0 }
	{  }
	{ p0 = cmp.eq(r19,00000000) }
	{  }
	{ if (!p0) r2 = add(r27,00000000); if (p0) jump:nt	000135C0 }
...
l000135A0:
	...
	{ memb(r8) = r7 }
	{ if (cmp.gtu(r7.new,r6)) jump:t	00013578; r7 = memw(r17) }
...
;;     000131FC (in fn00013178)
;;     000131FC (in fn00013178)
;;     000132E0 (in fn00013214)
logmsg_function proc
	{ allocframe(00000008); r3 = 00000002 }
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function; r5 = memw(r2+16) }

l00013600:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000002C) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }

;; errlog_function: 00013618
;;   Called from:
;;     00013138 (in concat_check)
;;     00013310 (in fn00013304)
;;     000135F4 (in logmsg_function)
;;     00013608 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000010) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
concat_execute_slice_asm proc
	...
	{ if (!p0.new) r25 = add(r16,00000004); if (!p0.new) r27 = 00000000; if (p0.new) jump:nt	00013770; p0 = cmp.gtu(r2,r11) }

l00013690:
	{ r3 = memw(r17+8); r2 = 0000002B }
	{  }
	{ r7 = memw(r3) }
...
000136D4             9D 04 04 48 00 7C 37 04 01 40 00 78     ...H.|7..@.x
000136E0 33 04 22 04 33 00 22 00 37 C2 84 EB 20 57 03 EB 3.".3.".7... W..
000136F0 92 EF FE 5B 16 40 60 70 93 01 92 02 94 03 95 00 ...[.@`p........
00013700 02 C2 03 ED 12 C5 02 ED 07 C4 F2 F3 00 C7 04 F5 ................
00013710 00 C0 95 A6 52 3C E1 50 20 42 17 EB 7C EF FE 5B ....R<.P B..|..[
00013720 E6 7F 5F 78 00 40 70 04 32 3C 03 48 27 40 80 8B .._x.@p.2<.H'@..
00013730 00 54 15 F5 85 C0 9D 91 02 D6 42 EB 04 43 42 EB .T........B..CB.
00013740 91 41 11 B0 92 03 73 54 24 40 84 8B 00 D2 9D A1 .A....sT$@......
00013750 04 C4 A6 D5 66 79 01 5A 04 C0 E4 70             ....fy.Z...p    
...
hexagon_nn_const_ctor proc
	...
	{ if (!cmp.eq(r18.new,00000000)) jump:t	000137F0; r18 = r0 }

l000137D4:
	{ r2 = r16; r1 = 00000054; r3 = add(badva,00000028) }
	{ r17 = 00000000; call	errlog_function }
	{ jump	00013828 }
000137EC                                     0A 7E FE 5B             .~.[

l000137F0:
	{  }
	{ r17 = 00000000; r2 = 00000000 }
	{ r2 = add(r18,0000001C); if (!p0.new) jump:nt	00013818; p0 = cmp.eq(r0,00000000) }

l00013800:
	{ r2 = r16; r1 = 00000058; r3 = add(badva,0000000B) }
	{ call	errlog_function }
	{ jump	00013828 }
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000029) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
const_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000003E) }
	{ r17 = r0; r16 = r1; r1 = 00000036 }
	{ call	logmsg_function }
	{ memw(r29) = r17 }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	000138A8; r2 = memw(r17+4) }

l0001388C:
	{ r3 = 00000000; r1 = 00000038; r4 = add(badva,0000002D) }
...
l00013894:
	...
	{ r0 = FFFFFFFF }
	{ dealloc_return; r17:r16 = memd(r29+8) }
000138A4             42 40 91 91                             B@..        

l000138A8:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	000138C0 }

l000138B0:
	{ r3 = 00000000; r1 = 0000003B; r4 = add(badva,0000001E) }
	{ jump	00013894 }
000138BC                                     01 48 00 78             .H.x

l000138C0:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	000138E0; r2 = memw(r2) }

l000138CC:
	{ r3 = 00000000; r1 = 0000003E; r4 = add(badva,0000001D) }
	{ jump	00013894 }
000138D8                         D3 44 00 00 84 54 49 6A         .D...TIj
...
logmsg_function proc
	{ allocframe(+00000008) }
	{ if (cmp.gtu(r3,r5.new)) jump:t	conv2d_execute_hvx; r5 = memw(r2+16) }

l0001396C:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,00000035) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }

;; conv2d_execute_hvx: 00013980
;;   Called from:
;;     00013960 (in logmsg_function)
...
l00013A08:
	{ if (p0.new) r2 = memw(r29-128); if (p0.new) jump:nt	00013A34; p0 = cmp.eq(r13,00000004) }
...
l00013A28:
	...
	{ jump	00013A40; r0 += add(r2,FFFFFFFF) }
...
l00013A40:
	{ memw(r29+120) = r3; memw(r29+112) = r1 }

l00013A44:
	{ if (p0.new) r2 = memw(r29+124); if (p0.new) r1 = add(r24,00000000); if (p0.new) jump:nt	00013A80; p0 = cmp.eq(r13,00000004) }

l00013A50:
	{ memw(r29+96) = r0; if (!p0.new) r26 = add(r24,00000000); if (p0.new) jump:nt	00013A74; p0 = cmp.eq(r13,00000002) }

l00013A5C:
	{ r1 = memd(r29+84); r0 = 00000000 }
	{ if (!p0) r1:r0 = combine(r26,r17); if (!p0.new) jump:nt	00013A98; p0 = r1 }
...
l00013A74:
	...
	{ jump	00013A90; r0 += add(r17,FFFFFFFF) }
...
l00013A98:
	{ r3 = memw(r23+16); r2 = memw(r19+16); r19 = 00000000 }
...
l00013AA0:
	...
	{  }
	{ call	fn00009624 }
	{ r5 = memw(r27+28); r22 = memw(r29+100); r4 = add(badva,00000020) }
	{  }
	{ r1 = 00000207 }
	{ memw(r29+4) = r5 }
	{ memw(r29) = r27; memw(r29+64) = r7 }
	{ call	logmsg_function }
	{ r21 = memd(r29+104); r19 = memd(r29+108); r4 = add(badva,00000012) }
	{  }
	{ memw(r29+12) = r19; r5 = memw(r29+128) }
	{ memw(r29+4) = r17; memw(r29+8) = r5; r1 = 00000208 }
	{ memw(r29) = r21; call	logmsg_function }
	{ r5 = memw(r29+120); r25 = memw(r29+92); r4 = add(badva,00000003) }
	{  }
	{ memw(r29+12) = r25 }
	...
	{ r18 = memw(r29+116) }
	{ memw(r29) = r18; call	logmsg_function }
	{ r5 = memw(r29+112); r1 = 0000020A; r4 = add(badva,0000002B) }
	{  }
	{ memw(r29) = r26; memw(r29+4) = r5 }
	{ call	logmsg_function }
	{ r4 = add(badva,0000001F) }
	{ r1 = 0000020B }
	{ memb(r29) = r5.new; r5 = memb(r27+32); call	logmsg_function }
	{ memw(r29) = r21; memw(r29+12) = r18; r4 = add(badva,00000015) }
	{  }
	{ memw(r29+4) = r24; r23 = memw(r29+96) }
	{ memw(r29+8) = r23; r1 = 0000020C }
	{ call	logmsg_function }
	{ r9 = r17; r1 = 0000020D; r3 = add(badva,00000010) }
	{ if (!cmp.eq(r12.new,r25)) jump:t	00013CF4; r12 = r19; r2 = mpyi(r21,r18) }

l00013C58:
	{ r2 = mpyi(r2,r23) }
	{ r2 = mpyi(r2,r24) }
	{ if (!cmp.gtu(r4.new,r5)) jump:t	00013C88; r4 = asl(r2,00000002) }

l00013C6C:
	{ memb(r29+2) = r2.new; r2 = memw(r27+28); r3 = add(badva,00000021) }
	{ memw(r29) = r5; memw(r29+4) = r4; jump	00013CF0; r2 = r14 }
00013C84             21 42 01 78                             !B.x        

l00013C88:
	{ r2 = memd(r29+88); r19 = r23 }
	{ r23 = r24; r3 = add(badva,0000002B) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00013CF0; r2 = memw(r2) }

l00013CA4:
	{ r2 = memw(r29+88); r1 = 00000212; r3 = add(badva,00000028) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00013CF0; r2 = memw(r2+12) }

l00013CBC:
	{ r2 = memd(r29+80); r5 = 00000004; r3 = add(badva,00000021) }
	{ r1 = 00000213 }
	{ if (cmp.gtu(r5,r2.new)) jump:t	00013CF0; r2 = memw(r2+20) }

l00013CD4:
	{ r2 = memw(r29+76); r1 = 00000214; r3 = add(badva,00000017) }
	{  }
	{ if (cmp.gtu(r2.new,00000006)) jump:t	00013D04; r2 = memw(r2+20) }
...
00013CFC                                     01 44 00 78             .D.x
00013D00 1B 7F 26 76                                     ..&v            

l00013D04:
	{ memw(r7+12) = r18; r2 = memd(r29+120) }
	{ memw(r7) = r21; memw(r7+8) = r19; r15 = 00000000; r3 = mpyi(r2,r20) }
	{  }
	{ memw(r7+4) = r23; r17 = r22; r3 = mpyi(r3,r12) }
	...
	{ r21 = and(r3,FFFFFF80) }
	{ call	fn000095F0 }
	{ r4 = add(badva,00000010) }
	{ memw(r29+4) = r26 }
	{ memw(r29) = r22; r16 = r26; r1 = 0000023B }
	{ call	logmsg_function }
	{ r4 = add(badva,0000000B) }
	{ r1 = 0000023C }
	...
	{ r20 = memd(r29+72); r19 = memd(r29+84); if (!p0.new) jump:nt	00013FE8; p0 = cmp.gt(r2,00000001) }
...
l00013F48:
	{ memb(r29+6) = r2.new; r2 = memw(r29+36) }
	...
	{ if (!cmp.eq(r17.new,00000001)) jump:t	00013F48; r17 = add(r17,FFFFFFFF); r20 = addasl(r20,r2,00000002) }

l00013FE8:
	{ memb(r29+3) = r2.new; r2 = memw(r29+116); r4 = add(badva,00000002) }
...
conv2d_check_ref proc
	{ allocframe(00000030); memd(r29+496) = r17:r16; r4 = add(badva,00000007) }
	{ r17 = r0; r16 = r1; r1 = 00000271 }
	{ call	logmsg_function }
	{ memw(r29) = r17; memd(r29+32) = r19:r18 }
	{ if (cmp.eq(r2.new,0000000E)) jump:t	00014070; r2 = memw(r17+16) }

l00014058:
	{ r2 = memw(r17+28); r1 = 00000272; r3 = add(badva,00000037) }
	{ memw(r29) = r2; jump	00014080 }
0001406C                                     61 4E 01 78             aN.x

l00014070:
	{ if (cmp.eq(r2.new,00000006)) jump:t	00014098; r2 = memw(r17+20) }

l0001407C:
	{ r3 = add(badva,0000002F) }
...
00014090 81 4E 01 78 23 40 91 91                         .N.x#@..        

l00014098:
	{ if (!cmp.eq(r3.new,00000000)) jump:t	000140B0 }

l000140A0:
	{ jump	00014088; r3 = add(badva,00000022) }
000140A8                         42 C0 91 91 16 40 02 10         B....@..

l000140B0:
	{ if (!p0.new) r4 = 00000000; if (p0.new) r1 = 00000275 }
	{ loop0(000140BC,00000007) }
	{ if (!cmp.eq(r5.new,00000000)) jump:t	000140E8; r5 = memw(r3) }

l000140C8:
	{ memw(r29) = r4; r1 = 00000278; r3 = add(badva,00000013) }
	{ jump	00014080 }
000140D8                         BA 44 00 00 03 59 49 6A         .D...YIj
000140E0 D4 FF FF 59 00 80 00 7F                         ...Y....        

l000140E8:
	{ r4 = r4; r3 = add(r3,00000004) }
	{ jump	000140FC; r4 = 00000000 }
000140F0 82 40 02 B0                                     .@..            

l000140F4:
	{ if (cmp.gtu(r4.new,00000004)) jump:nt	00014120; r4 = add(r4,00000001) }

l000140FC:
	{ if (!cmp.eq(r3.new,00000001)) jump:t	000140F4; r3 = memw(r2) }

l00014100:
	{ if (!cmp.eq(r3.new,00000001)) jump:t	000140F4 }

l00014108:
	{ memw(r29) = r4; r1 = 0000027D; r3 = add(badva,00000021) }
	{ jump	00014080 }
00014118                         BA 44 00 00 04 4E 49 6A         .D...NIj

l00014120:
	{  }
	{ r1 = 00000282 }
	{ memw(r29) = r17; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00014194; r2 = memw(r17+16); r19:r18 = combine(00000000,00000000) }

l00014140:
	{ r2 = memw(r17+4); r1 = 0000026B; r4 = add(badva,0000001F) }
	{ r2 = memw(r13+r18) }
	...
	{  }
	{ memw(r29+4) = r6; memw(r29+20) = r2 }
	{ memw(r29+12) = r8; memw(r29+16) = r9 }
	{ memw(r29) = r19; call	logmsg_function }
	{ r2 = memw(r17+16); r18 = add(r18,00000004) }
	{ if (cmp.gtu(r2,r19.new)) jump:t	00014140; r19 = add(r19,00000001) }
...
conv2d_ctor proc
	{ allocframe(00000028); memd(r29+488) = r19:r18; r6 = add(badva,0000002C) }
...
l000142E0:
	...
	{ if (!p0) r1:r0 = combine(r25,r17); if (!p0.new) jump:nt	00014310; p0 = r1 }

l000142F0:
	{ jump	00014308 }

l000142F4:
	{ jump	00014308; r0 += add(r17,FFFFFFFF) }
...
l00014310:
	{ r3 = memd(r29+60); r2 = memd(r29+64); r26 = 00000000 }
...
l00014318:
	...
	{  }
	{ memw(r29+56) = r0; r18 = r26 }
	{ r26 = r2; r1:r0 = combine(r26,r2); call	fn00009610 }
	{ r4 = memd(r29+56); r2 = 00000000 }
	{ r3 = 4F000000 }
	{  }
	{ r0 = r24 }
	{  }
	...
	{  }
	{ call	fn00009624 }
	{ r20 = memw(r29+32); r26 = memw(r29+72); r4 = add(badva,00000020) }
	{  }
	{ r1 = 00000174 }
	{ memb(r29+1) = r5.new; r5 = memw(r26+28) }
	{ memw(r29) = r26 }
	{ r4 = add(badva,00000012) }
	{ memw(r29+12) = r19 }
	{ memw(r29+4) = r17; r1 = 00000175 }
	{ memw(r29+8) = r27; r23 = memw(r29+28) }
	{ memw(r29) = r23; call	logmsg_function }
	{ memw(r29+4) = r21; r2 = memd(r29+80); r4 = add(badva,00000003) }
	{ r1 = 00000176 }
	{ memw(r29+12) = r2 }
	...
	{ memw(r29) = r5; call	logmsg_function }
	{ r4 = add(badva,0000002F) }
	{ r1 = 00000178 }
	{ r26 = memw(r29+48); r5 = memb(r26+32) }
	{ memw(r29) = r5; call	logmsg_function }
	{  }
	{ memw(r29) = r23; memw(r29+12) = r16 }
	{ memw(r29+4) = r26; r20 = memw(r29+76); r4 = add(badva,00000019) }
	{ memw(r29+8) = r20; r1 = 00000179 }
	{ call	logmsg_function }
	{ r1 = 0000017A; r7:r6 = combine(r20,r23); r3 = add(badva,0000001C) }
	{ if (!cmp.eq(r2.new,r19)) jump:t	00014568; r2 = memw(r29+80); r5 = r26 }

l000144CC:
	{ r3 = memw(r29+52) }
	{ r4 = memw(r3+20); r2 = mpyi(r2,r20) }
	{ r2 = mpyi(r2,r26) }
	{ if (!cmp.gtu(r2.new,r4)) jump:t	00014500; r2 = asl(r2,00000002) }

l000144E8:
	{ memw(r29+4) = r2; r1 = 0000017C; r3 = add(badva,00000039) }
	{ memw(r29) = r4; r2 = memd(r29+32) }
	{ jump	00014564 }
000144FC                                     08 43 05 F5             .C..

l00014500:
	{ r4 = memw(r29+40); r1 = 0000017E }
	{ r3 = add(badva,0000002F) }
	{ if (!cmp.eq(r4.new,00000002)) jump:t	00014564; r4 = memw(r4) }

l0001451C:
	{ r3 = memw(r29+40) }
	{ r4 = memw(r3+12); r3 = add(badva,00000028) }
	{ if (!p0.new) jump:nt	00014560; p0 = cmp.eq(r4,00000002) }

l00014530:
	{ r3 = memd(r29+36); r5 = 00000004; r1 = 00000180 }
	{ r4 = memw(r3+20); r3 = add(badva,00000021) }
	{ if (p0.new) jump:nt	00014560; p0 = cmp.gtu(r5,r4) }

l00014548:
	{ r3 = memw(r29+24); r1 = 00000181 }
	{ r4 = memw(r3+20); r3 = add(badva,00000017) }
	{ if (p0.new) jump:t	00014570; p0 = cmp.gtu(r4,-00000001) }
...
l0001469C:
	{ if (!cmp.gtu(r17,r5.new)) jump:nt	00014728; r5 = add(r3,r13) }

l000146A4:
	{ if (p0.new) r11 = add(r6,00000000); if (!p0.new) jump:t	00014724; p0 = tstbit(r5,00000000) }
...
l000146B8:
	...
	{ if (!cmp.gtu(r27,r5.new)) jump:nt	0001471C; r5 = add(r8,r0) }
...
l00014724:
	{ if (!cmp.eq(r3.new,r21)) jump:t	000146A4; r3 = add(r3,00000001); r6 = add(r6,r4) }

l00014728:
	{ if (!cmp.eq(r3.new,r21)) jump:t	000146A4; r3 = add(r3,00000001) }
...
l00014774:
	...
	{ r3 = add(r3,00000001) }
	{ memw(r29+24) = r3; if (!p0.new) jump:nt	0001460C; p0 = cmp.eq(r3,-00000001) }

l00014784:
	{ memw(r29+12) = r16; r3 = 00000002; r4 = add(badva,00000031) }
...
l000147D0:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,0000000C) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
;;     000147C4 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000034) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
;; fn0001480C: 0001480C
;;   Called from:
;;     000143BC (in conv2d_execute_ref)
fn0001480C proc
	{ r2 = 00000017 }
...
flatten_execute proc
	{ allocframe(+00000028); r4 = add(badva,00000032) }
	{ r3 = memw(r0+8); r2 = memw(r0+4) }
	...
	{ r2 = memw(r17+24) }
	{ if (!cmp.gtu(r2,r3.new)) jump:t	0001487C; r3 = memw(r18+20) }

l00014864:
	{ r2 = r16; r1 = 00000039; r3 = add(badva,0000003C) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	000148BC }
00014878                         02 56 15 ED                     .V..    

l0001487C:
	{ memw(r18+8) = 00000001; memw(r18) = 00000001 }
	...
	{ r2 = r16; r1 = 0000003F; r4 = add(badva,0000000A) }
...
flatten_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000001) }
	{ r17 = r0; r16 = r1; r1 = 0000005C }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r1 = 0000005D; r3 = add(badva,00000024) }
	{ if (cmp.gtu(r2.new,00000004)) jump:t	00014940; r2 = memw(r17+16) }

l000148FC:
	{ r1 = 0000005E; r3 = add(badva,0000001F) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00014940; r2 = memw(r17+20) }

l00014910:
	{ r2 = memw(r17+4); r1 = 0000005F; r3 = add(badva,00000016) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00014940; r2 = memw(r2) }

l00014928:
	{ r2 = memw(r17+8); r1 = 00000060; r3 = add(badva,00000009) }
	{ if (!cmp.eq(r2.new,00000000)) jump:t	00014950; r2 = memw(r2) }

l00014940:
	{ r2 = r16 }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001494C                                     A1 44 00 00             .D..

l00014950:
	{ r2 = r16; r1 = 00000061; r4 = add(badva,0000002D) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
qflatten_execute proc
	{ allocframe(00000028); memd(r29+496) = r17:r16; r4 = add(badva,00000015) }
	{ r17:r16 = combine(r0,r1) }
	...
	{ r2 = memw(r18+24) }
	{ if (!cmp.gtu(r2,r3.new)) jump:t	000149D0; r3 = memw(r19+20) }

l000149B4:
	{ r2 = r16; r1 = 0000004E; r3 = add(badva,0000002C) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00014A70 }
000149CC                                     02 57 16 ED             .W..
...
l000149D0:
	...
	{ memw(r2+12) = r1; memw(r2+8) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	00014A28; r6 = memw(r2+20) }
...
l00014A28:
	...
	{ memw(r2+12) = r1; memw(r2+8) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	00014A58; r6 = memw(r2+20) }

l00014A4C:
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
	{ r2 = memw(r18+24); r4 = add(badva,00000016) }
...
qflatten_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000002E) }
	{ r17 = r0; r16 = r1; r1 = 00000067 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	00014AC8; r2 = memw(r17+16); r1 = 00000068 }
...
l00014AB8:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00014AC0 21 4D 00 78 A2 40 91 91                         !M.x.@..        

l00014AC8:
	{ if (cmp.eq(r2.new,00000006)) jump:t	00014AE0 }

l00014AD0:
	{ jump	00014AB8; r3 = add(badva,0000000B) }
00014AD8                         99 44 00 00 84 47 49 6A         .D...GIj
...
l00014B08:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000000D) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
input_execute proc
	{ allocframe(00000020); memd(r29+496) = r17:r16; r4 = add(badva,0000003F) }
	{ r16 = r1; r1 = 00000031 }
	{ memd(r29+8) = r21:r20; memd(r29+16) = r19:r18; r18 = r0; r2 = r16 }
	{ memw(r29) = r18; call	logmsg_function }
	{ r2 = memw(r16+28) }
	{ if (!cmp.eq(r3.new,r2)) jump:t	00014BB4; r3 = memw(r18+20) }
...
l00014B90:
	...
	{ r5 = memw(r2+20) }
	{ if (!cmp.gtu(r5,r6.new)) jump:t	00014BCC; r6 = memw(r3+20) }

l00014BA8:
	{ jump	00014BC4; r1 = 0000003B; r3 = add(badva,00000012) }
00014BB0 9A 44 00 00                                     .D..            

l00014BB4:
	{ r1 = 00000036; r3 = add(badva,00000038) }
	{ r17 = -00000001; r2 = r16; call	errlog_function }

l00014BC4:
	{ jump	00014C28 }
00014BC8                         04 54 84 3A                     .T.:    
...
l00014BCC:
	...
	{ if (cmp.gtu(r2,r21.new)) jump:t	00014B90; r21 = add(r21,00000001) }

l00014C10:
	{ memw(r29) = r2; r1 = 00000040; r4 = add(badva,00000034) }
...
input_check proc
	...
	{ r17 = r0; r16 = r1; r1 = 00000046 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00014C98; r2 = memw(r17+20) }

l00014C5C:
	{ r3 = memw(r17+8) }
	{ if (!cmp.gtu(r2,r4.new)) jump:nt	00014C9C; r4 = add(r4,00000001); r3 = add(r3,00000004) }

l00014C64:
	{ if (!cmp.gtu(r2,r4.new)) jump:nt	00014C9C; r4 = add(r4,00000001) }

l00014C70:
	{ if (!cmp.eq(r5.new,00000001)) jump:t	00014C64 }

l00014C78:
	{ r1 = 0000004A; r4 = add(badva,0000002A) }
	{ memw(r29) = r4; call	errlog_function }
	{ r0 = FFFFFFFF }
	{ dealloc_return; r17:r16 = memd(r29+8) }
00014C94             96 44 00 00                             .D..        

l00014C98:
	{ r2 = r16; r1 = 0000004D; r4 = add(badva,00000024) }
...
matmul_execute_asm proc
	{ jump	fn00015000; r2 = add(badva,00000024) }

;; matmul_check_ref: 00014D0C
matmul_check_ref proc
	{ allocframe(00000048); memd(r29+496) = r17:r16; r4 = add(badva,0000001D) }
	{ r17 = r0; r16 = r1; r1 = 0000010F }
	{  }
	{ memd(r29+48) = r21:r20; memd(r29+56) = r19:r18 }
	{ memd(r29+32) = r25:r24; memd(r29+40) = r23:r22 }
	{ memw(r29) = r17; call	logmsg_function }
	{ r1 = 00000110; r3 = add(badva,00000009) }
	{ if (!cmp.eq(r2.new,0000000D)) jump:t	00014EE4; r2 = memw(r17+16) }

l00014D50:
	{ r1 = 00000111; r3 = add(badva,0000000B) }
	{ if (!cmp.eq(r2.new,00000007)) jump:t	00014EE4; r2 = memw(r17+20) }

l00014D64:
	{ r1 = 00000112; r3 = add(badva,0000000E) }
	{ if (cmp.eq(r4.new,00000001)) jump:nt	00014EE4; r4 = memw(r17+4) }

l00014D78:
	{ r2 = memw(r17+8); r1 = 00000113; r3 = add(badva,00000006) }
	{ r5 = 00000000; if (p0.new) jump:nt	00014EE4; p0 = cmp.eq(r2,00000001); loop0(00014D90,00000006) }

l00014D90:
	{ if (cmp.eq(r3.new,00000000)) jump:nt	00014DA8; r3 = memw(r4) }

l00014D9C:
	{ r5 = r5; r4 = add(r4,00000004) }
	{ jump	00014DC4; r4 = 00000000 }
00014DA4             9A 44 00 00                             .D..        

l00014DA8:
	{ memw(r29) = r5; r1 = 00000116; r3 = add(badva,00000023) }
	{ jump	00014EE0 }
00014DB8                         82 40 02 B0                     .@..    

l00014DBC:
	{ if (cmp.gtu(r4.new,00000004)) jump:nt	00014DE8; r4 = add(r4,00000001) }

l00014DC4:
	{ if (!cmp.eq(r3.new,00000001)) jump:t	00014DBC; r3 = memw(r2) }

l00014DC8:
	{ if (!cmp.eq(r3.new,00000001)) jump:t	00014DBC }

l00014DD0:
	{ memw(r29) = r4; r1 = 0000011B; r3 = add(badva,00000009) }
	{ jump	00014EE0 }
00014DE0 9A 44 00 00 04 42 49 6A                         .D...BIj        

l00014DE8:
	{  }
	{ r1 = 00000120 }
	{ memw(r29) = r17; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00014E60; r2 = memw(r17+16); r19:r18 = combine(00000000,00000000) }

l00014E08:
	{ r2 = memw(r17+4); r1 = 00000109; r4 = add(badva,00000023) }
	{ r2 = memw(r13+r18) }
	{ r6 = memw(r2+24); r5 = memw(r2+16) }
	{ r8 = memw(r2+4); r7 = memw(r2+12) }
	{  }
	{ r12 = memw(r2); r9 = memw(r2+8) }
	{ memw(r29+20) = r6; memw(r29+24) = r5 }
	{ memw(r29+12) = r9; memw(r29+16) = r7 }
	{ memw(r29+4) = r12; memw(r29+8) = r8 }
	{ memw(r29) = r19; call	logmsg_function }
	{ r2 = memw(r17+16); r18 = add(r18,00000004) }
	{ if (cmp.gtu(r2,r19.new)) jump:t	00014E08; r19 = add(r19,00000001) }
...
l00014E60:
	...
	{ r5 = and(r2,FFFFFFF0) }
	{ r0 = 00000080; r22 = and(r4,FFFFFFE0) }
	{  }
	{ call	fn00009554; r1 = mpyi(r23,r22) }
	{ memw(r17+40) = r0; r1 = 0000013A; r3 = add(badva,00000017) }
...
matmul_ctor proc
	{ allocframe(00000028); memd(r29+488) = r19:r18; r6 = add(badva,00000002) }
	{ r19:r18 = combine(r0,r4) }
	{ memd(r29+16) = r21:r20; memd(r29+32) = r17:r16; r21:r20 = combine(r2,r5); r17:r16 = combine(r3,r1) }
	{ r1 = 00000152 }
	{ r4 = r6 }
...
matmul_execute_ref proc
	{ jump	fn00015000; r2 = add(badva,00000034) }
...
fn00015000 proc
	...
	{ r1:r0 = combine(r0,r2); call	fn00009610 }
	{  }
	{ r16 = memd(r29+68); r20 = r16 }
	{  }
	{ call	fn00009624 }
	{ r4 = add(badva,0000002C) }
	{ r1 = 00000072 }
	{  }
	{ memw(r29) = r20; call	fn000153DC }
	{ memw(r29+20) = r26; memw(r29+28) = r23; r4 = add(badva,00000028) }
	{ r2 = memw(r29+64); r1 = 00000075 }
	{ memw(r29+24) = r25; r25 = memw(r29+56) }
	{ memw(r29+16) = r25; r17 = memw(r29+60) }
	{  }
	{ memw(r29) = r24; memw(r29+12) = r2 }
	...
	{ memw(r29+4) = r18; memw(r29+8) = r17 }
	{ call	logmsg_function }
	{ p0 = cmp.eq(r18,00000001); r1 = 00000078; r3 = add(badva,0000001F) }
	{ if (p0) r1 = 00000079; if (!p0) jump:nt	fn00015240 }

;; fn000151A0: 000151A0
;;   Called from:
;;     00015198 (in fn00015000)
;;     00015198 (in fn00015000)
fn000151A0 proc
	{ if (p0.new) r1 = 0000007A; p0 = cmp.eq(r26,00000001); r3 = add(badva,00000007) }
	{ if (!p0) jump:nt	fn00015240 }

l000151B4:
	{ if (p0.new) r1 = 0000007B; p0 = cmp.eq(r24,00000001); r3 = add(badva,00000005) }
	{ if (!p0) jump:nt	fn00015240 }

l000151C8:
	{ p0 = cmp.eq(r25,00000001); r2 = mpyi(r24,r17); r3 = add(badva,00000031) }
	{ if (!p0) jump:nt	fn00015240 }

l000151DC:
	{ r3 = memw(r29+52); r1 = 0000007C }
	{ r2 = mpyi(r2,r18) }
	{ r4 = memw(r3+20); r3 = add(badva,00000028) }
	{ r2 = mpyi(r2,r23) }
	{ if (cmp.gtu(r2.new,r4)) jump:t	00015244; r2 = asl(r2,00000002) }

l00015204:
	{ r3 = memd(r29+48); r5 = 00000004; r1 = 0000007D }
	{ r4 = memw(r3+20); p2 = cmp.gt(r19,FFFFFFFF); r3 = add(badva,00000015) }
	{ p3 = cmp.gt(r21,FFFFFFFF); if (p0.new) jump:nt	fn00015240; p0 = cmp.gtu(r5,r4) }

l00015224:
	{ r3 = memd(r29+44); r5 = 00000000; r1 = 0000007E }
	{ r4 = memw(r3+20); r3 = add(badva,00000003) }
	{ if (!p0) r1:r0 = combine(r16,r20); if (p0.new) jump:t	00015250; p0 = cmp.gtu(r4,-00000001) }

;; fn00015240: 00015240
;;   Called from:
;;     00015198 (in fn00015000)
;;     00015198 (in fn00015000)
;;     000151B0 (in fn000151A0)
;;     000151C4 (in fn000151A0)
;;     000151D8 (in fn000151A0)
;;     00015228 (in fn000151A0)
;;     00015240 (in fn000151A0)
;;     00015244 (in fn000151A0)
;;     000152C0 (in fn000151A0)
fn00015240 proc
	{ r2 = r16; call	errlog_function }
...
;; matmul_ref: 000152E0
matmul_ref proc
	{ allocframe(+00000038); r4 = add(badva,00000011) }
...
l0001533C:
	{ if (p0.new) jump:nt	000153B0; p0 = cmp.eq(r14,00000000); r5 = mpyi(r2,r22) }

l00015340:
	{ if (p0.new) jump:nt	000153B0; p0 = cmp.eq(r14,00000000) }
...
l00015360:
	{  }
	{ r9 = memb(r3); p0 = cmp.gtu(r19,00000001); r8 = add(r3,r22) }
...
l000153A0:
	...
	{ if (!cmp.eq(r2.new,r20)) jump:t	00015340; r2 = add(r2,00000001) }

l000153B0:
	{ if (!cmp.eq(r2.new,r20)) jump:t	00015340 }
...
;;     00015164 (in fn00015000)
;;     00015164 (in fn00015000)
;;     00015184 (in fn00015000)
;;     00015184 (in fn00015000)
;;     000152BC (in fn000151A0)
...
;; fn000153DC: 000153DC
;;   Called from:
;;     00015124 (in fn00015000)
;;     00015124 (in fn00015000)
fn000153DC proc
	{ if (cmp.gtu(r3,r5.new)) jump:t	fn000153FC; r5 = memw(r2+16) }

l000153E8:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,00000031) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }

;; fn000153FC: 000153FC
;;   Called from:
;;     000153DC (in fn000153DC)
;;     000153DC (in logmsg_function)
fn000153FC proc
	{ nop }
...
;;     00015240 (in fn00015240)
;;     000153FC (in fn000153FC)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000015) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l00015470:
	{ memw(r29+4) = r23; memw(r29+20) = r20; r4 = add(badva,00000025) }
	{ r24 = and(r25,FFFFFFF0) }
	{ memw(r29+28) = r16; memw(r29+16) = r19 }
	{ memw(r29+8) = 00000001; memw(r29+12) = r24 }
	{ memw(r29) = 00000001; call	logmsg_function }
	{ r2 = r25; r23 = FFFFFE00; if (p0.new) jump:nt	000155C0; p0 = cmp.eq(r14,00000001) }
...
l000154C0:
	{ r2 = memw(r21+8); r4 = r18; r1:r0 = combine(r19,r17) }
	{ memw(r29) = r24; r2 = add(r2,r16); r3 = r20; call	gemvmpybbw_asm }
	{ r18 = add(r18,00000080); r16 = add(r16,r23); r25 = add(r25,FFFFFFE0) }
	{ if (cmp.gtu(r22,r27.new)) jump:t	000154C0; r27 = add(r27,00000020) }

l000154F0:
	{ memw(r29+12) = r20; r21 = memw(r4+16); r4 = add(badva,00000001) }
	{  }
	{ memw(r29) = r24 }
...
l0001551C:
	{ if (p0.new) jump:nt	00015590; p0 = cmp.eq(r14,00000000); r5 = mpyi(r2,r22) }

l00015520:
	{ if (p0.new) jump:nt	00015590; p0 = cmp.eq(r14,00000000) }
...
l00015540:
	{  }
	{ r9 = memb(r3); p0 = cmp.gtu(r23,00000001); r8 = add(r3,r22) }
...
l00015580:
	{ memw(r5++#4) = r6; nop; r3 = add(r3,00000001) }
	{ if (!cmp.eq(r2.new,r24)) jump:t	00015520; r2 = add(r2,00000001) }

l00015590:
	{ if (!cmp.eq(r2.new,r24)) jump:t	00015520 }
...
l000155A0:
	{ r1 = 000000BA }
	{ call	logmsg_function }
	{ r4 = add(badva,00000002) }
	{ r1 = 000000EB }
	{ memw(r29+28) = r16; call	logmsg_function }

l000155C0:
	{ r1 = 000000EE; r3 = 00000002; r4 = add(badva,0000003B) }
...
maxpool_execute_asm proc
	{ jump	fn00015768; r2 = add(badva,00000014) }
...
maxpool_check proc
	...
	{ call	logmsg_function }
	{ memw(r29) = r17; memd(r29+32) = r19:r18 }
	{ if (cmp.eq(r2.new,0000000A)) jump:t	00015658; r2 = memw(r17+16); r1 = 0000016D }

l0001563C:
	{ r3 = add(badva,00000034) }
...
00015650 21 6E 00 78 A2 40 91 91                         !n.x.@..        

l00015658:
	{ if (cmp.eq(r2.new,00000006)) jump:t	00015674 }

l00015660:
	{ r1 = 0000016E; jump	00015648; r3 = add(badva,00000027) }
0001566C                                     81 44 00 00             .D..
00015670 04 56 49 6A                                     .VIj            

l00015674:
	{  }
	{ memw(r29) = r17 }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	000156FC; r2 = memw(r17+16); r19:r18 = combine(00000000,00000000) }

l00015690:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	000156B0; r2 = memw(r5+r18) }

l0001569C:
	{ memw(r29) = r19; r1 = 00000174; r3 = add(badva,0000003D) }
	{ jump	00015640 }
000156AC                                     82 44 00 00             .D..

l000156B0:
	{ r6 = memw(r2+4); r5 = memw(r2); r4 = add(badva,0000002F) }
	...
	{ memw(r29) = r19; call	logmsg_function }
	{ r2 = memw(r17+16); r18 = add(r18,00000004) }
	{ if (cmp.gtu(r2,r19.new)) jump:t	00015690; r19 = add(r19,00000001) }

l000156F8:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00015730 }

l000156FC:
	{ r3 = memw(r17+8); jump	00015710; r4 = 00000000 }

l00015700:
	{ r3 = memw(r17+8) }
00015704             83 40 03 B0                             .@..        

l00015708:
	{ if (!cmp.gtu(r2,r4.new)) jump:nt	00015734; r4 = add(r4,00000001) }

l00015710:
	{ if (!cmp.eq(r5.new,00000001)) jump:t	00015708; r5 = memw(r3) }

l00015714:
	{ if (!cmp.eq(r5.new,00000001)) jump:t	00015708 }

l0001571C:
	{ memw(r29) = r4; r1 = 0000017A; r3 = add(badva,00000013) }
	{ jump	00015640 }
0001572C                                     80 44 00 00             .D..
...
maxpool_execute_ref proc
	{ jump	fn00015768; r2 = add(badva,00000010) }
...
fn00015768 proc
	...
	{ r7 = memw(r4+8) }
	{ memw(r29+20) = r7; memw(r29+16) = r6 }
	{ memw(r29+28) = r0; if (!p0) jump:nt	fn000157D4 }

;; fn000157D0: 000157D0
;;   Called from:
;;     000157C8 (in fn00015768)
;;     000157C8 (in fn00015768)
fn000157D0 proc
	{ jump	000157F8; r0 = r2 }
...
;;     000157C8 (in fn00015768)
;;     000157C8 (in fn00015768)
;;     000157D0 (in fn000157D0)
fn000157D4 proc
	{ if (p0.new) r3 = memw(r26+8); if (p0.new) r2 = add(r1,r2); if (p0.new) jump:nt	000157F4; p0 = cmp.eq(r13,00000004) }

l000157E0:
	{ if (p0.new) r0 = add(r1,00000000); r19 = 00000000; if (!p0.new) jump:nt	00015800; p0 = cmp.eq(r13,00000002) }

l000157EC:
	{ jump	000157FC; r0 += add(r2,FFFFFFFF) }
...
l00015800:
	{ if (p0.new) r1 = add(r22,00000000); r2 = add(r22,r20); if (p0.new) jump:nt	00015830; p0 = cmp.eq(r13,00000004) }

l0001580C:
	{ if (!p0) r1:r0 = combine(r22,r22); if (p0.new) jump:nt	00015828; p0 = cmp.eq(r13,00000002) }

l00015814:
	{ r0 = memd(r29+28); r21 = 00000000 }
	{ if (!p0) r1:r0 = combine(r22,r20); if (!p0.new) jump:nt	00015840; p0 = r0 }

l00015824:
	{ jump	00015834 }

l00015828:
	{ jump	00015838; r0 += add(r20,FFFFFFFF) }
...
l00015848:
	...
	{ r1 = 00000137 }
	{ memw(r29) = r17; call	logmsg_function }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	000158B0; r2 = memw(r26) }

l00015898:
	{ if (!cmp.eq(r2.new,00000002)) jump:t	000158B0 }

l000158A0:
	{ if (!cmp.eq(r2.new,00000002)) jump:t	000158B0 }

l000158A8:
	{ if (cmp.eq(r2.new,00000002)) jump:t	000158CC }

l000158B0:
	{ r1 = 0000013C; r3 = add(badva,0000001F) }
	{ r2 = r16; call	errlog_function }
...
l000158CC:
	...
	{ r2 = mpyi(r2,r19) }
	{ if (!cmp.gtu(r3.new,r4)) jump:t	000158F0; r3 = mpyi(r2,r21) }

l000158E4:
	{ jump	000158C0; r3 = add(badva,00000003) }
000158EC                                     E1 67 00 78             .g.x

l000158F0:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0001590C; r2 = memb(r17+32) }

l000158FC:
	{ jump	000158C0; r3 = add(badva,00000039) }
00015904             02 44 1D B0 52 40 9D 91                 .D..R@..    
...
l0001590C:
	...
	{ memw(r4+12) = r7 }
	{ r2 = memw(r5+24) }
	{ if (cmp.gtu(r2,r6.new)) jump:t	00015978; r6 = memw(r4+20) }
...
l00015978:
	...
	{ memw(r5+12) = r7 }
	{ r2 = memw(r4+24) }
	{ if (cmp.gtu(r2,r6.new)) jump:t	000159B4; r6 = memw(r5+20) }

l000159A8:
	{ r1 = memw(r4+16); r2 = memw(r4+24); call	fn00009560 }
	{ r4 = add(badva,00000013) }
...
l00015A4C:
	{ if (p0.new) r0 = sub(r2,r26); if (p0.new) jump:nt	00015A64; p0 = cmp.eq(r10,00000004) }

l00015A54:
	{ if (p0.new) r0 = add(r17,00000000); r20 = 00000000; if (!p0.new) jump:nt	00015A70; p0 = cmp.eq(r10,00000002) }
...
l00015A70:
	{ if (p0.new) r1 = add(r22,00000000); r2 = add(r22,r23); if (p0.new) jump:nt	00015AA8; p0 = cmp.eq(r10,00000004) }

l00015A7C:
	{ if (!p0) r1:r0 = combine(r22,r22); if (p0.new) jump:nt	00015AA0; p0 = cmp.eq(r10,00000002) }
...
l00015AA0:
	{ jump	00015AB0; r0 += add(r23,FFFFFFFF) }
...
l00015AB0:
	{ memw(r29+68) = r0 }
	{ if (!cmp.gt(r2.new,00000000)) jump:nt	00015D30; r2 = memw(r29+12); r3 = sub(r25,r23) }

l00015AB8:
	{ if (!cmp.gt(r2.new,00000000)) jump:nt	00015D30; r2 = memw(r29+12) }
...
l00015B58:
	{ r2 = memw(r29+16) }
	{ if (!cmp.gt(r2,r6.new)) jump:t	00015D10; r6 = memw(r29+68) }
...
l00015BB8:
	...
	{  }
	{ if (p0.new) r9 = memw(r29+40); if (p0.new) r13 = memw(r29+88); if (!p0.new) jump:nt	00015B94; p0 = cmp.gt(r28,00000001) }
...
l00015BE8:
	...
	{ r2 = min(r0,r6) }
	{ p0 = cmp.gt(r24,00000000); r0 = add(r13,r19); if (!p0.new) jump:nt	00015CFC; r7 = mpyi(r13,r17) }
...
l00015CF8:
	{ if (cmp.eq(r13.new,r20)) jump:nt	00015BA0; r13 = add(r13,00000001); r1 = sub(r1,r17); r23 = add(r23,r17) }

l00015CFC:
	{ if (cmp.eq(r13.new,r20)) jump:nt	00015BA0; r13 = add(r13,00000001); r1 = sub(r1,r17) }
...
;;     00015884 (in fn000157D4)
;;     000159C0 (in fn000157D4)
logmsg_function proc
	{ allocframe(+00000008) }
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function; r5 = memw(r2+16) }

l00015D5C:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,0000003C) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
;;     000158B8 (in fn000157D4)
;;     00015D50 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000024) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l00015E04:
	{ if (p0.new) r0 = sub(r2,r27); if (p0.new) jump:nt	00015E18; p0 = cmp.eq(r11,00000004) }

l00015E0C:
	{ r0 = r18; r22 = 00000000; if (!p0.new) jump:nt	00015E24; p0 = cmp.eq(r11,00000002) }
...
l00015E24:
	{ nop; if (p0.new) jump:nt	00015E54; p0 = cmp.eq(r11,00000004) }

l00015E2C:
	{ if (p0.new) r1 = memw(r29+72); if (p0.new) jump:nt	00015E48; p0 = cmp.eq(r11,00000002) }

l00015E34:
	{ r1 = memd(r29+80); r0 = 00000000 }
	{ if (!p0.new) jump:nt	00015E68; p0 = r1 }
...
l00015E48:
	{ r0 = r1 }
	{ jump	00015E64; r0 += add(r21,FFFFFFFF) }
...
l00015E64:
	{ if (!cmp.gt(r2.new,00000001)) jump:nt	00016018; r2 = memw(r29+16); r3 = sub(r27,r17); r4 = add(r0,FFFFFFFF) }

l00015E68:
	{ if (!cmp.gt(r2.new,00000001)) jump:nt	00016018; r2 = memw(r29+16); r3 = sub(r27,r17) }
...
l00015F30:
	...
	{  }
	{ if (!cmp.gt(r3.new,00000001)) jump:nt	00015F1C; r3 = memw(r29+68) }
...
l00015F60:
	...
	{ if (p0) r5:r4 = combine(r17,r25); if (!p0) jump:nt	00015FDC; r1 += add(r7,r19) }

l00015FD0:
	{ call	maxpool_aligned_hvx }
	{ jump	00015FDC }
00015FD8                         C4 E6 01 5A                     ...Z    

l00015FDC:
	{ if (cmp.eq(r16.new,00000001)) jump:nt	00015F24; r16 = add(r16,FFFFFFFF); r22 = add(r22,r18); r24 = add(r24,r20) }
...
l00016018:
	{ r21:r20 = memd(r29+112); r19:r18 = memd(r29+120) }
...
min_execute proc
	{ r3 = 7F800000; r2 = add(badva,00000010) }
	{ r2 = memw(r2-144); jump	nn_reduction_float }
0001605C                                     00 C0 00 7F             ....

;; minmax_check: 00016060
minmax_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000002A) }
	{ r17 = r0; r16 = r1; r1 = 00000075 }
	{ memw(r29) = r17; r2 = r16; r0 = add(badva,0000003A) }
	{ call	logmsg_function }
	{ r1 = 00000076; r3 = add(badva,0000001F) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00016100; r2 = memw(r17+4) }

l0001609C:
	{ r1 = 00000077; r3 = add(badva,00000017) }
	{ if (cmp.eq(r4.new,00000000)) jump:nt	00016100; r4 = memw(r17+8) }

l000160B0:
	{ r1 = 00000078; r3 = add(badva,00000010) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00016100; r2 = memw(r2) }

l000160C4:
	{ r1 = 00000079; r3 = add(badva,00000009) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00016100; r2 = memw(r4) }

l000160D8:
	{ r1 = 0000007A; r3 = add(badva,00000003) }
	{ if (cmp.gtu(r2.new,00000006)) jump:t	00016100; r2 = memw(r17+16) }

l000160EC:
	{ r1 = 0000007B; r3 = add(badva,0000002F) }
	{ if (cmp.eq(r2.new,00000002)) jump:t	00016118; r2 = memw(r17+20) }

l00016100:
	{ r2 = r16; call	fn00016568; r0 = add(badva,00000032) }
	{ r17:r16 = memd(r29+8); r0 = -00000001 }
	{ dealloc_return }
00016114             5D 44 00 00                             ]D..        

l00016118:
	{ r2 = r16; r1 = 0000007C; r0 = add(badva,0000001A) }
	{ memw(r29) = r17; call	fn00016540; r4 = add(badva,00000002) }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
max_execute proc
	{ r3 = FF800000; r2 = add(badva,00000010) }
...
l00016238:
	{ r2 = r25; r1 = 000000BC; r0 = add(badva,00000011) }
	{ memw(r29+96) = r8; r27 = memw(r17+16); r4 = add(badva,00000020) }
	{ r26 = memw(r23+16); r20 = memw(r19+16) }
	{ memw(r29) = r24; call	logmsg_function }
	{ if (!cmp.gtu(r22,r2.new)) jump:t	0001629C; r2 = memw(r17+20); r1 = 000000BC }

l00016278:
	{ r2 = r25; r0 = add(badva,00000015) }
	{ r3 = add(badva,00000006) }

l00016288:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00016524 }
00016294             F5 00 B2 00 00 42 05 F2                 .....B..    
...
l000162C4:
	{ if (p0.new) jump:nt	000162CC; p0 = cmp.eq(r5,00000002) }

l000162C8:
	{ if (!p0.new) jump:nt	00016308; p0 = cmp.eq(r2,00000002) }

l000162CC:
	{ nop; if (p0.new) jump:nt	000162DC; p0 = cmp.eq(r6,-00000001) }

l000162D4:
	{ if (p0.new) jump:nt	000162DC; p0 = cmp.eq(r6,00000002) }

l000162D8:
	{ if (!p0.new) jump:nt	00016308; p0 = cmp.eq(r3,00000002) }

l000162DC:
	{ p0 = cmp.eq(r7,r9); if (p0.new) jump:nt	000162F0 }

l000162E4:
	{ if (p0.new) jump:nt	000162F0; p0 = cmp.eq(r7,00000002) }
...
l00016308:
	{ memw(r29+28) = r12; r1 = 000000BC; r0 = add(badva,00000001) }
	{ memw(r29+12) = r8; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(badva,00000034) }
	{ memw(r29+4) = r6; memw(r29+16) = r2; r2 = r25 }
	{ memw(r29) = r5; jump	00016288 }

l0001633C:
	{ memw(r29+44) = r16; r23 = memd(r29+112); r0 = add(badva,0000000D) }
	{ r19 = memw(r29+68); r1 = 000000BC; r4 = add(badva,0000003C) }
	{ memw(r29+40) = r23; r20 = memd(r29+88) }
	{ memw(r29+32) = r19; memw(r29+36) = r20 }
	{ memw(r29+28) = r12; memw(r29+52) = r24 }
	{ memw(r29+24) = r9; memw(r29+48) = r25 }
...
l00016438:
	{ if (cmp.gt(r2.new,00000000)) jump:t	00016450; r2 = memw(r29+112) }

l0001643C:
	{ if (cmp.gt(r2.new,00000000)) jump:t	00016450 }

l00016444:
	{ memw(r29+100) = r3; jump	000164BC }
0001644C                                     13 40 63 70             .@cp
...
l00016480:
	...
	{ if (!p0.new) jump:nt	00016480; p0 = cmp.eq(r30,00000001) }
...
l000164A4:
	{ r7 = memd(r29+104); r2 = memd(r29+108); r23 = add(r23,00000001) }
	{ r21 = addasl(r21,r2,00000002) }
	{ if (!cmp.eq(r2.new,r23)) jump:t	00016464; r2 = memw(r29+112); r19 = addasl(r19,r7,00000002) }
...
l000164C0:
	...
	{ r2 = memd(r29+88); r7 = memd(r29+92); r6 = addasl(r6,r2,00000002) }
	{ r5 = memd(r29+76); r4 = memd(r29+80); r3 = addasl(r3,r5,00000002) }
	{ if (!cmp.eq(r7.new,r2)) jump:t	0001643C; r7 = add(r7,00000001) }
...
l000164FC:
	{ memb(r29) = r2.new; r2 = memw(r29+52); r0 = add(badva,0000000D) }
	{ r2 = memw(r29+48); r1 = 000000BC; r4 = add(badva,00000028) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
logmsg_function proc
	{ allocframe(00000008); r3 = 00000002 }
	{ if (cmp.gtu(r3,r5.new)) jump:t	fn0001655C; r5 = memw(r2+16) }

;; fn00016540: 00016540
;;   Called from:
;;     00016124 (in minmax_check)
fn00016540 proc
	{ if (cmp.gtu(r3,r5.new)) jump:t	fn0001655C }
...
;; fn0001655C: 0001655C
;;   Called from:
;;     0001653C (in logmsg_function)
;;     00016540 (in fn00016540)
fn0001655C proc
	{ nop }
...
l00016610:
	...
	{ r12 = memw(r9++#4) }
	{ if (!cmp.gt(r12.new,00000006)) jump:t	00016634; r12 = add(r7,sub(0000007F,r12)) }
...
l00016634:
	{ if (p0.new) r18 = 00000001; p0 = cmp.eq(r12,00000000) }
...
l00016668:
	{ if (cmp.eq(r8.new,00000004)) jump:t	00016688; r8 = memb(r0+32); r13:r12 = combine(r10,r17) }
...
l00016688:
	{ if (!p0.new) r13:r12 = combine(r10,r17); p0 = cmp.eq(r14,00000000) }

l00016690:
	{ r9:r8 = combine(r11,r18); loop0(00016698,r14) }
	{ r14 = memw(r6++#4) }
	{ if (!cmp.gt(r14.new,00000006)) jump:t	000166B8; r14 = add(r7,sub(0000007F,r14)) }
...
l000166B8:
	{ if (p0.new) r8 = 00000000; p0 = cmp.eq(r14,00000000) }
...
l000166E8:
	...
	{ p1 = or(p1,p2) }
	{ if (p2.new) r13 = 00000001; if (!p2) r6 = add(r13,00000000); p2 = or(p1,p0) }
...
l00016728:
	...
	{ r8 = mpyi(r8,r17) }
	{ if (!cmp.gtu(r8.new,r9)) jump:t	00016770; r8 = asl(r8,00000002) }

l00016750:
	{ r1 = 000000C6; r0 = add(badva,00000003) }
	{ call	fn00016568; r3 = add(badva,0000002E) }
	{ r0 = FFFFFFFF; jump	000168E0 }
0001676C                                     00 40 00 78             .@.x

l00016770:
	{ memw(r4+24) = r8; memw(r4+12) = r6; p0 = cmp.gt(r17,00000000) }
...
l00016794:
	...
	{ p1 = cmp.eq(r4,00000001) }
	{ memw(r29+36) = r5; r23 = !cmp.eq(r15,00000001) }
	{ r3 = cmp.eq(r28,00000001) }
	{ memw(r29+40) = r2; memw(r29+20) = r4 }
	{ memw(r29+60) = r3 }
...
l000167E0:
	{ memw(r29+16) = r1; r2 = r1; p0 = cmp.gt(r4,00000000) }
...
l00016800:
	...
	{ if (cmp.gt(r2.new,00000000)) jump:t	00016820; r2 = memw(r29+60); r27 = 00000000 }

l00016808:
	{ if (cmp.gt(r2.new,00000000)) jump:t	00016820; r2 = memw(r29+60) }
...
l00016864:
	{ r1 = memw(r18); r18 = add(r18,00000004) }
	{ if (!cmp.eq(r25.new,00000001)) jump:t	00016864; r25 = add(r25,FFFFFFFF) }

l00016870:
	{ if (!cmp.eq(r22.new,r23)) jump:t	00016848; r22 = add(r22,00000001) }

l00016874:
	{ if (!cmp.eq(r22.new,r23)) jump:t	00016848 }

l0001687C:
	{ if (!cmp.eq(r27.new,r2)) jump:t	00016830; r27 = add(r27,00000001) }

l00016888:
	{ if (!cmp.eq(r3.new,r2)) jump:t	00016808; r3 = add(r3,00000001) }
...
l000168AC:
	{ r11 = memw(r29+12) }
	{ if (!cmp.eq(r17.new,r11)) jump:t	000167E0; r17 = add(r17,00000001) }
...
l000168D0:
	...
	{ r3 = add(r3,00000001) }
	{ memw(r29+36) = r3; r0 = -00000001; if (!p0.new) jump:nt	000167C0; p0 = cmp.eq(r3,-00000001) }
...
qsoftmax_execute_ref proc
	...
	{ r20 = memw(r18+8) }
	{  }
	{ memw(r29+28) = r1; r1 = r6 }
	{ memw(r29+36) = r24; memd(r29+56) = r27:r26 }
	{ memw(r29+48) = r7 }
	{ memw(r29+32) = r5; r26 = memw(r18+16) }
	{ r27 = memw(r19+16); call	fn00009614; r22 = mpyi(r2,r20) }
	{ r2 = r25; r1 = 0000004A; r4 = add(badva,00000035) }
	{ memw(r29) = r24; r21 = r0; call	logmsg_function }
	{ r5 = r19 }
	{ if (!cmp.gtu(r22,r2.new)) jump:t	000169C0; r2 = memw(r5+20) }

l000169A4:
	{ r2 = r25; r1 = 0000004B; r3 = add(badva,00000028) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00016C10 }
000169BC                                     C2 3C A3 00             .<..
...
l00016A2C:
	{ if (p0.new) memw(r29+44) = r22 }
	{ memb(r29+12) = r0.new; if (p0) jump:nt	00016A5C; r0 = p0 }

l00016A40:
	{ r0 = memw(r29+48) }
	{ if (p0.new) memw(r29+44) = r22; if (p0.new) r19 = 00000001; if (p0.new) jump:nt	00016AA0; p0 = r0 }

l00016A54:
	{ jump	00016B50 }
00016A58                         17 40 70 70                     .@pp    

l00016A5C:
	{ r25 = memb(r26); r19 = 00000001 }
	{  }
	{ r2 = r25 }
	{ r23 += sfmpy(r21,r3) }
...
l00016A70:
	...
	{  }
	{ call	fn00009604; r0 += sfmpy(r21,r2) }
	{ r23 = r0; r2 = add(r26,r19); if (p0.new) jump:nt	00016A40; p0 = cmp.eq(r9,-00000001) }

l00016A90:
	{ r19 = add(r19,00000001) }
	{ r2 = memb(r2); jump	00016A70 }
00016A9C                                     00 40 00 00             .@..
...
l00016AA4:
	...
	{ call	fn00009784 }
	{  }
	{ r2 = add(r26,r19); if (p0.new) jump:nt	00016AD8; p0 = cmp.eq(r9,-00000001) }

l00016AC8:
	{ r25 = memb(r2); r19 = add(r19,00000001) }
	{ jump	00016AA4 }
00016AD4             01 40 78 70                             .@xp        

l00016AD8:
	{ memw(r29+44) = r22; r0 = 00000000 }
	{ call	fn00009610 }
	{ r0 = memd(r29+48); r19 = 00000000; r24 = r0 }
	{ if (!p0.new) jump:nt	00016B54; p0 = r0 }
...
l00016B54:
	{ r2 = memd(r29+40); r22 = memd(r29+44); r27 = add(r27,r17) }
	{ if (!cmp.eq(r22.new,r2)) jump:t	00016A2C; r22 = add(r22,00000001) }

l00016B68:
	{ if (!p0.new) jump:nt	00016BCC; p0 = r0 }

l00016B70:
	{ r2 = memd(r29+16); r0 = 00000000; r1 = r18 }
	{ r16 = memw(r2+16); call	fn00009610 }
	{ r3 = memd(r29+40); r2 = 00000000 }
...
l00016BC8:
	{ r6 = memd(r29+32); r7 = memd(r29+28); r4 = add(badva,0000000E) }
...
qsoftmax_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000038) }
	{ r17 = r0; r16 = r1; r1 = 0000008B }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	00016C6C; r2 = memw(r17+16); r1 = 0000008C }

l00016C50:
	{ r3 = add(badva,00000029) }
	{ r2 = r16; call	errlog_function }

l00016C5C:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00016C64             A1 51 00 78 A2 40 91 91                 .Q.x.@..    

l00016C6C:
	{ if (cmp.eq(r2.new,00000006)) jump:t	00016C84 }

l00016C74:
	{ jump	00016C5C; r3 = add(badva,00000014) }
00016C7C                                     33 44 00 00             3D..
00016C80 04 4C 49 6A                                     .LIj            
...
l00016CAC:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000017) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     00016CA0 (in logmsg_function)
;;     00016CB4 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000003B) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
nop_execute proc
	{ allocframe(00000018); r2 = r1; r4 = add(badva,00000031) }
	{ memd(r29+8) = r19:r18; memd(r29+16) = r17:r16; r16 = r0; r1 = 00000031 }
	{ memw(r29) = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00016D68; r2 = memw(r16+20) }
...
l00016D20:
	...
	{ memw(r2+12) = r1; memw(r2+8) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	00016D5C; r6 = memw(r2+20) }
...
l00016D5C:
	{ if (cmp.gtu(r2,r18.new)) jump:t	00016D20; r18 = add(r18,00000001) }
...
nop_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r2 = memw(r17+20) }
	{ if (cmp.eq(r3.new,r2)) jump:t	00016DAC; r3 = memw(r17+16) }

l00016D9C:
	{ r2 = r16 }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00016DA8                         31 44 00 00                     1D..    

l00016DAC:
	{ r2 = r16; r1 = 0000003D; r4 = add(badva,00000024) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;; nop_ctor: 00016DC4
nop_ctor proc
	{ allocframe(00000028); memd(r29+488) = r19:r18; r6 = add(badva,0000000D) }
...
;; nop_dtor: 00016E1C
nop_dtor proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000024) }
...
logmsg_function proc
	{ allocframe(00000008); r3 = 00000002 }
	{ if (cmp.gtu(r3,r5.new)) jump:t	00016E6C; r5 = memw(r2+16) }
...
errlog_function proc
	{ allocframe(00000008); r3 = 00000000; r0 = add(badva,00000037) }
	{ r5 = add(r29,00000010); r1 = 0000003C; r4 = add(badva,0000003E) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
	{ r0 = memw(r0); r0 = memw(r0) }
	{ r0 = memw(r0); r0 = memw(r0) }
...
output_execute proc
	{ allocframe(00000020); memd(r29+496) = r17:r16; r4 = add(badva,00000036) }
	{ r16 = r1; r1 = 00000034 }
	{ memd(r29+8) = r21:r20; memd(r29+16) = r19:r18; r18 = r0; r2 = r16 }
	{ memw(r29) = r18; call	logmsg_function }
	{ r2 = memw(r16+32) }
	{ if (!cmp.eq(r3.new,r2)) jump:t	00016F08; r3 = memw(r18+16) }
...
l00016EE0:
	...
	{ r4 = memw(r3+20) }
	{ if (!cmp.gtu(r5.new,r4)) jump:t	00016F20; r5 = memw(r2+24) }

l00016EF8:
	{ memw(r29) = r19; r1 = 0000003A; r3 = add(badva,00000009) }
	{ jump	00016F10 }
00016F04             2E 44 00 00                             .D..        

l00016F08:
	{ r1 = 00000035; r3 = add(badva,0000002B) }

l00016F10:
	{ r17 = -00000001; r2 = r16; call	errlog_function }
	{ jump	00016F74 }
00016F1C                                     25 01 24 00             %.$.
...
l00016F20:
	...
	{ if (cmp.gtu(r2,r19.new)) jump:t	00016EE0; r19 = add(r19,00000001) }

l00016F5C:
	{ memw(r29) = r2; r1 = 00000041; r4 = add(badva,00000035) }
	{ r2 = r16; call	logmsg_function }
...
output_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	00016FE0; r2 = memw(r17+16) }

l00016FA8:
	{ r3 = memw(r17+4) }
	{ if (!cmp.gtu(r2,r4.new)) jump:nt	00016FE4; r4 = add(r4,00000001); r3 = add(r3,00000004) }

l00016FB0:
	{ if (!cmp.gtu(r2,r4.new)) jump:nt	00016FE4; r4 = add(r4,00000001) }

l00016FBC:
	{ if (!cmp.eq(r5.new,00000001)) jump:t	00016FB0 }

l00016FC4:
	{ r2 = r16; r1 = 0000004A; r3 = add(badva,0000002B) }
	{ call	errlog_function }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00016FDC                                     2A 44 00 00             *D..

l00016FE0:
	{ r2 = r16; r1 = 0000004C; r4 = add(badva,00000022) }
...
l0001700C:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000002F) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     00017000 (in logmsg_function)
;;     00017014 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000013) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
pprint_8_execute proc
	{ allocframe(+00000048); r4 = add(badva,0000002F) }
...
l000170D4:
	{ r26 = 00000000; r25 = r17 }

l000170DC:
	{ memb(r29+4) = r2.new; r2 = memb(r25++#1); r4 = add(badva,00000025) }
...
l000170E0:
	...
	{ if (!cmp.eq(r26.new,r18)) jump:t	000170E0; r26 = add(r26,00000001) }

l00017114:
	{ if (!cmp.eq(r24.new,r19)) jump:t	000170D4; r24 = add(r24,00000001) }

l0001711C:
	{ if (!cmp.eq(r23.new,r20)) jump:t	000170CC; r23 = add(r23,00000001) }

l00017120:
	{ if (!cmp.eq(r23.new,r20)) jump:t	000170CC }

l00017124:
	{ if (!cmp.eq(r22.new,r21)) jump:t	000170C4; r22 = add(r22,00000001) }
...
pprint_check proc
	...
	{ if (cmp.eq(r3.new,00000002)) jump:t	0001716C; r3 = memw(r0+16); r1 = 0000004E }
...
l00017164:
	{ if (cmp.eq(r3.new,00000000)) jump:nt	00017184; r3 = memw(r0+20); r1 = 0000004F }

l0001716C:
	{ if (cmp.eq(r3.new,00000000)) jump:nt	00017184 }

l00017174:
	{ jump	00017164; r3 = add(badva,00000031) }
0001717C                                     27 44 00 00             'D..
00017180 84 5A 49 6A                                     .ZIj            

l00017184:
	{ r1 = 00000050; r3 = 00000002 }
	{ call	logmsg_function }
	{ dealloc_return; r0 = 00000000 }

;; pprint_32_execute: 00017194
pprint_32_execute proc
	{ allocframe(+00000048); r4 = add(badva,0000002B) }
	{ r5 = memw(r0+28); r2 = memw(r0+4) }
...
l00017220:
	{ memb(r29+4) = r2.new; r2 = memw(r25++#4); r4 = add(badva,0000001C) }
...
l00017224:
	...
	{ memw(r29+8) = r24; memw(r29+12) = r26 }
	{ memw(r29) = r22; call	logmsg_function }
	{ if (!cmp.eq(r26.new,r18)) jump:t	00017224; r26 = add(r26,00000001) }

l00017258:
	{ if (!cmp.eq(r24.new,r19)) jump:t	00017218; r24 = add(r24,00000001) }

l00017260:
	{ if (!cmp.eq(r23.new,r20)) jump:t	00017210; r23 = add(r23,00000001) }

l00017264:
	{ if (!cmp.eq(r23.new,r20)) jump:t	00017210 }

l00017268:
	{ if (!cmp.eq(r22.new,r21)) jump:t	00017208; r22 = add(r22,00000001) }
...
l0001731C:
	{ r2 = memw(r25); r25 = add(r25,00000004); r4 = add(badva,0000000E) }

l00017320:
	{ r2 = memw(r25); r25 = add(r25,00000004); r4 = add(badva,0000000E) }
	{ r1:r0 = convert_sf2df(r2) }
	{ memw(r29+4) = r23; memw(r29+8) = r24 }
	{ memw(r29+12) = r26; memd(r29+16) = r1:r0; r1 = 0000004A }
	{ memw(r29) = r22; call	logmsg_function }
	{ if (!cmp.eq(r26.new,r18)) jump:t	00017320; r26 = add(r26,00000001) }

l0001735C:
	{ if (!cmp.eq(r24.new,r19)) jump:t	00017314; r24 = add(r24,00000001) }

l00017364:
	{ if (!cmp.eq(r23.new,r20)) jump:t	0001730C; r23 = add(r23,00000001) }

l00017368:
	{ if (!cmp.eq(r23.new,r20)) jump:t	0001730C }

l0001736C:
	{ if (!cmp.eq(r22.new,r21)) jump:t	00017304; r22 = add(r22,00000001) }
...
l0001739C:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,0000000B) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
;;     00017390 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000033) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
prefree_execute proc
	{ r2 = r1; r1 = 00000031; r3 = add(badva,00000025) }
...
prefree_check proc
	{ r2 = r1; r1 = 00000036; r3 = add(badva,00000021) }
	{ allocframe(+00000000); call	errlog_function }
	{ dealloc_return; r0 = -00000001 }
...
prefree_ctor proc
	{ allocframe(00000028); memd(r29+488) = r19:r18; r6 = add(badva,00000029) }
	{ r19:r18 = combine(r5,r0) }
	{ memd(r29+16) = r21:r20; memd(r29+32) = r17:r16; r21:r20 = combine(r2,r3); r17:r16 = combine(r4,r1) }
...
;;     000174AC (in logmsg_function)
;;     000174C0 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000007) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
quantize_execute proc
	{ allocframe(+00000040); r4 = add(badva,00000005) }
	...
	{  }
	{  }
	{ memd(r29+56) = r17:r16; r16 = r1 }
	{  }
	{  }
	{ r19 = memw(r5); r3 = memw(r3+16) }
	{  }
	{ r7 = memw(r7+16); r2 = r16; r1 = 00000049 }
	{  }
	{ memd(r29+32) = r23:r22; r9 = memw(r5+4) }
	{ memd(r29+40) = r21:r20; r5 = memw(r5+8) }
	{ memw(r29+8) = r9 }
	{  }
	{ memw(r29+12) = r5; r22 = memw(r6+16) }
	{ r17 = memw(r3); r23 = memw(r19+16) }
	{  }
	{ memw(r29) = r0; r20 = memw(r7); call	fn00017A04 }
	{  }
	{  }
	{ if (!cmp.gtu(r21,r2.new)) jump:t	000175B8; r2 = memw(r19+20) }

l00017594:
	{ r2 = r16; r1 = 0000004A; r3 = add(badva,0000000B) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	000176BC }
000175AC                                     23 40 7B 8B             #@{.
000175B0 22 40 79 8B 00 40 00 00                         "@y..@..        
...
l0001764C:
	...
	{  }
	{ r2 = 00000000 }
	{ if (p0.new) r2 = add(r3,00000000); if (!p0.new) jump:t	00017670; p0 = tstbit(r3,00000000) }
...
l00017670:
	{  }
	{ memb(r23++#1) = r2; r19 = add(r19,00000001); r22 = add(r22,00000004) }
	{ if (p0.new) jump:nt	0001764C; p0 = sfcmp.gt(r24,r3) }

l00017688:
	{ r3 = memd(r29+12); r4 = memd(r29+8); r0 = 00000000 }

l0001768C:
	{ r3 = memd(r29+12); r4 = memd(r29+8) }
...
quantize_check proc
	{ jump	quantize_check__merged; r2 = 00000000 }
...
l000176E8:
	{ memb(r29+2) = r0.new; r0 = p0; r4 = add(badva,0000002F) }
	{ r1 = 0000009E }

l00017700:
	{ r0 = p0; r4 = add(badva,00000029) }
	{ memw(r29+8) = r0 }
	{ memw(r29) = r17; r2 = r16 }
	{ call	logmsg_function }
	{ r0 = memw(r29+8) }
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001775C; r2 = memw(r17+16); p1 = r0 }

l0001772C:
	{ r1 = 0000009F; if (!p1) jump:nt	0001774C; r3 = add(badva,0000001D) }

l00017738:
	{ r1 = 000000A8; r3 = add(badva,0000000D) }
	{ r2 = r16; call	errlog_function }

l0001774C:
	{ dealloc_return; r17:r16 = memd(r29+16); r0 = FFFFFFFF }
00017754             20 41 00 5C A2 C0 91 91                  A.\....    

l0001775C:
	{ r1 = 000000A0; if (p0.new) jump:nt	00017780; p0 = cmp.eq(r2,00000006) }

l00017764:
	{ if (!p1) jump:nt	0001774C; r3 = add(badva,00000030) }

l00017770:
	{ r1 = 000000A9; jump	0001774C; r3 = add(badva,00000024) }

l00017780:
	{ if (!p1) r1 = 000000A1; if (p1) jump:nt	00017798 }

l00017788:
	{ jump	000177AC; r4 = add(badva,00000029) }
00017794             EE C1 72 10                             ..r.        

l00017798:
	{ r1 = 000000AA; r4 = add(badva,0000000C) }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
...
dequantize_execute proc
	...
	{ r7 = memw(r22+12); r6 = memw(r22+8); r4 = add(badva,00000036) }
	{  }
	{  }
	{ r16 = r0; r1 = 00000075 }
	{  }
	{  }
	{ r20 = memw(r23+16); r2 = r17 }
	{  }
	{ memw(r29) = r18; r22 = memw(r22+16) }
	{  }
	{  }
	{  }
	{  }
	{ call	fn00017A04 }
	{  }
	{ if (!cmp.gtu(r18,r2.new)) jump:t	00017880; r2 = memw(r23+20); r0 = 00000000 }

l0001785C:
	{ r2 = r17; r1 = 00000076; r3 = add(badva,00000003) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	000178C8 }
00017874             24 40 7A 8B 25 40 79 8B 00 40 00 00     $@z.%@y..@..

l00017880:
	{ r2 = 00000000 }
	{ memw(r23+4) = r4; memw(r23+24) = r18; if (p0.new) r2 = 00000001; p0 = sfcmp.gt(r21,r2) }
	{  }
	{ memw(r23+8) = r5; memw(r23) = r3 }
...
l000178A4:
	{ r3 = memb(r22++#1); r2 = add(r2,00000001); r5 = r19 }
	{  }
	{ p0 = sfcmp.gt(r21,r4) }
	{ r20 = add(r20,00000004); if (p0) jump:nt	000178A4; r5 += sfmpy(r16,r3) }
...
dequantize_check proc
	{ jump	quantize_check__merged; r2 = 00000001 }
...
dequantize_i32_execute proc
	...
	{ call	fn00017A04 }
	{  }
	{ if (!cmp.gtu(r26,r2.new)) jump:t	000179A4; r2 = memw(r20+20); r0 = 00000000 }

l00017980:
	{ r2 = r16; r1 = 00000092; r3 = add(badva,0000001F) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	000179EC }
00017998                         24 40 78 8B 25 40 79 8B         $@x.%@y.
000179A0 00 40 00 00                                     .@..            

l000179A4:
	{ r2 = 00000000 }
	{ memw(r20+4) = r4; memw(r20+24) = r26; if (p0.new) r2 = 00000001; p0 = sfcmp.gt(r17,r2) }
	{  }
	{ memw(r20+8) = r5; memw(r20) = r3 }
	{ memw(r20+12) = r3; if (!p0) jump:nt	000179EC }

l000179C8:
	{  }
	{ r3 = memw(r18++#4); r2 = add(r2,00000001) }
	{  }
	{ p0 = sfcmp.gt(r17,r4) }
	{  }
	{  }
...
;; fn00017A04: 00017A04
;;   Called from:
;;     00017578 (in quantize_execute)
;;     00017844 (in dequantize_execute)
;;     00017968 (in dequantize_i32_execute)
fn00017A04 proc
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function; r5 = memw(r2+16) }

;; fn00017A10: 00017A10
;;   Called from:
;;     00017A04 (in fn00017A04)
;;     00017A04 (in logmsg_function)
fn00017A10 proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000001A) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     00017A18 (in fn00017A10)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000003E) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
;; fn00017A50: 00017A50
;;   Called from:
;;     000175D8 (in quantize_execute)
;;     000177E8 (in dequantize_execute)
;;     00017910 (in dequantize_i32_execute)
fn00017A50 proc
	{ r2 = 00000017 }
	{ r1:r0 = combine(r0,r2); jump	fn00009600 }
...
relu_execute proc
	{ allocframe(00000048); memd(r29+496) = r17:r16; r4 = add(badva,0000003E) }
	...
	{ memw(r29) = r16; call	fn00017FC0; r26 = mpyi(r3,r8) }
	{ r3 = memw(r19+16); r2 = memw(r20+16); r4 = add(badva,00000024) }
	{ r3 = memw(r3); r2 = memw(r2); r1 = 00000053 }
	{ r2 = r17; r9:r8 = convert_sf2df(r3); r7:r6 = convert_sf2df(r2) }
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{  }
	{ r0 = 38D1B717; call	fn00009604 }
	{ r2 = 437F0000 }
	{ r1:r0 = combine(r0,r2); call	fn00009610 }
	{ r2 = 00000000 }
	{  }
	...
	{ call	fn00009624 }
	{  }
	{ if (!cmp.gtu(r26,r3.new)) jump:t	00017B70; r3 = memw(r25+20); p0 = cmp.eq(r26,00000000) }

l00017B4C:
	{ r2 = r17; r1 = 00000057; r3 = add(badva,0000002D) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00017C48 }
00017B64             E4 01 E3 00 01 44 99 A1 00 C3 99 A1     .....D......
...
l00017BB4:
	...
	{ memw(r21+12) = r7 }
	{ r2 = memw(r20+24) }
	{ if (!cmp.gtu(r2,r6.new)) jump:t	00017BF4; r6 = memw(r21+20) }
...
l00017BF4:
	{ memw(r21+24) = r2; r0 = memw(r21+16) }

l00017BF8:
	{ r1 = memw(r20+16); r2 = memw(r20+24); call	fn00009560 }
	{ r3 = memw(r18+16); r2 = memw(r19); r4 = add(badva,00000013) }
	{ r3 = memw(r3); r2 = memw(r2); r1 = 00000064 }
	{ r2 = r17; r9:r8 = convert_sf2df(r3); r7:r6 = convert_sf2df(r2) }
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{ r2 = r17; r1 = 00000065; r4 = add(badva,00000017) }
	{ memw(r29) = r16; call	logmsg_function }
	{ r0 = 00000000 }
...
;; relu_check: 00017C60
relu_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000030) }
	{ r17 = r0; r16 = r1; r1 = 00000098 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r1 = 00000099; r3 = add(badva,00000015) }
	{ if (!cmp.eq(r2.new,00000006)) jump:t	00017CEC; r2 = memw(r17+16) }

l00017C94:
	{ r1 = 0000009A; r3 = add(badva,00000010) }
	{ if (!cmp.eq(r2.new,00000006)) jump:t	00017CEC; r2 = memw(r17+20) }

l00017CA8:
	{ r4 = memw(r17+4); r5 = 00000000 }
	{ if (cmp.gt(r5.new,00000004)) jump:nt	00017D00; r5 = add(r5,00000001); r2 = add(r2,00000004) }

l00017CB0:
	{ if (cmp.gt(r5.new,00000004)) jump:nt	00017D00; r5 = add(r5,00000001) }

l00017CBC:
	{ if (!cmp.eq(r6.new,00000000)) jump:t	00017CDC; r6 = memw(r4++#4); r3 = add(badva,00000038) }

l00017CCC:
	{ r1 = 0000009C }
	{ r6 = memw(r17+8); r3 = add(badva,0000002B) }

l00017CDC:
	{ if (!cmp.eq(r6.new,00000001)) jump:t	00017CB0; r6 = memw(r4+r2) }
...
l00017CF0:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00017CF8                         03 44 00 00 04 57 49 6A         .D...WIj
...
reluX_execute proc
	{ allocframe(00000040); memd(r29+496) = r17:r16; r4 = add(badva,0000003E) }
	{ r16 = r0 }
	...
	{ call	fn00009624 }
	{  }
	{ if (!cmp.gtu(r27,r3.new)) jump:t	00017E2C; r3 = memw(r26+20); p0 = cmp.eq(r27,00000000) }

l00017E08:
	{ r2 = r18; r1 = 00000086; r3 = add(badva,00000031) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00017ED8 }
00017E20 03 40 99 91 24 C0 99 91 04 40 80 7E             .@..$....@.~    

l00017E2C:
	{ memw(r26) = r3; memw(r26+4) = r4 }
	{ r6 = memw(r25+8) }
...
l00017EA0:
	...
	{ r2 = r18; r1 = 00000091; r4 = add(badva,00000007) }
	{ memw(r29) = r16; call	logmsg_function }
	{ r0 = 00000000 }
...
reluX_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000000E) }
	{ r17 = r0; r16 = r1; r1 = 000000A6 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r1 = 000000A7; r3 = add(badva,00000009) }
	{ if (!cmp.eq(r2.new,00000008)) jump:t	00017F90; r2 = memw(r17+16) }

l00017F20:
	{ r1 = 000000A8; r3 = add(badva,00000004) }
	{ if (!cmp.eq(r2.new,00000006)) jump:t	00017F90; r2 = memw(r17+20) }

l00017F34:
	{ jump	00017F44; r6 = r2 }
00017F38                         84 40 04 B0                     .@..    

l00017F3C:
	{ if (cmp.gt(r5.new,00000004)) jump:nt	00017F80; r5 = add(r5,00000001) }

l00017F44:
	{ if (!cmp.eq(r7.new,00000000)) jump:t	00017F68; r7 = memw(r6++#4); r3 = add(badva,0000002C) }
...
l00017F58:
	{ r1 = 000000AA }
	{ r7 = memw(r17+8); r3 = add(badva,0000001F) }

l00017F68:
	{ if (!cmp.eq(r7.new,00000001)) jump:t	00017F3C; r7 = memw(r20+r4) }

l00017F74:
	{ r1 = 000000AB }
	{ r1 = 000000AD; r3 = add(badva,00000038) }

l00017F80:
	{ r1 = 000000AD }
	{ if (!cmp.eq(r2.new,00000000)) jump:t	00017FA0; r2 = memw(r2+12) }

l00017F90:
	{ r2 = r16 }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00017F9C                                     F7 43 00 00             .C..

l00017FA0:
	{ r2 = r16; r1 = 000000AE; r4 = add(badva,0000002B) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;; fn00017FCC: 00017FCC
;;   Called from:
;;     00017FC0 (in fn00017FC0)
;;     00017FC0 (in logmsg_function)
fn00017FCC proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000018) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     00017FD4 (in fn00017FCC)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000003C) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
relu_execute.extracted_region proc
	...
	{ memw(r0+12) = r7 }
	{ r3 = memw(r1+24) }
	{ if (cmp.gtu(r3,r4.new)) jump:t	00018044; r4 = memw(r0+20) }
...
;;   Called from:
;;     0001804C (in relu_execute.extracted_region)
autorequantize_execute proc
	{ allocframe(00000048); r5 = 00000000 }
	{ memd(r29+64) = r17:r16; r17:r16 = combine(r1,r0); r4 = add(badva,00000039) }
	...
	{  }
	{ r26 = memw(r3+4); r27 = memw(r3+8) }
	{ memd(r29+48) = r21:r20; memd(r29+56) = r19:r18 }
	{ r19 = memw(r23+16); r18 = memw(r22+16) }
	{  }
	{ memw(r29) = r16 }
	{ call	logmsg_function }
	{ r3 = memw(r24+16); r2 = memw(r25+16); r4 = add(badva,0000001A) }
	{ r3 = memw(r3); r2 = memw(r2); r1 = 0000004E }
	{ r2 = r17; r9:r8 = convert_sf2df(r3); r7:r6 = convert_sf2df(r2) }
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{ if (!cmp.gtu(r20,r2.new)) jump:t	00018130; r2 = memw(r23+20) }

l00018114:
	{ r2 = r17; r1 = 0000004F; r3 = add(badva,00000003) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001834C }
0001812C                                     00 40 14 75             .@.u

l00018130:
	{ r3 = memw(r22+4); r2 = memw(r22) }
	...
	{ memw(r29+16) = r0; jump	000181D0; if (!p0) jump:nt	00018168 }
...
000181C0 03 C3 C4 D5 02 40 42 8B 18 C0 43 8B 01 42 55 EB .....@B...C..BU.
...
l000181D0:
	...
	{ r24 = 437E0000; call	fn00018A28; r0 += sfmpy(r21,r24) }
	...
	{ if (p0) r3 = 3F000000; if (p0) jump:nt	000182AC; r24 += sfmpy(r25,r3) }

l00018274:
	{ if (p0.new) jump:nt	000182CC; p0 = r0 }
...
l000182AC:
	...
	{ call	fn00009614 }
	{  }
	{ r0 = r18; r4 = r20; r3:r2 = combine(r19,r21) }
	{ call	quantize_asm }

l000182C8:
	{ memw(r26+12) = FFFFFF81; r2 = memw(r26+16); r4 = add(badva,00000021) }
...
l000182D8:
	...
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{ r2 = r17; r1 = 00000081; r4 = add(badva,0000001B) }
	{ memw(r29) = r16; call	logmsg_function }
	{ r0 = 00000000 }
...
autorequantize_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000032) }
	{ r17 = r0; r16 = r1; r1 = 00000107 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r1 = 00000108; r3 = add(badva,0000002D) }
	{ if (!cmp.eq(r2.new,00000006)) jump:t	000183EC; r2 = memw(r17+16) }

l00018394:
	{ r1 = 00000109; r3 = add(badva,00000028) }
	{ if (!cmp.eq(r2.new,00000006)) jump:t	000183EC; r2 = memw(r17+20) }

l000183A8:
	{ r4 = memw(r17+4); r5 = 00000000 }
	{ if (cmp.gt(r5.new,00000004)) jump:nt	00018400; r5 = add(r5,00000001); r2 = add(r2,00000004) }

l000183B0:
	{ if (cmp.gt(r5.new,00000004)) jump:nt	00018400; r5 = add(r5,00000001) }

l000183BC:
	{ if (!cmp.eq(r6.new,00000000)) jump:t	000183DC; r6 = memw(r4++#4); r3 = add(badva,0000003A) }

l000183CC:
	{ r1 = 0000010B }
	{ r6 = memw(r17+8); r3 = add(badva,0000002D) }

l000183DC:
	{ if (!cmp.eq(r6.new,00000001)) jump:t	000183B0; r6 = memw(r4+r2) }
...
l000183F0:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
000183F8                         F0 43 00 00 84 48 49 6A         .C...HIj
...
requantize_execute proc
	{ allocframe(+00000050); r4 = add(badva,00000039) }
	{ memd(r29+72) = r17:r16; r6 = 00000000; r17 = r0 }
	...
	{  }
	{ memd(r29+56) = r21:r20; memw(r29+24) = r3 }
	{ r21 = memw(r24+16); r0 = memw(r15); r26 = mpyi(r5,r14) }
	{ r16 = memw(r25+16) }
	{  }
	{ memw(r29) = r17; memw(r29+28) = r0; call	fn00018968 }
	{ r3 = memw(r23+16); r2 = memw(r19+16); r4 = add(badva,00000032) }
	{ r3 = memw(r3); r2 = memw(r2); r1 = 000000A2 }
	{ r2 = r18; r9:r8 = convert_sf2df(r3); r7:r6 = convert_sf2df(r2) }
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{ if (!cmp.gtu(r26,r2.new)) jump:t	0001851C; r2 = memw(r25+20); r4 = r26 }

l000184FC:
	{ r2 = r18; r1 = 000000A3; r3 = add(badva,0000001B) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	000186C8 }
00018514             00 40 00 00 17 40 00 78                 .@...@.x    
...
l0001851C:
	...
	{  }
	{ r23 = r22 }
	{ if (p0) r16 = add(r27,00000000); if (p0) jump:nt	00018610; r23 += sfmpy(r16,r2) }
...
l000185DC:
	...
	{ r2 = 437F0000 }
	{ r1:r0 = combine(r0,r2); call	fn00009610 }
	{ r5:r4 = combine(r0,r22) }
	{ r1 = memd(r29+20); r0 = memd(r29+16) }
	{ memw(r29) = r20; call	autorequantize_execute.extracted_region }
	{ jump	0001864C }
0001860C                                     21 56 17 EB             !V..
...
l00018610:
	...
	{ call	fn00009614 }
	{  }
	{ r3 = memd(r29+20); r4 = r20; r2 = r21 }
	{ r0 = memd(r29+16); r16 = r18; call	quantize_asm }

l0001864C:
	{ memw(r26+12) = FFFFFF81; r2 = memw(r26+16); r4 = add(badva,00000015) }
	...
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{ r2 = r16; r1 = 000000C9; r4 = add(badva,00000013) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
...
requantize_check proc
	{ jump	requantize_check__merged; r2 = 00000000 }
...
requantize_check__merged proc
	{ allocframe(00000028); p0 = cmp.eq(r2,00000001); r4 = add(badva,00000039) }
	{ memd(r29+24) = r19:r18; memd(r29+32) = r17:r16; if (!p0) r1 = 00000114; r17:r16 = combine(r0,r1) }
	{ if (p0) r1 = 0000011D; r18 = add(badva,0000003D) }
...
l00018720:
	{ r19 = 00000120; r23:r22 = combine(00000003,00000002); r4 = add(badva,0000002B) }
	{ r21 = 0000011E; r20 = 0000011F; r18 = add(badva,00000018) }

l00018740:
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,r23)) jump:t	00018774; r2 = memw(r17+16); r1 = r21 }
...
0001876C                                     01 40 74 70             .@tp
00018770 A2 40 91 91                                     .@..            

l00018774:
	{ if (cmp.eq(r2.new,r22)) jump:t	0001878C }

l0001877C:
	{ jump	00018764; r3 = add(badva,00000000) }
00018784             02 40 70 70 01 40 73 70                 .@pp.@sp    
...
requantrange_execute proc
	{ allocframe(00000038); r6 = 00000000 }
	{ memd(r29+48) = r17:r16; r17:r16 = combine(r1,r0); r4 = add(badva,0000003A) }
	...
	{  }
	{ r19 = memw(r5+4); r21 = memw(r3+16) }
	{ memw(r29) = r16; r18 = memw(r5); r5 = mpyi(r8,r12) }
	{ r22 = mpyi(r5,r13) }
	{  }
	{ call	fn00018968 }
	{ r3 = memw(r24+16); r2 = memw(r23+16); r4 = add(badva,00000025) }
...
l0001886C:
	...
	{ r5 = memw(r21++#4); if (p0.new) jump:t	00018888; p0 = cmp.gtu(r14,-00000001) }
...
l00018888:
	...
	{ if (!p0) jump:nt	000188B8; loop0(0001889C,r6) }
...
l000188CC:
	{  }
	{ r5 = memw(r18+16); r6 = 00000000 }
	{  }
	{ memw(r18+8) = 00000001; memw(r18+12) = 00000001; r1 = 000000FE }
	{  }
	{ memw(r18) = 00000001 }
	{ memw(r18+4) = FFFFFF81 }
	...
	{ r2 = r17; r1 = 000000FF; r4 = add(badva,00000010) }
	{ memw(r29) = r16; call	logmsg_function }
	{ r0 = 00000000 }
	{ r19:r18 = memd(r29+40); r17:r16 = memd(r29+48) }
	{ r23:r22 = memd(r29+24); r21:r20 = memd(r29+32) }
...
requantrange_check proc
	{ jump	requantize_check__merged; r2 = 00000001 }
...
;; fn00018968: 00018968
;;   Called from:
;;     000184B8 (in requantize_execute)
;;     0001881C (in requantrange_execute)
fn00018968 proc
	{ if (cmp.gtu(r3,r5.new)) jump:t	fn0001898C; r5 = memw(r2+16) }

;; fn00018974: 00018974
;;   Called from:
;;     00018968 (in fn00018968)
;;     00018968 (in logmsg_function)
fn00018974 proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000003B) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     0001898C (in fn0001898C)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000001B) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
;;     00018280 (in autorequantize_execute)
;;     00018564 (in requantize_execute)
;;     000185E0 (in requantize_execute)
fn00018A28 proc
	{ r2 = 00000017 }
	{ r1:r0 = combine(r0,r2); jump	fn00009600 }
...
l00018B08:
	...
	{ r0 = r1 }
	{ jump	00018B28; r0 += add(r2,FFFFFFFF) }
...
l00018B4C:
	...
	{ if (p0.new) r1 = memw(r29-108); if (p0.new) r0 = memw(r29-112); if (!p0.new) jump:nt	00018B94; p0 = r0 }
...
l00018B6C:
	...
	{ jump	00018B8C; r0 += add(r2,FFFFFFFF) }
...
l00018B94:
	{ r2 = memw(r29+140); r0 = add(r29,000000E8); r1 = 00000000 }
...
l00018BA0:
	...
	{  }
	{  }
	{ r12 = memw(r29+96); r5 = 00000000 }
	{  }
	{ p2 = cmp.eq(r13,00000002); r0 = 00000001; r8 = add(r12,0000000F) }
	...
	{ if (!p0.new) r7 = memw(r29-128); if (!p0.new) r14 = memw(r29-112); if (!p0.new) jump:nt	00018D64; p0 = or(p1,and(p0,p2)) }

l00018D48:
	{ memw(r29+112) = r18; r4 = r18; r5 = asl(r19,00000001); r3 = mpyi(r16,r3) }
	{ r4 += add(r5,00000002) }
	{ jump	00018DAC; r3 = mpyi(r3,r4) }
00018D60 04 5A 27 F3                                     .Z'.            

l00018D64:
	{ r5 = r18; r3 = r16; r6 = sub(r19,r14) }
...
l00018DAC:
	{ r27 = memw(r29+100); r7 = memw(r29+104); p1 = !cmp.eq(r26,00000001) }
...
l00018DB8:
	...
	{ if (cmp.eq(r4.new,00000004)) jump:t	00018E1C; r4 = memb(r17+32); r21 = add(r1,00000580) }
...
l00018DF0:
	...
	{ jump	00018E38 }
00018E14             EE 60 DF 5C 00 C0 00 7F                 .`.\....    
...
l00018E38:
	{ r20 = memd(r29+84); r2 = memw(r17+28); r4 = add(badva,00000027) }
	{ r16 = memw(r29+124); r1 = 000003D8 }
	{  }
	{ memw(r29+4) = r2; r22 = memd(r29+88) }
	{ memw(r29) = r17; call	logmsg_function }
	...
	{ memd(r29+16) = r9:r8; r22 = memw(r29+132); r4 = add(badva,00000016) }
	{ r7:r6 = convert_sf2df(r2) }
	{ memw(r29+4) = r19; memw(r29+12) = r22 }
	{ memw(r29+8) = r26; memd(r29+24) = r7:r6 }
	{ memw(r29) = r27; call	logmsg_function }
	{ r4 = add(badva,00000023) }
	{ r1 = 000003DB }
	{ memw(r29+4) = r24; r5 = memw(r29+148) }
	{ memw(r29) = r5; call	logmsg_function }
	{ r4 = add(badva,0000001A) }
	{ r1 = 000003DC }
	{ memb(r29) = r5.new; r5 = memb(r17+32); call	logmsg_function }
	{ memw(r29+12) = r27; r7 = memw(r29+108); r4 = add(badva,00000013) }
	{  }
	{ memw(r29) = r18 }
	{ memw(r29+8) = r7; r5 = memd(r29+112); r1 = 000003DD }
	{ memw(r29+4) = r5 }
	{ call	logmsg_function }
	{ r19 = memw(r29+136); r25 = r23; r4 = add(badva,00000029) }
	{ r1 = 000003DF; r7:r6 = convert_sf2df(r25) }
	{ r5 = memw(r19+8) }
	{ memd(r29) = r7:r6; r8 = add(badva,0000001D) }
	{ r9 = add(badva,00000022) }
	{ if (!p0.new) r8 = add(r9,00000000); p0 = !cmp.eq(r5,00000000) }
	{ memw(r29+8) = r8; call	logmsg_function }
	{ p0 = cmp.eq(r20,r22); r1 = 000003E0; r3 = add(badva,00000006) }
	{ if (!p0) jump:nt	0001903C }

l00018F90:
	{ if (!cmp.gtu(r21,r2.new)) jump:t	00018FB4; r2 = memw(r16+8) }

l00018F9C:
	{ memw(r29+4) = r2; r1 = 000003E2; r3 = add(badva,0000003F) }
	{ memw(r29) = r21; r2 = r16 }
	{ jump	00019040 }
00018FB0 82 42 9D 91                                     .B..            

l00018FB4:
	{ r24 = memw(r29+116) }
	{ if (!cmp.gtu(r24,r4.new)) jump:t	00018FE4; r4 = memw(r2+20); r21 = r24 }

l00018FC8:
	{ memw(r29+4) = r24; r1 = 000003E5; r3 = add(badva,0000002D) }
	{ memw(r29) = r4; r2 = r16 }
	{ jump	00019040 }
00018FDC                                     D8 43 00 00             .C..
00018FE0 83 57 49 6A                                     .WIj            

l00018FE4:
	{ r2 = memw(r29+76); r1 = 000003E7 }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00019040; r2 = memw(r2) }

l00018FF8:
	{ r2 = memw(r29+76); r1 = 000003E8; r3 = add(badva,00000028) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00019040; r2 = memw(r2+12) }

l00019010:
	{ r2 = memd(r29+72); r4 = 00000004; r3 = add(badva,00000021) }
	{ r1 = 000003E9 }
	{ if (cmp.gtu(r4,r2.new)) jump:t	00019040; r2 = memw(r2+20) }

l00019028:
	{ r2 = memw(r29+68); r1 = 000003EA; r3 = add(badva,00000017) }
	{ if (cmp.gtu(r2.new,00000006)) jump:t	00019050; r2 = memw(r2+20) }
...
0001904C                                     20 C1 9D 91              ...

l00019050:
	{ if (p0.new) r1 = 000003EB; if (!p0.new) jump:nt	00019070; p0 = r0 }
...
l00019070:
	{ r20 = memd(r29+48); r2 = memd(r29+104) }
...
l000190E4:
	...
	{  }
	{ call	fn00009764 }
	{ r3 = r0; r2 = add(r29,000000E8); r21 = add(badva,00000038) }
	...
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00019150; r2 = memw(r16+52) }
...
l0001913C:
	...
	{ memd(r17+48) = r1:r0 }
	{ if (!cmp.eq(r2.new,00000000)) jump:t	000191C8; r2 = memw(r19+8) }

l00019150:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	000191C8 }
...
l00019158:
	...
	{  }
	{  }
	{ if (!p0.new) jump:nt	000191C8; p0 = sfcmp.gt(r3,r25) }

l00019178:
	{ r2 = memw(r19+4) }
	{ if (!p0.new) jump:nt	00019198; p0 = sfcmp.gt(r3,r2) }

l00019184:
	{  }

l00019188:
	{ if (p0.new) jump:nt	00019188; p0 = sfcmp.gt(r3,r2) }

l00019190:
	{ memw(r19+4) = r2 }
	{ r5 = memw(r17+28); r7:r6 = convert_sf2df(r2); r4 = add(badva,00000024) }
...
l000191A4:
	{  }
	{ memw(r29) = r5; r1 = 00000419 }
	{ memd(r29+8) = r7:r6; call	logmsg_function }
	{ r1:r0 = combine(r16,r17); call	supernode_execute_hvx }
	{ jump	00019218 }
000191C4             D9 43 00 00                             .C..        

l000191C8:
	{ r5 = memd(r29+68); r3 = memd(r29+72); r4 = add(badva,00000027) }
	...
	{  }
	{ memw(r5+24) = 00000004; memw(r2) = r25 }
...
supernode_check_ref proc
	{ allocframe(00000038); memd(r29+496) = r17:r16; r4 = add(badva,0000003F) }
	...
	{ call	logmsg_function }
	{ r2 = memw(r17+16); r1 = 0000043E; r3 = add(badva,0000002A) }
	{ if (cmp.gtu(r4.new,r2)) jump:t	00019420; r4 = 0000000A; p0 = cmp.gtu(r2,0000000B) }

l00019284:
	{ r1 = 0000043F; r3 = add(badva,0000000E) }
	{ if (!p0) r1 = 00000440; if (p0) jump:nt	00019418 }

l00019294:
	{ r3 = add(badva,00000013) }
	{ if (!cmp.eq(r4.new,00000007)) jump:t	0001941C; r4 = memw(r17+20) }

l000192A8:
	{ r1 = 00000441; r3 = add(badva,0000001D) }
	{ if (cmp.eq(r24.new,00000001)) jump:nt	0001941C; r24 = memw(r17+4) }

l000192BC:
	{ r1 = 00000442; r3 = add(badva,00000015) }
	{ if (cmp.eq(r4.new,00000001)) jump:nt	0001941C; r4 = memw(r17+8) }

l000192D0:
	{ r21 = 00000000; r5 = 00000000 }
	{ r6 = 00000000; r3 = r24; loop0(000192E0,r2) }
	{ if (cmp.eq(r7.new,00000000)) jump:nt	000192F8; r7 = memw(r3) }

l000192EC:
	{ r6 = r6; r3 = add(r3,00000004) }
	{ jump	00019314; r13 = r2 }
000192F4             CF 43 00 00                             .C..        

l000192F8:
	{ memw(r29) = r6; r1 = 00000445; r3 = add(badva,00000026) }
	{ jump	00019418 }
00019308                         84 40 04 B0                     .@..    

l0001930C:
	{ if (cmp.gtu(r5.new,00000004)) jump:nt	00019338; r5 = add(r5,00000001) }

l00019314:
	{ if (!cmp.eq(r2.new,00000001)) jump:t	0001930C; r2 = memw(r4) }

l00019318:
	{ if (!cmp.eq(r2.new,00000001)) jump:t	0001930C }

l00019320:
	{ memw(r29) = r5; r1 = 0000044A; r3 = add(badva,0000000C) }
	{ jump	00019418 }
00019330 82 40 98 91 A3 C0 98 91                         .@......        
...
l00019338:
	...
	{  }
	{ call	fn00009504 }
	{ r1 = 00000460; r2 = mpyi(r23,r25); r3 = add(badva,0000002B) }
	{ if (cmp.eq(r20.new,00000000)) jump:t	00019424; r20 = r0; p0 = cmp.gt(r26,000000FF); p2 = cmp.eq(r21,0000000B) }
...
l000193B0:
	...
	{ if (!p2) jump:nt	000193FC; r1 = mpyi(r22,r21) }
...
l000193FC:
	{ memw(r17+40) = r20; r0 = 00000080 }

l00019404:
	{ memw(r20) = r0; r1 = 0000046B; r3 = add(badva,0000000A) }
...
supernode_dtor proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r17:r16 = combine(r1,r0) }
	{ memd(r29) = r19:r18 }
	{ if (cmp.eq(r18.new,00000000)) jump:nt	000194B8; r18 = memw(r16+40) }
...
l0001956C:
	{ r0 = r1 }
	{ jump	00019580; r0 += add(r16,FFFFFFFF) }
...
l000195AC:
	...
	{ if (!p0) r1:r0 = combine(r23,r26); if (!p0.new) jump:nt	000195EC; p0 = r1 }

l000195C4:
	{ jump	000195E4 }

l000195C8:
	{ jump	000195E4; r0 += add(r26,FFFFFFFF) }
...
l000195F0:
	...
	{  }
	{ call	fn00009624 }
	{ r19 = memd(r29+72); r17 = memd(r29+112); r4 = add(badva,00000007) }
	{  }
	{ r1 = 000000EF }
	...
	{ r1 = 000000F3 }
	{ memb(r29) = r5.new; r5 = memb(r17+32); call	logmsg_function }
	{ memw(r29+12) = r24; r5 = memw(r29+80); r4 = add(badva,00000013) }
	{  }
	{ memw(r29) = r19; memw(r29+4) = r5 }
	{ memw(r29+8) = r20; r17 = r5; r1 = 000000F4 }
	{ call	logmsg_function }
	{ p0 = cmp.eq(r21,r26); r1 = 000000F5; r3 = add(badva,0000000E) }
