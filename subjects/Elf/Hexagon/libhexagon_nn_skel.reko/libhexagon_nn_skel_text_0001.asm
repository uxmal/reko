...
l00019850:
	...
	{ if (!cmp.gtu(r3.new,r2)) jump:t	00019878; r3 = and(00000081,asl(r3,00000004)) }

l00019860:
	{ memw(r29+4) = r2; r1 = 000000F7; r3 = add(badva,0000003B) }
	{ memw(r29) = r7; r2 = r23 }
	{ jump	00019904 }
00019874             E2 C3 9D 91                             ....        

l00019878:
	{ if (!cmp.gtu(r25,r4.new)) jump:t	000198A4; r4 = memw(r2+20); r5 = r2 }

l00019888:
	{ memw(r29+4) = r25; r1 = 000000FA; r3 = add(badva,0000002D) }
	{ memw(r29) = r4; r2 = r23 }
	{ jump	00019904 }
0001989C                                     B5 43 00 00             .C..
000198A0 83 57 49 6A                                     .WIj            

l000198A4:
	{ r2 = memw(r29+52); r1 = 000000FC }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00019904; r2 = memw(r2) }

l000198B8:
	{ r2 = memw(r29+52); r1 = 000000FD; r3 = add(badva,00000028) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	00019904; r2 = memw(r2+12) }

l000198D0:
	{ r2 = memd(r29+48); r4 = 00000004; r3 = add(badva,00000021) }
	{ r1 = 000000FE }
	{ if (cmp.gtu(r4,r2.new)) jump:t	00019904; r2 = memw(r2+20) }

l000198E8:
	{ r2 = memw(r29+44); r1 = 000000FF; r3 = add(badva,00000017) }
	{ if (cmp.gtu(r2.new,00000006)) jump:t	00019918; r2 = memw(r2+20); p0 = cmp.gt(r24,00000000) }
...
00019910 00 40 40 89 22 42 9D 91                         .@@."B..        
...
l0001993C:
	...
	{  }
	{  }
	{ r20 = add(r20,FFFFFFFF); call	fn00009624 }
	{  }
	{  }
...
l00019A50:
	{ if (p0.new) memw(r29+84) = r15; r9 = 00000000 }
...
l00019BB0:
	...
	{ if (!cmp.eq(r15.new,r9)) jump:t	00019A50; r15 = add(r15,00000001) }
...
l00019C24:
	...
	{ r8 = add(r9,r8) }
	{  }
	{ if (!tstbit(r8.new,-00000001)) jump:nt	00019C60; r8 = asrh(r8) }
...
l00019C74:
	{  }
	{ r6 = memd(r29+44); r4 = memd(r29+48); r1 = 00000152 }
	{ r5 = memw(r29+32) }
	{ memw(r4+12) = 00000001; r2 = memw(r4+16) }
	{  }
	{ memw(r4+4) = 00000001; memw(r4+8) = 00000001; r3 = 00000002 }
	{ memw(r2) = 00000000; memw(r4) = 00000001 }
	{ memw(r6) = 00000001; memw(r4+24) = 00000004; r4 = add(badva,00000031) }
...
l00019DF4:
	...
	{ memb(r29+59) = r0.new; if (p0) r2 = sub(r21,r19); if (p0) jump:nt	00019E40; r0 = p0 }

l00019E18:
	{ r1:r0 = combine(r18,r18) }
	{ r1 = memw(r29+220); r0 = 00000000 }
	{ if (!p0) r1:r0 = combine(r18,r21); if (!p0.new) jump:nt	00019E48; p0 = r1 }

l00019E30:
	{ jump	00019E40 }
00019E34             E0 5F 15 E2 06 C0 00 58 00 D2 02 F3     ._.....X....
...
l00019E48:
	{ r4 = memw(r29+256); r3 = memw(r29+240); r7 = sub(r20,r23) }
...
l00019E54:
	...
	{  }
	{ r8 = memw(r24+16); r6 = memw(r6+16); r24 = r0 }
	{ memw(r29+128) = r26 }
...
l00019F68:
	...
	{  }
	{ memb(r29+41) = r8.new; r5 = memw(r29+112); r8 = asr(r23,00000001) }
	...
	{ if (p1.new) r24 = memw(r29+108); if (!p1.new) r22 = memw(r29+116); if (p1.new) jump:nt	0001A07C; p1 = r0 }
...
l0001A070:
	{ jump	0001A090; p0 = and(p0,p0) }
0001A078                         00 40 43 89                     .@C.    

l0001A07C:
	{ r22 = memd(r29+116); r5 = 00000000 }
...
l0001A170:
	...
	{ if (!p0.new) jump:nt	0001A1A4; p0 = r0 }
...
l0001A1A4:
	{ memw(r29+224) = r20; r2 = memw(r29+104) }

l0001A1AC:
	{ memw(r29+116) = r22; r0 = 00000000; r2 = add(r22,r2) }
	...
	{ call	fn00009754; r20 = and(0000003D,lsr(r20,0000000B)) }
	...
	{ if (!cmp.gt(r17.new,00000000)) jump:nt	0001A31C; r2 = memw(r29+72); r7 = mpyi(r24,r25) }
...
l0001A29C:
	...
	{  }
	{ memw(r29+84) = r17; memw(r29+88) = r18 }
...
l0001A46C:
	...
	{ if (p0) r1 = add(r21,r5); if (!p0) jump:nt	0001A578; r20 = add(r3,mpyi(r20,r5)) }

l0001A49C:
	{ memb(r29+31) = r0.new; r0 = p2; r7 = add(badva,00000034) }
	{ r3 = memw(r7-96); r4 = memw(r7-112) }
	{ r24 = memw(r7-64); r6 = memw(r7-80) }
	{ r0 = memw(r29+120) }
	{ if (!p0.new) r6 = add(r2,r21); if (!p0.new) r7 = sub(r17,r2); if (!p0.new) jump:nt	0001A514; p0 = r0 }
...
l0001A574:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0001A5A0; r2 = memw(r29+248) }

l0001A578:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0001A5A0 }
...
l0001A5AC:
	...
	{ if (!p0) r20 = add(r25,00000000); if (!p0) jump:nt	0001A668; r0 = add(r20,mpyi(r0,r21)) }
...
l0001A6CC:
	...
	{ if (!cmp.eq(r23.new,r24)) jump:t	0001A374; r23 = add(r23,00000001) }

l0001A6EC:
	{ if (cmp.gtu(r2,r22.new)) jump:t	0001A35C; r22 = add(r22,00000020) }
...
l0001A6F8:
	{ r0 = memw(r29+68) }
	{ r18 = memw(r29+88) }
	{ if (!p0.new) r2 = memw(r29-24); r17 = memw(r2); if (p0.new) jump:nt	0001A750; p0 = r0 }
...
l0001A710:
	...
	{ call	fn0000D054; r3 = add(r6,mpyi(r3,r5)) }
...
l0001A840:
	{ jump	0001A850; r0 += add(r23,FFFFFFFF) }
...
l0001A888:
	{ r0 = r1 }
	{ jump	0001A8A4; r0 += add(r27,FFFFFFFF) }
...
l0001A8A4:
	{ memw(r29+68) = r0 }
	{ r2 = r22; r1 = 00000050; r4 = add(badva,00000017) }
...
l0001A8B8:
	...
	{ if (!cmp.eq(r2.new,00000002)) jump:t	0001A8EC; r2 = memw(r18) }
...
l0001A8EC:
	{ r1 = 00000055; r3 = add(badva,00000034) }
...
l0001A908:
	...
	{ r2 = mpyi(r2,r4) }
	{ if (!cmp.gtu(r2.new,r7)) jump:t	0001A934; r2 = asl(r2,00000002) }

l0001A928:
	{ jump	0001A8FC; r3 = add(badva,00000010) }
0001A930 00 40 58 75                                     .@Xu            

l0001A934:
	{ if (!cmp.eq(r3.new,00000000)) jump:t	0001A954; r3 = memb(r21+32) }

l0001A940:
	{ r1 = 00000058; jump	0001A8FC; r3 = add(badva,00000006) }
0001A94C                                     00 40 00 00             .@..
0001A950 14 40 00 7E                                     .@.~            

l0001A954:
	{ memw(r16+24) = r2; r2 = memd(r29+68) }
...
l0001AA30:
	{ if (!cmp.gt(r2.new,00000001)) jump:nt	0001ABCC; r2 = memw(r29+124) }
...
l0001AB24:
	...
	{ loop1(0001AB34,r3) }
	{ p0 = cmp.gt(r22,r24); r5 = add(r17,FFFFFFFF); if (!p0.new) jump:nt	0001AB74; r3 = addasl(r2,r25,00000002) }

l0001AB44:
	{  }
	{ r4 = memw(r2); p0 = cmp.gtu(r17,00000001) }
...
l0001AC0C:
	{ memb(r29) = r2.new; r2 = memw(r29+16); r4 = add(badva,00000008) }
	{ r2 = memw(r29+12) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
avgpool_check proc
	...
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001AC88; r2 = memw(r17+16); r1 = 0000008D }

l0001AC6C:
	{ r3 = add(badva,00000025) }
	{ r2 = r16; call	errlog_function }

l0001AC78:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001AC80 C1 51 00 78 A2 40 91 91                         .Q.x.@..        

l0001AC88:
	{ if (!cmp.eq(r2.new,00000002)) jump:t	0001AC9C }

l0001AC90:
	{ r3 = memw(r17+4) }
	{ jump	0001AC78; r3 = add(badva,00000010) }
...
l0001AD18:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000001) }
...
;;     0001AD0C (in logmsg_function)
;;     0001AD20 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000025) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
biasadd_f_execute proc
	{ allocframe(00000038); memd(r29+496) = r17:r16; r3 = add(badva,00000001) }
	...
	{ memd(r29+8) = r27:r26 }
	{ if (!cmp.eq(r4.new,00000002)) jump:t	0001AE34; r4 = memw(r5+4) }

l0001AD94:
	{ r1 = 00000046; r3 = add(badva,00000011) }
	{ if (!cmp.eq(r4.new,00000002)) jump:t	0001AE34; r4 = memw(r5) }

l0001ADA8:
	{ r1 = 00000047; r3 = add(badva,0000003D) }
	{ if (!cmp.eq(r4.new,00000002)) jump:t	0001AE34; r4 = memw(r5+8) }

l0001ADBC:
	{ if (cmp.eq(r18.new,r4)) jump:t	0001ADE0; r18 = memw(r3+12) }

l0001ADC8:
	{ memw(r29+4) = r18; r1 = 00000049; r3 = add(badva,00000028) }
	{ memw(r29) = r4; r2 = r16 }
	{ jump	0001AE34 }
0001ADDC                                     70 43 00 00             pC..

l0001ADE0:
	{ r24 = memw(r3+4); r23 = memw(r3); r4 = add(badva,00000028) }
	...
	{ r3 = mpyi(r3,r18) }
	{ call	fn0001AF7C; r26 = asl(r3,00000002) }
	{ r1 = 0000004D; r3 = add(badva,00000002) }
	{ if (!cmp.gtu(r26,r2.new)) jump:t	0001AE44; r2 = memw(r25+20) }

l0001AE34:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001AEE4 }
0001AE40 02 57 18 ED                                     .W..            

l0001AE44:
	{ memw(r25) = r23; memw(r25+24) = r26 }
	{ memw(r25+12) = r18; memw(r25+4) = r24; r3 = mpyi(r2,r22) }
	{ memw(r25+8) = r22 }
	{ r2 = 00000000; if (p0.new) jump:nt	0001AECC; p0 = cmp.eq(r3,00000000); loop1(0001AE68,r3) }
...
l0001AE74:
	...
	{ if (!p0) jump:nt	0001AEB8; loop0(0001AE90,r7) }
...
l0001AEC8:
	{ r2 = r16; r1 = 00000058; r4 = add(badva,00000024) }
...
biasadd_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000003) }
	{ r17 = r0; r16 = r1; r1 = 0000005E }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	0001AF48; r2 = memw(r17+16); r1 = 0000005F }
...
l0001AF38:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001AF40 01 4C 00 78 A2 40 91 91                         .L.x.@..        

l0001AF48:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001AF60 }

l0001AF50:
	{ jump	0001AF38; r3 = add(badva,00000027) }
0001AF58                         69 43 00 00 04 58 49 6A         iC...XIj
...
;; fn0001AF88: 0001AF88
;;   Called from:
;;     0001AF7C (in fn0001AF7C)
;;     0001AF7C (in logmsg_function)
fn0001AF88 proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000020) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000004) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
concat_execute proc
	{ allocframe(00000040); memd(r29+472) = r23:r22; r4 = add(badva,00000022) }
	{ r23 = r0 }
	...
	{ r2 = memw(r17+16) }
	{ if (!cmp.eq(r2.new,00000006)) jump:t	0001B110; r2 = memw(r2) }
...
l0001B040:
	...
	{ if (p0) r3 = add(r24,00000000); if (!p0) r26 = 00000000; if (p0) jump:nt	0001B12C; r17 = mpyi(r3,r27) }

l0001B064:
	{ memw(r18) = r27; memw(r29+8) = r25; if (p0) r27 = 00000000 }

l0001B068:
	{ memw(r18) = r27; memw(r29+8) = r25 }
...
l0001B088:
	{ r16 = memw(r24); p0 = cmp.gt(r17,00000000) }
...
l0001B0A8:
	{ r1:r0 = combine(r20,r18) }
	{ r2 = memw(r16+12); r18 = addasl(r18,r26,00000002) }
	{ if (!cmp.eq(r25.new,00000001)) jump:t	0001B0A8; r25 = add(r25,FFFFFFFF); r20 = addasl(r20,r2,00000002) }
...
l0001B0CC:
	{ if (!cmp.eq(r27.new,r23)) jump:t	0001B088; r27 = add(r27,00000001); r24 = r3 }

l0001B0D8:
	{ memb(r29) = r2.new; r2 = memw(r29+12); r4 = add(badva,0000002A) }
...
l0001B0F8:
	...
	{ dealloc_return }
0001B10C                                     67 43 00 00             gC..

l0001B110:
	{ r1 = 00000046; r3 = add(badva,0000000F) }
...
0001B128                         08 C0 17 60                     ...`    

l0001B12C:
	{ r6 = memw(r3) }
	{ if (cmp.eq(r7.new,r19)) jump:t	0001B150; r7 = memw(r6+8) }

l0001B13C:
	{ memw(r29) = r2; r1 = 00000049; r3 = add(badva,0000002E) }
	{ jump	0001B118 }
0001B14C                                     27 40 86 91             '@..

l0001B150:
	{ if (cmp.eq(r7.new,r20)) jump:t	0001B16C }

l0001B158:
	{ memw(r29) = r2; r1 = 0000004C; r3 = add(badva,0000002B) }
	{ jump	0001B118 }
0001B168                         07 40 86 91                     .@..    

l0001B16C:
	{ if (cmp.eq(r7.new,r27)) jump:t	0001B188 }

l0001B174:
	{ memw(r29) = r2; r1 = 0000004F; r3 = add(badva,00000029) }
	{ jump	0001B118 }
0001B184             07 41 05 B0                             .A..        

l0001B188:
	{ r6 = memw(r6+12); r5 = r3; r2 = add(r2,00000001) }
	{ r26 = add(r6,r26); r3 = r7 }
	{ nop; r4 += mpyi(r17,r6) }
	{ r3 = memw(r18+20) }
	{ if (!cmp.gtu(r2.new,r3)) jump:t	0001B068; r2 = asl(r4,00000002) }

l0001B1B0:
	{ r1 = 00000055; jump	0001B120; r3 = add(badva,00000008) }
0001B1BC                                     00 C0 00 7F             ....

;; concat_check: 0001B1C0
concat_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000001A) }
	{ r17 = r0; r16 = r1; r1 = 0000006A }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r2 = memw(r17+16); r1 = 0000006B; r3 = add(badva,00000016) }
	{ if (cmp.gtu(r4.new,r2)) jump:t	0001B250; r4 = 00000004 }

l0001B1F8:
	{ r1 = 0000006C; r3 = add(badva,0000000F) }
	{ if (!cmp.eq(r4.new,00000002)) jump:t	0001B250; r4 = memw(r17+20) }

l0001B20C:
	{ r4 = memw(r17+4) }
	{ if (!cmp.gtu(r2,r5.new)) jump:nt	0001B23C; r5 = add(r5,00000001); r4 = add(r4,00000004) }

l0001B21C:
	{ if (!cmp.eq(r6.new,00000001)) jump:t	0001B21C; r6 = memw(r4); r3 = add(badva,00000037) }
...
l0001B230:
	{ r1 = 0000006E }
	{ r2 = memw(r17+8); r1 = 00000071; r3 = add(badva,0000002A) }

l0001B23C:
	{ r2 = memw(r17+8); r1 = 00000071 }

l0001B244:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0001B260; r2 = memw(r2) }

l0001B250:
	{ r2 = r16 }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001B25C                                     61 43 00 00             aC..

l0001B260:
	{ r2 = r16; r1 = 00000073; r4 = add(badva,0000000E) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
l0001B28C:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000034) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }

;; errlog_function: 0001B2A4
;;   Called from:
;;     0001B118 (in concat_execute)
;;     0001B280 (in logmsg_function)
;;     0001B294 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000018) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0001B384:
	...
	{ if (!p0) r1:r0 = combine(r18,r17); if (!p0.new) jump:nt	0001B3B8; p0 = r1 }

l0001B398:
	{ jump	0001B3B0 }

l0001B39C:
	{ jump	0001B3B0; r0 += add(r17,FFFFFFFF) }
...
l0001B3B0:
	{ call	fn00009760 }
	{ r22 = memd(r29+44); r2 = memw(r19+16); r4 = add(badva,00000014) }
...
l0001B3C0:
	...
	{ memw(r29+12) = r23; r1 = 0000005F; r4 = add(badva,0000003E) }
	{ memw(r29+4) = r17; r2 = r18 }
	{ memw(r29+8) = r24; r21 = memw(r29+20) }
	{ memw(r29) = r21; call	logmsg_function }
	{ r20 = memd(r29+48); r2 = r18; r4 = add(badva,00000033) }
	{ memw(r29+12) = r20; r1 = 00000060 }
	{ memw(r29+4) = r27; memw(r29+8) = r26 }
	{ memw(r29) = r25; call	logmsg_function }
	{ r3 = memd(r29+60); r2 = r18; r4 = add(badva,00000027) }
	{ memw(r29+4) = r3; r1 = 00000061 }
	{ memw(r29) = r19; call	logmsg_function }
	{ r2 = r18; r1 = 00000062; r4 = add(badva,0000001F) }
	{ r22 = memw(r29+40); r3 = memb(r22+32) }
	{ memw(r29) = r3; call	logmsg_function }
	{ memw(r29) = r21; memw(r29+12) = r25; r4 = add(badva,00000011) }
	{ r19 = memw(r29+64); r1 = 00000063 }
	{ memw(r29+4) = r22; memw(r29+8) = r19; r2 = r18 }
	{ call	logmsg_function }
	{ r15 = r19; if (p0.new) jump:nt	0001B4B4; p0 = cmp.eq(r15,-00000001); r2 = mpyi(r21,r25) }

l0001B49C:
	{ r2 = r18; r1 = 00000065; r3 = add(badva,00000000) }
	{ jump	0001B504 }
0001B4B0 09 40 76 70                                     .@vp            

l0001B4B4:
	{ r3 = memd(r29+32); r6 = r21 }
	{ memw(r29+16) = r18; r5 = r3 }
	{ r4 = memw(r3+20); r2 = mpyi(r2,r19) }
	{ r2 = mpyi(r2,r22) }
	{ if (!cmp.gtu(r2.new,r4)) jump:t	0001B4EC; r2 = asl(r2,00000002) }

l0001B4D4:
	{ memw(r29+4) = r2; r1 = 00000067; r3 = add(badva,00000021) }
	{ memw(r29) = r4; r2 = memd(r29+16) }
	{ jump	0001B504 }
0001B4E8                         E4 C0 9D 91                     ....    

l0001B4EC:
	{ if (cmp.eq(r3.new,00000002)) jump:t	0001B514; r3 = memw(r4) }

l0001B4F8:
	{ r1 = 00000069; r3 = add(badva,00000017) }
	{ r2 = memw(r29+16) }
...
0001B510 00 40 46 75                                     .@Fu            

l0001B514:
	{ if (cmp.eq(r3.new,00000002)) jump:t	0001B534; r3 = memw(r4+12) }

l0001B520:
	{ r1 = 0000006A; jump	0001B508; r3 = add(badva,00000000) }
0001B52C                                     E2 5F 0F 74             ._.t
0001B530 03 5A 38 FB                                     .Z8.            

l0001B534:
	{ memw(r5+4) = r9; memw(r5+24) = r2 }
...
l0001B5E0:
	{ if (p0.new) r28 = memw(r29+56); p0 = cmp.gt(r25,00000000) }
...
l0001B620:
	{ if (!cmp.gtu(r17,r2.new)) jump:nt	0001B6B4; r2 = add(r7,r14) }

l0001B628:
	{ if (p0.new) r12 = add(r2,r8); if (p0.new) r21 = 00000000; if (!p0.new) jump:t	0001B6B0; p0 = tstbit(r2,00000000) }
...
l0001B640:
	...
	{ if (!cmp.gtu(r24,r12.new)) jump:nt	0001B6A8; r12 = add(r21,r1) }
...
l0001B6A8:
	{ nop; r21 = add(r21,00000001) }

l0001B6B0:
	{ if (!cmp.eq(r7.new,r27)) jump:t	0001B628; r7 = add(r7,00000001); r9 = addasl(r9,r5,00000002) }

l0001B6B4:
	{ if (!cmp.eq(r7.new,r27)) jump:t	0001B628; r7 = add(r7,00000001) }
...
l0001B6D4:
	{ if (!cmp.eq(r13.new,r15)) jump:t	0001B5E0; r13 = add(r13,00000001) }
...
l0001B704:
	{ memw(r29+12) = r25; r1 = 00000093; r4 = add(badva,00000029) }
...
conv2d_check_ref proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000033) }
	{ r17 = r0; r16 = r1; r1 = 0000009B }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001B77C; r2 = memw(r17+16) }

l0001B764:
	{ r2 = memw(r17+28); r1 = 0000009C; r3 = add(badva,00000027) }
	{ memw(r29) = r2; jump	0001B78C }
0001B778                         A1 53 00 78                     .S.x    

l0001B77C:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001B7A4; r2 = memw(r17+20) }

l0001B788:
	{ r3 = add(badva,0000001F) }
...
l0001B794:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001B79C                                     C1 53 00 78             .S.x
0001B7A0 22 40 91 91                                     "@..            

l0001B7A4:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0001B7BC }

l0001B7AC:
	{ jump	0001B794; r3 = add(badva,00000012) }
0001B7B4             04 40 00 78 43 40 91 91                 .@.xC@..    

l0001B7BC:
	{ if (!cmp.eq(r3.new,00000000)) jump:nt	0001B7E4 }

l0001B7C4:
	{ r1 = 0000009F; jump	0001B794; r3 = add(badva,00000006) }
0001B7D0 82 40 02 B0 24 40 04 B0 14 C2 02 25 05 40 82 91 .@..$@.....%.@..
0001B7E0 FA E0 72 24                                     ..r$            

l0001B7E4:
	{ memw(r29) = r4; r1 = 000000A2; r3 = add(badva,0000002F) }
	{ jump	0001B78C }
0001B7F8                         E1 54 00 78 02 40 83 91         .T.x.@..
0001B800 0E E0 42 24 4F 43 00 00 83 4E 49 6A 00 C0 5D 3C ..B$OC...NIj..]<
0001B810 BE FF FF 59 4F 43 00 00 04 4E 49 6A 41 55 00 78 ...YOC...NIjAU.x
0001B820 02 C0 70 70 08 40 00 5A 00 D1 9D A1 00 C0 00 78 ..pp.@.Z.......x
0001B830 40 1F 0C 3E                                     @..>            
...
l0001B844:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000011) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
matmul_execute_ref proc
	{ allocframe(+00000058); r4 = add(badva,0000002A) }
	...
	{ memw(r29+28) = r19; r1 = 00000052; r4 = add(badva,0000001E) }
	{ memw(r29+8) = r21; r2 = r16 }
	{ memw(r29+20) = r27; memw(r29+24) = r18 }
	{ memw(r29+12) = r20; memw(r29+16) = r25 }
	{ memw(r29) = r26; memw(r29+4) = r24 }
	{ call	logmsg_function }
	{ p0 = cmp.eq(r24,00000001); r1 = 00000053; r3 = add(badva,00000018) }
	{ if (p0) r1 = 00000054; if (!p0) jump:nt	0001B988 }

l0001B92C:
	{ if (p0.new) r1 = 00000055; p0 = cmp.eq(r27,00000001); r3 = add(badva,00000000) }
	{ if (!p0) jump:nt	0001B988 }

l0001B940:
	{ if (p0.new) r1 = 00000056; p0 = cmp.eq(r26,00000001); r3 = add(badva,0000003E) }
	{ if (!p0) jump:nt	0001B988 }

l0001B954:
	{ p0 = cmp.eq(r25,00000001); r2 = mpyi(r26,r21); r3 = add(badva,0000002A) }
	{ if (p0) r4 = memw(r23+20); if (p0) r1 = 00000057; if (!p0) jump:nt	0001B988 }

l0001B970:
	{ r2 = mpyi(r2,r24); r3 = add(badva,00000025) }
	{ r2 = mpyi(r2,r19) }
	{ if (!cmp.gtu(r2.new,r4)) jump:t	0001B99C; r2 = asl(r2,00000002) }
...
0001B998                         0F 40 71 70                     .@qp    

l0001B99C:
	{ memw(r23+24) = r2; r28 = memw(r29+36); r0 = r22 }
...
l0001B9D0:
	{ r4 = r28; if (p0.new) jump:nt	0001BA3C; p0 = cmp.eq(r11,00000000); r6 = mpyi(r2,r20) }

l0001B9D4:
	{ r4 = r28; if (p0.new) jump:nt	0001BA3C; p0 = cmp.eq(r11,00000000) }

l0001B9DC:
	{ r5 = mpyi(r2,r19); loop1(0001B9EC,r19) }
	{ r6 = addasl(r15,r6,00000002); r5 = addasl(r0,r5,00000002) }
	{ r7 = r3; if (p0.new) jump:nt	0001BA30; p0 = cmp.eq(r12,00000000); r12 = addasl(r4,r19,00000002) }

l0001B9F8:
	{ r8 = memw(r6); r9 = memw(r4); r13 = add(r6,00000004); r7 = r3 }
	{ if (!p0.new) jump:t	0001BA2C; p0 = cmp.gtu(r12,-00000001); loop0(0001BA10,r14) }
...
l0001BA30:
	{ memw(r5) = r7; r4 = add(r4,00000004); nop }

l0001BA38:
	{ if (!cmp.eq(r2.new,r21)) jump:t	0001B9D4; r2 = add(r2,00000001) }

l0001BA3C:
	{ if (!cmp.eq(r2.new,r21)) jump:t	0001B9D4 }

l0001BA40:
	{ r2 = r16; r1 = 00000068; r4 = add(badva,00000026) }
...
matmul_check_ref proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000008) }
	{ r17 = r0; r16 = r1; r1 = 0000006F }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r1 = 00000070; r3 = add(badva,00000004) }
	{ if (!cmp.eq(r2.new,00000004)) jump:t	0001BADC; r2 = memw(r17+16) }

l0001BAA0:
	{ r1 = 00000071; r3 = add(badva,00000006) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	0001BADC; r2 = memw(r17+20) }

l0001BAB4:
	{ r1 = 00000072; r3 = add(badva,00000009) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0001BADC; r2 = memw(r17+4) }

l0001BAC8:
	{ r1 = 00000073; r3 = add(badva,00000001) }
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0001BAEC; r2 = memw(r17+8) }

l0001BADC:
	{ r2 = r16 }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001BAE8                         4A 43 00 00                     JC..    

l0001BAEC:
	{ r2 = r16; r1 = 00000074; r4 = add(badva,0000002A) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
l0001BB18:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000002) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }

;; errlog_function: 0001BB30
;;   Called from:
;;     0001B988 (in matmul_execute_ref)
;;     0001BB0C (in logmsg_function)
;;     0001BB20 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000026) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0001BBD0:
	...
	{ jump	0001BBEC; r0 += add(r2,FFFFFFFF) }
...
l0001BC24:
	{ r0 = r1 }
	{ jump	0001BC40; r0 += add(r24,FFFFFFFF) }
...
l0001BC40:
	{ memw(r29+72) = r0 }
	{ r2 = r23; r1 = 00000054; r4 = add(badva,00000027) }
...
l0001BC54:
	...
	{ memw(r29+100) = r3; memw(r29+104) = r7 }
	{ memw(r29) = r22; call	logmsg_function }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	0001BC88; r2 = memw(r26) }
...
l0001BC88:
	{ r1 = 00000059; r3 = add(badva,00000001) }
...
l0001BCA4:
	...
	{ r2 = mpyi(r2,r21) }
	{ r2 = mpyi(r2,r4) }
	{ if (!cmp.gtu(r2.new,r3)) jump:t	0001BCCC; r2 = asl(r2,00000002) }

l0001BCC0:
	{ jump	0001BC98; r3 = add(badva,00000021) }
0001BCC8                         00 40 5B 75                     .@[u    

l0001BCCC:
	{ if (!cmp.eq(r3.new,00000000)) jump:t	0001BCEC; r3 = memb(r22+32) }

l0001BCD8:
	{ r1 = 0000005C; jump	0001BC98; r3 = add(badva,00000017) }
0001BCE4             00 40 F8 0F 01 40 00 7E                 .@...@.~    

l0001BCEC:
	{ memw(r16+24) = r2; r2 = memd(r29+72) }
...
l0001BDBC:
	...
	{ p0 = cmp.gt(r25,00000000); r8 = add(r9,r20); if (!p0.new) jump:nt	0001BF00; r3 = mpyi(r9,r19) }

l0001BE24:
	{ p0 = cmp.gt(r25,00000000) }
...
l0001BE78:
	...
	{ r24 = add(r8,FFFFFFFF); if (!p0.new) jump:nt	0001BEDC; p0 = cmp.gt(r10,-00000001); r23 = addasl(r11,r25,00000002) }
...
l0001BEB8:
	{  }
	{ r23 = memw(r24); r17 = r23; r24 = addasl(r24,r25,00000002) }
	{ nop; r14 = r17 }
...
l0001BEFC:
	{ if (!cmp.eq(r9.new,r21)) jump:t	0001BE24; r9 = add(r9,00000001); r28 = sub(r28,r19); r16 = add(r16,r19) }

l0001BF00:
	{ if (!cmp.eq(r9.new,r21)) jump:t	0001BE24; r9 = add(r9,00000001); r28 = sub(r28,r19) }
...
l0001BF5C:
	{ memb(r29) = r2.new; r2 = memw(r29+12); r4 = add(badva,00000021) }
	{ r2 = memw(r29+8) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
maxpool_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000010) }
	{ r17 = r0; r16 = r1; r1 = 0000008B }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001BFD8; r2 = memw(r17+16); r1 = 0000008C }

l0001BFBC:
	{ r3 = add(badva,00000001) }
	{ r2 = r16; call	errlog_function }

l0001BFC8:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001BFD0 A1 51 00 78 A2 40 91 91                         .Q.x.@..        

l0001BFD8:
	{ if (!cmp.eq(r2.new,00000002)) jump:t	0001BFEC }

l0001BFE0:
	{ r3 = memw(r17+4) }
	{ jump	0001BFC8; r3 = add(badva,0000002C) }
...
l0001C068:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000001D) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
relu_execute proc
	{ allocframe(00000028); memd(r29+496) = r17:r16; r4 = add(badva,00000026) }
	...
	{ r21 = mpyi(r3,r6) }
	{ call	fn0001C350; r23 = asl(r21,00000002) }
	{ if (!cmp.gtu(r23,r2.new)) jump:t	0001C120; r2 = memw(r22+20) }

l0001C108:
	{ r2 = r16; r1 = 00000037; r3 = add(badva,0000000A) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001C170 }
0001C11C                                     00 40 15 75             .@.u
...
l0001C158:
	{ r2 = r16; r1 = 0000003F; r4 = add(badva,00000015) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
...
relu_check__merged proc
	{ allocframe(00000020); p0 = cmp.eq(r2,00000001); r4 = add(badva,00000029) }
	{ r7 = 00000001; r5 = 00000002; r6 = add(badva,0000001E) }
	...
	{ if (cmp.eq(r2.new,r18)) jump:t	0001C1E8; r2 = memw(r17+16) }

l0001C1CC:
	{ r0 = memd(r29+8); r2 = r16; r3 = add(badva,00000038) }
	{ if (!p0.new) r1 = 00000062; if (p0.new) r1 = 0000006B; jump	0001C210; p0 = r0 }
0001C1E4             40 C0 9D 91                             @...        

l0001C1E8:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001C22C; r2 = memw(r17+20); p1 = r0 }

l0001C1F8:
	{ if (!p1) r1 = 00000063; if (p1) r1 = 0000006C }
	{ r3 = add(badva,0000000F) }
	{ r2 = r16 }
	{ call	errlog_function }
...
0001C220 F8 FF FF 59 0C 41 00 5C A1 4D 20 7E             ...Y.A.\.M ~    

l0001C22C:
	{ if (!p1) r1 = 00000064 }
	{ jump	0001C24C; r4 = add(badva,00000010) }
0001C23C                                     35 43 00 00             5C..
0001C240 84 D1 49 6A 84 40 00 5A 09 28 82 70             ..Ij.@.Z.(.p    
...
reluX_execute proc
	{ allocframe(00000030); memd(r29+496) = r17:r16; r4 = add(badva,0000001E) }
	{ r17:r16 = combine(r0,r1) }
	...
	{ r22 = mpyi(r5,r8) }
	{ call	fn0001C350; r24 = asl(r22,00000002) }
	{ if (!cmp.gtu(r24,r2.new)) jump:t	0001C2D8; r2 = memw(r23+20) }

l0001C2BC:
	{ r2 = r16; r1 = 00000053; r3 = add(badva,00000016) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001C338 }
0001C2D4             00 40 16 75                             .@.u        

l0001C2D8:
	{ r3 = memw(r19+4); r2 = memw(r19) }
...
l0001C31C:
	{ r2 = r16; r1 = 0000005B; r4 = add(badva,00000000) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
...
;; fn0001C35C: 0001C35C
;;   Called from:
;;     0001C350 (in fn0001C350)
;;     0001C350 (in logmsg_function)
fn0001C35C proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000035) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000019) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0001C3D0:
	...
	{ memw(r29+4) = r3 }
	{ if (!cmp.gt(r25.new,00000000)) jump:nt	0001C4D0; r26 = memw(r20+16); r25 = mpyi(r2,r3) }
...
l0001C408:
	{ r27 = memw(r26) }
	{ r17 = r27; r0 = r27 }
	{ memb(r29+4) = r1.new; if (!p0) jump:nt	0001C4B8; r1 = p0 }

l0001C424:
	{ r1 = r17 }
	{ if (!cmp.eq(r18.new,00000000)) jump:t	fn0001C518; r18 = add(r18,FFFFFFFF); r17 = r0; r2 = add(r19,00000004) }

l0001C43C:
	{ if (p0.new) r24 = add(r16,00000000); if (p0.new) r19 = 00000000; if (!p0.new) jump:nt	0001C4B8; p0 = r0 }
...
l0001C454:
	{  }
	{ r24 = add(r24,FFFFFFFF); call	fn00009784 }
	{ p0 = cmp.eq(r24,00000000); r2 = add(r22,r19) }
	{  }
	{ memw(r2) = r0; if (p0) jump:nt	0001C488 }

l0001C474:
	{ r19 = add(r19,00000004); r2 = add(r23,r19) }
	{ r27 = memw(r2); jump	0001C454 }
0001C484             C6 68 FD 5B                             .h.[        

l0001C488:
	{ r1 = r18; r0 = 00000000 }
	{ r2 = memw(r29+16) }
	{ if (p0.new) r2 = add(r22,00000000); if (!p0.new) jump:nt	0001C4B8; p0 = r2 }
...
l0001C4B8:
	{ r26 = addasl(r26,r16,00000002) }

l0001C4BC:
	{ if (!cmp.eq(r21.new,r25)) jump:t	0001C408; r21 = add(r21,00000001); r22 = addasl(r22,r16,00000002) }
...
l0001C4F8:
	{ call	fn0001C608; r3 = add(badva,00000016) }
	{ r0 = FFFFFFFF; jump	0001C4E4 }
0001C50C                                     00 C0 93 91             ....
0001C510 88 CB 32 17                                     ..2.            

;; softmax_check: 0001C514
softmax_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000005) }

;; fn0001C518: 0001C518
;;   Called from:
;;     0001C428 (in softmax_execute)
;;     0001C514 (in softmax_check)
fn0001C518 proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000005) }
	{ r17 = r0; r16 = r1; r1 = 0000005A }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r1 = 0000005B; r3 = add(badva,00000002) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0001C5AC; r2 = memw(r17+4) }

;; fn0001C548: 0001C548
;;   Called from:
;;     0001C534 (in fn0001C518)
;;     0001C534 (in fn0001C518)
;;     0001C53C (in fn0001C518)
fn0001C548 proc
	{ r1 = 0000005C; r3 = add(badva,0000003A) }
	{ if (cmp.eq(r4.new,00000000)) jump:nt	0001C5AC; r4 = memw(r17+8) }

l0001C55C:
	{ r1 = 0000005D; r3 = add(badva,00000033) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0001C5AC; r2 = memw(r2) }

l0001C570:
	{ r1 = 0000005E; r3 = add(badva,0000002C) }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0001C5AC; r2 = memw(r4) }

l0001C584:
	{ r1 = 0000005F; r3 = add(badva,00000026) }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	0001C5AC; r2 = memw(r17+16) }

l0001C598:
	{ r1 = 00000060; r3 = add(badva,00000012) }
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001C5BC; r2 = memw(r17+20) }

l0001C5AC:
	{ r2 = r16 }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001C5B8                         2B 43 00 00                     +C..    

l0001C5BC:
	{ r2 = r16; r1 = 00000061; r4 = add(badva,0000003D) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;   Called from:
;;     0001C528 (in fn0001C518)
;;     0001C528 (in fn0001C518)
;;     0001C5C8 (in fn0001C548)
logmsg_function proc
	{ allocframe(00000008); r3 = 00000002 }
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function; r5 = memw(r2+16) }

l0001C5E8:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000016) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }

;; errlog_function: 0001C600
;;   Called from:
;;     0001C5DC (in logmsg_function)
;;     0001C5F0 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000003A) }
...
l0001C660:
	{ memw(r29+4) = r7; r1 = 000000A1; r3 = add(badva,00000022) }
...
l0001C750:
	...
	{ r2 = mpyi(r2,r17) }
	{ memw(r29+32) = r2 }
	{ if (!p0.new) r3 = add(r3,00000001); jump	0001C988; if (p0.new) jump:nt	0001C77C; p0 = cmp.gt(r8,00000000) }
...
0001C980 43 C2 9D 43 EC C9 63 14                         C..C..c.        
...
;; lrn_check: 0001C9D8
lrn_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000001D) }
	{ r17 = r0; r16 = r1; r1 = 000000CB }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,0000000E)) jump:t	0001CA20; r2 = memw(r17+16); r1 = 000000CC }

l0001CA04:
	{ r3 = add(badva,0000000C) }
	{ r2 = r16; call	errlog_function }

l0001CA10:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001CA18                         A1 59 00 78 A2 40 91 91         .Y.x.@..

l0001CA20:
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001CA38 }

l0001CA28:
	{ jump	0001CA10; r3 = add(badva,0000003B) }
0001CA30 1C 43 00 00 04 40 49 6A                         .C...@Ij        
...
l0001CA60:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000000) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
lrn_8_execute_ref.extracted_region proc
	...
	{ memw(r0+12) = r7 }
	{ r3 = memw(r1+24) }
	{ if (cmp.gtu(r3,r4.new)) jump:t	0001CAD8; r4 = memw(r0+20) }
...
;;   Called from:
;;     0001CADC (in lrn_8_execute_ref.extracted_region)
lrn_f_execute proc
	{ allocframe(+000000E0) }
	{ r3 = memw(r0+4); r2 = memw(r0+8) }
...
l0001CB18:
	{ memw(r29+4) = r5; r1 = 000000A3; r3 = add(badva,0000003D) }
	{ jump	0001CC20 }
...
l0001CC10:
	{ r2 = r16; r1 = 000000A8; r3 = add(badva,0000001F) }
...
l0001CC7C:
	...
	{ r5 = memw(r12+4); r6 = add(r2,FFFFFFFF); r4 = add(badva,0000000F) }
...
l0001CE98:
	...
	{  }
	{ memd(r29+16) = r7:r6 }
	{ memd(r29+8) = r5:r4; r19:r18 = convert_sf2df(r17); r4 = add(badva,00000035) }
	...
	{  }
	{ call	fn00009784 }
	{ r1 = 0000007F; r17 = r0; r4 = add(badva,00000016) }
	{ r7:r6 = convert_sf2df(r17) }
	{ memd(r29) = r19:r18 }
	{ memd(r29+16) = r7:r6; r7:r6 = memd(r29+72) }
	{ memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{ r2 = memw(r29+124); r1 = 000000BD; r4 = add(badva,0000003B) }
...
;; lrn_check: 0001CFA8
lrn_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000001F) }
	{ r17 = r0; r16 = r1; r1 = 000000CB }
	{ call	logmsg_function }
	{ memw(r29) = r17 }
	{ if (cmp.eq(r2.new,0000000A)) jump:t	0001CFF4; r2 = memw(r17+16); r1 = 000000CC }
...
l0001CFE4:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001CFEC                                     C1 59 00 78             .Y.x
0001CFF0 A2 40 91 91                                     .@..            

l0001CFF4:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001D010 }

l0001CFFC:
	{ r1 = 000000CD; jump	0001CFE4; r3 = add(badva,00000037) }
0001D008                         06 43 00 00 04 5C 49 6A         .C...\Ij
...
l0001D088:
	{ r1 = 0000007D; r3 = add(badva,00000017) }
...
l0001D0A0:
	{ r2 = memw(r14+r2<<#2) }
	{ if (!cmp.gtu(r6.new,r7)) jump:t	0001D0C0; r6 = memw(r2+24) }

l0001D0B0:
	{ r1 = 0000007E; jump	0001D09C; r3 = add(badva,00000002) }
0001D0BC                                     06 C0 82 91             ....
...
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000000D) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0001D130:
	{ r1 = 00000094; r3 = add(badva,0000002F) }
	{ r2 = r0; call	errlog_function }
...
l0001D148:
	{ r6 = memw(r30+r6<<#2) }
	{ if (!cmp.gtu(r2,r7.new)) jump:t	0001D168; r7 = memw(r6+20) }

l0001D158:
	{ r1 = 00000095; jump	0001D144; r3 = add(badva,0000001A) }
0001D164             31 3C 60 04                             1<`.        
...
assign_execute proc
	{ allocframe(00000020); memd(r29+496) = r17:r16; r4 = add(badva,0000001C) }
	{ r1 = 000000A3; r17:r16 = combine(r0,r1) }
	{ memd(r29+16) = r19:r18; r2 = memw(r17+16) }
	{ memw(r29+4) = r2; r2 = r16 }
	{ memw(r29) = r17; memd(r29+8) = r21:r20 }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0001D1FC; r2 = memw(r17+16) }
...
l0001D1B4:
	...
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:nt	0001D284; r6 = memw(r2+20) }

l0001D1E4:
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
	{ r2 = memw(r17+16); r19 = add(r19,00000008) }
	{ if (cmp.gtu(r2,r18.new)) jump:t	0001D1B4; r18 = add(r18,00000002) }

l0001D1FC:
	{ if (cmp.eq(r2.new,00000000)) jump:nt	0001D284; r2 = memw(r17+20); r0 = 00000000 }
...
l0001D210:
	...
	{ memw(r2+12) = r1; memw(r2+8) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:nt	0001D260; r6 = memw(r2+20) }

l0001D240:
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
	{ r2 = memw(r17+20); r18 = add(r18,00000008); r19 = add(r19,00000004) }
	{ if (cmp.gtu(r2,r20.new)) jump:t	0001D210; r20 = add(r20,00000001) }

l0001D25C:
	{ memw(r29) = r20; r1 = 000000AC; r3 = add(badva,00000039) }
...
0001D280 03 43 00 00                                     .C..            

l0001D284:
	{ memw(r29) = r18; r1 = 000000A6; r3 = add(badva,0000003E) }
	{ jump	0001D26C }
...
l0001D2A4:
	{ jump	0001D2D0; r3 = add(badva,00000017) }

l0001D2B0:
	{ r4 = memw(r0+20); r0 = 00000000; r1 = 000000B6 }
	{ if (!cmp.gtu(r4,r3.new)) jump:t	variable_execute; r3 = lsr(r3,00000001) }

l0001D2C4:
	{ r3 = add(badva,0000000E) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF }
...
;;   Called from:
;;     0001D2B8 (in assign_check)
variable_execute proc
	{ allocframe(00000008); r2 = r1; r4 = add(badva,0000000C) }
...
variable_check proc
	...
	{ memw(r29) = r17; call	logmsg_function }
	{ r2 = memw(r17+20) }
	{ if (cmp.gtu(r3.new,r2)) jump:t	0001D3A8; r3 = memw(r17+16) }
...
l0001D334:
	...
	{ memw(r2+12) = r1; memw(r2+8) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:nt	0001D388; r6 = memw(r2+20) }

l0001D368:
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
	{ r2 = memw(r17+16) }
	{ if (!cmp.gtu(r2,r20.new)) jump:nt	0001D39C; r20 = add(r20,00000001) }

l0001D380:
	{ r2 = memw(r17+20); r19 = add(r19,00000004) }
	{ r1 = 0000003B; r3 = add(badva,0000000E) }
...
l0001D3A0:
	{ dealloc_return; r21:r20 = memd(r29+8) }
0001D3A4             FD 42 00 00                             .B..        

l0001D3A8:
	{ jump	0001D398; r1 = 00000038; r3 = add(badva,0000001E) }
...
variable_ctor proc
	...
	{ if (cmp.eq(r16.new,00000000)) jump:nt	0001D484; r16 = r0 }

l0001D3D8:
	{ memb(r29+2) = r0.new; if (p0) jump:nt	0001D3FC; r0 = p0 }
...
l0001D408:
	{ r2 = r18; r1 = 0000005F; r3 = add(badva,00000011) }
	{ call	errlog_function }

l0001D41C:
	{ r0 = memw(r29+8) }
	{ if (p0.new) jump:nt	0001D478; p0 = r0 }
...
l0001D478:
	{ r19:r18 = memd(r29+16); r17:r16 = memd(r29+24) }
	{ dealloc_return }
0001D480 F9 42 00 00                                     .B..            

l0001D484:
	{ r2 = r18; r1 = 00000058; r3 = add(badva,0000000E) }
	{ r16 = 00000000; call	errlog_function }
	{ jump	0001D474 }

;; variable_dtor: 0001D49C
variable_dtor proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000001C) }
	{ r17 = r0; r16 = r1; r1 = 0000006B }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r0.new,00000000)) jump:nt	0001D4C8; r0 = memw(r17+40) }

l0001D4C4:
	{ deallocframe; r17:r16 = memd(r29+8); r1:r0 = combine(r16,r17); jump	node_free_common }

l0001D4C8:
	{ deallocframe; r17:r16 = memd(r29+8); r1:r0 = combine(r16,r17) }
...
;;     0001D4C8 (in variable_dtor)
logmsg_function proc
	{ allocframe(00000008); r3 = 00000002 }
	{ if (cmp.gtu(r3,r5.new)) jump:t	0001D4F8; r5 = memw(r2+16) }
...
reshape_execute proc
	...
	{ memw(r29+68) = r4 }
	{ if (!cmp.gt(r2.new,00000006)) jump:t	0001D570; r2 = memw(r23+12); r18 = mpyi(r6,r22) }

l0001D55C:
	{ r4 = addasl(r3,r2,00000002) }
	{ r26 = memw(r4-16); jump	0001D578 }
0001D568                         0C 42 C2 10 3A 60 00 7C         .B..:`.|

l0001D570:
	{ if (p0.new) r3 = memw(r23+16) }
	{ r26 = 00000001 }
...
l0001D5A8:
	{ r2 = r16; r1 = 0000003F; r4 = add(badva,00000027) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r2 = memw(r25+20); r1 = 00000041; r3 = add(badva,00000030) }
	{ if (cmp.gtu(r4.new,r2)) jump:t	0001D774; r4 = memw(r24+24) }

l0001D5D8:
	{ r1 = 00000043; r2 = lsr(r27,0000001F); r3 = add(badva,00000026) }
	{ r2 += lsr(r26,0000001F) }
	{ r2 += lsr(r19,0000001F) }
	{ r2 += lsr(r20,0000001F) }
	...
	{ if (!cmp.eq(r2.new,00000006)) jump:t	0001D720; r2 = memw(r17+20) }

l0001D6A4:
	{ r3 = memw(r17+4); r2 = memw(r17+8) }
	{ r2 = memw(r2+4); r4 = memw(r3+8); r3 = add(badva,0000002E) }
	{ r5 = memw(r4+4); r7 = memw(r4) }
	{ memw(r2) = r7; memw(r2+4) = r5 }
	{ r6 = memw(r4+12); r0 = memw(r4+8) }
	{ memw(r2+12) = r6; memw(r2+8) = r0 }
	{ r5 = memw(r4+24) }
	{ if (cmp.gtu(r5,r7.new)) jump:t	0001D774; r7 = memw(r2+20) }

l0001D6D4:
	{ r1 = memw(r4+16); r2 = memw(r4+24); call	fn00009560 }
	{ r3 = memw(r17+4); r2 = memw(r17+8); r1 = 00000054 }
	{ r4 = memw(r3+12); r3 = add(badva,00000032) }
	{ r2 = memw(r2+8) }
	{ r5 = memw(r4+4); r7 = memw(r4) }
	{ memw(r2) = r7; memw(r2+4) = r5 }
	{ r6 = memw(r4+12); r0 = memw(r4+8) }
...
l0001D714:
	{ r1 = memw(r4+16); r2 = memw(r4+24); call	fn00009560 }
	{ r3 = memw(r23+4); r2 = memw(r23); r4 = add(badva,00000009) }
...
reshape_check__merged proc
	{ allocframe(00000028); p0 = cmp.eq(r2,00000001); r4 = add(badva,00000019) }
	{ memd(r29+24) = r19:r18; memd(r29+32) = r17:r16; if (p0) r19 = 0000006F; r17:r16 = combine(r0,r1) }
	{ if (p0) r1 = 0000006C; r18 = add(badva,0000001A) }
...
l0001D7C4:
	{ r21:r20 = combine(0000006D,0000006E); r23:r22 = combine(00000004,00000003); r4 = add(badva,00000006) }
	{ r18 = add(badva,0000002F) }

l0001D7DC:
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,r23)) jump:t	0001D810; r2 = memw(r17+16); r1 = r21 }
...
0001D808                         01 40 74 70 A2 40 91 91         .@tp.@..

l0001D810:
	{ if (cmp.eq(r2.new,r22)) jump:t	0001D828 }

l0001D818:
	{ jump	0001D800; r3 = add(badva,0000001F) }
0001D820 02 40 70 70 01 40 73 70                         .@pp.@sp        
...
slice_check_f proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001D8D0; r2 = memw(r17+16); r1 = 00000086 }

l0001D8C0:
	{ jump	0001D8E8; r3 = add(badva,0000000E) }
0001D8C8                         E1 50 00 78 00 40 00 78         .P.x.@.x

l0001D8D0:
	{ if (cmp.eq(r2.new,00000002)) jump:t	fn0001D8F8; r2 = memw(r17+20) }
...
slice_check_8 proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000003F) }

;; fn0001D8F8: 0001D8F8
;;   Called from:
;;     0001D8D0 (in slice_check_f)
;;     0001D8F4 (in slice_check_8)
fn0001D8F8 proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000003F) }
	{ r17 = r0; r16 = r1; r1 = 0000008D }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	fn0001D930; r2 = memw(r17+16); r1 = 0000008E }

;; fn0001D920: 0001D920
;;   Called from:
;;     0001D908 (in fn0001D8F8)
;;     0001D910 (in fn0001D8F8)
fn0001D920 proc
	{ jump	0001D948; r3 = add(badva,0000002E) }
0001D928                         E1 51 00 78 00 40 00 78         .Q.x.@.x

;; fn0001D930: 0001D930
;;   Called from:
;;     0001D908 (in fn0001D8F8)
;;     0001D910 (in fn0001D8F8)
;;     0001D930 (in fn0001D920)
fn0001D930 proc
	{ if (cmp.eq(r2.new,00000002)) jump:t	fn0001D958; r2 = memw(r17+20) }

l0001D93C:
	{ r3 = add(badva,0000001D) }
	{ r2 = r16; call	errlog_function }
...
;; fn0001D958: 0001D958
;;   Called from:
;;     0001D930 (in fn0001D930)
;;     0001D950 (in slice_execute_q8)
fn0001D958 proc
	...
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	fn0001D98C; r6 = memw(r2+20) }

;; fn0001D980: 0001D980
;;   Called from:
;;     0001D974 (in fn0001D958)
;;     0001D974 (in fn0001D958)
fn0001D980 proc
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
...
fn0001D98C proc
	...
	{ memw(r2+12) = r1; memw(r2+8) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	0001D9BC; r6 = memw(r2+20) }
...
slice_check_q8 proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000023) }
	{ r17 = r0; r16 = r1; r1 = 00000095 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,0000000A)) jump:t	0001DA0C; r2 = memw(r17+16); r1 = 00000096 }

l0001D9FC:
	{ jump	0001DA24; r3 = add(badva,00000012) }
0001DA04             E1 52 00 78 00 40 00 78                 .R.x.@.x    

l0001DA0C:
	{ if (cmp.eq(r2.new,00000006)) jump:t	fn0001DA34; r2 = memw(r17+20) }
...
;; fn0001DA34: 0001DA34
;;   Called from:
;;     0001DA0C (in slice_check_q8)
fn0001DA34 proc
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function }

;; fn0001DA3C: 0001DA3C
;;   Called from:
;;     0001DA34 (in fn0001DA34)
;;     0001DA34 (in fn0001DA34)
;;     0001DA34 (in fn0001DA34)
fn0001DA3C proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000020) }
...
;;     0001D940 (in fn0001D930)
;;     0001DA1C (in slice_check_q8)
;;     0001DA30 (in fn0001DA34)
;;     0001DA34 (in fn0001DA34)
...
;;     0001D9C4 (in fn0001D98C)
slice_impl proc
	{ allocframe(+00000058); r4 = add(badva,00000029) }
	{ r5 = memw(r0+8); r3 = memw(r0+4) }
	...
	{ r3 = mpyi(r3,r26) }
	{ r14 = mpyi(r3,r8); r3 = add(badva,0000000F) }
	{ if (cmp.gtu(r14,r15.new)) jump:t	0001DBF0; r15 = memw(r23+20) }

l0001DB40:
	{ p0 = cmp.gt(r20,00000000); r1 = 00000055; r3 = add(badva,00000009) }
	{ if (p0) r1 = 00000056; if (!p0) jump:nt	0001DBEC }

l0001DB54:
	{ if (p1.new) r1 = 00000057; p1 = cmp.gt(r21,00000000); r3 = add(badva,0000003C) }
	{ memb(r29+6) = r0.new; if (!p1) jump:nt	0001DBF0; r0 = p1 }

l0001DB74:
	{ if (p1.new) r1 = 00000058; p1 = cmp.gt(r26,00000000); r3 = add(badva,0000002B) }
	{ memb(r29+8) = r0.new; if (!p1) jump:nt	0001DBF0; r0 = p1 }

l0001DB90:
	{ p1 = cmp.gt(r8,00000000); r3 = add(badva,0000001A) }
	{ if (p1) r1 = 00000059; if (!p1) jump:nt	0001DBEC }

l0001DBA0:
	{ r3 = add(badva,00000011) }
	{ if (!cmp.gtu(r13,r15.new)) jump:t	0001DBF0; r15 = add(r20,r2) }

l0001DBB4:
	{ r1 = 0000005A; r3 = add(badva,00000010) }
	{ if (!cmp.gtu(r9,r13.new)) jump:t	0001DBF0; r13 = add(r21,r12) }

l0001DBC8:
	{ r1 = 0000005B; r3 = add(badva,0000000B) }
	{ if (!cmp.gtu(r4,r13.new)) jump:t	0001DBF0; r13 = add(r26,r5) }

l0001DBDC:
	{ r1 = 0000005C; r3 = add(badva,00000006) }
	{ if (cmp.gtu(r7,r13.new)) jump:t	0001DC00; r13 = add(r8,r6) }
...
0001DBFC                                     00 40 00 78             .@.x

l0001DC00:
	{ memw(r23+4) = r21; memw(r23+24) = r14 }
...
l0001DC7C:
	{ r0 = memd(r29+32); r18 = r19 }
	{ if (!p0.new) jump:nt	0001DCAC; p0 = r0 }

l0001DC88:
	{ r16 = add(r16,r23); r2 = r17; r1:r0 = combine(r16,r18); call	fn00009560 }

l0001DC90:
	{ r16 = add(r16,r23); r2 = r17 }
	{ if (!cmp.eq(r22.new,00000001)) jump:t	0001DC90; r22 = add(r22,FFFFFFFF); r18 = add(r18,r17) }

l0001DCA4:
	{ r19 = add(r19,r2) }
	{ if (!cmp.eq(r27.new,r21)) jump:t	0001DC7C; r27 = add(r27,00000001); r24 = add(r24,r25) }

l0001DCAC:
	{ if (!cmp.eq(r27.new,r21)) jump:t	0001DC7C; r27 = add(r27,00000001) }
...
l0001DCB8:
	{ r3 = memw(r29+16) }
	{ if (!cmp.eq(r7.new,r20)) jump:t	0001DC64; r7 = add(r7,00000001); r3 = add(r3,r2) }
...
split_check_f proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000020) }
	{ r17 = r0; r16 = r1; r1 = 00000075 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	0001DD24; r2 = memw(r17+16); r1 = 00000076 }

l0001DD14:
	{ jump	0001DD3C; r3 = add(badva,0000000F) }
0001DD1C                                     E1 4E 00 78             .N.x
0001DD20 00 40 00 78                                     .@.x            

l0001DD24:
	{ if (!cmp.eq(r2.new,00000000)) jump:t	fn0001DD4C; r2 = memw(r17+20) }
...
;; fn0001DD4C: 0001DD4C
;;   Called from:
;;     0001DD24 (in split_check_f)
;;     0001DD44 (in qsplit_execute_8)
fn0001DD4C proc
	...
	{ memw(r2+12) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r5.new)) jump:t	fn0001DD98; r5 = memw(r2+20) }

;; fn0001DD8C: 0001DD8C
;;   Called from:
;;     0001DD80 (in fn0001DD4C)
;;     0001DD80 (in fn0001DD4C)
fn0001DD8C proc
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
	{ r3 = memw(r16+4); r2 = memw(r16+8) }
...
fn0001DD98 proc
	...
	{ memw(r2+12) = r1; memw(r2+8) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	0001DDD0; r6 = memw(r2+20) }
...
qsplit_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000028) }
	{ r17 = r0; r16 = r1; r1 = 0000007D }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000008)) jump:t	0001DE1C; r2 = memw(r17+16); r1 = 0000007E }

l0001DE0C:
	{ jump	0001DE34; r3 = add(badva,00000017) }
0001DE14             E1 4F 00 78 00 40 00 78                 .O.x.@.x    

l0001DE1C:
	{ if (cmp.gtu(r2.new,00000004)) jump:t	fn0001DE44; r2 = memw(r17+20) }
...
;; fn0001DE44: 0001DE44
;;   Called from:
;;     0001DE1C (in qsplit_check)
fn0001DE44 proc
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function }

;; fn0001DE4C: 0001DE4C
;;   Called from:
;;     0001DE44 (in fn0001DE44)
;;     0001DE44 (in fn0001DE44)
;;     0001DE44 (in fn0001DE44)
fn0001DE4C proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000025) }
...
split_impl proc
	...
	{ r2 = r17; r1 = 00000046; r4 = add(badva,00000022) }
	{ memw(r29) = r22; r24 = memw(r21+16); r21 = r0; call	logmsg_function }
	{ if (p0.new) jump:nt	0001DF24; p0 = cmp.eq(r8,00000002) }

l0001DEFC:
	{ if (!p1.new) jump:t	0001DF78; p1 = cmp.gt(r8,00000000); loop0(0001DF04,r16) }

l0001DF04:
	{ r4 = memw(r3) }
	{ if (!cmp.gtu(r21,r5.new)) jump:t	0001DF60; r5 = memw(r4+20) }

l0001DF14:
	{ memw(r29) = r2; r1 = 0000004D; r3 = add(badva,0000003C) }
	{ jump	0001DFF4 }
...
l0001DF24:
	...
	{ memw(r2+12) = r1; memw(r2+8) = r7 }
	{ r4 = memw(r3+24) }
	{ if (cmp.gtu(r4,r6.new)) jump:t	0001E004; r6 = memw(r2+20) }

l0001DF50:
	{ r1 = memw(r3+16); r2 = memw(r3+24); call	fn00009560 }
	{ jump	0001E000; r0 = 00000000 }
0001DF5C                                     4D 06 22 71             M."q

l0001DF60:
	{ r4 = memw(r3++#4) }
	{ memw(r4+8) = r26; memw(r4+4) = r27 }
	{ memw(r4) = r25; memw(r4+12) = r19 }
	{ memb(r29+2) = r2.new; r1:r0 = combine(r16,r20); call	fn00009774; r2 = p1 }

l0001DF78:
	{ memb(r29+2) = r2.new; r1:r0 = combine(r16,r20); call	fn00009774 }

l0001DF88:
	{ if (p0.new) r20 = 00000000; r1 = 00000057 }
	{ r1 = memd(r29+8); r0 = 00000000; r2 = mpyi(r27,r26); r17 = mpyi(r19,r18) }
	{ if (!p0.new) jump:nt	0001E004; p0 = r1 }
...
l0001DFD0:
	{ r19 = add(r19,r21); r2 = r17 }
	{ if (!cmp.eq(r25.new,00000001)) jump:t	0001DFD0; r25 = add(r25,FFFFFFFF); r18 = add(r18,r17) }

l0001DFE0:
	{ if (!cmp.eq(r20.new,r16)) jump:t	0001DFB4; r20 = add(r20,00000001) }
...
tanh_execute proc
	{ allocframe(00000028); memd(r29+496) = r17:r16; r4 = add(badva,00000020) }
	{ r17:r16 = combine(r0,r1) }
	...
	{ r2 = r16; r3 = mpyi(r2,r5) }
	{ r20 = mpyi(r3,r6) }
	{ call	fn0001E168; r23 = asl(r20,00000002) }
	{ if (!cmp.gtu(r23,r2.new)) jump:t	0001E090; r2 = memw(r22+20) }

l0001E078:
	{ r2 = r16; r1 = 00000038; r3 = add(badva,00000023) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001E0E0 }
0001E08C                                     00 40 14 75             .@.u

l0001E090:
	{ r3 = memw(r21+4); r2 = memw(r21) }
	{ memw(r22) = r2; memw(r22+4) = r3 }
	{ r6 = memw(r21+8) }
	{ memw(r22+8) = r6 }
	{ r7 = memw(r21+12) }
...
l0001E0C4:
	{ r2 = r16; r1 = 00000040; r4 = add(badva,00000021) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
...
tanh_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001E134; r2 = memw(r17+16); r1 = 00000047 }
...
l0001E124:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001E12C                                     01 49 00 78             .I.x
0001E130 A2 40 91 91                                     .@..            

l0001E134:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001E14C }

l0001E13C:
	{ jump	0001E124; r3 = add(badva,00000022) }
0001E144             D5 42 00 00 04 53 49 6A                 .B...SIj    
...
;; fn0001E174: 0001E174
;;   Called from:
;;     0001E168 (in fn0001E168)
;;     0001E168 (in logmsg_function)
fn0001E174 proc
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000029) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
sigmoid_execute proc
	{ allocframe(00000028); memd(r29+496) = r17:r16; r4 = add(badva,00000032) }
	{ r17:r16 = combine(r0,r1) }
	{ memd(r29+16) = r21:r20; r2 = memw(r17+4); r1 = 00000037 }
	{ r3 = memw(r17+8) }
	{ memd(r29+24) = r19:r18; memd(r29+8) = r23:r22 }
	...
	{ r2 = r16; r3 = mpyi(r2,r5) }
	{ r20 = mpyi(r3,r6) }
	{ call	fn0001E318; r23 = asl(r20,00000002) }
	{ if (!cmp.gtu(r23,r2.new)) jump:t	0001E220; r2 = memw(r22+20) }

l0001E208:
	{ r2 = r16; r1 = 00000038; r3 = add(badva,00000038) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001E290 }
0001E21C                                     00 40 14 75             .@.u
...
l0001E244:
	...
	{ call	fn000097F4 }
	{  }
	{ r20 = r20; r18 = add(r18,00000004) }
	{ p0 = cmp.eq(r20,00000000) }
	{  }
	{  }

l0001E274:
	{ r2 = r16; r1 = 00000040; r4 = add(badva,00000016) }
...
sigmoid_check proc
	...
	{ r17 = r0; r16 = r1; r1 = 00000046 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001E2E4; r2 = memw(r17+16); r1 = 00000047 }

l0001E2C8:
	{ r3 = add(badva,00000026) }
	{ r2 = r16; call	errlog_function }

l0001E2D4:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001E2DC                                     01 49 00 78             .I.x
0001E2E0 A2 40 91 91                                     .@..            

l0001E2E4:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001E2FC }

l0001E2EC:
	{ jump	0001E2D4; r3 = add(badva,00000011) }
0001E2F4             D1 42 00 00 84 4A 49 6A                 .B...JIj    
...
;; fn0001E324: 0001E324
;;   Called from:
;;     0001E318 (in fn0001E318)
;;     0001E318 (in logmsg_function)
fn0001E324 proc
...
qtanh_execute_ref proc
	...
	{  }
	{ r21 = memw(r7+4); r20 = memw(r7+8) }
	{ r24 = memw(r27+16); r22 = memw(r26+16) }
	{ call	fn00009614; r25 = mpyi(r2,r5) }
	{ r2 = r17; r1 = 00000042; r4 = add(badva,0000003E) }
	{ memw(r29) = r16; r19 = r0; call	logmsg_function }
	{ if (!cmp.gtu(r25,r2.new)) jump:t	0001E424; r2 = memw(r27+20); p0 = cmp.eq(r25,00000000) }

l0001E404:
	{ r2 = r17; r1 = 00000043; r3 = add(badva,00000003) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001E4E8 }
0001E41C                                     02 40 9A 91             .@..
0001E420 23 C0 9A 91                                     #...            
...
l0001E460:
	...
	{  }
	{ call	fn000097F4; r0 += sfmpy(r19,r2) }
	{  }
	{ r25 = add(r25,FFFFFFFF); r2 = r17 }
...
l0001E49C:
	{ memw(r21+12) = 00000001; r2 = memw(r21+16); r4 = add(badva,00000035) }
...
qtanh_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001E548; r2 = memw(r17+16); r1 = 00000095 }
...
l0001E538:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001E540 C1 52 00 78 A2 40 91 91                         .R.x.@..        

l0001E548:
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001E560 }

l0001E550:
	{ jump	0001E538; r3 = add(badva,00000037) }
0001E558                         D0 42 00 00 84 5D 49 6A         .B...]Ij
...
qtanh_execute_hvx proc
	{ allocframe(00000050); memd(r29+496) = r17:r16; r4 = add(badva,0000001A) }
	...
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0001E614; r2 = memb(r16+32); r1 = 00000073 }
...
0001E60C                                     02 5B 16 ED             .[..
0001E610 81 4E 00 78                                     .N.x            

l0001E614:
	{ r3 = memw(r18+20) }
	{ r2 = mpyi(r2,r20) }
	{ if (!cmp.gtu(r20.new,r3)) jump:t	0001E634; r20 = mpyi(r2,r26) }

l0001E628:
	{ jump	0001E604; r3 = add(badva,0000001F) }
0001E630 F6 5F 14 B0                                     ._..            

l0001E634:
	{ memw(r29+12) = r2; r3 = memw(r21); r2 = 000000FF }
	...
	{  }
	{ r2 = C0800000 }
	{ if (!p0.new) jump:nt	0001E770; p0 = sfcmp.ge(r19,r2) }

l0001E6A0:
	{ r18 = 40800000 }
	{ if (!p0.new) jump:nt	0001E770; p0 = sfcmp.ge(r18,r24) }
...
l0001E6B0:
	...
	{  }
	{  }
	{ r25 = memw(r29+20); p0 = cmp.gt(r20,00000000) }
	{  }
	{  }
	{  }
	{ if (p0) r2 = memw(r29+12); if (!p0) jump:nt	0001E82C }
...
l0001E828:
	{ r3 = 01010101; r2 = add(badva,00000028) }
...
l0001E900:
	...
	{ r5 = memw(r29+28); r2 = memw(r25+16); r4 = add(badva,00000005) }
...
l0001E988:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000003C) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     0001E97C (in logmsg_function)
;;     0001E990 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000020) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
qsigmoid_execute_ref proc
	...
	{ r24 = memw(r27+16); r22 = memw(r26+16) }
	{ call	fn00009614; r25 = mpyi(r2,r5) }
	{ r2 = r17; r1 = 00000042; r4 = add(badva,00000011) }
	{ memw(r29) = r16; r19 = r0; call	logmsg_function }
	{ if (!cmp.gtu(r25,r2.new)) jump:t	0001EA94; r2 = memw(r27+20); p0 = cmp.eq(r25,00000000) }

l0001EA74:
	{ r2 = r17; r1 = 00000043; r3 = add(badva,00000019) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001EB54 }
0001EA8C                                     02 40 9A 91             .@..
0001EA90 23 C0 9A 91                                     #...            
...
l0001EB10:
	{ memw(r21+12) = 00000001; r2 = memw(r21+16); r4 = add(badva,00000007) }
...
qsigmoid_check proc
	...
	{ r17 = r0; r16 = r1; r1 = 00000095 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001EBB8; r2 = memw(r17+16); r1 = 00000096 }

l0001EB9C:
	{ r3 = add(badva,00000028) }
	{ r2 = r16; call	errlog_function }

l0001EBA8:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001EBB0 E1 52 00 78 A2 40 91 91                         .R.x.@..        

l0001EBB8:
	{ if (cmp.eq(r2.new,00000006)) jump:t	0001EBD0 }

l0001EBC0:
	{ jump	0001EBA8; r3 = add(badva,00000013) }
0001EBC8                         BF 42 00 00 84 4B 49 6A         .B...KIj
...
qsigmoid_execute_hvx proc
	{ allocframe(00000050); memd(r29+496) = r17:r16; r4 = add(badva,0000002D) }
	{ r17:r16 = combine(r1,r0) }
	...
	{ r24 = memw(r5) }
	{ memw(r29) = r16; call	logmsg_function }
	{ if (!cmp.eq(r2.new,00000000)) jump:t	0001EC84; r2 = memb(r16+32); r1 = 00000074 }
...
0001EC7C                                     02 5B 16 ED             .[..
0001EC80 A1 4E 00 78                                     .N.x            

l0001EC84:
	{ r3 = memw(r18+20) }
	{ r2 = mpyi(r2,r20) }
	{ if (!cmp.gtu(r20.new,r3)) jump:t	0001ECA4; r20 = mpyi(r2,r26) }

l0001EC98:
	{ jump	0001EC74; r3 = add(badva,00000035) }
0001ECA0 F6 5F 14 B0                                     ._..            
...
l0001ECA4:
	...
	{  }
	{ r2 = C0800000 }
	{ if (!p0.new) jump:nt	0001EDE0; p0 = sfcmp.ge(r19,r2) }

l0001ED10:
	{ r18 = 40800000 }
	{ if (!p0.new) jump:nt	0001EDE0; p0 = sfcmp.ge(r18,r24) }
...
l0001ED20:
	...
	{  }
	{  }
	{ if (p0) r2 = memw(r29+12); if (!p0) jump:nt	0001EE9C }
...
l0001EE98:
	{ r3 = 01010101; r2 = add(badva,00000038) }
...
l0001EF74:
	{ r0 = memd(r29+24); r1 = memd(r29+16); r2 = r20; call	fn00009560 }
	{ r5 = memw(r29+28); r2 = memw(r25+16); r4 = add(badva,00000017) }
...
l0001EFF8:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000000C) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     0001EFEC (in logmsg_function)
;;     0001F000 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000030) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l0001F0EC:
	{ r2 = r6; r1 = 000000BC; r0 = add(badva,00000022) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(badva,00000031) }
	{ memw(r29+88) = r7; r23 = memw(r25+16); r27 = r5; r24 = r6 }
	{ r17 = memw(r26+16) }
	{ memw(r29) = r5; memw(r29+100) = r3; call	logmsg_function }
	{ if (!cmp.gtu(r16,r2.new)) jump:t	0001F15C; r2 = memw(r25+20); r1 = 000000BC }

l0001F138:
	{ r2 = r24; r0 = add(badva,0000001A) }
	{ r3 = add(badva,0000000B) }

l0001F148:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001F380 }
0001F154             02 40 78 70 0D 40 93 91                 .@xp.@..    
...
l0001F1D8:
	{ memw(r29+28) = r12; r1 = 000000BC; r0 = add(badva,00000036) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(badva,00000029) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump	0001F148 }

l0001F20C:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(badva,00000036) }
	{ memw(r29+40) = r20; r1 = 000000BC; r4 = add(badva,00000025) }
...
l0001F338:
	{ if (!cmp.eq(r14.new,r18)) jump:t	0001F2F8; r14 = add(r14,00000001); r12 = addasl(r12,r4,00000002); r13 = addasl(r13,r22,00000002) }

l0001F348:
	{ if (!cmp.eq(r7.new,r24)) jump:t	0001F2EC; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002); r25 = addasl(r25,r8,00000002) }

l0001F34C:
	{ if (!cmp.eq(r7.new,r24)) jump:t	0001F2EC; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002) }

l0001F358:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,00000036) }

l0001F35C:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,00000036) }

l0001F36C:
	{ r2 = r19; r1 = 000000BC; r4 = add(badva,00000011) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
add_f_check proc
	...
	{ memw(r29) = r17; r2 = r16; r0 = add(badva,00000010) }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	0001F3EC; r2 = memw(r17+16); r1 = 00000038 }

l0001F3C8:
	{ r0 = add(badva,00000034) }
	{ r3 = add(badva,00000013) }
	{ r2 = r16; call	errlog_function }

l0001F3DC:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001F3E4             21 47 00 78 A2 40 91 91                 !G.x.@..    

l0001F3EC:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001F40C }

l0001F3F4:
	{ r0 = add(badva,00000008) }
	{ jump	0001F3DC; r3 = add(badva,00000036) }
0001F404             9E 42 00 00 00 5A 49 6A                 .B...ZIj    

l0001F40C:
	{ r2 = r16; r1 = 0000003A }
	{ memw(r29) = r17; call	fn0001F430; r4 = add(badva,0000002E) }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0001F42C (in logmsg_function)
;;     0001F430 (in fn0001F430)
errlog_function proc
...
mul_f_execute proc
	{ allocframe(000000A8); memd(r29+472) = r23:r22; r4 = add(badva,0000003A) }
	{  }
	{ memd(r29+120) = r27:r26; memd(r29+128) = r25:r24 }
	{ memd(r29+160) = r17:r16; r16 = r0; r2 = r23; r1 = 00000032 }
	{ memw(r29) = r16; r0 = add(badva,00000000) }
	...
	{ memw(r29+84) = r1; if (p0) jump:nt	0001F534; r17 = asl(r2,00000002) }

l0001F52C:
	{ r22 = mpyi(r6,r12) }
	{ r2 = r23; r1 = 000000BC; r0 = add(badva,00000008) }

l0001F534:
	{ r2 = r23; r1 = 000000BC; r0 = add(badva,00000008) }

l0001F540:
	{ memw(r29+92) = r6; r27 = r23; r4 = add(badva,00000017) }
	{ r6 = memw(r19+16) }
	{ memw(r29+68) = r12; r23 = memw(r3+16) }
	{ r26 = memw(r16+16); r25:r24 = combine(r3,r5) }
	{ memw(r29) = r5; memw(r29+108) = r6; call	logmsg_function }
	{ if (!cmp.gtu(r17,r2.new)) jump:t	0001F5A0; r2 = memw(r25+20); r1 = 000000BC }

l0001F57C:
	{ r2 = r27; r0 = add(badva,00000000) }
	{ r3 = add(badva,00000031) }

l0001F58C:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001F7AC }
0001F598                         85 00 B2 00 00 42 05 F2         .....B..

l0001F5A0:
	{ r7 = memw(r16+8); r8 = memw(r16+12) }
...
l0001F614:
	{ memw(r29+28) = r12; r1 = 000000BC; r0 = add(badva,00000024) }
	{ memw(r29+16) = r2; memw(r29+24) = r9 }
	{ memw(r29+4) = r6; memw(r29+20) = r3; r3 = add(badva,00000017) }
	{ memw(r29+8) = r7; r2 = memd(r29+104) }
	{ memw(r29) = r5; memw(r29+12) = r8 }
	{ jump	0001F58C }

l0001F648:
	{ memw(r29+44) = r21; r19 = memd(r29+112); r0 = add(badva,00000030) }
	{ memw(r29+32) = r19; r1 = 000000BC; r4 = add(badva,0000001F) }
...
l0001F764:
	{ if (!cmp.eq(r14.new,r18)) jump:t	0001F724; r14 = add(r14,00000001); r12 = addasl(r12,r4,00000002); r13 = addasl(r13,r22,00000002) }

l0001F774:
	{ if (!cmp.eq(r7.new,r19)) jump:t	0001F718; r7 = add(r7,00000001); r17 = addasl(r17,r9,00000002); r24 = addasl(r24,r8,00000002) }

l0001F778:
	{ if (!cmp.eq(r7.new,r19)) jump:t	0001F718; r7 = add(r7,00000001); r17 = addasl(r17,r9,00000002) }

l0001F784:
	{ memb(r29) = r2.new; r2 = memw(r29+64); r0 = add(badva,00000034) }

l0001F788:
	{ memb(r29) = r2.new; r2 = memw(r29+64); r0 = add(badva,00000034) }

l0001F798:
	{ r2 = memw(r29+104); r1 = 000000BC; r4 = add(badva,0000000F) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
mul_f_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000002F) }
	{ r16 = r1; r1 = 00000038; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(badva,00000000) }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	0001F818; r2 = memw(r17+16); r1 = 00000039 }

l0001F7F4:
	{ r0 = add(badva,00000024) }
	{ r3 = add(badva,00000003) }
	{ r2 = r16; call	errlog_function }

l0001F808:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001F810 41 47 00 78 A2 40 91 91                         AG.x.@..        

l0001F818:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001F838 }

l0001F820:
	{ r0 = add(badva,00000038) }
	{ jump	0001F808; r3 = add(badva,00000026) }
0001F830 92 42 00 00 00 52 49 6A                         .B...RIj        

l0001F838:
	{ r2 = r16; r1 = 0000003B }
	{ memw(r29) = r17; call	fn0001F85C; r4 = add(badva,0000001E) }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0001F858 (in logmsg_function)
;;     0001F85C (in fn0001F85C)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r3 = 00000000 }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); call	logv }
	{ r0 = memw(r0); r0 = memw(r0) }
...
neg_f_execute proc
	...
	{ r2 = r1; r7 = mpyi(r2,r7) }
	{ if (cmp.gtu(r5.new,r6)) jump:t	0001F914; r5 = asl(r7,00000002) }
...
l0001F8D8:
	...
	{ dealloc_return }
0001F910 95 42 00 00                                     .B..            

l0001F914:
	{ r1 = 00000036; call	fn0001F9CC; r3 = add(badva,00000004) }
	{ dealloc_return; r0 = -00000001 }
...
neg_f_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001F96C; r2 = memw(r17+16); r1 = 00000042 }

l0001F950:
	{ r3 = add(badva,00000019) }
	{ r2 = r16; call	errlog_function }

l0001F95C:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001F964             61 48 00 78 A2 40 91 91                 aH.x.@..    

l0001F96C:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001F984 }

l0001F974:
	{ jump	0001F95C; r3 = add(badva,00000004) }
0001F97C                                     93 42 00 00             .B..
0001F980 04 44 49 6A                                     .DIj            
...
l0001FA9C:
	{ r2 = r6; r1 = 000000BC; r0 = add(badva,0000001C) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(badva,0000002B) }
	{ memw(r29+88) = r7; r23 = memw(r25+16); r27 = r5; r24 = r6 }
	{ r17 = memw(r26+16) }
	{ memw(r29) = r5; memw(r29+100) = r3; call	logmsg_function }
	{ if (!cmp.gtu(r16,r2.new)) jump:t	0001FB0C; r2 = memw(r25+20); r1 = 000000BC }

l0001FAE8:
	{ r2 = r24; r0 = add(badva,00000014) }
	{ r3 = add(badva,00000005) }

l0001FAF8:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001FD30 }
0001FB04             02 40 78 70 0D 40 93 91                 .@xp.@..    
...
l0001FB88:
	{ memw(r29+28) = r12; r1 = 000000BC; r0 = add(badva,00000030) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(badva,00000023) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump	0001FAF8 }

l0001FBBC:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(badva,00000030) }
	{ memw(r29+40) = r20; r1 = 000000BC; r4 = add(badva,0000001F) }
	{ memw(r29+28) = r12; memw(r29+32) = r24 }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+12) = r8 }
	{ memw(r29) = r5; memw(r29+4) = r6 }
...
l0001FCE8:
	{ if (!cmp.eq(r14.new,r18)) jump:t	0001FCA8; r14 = add(r14,00000001); r12 = addasl(r12,r4,00000002); r13 = addasl(r13,r22,00000002) }

l0001FCF8:
	{ if (!cmp.eq(r7.new,r24)) jump:t	0001FC9C; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002); r25 = addasl(r25,r8,00000002) }

l0001FCFC:
	{ if (!cmp.eq(r7.new,r24)) jump:t	0001FC9C; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002) }

l0001FD08:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,00000030) }

l0001FD0C:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,00000030) }

l0001FD1C:
	{ r2 = r19; r1 = 000000BC; r4 = add(badva,0000000B) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
sub_f_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000039) }
	{ r16 = r1; r1 = 00000037; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(badva,0000000A) }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	0001FD9C; r2 = memw(r17+16); r1 = 00000038 }

l0001FD78:
	{ r0 = add(badva,0000002E) }
	{ r3 = add(badva,0000000D) }
	{ r2 = r16; call	errlog_function }

l0001FD8C:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001FD94             21 47 00 78 A2 40 91 91                 !G.x.@..    

l0001FD9C:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001FDBC }

l0001FDA4:
	{ r0 = add(badva,00000002) }
	{ jump	0001FD8C; r3 = add(badva,00000030) }
0001FDB4             82 42 00 00 00 57 49 6A                 .B...WIj    

l0001FDBC:
	{ r2 = r16; r1 = 0000003A }
	{ memw(r29) = r17; call	fn0001FDE0; r4 = add(badva,00000028) }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0001FDDC (in logmsg_function)
;;     0001FDE0 (in fn0001FDE0)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r3 = 00000000 }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); call	logv }
	{ r0 = memw(r0); r0 = memw(r0) }
...
rank_execute proc
	{ allocframe(00000018); memd(r29+496) = r17:r16; r4 = add(badva,00000004) }
	...
	{ if (cmp.gtu(r2.new,00000006)) jump:t	0001FE70; r2 = memw(r19+20) }

l0001FE58:
	{ r2 = r17; r1 = 00000035; r3 = add(badva,00000027) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	0001FE9C }
0001FE6C                                     86 42 00 00             .B..

l0001FE70:
	{ r3 = memw(r19+16); r1 = 0000003B; r4 = add(badva,0000001D) }
...
rank_check proc
	...
	{ r17 = r0; r16 = r1; r1 = 00000041 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	0001FEEC; r2 = memw(r17+16); r1 = 00000042 }

l0001FED0:
	{ r3 = add(badva,00000022) }
	{ r2 = r16; call	errlog_function }

l0001FEDC:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0001FEE4             61 48 00 78 A2 40 91 91                 aH.x.@..    

l0001FEEC:
	{ if (cmp.eq(r2.new,00000002)) jump:t	0001FF04 }

l0001FEF4:
	{ jump	0001FEDC; r3 = add(badva,0000000D) }
0001FEFC                                     83 42 00 00             .B..
0001FF00 84 48 49 6A                                     .HIj            
...
range_execute proc
	{ allocframe(00000028); memd(r29+496) = r17:r16; r4 = add(badva,0000000E) }
	{ r17:r16 = combine(r0,r1) }
...
l0001FFBC:
	{  }
	{ if (cmp.gtu(r19,r3.new)) jump:t	0001FFC8; r3 = add(r3,r21); r2 = add(r2,00000001) }

l0001FFC8:
	{ if (cmp.gtu(r19,r3.new)) jump:t	0001FFC8 }

l0001FFD0:
	{ if (!p1.new) jump:nt	0001FFE0; p1 = cmp.gt(r12,-00000001) }

l0001FFD4:
	{ if (cmp.gt(r19,r3.new)) jump:t	0001FFDC; r3 = add(r3,r21); r2 = add(r2,00000001) }

l0001FFDC:
	{ if (cmp.gt(r19,r3.new)) jump:t	0001FFDC }

l0001FFE0:
	{ r4 = memw(r22+20) }

l0001FFE4:
	{ if (!cmp.gtu(r3.new,r4)) jump:t	00020008; r3 = asl(r2,00000002) }

l0001FFF0:
	{ r2 = r16; r1 = 0000003F; r3 = add(badva,0000002A) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00020050 }
00020004             E1 11 E0 F1                             ....        
...
l0002001C:
	{ if (cmp.gtu(r19,r20.new)) jump:t	0002001C; r20 = add(r20,r21) }
...
l00020034:
	{ r2 = r16; r1 = 00000049; r4 = add(badva,00000030) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
...
range_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000006)) jump:t	000200A4; r2 = memw(r17+16); r1 = 00000050 }
...
l00020094:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
0002009C                                     21 4A 00 78             !J.x
000200A0 A2 40 91 91                                     .@..            

l000200A4:
	{ if (cmp.eq(r2.new,00000002)) jump:t	000200BC }

l000200AC:
	{ jump	00020094; r3 = add(badva,0000002F) }
000200B4             7E 42 00 00 84 59 49 6A                 ~B...YIj    
...
l000200E4:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000036) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     000200D8 (in logmsg_function)
;;     000200EC (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,0000001A) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }

;; transpose_execute: 00020120
transpose_execute proc
	{ allocframe(+00000090); r2 = add(badva,00000008) }
	...
	{ memw(r13) = r26; r24 = memw(r4); r4 = add(badva,00000034) }
	...
	{ call	logmsg_function }
	{ if (!cmp.eq(r2.new,00000002)) jump:t	000201F8; r2 = memw(r25) }
...
l000201F8:
	{ r1 = 0000004B; r3 = add(badva,0000003E) }
	{ r2 = r16; call	errlog_function }
...
l00020214:
	{ if (!cmp.gtu(r2,r3.new)) jump:t	00020230; r3 = memw(r24+20) }

l00020220:
	{ r1 = 0000004C; jump	00020208; r3 = add(badva,0000001F) }
0002022C                                     C3 C0 99 91             ....

l00020230:
	{ if (cmp.gtu(r4.new,r3)) jump:t	0002024C; r4 = 00000014 }

l0002023C:
	{ r1 = 0000004E; jump	00020208; r3 = add(badva,00000011) }
00020248                         25 42 03 8C                     %B..    

l0002024C:
	{ if (!cmp.eq(r5.new,00000002)) jump:t	000202A0; r1 = 00000052 }
...
l00020258:
	...
	{ jump	00020414 }
00020298                         0C 40 45 10 2C 60 15 73         .@E.,`.s

l000202A0:
	{ if (!p0.new) r4 = memw(r25+16) }
	{ r7:r6 = combine(00000001,00000002); r5 = 00000000; r8 = 00000003 }
	{ jump	00020320 }
000202B0 82 40 45 76 20 40 85 75 56 33 43 2D 00 41 06 60 .@Ev @.uV3C-.A.`
000202C0 43 C3 02 C4 0A 40 20 5C 25 C0 84 9B 05 C2 05 F3 C....@ \%.......
000202D0 25 80 84 9B 08 C5 83 AB 02 42 05 F3 09 C6 1D B0 %........B......
000202E0 02 4A 1D B0 08 C2 83 AB 04 42 C2 8C 03 48 1D B0 .J.......B...H..
000202F0 66 1D 45 3D E8 42 9D 91 C2 C0 92 91 07 40 84 91 f.E=.B.......@..
00020300 0D E6 83 3A 1B 65 83 3A 16 E5 89 3A 14 66 89 3A ...:.e.:...:.f.:
00020310 15 E8 89 3A 0C 68 83 3A 17 E7 89 3A 1A E7 83 3A ...:.h.:...:...:

l00020320:
	{ memw(r24+12) = r21; memw(r24+24) = r2; r4 = add(badva,0000002D) }
	{  }
	...
	{ memw(r29) = r5; call	logmsg_function }
	{ r3:r2 = combine(00000000,00000000); if (!p0.new) jump:nt	00020400; p0 = cmp.gt(r14,00000000); r1:r0 = vaslw(r25:r24,00000002) }
...
l0002038C:
	{ r8 = r6; if (!p0.new) jump:nt	000203E8; p0 = cmp.gt(r12,00000000); loop1(00020398,r20) }
...
l000203D8:
	...
	{ if (!cmp.eq(r7.new,r23)) jump:t	00020394; r7 = add(r7,00000001); r6 = add(r6,r4) }

l000203E8:
	{ if (!cmp.eq(r7.new,r23)) jump:t	00020394; r7 = add(r7,00000001) }

l000203F0:
	{ if (!cmp.eq(r3.new,r22)) jump:t	0002038C; r3 = add(r3,00000001); r2 = add(r2,r5) }

l000203F4:
	{ if (!cmp.eq(r3.new,r22)) jump:t	0002038C; r3 = add(r3,00000001) }
...
transpose_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000025) }
	{ r17 = r0; r16 = r1; r1 = 0000009C }
	{ call	logmsg_function }
	{ memw(r29) = r17 }
	{ if (cmp.eq(r2.new,00000006)) jump:t	00020478; r2 = memw(r17+16); r1 = 0000009D }

l0002045C:
	{ r3 = add(badva,00000014) }
	{ r2 = r16; call	errlog_function }

l00020468:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00020470 E1 53 00 78 A2 40 91 91                         .S.x.@..        

l00020478:
	{ if (cmp.eq(r2.new,00000002)) jump:t	00020494 }

l00020480:
	{ r1 = 0000009E; jump	00020468; r3 = add(badva,0000003F) }
0002048C                                     71 42 00 00             qB..
00020490 84 5F 49 6A                                     ._Ij            
...
l000204B8:
	{ r6 = add(r29,00000010); r5 = add(r29,00000010); r0 = add(badva,0000003E) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
addn_execute proc
	{ allocframe(00000030); memd(r29+496) = r17:r16; r4 = add(badva,00000014) }
	{ r17:r16 = combine(r0,r1) }
	...
	{ r2 = memw(r17+16) }
	{ if (cmp.gtu(r3.new,r2)) jump:t	000205A4; r3 = 00000002 }

l0002053C:
	{ r4 = add(r18,00000004) }
	{ if (!cmp.gtu(r2,r5.new)) jump:nt	000205A8; r5 = add(r5,00000001); r4 = add(r4,00000004) }

l0002054C:
	{ r6 = memw(r4); r3 = add(badva,0000000F) }

l00020550:
	{ r6 = memw(r4); r3 = add(badva,0000000F) }

l00020558:
	{ if (cmp.eq(r7.new,r25)) jump:t	00020568; r7 = memw(r6) }

l00020564:
	{ if (cmp.eq(r7.new,r24)) jump:t	00020584; r7 = memw(r6+4); r3 = add(badva,00000037) }

l00020568:
	{ if (cmp.eq(r7.new,r24)) jump:t	00020584; r7 = memw(r6+4); r3 = add(badva,00000037) }

l00020578:
	{ if (cmp.eq(r7.new,r23)) jump:t	00020598; r7 = memw(r6+8); r3 = add(badva,00000023) }

l00020584:
	{ if (cmp.eq(r7.new,r23)) jump:t	00020598 }

l0002058C:
	{ if (cmp.eq(r6.new,r22)) jump:t	0002054C; r6 = memw(r6+12); r3 = add(badva,0000000F) }

l00020598:
	{ if (cmp.eq(r6.new,r22)) jump:t	0002054C }

l000205A0:
	{ r5 = memw(r21+20); r2 = mpyi(r24,r25); r3 = add(badva,0000000A) }

l000205A4:
	{ r5 = memw(r21+20); r2 = mpyi(r24,r25); r3 = add(badva,0000000A) }

l000205A8:
	{ r5 = memw(r21+20); r2 = mpyi(r24,r25) }

l000205B0:
	{ r1 = 00000040; r2 = mpyi(r2,r23) }
	{ r4 = mpyi(r2,r22) }
	{ if (!cmp.gtu(r2.new,r5)) jump:t	000205D8; r2 = asl(r4,00000002) }

l000205C8:
	{ r2 = r16 }
	{ r0 = FFFFFFFF; jump	00020654 }
000205D4             00 40 04 75                             .@.u        

l000205D8:
	{ r3 = memw(r20); r5 = memw(r20+4) }
...
l00020638:
	{ r2 = r16; r1 = 0000004C; r4 = add(badva,00000000) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
...
addn_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.gtu(r2.new,00000002)) jump:t	000206AC; r2 = memw(r17+16); r1 = 00000053 }
...
l0002069C:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
000206A4             81 4A 00 78 A2 40 91 91                 .J.x.@..    

l000206AC:
	{ if (cmp.eq(r2.new,00000002)) jump:t	000206C4 }

l000206B4:
	{ jump	0002069C; r3 = add(badva,0000002E) }
000206BC                                     6E 42 00 00             nB..
000206C0 04 59 49 6A                                     .YIj            
...
execute_qinstancenorm_ref proc
	...
	{ call	fn000095F4; r20 = mpyi(r3,r27) }
	{ if (!cmp.gtu(r20,r2.new)) jump:t	000207D0; r2 = memw(r18+20); r1 = 00000071 }

l000207B4:
	{ r3 = add(badva,00000016) }
	{ r2 = r17; call	errlog_function }

l000207C0:
	{ r0 = FFFFFFFF; jump	00020AA8 }
000207C8                         0C 41 0B 10 41 6E 80 7E         .A..An.~

l000207D0:
	{ memw(r29+40) = r26 }
	{ jump	000207C0; r3 = add(badva,00000000) }
000207E0 02 40 71 70 03 5B 92 A1 02 D8 92 A1 01 D9 92 A1 .@qp.[..........
000207F0 01 40 52 3C 03 DB 9D A1 02 58 9D A1 01 D9 9D A1 .@R<.....X......
00020800 F4 42 00 5A 01 C0 5D 3C 00 40 58 75 0C 40 7B 70 .B.Z..]<.@Xu.@{p
00020810 06 D4 92 A1 00 40 40 89 34 40 20 5C 0C D4 BD A1 .....@@.4@ \....
00020820 43 50 0C C4 A2 3C 04 48 18 40 39 60 26 48 20 5C CP...<.H.@9`&H \
00020830 00 C0 59 75 1A 48 20 5C 05 40 63 70 00 40 4C 75 ..Yu.H \.@cp.@Lu
00020840 06 F0 02 FD 08 C0 0C 60 28 40 27 9B 09 C0 86 91 .......`(@'.....
00020850 09 C8 09 F3 08 C9 86 AB 0D C0 85 91 0D 88 08 E3 ................
00020860 08 D2 A5 AB 02 CC 02 F3 00 40 00 7F 00 80 00 7F .........@......
00020870 00 C0 00 7F 24 40 04 B0 DA F8 72 20 02 59 18 ED ....$@....r .Y..
00020880 00 40 4C 75 18 40 6C 70 09 D8 9D A1 00 40 40 89 .@Lu.@lp.....@@.
00020890 13 40 18 74 6D 08 8F E8 16 5F 72 03 9A 45 00 7E .@.tm...._r..E.~
000208A0 72 08 5E E8 3E 40 20 5C 00 40 F8 03 12 40 00 7E r.^.>@ \.@...@.~
000208B0 0E C0 9D A1 95 41 18 E0 56 43 18 8C 72 3C 8C 50 .....A..VC..r<.P
000208C0 5B 50 18 C4 11 C0 42 8B C2 00 91 50 00 40 22 8B [P....B....P.@".
000208D0 A2 C6 FD 5B 02 56 14 F3 01 40 71 70 17 D5 14 F3 ...[.V...@qp....
000208E0 42 5F C0 8C 00 C0 82 A1 23 40 9B 9B 04 C0 94 91 B_......#@......
000208F0 00 40 23 8B 03 C0 24 8B 80 43 02 EF 8C C6 FD 5B .@#...$..C.....[
00020900 02 DA 00 EB 7E 47 FD 5B F0 00 20 70 82 46 FD 5B ....~G.[.. p.F.[
00020910 00 52 00 F5 BB 33 4C 20 D8 40 7B 10 00 C0 97 A1 .R...3L .@{.....
00020920 04 40 78 70 80 C1 9D 91 9B 50 04 C4 00 C0 40 85 .@xp.....P....@.
00020930 0C 40 00 5C 00 40 00 00 12 C0 00 7E 00 40 00 00 .@.\.@.....~.@..
00020940 12 C0 00 78 60 C9 0A 17 62 40 04 E0 43 C1 04 8C ...x`...b@..C...
00020950 43 50 03 C4 05 40 00 78 11 40 72 70 0C D6 BD A1 CP...@.x.@rp....
00020960 42 50 02 C4 43 C1 9D 91 0B C2 9D A1 00 40 59 75 BP..C........@Yu
00020970 A5 28 0D 68 42 C0 20 5C C0 C1 9D 91 00 40 40 85 .(.hB. \.....@@.
00020980 3A 48 20 5C 1A 60 03 74 18 E4 03 FD 57 5B 04 C4 :H \.`.t....W[..
00020990 16 40 64 70 CB 1C BC 3C 22 40 39 9B 03 C0 93 91 .@dp...<"@9.....
000209A0 02 40 42 8B 04 C0 94 91 22 C3 02 EB 10 42 44 EB .@B....."....BD.
000209B0 9B 40 1B B0 00 D4 BB A1 FC 46 FD 5B 00 D0 12 F5 .@.......F.[....
000209C0 20 46 FD 5B 12 40 60 70 00 D0 11 F5 93 40 13 B0  F.[.@`p.....@..
000209D0 09 30 4C 20 F6 7F F6 BF E2 E0 72 24 03 40 7A 70 .0L ......r$.@zp
000209E0 04 40 78 70 1B 40 77 70 B9 C1 9D 91 03 C4 03 F3 .@xp.@wp........
000209F0 35 40 15 B0 C4 F9 72 20 92 1C A5 3C 25 40 05 B0 5@....r ...<%@..
00020A00 B8 E2 72 20 E2 C0 9D 91 13 44 02 ED 36 C0 C2 24 ..r .....D..6..$
00020A10 21 52 11 EB DC 46 8D 03 E0 C2 00 78 5B 42 13 8E !R...F.....x[B..
00020A20 F2 C5 FD 5B 00 7C 37 04 02 C0 00 78 F2 45 FD 5B ...[.|7....x.E.[
00020A30 00 C2 00 F5 08 30 0C 28 9B 40 1B B0 02 C0 9B 91 .....0.(.@......
00020A40 22 D2 02 EB 00 50 42 EB EE C5 FD 5B 22 40 80 8B "....PB....["@..
00020A50 83 3C BB 53 01 C0 13 75 E2 5F 42 75 E0 7F 62 75 .<.S...u._Bu..bu
00020A60 E2 FF 4F 7E 02 C0 94 74 08 C2 03 AB E6 61 FF 5C ..O~...t.....a.\
00020A70 08 C3 9D A1 00 40 00 78 63 1C 54 3C 81 C1 44 3C .....@.xc.T<..D<
00020A80 41 11 42 F1 32 11 40 F1 33 11 30 F1 81 C0 43 3C A.B.2.@.3.0...C<
00020A90 82 C0 84 91 00 D2 82 A1 87 C0 83 91 00 51 87 A1 .............Q..
00020AA0 04 C3 44 3C 04 C3 43 3C                         ..D<..C<        
...
check_qinstancenorm proc
	{ allocframe(00000000); r2 = r1 }
	{ if (cmp.eq(r3.new,00000006)) jump:t	00020AE0; r3 = memw(r0+16); r1 = 000000FC }

l00020AD0:
	{ jump	00020AF4; r3 = add(badva,0000001B) }
00020AD8                         A1 5F 00 78 03 05 00 48         ._.x...H

l00020AE0:
	{ if (p0.new) dealloc_return; p0 = cmp.eq(r3,00000003) }
00020AE4             60 42 00 00 03 C9 49 6A 6C C1 00 5A     `B....Ijl..Z
00020AF0 E0 FF DF 78                                     ...x            
...
execute_finstancenorm proc
	...
	{ if (!cmp.gtu(r3.new,r4)) jump:t	00020B78; r3 = asl(r0,00000002) }

l00020B4C:
	{ r2 = r7; r1 = 000000D6; r3 = add(badva,0000003E) }
	{ call	errlog_function }
	{ r0 = FFFFFFFF }
...
l00020B60:
	...
	{ dealloc_return }
00020B74             00 40 00 78                             .@.x        

l00020B78:
	{ r2 = memw(r2+16); r16 = memw(r7+4) }
...
l00020C10:
	{ r26 = r16; r25 = r24 }
	{ r23 = 3727C5AC }
	{ memb(r29+8) = r0.new; if (!p0) jump:nt	00020C94; r0 = p0 }
...
l00020C38:
	...
	{ memw(r20) = r0 }
	{ call	fn00009800 }
	{ r1 = r0; r0 = 00000000; call	fn00009610 }
...
l00020C98:
	...
	{ if (p0.new) r2 = memw(r29); if (!p0.new) jump:nt	00020D24; p0 = r0 }
...
l00020CC0:
	{ if (p1) r7:r6 = combine(r18,r17); if (p1) r8 = add(r22,00000000) }
...
l00020CC8:
	...
	{  }
	{ r13 = memw(r8); r8 = add(r8,00000004) }
	{  }
	{ memw(r3) = r9; r3 = add(r3,00000004) }
	{ r3 = r5; r18 = addasl(r18,r24,00000002) }

l00020D10:
	{ if (!cmp.eq(r4.new,r21)) jump:t	00020CC0; r4 = add(r4,00000001) }

l00020D18:
	{ if (!cmp.eq(r2.new,r23)) jump:t	00020CB8; r2 = add(r2,00000001) }

l00020D1C:
	{ if (!cmp.eq(r2.new,r23)) jump:t	00020CB8 }

l00020D24:
	{ if (!cmp.eq(r18.new,r14)) jump:t	00020BDC; r18 = add(r18,00000001) }

l00020D30:
	{ if (!p0.new) jump:nt	00020D80; p0 = cmp.gt(r13,00000000); loop1(00020D38,r21) }
...
l00020D70:
	{ nop; nop; nop }
	{ if (cmp.eq(r2.new,r23)) jump:nt	00020C10; r2 = add(r2,00000001) }

l00020D80:
	{ if (cmp.eq(r2.new,r23)) jump:nt	00020C10 }

;; check_finstancenorm: 00020D88
;;   Called from:
;;     00020D7C (in execute_finstancenorm)
;;     00020D80 (in execute_finstancenorm)
check_finstancenorm proc
	{ allocframe(00000000); r2 = r1 }
	{ if (cmp.eq(r3.new,00000002)) jump:t	00020DAC; r3 = memw(r0+16); r1 = 00000103 }

l00020D9C:
	{ jump	00020DC0; r3 = add(badva,0000000F) }
00020DA4             81 60 00 78 03 05 00 48                 .`.x...H    

l00020DAC:
	{ if (p0.new) dealloc_return; p0 = cmp.eq(r3,00000001) }
00020DB0 55 42 00 00 03 C3 49 6A 06 C0 00 5A E0 FF DF 78 UB....Ij...Z...x
...
logmsg_function proc
	...
	{ if (cmp.gtu(r4,r3.new)) jump:t	00020E1C; r3 = memw(r2+16) }

l00020DF8:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,00000011) }
	{ r6 = add(r29,00000010); r1 = 00000074; r4 = add(badva,00000034) }
	{ memw(r29+4) = r6; call	logv }
	{ dealloc_return }
...
l00020ECC:
	{ r2 = r6; r1 = 000000BD; r0 = add(badva,0000001D) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(badva,0000002C) }
	{ memw(r29+88) = r7; r23 = memw(r25+16); r27 = r5; r24 = r6 }
	{ r17 = memw(r26+16) }
	{ memw(r29) = r5; memw(r29+100) = r3; call	logmsg_function }
	{ if (!cmp.gtu(r16,r2.new)) jump:t	00020F3C; r2 = memw(r25+20); r1 = 000000BD }

l00020F18:
	{ r2 = r24; r0 = add(badva,00000015) }
	{ r3 = add(badva,00000006) }

l00020F28:
	{ call	errlog_function }
	{ r0 = FFFFFFFF; jump	00021160 }
00020F34             02 40 78 70 0D 40 93 91                 .@xp.@..    
...
l00020FB8:
	{ memw(r29+28) = r12; r1 = 000000BD; r0 = add(badva,00000031) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(badva,00000024) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump	00020F28 }

l00020FEC:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(badva,00000031) }
	{ memw(r29+40) = r20; r1 = 000000BD; r4 = add(badva,00000020) }
	{ memw(r29+28) = r12; memw(r29+32) = r24 }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+12) = r8 }
	{ memw(r29) = r5; memw(r29+4) = r6 }
...
l00021118:
	{ if (!cmp.eq(r14.new,r18)) jump:t	000210D8; r14 = add(r14,00000001); r12 = addasl(r12,r4,00000002); r13 = addasl(r13,r22,00000002) }

l00021128:
	{ if (!cmp.eq(r7.new,r24)) jump:t	000210CC; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002); r25 = addasl(r25,r8,00000002) }

l0002112C:
	{ if (!cmp.eq(r7.new,r24)) jump:t	000210CC; r7 = add(r7,00000001); r26 = addasl(r26,r9,00000002) }

l00021138:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,00000031) }

l0002113C:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(badva,00000031) }

l0002114C:
	{ r2 = r19; r1 = 000000BD; r4 = add(badva,0000000C) }
	{ call	logmsg_function }
	{ r0 = 00000000 }
...
sub_int32_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,0000003A) }
	{ r16 = r1; r1 = 00000037; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(badva,0000000D) }
	{ call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	000211CC; r2 = memw(r17+16); r1 = 00000038 }

l000211A8:
	{ r0 = add(badva,00000031) }
	{ r3 = add(badva,0000000E) }
	{ r2 = r16; call	errlog_function }

l000211BC:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
000211C4             21 47 00 78 A2 40 91 91                 !G.x.@..    

l000211CC:
	{ if (cmp.eq(r2.new,00000002)) jump:t	000211EC }

l000211D4:
	{ r0 = add(badva,00000005) }
	{ jump	000211BC; r3 = add(badva,00000031) }
000211E4             45 42 00 00 80 58 49 6A                 EB...XIj    

l000211EC:
	{ r2 = r16; r1 = 0000003A }
	{ memw(r29) = r17; call	fn00021210; r4 = add(badva,00000029) }
	{ r0 = 00000000 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
;;     0002120C (in logmsg_function)
;;     00021210 (in fn00021210)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r3 = 00000000 }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); call	logv }
	{ r0 = memw(r0); r0 = memw(r0) }
...
prelu_execute proc
	...
	{  }
	{ call	fn00009624 }
	{ r3 = 47800000; r4 = add(badva,0000002E) }
	{  }
	{  }
	{ r2 = r17; r1 = 00000047 }
	{ memw(r29) = r16 }
	{  }
	{ call	fn0002162C }
	{ r3 = memw(r21+16); r2 = memw(r18+16); r4 = add(badva,0000001A) }
	{ r3 = memw(r3); r2 = memw(r2); r1 = 0000004A }
	{ r2 = r17; r9:r8 = convert_sf2df(r3); r7:r6 = convert_sf2df(r2) }
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{ r2 = 3F800000 }
	{ if (p0.new) r1 = 0000004B; if (!p0.new) jump:nt	00021388; p0 = sfcmp.gt(r19,r2) }

l0002136C:
	{ r3 = add(badva,00000032) }
	{ r2 = r17; call	errlog_function }

l0002137C:
	{ r0 = FFFFFFFF; jump	00021558 }
00021384             80 53 F4 C7                             .S..        

l00021388:
	{ p1 = cmp.gt(r27,FFFFFFFF); r1 = 0000004E; if (!p0.new) jump:nt	000213A8 }

l00021394:
	{ r1 = 0000004C; jump	0002137C; r3 = add(badva,00000020) }
000213A4             06 40 93 84                             .@..        

l000213A8:
	{ r3 = memd(r29+32); r2 = memd(r29+36); p0 = cmp.gt(r27,000000FF) }
	{ r5 = memd(r29+40); r0 = memd(r29+44); if (p0) r27 = FFFFFFFF; r3 = mpyi(r2,r3) }
	{ if (!p1) r27 = 00000000; r3 = mpyi(r3,r0); r4 = add(badva,0000000E) }
	...
	{ call	logmsg_function }
	{ if (!cmp.gtu(r19,r2.new)) jump:t	00021424; r2 = memw(r25+20); p0 = cmp.eq(r19,00000000) }

l00021410:
	{ r1 = 00000050; jump	0002137C; r3 = add(badva,00000029) }
0002141C                                     02 40 98 91             .@..
00021420 23 C0 98 91                                     #...            
...
l00021454:
	{ if (!cmp.gtu(r20,r2.new)) jump:t	00021494; r2 = memb(r22); r1 = 00000058 }
...
l00021464:
	...
	{ if (!cmp.eq(r24.new,r19)) jump:t	00021454; r24 = add(r24,00000001); r22 = add(r22,00000001); r23 = add(r23,00000001) }

l00021494:
	{ if (!cmp.eq(r24.new,r19)) jump:t	00021454; r24 = add(r24,00000001) }
...
l000214A0:
	...
	{ memw(r20+12) = r7 }
	{ r2 = memw(r21+24) }
	{ if (cmp.gtu(r2,r6.new)) jump:t	000214D4; r6 = memw(r20+20) }
...
l000214D4:
	...
	{ memw(r4+12) = r7 }
	{ r2 = memw(r18+24) }
	{ if (!cmp.gtu(r2,r6.new)) jump:t	00021504; r6 = memw(r4+20) }
...
l00021504:
	{ memw(r4+24) = r2; r0 = memw(r4+16) }

l00021508:
	{ r1 = memw(r18+16); r2 = memw(r18+24); call	fn00009560 }
	{ r3 = memw(r20+16); r2 = memw(r19); r4 = add(badva,00000014) }
	{ r3 = memw(r3); r2 = memw(r2); r1 = 00000061 }
	{ r2 = r17; r9:r8 = convert_sf2df(r3); r7:r6 = convert_sf2df(r2) }
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call	logmsg_function }
	{ r2 = r17; r1 = 00000062; r4 = add(badva,00000001) }
	{ memw(r29) = r16; call	logmsg_function }
	{ r0 = 00000000 }
...
prelu_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r1 = 0000006A; r3 = add(badva,00000015) }
	{ if (!cmp.eq(r2.new,00000008)) jump:t	000215FC; r2 = memw(r17+16) }

l000215A4:
	{ r1 = 0000006B; r3 = add(badva,00000010) }
	{ if (!cmp.eq(r2.new,00000006)) jump:t	000215FC; r2 = memw(r17+20) }

l000215B8:
	{ r4 = memw(r17+4); r5 = 00000000 }
	{ if (cmp.gt(r5.new,00000004)) jump:nt	00021610; r5 = add(r5,00000001); r2 = add(r2,00000004) }

l000215C0:
	{ if (cmp.gt(r5.new,00000004)) jump:nt	00021610; r5 = add(r5,00000001) }

l000215CC:
	{ if (!cmp.eq(r6.new,00000000)) jump:t	000215EC; r6 = memw(r4++#4); r3 = add(badva,00000038) }
...
l000215EC:
	{ if (!cmp.eq(r6.new,00000001)) jump:t	000215C0; r6 = memw(r4+r2) }
...
l00021600:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00021608                         3B 42 00 00 84 47 49 6A         ;B...GIj
...
;; fn0002162C: 0002162C
;;   Called from:
;;     00021328 (in prelu_execute)
fn0002162C proc
	{ if (cmp.gtu(r3,r5.new)) jump:t	errlog_function; r5 = memw(r2+16) }

;; fn00021638: 00021638
;;   Called from:
;;     0002162C (in fn0002162C)
;;     0002162C (in logmsg_function)
fn00021638 proc
...
prelu_execute proc
	{ allocframe(00000038); memd(r29+496) = r17:r16; r4 = add(badva,00000035) }
	{ r17:r16 = combine(r0,r1) }
	...
	{ memw(r29) = r17; call	logmsg_function }
	{ r2 = 00000000 }
	{ if (!p0.new) r3 = memw(r19+20); if (p0.new) r1 = 00000039; if (!p0.new) jump:nt	00021708; p0 = sfcmp.gt(r2,r22) }

l000216EC:
	{ r3 = add(badva,00000021) }
	{ r2 = r16; call	errlog_function }

l000216FC:
	{ r0 = FFFFFFFF; jump	00021794 }
00021704             02 D9 1A ED                             ....        

l00021708:
	{ r2 = mpyi(r2,r24) }
	{ r23 = mpyi(r2,r23) }
	{ if (!cmp.gtu(r2.new,r3)) jump:t	00021728; r2 = asl(r23,00000002) }

l0002171C:
	{ jump	000216FC; r1 = 0000003A; r3 = add(badva,00000004) }
00021724             00 40 17 75                             .@.u        
...
l00021778:
	{ r2 = r16; r1 = 00000042; r4 = add(badva,00000032) }
	{ memw(r29) = r17; call	logmsg_function }
	{ r0 = 00000000 }
...
prelu_check proc
	{ allocframe(00000010); memd(r29+496) = r17:r16; r4 = add(badva,00000000) }
	{ r17 = r0; r16 = r1; r1 = 00000048 }
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ if (cmp.eq(r2.new,00000004)) jump:t	000217F0; r2 = memw(r17+16); r1 = 00000049 }
...
l000217E0:
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
000217E8                         41 49 00 78 A2 40 91 91         AI.x.@..

l000217F0:
	{ if (cmp.eq(r2.new,00000002)) jump:t	00021808 }

l000217F8:
	{ jump	000217E0; r3 = add(badva,0000001A) }
00021800 38 42 00 00 04 4F 49 6A                         8B...OIj        
...
l00021830:
	{ r5 = add(r29,00000010); r3 = 00000002; r0 = add(badva,0000001F) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); call	logv }
...
;;     00021824 (in logmsg_function)
;;     00021838 (in logmsg_function)
errlog_function proc
	{ allocframe(00000008); r4 = r3; r0 = add(badva,00000003) }
	{ memb(r29+1) = r6.new; r6 = add(r29,00000010); r5 = add(r29,00000010); r3 = 00000000 }
	{ dealloc_return }
...
l00021908:
	...
	{ r17 = memw(r16++#4) }
	{ if (!cmp.gt(r17.new,00000006)) jump:t	00021930; r17 = add(r10,sub(0000007F,r17)) }
...
l00021958:
	{ if (cmp.eq(r0.new,00000004)) jump:t	00021988; r0 = memb(r0+32); r11 = r9; p0 = cmp.eq(r18,00000000) }

l0002196C:
	{ r1 = r13; r28 = r12; r17 = r8 }
	{ jump	00021A1C }
0002197C                                     0B 40 89 74             .@.t
00021980 10 4C 08 F5 00 C0 6D 70                         .L....mp        
...
l00021994:
	{ loop0(00021998,r18) }
	{ r18 = memw(r1++#4) }
	{ if (!cmp.gt(r18.new,00000006)) jump:t	000219B8; r18 = add(r10,sub(0000007F,r18)) }

l000219A8:
	{ r16 = 00000000; r0 = 00000000; r17 = 00000000 }
	{ jump	000219D0 }
000219B4             0E 60 0A 10                             .`..        
...
l00021A1C:
	...
	{ r0 = mpyi(r0,r8) }
	{ r0 = mpyi(r0,r12) }
	{ if (!cmp.gtu(r0.new,r11)) jump:t	00021A5C; r0 = asl(r0,00000002) }

l00021A3C:
	{ r1 = 000000C6; r0 = add(badva,00000016) }
	{ call	fn00021C9C; r3 = add(badva,00000029) }
	{ r0 = FFFFFFFF; jump	00021BB4 }
00021A58                         00 40 00 78                     .@.x    
...
l00021B74:
	{ if (!cmp.eq(r20.new,r15)) jump:t	00021AE8; r20 = add(r20,00000001) }

l00021B7C:
	{ if (!cmp.eq(r19.new,r2)) jump:t	00021AD4; r19 = add(r19,00000001) }
...
l00021B98:
	{ if (!cmp.eq(r11.new,r9)) jump:t	00021ABC; r11 = add(r11,00000001) }

l00021BA0:
	{ if (!cmp.eq(r10.new,r8)) jump:t	00021AB0; r10 = add(r10,00000001) }

l00021BA4:
	{ if (!cmp.eq(r10.new,r8)) jump:t	00021AB0 }

l00021BA8:
	{ if (!cmp.eq(r0.new,r12)) jump:t	00021AA4; r0 = add(r0,00000001) }
...
sum_f_check proc
	...
	{ memw(r29) = r17; r2 = r16; call	logmsg_function }
	{ r2 = memw(r17+16) }
	{ if (cmp.gtu(r3.new,r2)) jump:t	00021C20; r3 = 00000004 }

l00021BFC:
	{ r1 = 00000038; r0 = add(badva,00000000) }
	{ r3 = add(badva,0000001B) }

l00021C0C:
	{ r2 = r16; call	errlog_function }
	{ dealloc_return; r17:r16 = memd(r29+8); r0 = FFFFFFFF }
00021C1C                                     0A 40 42 10             .@B.

l00021C20:
	{ r1 = 00000039 }
	{ jump	00021C0C; r0 = add(badva,00000014) }
00021C30 41 47 00 78 A2 40 91 91 10 E1 02 24 28 42 00 00 AG.x.@.....$(B..
00021C40 00 DE 49 6A 29 42 00 00 03 55 49 6A E4 FF FF 59 ..Ij)B...UIj...Y
00021C50 29 42 00 00 04 57 49 6A 82 30 B1 2B 08 40 00 5A )B...WIj.0.+.@.Z
00021C60 00 D1 9D A1 00 C0 00 78 40 1F 0C 3E             .......x@..>    
...
gemacca_asm proc
	...
	{ r15:r14 = memd(r0+8) }
	{  }
	{ if (p2) r12 = add(r12,r10); if (!p2) r12 = add(r12,r8) }
...
gemaccb_asm proc
	{ r2 = lsr(r2,00000002) }
	{ p0 = cmp.eq(r3,00000000); r4 = 00000001 }
	{ r5 = 00000010; if (p0) jump:nt	00021DCC; loop0(00021DC0,r2) }
...
gemsumb_asm proc
	{ r2 = lsr(r2,00000002) }
	{ p0 = cmp.eq(r3,00000000); r4 = 00000001 }
	{ r5 = 00000010; if (p0) jump:nt	0002276C; loop0(00022760,r2) }
...
gemvmpybbw_asm proc
	...
	{ if (!p0.new) jump:nt	00022E24; p0 = bitsclr(r5,r17) }
...
gvmsumb_asm proc
	...
	{ r2 = r2; r4 = 00000001; if (p0) jump:nt	00023E08 }
...
l00023EE0:
	...
	{ nop; nop; nop; nop }
	{  }
	{ dcfetch(r28,00000000); r6 = memw(r29+84); r7 = add(r7,00000001) }
	{ loop0(00023FC0,r6) }
...
gvconvsum2dbbb_asm proc
	...
	{  }
	{ dcfetch(r0,00000020); p0 = cmp.eq(r6,00000001) }
	{ memw(r29+4) = r6 }
...
l00024640:
	...
	{ nop; nop; nop; nop }
	{  }
	{ dcfetch(r28,00000000); r6 = memw(r29+84); r28 = add(r28,r8) }
	{ loop0(00024720,r6) }
