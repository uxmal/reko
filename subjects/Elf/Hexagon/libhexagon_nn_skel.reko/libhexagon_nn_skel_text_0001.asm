...
l0001989C:
	{ r2 = memw(r29+52); r1 = 0xFC; r3 = add(PC,0xED6F) }
...
l00019BD0:
	...
	{ r19 = add(r14,r2) }
	{ r1:r0 = combine(r19,0xFF0000); call fn00009760 }
...
l00019C08:
	{ r3:r2 = combine(0x100,0x0); r4 = mpyi(r4,r5) }
	{ loop1(00019C18,r4) }
...
l00019C74:
	...
	{ memw(r6) = 0x1; memw(r4+24) = 0x4; r4 = add(PC,0xE9B1) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xE7F4) }
...
l00019E44:
	...
	{ r2 = 0x437F0000 }
	{ r21 = 0x0; r1:r0 = combine(r0,r2); call fn00009610 }
	{ r2 = sfsub(r21,r27) }
...
l00019F68:
	...
	{ r4 = and(r4,0x3FFFFFFC); p0 = fastcorner9(p2,p0); r1 = mpyi(r24,r25) }
...
l0001A1A0:
	...
	{ memw(r29+116) = r22; r0 = 0x60000; r2 = add(r22,r2) }
	...
	{ if (!cmp.gt(r17.new,0x0)) jump:nt 0001A314; r2 = memw(r29+72); r7 = mpyi(r24,r25) }
...
l0001A49C:
	{ memb(r29+31) = r0.new; r0 = p2; r7 = add(PC,0x10C74) }
...
l0001A8A0:
	{ call fn00009760 }
	{ memw(r29+68) = r0 }
	{ r2 = r22; r1 = 0x50; r4 = add(PC,0xE057) }
...
l0001A94C:
	{ memw(r16+24) = r2; r2 = memd(r29+68); if (p0) r20 = 0x0 }
	{ memw(r29+128) = r26; r7 = memw(r29+124); if (p0) r26 = 0x3F800000 }
	{ memw(r29+12) = r22 }
...
l0001AC0C:
	{ memb(r29) = r2.new; r2 = memw(r29+16); r4 = add(PC,0xDD48) }
	{ r2 = memw(r29+12) }
	{ call logmsg_function }
	{ r0 = 0x0 }
...
avgpool_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xDC34) }
...
l0001AC94:
	{ jump 0001AC70; r3 = add(PC,0xDC10) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xDB25) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
biasadd_f_execute proc
	{ allocframe(0x38); memd(r29-16) = r17:r16; r3 = add(PC,0xDC81) }
...
l0001ADDC:
	{ r24 = memw(r3+4); r23 = memw(r3); r4 = add(PC,0xDC28) }
...
l0001AEC8:
	{ r2 = r16; r1 = 0x58; r4 = add(PC,0xDB64) }
...
biasadd_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xDA83) }
...
l0001AF58:
	{ r2 = r16; r1 = 0x61; r4 = add(PC,0xDA70) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xD9C4) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
concat_execute proc
	{ allocframe(0x40); memd(r29-40) = r23:r22; r4 = add(PC,0xDAE2) }
	{ r23 = r0 }
...
l0001B0D8:
	{ memb(r29) = r2.new; r2 = memw(r29+12); r4 = add(PC,0xDA6A) }
...
concat_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xD89A) }
	{ r17 = r0; r16 = r1; r1 = 0x6A }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r2 = memw(r17+16); r1 = 0x6B; r3 = add(PC,0xD896) }
...
l0001B234:
	{ r2 = memw(r17+8); r1 = 0x71; r3 = add(PC,0xD86A) }
...
l0001B25C:
	{ r2 = r16; r1 = 0x73; r4 = add(PC,0xD84E) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xD798) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0001B3B4:
	{ r22 = memd(r29+44); r2 = memw(r19+16); r4 = add(PC,0xD854) }
...
l0001B49C:
	{ r2 = r18; r1 = 0x65; r3 = add(PC,0xD800) }
	{ jump 0001B504 }
...
l0001B704:
	{ memw(r29+12) = r25; r1 = 0x93; r4 = add(PC,0xD5E9) }
...
conv2d_check_ref proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xD433) }
...
l0001B814:
	{ r2 = r16; r1 = 0xAA; r4 = add(PC,0xD3DC) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xD2F5) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }

;; matmul_execute_ref: 0001B880
matmul_execute_ref proc
	{ allocframe(#0x58); r4 = add(PC,0xD52A) }
	...
	{ memw(r29+28) = r19; r1 = 0x52; r4 = add(PC,0xD4DE) }
	{ memw(r29+8) = r21; r2 = r16 }
	{ memw(r29+20) = r27; memw(r29+24) = r18 }
	{ memw(r29+12) = r20; memw(r29+16) = r25 }
	{ memw(r29) = r26; memw(r29+4) = r24 }
	{ call logmsg_function }
	{ p0 = cmp.eq(r24,0x1); r1 = 0x53; r3 = add(PC,0xD4D8) }
	{ if (p0) r1 = 0x54; if (!p0) jump:nt 0001B988 }

l0001B92C:
	{ if (p0.new) r1 = 0x55; p0 = cmp.eq(r27,0x1); r3 = add(PC,0xD4C0) }
	{ if (!p0) jump:nt 0001B988 }

l0001B940:
	{ if (p0.new) r1 = 0x56; p0 = cmp.eq(r26,0x1); r3 = add(PC,0xD4BE) }
	{ if (!p0) jump:nt 0001B988 }

l0001B954:
	{ p0 = cmp.eq(r25,0x1); r2 = mpyi(r26,r21); r3 = add(PC,0xD4AA) }
	{ if (p0) r4 = memw(r23+20); if (p0) r1 = 0x57; if (!p0) jump:nt 0001B988 }

l0001B970:
	{ r2 = mpyi(r2,r24); r3 = add(PC,0xD4A5) }
	{ r2 = mpyi(r2,r19) }
...
l0001B998:
	...
	{ if (!p0) r14 = add(r20,0xFFFFFFFF); if (!p0) r3 = 0x0; if (p0) jump:nt 0001BA40 }
...
l0001BA40:
	{ r2 = r16; r1 = 0x68; r4 = add(PC,0xD3E6) }
...
matmul_check_ref proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xD2C8) }
	{ r17 = r0; r16 = r1; r1 = 0x6F }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r1 = 0x70; r3 = add(PC,0xD2C4) }
...
l0001BAE8:
	{ r2 = r16; r1 = 0x74; r4 = add(PC,0xD2AA) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xD1E6) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0001BC3C:
	{ call fn00009760 }
	{ memw(r29+72) = r0 }
	{ r2 = r23; r1 = 0x54; r4 = add(PC,0xD2A7) }
...
l0001BCE4:
	{ memw(r16+24) = r2; r2 = memd(r29+72); if (p0) r1 = 0xFF800000 }
...
l0001BF5C:
	{ memb(r29) = r2.new; r2 = memw(r29+12); r4 = add(PC,0xCFE1) }
	{ r2 = memw(r29+8) }
	{ call logmsg_function }
	{ r0 = 0x0 }
...
maxpool_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xCED0) }
...
l0001BFE4:
	{ jump 0001BFC0; r3 = add(PC,0xCEAC) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xCDC1) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
relu_execute proc
	{ allocframe(0x28); memd(r29-16) = r17:r16; r4 = add(PC,0xCF66) }
...
l0001C158:
	{ r2 = r16; r1 = 0x3F; r4 = add(PC,0xCED5) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
relu_check__merged proc
	{ allocframe(0x20); p0 = cmp.eq(r2,0x1); r4 = add(PC,0xCDE9) }
	{ r7 = 0x1; r5 = 0x2; r6 = add(PC,0xCE5E) }
...
l0001C230:
	{ jump 0001C244; r4 = add(PC,0xCDD0) }
...
reluX_execute proc
	{ allocframe(0x30); memd(r29-16) = r17:r16; r4 = add(PC,0xCD5E) }
	{ r17:r16 = combine(r0,r1) }
...
l0001C31C:
	{ r2 = r16; r1 = 0x5B; r4 = add(PC,0xCCC0) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xCBD9) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0001C484:
	{ r1 = r18; r0 = 0x3F800000; call fn00009610 }
	{ r2 = memw(r29+16) }
...
l0001C4F8:
	{ call errlog_function; r3 = add(PC,0xCBD6) }
...
softmax_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xCB45) }
	{ r17 = r0; r16 = r1; r1 = 0x5A }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r1 = 0x5B; r3 = add(PC,0xCB42) }
...
l0001C5B8:
	{ r2 = r16; r1 = 0x61; r4 = add(PC,0xCAFD) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xCA3A) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0001C660:
	{ memw(r29+4) = r7; r1 = 0xA1; r3 = add(PC,0xCAE2) }
...
l0001C700:
	...
	{ memw(r29+8) = r28; memw(r29+68) = r1; if (p0) r1 = 0x437F0000 }
...
;; lrn_check: 0001C9D8
lrn_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xC71D) }
...
l0001CA30:
	{ r2 = r16; r1 = 0xCE; r4 = add(PC,0xC700) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xC664) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0001CB18:
	{ memw(r29+4) = r5; r1 = 0xA3; r3 = add(PC,0xC6BD) }
	{ jump 0001CC20 }
...
l0001CC10:
	{ r2 = r16; r1 = 0xA8; r3 = add(PC,0xC5DF) }
...
l0001CC7C:
	...
	{ r5 = memw(r12+4); r6 = add(r2,0xFFFFFFFF); r4 = add(PC,0xC58F) }
...
;; lrn_check: 0001CFA8
lrn_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xC1DF) }
	{ r17 = r0; r16 = r1; r1 = 0xCB }
...
l0001D008:
	{ memw(r29) = r17; r3:r2 = combine(0x2,r16); r4 = add(PC,0xC1B8) }
	{ call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xC124) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xC18D) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
assign_execute proc
	{ allocframe(0x20); memd(r29-16) = r17:r16; r4 = add(PC,0xC1DC) }
...
l0001D25C:
	{ memw(r29) = r20; r1 = 0xAC; r3 = add(PC,0xC139) }
...
l0001D280:
	{ memw(r29) = r18; r1 = 0xA6; r3 = add(PC,0xC0FE) }
	{ jump 0001D26C }
...
l0001D2A4:
	{ jump 0001D2C8; r3 = add(PC,0xC097) }
...
variable_execute proc
	{ allocframe(0x8); r2 = r1; r4 = add(PC,0xC04C) }
...
variable_check proc
	{ allocframe(0x20); memd(r29-16) = r17:r16; r4 = add(PC,0xBFF8) }
...
l0001D3A4:
	{ jump 0001D390; r8 = 0x38; r3 = add(PC,0xBF5E) }
...
l0001D408:
	{ r2 = r18; r1 = 0x5F; r3 = add(PC,0xBED1) }
	{ call errlog_function }
...
l0001D480:
	{ r2 = r18; r1 = 0x58; r3 = add(PC,0xBE4E) }
	{ r16 = 0x0; call errlog_function }
	{ jump 0001D474 }

;; variable_dtor: 0001D49C
variable_dtor proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xBE1C) }
...
l0001D5A8:
	{ r2 = r16; r1 = 0x3F; r4 = add(PC,0xBEA7) }
	{ memw(r29) = r17; call logmsg_function }
	{ r2 = memw(r25+20); r1 = 0x41; r3 = add(PC,0xBEB0) }
...
l0001D6A4:
	{ r3 = memw(r17+4); r2 = memw(r17+8) }
	{ r2 = memw(r2+4); r4 = memw(r3+8); r3 = add(PC,0xBDEE) }
...
l0001D6D4:
	...
	{ r4 = memw(r3+12); r3 = add(PC,0xBDB2) }
	{ r2 = memw(r2+8) }
	{ r5 = memw(r4+4); r7 = memw(r4) }
	{ memw(r2) = r7; memw(r2+4) = r5 }
	{ r6 = memw(r4+12); r0 = memw(r4+8) }
...
l0001D71C:
	{ r3 = memw(r23+4); r2 = memw(r23); r4 = add(PC,0xBD89) }
...
reshape_check__merged proc
	{ allocframe(0x28); p0 = cmp.eq(r2,0x1); r4 = add(PC,0xBC99) }
	{ memd(r29+24) = r19:r18; memd(r29+32) = r17:r16; if (p0) r19 = 0x6F; r17:r16 = combine(r0,r1) }
	{ if (p0) r1 = 0x6C; r18 = add(PC,0xBC9A) }
...
l0001D7C4:
	{ r21:r20 = combine(0x6D,0x6E); r23:r22 = combine(0x4,0x3); r4 = add(PC,0xBC06) }
	{ r18 = add(PC,0xBC2F) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xBB41) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
slice_check_f proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xBC5F) }
...
slice_check_8 proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xBBFF) }
...
slice_check_q8 proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xBB23) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xBA84) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
slice_impl proc
	{ allocframe(#0x58); r4 = add(PC,0xBAA9) }
	{ r5 = memw(r0+8); r3 = memw(r0+4) }
	...
	{ r3 = mpyi(r3,r26) }
	{ r14 = mpyi(r3,r8); r3 = add(PC,0xBA0F) }
...
l0001DB54:
	{ if (p1.new) r1 = 0x57; p1 = cmp.gt(r21,0x0); r3 = add(PC,0xB9FC) }
...
split_check_f proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xB8E0) }
...
qsplit_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xB7E8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xB749) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
split_impl proc
	...
	{ r2 = r17; r1 = 0x46; r4 = add(PC,0xB722) }
...
tanh_execute proc
	{ allocframe(0x28); memd(r29-16) = r17:r16; r4 = add(PC,0xB6A0) }
	{ r17:r16 = combine(r0,r1) }
...
l0001E0C4:
	{ r2 = r16; r1 = 0x40; r4 = add(PC,0xB621) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
;; tanh_check: 0001E0EC
tanh_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xB589) }
...
l0001E144:
	{ r2 = r16; r1 = 0x49; r4 = add(PC,0xB566) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xB4CD) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }

;; sigmoid_execute: 0001E1B0
sigmoid_execute proc
	{ allocframe(0x28); memd(r29-16) = r17:r16; r4 = add(PC,0xB5B2) }
	{ r17:r16 = combine(r0,r1) }
	{ memd(r29+16) = r21:r20; r2 = memw(r17+4); r1 = 0x37 }
	{ r3 = memw(r17+8) }
	{ memd(r29+24) = r19:r18; memd(r29+8) = r23:r22 }
...
l0001E21C:
	...
	{ r6 = memw(r21+8) }
	{ memw(r22+8) = r6 }
	{ r7 = memw(r21+12); if (!p0) r21 = 0x3F000000 }
...
l0001E274:
	{ r2 = r16; r1 = 0x40; r4 = add(PC,0xB516) }
...
sigmoid_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xB475) }
	{ r17 = r0; r16 = r1; r1 = 0x46 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
...
l0001E2F4:
	{ r2 = r16; r1 = 0x49; r4 = add(PC,0xB455) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xB3B6) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
qtanh_execute_ref proc
	...
	{ r7 = memw(r16+8) }
	{ memd(r29+48) = r19:r18; memd(r29+32) = r23:r22; r18 = 0x437F0000 }
	...
	{ r2 = r17; r1 = 0x42; r4 = add(PC,0xB53E) }
...
l0001E41C:
	...
	{ r6 = memw(r26+8) }
	{ memw(r27+8) = r6 }
	{ memw(r29+12) = r17; r7 = memw(r26+12); if (!p0) r17 = 0x3F000000 }
	{ memw(r27+24) = r25; memw(r27+12) = r7; if (p0) jump:nt fn0001E49C }

l0001E450:
	{ r27 = 0x3F800000; r26 = 0x42FF0000 }
...
fn0001E49C proc
	{ memw(r21+12) = 0x1; r2 = memw(r21+16); r4 = add(PC,0xB4B5) }
...
l0001E4A8:
	...
	{ memw(r2) = 0xBF800000; memw(r21+4) = 0xFFFFFF81 }
...
l0001E4BC:
	...
	{ memw(r3) = 0x3F800000; memw(r20+12) = 0xFFFFFF81 }
...
qtanh_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xB45E) }
...
l0001E558:
	{ r2 = r16; r1 = 0x97; r4 = add(PC,0xB43B) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
qtanh_execute_hvx proc
	{ allocframe(0x50); memd(r29-16) = r17:r16; r4 = add(PC,0xB39A) }
...
l0001E630:
	...
	{ r2 = 0xC0800000; r1 = sfsub(r24,r19) }
...
l0001E6B0:
	...
	{ r2 = 0x41700000; r18 = convert_uw2sf(r0):chop }
	{ r0 = r2; call fn000097C0 }
	{ r3 = 0xBF800000; r2 = 0x41FF0000 }
...
l0001E790:
	...
	{ r1 = 0x41000000; r0 = 0x17 }
	{ call fn00009600 }
	{ r2 = 0x437F0000 }
	{ r1:r0 = combine(r0,r2); call fn00009610 }
	{ r2 = memd(r29+12); r23 = r0; r18 = r21 }
	{ r24 = 0x40800000; r19 = mpyi(r2,r26) }
...
l0001E828:
	{ r3 = 0x1010101; r2 = add(PC,0xC8E8) }
	{ r5 = 0x80808080; r4 = 0x4040404 }
	{ r7 = 0x7070707; r6 = 0xF8F8F8F8 }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xAF60) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
fn0001EA34 proc
	...
	{ r24 = memw(r27+16); r22 = memw(r26+16) }
	{ call fn00009610; r25 = mpyi(r2,r5) }
	{ r2 = r17; r1 = 0x42; r4 = add(PC,0xB0D1) }
	{ memw(r29) = r16; r19 = r0; call logmsg_function }
...
fn0001EA8C proc
	...
	{ r6 = memw(r26+8) }
	{ memw(r27+8) = r6 }
	{ memw(r29+12) = r17; r7 = memw(r26+12); if (!p0) r17 = 0x42FF0000 }
	{ memw(r27+24) = r25; memw(r27+12) = r7; if (p0) jump:nt fn0001EB10 }

l0001EAC0:
	{ r27 = 0x3F000000; r26 = 0x3F800000 }
...
fn0001EB10 proc
	{ memw(r21+12) = 0x1; r2 = memw(r21+16); r4 = add(PC,0xB047) }
...
qsigmoid_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xAFF7) }
	{ r17 = r0; r16 = r1; r1 = 0x95 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
...
l0001EBC8:
	{ r2 = r16; r1 = 0x98; r4 = add(PC,0xAFD7) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
qsigmoid_execute_hvx proc
	{ allocframe(0x50); memd(r29-16) = r17:r16; r4 = add(PC,0xAF2D) }
	{ r17:r16 = combine(r1,r0) }
...
l0001EE98:
	{ r3 = 0x1010101; r2 = add(PC,0xC278) }
	{ r5 = 0x2020202; r4 = 0x10101010 }
	{ r7 = 0x7070707; r6 = 0xF8F8F8F8 }
...
l0001EF74:
	{ r0 = memd(r29+24); r1 = memd(r29+16); r2 = r20; call fn00009560 }
	{ r5 = memw(r29+28); r2 = memw(r25+16); r4 = add(PC,0xABD7) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xAAF0) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
fn0001F0EC proc
	{ r2 = r6; r1 = 0xBC; r0 = add(PC,0xAB22) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(PC,0xAB31) }
...
l0001F1D8:
	{ memw(r29+28) = r12; r1 = 0xBC; r0 = add(PC,0xAA36) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(PC,0xAA69) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump 0001F148 }

l0001F20C:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(PC,0xA9F6) }
	{ memw(r29+40) = r20; r1 = 0xBC; r4 = add(PC,0xAA65) }
...
l0001F358:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(PC,0xA8B6) }
...
add_f_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xA83F) }
	{ r16 = r1; r1 = 0x37; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(PC,0xA810) }
	{ call logmsg_function }
...
l0001F3F4:
	{ r0 = add(PC,0x8) }
	{ jump 0001F3D4; r3 = add(PC,0xA7F6) }

l0001F404:
	{ r2 = r16; r1 = 0x3A; r0 = add(PC,0xA7B4) }
	{ memw(r29) = r17; call logmsg_function; r4 = add(PC,0xA7EE) }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
l0001F530:
	{ r2 = r23; r1 = 0xBC; r0 = add(PC,0xA808) }
	{ memw(r29+92) = r6; r27 = r23; r4 = add(PC,0xA817) }
	{ r6 = memw(r19+16) }
...
l0001F614:
	{ memw(r29+28) = r12; r1 = 0xBC; r0 = add(PC,0xA724) }
	{ memw(r29+16) = r2; memw(r29+24) = r9 }
	{ memw(r29+4) = r6; memw(r29+20) = r3; r3 = add(PC,0xA757) }
	{ memw(r29+8) = r7; r2 = memd(r29+104) }
	{ memw(r29) = r5; memw(r29+12) = r8 }
	{ jump 0001F58C }

l0001F648:
	{ memw(r29+44) = r21; r19 = memd(r29+112); r0 = add(PC,0xA6F0) }
	{ memw(r29+32) = r19; r1 = 0xBC; r4 = add(PC,0xA75F) }
...
l0001F784:
	{ memb(r29) = r2.new; r2 = memw(r29+64); r0 = add(PC,0xA5B4) }
...
mul_f_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xA52F) }
	{ r16 = r1; r1 = 0x38; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(PC,0xA500) }
	{ call logmsg_function }
...
l0001F820:
	{ r0 = add(PC,0x38) }
	{ jump 0001F800; r3 = add(PC,0xA4E6) }

l0001F830:
	{ r2 = r16; r1 = 0x3B; r0 = add(PC,0xA4A4) }
	{ memw(r29) = r17; call logmsg_function; r4 = add(PC,0xA4DE) }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
l0001F910:
	{ r1 = 0x36; call errlog_function; r3 = add(PC,0xA544) }
	{ dealloc_return; r0 = #-0x1 }

;; neg_f_check: 0001F924
neg_f_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xA4F5) }
...
l0001F97C:
	{ r2 = r16; r1 = 0x44; r4 = add(PC,0xA4C8) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xA43A) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l0001FA9C:
	{ r2 = r6; r1 = 0xBC; r0 = add(PC,0xA41C) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(PC,0xA42B) }
	{ memw(r29+88) = r7; r23 = memw(r25+16); r27 = r5; r24 = r6 }
	{ r17 = memw(r26+16) }
	{ memw(r29) = r5; memw(r29+100) = r3; call logmsg_function }
...
l0001FB88:
	{ memw(r29+28) = r12; r1 = 0xBC; r0 = add(PC,0xA330) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(PC,0xA363) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump 0001FAF8 }

l0001FBBC:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(PC,0xA2F0) }
	{ memw(r29+40) = r20; r1 = 0xBC; r4 = add(PC,0xA35F) }
	{ memw(r29+28) = r12; memw(r29+32) = r24 }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+12) = r8 }
	{ memw(r29) = r5; memw(r29+4) = r6 }
...
l0001FD08:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(PC,0xA1B0) }
...
sub_f_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xA139) }
	{ r16 = r1; r1 = 0x37; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(PC,0xA10A) }
	{ call logmsg_function }
...
l0001FDA4:
	{ r0 = add(PC,0x2) }
	{ jump 0001FD84; r3 = add(PC,0xA0F0) }

l0001FDB4:
	{ r2 = r16; r1 = 0x3A; r0 = add(PC,0xA0AE) }
	{ memw(r29) = r17; call logmsg_function; r4 = add(PC,0xA0E8) }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
rank_execute proc
	{ allocframe(0x18); memd(r29-16) = r17:r16; r4 = add(PC,0xA1C4) }
...
l0001FE6C:
	{ r3 = memw(r19+16); r1 = 0x3B; r4 = add(PC,0xA19D) }
...
;; rank_check: 0001FEA4
rank_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0xA0F4) }
	{ r17 = r0; r16 = r1; r1 = 0x41 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
...
l0001FEFC:
	{ r2 = r16; r1 = 0x44; r4 = add(PC,0xA0D1) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0xA03A) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
range_execute proc
	{ allocframe(0x28); memd(r29-16) = r17:r16; r4 = add(PC,0xA10E) }
	{ r17:r16 = combine(r0,r1) }
...
l00020034:
	{ r2 = r16; r1 = 0x49; r4 = add(PC,0xA070) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
range_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x9FD5) }
...
l000200B4:
	{ r2 = r16; r1 = 0x52; r4 = add(PC,0x9FB3) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x9F1A) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }

;; transpose_execute: 00020120
transpose_execute proc
	{ allocframe(#0x90); r2 = add(PC,0xA008) }
	...
	{ memw(r13) = r26; r24 = memw(r4); r4 = add(PC,0x9FB4) }
	...
	{ memw(r29) = r17; call logmsg_function }
	{ memw(r29+12) = r21; r3:r2 = combine(0x3,r16); r4 = add(PC,0x9F98) }
...
l00020320:
	{ memw(r24+12) = r21; memw(r24+24) = r2; r4 = add(PC,0x9EAD) }
...
l000203FC:
	{ r1 = 0x96; r3:r2 = combine(0x2,r16); r4 = add(PC,0x9E0F) }
...
transpose_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x9CA5) }
...
l0002048C:
	{ memw(r29) = r17; r3:r2 = combine(0x2,r16); r4 = add(PC,0x9C7F) }
	{ call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x9BE6) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }

;; addn_execute: 000204F0
addn_execute proc
	{ allocframe(0x30); memd(r29-16) = r17:r16; r4 = add(PC,0x9D94) }
	{ r17:r16 = combine(r0,r1) }
...
l00020564:
	{ if (cmp.eq(r7.new,r24)) jump:t 00020578; r7 = memw(r6+4); r3 = add(PC,0x9D37) }

l00020578:
	{ if (cmp.eq(r7.new,r23)) jump:t 0002058C; r7 = memw(r6+8); r3 = add(PC,0x9D23) }

l0002058C:
	{ if (cmp.eq(r6.new,r22)) jump:t 00020540; r6 = memw(r6+12); r3 = add(PC,0x9D0F) }

l000205A0:
	{ r5 = memw(r21+20); r2 = mpyi(r24,r25); r3 = add(PC,0x9D0A) }
...
l00020638:
	{ r2 = r16; r1 = 0x4C; r4 = add(PC,0x9C80) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
;; addn_check: 00020664
addn_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x9BD5) }
...
l000206BC:
	{ r2 = r16; r1 = 0x55; r4 = add(PC,0x9BB2) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x9B19) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l000207D4:
	{ jump 000207B8; r3 = add(PC,0x9B40) }
...
l00020880:
	...
	{ memw(r29+28) = r2; memw(r29+20) = r22; if (p0) r26 = 0x3727C5AC }
	{ memw(r29+56) = r0; if (p0) r18 = 0x3F800000; if (!p0) jump:nt 00020920 }
...
l00020920:
	...
	{ if (p0) r18 = 0x0; if (p0) jump:nt 00020948 }
...
l00020C38:
	...
	{ call fn00009800 }
	{ r1 = r0; r0 = 0x3F800000; call fn00009610 }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x9501) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
l00020DF8:
	{ r5 = add(r29,0x10); r3 = 0x2; r0 = add(PC,0x11) }
	{ r6 = add(r29,0x10); r1 = 0x74; r4 = add(PC,0x9534) }
	{ memw(r29+4) = r6; call logv }
...
l00020ECC:
	{ r2 = r6; r1 = 0xBD; r0 = add(PC,0x94DD) }
	{ memw(r29+64) = r12; r3 = memw(r19+16); r4 = add(PC,0x94EC) }
	{ memw(r29+88) = r7; r23 = memw(r25+16); r27 = r5; r24 = r6 }
	{ r17 = memw(r26+16) }
	{ memw(r29) = r5; memw(r29+100) = r3; call logmsg_function }
...
l00020FB8:
	{ memw(r29+28) = r12; r1 = 0xBD; r0 = add(PC,0x93F1) }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+20) = r3; r3 = add(PC,0x9424) }
	{ memw(r29+4) = r6; memw(r29+12) = r8 }
	{ memw(r29) = r5; jump 00020F28 }

l00020FEC:
	{ memw(r29+44) = r21; r24 = memw(r29+104); r19 = r2 }
	{ memw(r29+20) = r3; memw(r29+36) = r18; r0 = add(PC,0x93B1) }
	{ memw(r29+40) = r20; r1 = 0xBD; r4 = add(PC,0x9420) }
	{ memw(r29+28) = r12; memw(r29+32) = r24 }
	{ memw(r29+16) = r13; memw(r29+24) = r9 }
	{ memw(r29+8) = r7; memw(r29+12) = r8 }
	{ memw(r29) = r5; memw(r29+4) = r6 }
...
l00021138:
	{ memb(r29) = r2.new; r2 = memw(r29+60); r0 = add(PC,0x9271) }
...
sub_int32_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x91FA) }
	{ r16 = r1; r1 = 0x37; r17 = r0 }
	{ memw(r29) = r17; r2 = r16; r0 = add(PC,0x91CD) }
	{ call logmsg_function }
...
l000211D4:
	{ r0 = add(PC,0x5) }
	{ jump 000211B4; r3 = add(PC,0x91B1) }

l000211E4:
	{ r2 = r16; r1 = 0x3A; r0 = add(PC,0x9171) }
	{ memw(r29) = r17; call logmsg_function; r4 = add(PC,0x91A9) }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
prelu_execute proc
	...
	{ memd(r29+56) = r25:r24; r2 = memw(r16+4); r0 = 0x38D1B717 }
	{ r3 = memw(r16+8) }
...
fn00021298 proc
	...
	{ r2 = 0x437F0000 }
	{ r20 = 0x0; r1:r0 = combine(r0,r2); call fn00009610 }
...
l00021394:
	{ r1 = 0x4C; jump 00021374; r3 = add(PC,0x91A0) }
...
l000213A4:
	...
	{ if (!p1) r27 = 0x0; r3 = mpyi(r3,r0); r4 = add(PC,0x918E) }
	{ memd(r29) = r7:r6; memw(r29+8) = r26; r20 = and(r27,0xFF) }
	{ r27 = r20; r2 = add(0x8000,mpyi(r20,r26)) }
...
l00021464:
	{ r2 = add(0x8000,mpyi(r2,r26)); r4 = add(PC,0x23) }
...
l00021500:
	...
	{ r3 = memw(r20+16); r2 = memw(r19); r4 = add(PC,0x9094) }
	{ r3 = memw(r3); r2 = memw(r2); r1 = 0x61 }
	{ r2 = r17; r9:r8 = convert_sf2df(r3); r7:r6 = convert_sf2df(r2) }
	{ memd(r29) = r9:r8; memd(r29+8) = r7:r6 }
	{ call logmsg_function }
	{ r2 = r17; r1 = 0x62; r4 = add(PC,0x9081) }
	{ memw(r29) = r16; call logmsg_function }
	{ r0 = 0x0 }
...
prelu_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x8F1A) }
	{ r17 = r0; r16 = r1; r1 = 0x69 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r1 = 0x6A; r3 = add(PC,0x8F15) }
...
l000215DC:
	{ r1 = 0x6D }
	{ r6 = memw(r17+8); r3 = add(PC,0x8EEB) }
...
l00021608:
	{ r2 = r16; r1 = 0x70; r4 = add(PC,0x8ECF) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x8E1F) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
prelu_execute proc
	{ allocframe(0x38); memd(r29-16) = r17:r16; r4 = add(PC,0x8FB5) }
	{ r17:r16 = combine(r0,r1) }
...
l00021778:
	{ r2 = r16; r1 = 0x42; r4 = add(PC,0x8EF2) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
...
prelu_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x8E40) }
...
l00021800:
	{ r2 = r16; r1 = 0x4B; r4 = add(PC,0x8E1E) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
errlog_function proc
	{ allocframe(0x8); r4 = r3; r0 = add(PC,0x8D83) }
	{ memb(r29+1) = r6.new; r6 = add(r29,0x10); r5 = add(r29,0x10); r3 = 0x0 }
	{ dealloc_return }
...
sum_f_check proc
	{ allocframe(0x10); memd(r29-16) = r17:r16; r4 = add(PC,0x8AC3) }
	{ r17 = r0; r16 = r1; r1 = 0x37 }
	{ memw(r29) = r17; r2 = r16; call logmsg_function }
	{ r2 = memw(r17+16) }
...
l00021C24:
	{ jump 00021C04; r0 = add(PC,0x8A54) }
...
l00021C40:
	{ r0 = add(PC,0x3C) }
	{ jump 00021C0C; r3 = add(PC,0x8A6A) }

l00021C50:
	{ r2 = r16; r1 = 0x3B; r4 = add(PC,0x8A6E) }
	{ memw(r29) = r17; call logmsg_function }
	{ r0 = 0x0 }
	{ dealloc_return; r17:r16 = memd(r29+8) }
...
gemaccb_asm proc
	{ p0 = cmp.eq(r3,0x0); r4 = 0x1010101; if (p0.new) jump:nt 000219E0; p0 = cmp.eq(r3,#-0x1); r2 = lsr(r2,0x2) }
...
fn00021FF0 proc
	...
	{ r3:r2 = combine(r7,0x0); r9 = 0x0; r19:r18 = memd(r0++m0); loop0(000222AC,r6) }
	{ r19:r18 = memd(r29+8); r17:r16 = memd(r29) }
...
gemsumb_asm proc
	{ p0 = cmp.eq(r3,0x0); r4 = 0x1010101; if (p0.new) jump:nt 00022380; p0 = cmp.eq(r3,#-0x1); r2 = lsr(r2,0x2) }
...
fn00022884 proc
	{ r11 = asl(r4,0x4) }
	{ r9 = 0x8000; r8 = add(r8,0xFF); if (p0.new) jump:nt fn000224D8; p0 = cmp.eq(r5,#-0x1) }
...
vmemcpy_asm proc
	{ if (p0.new) jump:nt fn000225E8; p0 = cmp.eq(r0,#-0x1); r7 = add(r2,r0); r8 = 0x1010101 }
...
l000229C0:
	{ if (p1) r1 = add(r1,0x80); if (p0.new) jump:nt 00022650; p0 = cmp.eq(r9,#-0x1); loop0(000229E0,r3) }

l000229C4:
	{ if (p1) r1 = add(r1,0x80); if (p0.new) jump:nt 00022654; p0 = cmp.eq(r9,#-0x1) }

l000229C8:
	{ if (p1) r1 = add(r1,0x80) }
...
fn00022A30 proc
	{ jump 00022B44; r11 = 0xB; jump 00022A5C; r3 = 0x3; r9 = 0x1010101 }
...
avgpool_aligned_hvx proc
	...
	{ r6 = combine(r6.l,r6.l); r9 = 0x1010101; r7 = mpyi(r7,r2) }
...
l00022E20:
	...
	{ r11:r10 = memd(r0++#8); r16 = 0x1010101; loop0(00022E80,r7) }
...
;;     00023130 (in fn00023130)
fn0002313C proc
	{ r2 = and(r2,#0x1); r3 = 0x0; r16 = 0x2A0; r7 = 0x1010101 }
...
biasadd_relu_requant_nonaligned_hvx proc
	{ allocframe(#0x20); r14 = 0x1010101; r8 = add(r4,0x7F) }
...
l000235AC:
	...
	{ l2fetch(r18,r17:r16); r10 = 0x8000 }
	{ nop; nop; nop }
...
vmemset_asm proc
	{ r7 = add(r2,r0); r8 = 0x1010101; r1 = vsplatb(r1) }
...
gvmaccb_asm proc
	{ r4 = 0x1010101; if (p0.new) jump:nt 00023440; p0 = cmp.eq(r3,#-0x1); r2 = lsr(r2,0x2) }
...
gvmaddvvm_asm proc
	{ r0 = r0; r1 = 0x0; r11 = 0x80000000; r4 = asl(r4,0x2) }
...
l00023DCC:
	{ r2 = r2; r4 = 0x1010101; if (p0) jump:nt 00023E08 }
...
fn00023E4C proc
	...
	{ r0 = r0; r11 = 0x0; r16 = 0x80000001; r12 = addasl(r8,r8,0x1) }
...
gvconv2dbbw_asm proc
	...
	{ r0 = r0; r11 = 0x0; r16 = 0x80000001; r1 = addasl(r6,r6,0x1) }
...
gvconvsum2dbbb_asm proc
	{ dcfetch(r0,0x0); r9 = 0x20; r8 = 0x1010101 }
	{ if (p0.new) jump:nt fn00024178; p0 = cmp.eq(r9,#-0x1); r6 = 0x8000; r9 = 0x40 }
...
fn000249EC proc
	{ dcfetch(r0,0x0) }
	{ if (p0.new) jump:nt fn00024678; p0 = cmp.eq(r9,#-0x1); r6 = 0x8000; r9 = 0x40 }
