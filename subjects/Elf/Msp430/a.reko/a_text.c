...
ui20 xTaskCreate(ui20 sr, Eq_n r12, Eq_n r13, Eq_n r14, Eq_n r15, union Eq_n & r15Out)
{
	...
	if (r15_n != null)
	{
		...
		if (uxTopUsedPriority >= v31_n)
			uxTopUsedPriority = v31_n;
		*((char *) &r15_n->ptr0000 + 4) = (struct Eq_n *) uxTaskNumber.0;
		...
		if (usCriticalNesting != 0x00)
		{
			word16 v51_n = usCriticalNesting;
			usCriticalNesting = v51_n + ~0x00;
			if (v51_n == ~0x00)
				sr_n |= 0x08;
		}
	}
...
ui20 xTaskResumeAll(ui20 sr, union Eq_n & r15Out)
{
	...
	if (v10_n == ~0x00 && uxCurrentNumberOfTasks != 0x00)
	{
		...
		if (uxMissedTicks != 0x00)
		{
			if (uxMissedTicks != 0x00)
			{
				...
				{
					vTaskIncrementTick();
					word16 v35_n = uxMissedTicks;
					uxMissedTicks = v35_n + ~0x00;
				} while (v35_n != ~0x00);
			}
			r9_n.u1 = 0x01;
		}
	...
	if (usCriticalNesting != 0x00)
	{
		word16 v24_n = usCriticalNesting;
		usCriticalNesting = v24_n + ~0x00;
		if (v24_n == ~0x00)
			sr_n |= 0x08;
	}
	r15Out = r8_n;
	...
	*((word24) r15 + 48) = (word24) *((word24) r15 + 48) + 1;
	...
	if (r15_n != 0x00 && r13 != 0x00)
	{
		...
		*((word24) r11_n + 48) = (word24) *((word24) r11_n + 48) + 1;
		...
		if (usCriticalNesting != 0x00)
		{
			word16 v42_n = usCriticalNesting;
			usCriticalNesting = v42_n + ~0x00;
			if (v42_n == ~0x00)
				sr_n |= 0x08;
		}
	}
	...
	*((word24) r15 + 48) = (word24) *((word24) r15 + 48) + 1;
	...
	if (r15_n != 0x00 && r13 != 0x00)
	{
		...
		*((word24) r11_n + 48) = (word24) *((word24) r11_n + 48) + 1;
		if (usCriticalNesting != 0x00)
		{
			word16 v36_n = usCriticalNesting;
			usCriticalNesting = v36_n + ~0x00;
			if (v36_n == ~0x00)
				sr_n |= 0x08;
		}
		if (usCriticalNesting != 0x00)
...
ui20 prvUnlockQueue(ui20 sr, Eq_n r15, union Eq_n & r15Out)
{
	...
	*((word24) r15 + 46) = v17_n + ~0x00;
	...
	if (usCriticalNesting != 0x00)
	{
		word16 v21_n = usCriticalNesting;
		usCriticalNesting = v21_n + ~0x00;
		if (v21_n == ~0x00)
			sr_n |= 0x08;
	}
	r15Out = r10_n;
