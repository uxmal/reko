...
l00012204:
	add	%l0,0xFFFFFFFF_32,%l0
	ldsb	[%l0+%g0],%o0
	subcc	%o0,0x2F_32,%g0
	bne	00012204
	add	%i0,0xFFFFFFFF_32,%i0
...
l0001234C:
	or	%g0,%l1,%o0
	call	00027D40
	add	%i6,0xFFFFFF68_32,%o1
	or	%g0,%o0,%i0
	subcc	%i0,0xFFFFFFFF_32,%g0
	bne,a	000123B4
	st	%l4,[%l5+8_i32]
...
l00012ED8:
	...
	or	%g0,7_32,%o4
	ld	[%l0+336_i32],%o2
	add	%i6,0xFFFFFFE8_32,%o5
	st	%o4,[%sp+92_i32]
	call	000169F8
	add	%i6,0xFFFFFFEC_32,%o4
	subcc	%o0,0xFFFFFFFF_32,%g0
	bne	00012F6C
	add	%i6,0xFFFFFFE4_32,%o1
...
l00013BC8:
	addcc	%i1,0xFFFFFFFF_32,%i1
	be	00013CA4
	add	%l1,1_32,%l1

l00013BD4:
	ld	[%l2+480_i32],%o0
	add	%l1,0xFFFFFFFF_32,%l0
	subcc	%o0,%l0,%g0
	addx	%g0,0_32,%o0
	call	000136E0
	or	%g0,0_32,%o1
...
scan_for_missed_items proc
	...
	ld	[%o3+464_i32],%o0
	sethi	0xA0_32,%o4
	add	%o0,0xFFFFFFFD_32,%o0
	add	%o1,0xFFFFFFFF_32,%o2
	sethi	0xA0_32,%o3
	st	%o0,[%i6-20_i32]
	st	%o2,[%o4+304_i32]
	st	%i0,[%i6+68_i32]
...
l000153E0:
	ld	[%i0+40_i32],%o0
	sethi	0x200000_32,%o1
	andn	%o0,%o1,%o1
	add	%i2,0xFFFFFFFF_32,%o2
	st	%i4,[%i0+32_i32]
	st	%o2,[%i0+24_i32]
	subcc	%o1,0_32,%g0
	st	%i3,[%i0+28_i32]
...
l0001561C:
	...
	sll	%o3,2_32,%o1
	ld	[%o0+%o1],%o2
	addcc	%o3,0xFFFFFFFF_32,%o3
	st	%o2,[%o4+%g0]
	bpos	0001561C
	add	%o4,0xFFFFFFFC_32,%o4
...
__do_global_ctors_aux proc
	...
	ld	[%l7+%o0],%o1
	ld	[%o1-4_i32],%o2
	subcc	%o2,0xFFFFFFFF_32,%g0
	be	00016EB4
	add	%o1,0xFFFFFFFC_32,%l0

l00016E98:
	ld	[%l0+%g0],%o0
	jmpl	%o0,%g0,%o7
	add	%l0,0xFFFFFFFC_32,%l0
	ld	[%l0+%g0],%o0
	subcc	%o0,0xFFFFFFFF_32,%g0
	bne	00016E98
	sethi	0_32,%g0
