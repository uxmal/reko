...
word32 xmalloc(ptr32 & i1Out, ptr32 & i2Out, ptr32 & i6Out)
{
	...
	else
	{
		...
		word32 i2_n;
		word32 i6_n;
		notice("\n%s: virtual memory exceeded\n", g_t28150, dwLoc28, out i1_n, out i2_n, out i6_n);
		exit(33);
	}
}
...
l00011D1C:
		word32 i2_n;
		word32 i6_n;
		*xmalloc(out i1_n, out i2_n, out i6_n) = 0x0C;
		o0_n = (Eq_n) 0x0C;
	}
	word32 i6_n;
		...
		if (o0_n != 0x00)
		{
			...
			if (o0_n == 0x2E)
			{
				...
				if (o0_n == 0x00 || o0_n == 0x2F)
				{
					...
					o1_n = o0_n;
					while (o2_n - (sp_n + 0x60) <=u o2_n && (int32) (*o2_n) != 0x2F)
						o2_n += ~0x00;
					if (o2_n - (sp_n + 0x60) <u 0x00)
					{
						...
						word32 i1_n;
						word32 i2_n;
						notice("%s: invalid file name: %s\n", g_t28150, *((word32) sp_n + 72), out i1_n, out i2_n, out i6_n);
						exit(33);
					}
					o2_n = o2_n + 0x01;
					*o2_n = 0x00;
...
l000123B4:
		...
		struct Eq_n * sp_n = (struct Eq_n *) <invalid>;
		word32 i2_n;
		i6_n->tFFFFFFA8 = notice(l0_n, l3, sp_n->dw0048, out i1_n, out i2_n, out i6_n);
	}
	o0_n->t0008 = l4_n;
	goto l000123B4;
}
...
void save_def_or_dec()
{
	...
	word32 i1_n;
	word32 i1_n;
	struct Eq_n * i0_n = check_aux_info(0x01 - (word32) (((int32) (check_aux_info)(0x01 - (word32) (((int32) (check_aux_info)(0x01 - (word32) (((int32) (*xmalloc(out i1_n, out i2_n, out i6_n)) ^ 0x2F) < 0x00), out i1_n)[1] ^ 0x2A) < 0x00), out i1_n)[2] ^ 0x20) < 0x00), out i1_n);
	int8 * i0_n = i0_n + 3;
	if ((int32) i0_n[3] != 0x3A)
	{
		i0_n = (int8 *) (i0_n + 4);
							...
							if (o1_n - *((word32) o2_n + 8) == 0x00)
							{
								if (l2_n->ptr0004 - *((word32) o2_n + 4) == 0x00)
								{
									if (strcmp(l2_n->t000C, *((word32) o2_n + 0x0C)) != 0x00)
									{
										...
										word32 i6_n;
										word32 i1_n;
										notice("%s:%d: declaration of function `%s' takes different forms\n", l2_n->ptr0004->ptr0000->t0004, sp_n->dw0048, out i1_n, out i2_n, out i6_n);
										exit(33);
									}
									goto l00012AC0;
								}
...
Eq_n gen_aux_info_file(Eq_n o0, ptr32 & l0Out, struct stat & l1Out, char & l4Out, union Eq_n & i0Out, ptr32 & i2Out, ptr32 & i6Out)
{
	...
	else
	{
		...
		word32 i2_n;
		word32 i6_n;
		notice("%s: compiling `%s'\n", g_t28150, sp_n->dw0048, out i1_n, out i2_n, out i6_n);
	}
}
...
void declare_source_confusing(Eq_n o0)
{
	if (quiet_flag == 0x00)
	{
		if (o0 == 0x00)
		{
			...
			word32 i2_n;
			word32 i6_n;
			notice(l0_n, shortpath(0x00, g_t28180, out l0_n, out l1_n, out l2_n, out l3_n, out l4_n, out i0_n), sp_n->dw0048, out i1_n, out i2_n, out i6_n);
		}
		else
		{
			Eq_n i0_n;
			...
			word32 l3_n;
			word32 l4_n;
			Eq_n o0_n = shortpath(0x00, g_t28180, out l0_n, out l1_n, out l2_n, out l3_n, out l4_n, out i0_n);
...
uint32 output_bytes(Eq_n o0, Eq_n o1, ptr32 & l1Out, ptr32 & l2Out, union Eq_n & i0Out, union Eq_n & i1Out, ptr32 & i2Out)
{
	...
	up32 o1_n = g_dw28210 + ((word32) o1 + 1);
	Eq_n i0_n = o0;
	Eq_n i1_n = o1;
	ptr32 i2_n = o2;
	if (o1_n - l0_n <= o1_n)
	{
		...
		uint32 o1_n = g_dw28210;
		l0_n = (word32) o0_n + (l0_n - o0_n << 0x01);
		Eq_n o2_n = g_t281F0;
		g_dw28200 = l0_n;
...
l00013BAC:
	...
	if (l0_n == 0x00)
	{
		...
		if (i1_n != ~0x00)
		{
			...
			word32 i1_n;
			word32 i6_n;
			check_source(0x01 - (word32) (((int32) (*l0_n) ^ 0x29) < 0x00), l0_n, out i1_n, out i2_n, out i6_n);
...
word32 find_rightmost_formals_list(int8 * o0)
{
	...
	word32 i6_n;
	word32 i1_n;
	check_source(0x01 - (word32) (((int32) (*o0_n) ^ 0x7B) < 0x00), o0_n, out i1_n, out i2_n, out i6_n);
	return i6_n;
}
...
l0001452C:
	...
	if (o0_n != 0x28)
	{
		...
		if (g0_n != 0x00)
		{
			o0_n = g_t281C0;
l00014550:
			up32 i0_n = (word32) i0_n - 1;
			word32 i2_n;
			word32 i1_n;
			struct Eq_n * i6_n;
			i0_n = check_source(0x01 - (word32) (i0_n - o0_n > i0_n), 0x00, out i1_n, out i2_n, out i6_n);
			if (l0_n == 0x00)
			{
				l1Out = &g_t28000;
				i6Out = i6_n;
		...
		if (((ui32) o2_n->b2B411 & 0x03) != 0x00 || o2_n == (struct Eq_n *) 0x7B)
		{
			...
			do
			{
				...
				if (((ui32) g_a2B411[(ui32) o0_n->bFFFFFFFF] & 0x08) != 0x00)
				{
					...
					while (true)
					{
						...
						word32 i2_n;
						word32 i1_n;
						i0_n = check_source(0x01 - (word32) (o2_n - o1_n > o2_n), o1_n, out i1_n, out i2_n, out i6_n);
			...
			if (is_id_char((int32) *g_t28140) != 0x00)
			{
				...
				if (is_id_char((int32) *o0_n) != 0x00)
				{
					...
					word32 i2_n;
					word32 i1_n;
					check_source(0x01 - (word32) (((word32) o0_n - 1) - o1_n > (word32) o0_n - 1), o1_n, out i1_n, out i2_n, out i6_n);
				}
...
l000147BC:
						...
						word32 l2_n;
						word32 l1_n;
						Eq_n o0_n = shortpath(0x00, o1_n->ptr0000->t0004, out l0_n, out l1_n, out l2_n, out l3_n, out l4_n, out i0_n);
						identify_lineno(i0_n);
						struct Eq_n * sp_n = (struct Eq_n *) <invalid>;
						word32 i2_n;
						word32 i1_n;
...
l00014854:
	Eq_n o0_n = g_t28120;
	if ((word32) o0_n + 1 - i6_n->tFFFFFFEC <= (word32) o0_n + 1)
	{
...
void edit_file(struct Eq_n * o0)
{
	...
	if (directory_specified_p(o1_n) == 0x00 || file_excluded_p(g_t28180) != 0x00)
	{
		if (quiet_flag == 0x00 && in_system_include_dir(g_t28180) == 0x00)
		{
			...
			word32 l3_n;
			word32 l2_n;
			shortpath(0x00, g_t28180, out l0_n, out l1_n, out l2_n, out l3_n, out l4_n, out i0_n);
			struct Eq_n * sp_n = (struct Eq_n *) <invalid>;
			word32 i1_n;
			word32 i2_n;
			word32 i6_n;
...
void do_processing()
{
	...
	if (o0_n - (o0_n + (n_base_source_files << 0x02) / 4) < 0x00)
	{
		Eq_n o0_n = o0_n[0];
		while (true)
		{
...
Eq_n mkstemps(Eq_n o0, Eq_n o1)
{
	...
	if (o0_n - ((word32) o1 + 6) >= 0x00)
	{
		...
		else
		{
			...
			int32 o7_n = dwLoc18;
			up32 o1_n = (word32) o0_o1_n;
			up32 o1_n = o1_n + ((dwLoc14 << 0x10 ^ o7_n) ^ o0_n);
			g_qw2B400 = SEQ(SLICE(o0_o1_n, word32, 32) + (((dwLoc14 >> 0x10 | (dwLoc14 >> 0x1F) << 0x10) ^ o7_n >> 0x1F) ^ o0_n >> 0x1F) + (word32) (o1_n < o1_n), o1_n);
