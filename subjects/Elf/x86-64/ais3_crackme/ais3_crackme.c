...
// 0000000000400520: Register word32 verify(Register (arr Eq_120) rdi)
word32 verify(Eq_120 rdi[])
{
...
// 00000000004005C5: void main(Register (ptr64 Eq_197) rsi, Register word32 edi)
void main(struct Eq_197 * rsi, word32 edi)
{
	if (edi != 0x02)
