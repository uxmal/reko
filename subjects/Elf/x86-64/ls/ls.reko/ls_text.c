...
FILE * fn00000000004052D0(FILE * rcx, struct Eq_n * rdx, Eq_n rsi, FILE * rdi, Eq_n r12, struct Eq_n * fs)
{
	...
	if (rax_n > 0x1FFF)
	{
		Eq_n v24_n = (word64) (fp - 0x2088 - ((word32) rax_n + 31 & ~0x0F)) + 0x0F & ~0x0F;
		fn000000000040E6F0(~0x00, rsi, (word32) rax_n + 1, v24_n, rdx, fs);
		qwLoc2070_n = v24_n;
	}
	if (g_b61B0F0 == 0x00)
	{
...
int8 fn000000000040AB70(word32 edi)
{
	...
	if (rax_n == null)
		return 0x01;
	bool v17_n = rax_n->b0000 != 0x43;
	if (rax_n->b0000 == 0x43)
	{
		v17_n = rax_n->b0001 != 0x00;
		if (rax_n->b0001 == 0x00)
			return 0x00;
	}
...
l000000000040D53B:
		...
		if ((word32) rax_n <= 0x00)
		{
			...
			if (rbx != v22_n)
			{
				r12_n = *((word32) rdi + v22_n *64 0x08);
