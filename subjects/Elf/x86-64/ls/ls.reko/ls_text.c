...
l0000000000402AB1:
		...
		if (rax_n != 0x00)
		{
			...
			byte r13b_n;
			word32 ebx_n;
			if (fn0000000000410E90(rsp_n->t0020, 0x00, null, rax_n, 0x00, out ebx_n, out rbp_n, out r12_n, out r13b_n) == 0x00)
...
l0000000000402B30:
		rsp_n->t0038.u0 = ~0x00;
		Eq_n eax_n = getopt_long(ebx_n, rbp_n, "abcdfghiklmnopqrstuvw:xABCDFGHI:LNQRST:UXZ1", &g_t413080, &rsp_n->t0038);
		if (eax_n != ~0x00)
		{
			if (eax_n <= ~0x8E)
			{
				...
				case 0x54:
					...
					word32 ebx_n;
					byte r13b_n;
					if (fn0000000000410E90(rsp_n->t0020, 0x00, null, optarg, 0x00, out ebx_n, out rbp_n, out r12_n, out r13b_n) != 0x00)
					{
...
l0000000000402B78:
				...
				case 0x77:
					...
					word32 ebx_n;
					byte r13b_n;
					if (fn0000000000410E90(rsp_n->t0020, 0x00, null, optarg, 0x00, out ebx_n, out rbp_n, out r12_n, out r13b_n) != 0x00 || rsp_n->t0040 == 0x00)
					{
						fn000000000040E930(optarg, fs);
				...
				case 0x81:
					word64 r15_n;
					byte r14b_n;
					up32 eax_n = fn000000000040C810(&g_t61B138, &g_dw61B140, optarg, out r14b_n, out r15_n);
					if (eax_n != 0x00)
						fn00000000004112D0(rsp_n->t0038, eax_n);
...
l00000000004038A8:
				...
				else
				{
					...
					if (rax_n < 0x00)
					{
						...
						while (*rbx_n != 0x00)
						{
							__fprintf_chk(stderr, 1, 4274494, 0x00);
							++rbx_n;
						}
...
l00000000004038C2:
					...
					do
					{
						...
						{
							rsp_n->t0040 = r14_n;
							if (fn000000000040CDC0(rsp_n->t0020, 161, r13_n, nl_langinfo(r12d_n), 0x00, 0x00) > 0xA0)
							{
								g_t61A748.u0 = 0x00;
								...
								case 0x00:
									...
									if (cl_n == 0x2A)
									{
										...
										*((word64) rax_n + 8) = rsp_n->t0040;
										...
										ebx_n = (word32) rbx_n;
										word32 ebx_n;
										edx_n = (0x00 - (word32) (fn00000000004049E0(rax_n, 0x01, &rsp_n->t0038, rdi_n, out ebx_n, out rbp_n, out r12_n) < 0x01) & 0x02) + 0x03;
								...
								case 0x02:
									...
									if (*rax_n == 0x3D)
									{
										...
										*((word64) rcx_n + 8) = rsp_n->t0040;
										...
										edx_n = 0x00;
										word32 ebx_n;
										if (fn00000000004049E0(rcx_n, 0x00, &rsp_n->t0038, rdi_n, out ebx_n, out rbp_n, out r12_n) == 0x00)
										{
l0000000000404857:
								...
								case 0x03:
									...
									if (*rax_n == 0x3D)
									{
										...
										*((word64) r13_n + 24) = rsp_n->t0040;
										...
										ebx_n = (word32) rbx_n;
										word32 ebx_n;
										edx_n = 0x00 - (word32) (fn00000000004049E0((word64) r13_n + 16, 0x00, &rsp_n->t0038, rdi_n, out ebx_n, out rbp_n, out r12_n) < 0x01) & 0x05;
										goto l000000000040451F;
									}
									break;
								case 0x04:
...
l0000000000403AE2:
						if (g_b61B129 != 0x00)
						{
							...
							if (tcgetpgrp(1) >= 0x00)
							{
								...
								{
									int32 r14d_n = *r13_n;
									sigaction(r14d_n, 0x00, rsp_n->t0020);
									if (rsp_n->t0040 != 0x01)
...
l00000000004034D2:
							if (rsp_n->t0018 == 0x00)
							{
								...
								if (g_b61B130 != 0x00)
								{
									...
									__printf_chk(1, 0x00415D40, 0x00);
								}
...
l00000000004034C6:
							...
							rsp_n->b002F = (byte) *((word64) rax_n + 16);
							Eq_n rax_n = __errno_location();
							*rax_n = 0x00;
							Eq_n rax_n = opendir(r14_n);
							if (rax_n == 0x00)
							{
								fn0000000000405810(r14_n, dcgettext(null, 4274584, 5), (word32) (uint64) rsp_n->b002F, fs);
...
l00000000004036F0:
								...
								if (rax_n != null)
								{
									...
									word32 esi_n = 0x00;
									cu8 al_n = (byte) (word32) (uint64) rax_n->b0012 - 0x01;
									if (al_n <= 0x0D)
...
l0000000000403770:
								...
								if (*rax_n != 0x00)
								{
									fn0000000000405810(r14_n, dcgettext(null, 0x004139B1, 5), rsp_n->t0010, fs);
									if (*rax_n == 0x4B)
										goto l0000000000403770;
								}
								if (closedir(rax_n) != 0x00)
									fn0000000000405810(r14_n, dcgettext(null, 4274630, 5), (word32) (uint64) rsp_n->b002F, fs);
								fn0000000000404E80();
								if (g_b61B10E != 0x00)
									fn0000000000405090(rsp_n->b002F, r14_n);
...
l00000000004034A1:
							...
							if (eax_n >= 0x00)
								al_n = (byte) (__fxstat(1, eax_n, rdx_n) >> 0x1F);
							else
								al_n = (byte) (__xstat(1, r14_n, rdx_n) >> 0x1F);
							if (al_n != 0x00)
							{
								fn0000000000405810(r14_n, dcgettext(null, 4283624, 5), (word32) (uint64) rsp_n->b002F, fs);
								closedir(rax_n);
								goto l00000000004034A1;
							}
...
l00000000004043BB:
	...
	else
	{
		...
		word32 ebx_n;
		byte r13b_n;
		if (fn0000000000410E90(fp - 888, 0x00, null, rax_n, 0x00, out ebx_n, out rbp_n, out r12_n, out r13b_n) == 0x00)
		{
			Eq_n rax_n = rsp_n->t0040;
			if (rax_n != 0x00)
			{
	...
	do
	{
		...
		if (false)
		{
			while (true)
			{
				...
				if ((byte) (word32) rax_n > 55)
					break;
				r11_n.u0 = (uint64) ((word32) rax_n - 0x30 + (word32) r11_n * 0x08);
				++r8_n;
			}
...
l0000000000404AE0:
			...
			while ((byte) rcx_n <= 0x36)
			{
				...
				if ((r14d_n & 0x007E0000) == 0x00)
				{
					...
					{
						r11_n.u0 = (uint64) ((word32) rax_n - 0x57 + (r11d_n << 0x04));
						++r8_n;
				...
				++r8_n;
				rax_n = (uint64) *r8_n;
				r11_n.u0 = (uint64) ((word32) rax_n - 55 + (r11d_n << 0x04));
...
l0000000000404A70:
				...
				while (al_n != 0x3D)
				{
					...
					eax_n = (word32) rax_n;
					al_n = (byte) rax_n;
					if ((byte) (word32) rax_n > 0x7E || (byte) ((word32) rax_n) < 0x40)
					{
l0000000000404A2E:
						if (al_n != 0x3F)
						{
...
l0000000000405440:
				...
				if (al_n <= 0x3F)
				{
					if (al_n < 0x25 && (byte) ((word32) rax_n) > 0x23)
						goto l0000000000405460;
				}
				else if (al_n < 0x41 || al_n > 0x5F && ((byte) ((word32) rax_n) > 0x7E || (byte) ((word32) rax_n) < 0x61))
				{
l0000000000405460:
					do
					{
...
void fn0000000000405630(struct Eq_n * rsi, Eq_n rdi)
{
	...
	int64 rdx_n = (int64) ~(word32) rcx_n & rax_n + rcx_n;
...
// 0000000000405810: void fn0000000000405810(Register Eq_n rdx, Register Eq_n rsi, Register Eq_n edi, Register (ptr32 Eq_n) fs)
// Called from:
//      fn00000000004028C0
//      fn0000000000407EA0
void fn0000000000405810(Eq_n rdx, Eq_n rsi, Eq_n edi, struct Eq_n * fs)
{
	...
	if ((byte) rax_n != 0x00)
	{
		...
		if (rax_n < *((char *) rdi_n + 48))
		{
			...
			*rax_n = bl_n;
			...
			__overflow(rdi_n, (int32) (uint64) bl_n);
		g_t61B018 = (word64) g_t61B018 + 1;
	}
	...
	if (g_b61B144 != 0x00)
	{
		...
		else
		{
			...
			if (*((word64) rdi + 0x00B0) != 0x00)
				rax_n = strlen(fn000000000040BD70(0x0200, g_dw61B140, fp - 696, *((word64) rdi + 80), g_t61B138, fs)) + 0x01;
		}
		rbx_n += rax_n;
	}
	if (g_b61B17D != 0x00)
...
l000000000040622B:
	...
	__sprintf_chk(fp - 0x38, 1, 0x15, "%lu", 0x00);
	word32 ebx_n = (word32) fp - 0x38;
	word32 * rax_n = fp - 0x38;
	do
	{
		uint64 rcx_n = (uint64) *rax_n;
		uint64 rdx_n = (uint64) ((word32) rcx_n + ~0x01010100 & ~((word32) rcx_n) & 0x80808080);
		++rax_n;
	...
	rdx_n = (uint64) ((word32) rax_n - 0x03 - (word32) ((word64) (dl_n * 0x02 < 0x00)) - ebx_n);
...
void fn0000000000406490()
{
	while (g_dw61B038 != 0x00 || g_dw61B034 != 0x00)
	{
		...
		fflush_unlocked(stdout);
		sigprocmask(0, g_a61B040, fp + ~0x87);
...
l0000000000406BF7:
			...
			if (g_b61B114 != 0x00)
			{
				...
				__sprintf_chk(fp - 0x0E88, 1, 3643, "%*s ", 0x00);
				Eq_n rdx_n = fp - (struct Eq_n *) 0x0E88;
				do
				{
...
l0000000000406C8F:
				...
				__sprintf_chk(rbp_n, 1, ~0x00, "%s %*s ", 0x00);
				...
				if (g_b61A569 != 0x00 || (g_b61A568 != 0x00 || (g_b61B146 != 0x00 || g_b61B17D != 0x00)))
				{
					...
					g_t61B018 = (word64) g_t61B018 + (rbp_n - (fp - (struct Eq_n *) 0x0E88));
					if (g_b61A569 != 0x00)
...
l0000000000406D58:
				...
				if (*((word64) rdi + 0x00B0) != 0x00)
				{
					if ((*((word64) rdi + 40) & 0xB000) == 0x2000)
					{
						...
						fn000000000040CD70(fp - 0x1278, (uint64) (SEQ(SLICE(rax_n >> 0x0C, word24, 8), 0x00) | (word32) ((uint64) ((byte) rax_n))));
						uint64 rdx_n = *((word64) rdi + 56);
						fn000000000040CD70(fp - 0x1298, (uint64) ((word32) (rdx_n >> 0x20) & ~0x0FFF | (word32) (rdx_n >> 0x08) & 0x0FFF));
						__sprintf_chk(rbp_n, 1, ~0x00, "%*s, %*s ", 0x00);
						r13_n = rbp_n + 0x01 + CONVERT(Mem663[0x000000000061B154<p64>:word32], word32, int64);
						goto l0000000000406E9C;
					}
					r14_n = fn000000000040BD70(0x01, g_dw61B134, fp - 0x1278, *((word64) rdi + 64), g_t61A560, fs);
				}
				else
					r14_n.u0 = 4274020;
				...
				if (r13d_n > 0x00)
				{
					word64 rcx_n = rbp_n + 0x01 + CONVERT(r13d_n - 0x01, word32, uint64);
					Eq_n rdx_n = rbp_n;
					do
					{
						++rdx_n;
					...
					rbp_n = rbp_n + 0x01 + CONVERT(r13d_n - 0x01, word32, int64);
				}
				while (true)
				{
...
l0000000000406F80:
				...
				{
l0000000000407364:
					fn000000000040CCD0(fp - 0x1298, qwLoc12B8_n);
l0000000000406F86:
					if (g_dw61A3C4 < 0x00)
					{
						...
						if (rax_n != 0x00)
						{
							Eq_n rax_n = fn0000000000406A80(rax_n, g_t61A3D0, fp - 0x1278, fs);
							int32 r8d_n = g_dw61A3C4;
							if (rax_n != 0x00)
							{
								int32 eax_n = fn000000000040D240(0x00, rax_n, fp - 0x1278, fs);
								g_dw61A3C4 = eax_n;
								r8d_n = eax_n;
							}
							if (r8d_n >= 0x00)
					...
					{
l0000000000406F96:
						__sprintf_chk(r13_n, 1, ~0x00, "%*s ", 0x00);
						Eq_n rax_n = strlen(r13_n);
						rax_32_32_n = SLICE(rax_n, word32, 32);
						r13_n = r13_n + rax_n;
l0000000000406FBC:
						Eq_n r13_n = r13_n - (fp - (struct Eq_n *) 0x0E88);
						int32 eax_n = fputs_unlocked(fp - (struct Eq_n *) 0x0E88, stdout);
						Mem1072[0x000000000061B018<p64>:word64] = Mem1031[0x000000000061B018<p64>:word64] + r13_n;
						word64 rcx_n;
...
l0000000000406F20:
			...
			Eq_n r14_n = 4274020;
			if (*((word64) rdi + 0x00B0) != 0x00)
				r14_n = fn000000000040BD70(0x0200, g_dw61B140, fp - 0x1278, *((word64) rdi + 80), g_t61B138, fs);
			Eq_n rdx_n;
...
void fn0000000000407870(Eq_n rsi, Eq_n rdi, struct Eq_n * fs)
{
	...
	if (g_b61B114 != 0x00)
	{
		...
		rax_n = (uint64) __printf_chk(1, 4274041, 0x00);
	}
	if (g_b61B144 != 0x00)
	{
		if (*((word64) rdi + 0x00B0) != 0x00)
			fn000000000040BD70(0x0200, g_dw61B140, fp - 696, *((word64) rdi + 80), g_t61B138, fs);
		rax_n = (uint64) __printf_chk(1, 4274041, 0x00);
	}
	if (g_b61B17D != 0x00)
		rax_n = (uint64) __printf_chk(1, 4274041, 0x00);
...
l0000000000407FB1:
								...
								fn0000000000405810(r12_n, dcgettext(null, 0x00413783, 5), (word32) (uint64) r15b_n, fs);
								r12_n.u0 = 0x00;
								if (r15b_n != 0x00)
...
l000000000040862A:
								...
								if (rax_n == 0x00)
								{
									fn0000000000405810(r12_n, dcgettext(null, 0x00413794, 5), (word32) (uint64) bLoc038C_n, fs);
									r13_n = r14_n[1];
									if (r13_n == 0x00)
								...
								if (*r13_n != 0x2F)
								{
									...
									r13_n = fn0000000000410E30(r13_n);
								if (r13_n != 0x00 && (g_dw61B12C > 0x01 || g_b61B115 != 0x00) && __xstat(1, r13_n, fp - 0x0388) == 0x00)
								{
									r14_n->b00B1 = 0x01;
...
l000000000040873F:
											...
											if ((r14_n[5] & 0xB000) == 0x2000)
											{
												...
												int32 eax_n = (word32) strlen(fn000000000040CD70(fp - 0x02D8, (uint64) ((word32) (rax_n >> 0x20) & ~0x0FFF | (word32) (rax_n >> 0x08) & 0x0FFF)));
												if (eax_n > g_dw61B15C)
													g_dw61B15C = eax_n;
												uint64 rax_n = r14_n[7];
												int32 eax_n = (word32) strlen(fn000000000040CD70(fp - (char *) 0x02D8, (uint64) (SEQ(SLICE(rax_n >> 0x0C, word24, 8), 0x00) | (word32) ((uint64) ((byte) rax_n)))));
...
l00000000004081F4:
											...
											{
												eax_n = fn000000000040D420(0x00, fn000000000040BD70(0x01, g_dw61B134, fp - 0x02D8, r14_n[8], g_t61A560, fs), fs);
												if (eax_n <= g_dw61B154)
													goto l00000000004081D2;
											}
											g_dw61B154 = eax_n;
								...
								int32 eax_n = fn000000000040D420(0x00, fn000000000040BD70(0x0200, g_dw61B140, fp - 0x02D8, r12_n, g_t61B138, fs), fs);
								if (eax_n > g_dw61B174)
									g_dw61B174 = eax_n;
								r13d_n = g_dw61B150;
								if (r13d_n != 0x00)
...
l0000000000408AF5:
								...
								__sprintf_chk(fp - (char *) 0x02D8, 1, 0x15, "%lu", 0x00);
								Eq_n rdx_n = fp - (char *) 0x02D8;
								do
								{
									uint64 rcx_n = (uint64) *rdx_n;
									uint64 rax_n = (uint64) ((word32) rcx_n + ~0x01010100 & ~((word32) rcx_n) & 0x80808080);
								...
								if ((eax_n & 0x8080) == 0x00)
									rdx_n += 0x02;
								edx_n = (word32) rdx_n - 0x03 - (word32) ((word64) (al_n * 0x02 < 0x00)) - r15d_n;
...
struct Eq_n * fn000000000040A000(Eq_n rdx, Eq_n rsi, Eq_n rdi[], struct Eq_n * fs, union Eq_n & rdxOut, FILE & rsiOut, union Eq_n & rdiOut, union Eq_n & r8Out, union Eq_n & r9Out)
{
	...
	while (r12_n != 0x00)
	{
		if (rbx_n != 0x00 && memcmp(r14_n, rbp_n, rdx) == 0x00)
		{
			...
			word64 r9_n;
			fn000000000040EC10(r12_n, fs, out r8_n, out r9_n);
			__fprintf_chk(stderr, 1, 0x00415E52, 0x00);
			++rbx_n;
			rbp_n += rdx;
			rdx_n.u0 = 0x00415E52;
			rsi_n = (FILE *) 0x01;
		...
		word64 r9_n;
		fn000000000040EC10(r12_n, fs, out r8_n, out r9_n);
		__fprintf_chk(stderr, 1, 0x00415E4A, 0x00);
		++rbx_n;
		r14_n = rbp_n;
		rdx_n.u0 = 0x00415E4A;
		rsi_n = (FILE *) 0x01;
...
void fn000000000040A600(struct Eq_n * rsi, struct Eq_n * rdi)
{
	...
	byte dl_n;
	if ((edi_n & 0xF000) != 0x8000)
	{
		if ((edi_n & 0xF000) != 0x4000)
		{
			if ((edi_n & 0xF000) != 0x6000)
			{
				if ((edi_n & 0xF000) != 0x2000)
				{
					if ((edi_n & 0xF000) != 0xA000)
					{
						if ((edi_n & 0xF000) != 0x1000)
						{
							dl_n = 115;
	...
	byte al_n;
	rsi->b0000 = dl_n;
	rsi->b0001 = (0x00 - (byte) ((word32) ((edi_n & 0x0100) < 0x01)) & ~0x44) + 114;
	rsi->b0002 = (0x00 - (byte) ((word32) ((edi_n & 0x80) < 0x01)) & ~0x49) + 0x77;
	...
	byte al_n;
	rsi->b0003 = al_n;
	rsi->b0004 = (0x00 - (byte) ((word32) ((edi_n & 0x20) < 0x01)) & ~0x44) + 114;
	rsi->b0005 = (0x00 - (byte) ((word32) ((edi_n & 0x10) < 0x01)) & ~0x49) + 0x77;
	...
	if ((edi_n & 0x0400) != 0x00)
		...
		al_n = ((byte) eax_n & 181) + 0x78;
	rsi->b0006 = al_n;
	rsi->b0007 = (0x00 - (byte) ((word32) ((edi_n & 0x04) < 0x01)) & ~0x44) + 114;
	rsi->b0008 = (0x00 - (byte) ((word32) ((edi_n & 0x02) < 0x01)) & ~0x49) + 0x77;
	if ((edi_n & 0x0200) == 0x00)
	{
		rsi->b000A = 0x20;
		rsi->b000B = 0x00;
		rsi->b0009 = (0x00 - (byte) ((word32) ((edi_n & 0x01) < 0x01)) & 181) + 0x78;
	}
	else
	{
		rsi->b000A = 0x20;
		rsi->b000B = 0x00;
		rsi->b0009 = (0x00 - (byte) ((word32) ((edi_n & 0x01) < 0x01)) & 0xE0) + 116;
	}
}
...
// 000000000040ACB0: Register Eq_n fn000000000040ACB0(Register word32 ecx, Register (ptr64 (ptr64 Eq_n)) rdx, Register Eq_n rsi, Register Eq_n rdi, Register out Eq_n rsiOut)
// Called from:
//      fn000000000040B8F0
//      fn000000000040BB90
Eq_n fn000000000040ACB0(word32 ecx, struct Eq_n ** rdx, Eq_n rsi, Eq_n rdi, union Eq_n & rsiOut)
{
...
word32 fn000000000040B710(Eq_n rsi, Eq_n rdi)
{
	...
	{
		*((word64) rdi + 72) = rax_n;
		if ((byte) fn000000000040AE40(0x01, fp - 0x68, rdi) == 0x00 || (byte) fn000000000040AE40(0x00, fp - 0x68, rdi) == 0x00)
			abort();
		else
		{
			free(rax_n);
...
{
	Eq_n rax_n;
	word32 eax_n = fn000000000040B8F0(fp - 0x10, rsi, rdi);
	if (eax_n != ~0x00)
	{
		rax_n = rsi;
		if (eax_n == 0x00)
					...
					do
					{
						...
						if (rsi_n > rax_n)
						{
							...
							if ((edx & 0x03) != 0x01)
								...
								dl_n = (int8) ((word32) ecx_n.u1 + (eax_n & 0x01) > 0x02);
							if (dl_n == 0x00)
							{
								if (eax_n == 0x00)
								{
...
l000000000040C530:
			...
			if ((edx & 0x03) != 0x01)
			{
				...
				al_n = CONVERT(edi_n + SLICE(CONVERT(CONVERT(SLICE(r10_n, word32, 0) & 0x01, word32, uint64) + CONVERT(ecx_n, word32, int64) != 0x00, bool, uint64), word32, 0) > 0x05, bool, int8);
			if (al_n != 0x00)
			{
			...
			do
			{
				...
				--r12_n;
				*r12_n = (byte) (word32) r10_n - ((byte) ((word32) (rdx_n >> 0x03)) + (byte) ((word32) (rdx_n >> 0x03)) * 0x04) * 0x02 + 0x30;
				r10_n = rdx_n >> 0x03;
...
l000000000040BE7D:
	...
	if ((bLocC8_n & 0x10) != 0x00)
	{
		...
		if (rax_n >u (r11_n + 0x02) + CONVERT(CONVERT((edx & 0x20) == 0x00, bool, int8), int8, uint64) || (bLocC8_n & 0x08) != 0x00 && Mem961[(rsi - 0x01) + rax_n:byte] == 0x30)
		{
			...
			__sprintf_chk(rsi, 1, ~0x00, "%.0Lf", 0x00);
			r14_n = 0x00;
			r15_n = strlen(rsi);
		}
	}
...
word32 fn000000000040C810(union Eq_n * rdx, ui32 * rsi, Eq_n rdi, union Eq_n & r14bOut, ptr64 & r15Out)
{
	...
	if (rdi == 0x00)
	{
		...
		if (rax_n == 0x00)
		{
			...
			if (rax_n == 0x00)
			{
				uint64 rdx_n = (uint64) (0x00 - (word32) ((word64) (getenv("POSIXLY_CORRECT") < 0x01)) & 0x0200);
	...
	if (eax_n >= 0x00)
	{
		*rdx = 0x01;
		rdx_n.u0 = 0x01;
		ebp_n = ebp_n | g_a415F50[(int64) eax_n * 0x04];
		goto l000000000040C864;
	}
...
l000000000040C86A:
		if (rdx_n == 0x00)
		{
			*r12_n = (union Eq_n *) ((uint64) (0x00 - (word32) ((word64) (getenv("POSIXLY_CORRECT") < 0x01)) & 0x0200) + 0x0200);
			rax_n = 0x04;
		}
		r14bOut.u1 = <invalid>;
		r15Out = r15;
	...
	if ((byte) (word32) (uint64) *rbx_n > 0x39)
	{
		Eq_n rdx_n = rsp_n->t0008;
		while (rbx_n != rdx_n)
		{
			rbx_n = (word64) rbx_n + 1;
			if ((byte) (word32) (uint64) *rbx_n <= 0x39 && (byte) ((word32) ((uint64) (*rbx_n))) >= 0x30)
...
// 000000000040CCD0: void fn000000000040CCD0(Register Eq_n rsi, Register int64 rdi)
// Called from:
//      fn0000000000406B70
void fn000000000040CCD0(Eq_n rsi, int64 rdi)
{
	*((word64) rsi + 20) = 0x00;
	...
	if (rdi < 0x00)
	{
		do
		{
			...
			--rcx_n;
			rcx_n->b0000 = (byte) (word32) rdx_n * 0x0A + 0x30 - (byte) ((word32) rdi);
			rdi = rdx_n;
		} while (rdx_n != 0x00);
	...
	else
	{
		do
		{
			int64 rdx_n = (SLICE(rdi *s128 0x6666666666666667, word64, 64) >> 0x02) - (rdi >> 0x3F);
			--rcx_n;
			rcx_n->b0000 = (byte) (word32) rdi - (byte) ((word32) rdx_n) * 0x0A + 0x30;
			rdi = rdx_n;
		} while (rdx_n != 0x00);
	}
}
...
byte * fn000000000040CD70(Eq_n rsi, Eq_n rdi)
{
	*((word64) rsi + 20) = 0x00;
	...
	do
	{
		...
		--rcx_n;
		*rcx_n = (byte) (word32) rdi - ((byte) ((word32) (rdx_n >> 0x03)) + (byte) ((word32) (rdx_n >> 0x03)) * 0x04) * 0x02 + 0x30;
		rdi = rdx_n >> 0x03;
	} while (rdx_n >> 0x03 != 0x00);
	return rcx_n;
}
...
// 000000000040D420: Register int32 fn000000000040D420(Register word32 esi, Register Eq_n rdi, Register (ptr32 Eq_n) fs)
// Called from:
//      fn0000000000405700
//      fn00000000004061B0
//      fn0000000000406B70
//      fn0000000000407EA0
int32 fn000000000040D420(word32 esi, Eq_n rdi, struct Eq_n * fs)
{
	Eq_n rax_n = strlen(rdi);
	uint64 rdx_n = (uint64) esi;
...
// 000000000040D7B0: Register Eq_n fn000000000040D7B0(Register up32 esi, Register Eq_n rdi, Register (ptr32 Eq_n) fs, Register out ptr64 rcxOut, Register out Eq_n rdxOut)
// Called from:
//      fn000000000040D8A0
Eq_n fn000000000040D7B0(up32 esi, Eq_n rdi, struct Eq_n * fs, ptr64 & rcxOut, union Eq_n & rdxOut)
{
...
// 000000000040D8A0: Register Eq_n fn000000000040D8A0(Register Eq_n rcx, Register Eq_n rdx, Register Eq_n rsi, Register Eq_n rdi, Register up32 r8d, Register uint32 r9d, Register (ptr32 Eq_n) fs, Stack Eq_n qwArg08, Stack Eq_n qwArg10, Stack Eq_n qwArg18, Register out Eq_n rbxOut, Register out Eq_n rbpOut, Register out Eq_n r12Out, Register out Eq_n r13Out, Register out Eq_n r14Out, Register out Eq_n r15Out)
// Called from:
//      fn000000000040D8A0
//      fn000000000040E6F0
//      fn000000000040E930
Eq_n fn000000000040D8A0(Eq_n rcx, Eq_n rdx, Eq_n rsi, Eq_n rdi, up32 r8d, uint32 r9d, struct Eq_n * fs, Eq_n qwArg08, Eq_n qwArg10, Eq_n qwArg18, union Eq_n & rbxOut, union Eq_n & rbpOut, union Eq_n & r12Out, union Eq_n & r13Out, union Eq_n & r14Out, union Eq_n & r15Out)
{
	word64 rax_n = fs->qw0028;
	...
	case 0x08:
		...
		if (r8d != 0x08)
		{
			word64 rdx_n;
			word64 rcx_n;
			qwLoc88_n = fn000000000040D7B0(r8d, 4284405, fs, out rcx_n, out rdx_n);
			qwLoc90_n = fn000000000040D7B0(r8d, 4287978, fs, out rcx_n, out rdx_n);
		}
		rbx_n.u0 = 0x00;
		Eq_n rcx_n = rcx_n;
		if (al_n == 0x00)
	...
	Eq_n r14_n = rsi;
	Eq_n r8_n = rdx;
	ui8 al_n = (byte) (word32) (uint64) bLocC5_n ^ 0x01;
	ui8 al_n = (byte) (word32) (uint64) bLocD8_n ^ 0x01;
...
l000000000040D9A8:
			...
			do
			{
				...
				if (rax_n == 0x00)
				{
					...
					dl_n = (byte) rdx_n;
					rdx_56_8_n = SLICE(rdx_n, word56, 8);
					rcx_n = SEQ(SLICE(fp - 0x48, word56, 8), cl_n);
				...
				Eq_n rcx_n = SEQ(SLICE(fp - 0x48, word56, 8), cl_n);
				if (bLocC5_n != 0x00)
				{
					rcx_n = SEQ(SLICE(fp - 0x48, word56, 8), cl_n);
					if (dwLocC4_n == 0x02)
					{
						...
						if (rax_n != 0x01)
						{
							...
							do
							{
								rcx_n = CONVERT(SLICE(CONVERT(Mem419[r15_n + rdx_n:byte], byte, uint64), word32, 0) - 0x5B, word32, uint64);
								cu8 cl_n = (byte) rcx_n;
				...
				rdi_n = fp - 0x48;
				if (iswprint(dwLoc4C) == 0x00)
					r12d_n = 0x00;
				rbx_n += rax_n;
			} while (mbsinit(fp - 0x48) == 0x00);
			rsi_n = (uint64) r12d_n;
			uint64 rdx_n = (uint64) ((word32) rsi_n ^ 0x01);
			r12_n.u0 = (uint64) r12b_n;
			rax_n = rbx_n;
			dl_n = (byte) rdx_n;
			rdx_56_8_n = SLICE(rdx_n, word56, 8);
...
l000000000040DEF0:
				...
				if (r14_n >u rbx_n + 0x01)
				{
					...
					Mem799[rdi + 0x01 + rbx_n:byte] = (SLICE(rsi_n, byte, 0) >>u 0x06) + 0x30;
				}
				rsi_n = rbx_n + 0x02;
				if (r14_n > rsi_n)
				{
...
l000000000040DB09:
			...
			if (qwArg08 != 0x00)
			{
				...
				rdx_n = (uint64) ((byte) r12d_n >> 0x05);
				r12_56_8_n = SEQ(r12_32_32_n, r12d_24_8_n);
				if ((*((word64) qwArg08 + rdx_n * 0x04) & 0x01 << (byte) rcx_n) == 0x00)
					goto l000000000040DB2E;
...
l000000000040DC46:
					...
					word64 r15_n;
					word64 r12_n;
					rax_n = fn000000000040D8A0(r15_n, r13_n, r11_n, rdi, dwLocC4_n, r9d & ~0x02, fs, 0x00, qwLoc88_n, qwLoc90_n, out rbx_n, out rbp_n, out r12_n, out r13_n, out r14_n, out r15_n);
...
Eq_n fn000000000040E450(struct Eq_n * rcx, Eq_n rdx, Eq_n rsi, word32 edi, struct Eq_n * fs, ptr64 & r8Out, ptr64 & r9Out)
{
	...
	else
	{
		...
		word32 * r13_n;
		Eq_n r14_n;
		Eq_n rax_n = fn000000000040D8A0(rdx, rsi, r12_n->t0000, r12_n->t0008, rcx->dw0000, rcx->dw0004 | 0x01, fs, &rcx->dw0004 + 1, rcx->t0028, rcx->t0030, out rbx_n, out rbp_n, out r12_n, out r13_n, out r14_n, out r15_n);
		struct Eq_n * rsp_n = (struct Eq_n *) <invalid>;
		uint32 ebp_n = (word32) rbp_n;
		if (rsp_n->t0038 <= rax_n)
		{
			...
			word64 rbx_n;
			word64 rbp_n;
			fn000000000040D8A0(rcx_n, rdx_n, rsi_n, rax_n, r8d_n, ebp_n, fs, rsp_n->t0000, rsp_n->t0008, rsp_n->t0010, out rbx_n, out rbp_n, out r12_n, out r13_n, out r14_n, out r15_n);
		}
		ptr64 r9_n;
		ptr64 r8_n;
		*r13_n = eax_n;
...
Eq_n fn000000000040E6F0(Eq_n rcx, Eq_n rdx, Eq_n rsi, Eq_n rdi, struct Eq_n * r8, struct Eq_n * fs)
{
	...
	word64 r13_n;
	word64 rbx_n;
	Eq_n rax_n = fn000000000040D8A0(rcx, rdx, rsi, rdi, rbx_n->dw0000, rbx_n->dw0004, fs, &rbx_n->dw0004 + 1, rbx_n->t0028, rbx_n->t0030, out rbx_n, out rbp_n, out r12_n, out r13_n, out r14_n, out r15_n);
	*rbp_n = (word32) r12_n;
	return rax_n;
}
...
void fn000000000040E970(Eq_n rdx, word32 esi, word32 edi, struct Eq_n * fs)
{
	...
	word64 r8_n;
	word64 r9_n;
	fn000000000040E450(fp - 88, ~0x00, rdx, edi, fs, out r8_n, out r9_n);
}
...
void fn000000000040EC30(word64 rdx, ptr64 rsi, byte rdi[])
{
	...
	if (rdx != 0x00)
	{
		...
		do
		{
			rdi[rbx_n] = (byte) *((char *) *rax_n + (uint64) (rsi + rbx_n) * 0x04);
			--rbx_n;
		} while (rbx_n != ~0x00);
	}
}
...
// Called from:
//      fn0000000000410600
uint64 fn000000000040ECD0(Eq_n rcx, uint64 rdx, Eq_n rsi, byte dil, Eq_n r8, struct Eq_n * fs)
{
	byte dil = (byte) rdi;
	Eq_n r12_n = rsi;
	Eq_n rbx_n = rcx;
	word64 rsi_n = fs->qw0028;
	int32 esi_n = *((word64) r8 + 8);
	uint64 rax_n;
	byte al_n = *rcx;
	uint64 r13_n = 0x00;
	if (al_n != 0x00)
...
void fn0000000000410630(uint64 rcx, uint64 rsi, FILE * rdi, uint64 r9)
{
	...
	if (rsi != 0x00)
	{
		__fprintf_chk(rdi, 1, 4286656, 0x00);
		r9_n = rcx;
	}
	else
	{
		__fprintf_chk(rdi, 1, 4286668, 0x00);
		r9_n = r9;
	}
	Eq_n rax_n = dcgettext(null, 4286675, 5);
	__fprintf_chk(rdi, 1, 0x00416BA0, 0x00);
...
// 0000000000410E90: Register ui32 fn0000000000410E90(Register Eq_n rcx, Register Eq_n edx, Register (ptr64 (ptr64 char)) rsi, Register Eq_n rdi, Register Eq_n r8, Register out Eq_n ebxOut, Register out (ptr64 Eq_n) rbpOut, Register out Eq_n r12Out, Register out Eq_n r13bOut)
// Called from:
//      fn00000000004028C0
ui32 fn0000000000410E90(Eq_n rcx, Eq_n edx, char ** rsi, Eq_n rdi, Eq_n r8, union Eq_n & ebxOut, union Eq_n & rbpOut, union Eq_n & r12Out, union Eq_n & r13bOut)
{
	if (edx > 0x24)
...
l0000000000410EF0:
	...
	Eq_n rax_n = __errno_location();
	*rax_n = 0x00;
	uint64 rax_n = SEQ(SLICE(rax_n, word32, 32), strtoul(rdi, r15_n, edx));
	Eq_n r14_n = *r15_n;
	uint64 rbx_n = rax_n;
	if (r14_n != rdi)
	{
...
// 00000000004112D0: void fn00000000004112D0(Register Eq_n esi, Register up32 edi)
// Called from:
//      fn00000000004028C0
void fn00000000004112D0(Eq_n esi, up32 edi)
{
	Eq_n rsi_n;
...
// 0000000000411360: Register ui32 fn0000000000411360(Register (ptr64 Eq_n) rcx, Register Eq_n edx, Register (ptr64 (ptr64 char)) rsi, Register Eq_n rdi, Register Eq_n r8, Register out Eq_n rbxOut, Register out Eq_n ebpOut, Register out Eq_n r12Out, Register out (ptr64 Eq_n) r13Out, Register out Eq_n r14bOut, Register out (ptr64 (ptr64 char)) r15Out)
// Called from:
//      fn000000000040C810
ui32 fn0000000000411360(union Eq_n * rcx, Eq_n edx, char ** rsi, Eq_n rdi, Eq_n r8, union Eq_n & rbxOut, union Eq_n & ebpOut, union Eq_n & r12Out, union Eq_n & r13Out, union Eq_n & r14bOut, char & r15Out)
{
	if (edx > 0x24)
...
l00000000004113C0:
	...
	Eq_n rax_n = __errno_location();
	*rax_n = 0x00;
	Eq_n rax_n = SEQ(SLICE(rax_n, word32, 32), __strtoul_internal(rdi, r15_n, edx, 0));
	Eq_n r14_n = *r15_n;
	Eq_n rbx_n = rax_n;
	if (r14_n != rdi)
	{
