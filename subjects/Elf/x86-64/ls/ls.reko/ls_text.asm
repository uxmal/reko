...
l0000000000403242:
	...
	call	fn000000000040E600
	mov	rdi,rax
	mov	[000000000061B0E8],rax                                 ; [rip+00217E8E]
	call	fn000000000040E630
	cmp	eax,5h
	jz	40426Ch
...
l0000000000404BE0:
	mov	r11d,20h
	jmp	404BD0h
0000000000404BE8                         0F 1F 84 00 00 00 00 00         ........

l0000000000404BF0:
	mov	eax,6h
	jmp	404BB0h
0000000000404BF7                      66 0F 1F 84 00 00 00 00 00        f........

l0000000000404C00:
	lea	r11d,[rax-30h]
	mov	eax,2h
	jmp	404BB0h
0000000000404C0B                                  0F 1F 44 00 00            ..D..

l0000000000404C10:
	mov	r11d,7Fh
	jmp	404BD0h
0000000000404C18                         0F 1F 84 00 00 00 00 00         ........

l0000000000404C20:
	mov	r11d,7h
	jmp	404BD0h
0000000000404C28                         0F 1F 84 00 00 00 00 00         ........

l0000000000404C30:
	mov	r11d,8h
	jmp	404BD0h
0000000000404C38                         0F 1F 84 00 00 00 00 00         ........

l0000000000404C40:
	mov	r11d,9h
	jmp	404BD0h
0000000000404C48                         0F 1F 84 00 00 00 00 00         ........

l0000000000404C50:
	mov	r11d,0Bh
	jmp	404BD0h
0000000000404C5B                                  0F 1F 44 00 00            ..D..

l0000000000404C60:
	mov	r11d,0Ah
	jmp	404BD0h
0000000000404C6B                                  0F 1F 44 00 00            ..D..

l0000000000404C70:
	mov	r11d,0Dh
	jmp	404BD0h
0000000000404C7B                                  0F 1F 44 00 00            ..D..

l0000000000404C80:
	mov	r11d,0Ch
	jmp	404BD0h
0000000000404C8B                                  0F 1F 44 00 00            ..D..
...
l00000000004057CB:
	...
	pop	rbx
	mov	rdi,rax
	jmp	fn0000000000405700
00000000004057DD                                        0F 1F 00              ...

l00000000004057E0:
	mov	[rsp+0Ch],esi
	call	fn000000000040C9B0
	mov	esi,[rsp+0Ch]
	jmp	4057CBh
00000000004057EF                                              90                .
...
l0000000000409FA4:
	mov	rsi,rbp
	mov	edi,1h
	call	fn000000000040EBF0
	mov	rdx,rbx
	mov	esi,6h
	xor	edi,edi
	mov	rbp,rax
	call	fn000000000040E970
	pop	rbx
	mov	r8,rbp
	mov	rdx,r12
	mov	rcx,rax
...
l000000000040DCCB:
	mov	r12d,eax
	jmp	40DB33h
000000000040DCD3          0F 1F 44 00 00                            ..D..        
...
l000000000040DCE0:
	mov	eax,66h
	jmp	40DCC0h
000000000040DCE7                      66 0F 1F 84 00 00 00 00 00        f........

l000000000040DCF0:
	mov	eax,76h
	jmp	40DCC0h
000000000040DCF7                      66 0F 1F 84 00 00 00 00 00        f........

l000000000040DD00:
	mov	eax,6Eh
	jmp	40DCB5h
000000000040DD07                      66 0F 1F 84 00 00 00 00 00        f........

l000000000040DD10:
	mov	eax,74h
	jmp	40DCB5h
000000000040DD17                      66 0F 1F 84 00 00 00 00 00        f........
...
l000000000040DD80:
	...
	mov	r12d,30h
	jmp	40DB09h
000000000040DD8E                                           66 90               f.

l000000000040DD90:
	mov	eax,61h
	jmp	40DCC0h
000000000040DD9A                               66 0F 1F 44 00 00           f..D..
...
l000000000040DE00:
	mov	rax,[rsp+28h]
	mov	byte ptr [rax+rbx+2h],27h

l000000000040DE0A:
	add	rbx,3h
	jmp	40DAF8h
000000000040DE13          0F 1F 44 00 00                            ..D..        
...
l000000000040E240:
	test	byte ptr [rsp+90h],1h
	jz	40DAF8h

l000000000040E24E:
	add	rbp,1h
	jmp	40D986h
000000000040E257                      66 0F 1F 84 00 00 00 00 00        f........
...
l000000000040E270:
	cmp	byte ptr [r8+1h],0h
	setnz	al
	jmp	40DC11h
000000000040E27D                                        0F 1F 00              ...
...
fn000000000040E970 proc
	...
	sub	rsp,48h
	mov	rdi,rsp
	call	fn000000000040D740
	mov	rcx,rsp
	mov	rsi,rbp
	mov	edi,ebx
	mov	rdx,-1h
	call	fn000000000040E450
	add	rsp,48h
	pop	rbx
	pop	rbp
	ret
...
;;   Called from:
;;     000000000040F1AD (in fn000000000040ECD0)
;;     000000000041037D (in fn000000000040ECD0)
...
;;   Called from:
;;     000000000040F028 (in fn000000000040ECD0)
;;     000000000040F15C (in fn000000000040ECD0)
;;     000000000040F4BD (in fn000000000040ECD0)
;;     000000000040F757 (in fn000000000040ECD0)
...
;;   Called from:
;;     000000000040F82D (in fn000000000040ECD0)
;;     000000000040F8BE (in fn000000000040ECD0)
...
l000000000040EF0C:
	test	ecx,ecx
	mov	byte ptr [rsp+0B0h],20h
	mov	byte ptr [rsp+0B1h],25h
	jnz	4105EFh

l000000000040EF24:
	lea	rax,[rsp+0B2h]
	mov	r8,rbx
	mov	dword ptr [rsp+18h],0h
...
l000000000040F065:
	...
	mov	rax,r13
	jmp	40EE9Ah
000000000040F072       66 0F 1F 44 00 00                           f..D..        
...
l000000000040F531:
	jmp	40F53Bh
000000000040F533          0F 1F 44 00 00                            ..D..        
...
l000000000040FD9C:
	jmp	40F228h
000000000040FDA1    0F 1F 80 00 00 00 00                          .......        
...
l000000000040FF64:
	...
	mov	byte ptr [rsp+30h],1h
	jmp	40F5A8h
000000000040FF73          0F 1F 44 00 00                            ..D..        
...
l00000000004102D3:
	...
	shr	r10d,1Fh
	imul	eax,r8d
	mov	byte ptr [rsp+28h],1h
	mov	dword ptr [rsp+18h],9h
	lea	r8d,[rdi+rax]
	mov	edi,14h
	add	r8d,edx
	jmp	40F238h
