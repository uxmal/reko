...
l00000000000172C4:
		...
		if (s5_141 == 0x0020)
		{
			a2->ptr00A8 = &sp_103->qw0038;
			a2->ptr00B0 = &sp_103->qw0038;
	...
	if ((a1 & 0x03) == 0x00)
	{
		...
		if (t5_38 != 0x00)
		{
			...
			do
			{
				...
				Eq_4351 a6_127 = (a5_94 & 0x0F) + 0x0057;
				if (t1_84 >= (a5_94 & 0x0F))
					a6_127 = (a5_94 & 0x0F) + 0x0030;
				(word64) (a4_123 << 0x00 >> 0x00) + ((word64) fp - 0x0010) + 3832 = (union Eq_4351 *) a6_127;
				(word64) (a3_95 << 0x00 >> 0x00) + ((word64) fp - 0x0010) + 3832 = (union Eq_4334 *) a7_85;
				int64 a2_109 = (int64) ((word32) a4_123 + 0x02);
				int64 a3_110 = (int64) ((word32) a4_123 + 0x03);
				Eq_4334 a6_111 = (a5_94 >> 0x04) + 0x0030;
				if (t1_84 < a5_94 >> 0x04)
