...
l0000000000015CB0:
			...
			if (s1_n != 0x00)
			{
				...
				if (fn00000000000164D0(fp + -391, 0x0F) >= 0x00 && inet_ntop(0x0A, &tLoc0188, fp + -0x00B8, 64) != null)
...
int32 * fn00000000000166F4(struct Eq_n * gp, int32 * a0, Eq_n a1, int64 a2)
{
	...
	{
		if ((uint64) inet_pton(2, a1, &tLoc40) != 0x00)
		{
			word64 a4_n;
			word64 a3_n;
			int64 a0_n = fn00000000000182B4((int64) tLoc40, out a3_n, out a4_n);
			while (a0_n != 0x00)
			{
				if ((a0_n & 1) != 0x00)
				{
...
Eq_n fn0000000000016D74(word64 ra, struct Eq_n * gp, Eq_n a0, char * a1, struct Eq_n * a2, Eq_n a3, union Eq_n & a4Out)
{
	...
	struct Eq_n * s6_n = a2;
	char * s5_n = a1;
	if ((uint64) inet_pton(2, a0, &tLoc01B8) <= 0x00)
	{
		if ((int64) gp->dwFFFFF814 != 0x00)
...
l0000000000016E24:
	...
	else
	{
		...
		if (a3 << 0x2D < 0x00)
		{
			word64 a4_n;
			word64 a3_n;
			int64 a0_n = fn00000000000182B4((int64) tLoc01B8.t0000, out a3_n, out a4_n);
			s5_n = (char *) 8;
			int64 a5_n = (int64) ((word32) a0_n >> 24);
			if (a0_n < 0x00)
			{
	...
	if (inet_ntop(2, &tLoc01B8, fp + -0x0188, 47) != null)
	{
		...
		int64 s0_n = (int64) tLoc01B8.t0000;
		...
		int64 s0_n = fn0000000000016830(gp, s5_n) & (int64) tLoc01B8.t0000;
...
l000000000001717C:
			if (a3 << 0x31 < 0x00)
				gp = fn0000000000017B40(ra, gp, (int64) tLoc01B8.t0000, &a2->qw0038 + 1, &a2->qw0038 + 2, &a2->qw0038 + 3, &a2->qw0038 + 4, s5_n, a2, out s6_n);
			if ((a3 & 1) == 0x00)
			{
l000000000001718C:
				a0_n.u0 = 0;
...
Eq_n fn00000000000175BC(word64 ra, struct Eq_n * gp, Eq_n s1, Eq_n a0, char * a1, struct Eq_n * a2, Eq_n a3, union Eq_n & a4Out)
{
	...
	char * s2_n = a1;
	Eq_n s6_n = a3;
	if ((uint64) inet_pton(0x0A, a0, &tLoc0198) <= 0x00)
	{
		if ((int64) gp->dwFFFFF814 != 0x00)
	...
	if (inet_ntop(0x0A, &tLoc0198, fp + -360, 0x00FA) == null)
	{
l0000000000017768:
		if ((int64) gp->dwFFFFF814 != 0x00)
			goto l0000000000017770;
	...
	else
	{
		...
		if (a1 <= (char *) 0x0080)
		{
			...
			if (a0_n != null)
			{
				struct Eq_n * s8_n = &tLoc0178;
				struct Eq_n * a5_n = &tLoc0198;
				byte * s9_n = fp + -0x0188;
				struct Eq_n * a2_n = &tLoc0178;
				byte * a3_n = fp + -0x0188;
				do
				{
					a2_n->b0000 = a5_n->b0000 & *a3_n;
					++a5_n;
					++a3_n;
					++a2_n;
				} while (fp + -0x0188 != a5_n);
				if (inet_ntop(0x0A, &tLoc0178, fp + -360, 0x00FA) != null)
				{
