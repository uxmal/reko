...
// 000000EC: FlagGroup bool prvCopyDataToQueue(Register (ptr32 Eq_n) r0, Register Eq_n r1, Register word32 r2, Register out Eq_n r0Out, Register out ptr32 r7Out)
// Called from:
//      xQueueGenericSend
//      xQueueGenericSendFromISR
//      xQueueCRSend
//      xQueueCRSendFromISR
bool prvCopyDataToQueue(struct Eq_n * r0, Eq_n r1, word32 r2, union Eq_n & r0Out, ptr32 & r7Out)
{
	struct Eq_n * r4_n = r0;
	Eq_n r0_n;
	r0_n.u0 = r0->t0040.u0;
	...
	if (r0_n == 0x00)
	{
		...
		{
			r0_n = xTaskPriorityDisinherit(r0->t0004.u0);
			r0->t0004.u0 = (uint32) r6_n;
			r5_n = r5_n + 0x01;
			Z_n = SLICE(cond(r5_n + 0x01), bool, 2);
		}
	}
	else
	{
		if (r2 == 0x00)
		{
			...
			Eq_n r6_n;
			ptr32 r7_n;
			memcpy(r0->t0008.u0, r1, r0_n, out r4_n, out r5_n, out r6_n, out r7_n);
		...
		word32 r6_n;
		memcpy(r0->t000C.u0, r1, r0_n, out r4_n, out r5_n, out r6_n, out r7);
		Eq_n r3_n;
		r3_n.u0 = r4_n->t000C.u0;
		Eq_n r1_n;
		r1_n.u0 = r4_n->t0000.u0;
		r4_n->t000C.u0 = (uint32) r3_n;
		if (r3_n < r1_n)
			r4_n->t000C.u0 = r4_n->t0004.u0;
...
// 0000016C: Register word32 prvCopyDataFromQueue(Register (ptr32 Eq_n) r0, Register Eq_n r1, Register out ptr32 r5Out, Register out ptr32 r6Out, Register out ptr32 r7Out)
// Called from:
//      xQueuePeekFromISR
//      xQueueGenericReceive
//      xQueueReceiveFromISR
word32 prvCopyDataFromQueue(struct Eq_n * r0, Eq_n r1, ptr32 & r5Out, ptr32 & r6Out, ptr32 & r7Out)
{
	Eq_n r2_n;
	r2_n.u0 = r0->t0040.u0;
	if (r2_n == 0x00)
...
// 00000190: void xQueueGenericSend(Register (ptr32 Eq_n) r0, Register Eq_n r1, Register word32 r2, Register word32 r3, Register word32 cpsr)
// Called from:
//      xQueueGiveMutexRecursive
//      xQueueCreateMutex
//      MPU_xQueueGenericSend
void xQueueGenericSend(struct Eq_n * r0, Eq_n r1, word32 r2, word32 r3, word32 cpsr)
{
	Eq_n tLoc2C = (Eq_n) r2;
	word32 r5_n = 0x00;
...
// 000002A4: void xQueuePeekFromISR(Register (ptr32 Eq_n) r0, Register Eq_n r1, Register word32 cpsr)
// Called from:
//      MPU_xQueuePeekFromISR
void xQueuePeekFromISR(struct Eq_n * r0, Eq_n r1, word32 cpsr)
{
	...
	if (r0->dw0038 != 0x00)
	{
		...
		word32 r6_n;
		word32 r7_n;
		prvCopyDataFromQueue(r0, r1, out r5_n, out r6_n, out r7_n)->dw000C = r6_n;
		__msr(cpsr, r5_n);
	}
	else
		__msr(cpsr, r5_n);
...
// 000002D8: Register (ptr32 Eq_n) xQueueGenericReceive(Register (ptr32 Eq_n) r0, Register Eq_n r1, Register word32 r2, Register word32 r3, Register word32 cpsr)
// Called from:
//      xQueueTakeMutexRecursive
//      MPU_xQueueGenericReceive
struct Eq_n * xQueueGenericReceive(struct Eq_n * r0, Eq_n r1, word32 r2, word32 r3, word32 cpsr)
{
	word32 r7_n;
	word32 r6_n;
	word32 r5_n;
...
l000003A4:
		...
		else
		{
			...
			else
			{
				...
				{
					vPortEnterCritical(cpsr);
					vTaskPriorityInherit(r0->t0004.u0);
					vPortExitCritical(cpsr);
				}
...
// 00000428: void uxQueueMessagesWaiting(Register word32 cpsr)
// Called from:
...
// 0000043C: void uxQueueSpacesAvailable(Register word32 cpsr)
// Called from:
...
// 00000458: void xQueueGenericSendFromISR(Register (ptr32 Eq_n) r0, Register Eq_n r1, Register word32 r3, Register word32 cpsr)
// Called from:
//      vUART_ISR
void xQueueGenericSendFromISR(struct Eq_n * r0, Eq_n r1, word32 r3, word32 cpsr)
{
...
void xQueueGiveFromISR(struct Eq_n * r0, word32 * r1, word32 cpsr)
{
...
// 00000524: void xQueueReceiveFromISR(Register (ptr32 Eq_n) r0, Register Eq_n r1, Register (ptr32 word32) r2, Register word32 cpsr)
void xQueueReceiveFromISR(struct Eq_n * r0, Eq_n r1, word32 * r2, word32 cpsr)
{
	struct Eq_n * r7_n;
	word32 r5_n;
	Eq_n r6_n = __mrs(cpsr);
...
{
	if (r0->t0004.u0 == xTaskGetCurrentTaskHandle())
		r0->t000C.u0 = (uint32) (r0->t000C.u0 + 0x01);
...
void xQueueGenericReset(struct Eq_n * r0, word32 r1, word32 cpsr)
{
	...
	r0->dw0038 = 0x00;
	r0->dw0004 = (ui32) ((char *) &r0_n->ptr0000 + r2_n);
	r0->ptr0044 = (struct Eq_n *) &g_tFFFFFFFF;
	r0->dw000C = (ui32) ((char *) &r0_n->ptr0000 + (r2_n - r3_n));
	r0->ptr0008 = r0_n;
	r0->b0045 = ~0x00;
	if (r1 != 0x00)
	{
...
void xQueueCreateMutex(word32 cpsr)
{
	...
	if (true)
	{
		...
		g_dw0001 = 0x00;
		g_dw000D = 0x00;
		xQueueGenericSend(&g_dw0001, 0x00, 0x00, 0x00, cpsr);
	}
}
...
{
	ui32 r5_n = (ui32) ((char *) &dwArg08->ptr0050->ptr0000 + (r2 + 0x3FFFFFFF << 0x02));
	byte * r3_n = r1 - 0x01 + 1;
...
// 00000A58: void xTaskGenericNotify(Register (ptr32 Eq_n) r0, Register ui32 r1, Register up32 r2, Register (ptr32 ui32) r3, Register word32 cpsr)
// Called from:
//      MPU_xTaskGenericNotify
void xTaskGenericNotify(struct Eq_n * r0, ui32 r1, up32 r2, ui32 * r3, word32 cpsr)
{
	vPortEnterCritical(cpsr);
	if (r3 != null)
		*r3 = r0->dw0060;
...
// 00000B0C: void xTaskGenericNotifyFromISR(Register (ptr32 Eq_n) r0, Register ui32 r1, Register up32 r2, Register (ptr32 ui32) r3, Register word32 cpsr, Stack (ptr32 word32) dwArg00)
void xTaskGenericNotifyFromISR(struct Eq_n * r0, ui32 r1, up32 r2, ui32 * r3, word32 cpsr, word32 * dwArg00)
{
	Eq_n r5_n = __mrs(cpsr);
	__msr(cpsr, 191);
	__instruction_sync_barrier("sy");
...
// 00000BD4: void xTaskNotifyWait(Register word32 r0, Register word32 r1, Register (ptr32 ui32) r2, Register up32 r3, Register word32 cpsr)
// Called from:
//      MPU_xTaskNotifyWait
void xTaskNotifyWait(word32 r0, word32 r1, ui32 * r2, up32 r3, word32 cpsr)
{
...
void vTaskNotifyGiveFromISR(struct Eq_n * r0, word32 * r1, word32 cpsr)
{
	Eq_n r6_n = __mrs(cpsr);
	__msr(cpsr, 191);
	__instruction_sync_barrier("sy");
...
struct Eq_n * xTaskCheckForTimeOut(struct Eq_n * r0, up32 * r1, word32 cpsr)
{
	vPortEnterCritical(cpsr);
...
void vTaskPriorityInherit(Eq_n r0)
{
	...
	uint32 r3_n = r0.u1->dw004C;
	if (r3_n >= (r4_n->ptr0004)->dw004C)
		return;
	if (r0.u1->dw0038 >= 0x00)
		r0.u1->dw0038 = 0x02 - (r4_n->ptr0004)->dw004C;
	word32 r5_n = g_dw124C;
	if (r0.u1->dw0034 == r5_n + r3_n * 0x14)
	{
		if (uxListRemove((word32) r0 + 36) == 0x00)
		{
			uint32 r2_n = r0.u1->dw004C;
		...
		r0.u1->dw004C = r4_n->ptr0004->dw004C;
}
...
Eq_n xTaskPriorityDisinherit(Eq_n r0)
{
	if (r0 == 0x00)
		return 0x00;
	uint32 r1_n = r0.u1->dw004C;
	word32 r3_n = r0.u1->dw005C;
	uint32 r2_n = r0.u1->dw0058;
	r0.u1->dw005C = r3_n - 0x01;
	...
	if (uxListRemove((word32) r0 + 36) == 0x00)
	{
		...
		r2_n = g_ptr12CC;
	uint32 r3_n = r0.u1->dw0058;
	ui32 lr_n = r2_n->dw007C;
	word32 r0_n = g_dw12D0;
	r0.u1->dw004C = r3_n;
	r0.u1->dw0038 = 0x02 - r3_n;
...
void prvRestoreContextOfFirstTask(word32 cpsr)
{
	...
	struct Eq_n * r1_n = (struct Eq_n *) *g_ptr1330;
...
// 0000137C: Register Eq_n pxPortInitialiseStack(Register Eq_n r0, Register ui32 r1, Register word32 r2, Register int32 r3)
// Called from:
...
Eq_n pxPortInitialiseStack(Eq_n r0, ui32 r1, word32 r2, int32 r3)
{
	...
	if (r3 != 0x01)
		r3_n = 0x03;
	r0.u1->dwFFFFFFE0 = r2;
	r0.u1->dwFFFFFFF8 = r1 & ~0x01;
	r0.u1->dwFFFFFFFC = 0x01000000;
	r0.u1->dwFFFFFFF4 = 0x00;
	r0.u1->dwFFFFFFBC = r3_n;
	return r0 - 0x44;
}
...
void xPortPendSVHandler(word32 r4, word32 r5, word32 r6, word32 r7, word32 r8, word32 r9, word32 r10, word32 fp, word32 cpsr)
{
	...
	vTaskSwitchContext();
	__msr(cpsr, 0x00);
	struct Eq_n * r1_n = (struct Eq_n *) *r3_n;
	union Eq_n * r0_n = r1_n->ptr0000;
	struct Eq_n * r2_n = g_ptr1728;
	word32 r5_n = r1_n->dw0008;
	word32 r6_n = r1_n->dw000C;
...
// 00001714: void vPortSVCHandler(Register word32 cpsr)
void vPortSVCHandler(word32 cpsr)
{
	Eq_n %continuation;
	if ((%continuation & 0x04) == 0x00)
		__mrs(cpsr);
	struct Eq_n * r0_n = __mrs(cpsr);
...
ui32 pvPortMalloc(ui32 r0, word32 cpsr)
{
	...
	if (r3_n.u1->dw0000 == 0x00)
		r3_n.u1->dw0000 = (word32) r3_n + 0x0C & ~0x07;
	up32 r2_n = r3_n.u1->dw05C0;
	up32 r4_n = r4_n + r2_n;
...
// 00001874: void xEventGroupClearBits(Register (ptr32 ui32) r0, Register word32 r1, Register word32 cpsr)
// Called from:
//      MPU_xEventGroupClearBits
void xEventGroupClearBits(ui32 * r0, word32 r1, word32 cpsr)
{
	vPortEnterCritical(cpsr);
	*r0 &= ~r1;
	vPortExitCritical(cpsr);
...
void xEventGroupSetBits(struct Eq_n * r0, ui32 r1, word32 cpsr)
{
	vTaskSuspendAll();
...
// Called from:
//      MPU_xEventGroupSync
void xEventGroupSync(struct Eq_n * r0, ui32 r1, ui32 r2, up32 r3, word32 cpsr)
{
	vTaskSuspendAll();
...
void vEventGroupDelete(struct Eq_n * r0, word32 cpsr)
{
	vTaskSuspendAll();
...
void vEventGroupSetBitsCallback(struct Eq_n * r0, ui32 r1, word32 cpsr)
{
	xEventGroupSetBits(r0, r1, cpsr);
}

// 000019D4: void vEventGroupClearBitsCallback(Register (ptr32 ui32) r0, Register word32 r1, Register word32 cpsr)
void vEventGroupClearBitsCallback(ui32 * r0, word32 r1, word32 cpsr)
{
	vPortEnterCritical(cpsr);
	*r0 &= ~r1;
	vPortExitCritical(cpsr);
