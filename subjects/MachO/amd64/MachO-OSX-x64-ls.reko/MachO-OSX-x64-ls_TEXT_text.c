...
l0000000100002322:
	...
	if (0x100006574 != 0x00 || (g_dw6578 != 0x00 || 0x100006598 != 0x00))
		...
		dwLoc011C_n = 0x00;
	size_t rax_n = getenv("LS_COLWIDTHS");
	Eq_n qwLocB8_n;
	qwLocB8_n.u0 = 0x00;
...
l0000000100001F1A:
					...
					if (dwLoc011C_n != 0x00)
					{
						...
						if (g_dw6578 != 0x00)
						{
							...
							size_t rax_n = malloc((word64) rax_n.u1 + 36);
							if (rax_n == 0x00)
								goto l0000000100002337;
							*rax_n = (Eq_n) ((word64) rax_n + 24);
							strcpy(qwLoc0100_n, (word64) rax_n + 24);
							Eq_n rdi_n;
							rdi_n.u1 = (word64) rax_n + ((word64) rax_n + 25);
							*((word64) rax_n + 8) = (Eq_n) rdi_n;
							strcpy(r15_n, rdi_n);
							...
							if (0x100006568 != 0x00)
							{
								*((word64) rax_n + 16) = (Eq_n) ((word64) rax_n + 26);
	...
	if (rax_n != 0x00)
	{
		...
		{
			*rax_n = (Eq_n) 0x3A30;
			*((word64) rax_n + 2) = (Eq_n) 0x00;
			rax_n = (word64) rax_n + 2;
		}
		else
		{
			*rax_n = (Eq_n) r14b_n;
			*((word64) rax_n + 1) = (Eq_n) 0x00;
			rax_n = (word64) rax_n + 1;
		}
		byte cl_n = (byte) *((word64) rax_n + 1);
		if (cl_n != 0x00)
		{
		...
		up32 eax_n = sscanf(" %llu : %qu : %lu : %i : %i : %i : %qu : %lu : %lu ", rax_n);
		g_dw6580 = 0x01;
		if (eax_n <= 0x08)
		{
			switch (eax_n)
...
l0000000100002B5E:
			...
			case 0x6A:
				goto l0000000100002B56;
			case 0x40:
				size_t rax_n = 0x1000065B0;
				goto l00000001000029DA;
			case 0x41:
				goto l0000000100002958;
			case 66:
				0x10000657C = (Eq_n) 0x00;
				g_dw6588 = 0x01;
			...
			case 0x46:
				4294993324 = (Eq_n) 0x01;
				Eq_n rax_n = 0x10000659C;
				goto l0000000100002A9C;
			case 0x47:
				setenv(0x01, 0x100005410, "CLICOLOR");
				break;
			case 0x48:
				compat_mode();
				if (true)
			...
			case 0x54:
				...
				goto l00000001000029DA;
			case 0x55:
				0x100006560 = (Eq_n) 0x01;
				size_t rax_n = 0x100006558;
...
l0000000100002958:
			...
			case 0x62:
				...
				goto l00000001000029DA;
			case 99:
				0x1000065A4 = (Eq_n) 0x01;
				0x100006560 = (Eq_n) 0x00;
				rax_n = 0x100006558;
				goto l0000000100002A9C;
			case 100:
				g_b65C0 = 0x01;
...
l0000000100002A22:
			...
			case 0x70:
				0x10000659C = (Eq_n) 0x01;
				rax_n = 4294993324;
				goto l00000001000029DA;
			case 113:
				0x10000657C = (Eq_n) 0x01;
...
l0000000100002B56:
		...
		char bLoc043C;
		if (getenv("CLICOLOR") != 0x00 && (isatty(0x01) != 0x00 || getenv("CLICOLOR_FORCE") != 0x00) && tgetent(getenv("TERM"), &bLoc043C) == 0x01)
		{
			g_ptr6538 = tgetstr(&ptrLoc0648, "AF");
			g_ptr6528 = tgetstr(&ptrLoc0648, "AB");
			g_ptr6540 = tgetstr(&ptrLoc0648, "me");
			g_ptr6550 = tgetstr(&ptrLoc0648, "md");
			char * rax_n = tgetstr(&ptrLoc0648, "op");
			g_ptr6530 = rax_n;
			if (rax_n == null)
			{
				rax_n = tgetstr(&ptrLoc0648, "oc");
				g_ptr6530 = rax_n;
			}
			if (g_ptr6538 != null && (g_ptr6528 != null && rax_n != null))
			{
				g_dw6564 = 0x01;
l0000000100002D0A:
				g_dw6580 = 0x01;
...
l0000000100002E3A:
				...
				else
				{
					...
					Eq_n rax_n;
					rax_n.u0 = g_t6548.u0;
					g_t6548.u0 = (int64) ((rax_n >> 0x3F >> 55) + rax_n >> 0x09);
				}
...
void fn00000001000033F4(word32 edi)
{
	...
	if ((&g_t65F8)[rax_n] != 0x00)
		tputs(&g_t318E, 0x01, g_ptr6550);
	word32 edx_n = (word32) g_a65F0[rax_n];
	if (edx_n != ~0x00)
	{
		char * rax_n = tgoto(edx_n, 0x00, g_ptr6538);
		if (rax_n != null)
			tputs(&g_t318E, 0x01, rax_n);
	}
	word32 edx_n = (word32) g_a65F4[rax_n];
	if (edx_n == ~0x00)
		return;
	char * rax_n = tgoto(edx_n, 0x00, g_ptr6528);
	if (rax_n == null)
		return;
	tputs(&g_t318E, 0x01, rax_n);
}
...
// 000000010000356F: Register word32 fn000000010000356F(Register Eq_n rdi, Register out word64 rbxOut, Register out (ptr64 Eq_n) rbpOut, Register out word32 r12dOut, Register out word64 r14Out, Register out word64 r15Out)
// Called from:
//      fn00000001000035A9
//      fn0000000100003AA8
word32 fn000000010000356F(Eq_n rdi, word64 & rbxOut, struct Eq_n & rbpOut, word32 & r12dOut, word64 & r14Out, word64 & r15Out)
{
	wchar_t wLocBC;
	word64 r15_n;
	word64 r14_n;
						...
						if (eax_n != 0x00)
						{
							if (r15d_n > 0x00)
							{
								...
								do
								{
									...
									r13_n = (Eq_n) ((word64) r13_n + 1);
									--r12_n;
								} while (r12_n != 0x00);
							}
							r14_n = (Eq_n) (r14_n + rax_n);
...
void fn00000001000035A9(struct Eq_n * rdi)
{
	...
	{
		tputs(&g_t318E, 0x01, g_ptr6530);
		tputs(&g_t318E, 0x01, g_ptr6540);
	}
	if (4294993324 != 0x00)
...
void fn0000000100003AA8(int64 rdi)
{
	...
	if (g_dw62D8 < 0x00)
	{
		g_dw62D8 = (word32) (*nl_langinfo(0x39) == 100);
		rax_32_32_n = 0x00;
	}
	if (g_qw6680 == 0x00)
		g_qw6680 = SEQ(rax_32_32_n, time(null));
	byte al_n = (byte) 0x100006594;
	bool v51_n;
	char * rax_n;
	char * rbx_n;
	if (0x100006594 != 0x00)
	{
		...
		rax_n = (char *) "%b %e %T %Y ";
		rbx_n = (char *) "%e %b %T %Y ";
		goto l0000000100003B9F;
	}
	compat_mode();
	int64 rax_n = g_qw6680;
	if (al_n != 0x00)
	{
		int32 ecx_n = g_dw62D8;
		if (rdi + 0x00EFF100 > rax_n && rdi <= rax_n)
		{
			v51_n = ecx_n != 0x00;
			goto l0000000100003B5D;
		}
		v51_n = ecx_n != 0x00;
	}
	else
	{
		if (rdi + 0x00EFF100 > rax_n && rdi < rax_n + 0x00EFF100)
		{
			v51_n = g_dw62D8 != 0x00;
l0000000100003B5D:
			rax_n = (char *) "%b %e %R ";
...
l0000000100003B9F:
			...
			ptr64 fp;
			char bLoc70;
			strftime(localtime((word32) fp - 0x78), rbx_n, 0x50, &bLoc70);
			fputs(*__stdoutp, &bLoc70);
			if (*__stack_chk_guard == rax_n)
				return;
			__stack_chk_fail();
		}
		v51_n = g_dw62D8 != 0x00;
