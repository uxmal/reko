					...
					if (dwLoc011C_n != 0x00)
					{
						...
						if (g_dw6578 != 0x00)
						{
							...
							else
							{
								user_from_uid();
								group_from_gid();
								&qwLoc0100_n.u0->b0000 = &g_t6584;
								&r15_n.u0->b0000 = &g_t6584;
							}
