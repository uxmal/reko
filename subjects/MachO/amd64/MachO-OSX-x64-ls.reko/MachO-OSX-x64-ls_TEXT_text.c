...
l0000000100001F1A:
					...
					if (dwLoc011C_n != 0x00)
					{
						...
						if (g_dw6578 != 0x00)
						{
							...
							else
							{
								user_from_uid();
								group_from_gid();
								&qwLoc0100_n.u0->b0000 = &g_dw6584;
								&r15_n.u0->b0000 = &g_dw6584;
							}
	...
	if (rax_n != 0x00)
	{
		...
		byte cl_n = rax_n.u0[1];
		if (cl_n != 0x00)
		{
			struct Eq_n * rbx_n = rax_n.u0 + 2;
			do
			{
		...
		if (g_b65C0 != 0x01)
		{
			...
			while (rax_n != null)
			{
				...
				if (eax_n <= 0x0C)
				{
					...
					if (eax_n <= 0x06)
					{
						rax_n = (struct Eq_n *) (g_a2684 + (int64) g_a2684[rax_n * 0x04]);
...
l0000000100002B5E:
			...
			case 0x53:
				...
				break;
			case 0x54:
				&rax_n.u0->b0000 = 0x100006594;
				goto l00000001000029DA;
			case 0x55:
				0x100006560 = (acl_t) 0x01;
				&rax_n.u0->b0000 = 0x100006558;
...
l0000000100002958:
			...
			case 0x67:
				...
				break;
			case 0x68:
				&rax_n.u0->b0000 = 0x100006570;
				goto l00000001000029DA;
			case 0x69:
				&rax_n.u0->b0000 = &g_t6574;
				goto l00000001000029DA;
			case 0x6B:
...
void fn000000010000328E(Eq_n rdi)
{
	...
	if (rdi != 0x00)
		rax_n = rdi;
	struct Eq_n * qwLoc48_n = rax_n.u0 + 1;
