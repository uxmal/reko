...
l0000000100001F1A:
	...
	if (rax_n != 0x00)
	{
		...
		if (eax_n <= 0x08)
		{
			<anonymous> * rax_n = g_a238C + (int64) g_a238C[(uint64) eax_n * 0x04];
			word64 rax_n;
			word64 rdx_n;
			word64 r8_n;
			word64 r9_n;
...
l000000010000250A:
									...
									fts_children$INODE64();
									compat_mode();
									if ((byte) &g_t5340 != 0x00 && (ebx_n != 0x00 && rax_n != null))
									{
					...
					else if (eax_n == 0x0D)
					{
						...
						if ((byte) &g_t5340 != 0x00 && ebx_n != 0x00)
						{
...
l0000000100002D4C:
					ui32 eax_n = g_dw6578;
					if (eax_n != 0x00 || (eax_n != 0x00 || g_t6598 != 0x00))
					{
						if (eax_n != 0x00)
							g_t6548.u0 = 0x02;
						else
