...
l000060BC:
	...
	l.jr	r9
	l.lwz	r30,-8(r1)
00006280 9C 80 00 02 D4 01 20 00 AA 44 00 00 03 FF FC 62 ...... ..D.....b
00006290 D4 01 20 10 9C C0 00 01 D4 01 30 00 9E 40 00 02 .. .......0..@..
000062A0 03 FF FD 75 D4 01 90 10 9C 60 00 02 D4 01 18 00 ...u.....`......
000062B0 AA 43 00 00 03 FF FE 20 D4 01 18 10             .C..... ....   
...
l000062DC:
	...
	l.jr	r3
	l.nop
000062F8                         18 80 E4 86 00 00 00 0C         ........
00006300 A8 84 CC CC 18 80 E9 06 00 00 00 09 A8 84 99 99 ................
00006310 18 80 ED 86 00 00 00 06 A8 84 66 66 00 00 00 04 ..........ff....
00006320 18 80 F5 86                                     ....           
...
l000079E0:
	...
	l.j	0000776C
	l.addi	r4,r0,+00000000
000079F4             BC 0B 00 01 10 00 00 0A B8 68 00 50     .........h.P
00007A00 9C 80 F0 FF A5 08 FF FF E4 23 40 00 0C 00 00 03 .........#@.....
00007A10 E0 77 20 03 A8 63 01 00 D4 02 18 14 9D 60 00 01 .w ..c.......`..
...
fn000080EC proc
	...
	l.sw	-8(r1),r16
	l.sw	-4(r1),r9
	l.ori	r16,r2,00007144
	l.addi	r1,r1,-00000014
	l.j	000081E8
	l.ori	r14,r2,00007184
	l.lwz	r2,0(r14)
	l.sw	0(r1),r2
	l.lwz	r3,0(r1)
	l.jal	0000F874
	...
	l.bf	00008180
	l.movhi	r2,000001C1
	l.ori	r3,r2,00007050
	l.addi	r4,r0,+00000004
	l.sw	0(r3),r4
	l.ori	r3,r2,00007150
	l.lwz	r3,0(r3)
	l.sfeqi	r3,00000000
	l.bf	00008280
	l.ori	r2,r2,00007190
	l.lwz	r2,0(r2)
	l.sw	0(r1),r2
	l.lwz	r3,0(r1)
	l.jal	0000F874
	...
	l.sb	0(r2),r4
	l.movhi	r2,000001C1
	l.addi	r3,r0,+00000100
	l.ori	r2,r2,00007050
	l.addi	r11,r0,+00000001
	l.sw	0(r2),r3
	l.addi	r1,r1,+00000014
	l.lwz	r9,-4(r1)
...
l0000AF30:
	...
	l.jr	r3
	l.nop
0000AF4C                                     00 00 00 37             ...7
0000AF50 9D 60 00 11 18 60 00 01 18 40 00 01 A8 63 39 48 .`...`...@...c9H
0000AF60 A8 42 25 DC 84 63 00 00 84 63 00 00 B8 63 00 4E .B%..c...c...c.N
0000AF70 00 00 00 28 A4 63 00 0C 18 60 01 C2 18 40 00 01 ...(.c...`...@..
...
0000B010 E0 63 10 00 00 00 00 05 85 63 00 00             .c.......c..   
...
;;     00006AD8 (in fn00006880)
;;     00006B44 (in fn00006880)
;;     00006B64 (in fn00006880)
;;     00006BA4 (in fn00006880)
;;     00006BEC (in fn00006880)
;;     00006C20 (in fn00006880)
;;     00006C64 (in fn00006880)
;;     00006CF8 (in fn00006880)
;;     00006D3C (in fn00006880)
;;     00006DA8 (in fn00006880)
;;     00006DC4 (in fn00006880)
;;     00006DE0 (in fn00006880)
...
fn0000FA94 proc
	...
	l.movhi	r8,00000000
	l.movhi	r9,00000000
	l.movhi	r10,00000000
	l.movhi	r11,00000000
	l.movhi	r12,00000000
	l.movhi	r13,00000000
	l.movhi	r14,00000000
	l.movhi	r15,00000000
	l.movhi	r16,00000000
	l.movhi	r17,00000000
	l.movhi	r18,00000000
	l.movhi	r19,00000000
	l.movhi	r20,00000000
	l.movhi	r21,00000000
	l.movhi	r22,00000000
	l.movhi	r23,00000000
	l.movhi	r24,00000000
	l.movhi	r25,00000000
	l.movhi	r26,00000000
	l.movhi	r27,00000000
	l.movhi	r28,00000000
	l.movhi	r29,00000000
	l.movhi	r30,00000000
	l.movhi	r31,00000000
	l.ori	r1,r0,00000001
	l.ori	r1,r1,00000080
	l.mtspr	r0,r1,SR
	l.mtspr	r0,r0,00005000
	l.movhi	r1,00000001
	l.ori	r1,r1,00003E18
	l.addi	r2,r0,-00000003
	l.and	r1,r1,r2
	l.mfspr	r6,r0,SR
	l.addi	r5,r0,-00000001
	l.xori	r5,r5,00000010
	l.and	r5,r6,r5
	l.mtspr	r0,r5,SR
	l.addi	r14,r0,+00000010
	l.addi	r6,r0,+00000000
	l.addi	r5,r0,+00001000
	l.mtspr	r0,r6,00002002
	l.sfne	r6,r5
	l.bf	0000FBA0
	l.add	r6,r6,r14
	l.nop
	...
	l.ori	r5,r5,00003158
	l.movhi	r6,00000001
	l.ori	r6,r6,00003A18
	l.sw	0(r5),r0
	l.sfltu	r5,r6
	l.bf	0000FBEC
	l.addi	r5,r5,+00000004
	l.jal	0000E98C
	l.nop
	l.addi	r3,r11,+00000000
	l.jal	0000E750
	l.nop
	l.addi	r1,r1,-00000100
	l.sw	4(r1),r3
	l.sw	8(r1),r4
	l.sw	12(r1),r5
	l.addi	r3,r0,+00000002
	l.mfspr	r4,r0,00000020
	l.addi	r5,r1,+00000000
	l.j	0000FDE4
	l.nop
	l.addi	r1,r1,-00000100
	l.sw	4(r1),r3
...
00012470 20 6E 6F 77 0A 00 00 00 00 00 63 80 00 00 62 F8  now......c...b.
00012480 00 00 63 04 00 00 63 10 00 00 63 24 00 00 63 1C ..c...c...c$..c.
00012490 00 00 AF 54 00 00 AF 4C 00 00 B0 24 00 00 AF 78 ...T...L...$...x
...
fn00018C68 proc
	...
	l.bf	00018D70
	l.movhi	r3,000001F0
	l.ori	r3,r3,00000CC8
	l.lwz	r4,0(r3)
	l.ori	r4,r4,00003F80
	l.sw	0(r3),r4
	l.jal	00018C24
	l.addi	r3,r0,+0000001B
	l.jal	00018C24
	...
	l.addi	r4,r0,+00000000
	l.jal	00018F10
	l.ori	r3,r3,0000C92C
	l.jal	00018A60
	l.ori	r3,r2,00000000
	l.movhi	r4,00003087
	l.lwz	r3,0(r2)
	l.ori	r4,r4,0000F000
	l.and	r3,r3,r4
	l.sfeqi	r3,00000000
	l.bf	00018E80
	l.nop
