...
// 00000E: void fn00000E(Register byte TABLAT, Register Eq_10 FSR0, Register word24 TBLPTR)
void fn00000E(byte TABLAT, Eq_10 FSR0, word24 TBLPTR)
{
	__tblrd(TBLPTR, 0x01);
	0x00->b00C5 = TABLAT;
	__tblrd(TBLPTR, 0x01);
...
// 000128: void fn000128(Register cu8 WREG, Register cu8 FSR0L, Register cu8 FSR0H, Register cu8 PRODL, Register Eq_217 FSR0)
void fn000128(cu8 WREG, cu8 FSR0L, cu8 FSR0H, cu8 PRODL, Eq_217 FSR0)
{
	while (FSR0H < WREG)
	{
		*FSR0 = 0x00;
