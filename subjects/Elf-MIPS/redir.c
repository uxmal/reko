...
l00407C8C:
	...
	if ((dwLoc38 ^ 0x02) == 0x00)
		goto l00407C8C;
	uint32 r4_165;
	Eq_7295 hi_lo_142 = dwLoc3C * dwLoc2C;
	int32 hi_144 = SLICE(hi_lo_142, word32, 32);
	uint32 lo_143 = (word32) hi_lo_142;
	Eq_7303 r6_160 = hi_144 >> 0x00;
	if (hi_144 >> 0x00 < 0x00)
	{
		r4_165 = lo_143;
		Eq_7314 r2_209 = (hi_144 >> 0x00) + 0x01;
		while (true)
		{
			if (r2_209 != 0x00)
			{
...
l004087D0:
	...
	if ((dwLoc70 ^ 0x02) == 0x00)
		goto l004087D0;
	uint32 r16_296;
	Eq_8281 hi_lo_244 = (dwLoc60 >> 0x00) * ((word32) dwLoc74 - 0x01);
	Eq_8289 hi_lo_250 = ((word32) dwLoc5C - 0x01) * (dwLoc78 >> 0x00);
	uint32 lo_245 = (word32) hi_lo_244;
	uint32 lo_251 = (word32) hi_lo_250;
	uint32 r21_264 = lo_245 + lo_251;
	uint32 r24_259 = SLICE(hi_lo_244, word32, 32) + (word32) ((dwLoc60 >> 0x00) *s dwLoc78) + (word32) (((word32) dwLoc74 - 0x01) *s 0x00);
	Eq_8314 hi_lo_275 = ((word32) dwLoc5C - 0x01) * ((word32) dwLoc74 - 0x01);
	Eq_8318 hi_lo_281 = (dwLoc60 >> 0x00) * (dwLoc78 >> 0x00);
	word32 lo_288 = (word32) ((dwLoc78 >> 0x00) *s 0x00);
	uint32 r20_269 = r24_259 + ((SLICE(hi_lo_250, word32, 32) + (word32) (((word32) dwLoc5C - 0x01) *s 0x00)) + (word32) ((dwLoc78 >> 0x00) *s dwLoc60)) + (word32) (r21_264 < lo_251);
	int32 dwLoc30_238 = 0x00;
	Eq_8344 lo_276 = (word32) hi_lo_275;
	word32 r16_280 = SLICE(hi_lo_275, word32, 32) + (word32) (((word32) dwLoc5C - 0x01) *s dwLoc78);
	Eq_8352 lo_282 = (word32) hi_lo_281;
	word32 r18_290 = SLICE(hi_lo_281, word32, 32) + (word32) ((dwLoc60 >> 0x00) *s 0x00) + lo_288;
	word32 lo_292 = (word32) (((word32) dwLoc74 - 0x01) *s dwLoc60);
	...
	else
	{
		...
		if (r24_259 == r20_269)
		{
			word32 r2_487 = (word32) (r21_264 < lo_245);
			if (r2_487 != 0x00)
			{
l00408924:
				dwLoc30_238 = 0x01;
...
l00408978:
		...
		else
		{
			if (r16_296 == r10_305)
			{
				word32 r2_479 = (word32) (lo_276 < lo_276);
				if (r2_479 != 0x00)
					goto l00408978;
			}
l00408998:
			Eq_8344 r7_352;
			Eq_8352 r5_315 = (word32) lo_282.u1 + ((word32) (r20_269 >> 0x00) - 0x01);
			Eq_8352 r13_326 = (word32) r5_315.u1 + dwLoc2C_295;
...
l00408B44:
			...
			int32 r5_385 = (word32) r13_326 + 0x00FF;
			if (r5_385 == 0x0080)
			{
				if (((word32) r13_326 + 0x0100 | r12_332) != 0x00)
				{
l00408B38:
					goto l00408B44;
				}
