...
// 004046C4: void request_make_url(Register (ptr Eq_4048) r4, Stack word32 dwArg00)
void request_make_url(Eq_4048 * r4, word32 dwArg00)
{
	if (r4 == null)
	{
...
// 004048DC: void request_add_lines(Register (ptr Eq_4130) r4, Register (ptr Eq_4131) r5, Register word32 r6, Stack word32 dwArg00, Stack word32 dwArg04, Stack word32 dwArg08)
void request_add_lines(Eq_4130 * r4, Eq_4131 * r5, word32 r6, word32 dwArg00, word32 dwArg04, word32 dwArg08)
{
...
// 00404CF0: void request_get_host(Register (ptr Eq_4320) r4, Register uint32 r5, Stack word32 dwArg00, Stack word32 dwArg04)
void request_get_host(Eq_4320 * r4, uint32 r5, word32 dwArg00, word32 dwArg04)
{
	if (r4 != null)
	{
		if (r4 != (struct Eq_4320 *) -0x0014)
		{
...
// 00404FC0: void request_get_content_length(Register (ptr Eq_4466) r4, Register uint32 r5, Stack word32 dwArg00, Stack word32 dwArg04)
void request_get_content_length(Eq_4466 * r4, uint32 r5, word32 dwArg00, word32 dwArg04)
{
	if (r4 != null)
	{
		if (r4 != (struct Eq_4466 *) -0x0014)
		{
			<anonymous> * r25_75 = globals->ptr10000890;
			word32 sp_78;
			word32 r28_79;
...
// 00405328: void request_destroy(Register (ptr Eq_4638) r4, Stack word32 dwArg00)
void request_destroy(Eq_4638 * r4, word32 dwArg00)
{
	while (true)
	{
					...
					else
					{
						...
						*r2_248 = 0x00;
						...
						while (true)
						{
							...
							{
								dwLoc2C_343 = 0x01;
								Eq_5123 r2_448 = globals->ptr10000A40->a0008[dwLoc014C_344 * 0x14 - dwLoc014C_344].t0000;
								if (r2_448 != 0x01)
								{
...
// 00405CD0: void properties_parse_command_line(Register int32 r4, Register (arr (ptr Eq_5257)) r5, Stack word32 dwArg00, Stack word32 dwArg04)
void properties_parse_command_line(int32 r4, Eq_5257 * r5[], word32 dwArg00, word32 dwArg04)
{
...
l00405EAC:
			...
			if (r3_159 != 0x0020)
			{
				if (dwLoc20_131 != 0x00)
					break;
				struct Eq_5339 * r1_216 = globals->ptr10000A40 + ((dwLoc24_132 * 0x14 - dwLoc24_132 << 0x03) + 0x08) / 0x0696;
				if ((word32) bLoc1C_111 != (word32) r1_216->b0004)
				{
					Eq_5123 r3_363 = globals->ptr10000A40->a0008[dwLoc24_132 * 0x14 - dwLoc24_132].t0000;
					if (r3_363 != 0x02)
						goto l004061C8;
...
l004061C8:
				...
				dwLoc20_131 = 0x01;
				Eq_5123 r2_261 = globals->ptr10000A40->a0008[dwLoc24_132 * 0x14 - dwLoc24_132].t0000;
				if (r2_261 != 0x01)
				{
...
// 0040720C: void slist_add(Register (ptr Eq_6587) r4, Register (ptr Eq_6588) r5, Stack word32 dwArg00, Stack word32 dwArg04)
void slist_add(Eq_6587 * r4, Eq_6588 * r5, word32 dwArg00, word32 dwArg04)
{
	if (r4->ptr0008 != null)
	{
...
// 0040730C: void slist_remove(Register (ptr Eq_6639) r4, Register (ptr Eq_6640) r5, Stack word32 dwArg00, Stack word32 dwArg04)
void slist_remove(Eq_6639 * r4, Eq_6640 * r5, word32 dwArg00, word32 dwArg04)
{
	if (r5 != null)
	{
		if (r5 == r4->ptr0008)
...
// 00407410: void slist_find_fd(Register (ptr Eq_6686) r4, Register word32 r5, Stack word32 dwArg00, Stack word32 dwArg04)
void slist_find_fd(Eq_6686 * r4, word32 r5, word32 dwArg00, word32 dwArg04)
{
	struct Eq_6690 * dwLoc10_18 = r4->ptr0008;
	while (dwLoc10_18 != null)
	{
		if (dwLoc10_18->dw0000 == r5)
			return;
...
// 00407568: void slist_close_all(Register (ptr Eq_6744) r4, Stack word32 dwArg00)
void slist_close_all(Eq_6744 * r4, word32 dwArg00)
{
	struct Eq_6746 * dwLoc18_18 = r4->ptr0008;
	while (dwLoc18_18 != null)
	{
...
// 00407600: void slist_destroy_all(Register (ptr Eq_6765) r4, Stack word32 dwArg00)
void slist_destroy_all(Eq_6765 * r4, word32 dwArg00)
{
	while (r4->dw0008 != 0x00)
	{
...
// 004077E0: void _fpadd_parts(Register (ptr Eq_6818) r4, Register (ptr Eq_6819) r5, Register (ptr Eq_6820) r6)
void _fpadd_parts(Eq_6818 * r4, Eq_6819 * r5, Eq_6820 * r6)
{
	Eq_6821 r7_9 = r4->t0000;
	if ((word32) (r7_9 < 0x02) == 0x00)
	{
		Eq_6830 r4_29 = r5->t0000;
			...
			else if ((r4_29 ^ 0x04) != 0x00)
			{
				...
				if ((r7_9 ^ 0x02) != 0x00)
				{
					...
					else
					{
						r6->dw0004 = r4_77;
						r6->dw0008 = r8_140;
						Eq_6887 r2_129 = (word32) r10_141.u0 + r9_136;
						r6->t000C = r2_129;
						r7_103 = r2_129;
					}
					if (r7_103 < 0x00)
...
// 00408180: void _fpadd_parts(Register (ptr Eq_7575) r4, Register (ptr Eq_7576) r5, Register (ptr Eq_7577) r6)
void _fpadd_parts(Eq_7575 * r4, Eq_7576 * r5, Eq_7577 * r6)
{
	Eq_7578 r7_9 = r4->t0000;
	if ((word32) (r7_9 < 0x02) == 0x00)
	{
		Eq_7587 r4_42 = r5->t0000;
		...
		if ((r7_9 ^ 0x02) != 0x00)
		{
			...
			Eq_7650 r10_252 = r4->t0010;
			Eq_7656 r11_253 = r4->t0014;
			int32 r2_291 = r12_251 - r7_243;
			uint32 r8_241 = r5->dw0010;
			Eq_7656 r9_100 = r5->t0014;
			if (r2_291 < 0x00)
				r2_291 = -r2_291;
			...
			else
			{
				r6->dw0004 = 0x01;
				r6->dw0008 = r12_251;
				Eq_7656 r5_215 = -r5_145;
				r6->t0010 = -r4_148 - (word32) (0x00 < r5_215);
				r6->t0014 = r5_215;
			}
			Eq_7656 r9_151 = r6->t0014;
			Eq_7650 r8_150 = r6->t0010;
...
l0040840C:
				...
				while (true)
				{
					Eq_7656 r7_176 = r9_151 << 0x01;
					Eq_7650 r6_174 = r6_168 | r2_167;
					r6->dw0008 = r6->dw0008 + -0x01;
					r6->t0010 = r6_174;
					r6->t0014 = r7_176;
...
l00408490:
			...
			{
				r6->t0000.u0 = 0x03;
				Eq_7650 r4_126 = r6->t0010;
				Eq_7656 r5_127 = r6->t0014;
...
l004087EC:
	uint32 r16_286
	Eq_8281 hi_lo_234 = (dwLoc60 >> 0x00) * ((word32) dwLoc74 - 0x01)
	Eq_8289 hi_lo_240 = ((word32) dwLoc5C - 0x01) * (dwLoc78 >> 0x00)
	...
	Eq_8314 hi_lo_265 = ((word32) dwLoc5C - 0x01) * ((word32) dwLoc74 - 0x01)
	Eq_8318 hi_lo_271 = (dwLoc60 >> 0x00) * (dwLoc78 >> 0x00)
...
l00408998:
	Eq_8344 r7_342
	Eq_8352 r5_305 = (word32) lo_272.u1 + ((word32) (r20_259 >> 0x00) - 0x01)
	Eq_8352 r13_316 = (word32) r5_305.u1 + dwLoc2C_285
...
// 00409150: void __floatsidf(Register Eq_8990 r4)
void __floatsidf(Eq_8990 r4)
{
	if (r4 != 0x00)
	{
		Eq_8990 dwLoc0C_103;
		...
		if ((word32) (0x0FFFFFFF < dwLoc10_102) == 0x00)
		{
			do
			{
				Eq_8994 r2_85 = dwLoc10_102 << 0x01 | dwLoc0C_103 >> 0x1F;
				dwLoc10_102 = r2_85;
...
// 004093E0: void __pack_f(Register (ptr Eq_9120) r4)
void __pack_f(Eq_9120 * r4)
{
	Eq_9121 r3_6 = r4->t0000;
	Eq_9125 r4_66 = r4->t000C;
...
// 00409540: void __unpack_f(Register (ptr uint32) r4, Register (ptr Eq_9196) r5)
void __unpack_f(uint32 * r4, Eq_9196 * r5)
{
	uint32 r3_5 = *r4;
	r5->dw0004 = r3_5 >> 0x1F;
...
// 00409680: void __pack_d(Register (ptr Eq_9312) r4)
void __pack_d(Eq_9312 * r4)
{
	Eq_9313 r3_8 = r4->t0000;
	Eq_9317 r10_163 = r4->t0010;
	Eq_9321 r11_10 = r4->t0014;
...
// 00409930: void __unpack_d(Register (ptr Eq_9450) r4, Register (ptr Eq_9451) r5)
void __unpack_d(Eq_9450 * r4, Eq_9451 * r5)
{
	uint32 r2_8 = r4->dw0000;
	Eq_9456 r3_9 = r4->t0004;
	...
	else if (((word32) r3_9 - 0x01 | r2_8 + 0x000FFFFF) != 0x00)
	{
		...
		Eq_9495 r9_38 = (word32) r3_9 - 0x01 << 0x08;
...
// 00409A90: void __fpcmp_parts_d(Register (ptr Eq_9605) r4, Register (ptr Eq_9606) r5)
void __fpcmp_parts_d(Eq_9605 * r4, Eq_9606 * r5)
{
	Eq_9607 r6_5 = r4->t0000;
	if ((word32) (r6_5 < 0x02) != 0x00)
		return;
	Eq_9616 r3_17 = r5->t0000;
