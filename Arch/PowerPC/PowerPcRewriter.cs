    ...
    public partial class PowerPcRewriter : IEnumerable<RtlInstructionCluster>
    {
        ...
        public IEnumerator<RtlInstructionCluster> GetEnumerator()
        {
            while (dasm.MoveNext())
            {
                ...
                case Opcode.bdnz: RewriteCtrBranch(false, false, Operator.Ne, false); break;
                case Opcode.bdnzf: RewriteCtrBranch(false, false, Operator.Ne, false); break;
                case Opcode.bdnzl: RewriteCtrBranch(true, false, Operator.Ne, false); break;
                case Opcode.bdnzt: RewriteCtrBranch(false, false, Operator.Ne, true); break;
                case Opcode.bdz: RewriteCtrBranch(false, false, Operator.Eq, false); break;
                case Opcode.bdzf: RewriteCtrBranch(false, false, Operator.Eq, false); break;
                case Opcode.bdzl: RewriteCtrBranch(true, false, Operator.Eq, false); break;
