...
namespace Decompiler.UnitTests.Core
{
	...
	public class ProgramImageTests
	{
		...
		public void PriReadLiterals()
		{
			...
			Assert.AreEqual(0.5, (double) img.ReadLeDouble(0x04).Value, 0.00001);
			Assert.AreEqual(1.0, (double) img.ReadLeDouble(0x0C).Value, 0.00001);
			Assert.AreEqual(1e-5, (double) img.ReadLeDouble(0x14).Value, 1e-10);
			Assert.AreEqual(0.007843137254902, (double) img.ReadLeDouble(0x1C).Value, 1e-8);
