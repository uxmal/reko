    ...
    public class CilDisassembler : DisassemblerBase<CilInstruction>
    {
        ...
        public override bool MoveNext()
        {
            ...
            case 0x65:
                ...
                instr.Opcode = OpCodes.Neg;
                break;

            //Negate value. Base instruction 
            case 0x66:

                instr.Opcode = OpCodes.Not;
                break;

            //Bitwise complement (logical not). Base instruction 
            case 0x67:

                instr.Opcode = OpCodes.Conv_I1;
                break;

            //Convert to int8, pushing int32 on stack. Base instruction 
            case 0x68:

                instr.Opcode = OpCodes.Conv_I2;
                break;
            ...
            case 0x6F:
                instr.Opcode = OpCodes.Callvirt; // <method>
                break;

            //Call a method associated with an object. Object model instruction 
            case 0x70:

                instr.Opcode = OpCodes.Cpobj; // <typeTok>
                break;
            ...
            case 0x82:
                ...
                instr.Opcode = OpCodes.Conv_Ovf_I1_Un;
                break;
            ...
            case 0xFE:
                ...
                case 0x02:
                    ...
                    break;
                    // Push 1 (of type int32) if value1 > value2, else push 0. Base instruction 
                case 0x03:
                    instr.Opcode = OpCodes.Cgt_Un;
                    break;
                    // Push 1 (of type int32) if value1 > value2, unsigned or unordered, else push 0. Base instruction 
                case 0x04:
                ...
                case 0x0D:
                    ...
                    instr.Opcode = OpCodes.Ldloca; //<uint16 (indx)>
                    break;

                //Load address of local variable with index indx. Base instruction 
                case 0x0E:
                    instr.Opcode = OpCodes.Stloc; // <uint16 (indx)>
                    break;
