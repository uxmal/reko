...
namespace Decompiler.Arch.PowerPC
{
    public static class Registers
    {
        ...
        public static readonly RegisterStorage r16 = new RegisterStorage("r16", 16, PrimitiveType.Word32);
        public static readonly RegisterStorage r17 = new RegisterStorage("r17", 17, PrimitiveType.Word32);
        public static readonly RegisterStorage r18 = new RegisterStorage("r18", 18, PrimitiveType.Word32);
        public static readonly RegisterStorage r19 = new RegisterStorage("r19", 19, PrimitiveType.Word32);
        public static readonly RegisterStorage r20 = new RegisterStorage("r20", 20, PrimitiveType.Word32);
        public static readonly RegisterStorage r21 = new RegisterStorage("r21", 21, PrimitiveType.Word32);
        public static readonly RegisterStorage r22 = new RegisterStorage("r22", 22, PrimitiveType.Word32);
        public static readonly RegisterStorage r23 = new RegisterStorage("r23", 23, PrimitiveType.Word32);
        public static readonly RegisterStorage r24 = new RegisterStorage("r24", 24, PrimitiveType.Word32);
        public static readonly RegisterStorage r25 = new RegisterStorage("r25", 25, PrimitiveType.Word32);
        public static readonly RegisterStorage r26 = new RegisterStorage("r26", 26, PrimitiveType.Word32);
        public static readonly RegisterStorage r27 = new RegisterStorage("r27", 27, PrimitiveType.Word32);
        public static readonly RegisterStorage r28 = new RegisterStorage("r28", 28, PrimitiveType.Word32);
        public static readonly RegisterStorage r29 = new RegisterStorage("r29", 29, PrimitiveType.Word32);
        public static readonly RegisterStorage r30 = new RegisterStorage("r30", 30, PrimitiveType.Word32);
        public static readonly RegisterStorage r31 = new RegisterStorage("r31", 31, PrimitiveType.Word32);
