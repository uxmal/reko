...
namespace Reko.Gui.ViewModels.Dialogs
{
    public class AboutViewModel
    {
        public string Caption
        {
            get
            {
                return String.Format("About {0}", AssemblyTitle);
            }
        }
