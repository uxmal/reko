...
IGNORE tab + cr + lf
        ...
        private DeclSpec Parse_DeclSpecifier()
        {
            ...
            case CTokenType.Register:
                return grammar.StorageClass(token);
        ...
        private StructDecl Parse_StructDecl()
        {
            ...
            List<StructDeclarator> decls = new List<StructDeclarator>();
        ...
        private StructDeclarator Parse_StructDeclarator()
        {
        ...
        {
            var id = grammar.Id((string) ExpectToken(CTokenType.Id));
        ...
        public Declarator Parse_Declarator()
        {
            ...
            for (; ; )
            {
                ...
                case CTokenType.LParen:
                    ...
                    break;
                default: return decl; //$debug real data plz
                }
            }
        }
        ...
        Declarator Parse_DirectAbstractDeclarator()
        {
            ...
            case CTokenType.LBracket:
                ...
                ExpectToken(CTokenType.RBracket);
                decl = grammar.ArrayDeclarator(expr);
                break;
            default:
                return null;
            }
        ...
        public CExpression Parse_PostfixExpr()
        {
            ...
            case CTokenType.Dot:
                ...
                return grammar.MemberAccess(expr, id);
            case CTokenType.Arrow:
                ReadToken();
                id = (string) ExpectToken(CTokenType.Id);
                return grammar.PtrMemberAccess(expr, id);
            case CTokenType.LParen:
                ReadToken();
                ...
                ExpectToken(CTokenType.RParen);
                return grammar.Application(expr, args);
            case CTokenType.Increment:
            case CTokenType.Decrement:
                ReadToken();
                return grammar.PostIncrement(expr, token);
            default:
                return expr;
            }
        }
