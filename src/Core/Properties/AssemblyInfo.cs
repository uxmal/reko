...
namespace Reko
{
    ...
    {
        public const string AssemblyVersion = "0.11.0.0";
        public const string AssemblyFileVersion = "0.11.0.0";
        public const string Product = "Reko decompiler";
        public const string Copyright = "Copyright © 1999-2022 John Källén";
