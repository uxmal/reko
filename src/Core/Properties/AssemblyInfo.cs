...
namespace Reko
{
    ...
    {
        public const string AssemblyVersion = "0.10.2.0";
        public const string AssemblyFileVersion = "0.10.2.0";
        public const string Product = "Reko decompiler";
        public const string Copyright = "Copyright © 1999-2021 John Källén";
