...
namespace Reko
{
    ...
    {
        public const string AssemblyVersion = "0.8.0.1";
        public const string AssemblyFileVersion = "0.8.0.1";
        public const string Product = "Reko decompiler";
        public const string Copyright = "Copyright © 1999-2018 John Källén";
