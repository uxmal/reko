...
function(process_project name path)
	...
	if(ACTION STREQUAL "clean")
		clean_project(${name} ${path} ${BUILD_DIR} ${CMAKE_BUILD_TYPE})
	else()
		invoke_cmake(${name} ${path} ${BUILD_DIR})
	endif()
endfunction()

function(clean_project name path build_dir configuration)
	if(EXISTS ${build_dir})
		message(STATUS "Removing ${build_dir}/${configuration}")
		file(REMOVE_RECURSE ${build_dir}/${configuration})
	endif()
endfunction()
