...
{
    internal class WasmInstructionComparer : InstructionComparer
    {
        private const int MemCode = 0x10;

        public WasmInstructionComparer(Normalize norm) : base(norm)
        {
        }
        ...
        public override bool DoCompareOperands(MachineOperand op1, MachineOperand op2)
        {
            return op1 switch
            {
                ...
                _ => throw new System.NotImplementedException(op1.GetType().FullName)
            };
        ...
        public override int GetOperandHash(MachineOperand op)
        {
            return op switch
            {
                ...
                _ => throw new System.NotImplementedException(op.GetType().FullName)
            };
            throw new System.NotImplementedException();
        }
        ...
        {
            int hash = MemCode;
            hash = hash * 17 ^ (int) m.Offset;
            hash = hash * 17 ^ (int) m.Alignment;
            return hash;
        }
    }
}