...
namespace Reko.UnitTests.Core.Serialization
{
    ...
    public class DataTypeSerializerTests
    {
        ...
        {
            var pt = new PointerType(PrimitiveType.Int32, 32).Accept(new DataTypeSerializer());
        ...
        {
            var pt = new ArrayType(new PointerType(new CodeType(), 32), 3).Accept(new DataTypeSerializer());
        ...
        public void DTS_issue_113()
        {
            ...
            str.Fields.Add(0, new PointerType(str, 32), "bar");
