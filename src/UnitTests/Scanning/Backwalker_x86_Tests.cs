...
namespace Reko.UnitTests.Scanning
{
	...
	public class Backwalker_x86_Tests
	{
        ...
        public void Setup()
        {
            ...
            state = arch.CreateProcessorState(new SegmentMap(Address.Ptr32(0x10000000)));
            expSimp = new ExpressionSimplifier(state, new FakeDecompilerEventListener());
        ...
        {
            var eax = m.Frame.EnsureRegister(Registers.eax);
            var bw = new Backwalker<Block,Instruction>(host, new RtlGoto(m.LoadDw(m.IAdd(eax, 0x10000)), RtlClass.Transfer), expSimp);
        ...
        public void BwJmp()
        {
            ...
            var bw = new Backwalker<Block,Instruction>(host, new RtlGoto(m.LoadDw(m.IAdd(eax, 0x1000)), RtlClass.Transfer), expSimp);
            Assert.IsTrue(
        ...
        public void BwXorHiwordOfIndex()
        {
            ...
            var bw = new Backwalker<Block,Instruction>(host, new RtlGoto(m.LoadDw(m.IAdd(bx, 0x1000)), RtlClass.Transfer), expSimp);
        ...
        public void BwInc()
        {
            var state = arch.CreateProcessorState(new SegmentMap(Address32.Ptr32(0x10000000)));
