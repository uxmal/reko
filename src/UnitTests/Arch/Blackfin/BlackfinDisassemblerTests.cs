...
[Test]
public void BlackfinDasm_B047()
{
    AssertCode("@@@", "B047");
}
// Reko: a decoder for the instruction E770 at address 00000020 has not been implemented. (0b0111............)
[Test]
public void BlackfinDasm_E770()
{
    AssertCode("@@@", "E770");
}
// Reko: a decoder for the instruction 0081 at address 00082A1A has not been implemented. (0b1000............)
[Test]
public void BlackfinDasm_0081()
{
    AssertCode("@@@", "0081");
}
// Reko: a decoder for the instruction 567C at address 00082A20 has not been implemented. (0b0111............)
[Test]
public void BlackfinDasm_567C()
{
    AssertCode("@@@", "567C");
}
// Reko: a decoder for the instruction 40EBD002 at address 00082A22 has not been implemented.
[Test]
public void BlackfinDasm_40EBD002()
{
    AssertCode("@@@", "40EBD002");
}
// Reko: a decoder for the instruction 62DAFFFF at address 00082A36 has not been implemented.
[Test]
public void BlackfinDasm_62DAFFFF()
{
    AssertCode("@@@", "62DAFFFF");
}
