...
namespace Reko.UnitTests.Arch.Arm
{
    ...
    public class T32DisassemblerTests : ArmTestBase
    {
        ...
        [Test]
        public void ThumbDis_crc32b()
        {
            AssertCode("crc32b\tr4,r1,r7", "C1FA8724");
        }

        [Test]
        public void ThumbDis_crc32w()
        {
            AssertCode("crc32w\tr8,r1,ip", "C1FAACE8");
        }
        ...
        [Test]
        public void ThumbDis_vcmla_f16()
        {
            AssertCode("vcmla.f16\td2,d14,d0", "2EFD0028");
        }

        [Test]
        public void ThumbDis_vcmla_f32()
        {
            AssertCode("vcmla.f32\td18,d3,d0", "73FD0028");
        }
        ...
        [Test]
        public void ThumbDis_vpmax()
        {
            AssertCode("vpmax.f64\td13,d16,d2", "00FF92DF");
        }
        ...
        [Test]
        public void ThumbDis_vfmal_f16()
        {
            AssertCode("vfmal.f16\td30,d16,d29", "40FEBDE8");
        }
        ...
        [Test]
        public void ThumbDis_vmul_p8()
        {
            AssertCode("vmul.p8\tq5,q0,q6", "01FF5CA9");
        }
