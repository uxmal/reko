...
@"  00401000: 0000      movs        r0,r0
  ...
  ";
        ...
        public void Setup()
        {
            ...
            state = new ThumbProcessorState(arch);
        }
        ...
        public void ThumbRw_regression()
        {
            ...
            var rw = new ThumbRewriter(arch, image.CreateLeReader(0), new ThumbProcessorState(arch), arch.CreateFrame(), new FakeRewriterHost());
            {
