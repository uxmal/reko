    ...
    public class M6809RewriterTests : RewriterTestBase
    {
        ...
        public void M6809Rw_andcc()
        {
            ...
            AssertCode(
                ...
                "1|L--|cc = cc & 0xFE<8>");     //$LIT: sign extend
        }
        ...
        public void M6809Rw_asr_pc_offset()
        {
            ...
            AssertCode(
                "0|L--|0100(3): 3 instructions",
                "1|L--|v2 = Mem0[0x00FF<p16>:byte] << 1<8>",
                "2|L--|Mem0[0x00FF<p16>:byte] = v2",
                "3|L--|NZC = cond(v2)");
        }
        ...
        public void M6809Rw_bita_indirect_extended()
        {
            ...
            AssertCode(
                ...
                "1|L--|v3 = Mem0[Mem0[0x1234<p16>:ptr16]:byte]",
                "2|L--|v3 = a & v3",
                "3|L--|NZ = cond(v3)",
                "4|L--|V = false");
        }
        ...
        public void M6809Rw_dec_extend()
        {
            ...
            AssertCode(
                "0|L--|0100(3): 3 instructions",
                "1|L--|v2 = Mem0[0x1234<p16>:byte] - 1<i8>",
        ...
        public void M6809Rw_inc_postInc_1()
        {
            ...
            AssertCode(
                "0|L--|0100(2): 4 instructions",
                "1|L--|v3 = Mem0[y:byte] + 1<i8>",      //$LIT: 1<8>
                "2|L--|Mem0[y:byte] = v3",
                "3|L--|y = y + 1<i16>",
                "4|L--|NZV = cond(v3)");
        }
        ...
        public void M6809Rw_lsr()
        {
            ...
            AssertCode(
                "0|L--|0100(2): 3 instructions",
                "1|L--|v3 = Mem0[dp + 0x12<8>:byte] >>u 1<8>",  //$LIT = 0x0012
                "2|L--|Mem0[dp + 0x12<8>:byte] = v3",
                "3|L--|NZC = cond(v3)");
        }
        ...
        public void M6809Rw_neg_dir()
        {
            ...
            AssertCode(
                "0|L--|0100(2): 3 instructions",
                "1|L--|v3 = -Mem0[dp + 0x42<8>:byte]",  //$LIT
                "2|L--|Mem0[dp + 0x42<8>:byte] = v3",
                "3|L--|NZVC = cond(v3)");
        }
        ...
        public void M6809Rw_ror()
        {
            ...
            AssertCode(
                "0|L--|0100(2): 3 instructions",
                "1|L--|v3 = __ror(Mem0[dp + 0x30<8>:byte], 1<8>)",
                "2|L--|Mem0[dp + 0x30<8>:byte] = v3",
                "3|L--|NZC = cond(v3)");
        }
