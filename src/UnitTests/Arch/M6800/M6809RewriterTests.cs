...
namespace Reko.UnitTests.Arch.M6800
{
    ...
    public class M6809RewriterTests : RewriterTestBase
    {
        ...
        public void M6809Rw_asl_acc_offset()
        {
            ...
            AssertCode(
                "0|L--|0100(2): 3 instructions",
                "1|L--|v5 = Mem0[y + CONVERT(a, byte, int16):byte] << 1<8>",
                "2|L--|Mem0[y + CONVERT(a, byte, int16):byte] = v5",
                "3|L--|NZVC = cond(v5)");
        }
        ...
        public void M6809Rw_asr_pc_offset()
        {
            ...
            AssertCode(
                "0|L--|0100(3): 3 instructions",
                "1|L--|v3 = Mem0[0x00FF<p16>:byte] << 1<8>",
                "2|L--|Mem0[0x00FF<p16>:byte] = v3",
                "3|L--|NZC = cond(v3)");
        }
        ...
        public void M6809Rw_bita_indirect_extended()
        {
            ...
            AssertCode(
                ...
                "1|L--|v4 = Mem0[Mem0[0x1234<p16>:ptr16]:byte]",
                "2|L--|v4 = a & v4",
                "3|L--|NZ = cond(v4)",
                "4|L--|V = false");
        }
        ...
        public void M6809Rw_com_indexed_indirect()
        {
            ...
            AssertCode(
                ...
                "1|L--|v5 = ~Mem0[Mem0[x + d:ptr16]:byte]",
                "2|L--|Mem0[Mem0[x + d:ptr16]:byte] = v5",
                "3|L--|NZ = cond(v5)",
                "4|L--|V = false",
                "5|L--|C = true");
        }
        ...
        public void M6809Rw_lsr()
        {
            ...
            AssertCode(
                "0|L--|0100(2): 3 instructions",
                "1|L--|v4 = Mem0[dp + 0x12<16>:byte] >>u 1<8>",
                "2|L--|Mem0[dp + 0x12<16>:byte] = v4",
                "3|L--|NZC = cond(v4)");
        }
        ...
        public void M6809Rw_neg_dir()
        {
            ...
            AssertCode(
                "0|L--|0100(2): 3 instructions",
                "1|L--|v4 = -Mem0[dp + 0x42<16>:byte]",
                "2|L--|Mem0[dp + 0x42<16>:byte] = v4",
                "3|L--|NZVC = cond(v4)");
        }
        ...
        public void M6809Rw_ror()
        {
            ...
            AssertCode(
                "0|L--|0100(2): 3 instructions",
                "1|L--|v4 = __ror<byte,byte>(Mem0[dp + 0x30<16>:byte], 1<8>)",
                "2|L--|Mem0[dp + 0x30<16>:byte] = v4",
                "3|L--|NZC = cond(v4)");
        }
        ...
        public void M6809Rw_swi()
        {
            ...
            AssertCode(
                ...
                "15|L--|s = s - 1<i16>",
                "16|L--|Mem0[s:byte] = cc",
                "17|T--|goto Mem0[0xFFFA<p16>:word16]");
        }
