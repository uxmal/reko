...
namespace Reko.UnitTests.Arch.MilStd1750
{
    ...
    public class MilStd1750DisassemblerTests : DisassemblerTestBase<Instruction>
    {
        ...
        {
            AssertCode("orim\tpg1,0xFF", "4A1800FF");
        }
        ...
        // Reko: a decoder for the instruction 4A270001 at address 0133 has not been implemented. (andm)
 
        // Reko: a decoder for the instruction 4AB18060 at address 01C4 has not been implemented. (aim)

        // Reko: a decoder for the instruction 4A118060 at address 01DE has not been implemented. (aim)

        // Reko: a decoder for the instruction 4A17FF00 at address 023E has not been implemented. (andm)

        // Reko: a decoder for the instruction 4A4700FF at address 0240 has not been implemented. (andm)
        
        // Reko: a decoder for the instruction 4A48FF00 at address 0244 has not been implemented. (orim)

        // Reko: a decoder for the instruction 4A1800FF at address 0249 has not been implemented. (orim)

        // Reko: a decoder for the instruction 4A27FFF8 at address 032F has not been implemented. (andm)

        // Reko: a decoder for the instruction FFF8 at address 0330 has not been implemented. (FF)

        // Reko: a decoder for the instruction 4AD80030 at address 03EB has not been implemented. (orim)

        // Reko: a decoder for the instruction 4A1A8000 at address 0415 has not been implemented. (cim)

        // Reko: a decoder for the instruction 4A510030 at address 0424 has not been implemented. (aim)

        // Reko: a decoder for the instruction 4A283030 at address 0490 has not been implemented. (orim)

        // Reko: a decoder for the instruction 4A310030 at address 04A0 has not been implemented. (aim)
   
        // Reko: a decoder for the instruction 48004000 at address 04C1 has not been implemented. (xio 4000)
        [Test]
        public void MS1750Dis_48004000()
        {
            AssertCode("@@@", "48004000");
        }

        // Reko: a decoder for the instruction 4A010030 at address 04DA has not been implemented. (aim)
 
        // Reko: a decoder for the instruction 4A010037 at address 04DD has not been implemented. (aim)
 
        // Reko: a decoder for the instruction 4F76 at address 0534 has not been implemented. (bif)
        [Test]
        public void MS1750Dis_4F76()
        {
            AssertCode("@@@", "4F76");
        }
        // Reko: a decoder for the instruction 4894AD51 at address 055B has not been implemented. (xio AD51)
        [Test]
        public void MS1750Dis_4894AD51()
        {
            AssertCode("@@@", "4894AD51");
        }
