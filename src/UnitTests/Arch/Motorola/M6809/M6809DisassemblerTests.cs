...
using Reko.Arch.Motorola.M6809;
using Reko.Core;
...
namespace Reko.UnitTests.Arch.M6800
{
    ...
    {
        private Reko.Arch.Motorola.M6809Architecture arch;
        private Address addr;

        [SetUp]
        public void Setup()
        {
            this.arch = new Reko.Arch.Motorola.M6809Architecture(new ServiceContainer(), "m6809", new Dictionary<string, object>());
