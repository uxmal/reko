...
namespace Reko.UnitTests.Arch.M6800
{
    ...
    {
        private Reko.Arch.Motorola.M6812Architecture arch;
        private Address addr;

        public M6812RewriterTests()
        {
            this.arch = new Reko.Arch.Motorola.M6812Architecture(CreateServiceContainer(), "m6812", new Dictionary<string, object>());
