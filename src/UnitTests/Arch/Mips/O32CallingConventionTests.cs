...
{
    [TestFixture]
    public class O32CallingConventionTests
    {
        ...
        [Test]
        public void MipsCc_NoFp()
        {
            AssertSignatureNoFp("Stk: 0 void (r4, r5, r6, r7)                     ", i32, i32, i32, i32);
            AssertSignatureNoFp("Stk: 0 void (r4, r5, r6, Stack +0010)            ", i32, i32, i32, r64);
            AssertSignatureNoFp("Stk: 0 void (r4, r5, r6, r7)                     ", i32, i32, i32, r32);
            AssertSignatureNoFp("Stk: 0 void (r4, r5, Sequence r6:r7)             ", i32, i32, r64);
            AssertSignatureNoFp("Stk: 0 void (r4, Sequence r6:r7)                 ", i32, r64);
        }
    }
}
