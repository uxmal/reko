...
namespace Reko.UnitTests.Arch.Vax
{
    ...
    public class VaxRewriterTests : RewriterTestBase
    {
        ...
        {
            BuildTest(0x7C, 0x00);	// clrq	#00000000
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x1F, 0xF1);	// blssu	000096E8
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x78, 0x8F, 0xF7, 0x53, 0x52);	// ashl	#F7,r3,r2
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x20, 0x00, 0x20, 0x00, 0x20);	// addp4	#0000,#20,#0000,#20
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x88, 0xE1, 0xFE, 0x7F, 0xD0, 0x50, 0x51);	// bisb2	+50D07FFE(r1),r1
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x89, 0xF3, 0xD4, 0x50, 0x04, 0xD5, 0x50, 0x1C);	// bisb3	-2AFBAF2C(r3),r0,#1C
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0xA1, 0x14, 0xD0, 0xC2, 0xE7, 0x05);	// addw3	#0014,-183E(r0),#0005
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x79, 0x00, 0x1A, 0x04);	// ashq	#00,#0000001A,#00000004
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x66, 0x00, 0xEA, 0x00, 0xEA, 0x00, 0xEA);	// divd2	#0.5,-15FF1600(r10)
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0xA9, 0x00, 0xA9, 0x00, 0xA9, 0x00);	// bisw3	#0000,+00(r9),+00(r9)
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x61, 0x01, 0x75, 0x01);	// addd3	#0.5625,-(r5),#0.5625
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x21, 0x00, 0x21, 0x00, 0x73, 0x00, 0x73);	// addp6	#0000,#21,#0000,-(r3),#0000,-(r3)
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x8C, 0x02, 0x00);	// xorb2	#02,#00
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x67, 0x65, 0x3A, 0x20);	// divd3	(r5),#80,#8
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x87, 0x53, 0x01, 0x00);	// divb3	r3,#01,#00
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0x81, 0x00, 0xC1, 0x00, 0x01, 0x01);	// addb3	#00,+0100(r1),#01
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
