...
namespace Reko.UnitTests.Arch.Vax
{
    ...
    public class VaxRewriterTests : RewriterTestBase
    {
        ...
        {
            BuildTest(0x6C, 0x51, 0x50);	// cvtbd	#00,#0.5
            AssertCode(
                "0|L--|00010000(3): 3 instructions",
                "1|L--|r0 = (word32) (int8) r1");
        }
        ...
        {
            BuildTest(0x99, 0xC6, 0xC8, 0x00, 0xC6, 0x1C, 0x03, 0x01, 0x00);	// cvtbw	+00E8(r6),+0001031C(r6)
            AssertCode(
                "0|L--|00010000(2): 1 instructions",
                "1|L--|@@@");
        }
        ...
        {
            BuildTest(0xA6, 0x2D, 0xBB, 0x04);	// divw2	#002D,
            AssertCode(
                "0|L--|00010000(4): 3 instructions",
                "1|L--|v3 = Mem0[r11 + 4:word16] / 0x002D",
                "2|L--|Mem0[Mem0[r11 + 4:word32]:word16] = v3",
                "3|L--|CVZN = cond(v3)");
        }
