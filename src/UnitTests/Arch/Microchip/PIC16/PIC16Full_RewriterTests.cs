...
namespace Reko.UnitTests.Arch.Microchip.PIC16.Rewriter
{
    ...
    /// <summary>
    /// PIC16 full-featured rewriter tests.
    /// </summary>
    [TestFixture]
    public class PIC16Full_RewriterTests : PICRewriterTestsBase
    {
        [OneTimeSetUp]
        ...
        [Test]
        public void PIC16Full_Rewriter_SomeBasic()
        {
            // ADDLW 0x55
        ...
        [Test]
        public void PIC16Full_Rewriter_ADDFSR()
        {
        ...
        [Test]
        public void PIC16Full_Rewriter_ADDWFC()
        {
            ExecTest(Words(0x3D01),
            "0|L--|000200(2): 2 instructions",
                "1|L--|WREG = __addc<byte,byte>(WREG, Data[FSR1:byte], C)",
                "2|L--|CDCZ = cond(WREG)"
            );
            ExecTest(Words(0x3D81),
            "0|L--|000200(2): 2 instructions",
                "1|L--|Data[FSR1:byte] = __addc<byte,byte>(WREG, Data[FSR1:byte], C)",
                "2|L--|CDCZ = cond(Data[FSR1:byte])"
            );
        }

        [Test]
        public void PIC16Full_Rewriter_ASRF()
        {
        ...
        [Test]
        public void PIC16Full_Rewriter_BRA()
        {
        ...
        [Test]
        public void PIC16Full_Rewriter_BRW()
        {
        ...
        [Test]
        public void PIC16Full_Rewriter_CALLW()
        {
            ExecTest(Words(0x000A),
            "0|T--|000200(2): 3 instructions",
                "1|L--|STKPTR = STKPTR + 1<8>",
                "2|L--|Stack[STKPTR] = 000202",
                "3|T--|call (PCLATH << 8<8>) + WREG (0)"
            );
        }

        [Test]
        public void PIC16Full_Rewriter_LSLF()
        {
            ...
            ExecTest(Words(0x3580),
            "0|L--|000200(2): 2 instructions",
                "1|L--|Data[FSR0:byte] = __lslf(Data[FSR0:byte])",
                "2|L--|CZ = cond(Data[FSR0:byte])"
            );
        }

        [Test]
        public void PIC16Full_Rewriter_LSRF()
        {
        ...
        [Test]
        public void PIC16Full_Rewriter_MOVIW()
        {
            ...
            "0|L--|000200(2): 2 instructions",
                "1|L--|WREG = Data[FSR0 + 10<i8>:byte]",
                "2|L--|Z = cond(WREG)"
            );
            ExecTest(Words(0x3F2A),
            "0|L--|000200(2): 2 instructions",
                "1|L--|WREG = Data[FSR0 - 22<i8>:byte]",
                "2|L--|Z = cond(WREG)"
            );
            ExecTest(Words(0x3F45),
            "0|L--|000200(2): 2 instructions",
                "1|L--|WREG = Data[FSR1 + 5<i8>:byte]",
                "2|L--|Z = cond(WREG)"
            );
        }
        ...
        [Test]
        public void PIC16Full_Rewriter_MOVLP()
        {
        ...
        [Test]
        public void PIC16Full_Rewriter_MOVWI()
        {
            ...
            "0|L--|000200(2): 1 instructions",
                "1|L--|Data[FSR0 + 10<i8>:byte] = WREG"
            );
            ExecTest(Words(0x3FAA),
            "0|L--|000200(2): 1 instructions",
                "1|L--|Data[FSR0 - 22<i8>:byte] = WREG"
            );
            ExecTest(Words(0x3FC5),
            "0|L--|000200(2): 1 instructions",
                "1|L--|Data[FSR1 + 5<i8>:byte] = WREG"
            );
        }
        ...
        [Test]
        public void PIC16Full_Rewriter_SUBWFB()
        {
            ExecTest(Words(0x3B01),
            "0|L--|000200(2): 2 instructions",
                "1|L--|WREG = __subc<byte,bool>(Data[FSR1:byte], WREG, !C)",
                "2|L--|CDCZ = cond(WREG)"
            );
            ExecTest(Words(0x3B81),
            "0|L--|000200(2): 2 instructions",
                "1|L--|Data[FSR1:byte] = __subc<byte,bool>(Data[FSR1:byte], WREG, !C)",
                "2|L--|CDCZ = cond(Data[FSR1:byte])"
            );
        }

        [Test]
        public void PIC16Full_Rewriter_TRIS()
        {
