...
namespace Reko.UnitTests.Arch.Microchip.PIC16.Rewriter
{
    ...
    public class PIC16Full_RewriterTests : PICRewriterTestsBase
    {
        ...
        public void PIC16Full_Rewriter_ADDWFC()
        {
            ...
            "0|L--|00000200(2): 2 instructions",
                "1|L--|WREG = WREG + INDF1 + C",
                "2|L--|CDCZ = cond(WREG)"
            );
            ExecTest(Words(0x3D81),
            "0|L--|00000200(2): 2 instructions",
                "1|L--|INDF1 = WREG + INDF1 + C",
                "2|L--|CDCZ = cond(INDF1)"
            );
        }
        ...
        public void PIC16Full_Rewriter_ASRF()
        {
            ...
            "0|L--|00000200(2): 2 instructions",
                "1|L--|WREG = __asrf(INDF0)()",
                "2|L--|CZ = cond(WREG)"
            );
            ExecTest(Words(0x3780),
            "0|L--|00000200(2): 2 instructions",
                "1|L--|INDF0 = __asrf(INDF0)()",
                "2|L--|CZ = cond(INDF0)"
            );
        }
        ...
        public void PIC16Full_Rewriter_LSLF()
        {
            ...
            "0|L--|00000200(2): 2 instructions",
                "1|L--|WREG = __lslf(INDF0)()",
                "2|L--|CZ = cond(WREG)"
            );
            ExecTest(Words(0x3580),
            "0|L--|00000200(2): 2 instructions",
                "1|L--|INDF0 = __lslf(INDF0)()",
                "2|L--|CZ = cond(INDF0)"
            );
        }
        ...
        public void PIC16Full_Rewriter_LSRF()
        {
            ...
            "0|L--|00000200(2): 2 instructions",
                "1|L--|WREG = __lsrf(INDF0)()",
                "2|L--|CZ = cond(WREG)"
            );
            ExecTest(Words(0x3681),
            "0|L--|00000200(2): 2 instructions",
                "1|L--|INDF1 = __lsrf(INDF1)()",
                "2|L--|CZ = cond(INDF1)"
            );
        }
        ...
        public void PIC16Full_Rewriter_SUBWFB()
        {
            ...
            "0|L--|00000200(2): 2 instructions",
                "1|L--|WREG = INDF1 - WREG - !C",
                "2|L--|CDCZ = cond(WREG)"
            );
            ExecTest(Words(0x3B81),
            "0|L--|00000200(2): 2 instructions",
                "1|L--|INDF1 = INDF1 - WREG - !C",
                "2|L--|CDCZ = cond(INDF1)"
            );
        }
