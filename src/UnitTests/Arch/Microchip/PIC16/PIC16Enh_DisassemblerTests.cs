...
namespace Reko.UnitTests.Arch.Microchip.PIC16.Disasm
{
    ...
    public class PIC16Enhd_DisassemblerTests : DisassemblerTestsBase
    {
        ...
        {
            SetPICMode(PIC16EnhancedName);
        }

        [Test]
        public void PIC16Enhd_Disasm_basics()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_ADDFSR()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_ADDWFC()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_ASRF()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_BRW()
        {
            VerifyDisasm("BRW", "", 0x000B);
        }

        public void PIC16Enhd_Disasm_CALLW()
        {
            VerifyDisasm("CALLW", "", 0x000A);
        }

        [Test]
        public void PIC16Enhd_Disasm_CLRW()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_LSLF()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_LSRF()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_MOVIW()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_MOVLB()
        {
            VerifyDisasm("MOVLB\t0x00", "", 0x0020);
            VerifyDisasm("MOVLB\t0x12", "", 0x0032);
            VerifyDisasm("MOVLB\t0x1F", "", 0x003F);
        }

        [Test]
        public void PIC16Enhd_Disasm_MOVLP()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_MOVWI()
        {
        ...
        [Test]
        public void PIC16Enhd_Disasm_NOP()
        {
            VerifyDisasm("NOP", "", 0x0000);
        }

        [Test]
        public void PIC16Enhd_Disasm_RESET()
        {
            VerifyDisasm("RESET", "", 0x0001);
        }

        [Test]
        public void PIC16Enhd_Disasm_SUBWFB()
        {
