...
namespace Reko.UnitTests.Arch.Microchip.PIC16.Rewriter
{
    ...
    public class PIC16Basic_RewriterTests : PICRewriterTestsBase
    {
        ...
        {
            SetPICMode(PIC16BasicName, PICExecMode.Traditional);
        }
        ...
        public void PIC16Basic_Rewriter_ADDWF()
        {
            ...
            ExecTest(Words(0x0780),
                "0|L--|0x00000200(2): 2 instructions",
                    "1|L--|Data[0x0000:byte] = WREG + Data[0x0000:byte]",
                    "2|L--|CDCZ = cond(Data[0x0000:byte])"
                );
        ...
        public void PIC16Basic_Rewriter_BTFSC()
        {
            ...
            "0|T--|0x00000200(2): 1 instructions",
                "1|T--|if ((Data[0x000A:byte] & 0x01) == 0x00) branch 0x00000204"
            );
            ExecTest(Words(0x1BFF),
            "0|T--|0x00000200(2): 1 instructions",
                "1|T--|if ((Data[0x007F:byte] & 0x80) == 0x00) branch 0x00000204"
            );
        }
        ...
        public void PIC16Basic_Rewriter_BTFSS()
        {
            ...
            "0|T--|0x00000200(2): 1 instructions",
                "1|T--|if ((Data[0x007A:byte] & 0x01) != 0x00) branch 0x00000204"
            );
        ...
        public void PIC16Basic_Rewriter_DECFSZ()
        {
            ...
            "0|T--|0x00000200(2): 2 instructions",
                ...
                "2|T--|if (Data[0x0077:byte] == 0x00) branch 0x00000204"
            );
        }
        ...
        public void PIC16Basic_Rewriter_SUBWF()
        {
            ...
            ExecTest(Words(0x0280),
                "0|L--|0x00000200(2): 2 instructions",
                    "1|L--|Data[0x0000:byte] = Data[0x0000:byte] - WREG",
                    "2|L--|CDCZ = cond(Data[0x0000:byte])"
                );
