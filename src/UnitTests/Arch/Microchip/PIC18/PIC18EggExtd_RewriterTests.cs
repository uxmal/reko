    ...
    public class PIC18EggExtd_RewriterTests : PICRewriterTestsBase
    {
        ...
        public void PIC18EggExtd_Rewriter_ANDLW()
        {
            ExecTest(Words(0x0B00),
               "0|L--|000200(2): 2 instructions", "1|L--|WREG = WREG & 0<8>",
               "2|L--|ZN = cond(WREG)"
               );
            ExecTest(Words(0x0B55),
               "0|L--|000200(2): 2 instructions", "1|L--|WREG = WREG & 0x55<8>",
               "2|L--|ZN = cond(WREG)"
               );
        }
        ...
        public void PIC18EggExtd_Rewriter_DCFSNZ()
        {
            ...
            ExecTest(Words(0x4EC4),
                "0|T--|000200(2): 2 instructions",
                    "1|L--|ADRESH = ADRESH - 1<8>",
                    "2|T--|if (ADRESH != 0<8>) branch 000204"
                );
        ...
        public void PIC18EggExtd_Rewriter_TSTFSZ()
        {
            ...
            ExecTest(Words(0x66C3),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if (ADRESL == 0<8>) branch 000204"
                );
        ...
        public void PIC18EggExtd_Rewriter_Indirect()
        {
            ...
            // MOVSF [0x38<8>],POSTDEC0
            ExecTest(Words(0xEB38, 0xFFED),
                "0|L--|000200(4): 2 instructions",
                    "1|L--|Data[FSR0:byte] = Data[FSR2 + 0x38<8>:byte]",
                    "2|L--|FSR0 = FSR0 - 1<16>"
                );
            // MOVSS [0x38<8>],[0x83<8>]
