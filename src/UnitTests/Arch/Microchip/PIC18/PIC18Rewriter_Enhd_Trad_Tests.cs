...
namespace Reko.UnitTests.Arch.Microchip.PIC18.Rewriter
{
    ...
    /// </summary>
    [TestFixture]
    public class PIC18Rewriter_Enhd_Trad_Tests : PIC18RewriterTestsBase
    {
        [TestFixtureSetUp]
        public void OneSetup_Enhd_Trad()
        {
            SetPICMode("PIC18F25K42", PICExecMode.Traditional);
        }

        [Test]
        public void Rewriter_ADDFSR_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_ADDLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_ADDWF_Enhd_Trad()
        {
            ExecTest(Words(0x2400),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = WREG + Data[0x00:byte]",
                    "2|L--|CDCZOVN = cond(WREG)"
                );
            ExecTest(Words(0x2401),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = WREG + Data[0x01:byte]",
                    "2|L--|CDCZOVN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x2601),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = WREG + Data[0x01:byte]",
                    "2|L--|CDCZOVN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_ADDWFC_Enhd_Trad()
        {
            ExecTest(Words(0x2000),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = WREG + Data[0x00:byte] + C",
                    "2|L--|CDCZOVN = cond(WREG)"
                );
            ExecTest(Words(0x2001),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = WREG + Data[0x01:byte] + C",
                    "2|L--|CDCZOVN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x2212),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x12:byte] = WREG + Data[0x12:byte] + C",
                    "2|L--|CDCZOVN = cond(Data[0x12:byte])"
                );
        ...
        [Test]
        public void Rewriter_ANDLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_ANDWF_Enhd_Trad()
        {
            ...
            ExecTest(Words(0x1614),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x14:byte] = WREG & Data[0x14:byte]",
                    "2|L--|ZN = cond(Data[0x14:byte])"
                );
        ...
        [Test]
        public void Rewriter_BC_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BCF_Enhd_Trad()
        {
            ExecTest(Words(0x9001),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|Data[0x01:byte] = Data[0x01:byte] & 0xFE"
                );
        ...
        [Test]
        public void Rewriter_BN_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BNC_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BNN_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BNOV_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BNZ_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BOV_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BRA_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BSF_Enhd_Trad()
        {
            ExecTest(Words(0x8001),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|Data[0x01:byte] = Data[0x01:byte] | 0x01"
                );
        ...
        [Test]
        public void Rewriter_BTFSC_Enhd_Trad()
        {
            ExecTest(Words(0xB000),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if ((Data[0x00:byte] & 0x01) == 0x00) branch 000204"
                );
        ...
        [Test]
        public void Rewriter_BTFSS_Enhd_Trad()
        {
            ExecTest(Words(0xA002),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if ((Data[0x02:byte] & 0x01) != 0x00) branch 000204"
                );
        ...
        [Test]
        public void Rewriter_BTG_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_BZ_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_CALL_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_CALLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_CLRF_Enhd_Trad()
        {
            ExecTest(Words(0x6A01),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = 0x00",
                    "2|L--|Z = true"
                );
        ...
        [Test]
        public void Rewriter_CLRWDT_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_COMF_Enhd_Trad()
        {
            ExecTest(Words(0x1C00),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = ~Data[0x00:byte]",
                    "2|L--|ZN = cond(WREG)"
                );
            ExecTest(Words(0x1C01),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = ~Data[0x01:byte]",
                    "2|L--|ZN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x1E12),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x12:byte] = ~Data[0x12:byte]",
                    "2|L--|ZN = cond(Data[0x12:byte])"
                );
        ...
        [Test]
        public void Rewriter_CPFSEQ_Enhd_Trad()
        {
            ExecTest(Words(0x6200),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if (Data[0x00:byte] == WREG) branch 000204"
                );
            ExecTest(Words(0x6201),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if (Data[0x01:byte] == WREG) branch 000204"
                );
        ...
        [Test]
        public void Rewriter_CPFSGT_Enhd_Trad()
        {
            ExecTest(Words(0x6400),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if (Data[0x00:byte] >u WREG) branch 000204"
                );
            ExecTest(Words(0x6401),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if (Data[0x01:byte] >u WREG) branch 000204"
                );
        ...
        [Test]
        public void Rewriter_CPFSLT_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_DAW_Enhd_Trad()
        {
        ...
        public void Rewriter_DCFSNZ_Enhd_Trad()
        {
            ...
            ExecTest(Words(0x4E01),
                "0|T--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = Data[0x01:byte] - 0x01",
                    "2|T--|if (Data[0x01:byte] != 0x00) branch 000204"
                );
        ...
        [Test]
        public void Rewriter_DECF_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_DECFSZ_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_GOTO_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_INCF_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_INCFSZ_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_INFSNZ_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_IORLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_IORWF_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_LFSR_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_MOVF_Enhd_Trad()
        {
            ...
            ExecTest(Words(0x5201),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = Data[0x01:byte]",
                    "2|L--|ZN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_MOVFF_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_MOVFFL_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_MOVLB_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_MOVLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_MOVWF_Enhd_Trad()
        {
            ExecTest(Words(0x6E01),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|Data[0x01:byte] = WREG"
                );
        ...
        [Test]
        public void Rewriter_MULLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_MULWF_Enhd_Trad()
        {
            ...
            ExecTest(Words(0x0200),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|PROD = Data[0x00:byte] *u WREG"
                );
            ExecTest(Words(0x025F),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|PROD = Data[0x5F:byte] *u WREG"
                );
        ...
        [Test]
        public void Rewriter_NEGF_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_NOP_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_POP_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_PUSH_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_RCALL_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_RESET_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_RETFIE_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_RETLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_RETURN_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_RLCF_Enhd_Trad()
        {
            ExecTest(Words(0x3400),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = __rlcf(Data[0x00:byte], C)()",
                    "2|L--|CZN = cond(WREG)"
                );
            ExecTest(Words(0x3401),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = __rlcf(Data[0x01:byte], C)()",
                    "2|L--|CZN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x3601),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = __rlcf(Data[0x01:byte], C)()",
                    "2|L--|CZN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_RLNCF_Enhd_Trad()
        {
            ExecTest(Words(0x4400),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = __rlncf(Data[0x00:byte])()",
                    "2|L--|ZN = cond(WREG)"
                );
            ExecTest(Words(0x4401),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = __rlncf(Data[0x01:byte])()",
                    "2|L--|ZN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x4601),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = __rlncf(Data[0x01:byte])()",
                    "2|L--|ZN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_RRCF_Enhd_Trad()
        {
            ExecTest(Words(0x3000),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = __rrcf(Data[0x00:byte], C)()",
                    "2|L--|CZN = cond(WREG)"
                );
            ExecTest(Words(0x3001),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = __rrcf(Data[0x01:byte], C)()",
                    "2|L--|CZN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x3201),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = __rrcf(Data[0x01:byte], C)()",
                    "2|L--|CZN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_RRNCF_Enhd_Trad()
        {
            ExecTest(Words(0x4000),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = __rrncf(Data[0x00:byte])()",
                    "2|L--|ZN = cond(WREG)"
                );
            ExecTest(Words(0x4001),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = __rrncf(Data[0x01:byte])()",
                    "2|L--|ZN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x4201),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = __rrncf(Data[0x01:byte])()",
                    "2|L--|ZN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_SETF_Enhd_Trad()
        {
            ExecTest(Words(0x6801),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|Data[0x01:byte] = 0xFF"
                );
        ...
        [Test]
        public void Rewriter_SLEEP_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_SUBFSR_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_SUBFWB_Enhd_Trad()
        {
            ...
            ExecTest(Words(0x5601),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = WREG - Data[0x01:byte] - !C",
                    "2|L--|CDCZOVN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_SUBLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_SUBWF_Enhd_Trad()
        {
            ExecTest(Words(0x5C00),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = Data[0x00:byte] - WREG",
                    "2|L--|CDCZOVN = cond(WREG)"
                );
            ExecTest(Words(0x5C01),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = Data[0x01:byte] - WREG",
                    "2|L--|CDCZOVN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x5E01),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = Data[0x01:byte] - WREG",
                    "2|L--|CDCZOVN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_SUBWFB_Enhd_Trad()
        {
            ExecTest(Words(0x5800),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = Data[0x00:byte] - WREG - !C",
                    "2|L--|CDCZOVN = cond(WREG)"
                );
            ExecTest(Words(0x5801),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|WREG = Data[0x01:byte] - WREG - !C",
                    "2|L--|CDCZOVN = cond(WREG)"
                );
            ...
            ExecTest(Words(0x5A01),
                "0|L--|000200(2): 2 instructions",
                    "1|L--|Data[0x01:byte] = Data[0x01:byte] - WREG - !C",
                    "2|L--|CDCZOVN = cond(Data[0x01:byte])"
                );
        ...
        [Test]
        public void Rewriter_SWAPF_Enhd_Trad()
        {
            ExecTest(Words(0x3800),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|WREG = __swapf(Data[0x00:byte])()"
                );
            ExecTest(Words(0x3801),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|WREG = __swapf(Data[0x01:byte])()"
                );
            ...
            ExecTest(Words(0x3A01),
                "0|L--|000200(2): 1 instructions",
                    "1|L--|Data[0x01:byte] = __swapf(Data[0x01:byte])()"
                );
        ...
        [Test]
        public void Rewriter_TBLRD_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_TBLWT_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_TSTFSZ_Enhd_Trad()
        {
            ExecTest(Words(0x6600),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if (Data[0x00:byte] == 0x00) branch 000204"
                );
            ExecTest(Words(0x6601),
                "0|T--|000200(2): 1 instructions",
                    "1|T--|if (Data[0x01:byte] == 0x00) branch 000204"
                );
        ...
        [Test]
        public void Rewriter_XORLW_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_XORWF_Enhd_Trad()
        {
        ...
        [Test]
        public void Rewriter_Indirect_Enhd_Trad()
        {
            // TSTFSZ INDF2,ACCESS
        ...
        [Test]
        public void Rewriter__Invalid_Enhd_Trad()
        {
            ...
            ExecTest(Words(0x0002, 0xF000, 0x1234),
                ...
                "4|L--|000204(2): 2 instructions",
                    "5|L--|Data[0x34:byte] = WREG | Data[0x34:byte]",
                    "6|L--|ZN = cond(Data[0x34:byte])"
                );
            ...
            ExecTest(Words(0x0067, 0x1234),
                ...
                "2|L--|000202(2): 2 instructions",
                    "3|L--|Data[0x34:byte] = WREG | Data[0x34:byte]",
                    "4|L--|ZN = cond(Data[0x34:byte])"
                );
