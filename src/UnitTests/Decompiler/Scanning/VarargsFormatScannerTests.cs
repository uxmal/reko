...
namespace Reko.UnitTests.Decompiler.Scanning
{
    ...
    public class VarargsFormatScannerTests
    {
        ...
        {
            return new PointerType(PrimitiveType.Char, 32);
        }

        private DataType CStringType64()
        {
            return new PointerType(PrimitiveType.Char, 64);
        }
        ...
        public void Vafs_NoVarargs()
        {
            ...
            var ab = CreateApplicationBuilder(new CallSite(4));
        ...
        public void Vafs_X86Printf()
        {
            ...
            var ab = win32.Architecture.CreateFrameApplicationBuilder(frame, new CallSite(4));
        ...
        public void Vafs_X86_64Printf()
        {
            ...
            var c = Constant.Word32(666);
            var ab = win_x86_64.Architecture.CreateFrameApplicationBuilder(frame, new CallSite(8));
        ...
        public void Vafs_PpcPrintf()
        {
            ...
            var ab = sysV_ppc.Architecture.CreateFrameApplicationBuilder(frame, new CallSite(0));
        ...
        public void Vafs_ReplaceArgs()
        {
            ...
            var newSig = VarargsFormatScanner.ReplaceVarargs(
                platform.Object,
                x86PrintfSig, 
                new DataType[] { PrimitiveType.Int16, new PointerType(PrimitiveType.Char, 32) });
