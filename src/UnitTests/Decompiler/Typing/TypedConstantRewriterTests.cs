...
namespace Reko.UnitTests.Decompiler.Typing
{
	...
	public class TypedConstantRewriterTests
	{
		...
		public void Setup()
		{
			...
			store.EnsureExpressionTypeVariable(factory, null, globals);
        ...
        private void Given_Segment(ushort selector, string name)
        {
            ...
            var tv = store.EnsureExpressionTypeVariable(factory, null, seg.Identifier);
        ...
        private Constant Given_Constant(int n)
        {
            ...
            store.EnsureExpressionTypeVariable(factory, null, c);
            return c;
        }

        private void Given_DataType(Constant c, DataType dt)
        {
            var tv = store.GetTypeVariable(c);
            tv.DataType = dt;
		...
		public void Tcr_RewriteWord32()
		{
			...
			tv.DataType = PrimitiveType.Word32;
        ...
        public void Tcr_RewriterRealBitpattern()
		{
			...
			var tv = store.EnsureExpressionTypeVariable(factory, null, c);
			tv.DataType = PrimitiveType.Real32;
			tv.OriginalDataType = c.DataType;
			Expression e = RewritePointer(c);
        ...
        public void Tcr_TypelessPointer()
        {
            ...
            var tv = store.EnsureExpressionTypeVariable(factory, null, c);
            tv.DataType = PrimitiveType.SegPtr32;
            tv.OriginalDataType = PrimitiveType.SegPtr32;
