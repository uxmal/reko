...
namespace Reko.Environments.MorphOS
{
    ...
    public class MorphosElfImageLoader : ProgramImageLoader
    {
        ...
        public MorphosElfImageLoader(IServiceProvider services, RekoUri imageUri, byte[] rawBytes) 
        ...
        public override Program LoadProgram(Address? addrLoad)
        {
            ...
            this.elfLdr = new ElfImageLoader(this.Services, this.ImageUri, embeddedElfImage);
