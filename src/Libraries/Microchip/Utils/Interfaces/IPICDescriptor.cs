...
namespace Reko.Libraries.Microchip
{
    ...
    /// It permits to dissociate the physical implementation of the Microchip XML definition file from the access by consumers of the PIC descriptor.
    /// </summary>
