...
#pragma warning disable IDE1006 // Naming Styles
        ...
        private static readonly Decoder[] decoders = new Decoder[]
        {
            ...
            // 10
            Instr(Mnemonic.illegal, Mnemonic.djnz, Jb, InstrClass.CondJump),
            ...
            Instr(Mnemonic.illegal, Mnemonic.jr, Jb, InstrClass.Jump),
            ...
            // 20
            Instr(Mnemonic.illegal, Mnemonic.jr, Q, Jb,InstrClass.CondJump),
            ...
            // C0
            Instr(Mnemonic.illegal, Mnemonic.ret, C, InstrClass.CondReturn),
            Instr(Mnemonic.illegal, Mnemonic.pop, Wb),
            Instr(Mnemonic.jnz, Mnemonic.jp, C, A,InstrClass.CondJump),
            Instr(Mnemonic.jmp, Mnemonic.jp, A, InstrClass.Jump),
            Instr(Mnemonic.illegal, Mnemonic.call, C, A,InstrClass.CondCall),
            Instr(Mnemonic.illegal, Mnemonic.push, Wb),
            Instr(Mnemonic.adi, Mnemonic.add, a,Ib),
            Instr(Mnemonic.illegal, Mnemonic.rst, x(00), InstrClass.Call),

            Instr(Mnemonic.illegal, Mnemonic.ret, C, InstrClass.CondReturn),
            Instr(Mnemonic.illegal, Mnemonic.ret, InstrClass.Return),
            Instr(Mnemonic.jz, Mnemonic.jp, C, A,InstrClass.CondJump),
            new CbPrefixDecoder(),
            Instr(Mnemonic.illegal, Mnemonic.call, C, A,InstrClass.CondCall),
            Instr(Mnemonic.illegal, Mnemonic.call, A, InstrClass.Call),
            Instr(Mnemonic.aci, Mnemonic.adc, a,Ib),
            Instr(Mnemonic.illegal, Mnemonic.rst, x(0x08), InstrClass.Call),

            // D0
            Instr(Mnemonic.illegal, Mnemonic.ret, C, InstrClass.CondReturn),
            Instr(Mnemonic.illegal, Mnemonic.pop, Wd),
            Instr(Mnemonic.jnc, Mnemonic.jp, C, A,InstrClass.CondJump),
            Instr(Mnemonic.illegal, Mnemonic.@out, ob,a),
            Instr(Mnemonic.illegal, Mnemonic.call, C, A,InstrClass.CondCall),
            Instr(Mnemonic.illegal, Mnemonic.push, Wd),
            Instr(Mnemonic.sui, Mnemonic.sub, a,Ib),
            Instr(Mnemonic.illegal, Mnemonic.rst, x(0x10), InstrClass.Call),

            Instr(Mnemonic.illegal, Mnemonic.ret, C, InstrClass.CondReturn),
            Instr(Mnemonic.illegal, Mnemonic.exx),
            Instr(Mnemonic.jc, Mnemonic.jp, C, A,InstrClass.CondJump),
            Instr(Mnemonic.illegal, Mnemonic.@in, a,ob),
            Instr(Mnemonic.illegal, Mnemonic.call, C, A,InstrClass.CondCall),
            new IndexPrefixDecoder(Registers.ix),
            Instr(Mnemonic.sbi, Mnemonic.sbc, a,Ib),
            Instr(Mnemonic.illegal, Mnemonic.rst, x(0x18), InstrClass.Call),

            // E0
            Instr(Mnemonic.illegal, Mnemonic.ret, C, InstrClass.CondReturn),
            Instr(Mnemonic.illegal, Mnemonic.pop, Wh),
            Instr(Mnemonic.jpo, Mnemonic.jp, C, A,InstrClass.CondJump),
            ...
            Instr(Mnemonic.illegal, Mnemonic.rst, x(0x20),InstrClass.Call),

            Instr(Mnemonic.illegal, Mnemonic.add, Ws,D),
            Instr(Mnemonic.pchl, Mnemonic.jp, Mw, InstrClass.CallInd),
            Instr(Mnemonic.jpe, Mnemonic.jp, C, A,InstrClass.CondJump),
            Instr(Mnemonic.illegal, Mnemonic.ex, Wd,Wh),
            Instr(Mnemonic.illegal, Mnemonic.illegal),
            new EdPrefixDecoder(),
            Instr(Mnemonic.illegal, Mnemonic.xor, a,Ib),
            Instr(Mnemonic.illegal, Mnemonic.rst, x(0x28), InstrClass.Call),

            // F0
            Instr(Mnemonic.illegal, Mnemonic.illegal),
            Instr(Mnemonic.illegal, Mnemonic.pop, Wa),
            Instr(Mnemonic.jp, Mnemonic.jp, C, A,InstrClass.CondJump),
            Instr(Mnemonic.di, Mnemonic.di),
            Instr(Mnemonic.illegal, Mnemonic.illegal),
            Instr(Mnemonic.illegal, Mnemonic.push, Wa),
            Instr(Mnemonic.illegal, Mnemonic.or, a,Ib),
            Instr(Mnemonic.illegal, Mnemonic.rst, x(0x30), InstrClass.Call),

            Instr(Mnemonic.illegal, Mnemonic.illegal),
            Instr(Mnemonic.sphl, Mnemonic.ld, Ws,Wh),
            Instr(Mnemonic.jm, Mnemonic.jp, C, A,InstrClass.CondJump),
            Instr(Mnemonic.ei, Mnemonic.ei),
            Instr(Mnemonic.illegal, Mnemonic.illegal),
            new IndexPrefixDecoder(Registers.iy),
            Instr(Mnemonic.illegal, Mnemonic.cp, a,Ib),
            Instr(Mnemonic.illegal, Mnemonic.rst, x(0x38), InstrClass.Call),
        };
        ...
        private static readonly Decoder[] edDecoders = new Decoder[] 
        {
            ...
            Instr(Mnemonic.illegal, Mnemonic.retn, InstrClass.Return),
            ...
            Instr(Mnemonic.illegal, Mnemonic.illegal  ),
            Instr(Mnemonic.illegal, Mnemonic.reti, InstrClass.Return),
            Instr(Mnemonic.illegal, Mnemonic.illegal  ),
