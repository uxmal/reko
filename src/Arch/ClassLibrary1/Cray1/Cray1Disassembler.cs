...
{
    using Decoder = Reko.Core.Machine.Decoder<Cray1Disassembler, Mnemonic, Cray1Instruction>;

    public class Cray1Disassembler : DisassemblerBase<Cray1Instruction>
    {
        ...
        public override Cray1Instruction DisassembleInstruction()
        {
        ...
        protected override Cray1Instruction CreateInvalidInstruction()
        {
            return new Cray1Instruction
            {
        ...
        private class InstrDecoder : Decoder
        {
            ...
            public override Cray1Instruction Decode(uint wInstr, Cray1Disassembler dasm)
            {
                ...
                var instr = new Cray1Instruction
                {
