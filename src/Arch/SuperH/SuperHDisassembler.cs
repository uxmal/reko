...
{
    using Decoder = Decoder<SuperHDisassembler, Opcode, SuperHInstruction>;
        ...
        private static readonly Decoder[] decoders = new Decoder[]
        {
            ...
            Sparse(0, 4, "  0...", invalid,
                ...
                (0x9, Sparse(4, 4, "  9", invalid,
                        ( 0x0, Select((8,4),Ne0,invalid, Instr(Opcode.nop))),
                        ( 0x1, Select((8,4),Ne0,invalid, Instr(Opcode.div0u))),
