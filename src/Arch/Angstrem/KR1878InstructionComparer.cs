...
internal class KR1878InstructionComparer : InstructionComparer
{
    private KR1878Architecture kR1878Architecture;
    private Normalize norm;

    public KR1878InstructionComparer(KR1878Architecture kR1878Architecture, Normalize norm)
        : base(norm)
    {
        this.kR1878Architecture = kR1878Architecture;
        this.norm = norm;
    }
