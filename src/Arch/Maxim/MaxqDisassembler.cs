...
namespace Reko.Arch.Maxim
{
    public class MaxqDisassembler : DisassemblerBase<MaxqInstruction, Mnemonic>
    {
        ...
        private static readonly Bitfield bf8l7 = new Bitfield(7, 8);
        private static InstrClass MBP_predecOffs;
        ...
        private static readonly InstrClass MBP_preincOffs;
        public static InstrClass MpreincSP { get; }
        public static InstrClass MBP_Offs { get; }
        ...
        private static bool MNn(uint u, MaxqDisassembler d)
        {
            ...
            if (n > 5)
                return false;
            d.ops.Add(new ModuleRegister(n));
            return true;
        }
...
case 0b0001_1001: return An(0, u, d);
case 0b0010_1001: return An(0, u, d);
case 0b0011_1001: return An(0, u, d);
case 0b0100_1001: return An(0, u, d);
case 0b0101_1001: return An(0, u, d);
case 0b0110_1001: return An(0, u, d);
case 0b0111_1001: return An(0, u, d);
case 0b1000_1001: return An(0, u, d);
case 0b1001_1001: return An(0, u, d);
case 0b1010_1001: return An(0, u, d);
case 0b1011_1001: return An(0, u, d);
case 0b1100_1001: return An(0, u, d);
case 0b1101_1001: return An(0, u, d);
case 0b1110_1001: return An(0, u, d);
case 0b1111_1001: return An(0, u, d);
...
case 0b0000_1110: return MBPOffs(u, d);  // @BP[Offs]      1 0000 1110 8/16 Data Memory @BP[Offs]
case 0b0001_1110: return MBPOffsPostdec(u,d);// @BP[Offs++]    1 0001 1110 8/16 Data memory @BP[Offs]; Post Increment OFFS
case 0b0010_1110: return MBPOffsPostdec(u,d);// @BP[Offs--]    1 0010 1110 8/16 Data Memory @BP[Offs]; Post Decrement OFFS
...
case 0b0111_1111: return DPn(1, u, d);       // DP[n]          1 0n11 1111 16 n Selects 1 of 2 Data Pointer
        ...
        private static bool A_AP(uint u, MaxqDisassembler d)
        {
            throw new NotImplementedException();
        }
        ...
        private static bool MBPOffs(uint u, MaxqDisassembler d)
        {
            throw new NotImplementedException();
        }

        private static bool MBPOffsPostdec(uint u, MaxqDisassembler d)
        {
            throw new NotImplementedException();
        }
...
/*
(0bf001_1010, Instr(Mnemonic.AND)), // AND src Acc ← Acc AND src f001 1010 ssss ssss S, Z Y 1
...
(0b1000_1010, Instr(Mnemonic.NEG)), // NEG Acc ← ~Acc + 1 1000 1010 1001 1010 S, Z Y
(0b1000_1010, Instr(Mnemonic.SLA)), // SLA Shift Acc left arithmetically 1000 1010 0010 1010 C, S, Z Y
(0b1000_1010, Instr(Mnemonic.SLA2)), // SLA2 Shift Acc left arithmetically twice 1000 1010 0011 1010 C, S, Z Y
(0b1000_1010, Instr(Mnemonic.SLA4)), // SLA4 Shift Acc left arithmetically four times 1000 1010 0110 1010 C, S, Z Y
(0b1000_1010, Instr(Mnemonic.RL)), // RL Rotate Acc left (w/o C) 1000 1010 0100 1010 S Y
(0b1000_1010, Instr(Mnemonic.RLC)), // RLC Rotate Acc left (through C) 1000 1010 0101 1010 C, S, Z Y
(0b1000_1010, Instr(Mnemonic.SRA)), // SRA Shift Acc right arithmetically 1000 1010 1111 1010 C, Z Y
(0b1000_1010, Instr(Mnemonic.SRA2)), // SRA2 Shift Acc right arithmetically twice 1000 1010 1110 1010 C, Z Y
(0b1000_1010, Instr(Mnemonic.SRA4)), // SRA4 Shift Acc right arithmetically four times 1000 1010 1011 1010 C, Z Y
(0b1000_1010, Instr(Mnemonic.SR)), // SR Shift Acc right (0 → msbit) 1000 1010 1010 1010 C, S, Z Y
(0b1000_1010, Instr(Mnemonic.RR)), // RR Rotate Acc right (w/o C) 1000 1010 1100 1010 S Y
(0b1000_1010, Instr(Mnemonic.RRC)), // RRC Rotate Acc right (though C) 1000 1010 1101 1010 C, S, Z Y
...
(0b1000_1100, Instr(Mnemonic.RET)), // RET IP ← @SP-- 1000 1100 0000 1101
...
(0bf111_1000, Instr(Mnemonic.CMP)), // CMP src E ← (Acc = src) f111 1000 ssss ssss E
