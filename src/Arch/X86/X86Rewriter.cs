    ...
    public partial class X86Rewriter : IEnumerable<RtlInstructionCluster>
    {
        ...
        public IEnumerator<RtlInstructionCluster> GetEnumerator()
        {
            while (dasm.MoveNext())
            {
                ...
                case Opcode.call: RewriteCall(instrCur.Operands[0], instrCur.Operands[0].Width); break;
                ...
                case Opcode.cmova: RewriteConditionalMove(ConditionCode.UGT, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovbe: RewriteConditionalMove(ConditionCode.ULE, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovc: RewriteConditionalMove(ConditionCode.ULT, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovge: RewriteConditionalMove(ConditionCode.GE, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovg: RewriteConditionalMove(ConditionCode.GT, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovl: RewriteConditionalMove(ConditionCode.LT, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovle: RewriteConditionalMove(ConditionCode.LE, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovnc: RewriteConditionalMove(ConditionCode.UGE, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovno: RewriteConditionalMove(ConditionCode.NO, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovns: RewriteConditionalMove(ConditionCode.NS, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovnz: RewriteConditionalMove(ConditionCode.NE, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovo: RewriteConditionalMove(ConditionCode.OV, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovpe: RewriteConditionalMove(ConditionCode.PE, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovpo: RewriteConditionalMove(ConditionCode.PO, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovs: RewriteConditionalMove(ConditionCode.SG, instrCur.Operands[0], instrCur.Operands[1]); break;
                case Opcode.cmovz: RewriteConditionalMove(ConditionCode.EQ, instrCur.Operands[0], instrCur.Operands[1]); break;
                ...
                case Opcode.ja: RewriteConditionalGoto(ConditionCode.UGT, instrCur.Operands[0]); break;
                case Opcode.jbe: RewriteConditionalGoto(ConditionCode.ULE, instrCur.Operands[0]); break;
                case Opcode.jc: RewriteConditionalGoto(ConditionCode.ULT, instrCur.Operands[0]); break;
                case Opcode.jcxz: RewriteJcxz(); break;
                case Opcode.jge: RewriteConditionalGoto(ConditionCode.GE, instrCur.Operands[0]); break;
                case Opcode.jg: RewriteConditionalGoto(ConditionCode.GT, instrCur.Operands[0]); break;
                case Opcode.jl: RewriteConditionalGoto(ConditionCode.LT, instrCur.Operands[0]); break;
                case Opcode.jle: RewriteConditionalGoto(ConditionCode.LE, instrCur.Operands[0]); break;
                case Opcode.jnc: RewriteConditionalGoto(ConditionCode.UGE, instrCur.Operands[0]); break;
                case Opcode.jno: RewriteConditionalGoto(ConditionCode.NO, instrCur.Operands[0]); break;
                case Opcode.jns: RewriteConditionalGoto(ConditionCode.NS, instrCur.Operands[0]); break;
                case Opcode.jnz: RewriteConditionalGoto(ConditionCode.NE, instrCur.Operands[0]); break;
                case Opcode.jo: RewriteConditionalGoto(ConditionCode.OV, instrCur.Operands[0]); break;
                case Opcode.jpe: RewriteConditionalGoto(ConditionCode.PE, instrCur.Operands[0]); break;
                case Opcode.jpo: RewriteConditionalGoto(ConditionCode.PO, instrCur.Operands[0]); break;
                case Opcode.js: RewriteConditionalGoto(ConditionCode.SG, instrCur.Operands[0]); break;
                case Opcode.jz: RewriteConditionalGoto(ConditionCode.EQ, instrCur.Operands[0]); break;
                ...
                case Opcode.paddq: case Opcode.vpaddq: RewritePackedBinop("__paddq", PrimitiveType.Word64); break;
                ...
                case Opcode.pand: case Opcode.vpand: RewritePackedLogical("__pand"); break;
                case Opcode.pandn: case Opcode.vpandn: RewritePackedLogical("__pandn"); break;
                ...
                case Opcode.pextrw: case Opcode.vextrw:  RewritePextrw(); break;
                case Opcode.pinsrw: case Opcode.vpinsrw: RewritePinsrw(); break;
                ...
                case Opcode.pmullw: case Opcode.vpmullw: RewritePackedBinop("__pmullw", PrimitiveType.Int16, new ArrayType(PrimitiveType.Int16, 8)); break;
                ...
                case Opcode.psllq: case Opcode.vpsllq: RewritePackedBinop("__psllq", PrimitiveType.Word64); break;
                ...
                case Opcode.psubd: case Opcode.vpsubd: RewritePackedBinop("__psubd", PrimitiveType.Word32); break;
                ...
                case Opcode.pxor: case Opcode.vpxor: RewritePxor(); break;
                ...
                case Opcode.ud0: rtlc = InstrClass.Invalid; m.Invalid(); break;
                case Opcode.ud1: rtlc = InstrClass.Invalid; m.Invalid(); break;
