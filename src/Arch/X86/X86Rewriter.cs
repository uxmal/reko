    ...
    public partial class X86Rewriter : IEnumerable<RtlInstructionCluster>
    {
        ...
        public IEnumerator<RtlInstructionCluster> GetEnumerator()
        {
            while (dasm.MoveNext())
            {
                ...
                case Mnemonic.fcomi: RewrteFcomi(false); break;
                case Mnemonic.fcomip: RewrteFcomi(true); break;
                ...
                case Mnemonic.fucomi: RewrteFcomi(false); break;
                case Mnemonic.fucomip: RewrteFcomi(true); break;
