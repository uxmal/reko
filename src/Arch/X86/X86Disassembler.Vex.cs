    ...
    public partial class X86Disassembler
    {
        private static Dictionary<Mnemonic, Mnemonic> CreateVexMapping()
        {
            return new Dictionary<Mnemonic, Mnemonic>
            {
                ...
                { Mnemonic.addss, Mnemonic.vaddss },
                ...
                { Mnemonic.divsd, Mnemonic.vdivsd },
                { Mnemonic.divss, Mnemonic.vdivss },
                { Mnemonic.movapd, Mnemonic.vmovapd },
                { Mnemonic.movaps, Mnemonic.vmovaps },
                { Mnemonic.movdqa, Mnemonic.vmovdqa },
                ...
                { Mnemonic.mulsd, Mnemonic.vmulsd },
                { Mnemonic.mulss, Mnemonic.vmulss },
                { Mnemonic.phaddw, Mnemonic.vphaddw },
                { Mnemonic.subsd, Mnemonic.vsubsd },
                { Mnemonic.subss, Mnemonic.vsubss },
