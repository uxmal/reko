...
namespace Reko.Arch.Sparc
{
    ...
    public class InstructionSet
    {
        ...
        Decoder CreateDecoder()
        {
            ...
            {
                // 00
                Instr(Mnemonic.add, r14,Ru13,r25),
                Instr(Mnemonic.and, r14,Ru13,r25),
                Instr(Mnemonic.or, r14,Ru13,r25),
                Instr(Mnemonic.xor, r14,Ru13,r25),
                Instr(Mnemonic.sub, r14,Ru13,r25),
                Instr(Mnemonic.andn, r14,Ru13,r25),
                Instr(Mnemonic.orn, r14,Ru13,r25),
                Instr(Mnemonic.xnor, r14,Ru13,r25),

                Instr64(
                    Instr(Mnemonic.addc, r14,Ru13,r25),
                    Instr(Mnemonic.addx, r14,Ru13,r25)),
                Instr64(
                    Instr(Mnemonic.mulx, r14,Ru13,r25),
                    invalid),
                Instr(Mnemonic.umul, r14,Ru13,r25),
                Instr(Mnemonic.smul, r14,Ru13,r25),
                Instr64(
                    Instr(Mnemonic.subc, r14,Ru13,r25),
                    Instr(Mnemonic.subx, r14,Ru13,r25)),
                Instr64(
                    Instr(Mnemonic.udivx, r14,Ru13,r25),
                    invalid),
                Instr(Mnemonic.udiv, r14,Ru13,r25),
                Instr(Mnemonic.sdiv, r14,Ru13,r25),

                // 10
                Instr(Mnemonic.addcc, r14,Ru13,r25),
                Instr(Mnemonic.andcc, r14,Ru13,r25),
                Instr(Mnemonic.orcc, r14,Ru13,r25),
                Instr(Mnemonic.xorcc, r14,Ru13,r25),
                Instr(Mnemonic.subcc, r14,Ru13,r25),
                Instr(Mnemonic.andncc, r14,Ru13,r25),
                Instr(Mnemonic.orncc, r14,Ru13,r25),
                Instr(Mnemonic.xnorcc, r14,Ru13,r25),

                Instr64(
                    Instr(Mnemonic.addccc, r14,Ru13,r25),
                    Instr(Mnemonic.addxcc, r14,Ru13,r25)),
                invalid,
                Instr(Mnemonic.umulcc, r14,Ru13,r25),
                Instr(Mnemonic.smulcc, r14,Ru13,r25),
                Instr64(
                    Instr(Mnemonic.subxcc, r14,Ru13,r25),
                    Instr(Mnemonic.subxcc, r14,Ru13,r25)),
                invalid,
                Instr(Mnemonic.udivcc, r14,Ru13,r25),
                Instr(Mnemonic.sdivcc, r14,Ru13,r25),

                // 20
                Instr(Mnemonic.taddcc, r14,Ru13,r25),
                Instr(Mnemonic.tsubcc, r14,Ru13,r25),
                Instr(Mnemonic.taddcctv, r14,Ru13,r25),
                Instr(Mnemonic.tsubcctv, r14,Ru13,r25),
                Instr(Mnemonic.mulscc, r14,Ru13,r25),
                Instr64(
                ...
                Instr64(
                    SparcDisassembler.Mask(18, 1, "  MOVcc",
                        SparcDisassembler.Mask(14, 4, " MOVcc fcc",
                            Instr(Mnemonic.movfn  , fcc, Rs11, r25),
                            Instr(Mnemonic.movfne , fcc, Rs11, r25),
                            Instr(Mnemonic.movflg , fcc, Rs11, r25),
                            Instr(Mnemonic.movful , fcc, Rs11, r25),

                            Instr(Mnemonic.movfl  , fcc, Rs11, r25),
                            Instr(Mnemonic.movfug , fcc, Rs11, r25),
                            Instr(Mnemonic.movfg  , fcc, Rs11, r25),
                            Instr(Mnemonic.movfu  , fcc, Rs11, r25),

                            Instr(Mnemonic.movfa  , fcc, Rs11, r25),
                            Instr(Mnemonic.movfe  , fcc, Rs11, r25),
                            Instr(Mnemonic.movfue , fcc, Rs11, r25),
                            Instr(Mnemonic.movfge , fcc, Rs11, r25),

                            Instr(Mnemonic.movfuge, fcc, Rs11, r25),
                            Instr(Mnemonic.movfle , fcc, Rs11, r25),
                            Instr(Mnemonic.movfule, fcc, Rs11, r25),
                            Instr(Mnemonic.movfo  , fcc, Rs11, r25)),
                        SparcDisassembler.Mask(14, 4, " MOVcc icc",
                            Instr(Mnemonic.movn  , icc, Rs11, r25),
                            Instr(Mnemonic.move  , icc, Rs11, r25),
                            Instr(Mnemonic.movle , icc, Rs11, r25),
                            Instr(Mnemonic.movl  , icc, Rs11, r25),

                            Instr(Mnemonic.movleu, icc, Rs11, r25),
                            Instr(Mnemonic.movcs , icc, Rs11, r25),
                            Instr(Mnemonic.movneg, icc, Rs11, r25),
                            Instr(Mnemonic.movvs , icc, Rs11, r25),

                            Instr(Mnemonic.mova  , icc, Rs11, r25),
                            Instr(Mnemonic.movne , icc, Rs11, r25),
                            Instr(Mnemonic.movg  , icc, Rs11, r25),
                            Instr(Mnemonic.movge , icc, Rs11, r25),

                            Instr(Mnemonic.movgu , icc, Rs11, r25),
                            Instr(Mnemonic.movcc , icc, Rs11, r25),
                            Instr(Mnemonic.movpos, icc, Rs11, r25),
                            Instr(Mnemonic.movvc , icc, Rs11, r25))),
                    invalid),
                Instr64(
                    Instr(Mnemonic.sdivx, r14,Ru13,r25),
                    invalid),
                Instr64(
                    Instr(Mnemonic.popc, Ru13,r25),
                    invalid),
                Instr64(
                ...
                Instr64(
                    invalid,
                    Instr(Mnemonic.wrtbr, InstrClass.Linear | InstrClass.Privileged, r14, Ru13)),
                ...
                Instr(Mnemonic.restore, r14,Ru13,r25),
                Instr64(
                    SparcDisassembler.Sparse(25, 5, "  31", invalid,
