    ...
    public partial class SparcRewriter : IEnumerable<RtlInstructionCluster>
    {
        ...
        public IEnumerator<RtlInstructionCluster> GetEnumerator()
        {
            ...
            while (dasm.MoveNext())
            {
                ...
                case Mnemonic.ld: RewriteLoadZ(PrimitiveType.Word32); break;
                case Mnemonic.lddf: RewriteLoadF(PrimitiveType.Real64); break;
                case Mnemonic.ldf: RewriteLoadF(PrimitiveType.Real32); break;
                case Mnemonic.ldd: RewriteLdd(); break;
                case Mnemonic.ldsb: RewriteLoadS(PrimitiveType.Byte); break;
                case Mnemonic.ldsh: RewriteLoadS(PrimitiveType.Word16); break;
                case Mnemonic.ldsw: RewriteLoadS(PrimitiveType.Word32); break;
                case Mnemonic.ldstub: RewriteLdstub(); break;
                case Mnemonic.ldub: RewriteLoadZ(PrimitiveType.Byte); break;
                case Mnemonic.lduba: RewriteLoada(PrimitiveType.Byte); break;
                case Mnemonic.lduh: RewriteLoadZ(PrimitiveType.Word16); break;
                case Mnemonic.lduw: RewriteLoadZ(PrimitiveType.Word32); break;
                case Mnemonic.ldx: RewriteLoadZ(PrimitiveType.Word64); break;
                case Mnemonic.ldfsr: RewriteLoadZ(PrimitiveType.Word32); break;
