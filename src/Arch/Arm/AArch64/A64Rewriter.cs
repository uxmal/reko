    ...
    public partial class A64Rewriter : IEnumerable<RtlInstructionCluster>
    {
        ...
        public IEnumerator<RtlInstructionCluster> GetEnumerator()
        {
            while (dasm.MoveNext())
            {
                ...
                case Mnemonic.mla: RewriteSimdTrinary("__mla_{0}", Domain.None); break;
                case Mnemonic.mls: RewriteSimdTrinary("__mls_{0}", Domain.None); break;
                ...
                case Mnemonic.smlal: RewriteSimdTrinary("__smlal_{0}", Domain.SignedInt); break;
                case Mnemonic.smlal2: RewriteSimdTrinary("__smlal2_{0}", Domain.SignedInt); break;
                case Mnemonic.smlsl: RewriteSimdTrinary("__smlsl_{0}", Domain.SignedInt); break;
                case Mnemonic.smlsl2: RewriteSimdTrinary("__smlsl2_{0}", Domain.SignedInt); break;
                ...
                case Mnemonic.sqdmlal: RewriteSimdTrinary("__sqdmlal_{0}", Domain.SignedInt); break;
                case Mnemonic.sqdmlal2: RewriteSimdTrinary("__sqdmlal2_{0}", Domain.SignedInt); break;
                case Mnemonic.sqdmlsl: RewriteSimdTrinary("__sqdmlsl_{0}", Domain.SignedInt); break;
                case Mnemonic.sqdmlsl2: RewriteSimdTrinary("__sqdmlsl2_{0}", Domain.SignedInt); break;
                case Mnemonic.sqneg: RewriteSimdUnary("__sqneg_{0}", Domain.SignedInt); break;
                case Mnemonic.sqrdmlah: RewriteSimdTrinary("__sqrdmlah_{0}", Domain.SignedInt); break;
                case Mnemonic.sqrdmlsh: RewriteSimdTrinary("__sqrdmlsh_{0}", Domain.SignedInt); break;
                ...
                case Mnemonic.umlal: RewriteSimdTrinary("__umlal_{0}", Domain.UnsignedInt); break;
                case Mnemonic.umlal2: RewriteSimdTrinary("__umlal2_{0}", Domain.UnsignedInt); break;
                case Mnemonic.umlsl: RewriteSimdTrinary("__umlsl_{0}", Domain.UnsignedInt); break;
                case Mnemonic.umlsl2: RewriteSimdTrinary("__umlsl2_{0}", Domain.UnsignedInt); break;
