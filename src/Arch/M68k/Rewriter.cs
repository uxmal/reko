 ...
 */
                ...
                case Opcode.bls: RewriteBcc(ConditionCode.ULE, FlagM.CF | FlagM.ZF); break;
                case Opcode.blt: RewriteBcc(ConditionCode.LT, FlagM.NF | FlagM.VF); break;
                ...
                case Opcode.dbge: RewriteDbcc(ConditionCode.GE, FlagM.NF | FlagM.VF); break;
                case Opcode.dbgt: RewriteDbcc(ConditionCode.GE, FlagM.NF | FlagM.VF | FlagM.ZF); break;
                ...
                case Opcode.dblt: RewriteDbcc(ConditionCode.LT, FlagM.NF | FlagM.VF); break;
                case Opcode.dbmi: RewriteDbcc(ConditionCode.LT, FlagM.NF); break;
                ...
                case Opcode.sls: RewriteScc(ConditionCode.ULE, FlagM.CF | FlagM.ZF); break;
                case Opcode.slt: RewriteScc(ConditionCode.LT, FlagM.NF | FlagM.ZF); break;
                ...
                case Opcode.st: orw.RewriteMoveDst(instr.Operands[0], instr.Address, PrimitiveType.Bool, Constant.True()); break;
                case Opcode.sf: orw.RewriteMoveDst(instr.Operands[0], instr.Address, PrimitiveType.Bool, Constant.False()); break;
