    ...
    public class PIC16FullDisasm : PIC16BasicDisasm
    {
        ...
        private static Decoder[] opcodesTable = new Decoder[4]
        {
                    ...
                    new SubDecoder(7, 1, new Decoder[2] {           // 00 0000 ?... ....
                        new SubDecoder(4, 3, new Decoder[8]{        // 00 0000 0??? ....
                            ...
                            new SubDecoder(3, 1, new Decoder[2]{    // 00 0000 0001 ?...
                                new MoviIncDecDecoder(Opcode.MOVIW),  // 00 0000 0001 0...
                                new MoviIncDecDecoder(Opcode.MOVWI)   // 00 0000 0001 1...
                            }),
            ...
            new SubDecoder(8, 4, new Decoder[16]{                   // 11 ???? .... ....
                new Immed8Decoder(Opcode.MOVLW),                      // 11 0000 .... ....
                new SubDecoder(7, 1, new Decoder[2]{                // 11 0001 ?... ....
                    new FSRArithDecoder(Opcode.ADDFSR),               // 11 0001 0... ....
                    new Immed7Decoder(Opcode.MOVLP)                   // 11 0001 1... ....
                }),
                new TargetRel9Decoder(Opcode.BRA),                    // 11 0010 .... ....
                new TargetRel9Decoder(Opcode.BRA),                    // 11 0011 .... ....
                new Immed8Decoder(Opcode.RETLW),                      // 11 0100 .... ....
                new MemoryByteWDestDecoder(Opcode.LSLF),              // 11 0101 .... ....
                new MemoryByteWDestDecoder(Opcode.LSRF),              // 11 0110 .... ....
                new MemoryByteWDestDecoder(Opcode.ASRF),              // 11 0111 .... ....
                new Immed8Decoder(Opcode.IORLW),                      // 11 1000 .... ....
                new Immed8Decoder(Opcode.ANDLW),                      // 11 1001 .... ....
                new Immed8Decoder(Opcode.XORLW),                      // 11 1010 .... ....
                new MemoryByteWDestDecoder(Opcode.SUBWFB),            // 11 1011 .... ....
                new Immed8Decoder(Opcode.SUBLW),                      // 11 1100 .... ....
                new MemoryByteWDestDecoder(Opcode.ADDWFC),            // 11 1101 .... ....
                new Immed8Decoder(Opcode.ADDLW),                      // 11 1110 .... ....
                new SubDecoder(7, 1, new Decoder[2]{                // 11 1111 ?... ....
                    new FSRIndexedDecoder(Opcode.MOVIW),              // 11 1111 0... ....
                    new FSRIndexedDecoder(Opcode.MOVWI),              // 11 1111 1... ....
                })
            })
        };
