...
namespace Reko.Arch.Microchip.Common
{
    ...
    public interface IOperandVisitor
    {
        ...
        void VisitOffsetBankedMem(PICOperandOffsetBankedMemory mem);
        void VisitRegister(PICOperandRegister reg);
        void VisitWregDest(PICOperandWregDest reg);
        void VisitIsAccessBank(PICOperandIsAccessBank acc);
    ...
    public interface IOperandVisitor<T>
    {
        ...
        T VisitOffsetBankedMem(PICOperandOffsetBankedMemory mem);
        T VisitRegister(PICOperandRegister reg);
        T VisitWregDest(PICOperandWregDest reg);
        T VisitIsAccessBank(PICOperandIsAccessBank acc);
    ...
    public interface IOperandVisitor<T, C>
    {
        ...
        T VisitOffsetBankedMem(PICOperandOffsetBankedMemory mem, C ctx);
        T VisitRegister(PICOperandRegister reg, C ctx);
        T VisitWregDest(PICOperandWregDest reg, C ctx);
        T VisitIsAccessBank(PICOperandIsAccessBank acc, C ctx);
