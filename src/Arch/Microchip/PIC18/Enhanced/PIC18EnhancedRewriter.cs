...
namespace Reko.Arch.MicrochipPIC.PIC18
{
    ...
    public class PIC18EnhancedRewriter : PIC18RewriterBase
    {
        private PIC18EnhancedRewriter(PICArchitecture arch, PICDisassemblerBase dasm, PICProcessorState state, IStorageBinder binder, IRewriterHost host)
        ...
        {
            return new PIC18EnhancedRewriter(
