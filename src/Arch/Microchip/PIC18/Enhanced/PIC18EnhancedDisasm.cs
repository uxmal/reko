...
namespace Reko.Arch.MicrochipPIC.PIC18
{
    ...
    public class PIC18EnhancedDisasm : PIC18LegacyDisasm
    {
        ...
        /// </summary>
        private static readonly Decoder[] enhancedOpcodesTable = new Decoder[16]
        {
        ...
        private class MovfflDecoder : Decoder
        {
            ...
            public MovfflDecoder(Mnemonic mnemonic)
            {
                this.mnemonic = mnemonic;
            }
        ...
        private class FsrULinkDecoder : Decoder
        {
            ...
            public FsrULinkDecoder(Mnemonic mnemonic)
            {
                this.mnemonic = mnemonic;
            }
        ...
        private class MovsfDecoder : Decoder
        {
            ...
            public MovsfDecoder(Mnemonic mnemonic)
            {
                this.mnemonic = mnemonic;
            }
        ...
        private class MovsflDecoder : Decoder
        {
            ...
            public MovsflDecoder(Mnemonic mnemonic)
            {
                this.mnemonic = mnemonic;
            }
        ...
        private class MovssDecoder : Decoder
        {
            ...
            public MovssDecoder(Mnemonic mnemonic)
            {
                this.mnemonic = mnemonic;
            }
        ...
        private class PushlDecoder : Decoder
        {
            ...
            public PushlDecoder(Mnemonic mnemonic)
            {
                this.mnemonic = mnemonic;
            }
