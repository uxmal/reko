        ...
        private Decoder Ext1FDecoder()
        {
            var decoder = Mask(26, 5, "  Ext31",
                ...
                Sparse(21, 5, invalid, "  0b00110",
                    ...
                    (0b10111, Nyi("stdat")),                            // v3.0 stdat Store Dword ATomic
                    (0b11000, Nyi("copy")),                             // v3.0 copy Copy
                    (0b11010, Nyi("cp_abort")),                         // v3.0 cp_abort CP_Abort
                    (0b11100, Nyi("paste[.]"))),                        // v3.0 paste[.] Paste
                Sparse(21, 5, invalid, "  0b00111",
                    (0b00000, Nyi("lvebx")),                            // v2.03 lvebx Load Vector Element Byte Indexed
                    (0b00001, Nyi("lvehx")),                            // v2.03 lvehx Load Vector Element Hword Indexed
                    ...
                    (0b01111, Nyi("stvxl")),                            // v2.03 stvxl Store Vector Indexed Last
                ...
                Sparse(21, 5, invalid, "  0b01000",
                    ...
                    (0b00111, Nyi("subfme")),                           // P1 SR subfme[o][.] Subtract From Minus One Extended
                    ...
                    (0b10111, Nyi("subfmeo"))),                         // P1 SR subfme[o][.] Subtract From Minus One Extended

                Sparse(22, 4, invalid, "  0b01001",
                    (0b0000, Nyi(" XO I 80")),                          // PPC SR mulhdu[.] Multiply High Dword Unsigned
                    (0b0010, Nyi(" XO I 80")),                          // PPC SR mulhd[.] Multiply High Dword
                    (0b0111, InstrPPC(Mnemonic.mulld, C, r1, r2, r3)),  // PPC SR mulld[o][.] Multiply Low Dword
                    (0b1100, Nyi(" XO I 83")),                          // v2.06 SR divdeu[o][.] Divide Dword Extended Unsigned
                    (0b1101, Nyi(" XO I 83")),                          // v2.06 SR divde[o][.] Divide Dword Extended
                    ...
                    (0b1000, Mask(21, 1, "  modud/sd",
                        Nyi("modud"),                                   // v3.0 modud Modulo Unsigned Dword
                        Nyi("modsd")))),                                // v3.0 modsd Modulo Signed Dword
                ...
                Sparse(21, 5, invalid, "  0b01011",
                    ...
                    (0b1100, Nyi("divweu")),                            // v2.06 SR divweu[o][.] Divide Word Extended Unsigned
                    (0b1101, Nyi("divwe")),                             // v2.06 SR divwe[o][.] Divide Word Extended
                    ...
                    (0b1000, Mask(21, 1, "  moduw/sw",
                        Nyi("moduw"),                                   // v3.0 moduw Modulo Unsigned Word
                        Nyi("modsw ")))),                               // v3.0 modsw Modulo Signed Word
                
                Sparse(21, 5, invalid, "  0b01100",
                    (0b00000, Nyi("lxsiwzx")),                          // v2.07 lxsiwzx Load VSX Scalar as Integer Word & Zero Indexed
                    (0b00010, Nyi("lxsiwax")),                          // v2.07 lxsiwax Load VSX Scalar as Integer Word Algebraic Indexed
                    (0b00100, Nyi("stxsiwx")),                          // v2.07 stxsiwx Store VSX Scalar as Integer Word Indexed
                    ...
                    (0b10110, Nyi("stxsdx")),                           // v2.06 stxsdx Store VSX Scalar Dword Indexed
                    ...
                    (0b11010, Nyi("lxvd2x")),                           // v2.06 lxvd2x Load VSX Vector Dword*2 Indexed
                    (0b11011, Nyi("lxvb16x")),                          // v3.0 lxvb16x Load VSX Vector Byte*16 Indexed
                    (0b11100, Nyi("stxvw4x")),                          // v2.06 stxvw4x Store VSX Vector Word*4 Indexed
                    (0b11101, Nyi("stxvh8x")),                          // v3.0 stxvh8x Store VSX Vector Hword*8 Indexed
                    (0b11110, Nyi("stxvd2x")),                          // v2.06 stxvd2x Store VSX Vector Dword*2 Indexed
                    (0b11111, Nyi("stxvb16x"))),                        // v3.0 stxvb16x Store VSX Vector Byte*16 Indexed
                Sparse(21, 5, invalid, "  0b01101",
                    (0b01000, Nyi("lxvl")),                             // v3.0 lxvl Load VSX Vector with Length
                    (0b01001, Nyi("lxvll")),                            // v3.0 lxvll Load VSX Vector Left-justified with Length
                    ...
                    (0b11001, Nyi("lxsihzx")),                          // v3.0 lxsihzx Load VSX Scalar as Integer Hword & Zero Indexed
                    (0b11100, Nyi("stxsibx")),                          // v3.0 stxsibx Store VSX Scalar as Integer Byte Indexed
                    (0b11101, Nyi("stxsihx"))),                         // v3.0 stxsihx Store VSX Scalar as Integer Hword Indexed
                Sparse(21, 5, invalid, "  0b01110",
                    (0b00100, Nyi("msgsndp")),                          // v2.07 P msgsndp Message Send Privileged
                    (0b00101, Nyi("msgclrp")),                          // v2.07 P msgclrp Message Clear Privileged
                    (0b00110, Nyi("msgsnd ")),                          // v2.07 H msgsnd Message Send
                    (0b00111, Nyi("msgclr ")),                          // v2.07 H msgclr Message Clear
                    (0b01001, Nyi("mfbhrbe")),                          // v2.07 mfbhrbe Move From BHRB
                    (0b01101, Nyi("clrbhrb")),                          // v2.07 clrbhrb Clear BHRB
                    (0b10101, Nyi("tend.")),                            // v2.07 tend. Transaction End & record
                    (0b10110, Nyi("tcheck")),                           // v2.07 tcheck Transaction Check & record
                    (0b10111, Nyi("tsr.")),                             // v2.07 tsr.         Transaction Suspend or Resume & record
                    (0b10100, Nyi("tbegin.")),                          // v2.07 tbegin.    Transaction Begin & record
                    (0b11000, Nyi("tabortwc.")),                        // v2.07 tabortwc.  Transaction Abort Word Conditional & record
                    (0b11001, Nyi("tabortdc.")),                        // v2.07 tabortdc.  Transaction Abort Dword Conditional & record
                    ...
                    (0b11100, Nyi("tabort.")),                          // v2.07 tabort.    Transaction Abort & record
                    (0b11101, Nyi("treclaim.")),                        // v2.07 P treclaim.Transaction Reclaim & record
                    (0b11111, Nyi("trechkpt."))),                       // v2.07 P trechkpt.Transaction Recheckpoint & record
                Nyi("isel"),                                            // v2.03 isel Integer Select

                Sparse(21, 5, invalid, "  0b10000",
                    (0b00100, Mask(11, 1, "  mtcrf/mtocrf",
                        Instr(Mnemonic.mtcrf, M, r1),                   // P1 mtcrf Move To CR Fields
                        Nyi("mtocrf")))),                               // v2.01 mtocrf Move To One CR Field
                invalid,
                Sparse(21, 5, invalid, "  0b10010",
                    (0b00100, Instr(Mnemonic.mtmsr, r1, u16_1)),        // P1 P mtmsr Move To MSR
                    (0b00101, Instr(Mnemonic.mtmsrd, r1, u16_1)),       // PPC P mtmsrd Move To MSR Dword
                    (0b01000, Nyi("P")),                                // v2.03 P 64 tlbiel TLB Invalidate Entry Local
                    (0b01001, Instr(Mnemonic.tlbie, r3)),               // P1 H 64 tlbie TLB Invalidate Entry
                    (0b01010, Nyi("P")),                                // v3.0 P slbsync SLB Synchronize
                    (0b01100, Nyi("P")),                                // v2.00 P slbmte SLB Move To Entry
                    (0b01101, Nyi("P")),                                // PPC P slbie SLB Invalidate Entry
                    (0b01110, Nyi("P")),                                // v3.0 P slbieg SLB Invalidate Entry Global
                ...
                Sparse(21, 5, invalid, "  0b10011",
                    ...
                    (0b00110, Nyi("mtvsrwa")),                          // v2.07 mtvsrwa Move To VSR Word Algebraic
                    (0b00111, Nyi("mtvsrwz")),                          // v2.07 mtvsrwz Move To VSR Word & Zero
                    (0b01001, Nyi("mfvsrld")),                          // v3.0 mfvsrld Move From VSR Lower Dword
                    ...
                    (0b11100, Nyi("slbmfee")),                          // v2.00 P slbmfee SLB Move From Entry ESID
                ...
                Sparse(21, 5, invalid, "  0b10100",
                    ...
                    (0b10100, Nyi("stdbrx"))),                          // v2.06 stdbrx Store Dword Byte-Reverse Indexed
                ...
                Sparse(21, 5, invalid, "  0b10110",
                    (0b00000, Nyi("icbt")),                             // v2.07 icbt Instruction Cache Block Touch
                    ...
                    (0b01110, Instr(Mnemonic.dcbi, r2, r3)),            // PPC-ONLY dcbi P Data Cache Block iInvalidate
                    (0b10000, Instr(Mnemonic.lwbrx, r1, r2, r3)),       // P1 lwbrx Load Word Byte-Reverse Indexed
                    (0b10001, Instr(Mnemonic.tlbsync)),                 // PPC H tlbsync TLB Synchronize
                ...
                Sparse(21, 5, invalid, "  0b11000",
                    ...
                    (0b11001, Instr(Mnemonic.srawi, r2, r1, I3))),      // P1 SR srawi[.] Shift Right Algebraic Word Immediate
                invalid,    // 0b11001,
                Sparse(21, 5, invalid, "  0b11010",
                    ...
                    (0b00011, Nyi("popcntb")),                          // v2.02 popcntb Population Count Byte
                    (0b00100, Nyi("prtyw")),                            // v2.05 prtyw Parity Word
                    (0b00101, Nyi("prtyd")),                            // v2.05 prtyd Parity Dword
                    (0b01000, Nyi("cdtbcd")),                           // v2.06 cdtbcd Convert Declets To Binary Coded Decimal
                    (0b01001, Nyi("cbcdtd")),                           // v2.06 cbcdtd Convert Binary Coded Decimal To Declets
                    (0b01011, Nyi("popcntw")),                          // v2.06 popcntw Population Count Words
                    (0b01111, Nyi("popcntd")),                          // v2.06 popcntd Population Count Dword
                    (0b10000, Nyi("cnttzw[.]")),                        // v3.0 cnttzw[.] Count Trailing Zeros Word
                    (0b10001, Nyi("cnttzd[.]")),                        // v3.0 cnttzd[.] Count Trailing Zeros Dword
        ...
        private Decoder Ext3BDecoder()
        {
            var decoder = Sparse(26, 5, invalid, "  Ext3B",
                (0b00010, Mask(21, 5, "  00010",
                    Nyi("dadd[.]"),   // 111011 ..... ..... ..... 00000 00010. X I 195 v2.05 dadd[.] DFP Add
                    ...
                    Nyi("dctfix[.]"), // 111011 ..... ///// ..... 01001 00010. X I 217 v2.05 dctfix[.] DFP Convert To Fixed
                    ...
                    Nyi("denbcd[.]"), // 111011 ..... .//// ..... 11010 00010. X I 219 v2.05 denbcd[.] DFP Encode BCD To DPD
                ...
                (0b00011, Mask(23, 3, "  00011",
                    ...
                    invalid,
                    Nyi("drintn[.]"))), // 111011 ..... ////. ..... ..111 00011. Z23 I 213 v2.05 drintn[.] DFP Round To FP Integer Without Inexact
        ...
        public Decoder Ext3FDecoder()
        {
            var decoder = Mask(26, 5, "  Ext3F",
                ...
                Mask(21, 5, "  00100",
                    ...
                    Nyi("xsmaddqp[o]"),     // 111111 ..... ..... ..... 01100 00100. X I 578 v3.0 xsmaddqp[o] VSX Scalar Multiply-Add QP
                    Nyi("xsmsubqp[o]"),     // 111111 ..... ..... ..... 01101 00100. X I 599 v3.0 xsmsubqp[o] VSX Scalar Multiply-Subtract QP
                    ...
                    Nyi("xsdivqp[o]"),      // 111111 ..... ..... ..... 10001 00100. X I 566 v3.0 xsdivqp[o] VSX Scalar Divide QP
                    invalid,
                    invalid,
                ...
                Sparse(21, 5, invalid, "  01000",
                    ...
                    ( 0b00001, Instr(Mnemonic.fneg, C,f1,f3)),      // 111111 ..... ///// ..... 00001 01000. X I 151 P1 fneg[.] Floating Negate
                ...
                Sparse(21, 5, invalid, "  01110",
                    ( 0b00000, Instr(Mnemonic.fctiw, C,f1,f3)),     // 111111 ..... ///// ..... 00000 01110. X I 162 P2 fctiw[.] Floating Convert To Integer Word
