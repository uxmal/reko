    ...
    public partial class PowerPcDisassembler : DisassemblerBase<PowerPcInstruction>
    {
        ...
        static PowerPcDisassembler()
        {
            ...
            oprecs = new Decoder[] {
                ...
                new MDOpRec(),
                new XOpRec(new Dictionary<uint, Decoder>      // 1F
                {
                ...
                new DOpRec(Opcode.lq, "r1,E2"),                 // 38
                new DOpRec(Opcode.lfdp, "p1,E2:2"),             // 39
                new DSOpRec(Opcode.ld, Opcode.ldu, "r1,E2"),    // 3A
                new FpuOpRec(1, 0x1F, new Dictionary<uint, Decoder> // 3B
                {
        ...
        private static Decoder Ext4Decoder_VMX128()
        {
...
*/
        ...
        private static Decoder Mask(int ppcBitPosition, int bits, params Decoder[] decoders)
        {
            return new MaskDecoder(ppcBitPosition, bits, decoders);
        }
        private static Decoder Sparse(int ppcBitPosition, int bits, params (uint, Decoder)[] sparseDecoders)
        {
        ...
        private static Decoder Ext4Decoder_PPC750CL()
        {
