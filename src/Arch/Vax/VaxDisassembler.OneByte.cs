...
namespace Reko.Arch.Vax
{
    public partial class VaxDisassembler
    {
        ...
        {
 /* 00 */ new OpRec(Opcode.halt,  -1), 
 /* 01 */ new OpRec(Opcode.nop,  -1), 
 /* 02 */ new OpRec(Opcode.rei,  -1), 
 /* 03 */ new OpRec(Opcode.bpt,  -1), 
 /* 04 */ new OpRec(Opcode.ret,  -1), 
 /* 05 */ new OpRec(Opcode.rsb,  -1), 
 /* 06 */ new OpRec(Opcode.ldpctx,  -1), 
 /* 07 */ new OpRec(Opcode.svpctx,  -1), 
 /* 08 */ new OpRec(Opcode.cvtps,  -1), 
 /* 09 */ new OpRec(Opcode.cvtsp,  -1), 
 /* 0A */ new OpRec(Opcode.index,  -1), 
 /* 0B */ new OpRec(Opcode.crc,  -1), 
 /* 0C */ new OpRec(Opcode.prober,  -1), 
 /* 0D */ new OpRec(Opcode.probew,  -1), 
 /* 0E */ new OpRec(Opcode.insque,  -1), 
 ...
 /* 22 */ new OpRec(Opcode.subp4,  -1), 
 /* 23 */ new OpRec(Opcode.subp6,  -1), 
 /* 24 */ new OpRec(Opcode.cvtpt,  -1), 
 /* 25 */ new OpRec(Opcode.mulp,  -1), 
 /* 26 */ new OpRec(Opcode.cvttp,  -1), 
 /* 27 */ new OpRec(Opcode.divp,  -1), 
 /* 28 */ new OpRec(Opcode.movc3,  -1), 
 /* 29 */ new OpRec(Opcode.cmpc3,  -1), 
 /* 2A */ new OpRec(Opcode.scanc,  -1), 
 /* 2B */ new OpRec(Opcode.spanc,  -1), 
 ...
 /* 4E */ new OpRec(Opcode.cvtlf,  -1), 
 /* 4F */ new OpRec(Opcode.acbf,  -1), 

 /* 50 */ new OpRec(Opcode.movf,  -1), 
 /* 51 */ new OpRec(Opcode.cmpf,  -1), 
 ...
 /* 80 */ new OpRec(Opcode.addb2,  -1), 
 /* 81 */ new OpRec(Opcode.addb3,  -1), 
 /* 82 */ new OpRec(Opcode.subb2,  -1), 
 /* 83 */ new OpRec(Opcode.subb3,  -1), 
 ...
 /* 8C */ new OpRec(Opcode.xorb2,  -1), 
 /* 8D */ new OpRec(Opcode.xorb3,  -1), 
 /* 8E */ new OpRec(Opcode.mnegb,  -1), 
 /* 8F */ new OpRec(Opcode.caseb,  -1), 

 /* 90 */ new OpRec(Opcode.movb,  -1), 
 /* 91 */ new OpRec(Opcode.cmpb,  -1), 
 ...
 /* AC */ new OpRec(Opcode.xorw2,  -1), 
 /* AD */ new OpRec(Opcode.xorw3,  -1), 
 /* AE */ new OpRec(Opcode.mnegw,  -1), 
 /* AF */ new OpRec(Opcode.casew,  -1), 

 /* B0 */ new OpRec(Opcode.movw,  -1), 
 ...
 /* C0 */ new OpRec(Opcode.addl2,  -1), 
 /* C1 */ new OpRec(Opcode.addl3,  -1), 
 ...
 /* D0 */ new OpRec(Opcode.movl,  -1), 
 /* D1 */ new OpRec(Opcode.cmpl,  -1), 
