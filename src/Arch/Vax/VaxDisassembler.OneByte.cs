...
namespace Reko.Arch.Vax
{
    public partial class VaxDisassembler
    {
        ...
        {
 /* 00 */ new Decoder(Opcode.halt, ""), 
 /* 01 */ new Decoder(Opcode.nop, ""), 
 /* 02 */ new Decoder(Opcode.rei, ""), 
 /* 03 */ new Decoder(Opcode.bpt, ""), 
 /* 04 */ new Decoder(Opcode.ret, ""), 
 /* 05 */ new Decoder(Opcode.rsb, ""), 
 ...
 /* 10 */ new Decoder(Opcode.bsbb, "bb"), 
 /* 11 */ new Decoder(Opcode.brb, "bb"), 
 /* 12 */ new Decoder(Opcode.bneq, "bb"),    // bnequ
 /* 13 */ new Decoder(Opcode.beql, "bb"),  // beqlu
 /* 14 */ new Decoder(Opcode.bgtr, "bb"), 
 /* 15 */ new Decoder(Opcode.bleq, "bb"), 
 /* 16 */ new Decoder(Opcode.jsb, "ab"), 
 /* 17 */ new Decoder(Opcode.jmp, "ab"), 
 /* 18 */ new Decoder(Opcode.bgeq, "bb"), 
 /* 19 */ new Decoder(Opcode.blss, "bb"), 
 /* 1A */ new Decoder(Opcode.bgtru, "bb"), 
 /* 1B */ new Decoder(Opcode.blequ, "bb"), 
 /* 1C */ new Decoder(Opcode.bvc, "bb"), 
 /* 1D */ new Decoder(Opcode.bvs, "bb"), 
 /* 1E */ new Decoder(Opcode.bgequ, "bb"), // bcc, 
 /* 1F */ new Decoder(Opcode.blssu, "bb"), //  bcs, 
 ...
 /* 30 */ new Decoder(Opcode.bsbw,  "bw"), 
 /* 31 */ new Decoder(Opcode.brw,   "bw"), 
 ...
 /* 3D */ new Decoder(Opcode.acbw,  "rw,rw,mw,bw"),
 ...
 /* 4F */ new Decoder(Opcode.acbf,  "rf,rf,mf,bw"),
 ...
 /* 6F */ new Decoder(Opcode.acbd,   "rd,rd,md,bw"),
 ...
 /* 9D */ new Decoder(Opcode.acbb,  "rb,rb,mb,bw"), 
 ...
 /* E0 */ new Decoder(Opcode.bbs, "rl,vb,bb"), 
 /* E1 */ new Decoder(Opcode.bbc, "rl,vb,bb"), 
 /* E2 */ new Decoder(Opcode.bbss, "rl,vb,bb"), 
 /* E3 */ new Decoder(Opcode.bbcs, "rl,vb,bb"), 
 /* E4 */ new Decoder(Opcode.bbsc, "rl,vb,bb"),
 /* E5 */ new Decoder(Opcode.bbcc, "rl,vb,bb"),
 /* E6 */ new Decoder(Opcode.bbssi, "rl,vb,bb"), 
 /* E7 */ new Decoder(Opcode.bbcci, "rl,vb,bb"),
 /* E8 */ new Decoder(Opcode.blbs,  "rl,bb"), 
 /* E9 */ new Decoder(Opcode.blbc,  "rl,bb"), 
 ...
 /* F1 */ new Decoder(Opcode.acbl,   "rl,rl,ml,bw"),
 /* F2 */ new Decoder(Opcode.aoblss, "rl,ml,bb"), 
 /* F3 */ new Decoder(Opcode.aobleq, "rl,ml,bb"), 
 /* F4 */ new Decoder(Opcode.sobgeq, "ml,bb"),
 /* F5 */ new Decoder(Opcode.sobgtr, "ml,bb"),
 ...
 /* FA */ new Decoder(Opcode.callg,  -1), 
 /* FB */ new Decoder(Opcode.calls, "ab,ab"), 
