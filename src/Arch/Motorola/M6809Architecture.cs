...
namespace Reko.Arch.Motorola
{
    ...
    public class M6809Architecture : ProcessorArchitecture
    {
        ...
        {
            return new M6809.M6809InstructionComparer(norm);
        }
        ...
        public override string GrfToString(RegisterStorage flagRegister, string prefix, ulong grf)
        {
            ...
            if ((grf & (ulong) FlagM.N) != 0) sb.Append('N');
            if ((grf & (ulong) FlagM.Z) != 0) sb.Append('Z');
            if ((grf & (ulong) FlagM.V) != 0) sb.Append('V');
            if ((grf & (ulong) FlagM.C) != 0) sb.Append('C');
            return sb.ToString();
        }
