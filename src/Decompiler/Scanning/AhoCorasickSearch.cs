...
public struct StringSearchResult<TSymbol>
{
    ...
    /// <param name="scannedMemory">True if scanned memory should be visited.
    /// </param>
    /// <param name="unscannedMemory">True if unscanned memory should be visited.
    /// </param>
    ...
    /// <summary>
    /// Find all matching positions in the array <paramref name="stringToSearch"/>.
    /// </summary>
    ...
    where TSymbol : IComparable<TSymbol>
{
    ...
    /// <summary>
    /// Constructs a new instance of the <see cref="AhoCorasickSearch{TSymbol}"/> class.
    /// </summary>
    /// <param name="keywords">Symbols to search for.</param>
    /// <param name="scannedMemory">True if scanned memory is to be searched.</param>
    /// <param name="unscannedMemory">True if unscanned memory is to be searched.</param>
...
public class AhoCorasick
{
    ...
    /// <summary>
    /// Constructs a new instance of the <see cref="AhoCorasick"/> class.
    /// </summary>
    ...
    /// </summary>
    /// <param name="s">Keyword to add.</param>
    ...
    /// <summary>
    /// Create a suffix link for a node.
    /// </summary>
    /// <param name="nodeIndex">Node index.</param>
    /// <returns>The suffix link.</returns>
    ...
    /// <summary>
    /// Creates a transition for a node given a character.
    /// </summary>
    /// <param name="nodeIndex">Node index.</param>
    /// <param name="ch">Character on which to transition.
    /// </param>
    /// <returns></returns>
