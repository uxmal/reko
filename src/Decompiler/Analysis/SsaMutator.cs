...
public class SsaMutator
{
    ...
    /// </remarks>
    /// <param name="dst">Destination of the assignment to insert.</param>
    /// <param name="src">Source of the assigment to insert.</param>
    /// <param name="stmAfter"><see cref="Statement"/> after which 
    /// the new assignment is added.</param>
    ...
    /// This method creates an <c>&lt;id&gt; = Constant.Invalid</c> instruction for
    ...
    /// are uses of <c>&lt;id&gt;</c> after the call. This implies the signanture of 
    ...
    /// </summary>
    /// <param name="stm">Statement containing the call instruction.</param>
    ...
    /// <summary>
    /// Tidy the SSA graph around the given statement <paramref name="stm"/>
    /// containing the call <paramref name="call"/>.
    /// </summary>
    /// <param name="stm">Statement containing the call instruction.</param>
    /// <param name="call">Call instruction to bypass.</param>
