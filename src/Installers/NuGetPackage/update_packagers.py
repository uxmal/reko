...
def validate_vars(vars):
    ...
    for (k, v) in vars.items():
        v = v.replace('$TargetDir$', 'bin/Debug/net8.0')
        v = v.replace('$TargetFwkDir$', 'bin/Debug/net8.0')
        v = v.replace('$TargetFwk472Dir$', 'bin/Debug/net8.0')
        v = v.replace('$TargetDir_x64$', 'bin/x64/Debug/net8.0')
...
def expand_vars(vars):
    result = {}
    for k,v in vars.items():
        v = v.replace('$TargetDir$', 'bin/$Configuration$/net8.0')
        v = v.replace('$TargetFwkDir$', 'bin/$Configuration$/net8.0')
        v = v.replace('$TargetFwk472Dir$', 'bin/$Configuration$/net8.0')
        v = v.replace('$TargetDir_x64$', 'bin/x64/$Configuration$/net8.0')
        result[k] = v
    return result
